...
`mobile_identifier` - (Optional) If request matches mobile identifier service policy, mobile identifier is true (`Bool`).

`mobile_traffic` - (Optional) If request matches mobile endpoint service policy, mobile traffic is true (`Bool`).

`web_traffic` - (Optional) If request matches web endpoint service policy, web traffic is true (`Bool`).
