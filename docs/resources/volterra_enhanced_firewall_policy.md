...
###### One of the arguments from this list "allow, deny, insert_service" must be set
...
###### One of the arguments from this list "all_tcp_traffic, all_traffic, all_udp_traffic, applications, protocol_port_range" must be set
