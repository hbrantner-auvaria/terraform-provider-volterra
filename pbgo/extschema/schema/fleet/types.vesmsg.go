...
func (v *ValidateCreateSpecType) NetworkConnectorsValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for network_connectors")
	}
...
func (v *ValidateCreateSpecType) NetworkFirewallValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for network_firewall")
	}
	itemsValidatorFn := func(ctx context.Context, elems []*ves_io_schema.ObjectRefType, opts ...db.ValidateOpt) error {
		for i, el := range elems {
			if err := itemValFn(ctx, el, opts...); err != nil {
...
func (v *ValidateCreateSpecType) OutsideVirtualNetworkValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for outside_virtual_network")
	}
	itemsValidatorFn := func(ctx context.Context, elems []*ves_io_schema.ObjectRefType, opts ...db.ValidateOpt) error {
		for i, el := range elems {
			if err := itemValFn(ctx, el, opts...); err != nil {
...
func (v *ValidateCreateSpecType) InsideVirtualNetworkValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for inside_virtual_network")
	}
	itemsValidatorFn := func(ctx context.Context, elems []*ves_io_schema.ObjectRefType, opts ...db.ValidateOpt) error {
		for i, el := range elems {
			if err := itemValFn(ctx, el, opts...); err != nil {
...
func (v *ValidateCreateSpecType) BlockedServicesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for blocked_services")
	}
	itemsValidatorFn := func(ctx context.Context, elems []*BlockedServices, opts ...db.ValidateOpt) error {
		for i, el := range elems {
			if err := itemValFn(ctx, el, opts...); err != nil {
...
func (v *ValidateFlashArrayType) FlashArraysValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for flash_arrays")
	}
...
func (v *ValidateFlashBladeType) FlashBladesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for flash_blades")
	}
...
func (v *ValidateFleetBondDevicesListType) BondDevicesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for bond_devices")
	}
...
func (v *ValidateFleetStorageDeviceListType) StorageDevicesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for storage_devices")
	}
...
func (v *ValidateFleetStorageStaticRoutesListType) StorageRoutesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for storage_routes")
	}
...
func (v *ValidateGlobalSpecType) SingleSiteValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for single_site")
	}
	itemsValidatorFn := func(ctx context.Context, elems []*ves_io_schema.ObjectRefType, opts ...db.ValidateOpt) error {
		for i, el := range elems {
			if err := itemValFn(ctx, el, opts...); err != nil {
...
func (m *SriovInterface) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *SriovInterface) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *SriovInterface) DeepCopy() *SriovInterface {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *SriovInterface) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *SriovInterface) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return SriovInterfaceValidator().Validate(ctx, m, opts...)
}

type ValidateSriovInterface struct {
	FldValidators map[string]db.ValidatorFunc
}
...
func (v *ValidateSriovInterface) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*SriovInterface)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *SriovInterface got type %s", t)
		}
	}
	if m == nil {
		return nil
...
var DefaultSriovInterfaceValidator = func() *ValidateSriovInterface {
	...
	vrhInterfaceName := v.InterfaceNameValidationRuleHandler
	rulesInterfaceName := map[string]string{
		"ves.io.schema.rules.message.required": "true",
	}
	vFn, err = vrhInterfaceName(rulesInterfaceName)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for SriovInterface.interface_name: %s", err)
		panic(errMsg)
	}
	v.FldValidators["interface_name"] = vFn

	vrhNumberOfVfs := v.NumberOfVfsValidationRuleHandler
	rulesNumberOfVfs := map[string]string{
		"ves.io.schema.rules.message.required": "true",
	}
	vFn, err = vrhNumberOfVfs(rulesNumberOfVfs)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for SriovInterface.number_of_vfs: %s", err)
		panic(errMsg)
	}
	v.FldValidators["number_of_vfs"] = vFn

	return v
}()

func SriovInterfaceValidator() db.Validator {
	return DefaultSriovInterfaceValidator
}

// augmented methods on protoc/std generated struct

func (m *SriovInterfacesListType) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *SriovInterfacesListType) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *SriovInterfacesListType) DeepCopy() *SriovInterfacesListType {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *SriovInterfacesListType) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *SriovInterfacesListType) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return SriovInterfacesListTypeValidator().Validate(ctx, m, opts...)
}

type ValidateSriovInterfacesListType struct {
	FldValidators map[string]db.ValidatorFunc
}
...
func (v *ValidateSriovInterfacesListType) SriovInterfaceValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for sriov_interface")
	}
	itemsValidatorFn := func(ctx context.Context, elems []*SriovInterface, opts ...db.ValidateOpt) error {
		for i, el := range elems {
			if err := itemValFn(ctx, el, opts...); err != nil {
				return errors.Wrap(err, fmt.Sprintf("element %d", i))
			}
			if err := SriovInterfaceValidator().Validate(ctx, el, opts...); err != nil {
				return errors.Wrap(err, fmt.Sprintf("element %d", i))
			}
		}
		return nil
	...
	repValFn, err := db.NewRepeatedValidationRuleHandler(rules)
	if err != nil {
		return nil, errors.Wrap(err, "Repeated ValidationRuleHandler for sriov_interface")
	}

	validatorFn := func(ctx context.Context, val interface{}, opts ...db.ValidateOpt) error {
		elems, ok := val.([]*SriovInterface)
		if !ok {
			return fmt.Errorf("Repeated validation expected []*SriovInterface, got %T", val)
		}
		l := []string{}
		for _, elem := range elems {
			strVal, err := codec.ToJSON(elem, codec.ToWithUseProtoFieldName())
		...
		if err := repValFn(ctx, l, opts...); err != nil {
			return errors.Wrap(err, "repeated sriov_interface")
		}
		if err := itemsValidatorFn(ctx, elems, opts...); err != nil {
			return errors.Wrap(err, "items sriov_interface")
		}
		return nil
	}
...
func (v *ValidateSriovInterfacesListType) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*SriovInterfacesListType)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *SriovInterfacesListType got type %s", t)
		}
	}
	if m == nil {
		return nil
...
var DefaultSriovInterfacesListTypeValidator = func() *ValidateSriovInterfacesListType {
	...
	vrhSriovInterface := v.SriovInterfaceValidationRuleHandler
	rulesSriovInterface := map[string]string{
		"ves.io.schema.rules.repeated.unique": "true",
	}
	vFn, err = vrhSriovInterface(rulesSriovInterface)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for SriovInterfacesListType.sriov_interface: %s", err)
		panic(errMsg)
	}
	v.FldValidators["sriov_interface"] = vFn

	return v
}()

func SriovInterfacesListTypeValidator() db.Validator {
	return DefaultSriovInterfacesListTypeValidator
}
...
func (v *ValidateStorageDeviceNetappBackendOntapNasType) StorageValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	itemValFn, err := db.NewMessageValidationRuleHandler(itemRules)
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for storage")
	}
