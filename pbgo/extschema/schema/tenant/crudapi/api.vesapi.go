...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/tenant"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.tenant.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.tenant.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.tenant.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tenant.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tenant.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tenant.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tenant.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tenant.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.tenant.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.tenant.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tenant.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tenant.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/tenant/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.tenant/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.tenant.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-tenant-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.tenant.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-tenant-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.tenant.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-tenant-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "tenant",
            "x-ves-object-type": "ves.io.schema.tenant.Object",
            "x-ves-proto-service": "ves.io.schema.tenant.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.tenant/Objects": {
            "get": {
                "operationId": "ves.io.schema.tenant.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-tenant-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.tenant.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-tenant-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "tenant",
            "x-ves-object-type": "ves.io.schema.tenant.Object",
        ...
        "/ves.io.schema.tenant/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.tenant.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-tenant-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.tenant.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "tenant",
            "x-ves-object-type": "ves.io.schema.tenant.Object",
        ...
        "/ves.io.schema.tenant/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.tenant.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.tenant/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.tenant.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.tenant/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.tenant.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.tenant/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.tenant.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/tenantSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/tenantStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tenant.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "tenantCA": {
            ...
            "title": "CA Usage",
            "x-displayname": "CA",
            "x-ves-proto-message": "ves.io.schema.tenant.CA",
            "properties": {
                "name": {
                    "type": "string",
                ...
                "password": {
                    "description": " Password for CA",
                    "title": "Password",
                    "$ref": "#/definitions/tenantEncryptedPassword",
        ...
        "tenantEncryptedPassword": {
            "type": "object",
            "description": "Encrypted Password type.",
            "title": "EncryptedPassword",
            "x-displayname": "EncryptedPassword",
            "x-ves-proto-message": "ves.io.schema.tenant.EncryptedPassword",
            "properties": {
                "Password": {
                    "type": "string",
        ...
        "tenantGlobalSpecType": {
            ...
            "x-ves-proto-message": "ves.io.schema.tenant.GlobalSpecType",
            "properties": {
                ...
                "default_disable_public_ap": {
                    "type": "boolean",
                    "description": " Disable advertisement on public by default if true.",
                    "title": "Default disable advertisement on public",
                    "format": "boolean",
                    "x-displayname": "Default disable advertisement on public"
                },
                "deleted": {
                    "type": "boolean",
                    "description": " Represents tenant object of deletion state.",
                    "title": "Deleted Flag",
                    "format": "boolean",
                ...
                "downstream_cos": {
                    "type": "array",
                    "description": " this is a ref to downstream_cos object\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "Downstream Class of Service",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "k8s_server_sub_ca_latest_version": {
                    ...
                    "title": "K8S Server Sub CA Version",
                    "format": "int64",
                    "x-displayname": "K8S Server Sub CA Version"
                },
                "k8s_server_sub_cas": {
                    "type": "array",
                    "description": " Array of SubCAs, the latest one will be used for minting k8s server cert for tenant",
                    "title": "K8S Server Sub CAs",
                    "items": {
                ...
                "proxy_root_ca_latest_version": {
                    ...
                    "title": "Proxy Root CA version",
                    "format": "int64",
                    "x-displayname": "Proxy Root CA version"
                },
                "proxy_root_cas": {
                    "type": "array",
                    "description": " Array of CAas, the latest one will be used for proxy feature.",
                    "title": "Proxy Root CAs",
                    "items": {
                        "$ref": "#/definitions/tenantCA"
                    },
                ...
                "shape_shared_instance_auth_key": {
                    "description": " API Auth Key for Shared Shape Bot Defense. This value is\n set when tenant is created and comes from Shape IBD backend\n\nExample: - \"iL48DRzej6_UX1cOypny7NmtnJVBL9iSuT-0ImUsKlU\"-",
                    "title": "Shared Shape Instance API auth key",
                    "$ref": "#/definitions/schemaSecretType",
                    "x-displayname": "API auth key",
                    "x-ves-example": "iL48DRzej6_UX1cOypny7NmtnJVBL9iSuT-0ImUsKlU"
                },
                "shared_public_vip": {
                    "type": "array",
                    "description": " this is a ref to a shared public ip object\n this will be used for all of this tenant's VHs in public if dedicated public vip is not set\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "Shared Public VIP",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "tenant_fqdn": {
                    ...
                    "x-ves-example": "abc.console.ves.volterra.io",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.string.max_len": "256"
                    }
                },
                ...
                "tgw_asn_offset": {
                    "type": "integer",
                    "description": " Starting ASN for automatic allocation of ASNs for AWS TGW.\n\nExample: - 4293918720-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.lte: 4294963198\n",
                    "title": "TGW ASN Offset",
                    "format": "int64",
        ...
        "tenantSpecType": {
            "type": "object",
            "description": "Shape of the tenant specification",
            "title": "SpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.tenant.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/tenantGlobalSpecType",
        ...
        "tenantStatusObject": {
            ...
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.tenant.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "object_refs": {
                    "type": "array",
                    "description": " A tenant direct reference",
                    "title": "object_refs",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
        ...
        "tenantSubCA": {
            ...
            "x-ves-proto-message": "ves.io.schema.tenant.SubCA",
            "properties": {
                "CaName": {
                    "type": "string",
                    "description": " Name for this CA",
    ...
    "x-ves-proto-file": "ves.io/schema/tenant/crudapi/api.proto"
}`
