...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/bigip_irule"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.bigip_irule.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.bigip_irule.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.bigip_irule.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigip_irule.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigip_irule.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigip_irule.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigip_irule.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigip_irule.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.bigip_irule.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.bigip_irule.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigip_irule.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigip_irule.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigip_irule.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigip_irule.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigip_irule.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigip_irule.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigip_irule.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigip_irule.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/bigip_irule/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.bigip_irule/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigip_irule-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigip_irule.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigip_irule-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigip_irule.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigip_irule-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigip_irule.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bigip_irule",
            "x-ves-object-type": "ves.io.schema.bigip_irule.Object",
            "x-ves-proto-service": "ves.io.schema.bigip_irule.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.bigip_irule/Objects": {
            "get": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigip_irule-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigip_irule.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigip_irule-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigip_irule.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bigip_irule",
            "x-ves-object-type": "ves.io.schema.bigip_irule.Object",
        ...
        "/ves.io.schema.bigip_irule/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigip_irule-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigip_irule.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bigip_irule",
            "x-ves-object-type": "ves.io.schema.bigip_irule.Object",
        ...
        "/ves.io.schema.bigip_irule/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bigip_irule/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bigip_irule/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bigip_irule/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.bigip_irule.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "bigip_iruleGlobalSpecType": {
            "type": "object",
            "description": "Desired state for BIG-IP iRule Service",
            "title": "BIG-IP iRule Service specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.GlobalSpecType",
            "properties": {
                "code": {
                    "type": "string",
                ...
                "source": {
                    "type": "string",
                    "description": " iRule generation/updation source\n\nValidation Rules:\n  ves.io.schema.rules.string.in: [\\\"AI\\\",\\\"Human\\\",\\\"Mix\\\"]\n",
                    "title": "iRule source",
        ...
        "bigip_iruleSpecType": {
            "type": "object",
            "description": "Shape of the BIG-IP iRule Service specification",
            "title": "Specification for BIG-IP iRule Service",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/bigip_iruleGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "bigip_iruleStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for BIG-IP iRule Service",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "bigip_irulecrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.bigip_irule.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/bigip_iruleSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bigip_irulecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bigip_irulecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/bigip_iruleStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bigip_irulecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigip_irule.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bigip_irulecrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/bigip_irule/crudapi/api.proto"
}`
