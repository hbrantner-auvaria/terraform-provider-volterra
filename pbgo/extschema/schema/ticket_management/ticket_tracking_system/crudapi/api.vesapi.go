...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/ticket_management/ticket_tracking_system"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.ticket_management.ticket_tracking_system.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.ticket_management.ticket_tracking_system.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/ticket_management/ticket_tracking_system/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.ticket_management.ticket_tracking_system/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Get",
                "responses": {
                    "200": {
            ...
            "delete": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "put": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "x-displayname": "",
            "x-ves-object-kind": "ticket_tracking_system",
            "x-ves-object-type": "ves.io.schema.ticket_management.ticket_tracking_system.Object",
            "x-ves-proto-service": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.ticket_management.ticket_tracking_system/Objects": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "post": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
        ...
        "/ves.io.schema.ticket_management.ticket_tracking_system/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.ListStream",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ticket_management.ticket_tracking_system/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ticket_management.ticket_tracking_system/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ticket_management.ticket_tracking_system/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ticket_management.ticket_tracking_system/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/ticket_tracking_systemSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ticket_tracking_systemcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ticket_tracking_systemcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ticket_tracking_systemcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ticket_tracking_systemcrudapiErrorCode"
                },
        ...
        "ticket_tracking_systemGlobalSpecType": {
            "type": "object",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-oneof-field-provider_config": "[\"jira_config\"]",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.GlobalSpecType",
            "properties": {
                "jira_config": {
        ...
        "ticket_tracking_systemSpecType": {
            "type": "object",
            "description": "Shape of the ticket tracking system specification",
            "title": "Specification for Ticket Tracking System",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket_tracking_system.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/ticket_tracking_systemGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "ticket_tracking_systemcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.ticket_management.ticket_tracking_system.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/ticket_management/ticket_tracking_system/crudapi/api.proto"
}`
