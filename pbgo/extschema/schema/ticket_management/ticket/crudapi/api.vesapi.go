...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/ticket_management/ticket"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.ticket_management.ticket.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.ticket_management.ticket.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.ticket_management.ticket.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ticket_management.ticket.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ticket_management.ticket.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ticket_management.ticket.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ticket_management.ticket.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ticket_management.ticket.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/ticket_management/ticket/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.ticket_management.ticket/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ticket_management-ticket-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.ticket_management.ticket.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ticket_management-ticket-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.ticket_management.ticket.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ticket_management-ticket-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.ticket_management.ticket.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ticket",
            "x-ves-object-type": "ves.io.schema.ticket_management.ticket.Object",
            "x-ves-proto-service": "ves.io.schema.ticket_management.ticket.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.ticket_management.ticket/Objects": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ticket_management-ticket-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.ticket_management.ticket.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ticket_management-ticket-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.ticket_management.ticket.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ticket",
            "x-ves-object-type": "ves.io.schema.ticket_management.ticket.Object",
        ...
        "/ves.io.schema.ticket_management.ticket/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ticket_management-ticket-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.ticket_management.ticket.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ticket",
            "x-ves-object-type": "ves.io.schema.ticket_management.ticket.Object",
        ...
        "/ves.io.schema.ticket_management.ticket/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ticket_management.ticket/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ticket_management.ticket/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ticket_management.ticket/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.ticket_management.ticket.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/ticketSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ticketcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ticketcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ticketcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ticketcrudapiErrorCode"
                },
        ...
        "ticketGlobalSpecType": {
            ...
            "properties": {
                ...
                "service_feature": {
                    "type": "string",
                    "description": " An identifier for the feature that the implementing XC service can set to\n group tickets together\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "ticketSpecType": {
            "type": "object",
            "description": "Shape of the ticket specification",
            "title": "SpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.ticket_management.ticket.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/ticketGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "ticketcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.ticket_management.ticket.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/ticket_management/ticket/crudapi/api.proto"
}`
