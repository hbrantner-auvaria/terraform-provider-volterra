...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/forwarding_class"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.forwarding_class.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.forwarding_class.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.forwarding_class.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.forwarding_class.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.forwarding_class.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.forwarding_class.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.forwarding_class.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.forwarding_class.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.forwarding_class.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.forwarding_class.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.forwarding_class.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.forwarding_class.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.forwarding_class.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.forwarding_class.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.forwarding_class.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.forwarding_class.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.forwarding_class.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.forwarding_class.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/forwarding_class/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.forwarding_class/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-forwarding_class-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.forwarding_class.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-forwarding_class-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.forwarding_class.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-forwarding_class-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.forwarding_class.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "forwarding_class",
            "x-ves-object-type": "ves.io.schema.forwarding_class.Object",
            "x-ves-proto-service": "ves.io.schema.forwarding_class.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.forwarding_class/Objects": {
            "get": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-forwarding_class-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.forwarding_class.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-forwarding_class-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.forwarding_class.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "forwarding_class",
            "x-ves-object-type": "ves.io.schema.forwarding_class.Object",
        ...
        "/ves.io.schema.forwarding_class/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-forwarding_class-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.forwarding_class.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "forwarding_class",
            "x-ves-object-type": "ves.io.schema.forwarding_class.Object",
        ...
        "/ves.io.schema.forwarding_class/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.forwarding_class/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.forwarding_class/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.forwarding_class/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.forwarding_class.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/forwarding_classSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/forwarding_classcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/forwarding_classcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/forwarding_classStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/forwarding_classcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/forwarding_classcrudapiErrorCode"
                },
        ...
        "forwarding_classDSCPAFDropPrecedenceType": {
            "type": "string",
            "description": "DSCP Assured forwarding drop precedence\n\nDSCP Low drop precedence\nDSCP Low drop precedence\nDSCP Low drop precedence\nDSCP drop precedence value is taken from output of policer",
            "title": "DSCP Drop Precedence",
            "enum": [
                "DSCP_AF_LOW",
                "DSCP_AF_MEDIUM",
                "DSCP_AF_HIGH",
        ...
        "forwarding_classDSCPClassType": {
            ...
            "x-ves-proto-enum": "ves.io.schema.forwarding_class.DSCPClassType"
        },
        "forwarding_classDSCPMarkingType": {
            "type": "object",
            "description": "DSCP marking setting as per RFC 2475",
            "title": "DSCP Marking setting",
            "x-displayname": "DSCP Marking setting",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.DSCPMarkingType",
            "properties": {
                "drop_precedence": {
                    "description": " Select DSCP assured forwarding class drop precedence",
                    "title": "Assured Forwarding",
                    "$ref": "#/definitions/forwarding_classDSCPAFDropPrecedenceType",
                    "x-displayname": "Drop Precedence"
                },
                "dscp_class": {
                    "description": " Select DSCP precedence level",
                    "title": "Precedence Level",
                    "$ref": "#/definitions/forwarding_classDSCPClassType",
                    "x-displayname": "Precedence Level"
                }
            }
        },
        "forwarding_classGlobalSpecType": {
            "type": "object",
            "description": "Specification of Forwarding Class",
            "title": "Forwarding Class Specification",
            "x-displayname": "Specification",
            "x-ves-oneof-field-marking_choice": "[\"dscp\",\"no_marking\",\"tos_value\"]",
            "x-ves-oneof-field-policer_choice": "[\"no_policer\",\"policer\"]",
            "x-ves-oneof-field-queueing_choice": "[\"dscp_based_queue\",\"queue_id_to_use\"]",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.GlobalSpecType",
            "properties": {
                "dscp": {
                    "description": "Exclusive with [no_marking tos_value]\n DSCP marking setting as per RFC 2475",
                    "title": "DSCP Marking setting",
                    "$ref": "#/definitions/forwarding_classDSCPMarkingType",
                    "x-displayname": "DSCP Marking setting"
                },
                "dscp_based_queue": {
                    "description": "Exclusive with [queue_id_to_use]\n Queue is selected based on marking",
                    "title": "Queue Based on Marking",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Queue Based on DSCP"
                },
                "interface_group": {
                    "description": " Select Interface group or all interfaces to use for this forwarding class\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "all Priorities",
                    "$ref": "#/definitions/forwarding_classInterfaceGroupType",
                ...
                "no_marking": {
                    "description": "Exclusive with [dscp tos_value]\n Existing Marking are kept as is",
                    "title": "Do Not Mark",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Do Not Mark"
                },
                "no_policer": {
                    "description": "Exclusive with [policer]\n Disable Policer for this forwarding class",
                    "title": "No Policer",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Disable Policer"
                },
                "policer": {
                    "description": "Exclusive with [no_policer]\n Enable Policer for this forwarding class",
                    "title": "Queue Selection",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Enable Policer"
                },
                "queue_id_to_use": {
                    "description": "Exclusive with [dscp_based_queue]\n Queues as per RFC 2475",
                    "title": "Queue Selection",
                    "$ref": "#/definitions/forwarding_classDSCPClassType",
                    "x-displayname": "Queue Selection"
                },
                "tos_value": {
                    "type": "integer",
                    "description": "Exclusive with [dscp no_marking]\n Decimal value of raw 8 bit TOS. In above example DSCP 10 = Precedence Class 1 and drop precedence low\n\nExample: - \"10\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.lte: 255\n",
                    "title": "TOS value",
                    "format": "int64",
                    "x-displayname": "TOS value",
                    "x-ves-example": "10",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.uint32.lte": "255"
                    }
        ...
        "forwarding_classInterfaceGroupType": {
            ...
            "x-displayname": "Interface Group",
            "x-ves-proto-enum": "ves.io.schema.forwarding_class.InterfaceGroupType"
        },
        "forwarding_classSpecType": {
            "type": "object",
            "description": "Shape of the forwarding_class specification",
            "title": "Forwarding Class Object Specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/forwarding_classGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "forwarding_classStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status Object",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.forwarding_class.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "forwarding_classcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.forwarding_class.crudapi.ErrorCode"
        },
    ...
    "x-ves-proto-file": "ves.io/schema/forwarding_class/crudapi/api.proto"
}`
