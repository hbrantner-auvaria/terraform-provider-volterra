...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/network_policy"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.network_policy.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.network_policy.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.network_policy.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.network_policy.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.network_policy.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/network_policy/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.network_policy/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "network_policy",
            "x-ves-object-type": "ves.io.schema.network_policy.Object",
            "x-ves-proto-service": "ves.io.schema.network_policy.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.network_policy/Objects": {
            "get": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy-crudapi-api-create"
                },
        ...
        "/ves.io.schema.network_policy/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy-crudapi-api-liststream"
                },
        ...
        "/ves.io.schema.network_policy/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_policy/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_policy/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_policy/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.network_policy.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/network_policySpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/network_policyStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "network_policySpecType": {
            "type": "object",
            "description": "Shape of the Network Policy specification",
            "title": "Specification for network policy",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.network_policy.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemanetwork_policyGlobalSpecType",
        ...
        "schemanetwork_policyGlobalSpecType": {
            "type": "object",
            "description": "Desired state for Network policy",
            "title": "Network policy specification",
            "x-displayname": "Specification",
            "x-ves-oneof-field-local_endpoint": "[\"prefix\",\"prefix_selector\"]",
            "x-ves-oneof-field-rule_choice": "[\"legacy_rules\",\"rules\"]",
            "x-ves-proto-message": "ves.io.schema.network_policy.GlobalSpecType",
            "properties": {
                "egress_rules": {
                    "type": "array",
                    "description": " List of rules that apply to outgoing session from local endpoint\n Sequence in which rule is configured (in repeated egress rules) is the sequence in which egress rules are applied\n If egress rules are not specified or is empty list, then policy will assume default deny and to ANY destination from local endpoint\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 128\n",
    ...
    "x-ves-proto-file": "ves.io/schema/network_policy/crudapi/api.proto"
}`
