...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/l7_acl"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.l7_acl.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.l7_acl.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.l7_acl.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.l7_acl.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.l7_acl.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.l7_acl.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.l7_acl.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.l7_acl.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.l7_acl.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.l7_acl.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.l7_acl.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.l7_acl.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.l7_acl.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.l7_acl.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.l7_acl.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.l7_acl.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/l7_acl/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.l7_acl/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-l7_acl-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.l7_acl.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-l7_acl-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.l7_acl.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-l7_acl-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.l7_acl.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "l7_acl",
            "x-ves-object-type": "ves.io.schema.l7_acl.Object",
            "x-ves-proto-service": "ves.io.schema.l7_acl.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.l7_acl/Objects": {
            "get": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-l7_acl-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.l7_acl.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-l7_acl-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.l7_acl.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "l7_acl",
            "x-ves-object-type": "ves.io.schema.l7_acl.Object",
        ...
        "/ves.io.schema.l7_acl/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-l7_acl-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.l7_acl.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "l7_acl",
            "x-ves-object-type": "ves.io.schema.l7_acl.Object",
        ...
        "/ves.io.schema.l7_acl/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.l7_acl/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.l7_acl/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.l7_acl/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.l7_acl.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.l7_acl.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/l7_aclSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.l7_acl.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/l7_aclcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.l7_acl.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/l7_aclcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.l7_acl.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/l7_aclStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.l7_acl.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/l7_aclcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.l7_acl.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.l7_acl.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.l7_acl.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/l7_aclcrudapiErrorCode"
                },
        ...
        "l7_aclL7AclRule": {
            ...
            "properties": {
                "action": {
                    ...
                    "title": "Action",
                    "$ref": "#/definitions/l7_aclL7AclAction",
        ...
        "l7_aclSpecType": {
            "type": "object",
            "description": "Shape of L7 ACL rule",
            "title": "Specification",
            "x-displayname": "Specification",
            "x-ves-displayorder": "2",
            "x-ves-proto-message": "ves.io.schema.l7_acl.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemal7_aclGlobalSpecType",
        ...
        "l7_aclStatusObject": {
            ...
            "x-ves-proto-message": "ves.io.schema.l7_acl.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "l7_aclcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.l7_acl.crudapi.ErrorCode"
        },
        "policyCountryCode": {
            "type": "string",
        ...
        "schemal7_aclGlobalSpecType": {
            "type": "object",
            "description": "Shape of -l7_acl- object",
    ...
    "x-ves-proto-file": "ves.io/schema/l7_acl/crudapi/api.proto"
}`
