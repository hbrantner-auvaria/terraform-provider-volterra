...
type UpstreamCertificateParamsType struct {
	...
	// validation_params
	//
	// x-displayName: "Root CA Validation parameters (Deprecated)"
	// DEPRECATED: Use server_validation_choice.tls_validation_params instead.
	// Kept for backward compatibility with existing clients.
	// This includes URL for a trust store, whether SAN verification is required
	// and list of Subject Alt Names for verification
	ValidationParams *TlsValidationParamsType `protobuf:"bytes,2,opt,name=validation_params,json=validationParams,proto3" json:"validation_params,omitempty"` // Deprecated: Do not use.
	// server_validation_choice
	//
	// x-displayName: "TLS Verification"
	// Choose whether to perform TLS verification.
	//
	// Types that are valid to be assigned to ServerValidationChoice:
	//	*UpstreamCertificateParamsType_SkipServerVerification
	//	*UpstreamCertificateParamsType_TlsValidationParams
	//	*UpstreamCertificateParamsType_VolterraTrustedCa
	ServerValidationChoice isUpstreamCertificateParamsType_ServerValidationChoice `protobuf_oneof:"server_validation_choice"`
	// minimum_protocol_version
	//
	// x-displayName: "Minimum TLS Version"
	// Minimum TLS protocol version.
...
type isUpstreamCertificateParamsType_ServerValidationChoice interface {
	isUpstreamCertificateParamsType_ServerValidationChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type UpstreamCertificateParamsType_SkipServerVerification struct {
	SkipServerVerification *Empty `protobuf:"bytes,7,opt,name=skip_server_verification,json=skipServerVerification,proto3,oneof" json:"skip_server_verification,omitempty"`
}
type UpstreamCertificateParamsType_TlsValidationParams struct {
	TlsValidationParams *TlsValidationParamsType `protobuf:"bytes,9,opt,name=tls_validation_params,json=tlsValidationParams,proto3,oneof" json:"tls_validation_params,omitempty"`
}
type UpstreamCertificateParamsType_VolterraTrustedCa struct {
	VolterraTrustedCa *Empty `protobuf:"bytes,8,opt,name=volterra_trusted_ca,json=volterraTrustedCa,proto3,oneof" json:"volterra_trusted_ca,omitempty"`
}

func (*UpstreamCertificateParamsType_SkipServerVerification) isUpstreamCertificateParamsType_ServerValidationChoice() {
}
func (*UpstreamCertificateParamsType_TlsValidationParams) isUpstreamCertificateParamsType_ServerValidationChoice() {
}
func (*UpstreamCertificateParamsType_VolterraTrustedCa) isUpstreamCertificateParamsType_ServerValidationChoice() {
}

func (m *UpstreamCertificateParamsType) GetServerValidationChoice() isUpstreamCertificateParamsType_ServerValidationChoice {
	if m != nil {
...
func (m *UpstreamCertificateParamsType) GetSkipServerVerification() *Empty {
	if x, ok := m.GetServerValidationChoice().(*UpstreamCertificateParamsType_SkipServerVerification); ok {
		return x.SkipServerVerification
	}
	return nil
}

func (m *UpstreamCertificateParamsType) GetTlsValidationParams() *TlsValidationParamsType {
	if x, ok := m.GetServerValidationChoice().(*UpstreamCertificateParamsType_TlsValidationParams); ok {
		return x.TlsValidationParams
	}
	return nil
}

func (m *UpstreamCertificateParamsType) GetVolterraTrustedCa() *Empty {
	if x, ok := m.GetServerValidationChoice().(*UpstreamCertificateParamsType_VolterraTrustedCa); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*UpstreamCertificateParamsType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*UpstreamCertificateParamsType_SkipServerVerification)(nil),
		(*UpstreamCertificateParamsType_TlsValidationParams)(nil),
		(*UpstreamCertificateParamsType_VolterraTrustedCa)(nil),
	}
}
...
var fileDescriptor_f024b829e526b1d4 = []byte{
	...
	,
}
...
func (this *UpstreamCertificateParamsType_SkipServerVerification) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpstreamCertificateParamsType_SkipServerVerification)
	if !ok {
		that2, ok := that.(UpstreamCertificateParamsType_SkipServerVerification)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UpstreamCertificateParamsType_TlsValidationParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpstreamCertificateParamsType_TlsValidationParams)
	if !ok {
		that2, ok := that.(UpstreamCertificateParamsType_TlsValidationParams)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.TlsValidationParams.Equal(that1.TlsValidationParams) {
		return false
	}
	return true
}
func (this *UpstreamCertificateParamsType_VolterraTrustedCa) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpstreamCertificateParamsType_VolterraTrustedCa)
	if !ok {
		that2, ok := that.(UpstreamCertificateParamsType_VolterraTrustedCa)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UpstreamCertificateParamsType_SkipServerVerification) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.UpstreamCertificateParamsType_SkipServerVerification{` +
		`SkipServerVerification:` + fmt.Sprintf("%#v", this.SkipServerVerification) + `}`}, ", ")
	return s
}
func (this *UpstreamCertificateParamsType_TlsValidationParams) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.UpstreamCertificateParamsType_TlsValidationParams{` +
		`TlsValidationParams:` + fmt.Sprintf("%#v", this.TlsValidationParams) + `}`}, ", ")
	return s
}
func (this *UpstreamCertificateParamsType_VolterraTrustedCa) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.UpstreamCertificateParamsType_VolterraTrustedCa{` +
...
func (m *UpstreamCertificateParamsType_SkipServerVerification) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpstreamCertificateParamsType_SkipServerVerification) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *UpstreamCertificateParamsType_VolterraTrustedCa) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpstreamCertificateParamsType_VolterraTrustedCa) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *UpstreamCertificateParamsType_TlsValidationParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpstreamCertificateParamsType_TlsValidationParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.TlsValidationParams != nil {
		{
			size, err := m.TlsValidationParams.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DownstreamTlsParamsType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.XfccHeaderElements) > 0 {
		dAtA20 := make([]byte, len(m.XfccHeaderElements)*10)
		var j19 int
		for _, num := range m.XfccHeaderElements {
			for num >= 1<<7 {
		...
		i = encodeVarintCertTypes(dAtA, i, uint64(j19))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Crl) > 0 {
...
func (m *UpstreamCertificateParamsType_SkipServerVerification) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpstreamCertificateParamsType_VolterraTrustedCa) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpstreamCertificateParamsType_TlsValidationParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *UpstreamCertificateParamsType_SkipServerVerification) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpstreamCertificateParamsType_SkipServerVerification{`,
		`SkipServerVerification:` + strings.Replace(fmt.Sprintf("%v", this.SkipServerVerification), "Empty", "Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpstreamCertificateParamsType_VolterraTrustedCa) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpstreamCertificateParamsType_VolterraTrustedCa{`,
		`VolterraTrustedCa:` + strings.Replace(fmt.Sprintf("%v", this.VolterraTrustedCa), "Empty", "Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpstreamCertificateParamsType_TlsValidationParams) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UpstreamCertificateParamsType_TlsValidationParams{`,
		`TlsValidationParams:` + strings.Replace(fmt.Sprintf("%v", this.TlsValidationParams), "TlsValidationParamsType", "TlsValidationParamsType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *UpstreamCertificateParamsType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.ServerValidationChoice = &UpstreamCertificateParamsType_SkipServerVerification{v}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			m.ServerValidationChoice = &UpstreamCertificateParamsType_VolterraTrustedCa{v}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TlsValidationParams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &TlsValidationParamsType{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.ServerValidationChoice = &UpstreamCertificateParamsType_TlsValidationParams{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCertTypes(dAtA[iNdEx:])
