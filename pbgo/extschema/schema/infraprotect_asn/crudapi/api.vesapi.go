...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/infraprotect_asn"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.infraprotect_asn.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.infraprotect_asn.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.infraprotect_asn.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.infraprotect_asn.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.infraprotect_asn.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_asn.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_asn.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_asn.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/infraprotect_asn/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.infraprotect_asn/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_asn",
            "x-ves-object-type": "ves.io.schema.infraprotect_asn.Object",
            "x-ves-proto-service": "ves.io.schema.infraprotect_asn.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.infraprotect_asn/Objects": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_asn",
            "x-ves-object-type": "ves.io.schema.infraprotect_asn.Object",
        ...
        "/ves.io.schema.infraprotect_asn/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_asn",
            "x-ves-object-type": "ves.io.schema.infraprotect_asn.Object",
        ...
        "/ves.io.schema.infraprotect_asn/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_asn/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_asn/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_asn/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.infraprotect_asn.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/infraprotect_asnSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_asncrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_asncrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/infraprotect_asnStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_asncrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_asncrudapiErrorCode"
                },
        ...
        "infraprotect_asnGlobalSpecType": {
            "type": "object",
            "description": "DDos Transit ASN spec",
            ...
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.GlobalSpecType",
            "properties": {
                "asn": {
                    "type": "integer",
                ...
                "bgp_session_disabled": {
                    "description": "Exclusive with [bgp_session_enabled]\n BGP Sessions Not Enabled",
                    "title": "BGP Sessions Not Enabled",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Disable"
                },
                "bgp_session_enabled": {
                    "description": "Exclusive with [bgp_session_disabled]\n BGP Sessions Enabled",
                    "title": "BGP Sessions Enabled",
                    "$ref": "#/definitions/schemaEmpty",
        ...
        "infraprotect_asnSpecType": {
            "type": "object",
            "description": "Infraprotect ASN Object",
            "title": "Infraprotect ASN Specification",
            "x-displayname": "ASN Specification",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/infraprotect_asnGlobalSpecType",
        ...
        "infraprotect_asncrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.infraprotect_asn.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/infraprotect_asn/crudapi/api.proto"
}`
