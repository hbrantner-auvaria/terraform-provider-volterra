...
import (
	...
	_ "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/common_cache_rule"
	io "io"
	math "math"
	math_bits "math/bits"
	reflect "reflect"
...
type HTTPLBRequest struct {
	...
	// Caching
	//
	// x-displayName: "Caching"
	// This feature belongs to the Content Delivery Network service. Enable it to enhance Console capabilities and utilize this feature.
	//
	// Types that are valid to be assigned to Caching:
	//	*HTTPLBRequest_DefaultCachingDisable
	//	*HTTPLBRequest_DefaultCachingEnable
	Caching isHTTPLBRequest_Caching `protobuf_oneof:"caching"`
}
...
type isHTTPLBRequest_Caching interface {
	isHTTPLBRequest_Caching()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type HTTPLBRequest_DefaultCachingDisable struct {
	DefaultCachingDisable *schema.Empty `protobuf:"bytes,14,opt,name=default_caching_disable,json=defaultCachingDisable,proto3,oneof" json:"default_caching_disable,omitempty"`
}
type HTTPLBRequest_DefaultCachingEnable struct {
	DefaultCachingEnable *schema.Empty `protobuf:"bytes,16,opt,name=default_caching_enable,json=defaultCachingEnable,proto3,oneof" json:"default_caching_enable,omitempty"`
}
...
func (*HTTPLBRequest_DefaultCachingDisable) isHTTPLBRequest_Caching()                 {}
func (*HTTPLBRequest_DefaultCachingEnable) isHTTPLBRequest_Caching()                  {}
...
func (m *HTTPLBRequest) GetCaching() isHTTPLBRequest_Caching {
	if m != nil {
		return m.Caching
	}
	return nil
...
func (m *HTTPLBRequest) GetDefaultCachingDisable() *schema.Empty {
	if x, ok := m.GetCaching().(*HTTPLBRequest_DefaultCachingDisable); ok {
		return x.DefaultCachingDisable
	}
	return nil
}

func (m *HTTPLBRequest) GetDefaultCachingEnable() *schema.Empty {
	if x, ok := m.GetCaching().(*HTTPLBRequest_DefaultCachingEnable); ok {
		return x.DefaultCachingEnable
	}
	return nil
}
...
func (*HTTPLBRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*HTTPLBRequest_DefaultCachingDisable)(nil),
		(*HTTPLBRequest_DefaultCachingEnable)(nil),
	}
}
...
var fileDescriptor_7c0dbe3d2ae6fd6c = []byte{
	...
	,
}
...
func (this *HTTPLBRequest) Equal(that interface{}) bool {
	...
	if that1.Caching == nil {
		if this.Caching != nil {
			return false
		}
	} else if this.Caching == nil {
		return false
	} else if !this.Caching.Equal(that1.Caching) {
		return false
	}
	return true
}
...
func (this *HTTPLBRequest_DefaultCachingDisable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HTTPLBRequest_DefaultCachingDisable)
	if !ok {
		that2, ok := that.(HTTPLBRequest_DefaultCachingDisable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DefaultCachingDisable.Equal(that1.DefaultCachingDisable) {
		return false
	}
	return true
}
func (this *HTTPLBRequest_DefaultCachingEnable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HTTPLBRequest_DefaultCachingEnable)
	if !ok {
		that2, ok := that.(HTTPLBRequest_DefaultCachingEnable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DefaultCachingEnable.Equal(that1.DefaultCachingEnable) {
		return false
	}
	return true
}
...
func (this *HTTPLBRequest) GoString() string {
	...
	if this.Caching != nil {
		s = append(s, "Caching: "+fmt.Sprintf("%#v", this.Caching)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *HTTPLBRequest_DefaultCachingDisable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&discovered_service.HTTPLBRequest_DefaultCachingDisable{` +
		`DefaultCachingDisable:` + fmt.Sprintf("%#v", this.DefaultCachingDisable) + `}`}, ", ")
	return s
}
func (this *HTTPLBRequest_DefaultCachingEnable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&discovered_service.HTTPLBRequest_DefaultCachingEnable{` +
		`DefaultCachingEnable:` + fmt.Sprintf("%#v", this.DefaultCachingEnable) + `}`}, ", ")
	return s
}
	...
	if m.Caching != nil {
		{
			size := m.Caching.Size()
			i -= size
			if _, err := m.Caching.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *HTTPLBRequest_DefaultCachingDisable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HTTPLBRequest_DefaultCachingDisable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DefaultCachingDisable != nil {
		{
			size, err := m.DefaultCachingDisable.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HTTPLBRequest_DefaultCachingEnable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HTTPLBRequest_DefaultCachingEnable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DefaultCachingEnable != nil {
		{
			size, err := m.DefaultCachingEnable.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HTTPLBRequest_DefaultCachingDisable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DefaultCachingDisable != nil {
		l = m.DefaultCachingDisable.Size()
		n += 1 + l + sovPublicCustomapi(uint64(l))
	}
	return n
}
func (m *HTTPLBRequest_DefaultCachingEnable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *HTTPLBRequest) String() string {
	...
	s := strings.Join([]string{`&HTTPLBRequest{`,
		...
		`Caching:` + fmt.Sprintf("%v", this.Caching) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *HTTPLBRequest_DefaultCachingDisable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HTTPLBRequest_DefaultCachingDisable{`,
		`DefaultCachingDisable:` + strings.Replace(fmt.Sprintf("%v", this.DefaultCachingDisable), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HTTPLBRequest_DefaultCachingEnable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HTTPLBRequest_DefaultCachingEnable{`,
		`DefaultCachingEnable:` + strings.Replace(fmt.Sprintf("%v", this.DefaultCachingEnable), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *HTTPLBRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultCachingDisable", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Caching = &HTTPLBRequest_DefaultCachingDisable{v}
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultCachingEnable", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Caching = &HTTPLBRequest_DefaultCachingEnable{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPublicCustomapi(dAtA[iNdEx:])
