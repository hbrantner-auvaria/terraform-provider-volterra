...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/jwt_provider"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.jwt_provider.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.jwt_provider.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.jwt_provider.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt_provider.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt_provider.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt_provider.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt_provider.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt_provider.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.jwt_provider.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.jwt_provider.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt_provider.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.jwt_provider.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt_provider.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.jwt_provider.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt_provider.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt_provider.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt_provider.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.jwt_provider.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/jwt_provider/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.jwt_provider/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt_provider-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt_provider.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt_provider-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt_provider.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt_provider-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt_provider.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "jwt_provider",
            "x-ves-object-type": "ves.io.schema.jwt_provider.Object",
            "x-ves-proto-service": "ves.io.schema.jwt_provider.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.jwt_provider/Objects": {
            "get": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt_provider-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt_provider.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt_provider-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt_provider.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "jwt_provider",
            "x-ves-object-type": "ves.io.schema.jwt_provider.Object",
        ...
        "/ves.io.schema.jwt_provider/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt_provider-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt_provider.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "jwt_provider",
            "x-ves-object-type": "ves.io.schema.jwt_provider.Object",
        ...
        "/ves.io.schema.jwt_provider/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.jwt_provider/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.jwt_provider/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.jwt_provider/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.jwt_provider.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/jwt_providerSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/jwt_providercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/jwt_providercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/jwt_providerStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/jwt_providercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/jwt_providercrudapiErrorCode"
                },
        ...
        "jwt_providerJwtHeader": {
            "type": "object",
            "description": "Specify the HTTP headers from which JWT token can be extracted.",
            "title": "JwtHeader",
            "x-displayname": "JWT Header",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.JwtHeader",
            "properties": {
                "name": {
                    "type": "string",
        ...
        "jwt_providerRemoteJwks": {
            "type": "object",
            "description": "JSON Web Key Set (JWKS) is needed to validate signature of a JWT.\nThis field specifies how to fetch JWKS remotely and how to cache it.",
            "title": "RemoteJwks",
            "x-displayname": "Remote JSON Web Key Set",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.RemoteJwks",
            "properties": {
                "cache_duration_ms": {
                    "type": "integer",
                    "description": " Duration in milliseconds after which the cached JWKS should be expired.\n\nExample: - 4000-",
                ...
                "cluster": {
                    "type": "array",
                    "description": " Cluster which specifies how URI has to be fetched.\n This is the reference to the cluster object.",
                    "title": "cluster",
                    "items": {
                ...
                "timeout": {
                    "type": "integer",
                    "description": " Maximum duration in milliseconds that a response can take to arrive upon request\n\nExample: - 2000-",
                    "title": "timeout",
                    "format": "int64",
                ...
                "uri": {
                    ...
                    "title": "URI",
                    "x-displayname": "URI",
                    "x-ves-example": "https://example.com/.well-known/jwks.json"
                }
            }
        },
        "jwt_providerSpecType": {
            "type": "object",
            "description": "Shape of the JWT specification",
            "title": "Specification for JWT provider",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemajwt_providerGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "jwt_providerStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for JWT provider",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "jwt_providercrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.jwt_provider.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
        ...
        "schemajwt_providerGlobalSpecType": {
            "type": "object",
            "description": "Global config specification",
            "title": "JWT provider configuration",
            "x-displayname": "Global Configuration Specification",
            "x-ves-oneof-field-source_specifier": "[\"inline_string\",\"local_jwks\",\"remote_jwks\"]",
            "x-ves-proto-message": "ves.io.schema.jwt_provider.GlobalSpecType",
            "properties": {
                "audiences": {
                    "type": "array",
                    "description": " The list of JWT audiences that are are allowed to access. A JWT containing any of these audiences will be accepted.\n If not specified, will not check audiences in the token\n\nExample: - \"bookstore_android.apps.googleusercontent.com\"-",
                    "title": "audiences",
                    "items": {
                        "type": "string"
                    },
                    "x-displayname": "Audiences",
                    "x-ves-example": "bookstore_android.apps.googleusercontent.com"
                },
                "authorization_servers": {
                    "type": "array",
                    "description": " List of authorization server",
                    "title": "auth_server",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "bearer_token": {
                    "type": "boolean",
                    "description": " Token is found in Authorization HTTP header with Bearer authentication scheme",
                    "title": "bearer token",
                    "format": "boolean",
                ...
                "from_headers": {
                    ...
                    "title": "from_headers",
                    "items": {
                        "$ref": "#/definitions/jwt_providerJwtHeader"
                    },
                ...
                "inline_string": {
                    "description": "Exclusive with [local_jwks remote_jwks]\n JWKS is in local data source. It should be embedded in the inline_string.",
                    "title": "inline_string",
                    "$ref": "#/definitions/schemaSecretType",
                    "x-displayname": "Local JWKS"
                },
                "issuer": {
                    "type": "string",
                    "description": " Specify the principal that issued the JWT, usually a URL or an email address.\n\nExample: - \"https://example.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Issuer",
                ...
                "jwks_key_ids": {
                    "type": "array",
                    "description": " Collection of Key ID values present in the JWKS, helps in quick lookup and key rotation handling.",
                    "title": "jwks_key_ids",
                    "items": {
                        "type": "string"
                    },
                    "x-displayname": "JWKS Key IDs"
                },
                "local_jwks": {
                    "type": "string",
                    "description": "Exclusive with [inline_string remote_jwks]\n Filename having JWKS\n\nExample: - \"/etc/envoy/jwks/jwks1.txt\"-",
                    "title": "Local JWK",
                    "x-displayname": "Local JWK",
                    "x-ves-example": "/etc/envoy/jwks/jwks1.txt"
                },
                "payload_in_metadata": {
                    "type": "string",
                    ...
                    "title": "payload_in_metadata",
                    "x-displayname": "Payload In Metadata"
                },
                "remote_jwks": {
                    "description": "Exclusive with [inline_string local_jwks]\n Specify details for remote JWKS",
                    "title": "Remote JWKS",
                    "$ref": "#/definitions/jwt_providerRemoteJwks",
                    "x-displayname": "Remote JWKS"
                },
                "validate_period": {
                    "type": "boolean",
                    "description": " Validate that expiration time and nbf",
                    "title": "validate_period",
                    "format": "boolean",
    ...
    "x-ves-proto-file": "ves.io/schema/jwt_provider/crudapi/api.proto"
}`
