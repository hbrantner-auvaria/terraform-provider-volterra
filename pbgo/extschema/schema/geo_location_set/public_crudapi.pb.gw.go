...
/*
Package geo_location_set is a reverse proxy.
...
var (
	pattern_API_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"public", "namespaces", "metadata.namespace", "geo_location_sets"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_API_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"public", "namespaces", "namespace", "geo_location_sets", "name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_API_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"public", "namespaces", "namespace", "geo_location_sets"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_API_Replace_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"public", "namespaces", "metadata.namespace", "geo_location_sets", "metadata.name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_API_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"public", "namespaces", "namespace", "geo_location_sets", "name"}, "", runtime.AssumeColonVerbOpt(false)))
)
