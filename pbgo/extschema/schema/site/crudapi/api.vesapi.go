...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.site.crudapi.API.Delete")
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.site.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.site.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.site.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.site.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.site.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.site.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        ...
        "/ves.io.schema.site/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.site.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.site/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.site.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.site/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.site.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.site/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.site.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "crudapiObjectCreateRsp": {
            ...
            "properties": {
                "err": {
                    "$ref": "#/definitions/sitecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "schemasiteGlobalSpecType": {
            ...
            "properties": {
                ...
                "kubernetes_upgrade_drain": {
                    "description": " K8s Node drain during OS or SW upgrade",
                    "title": "Kubernetes Upgrade Drain",
