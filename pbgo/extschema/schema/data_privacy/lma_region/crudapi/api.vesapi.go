...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/data_privacy/lma_region"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.data_privacy.lma_region.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.data_privacy.lma_region.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.data_privacy.lma_region.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_privacy.lma_region.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_privacy.lma_region.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_privacy.lma_region.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_privacy.lma_region.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_privacy.lma_region.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.data_privacy.lma_region.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.data_privacy.lma_region.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_privacy.lma_region.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.data_privacy.lma_region.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_privacy.lma_region.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.data_privacy.lma_region.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_privacy.lma_region.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_privacy.lma_region.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_privacy.lma_region.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.data_privacy.lma_region.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/data_privacy/lma_region/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.data_privacy.lma_region/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_privacy-lma_region-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_privacy.lma_region.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_privacy-lma_region-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_privacy.lma_region.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_privacy-lma_region-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_privacy.lma_region.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "lma_region",
            "x-ves-object-type": "ves.io.schema.data_privacy.lma_region.Object",
            "x-ves-proto-service": "ves.io.schema.data_privacy.lma_region.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.data_privacy.lma_region/Objects": {
            "get": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_privacy-lma_region-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_privacy.lma_region.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_privacy-lma_region-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_privacy.lma_region.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "lma_region",
            "x-ves-object-type": "ves.io.schema.data_privacy.lma_region.Object",
        ...
        "/ves.io.schema.data_privacy.lma_region/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_privacy-lma_region-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_privacy.lma_region.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "lma_region",
            "x-ves-object-type": "ves.io.schema.data_privacy.lma_region.Object",
        ...
        "/ves.io.schema.data_privacy.lma_region/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.data_privacy.lma_region/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.data_privacy.lma_region/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.data_privacy.lma_region/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.data_privacy.lma_region.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/lma_regionSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/lma_regioncrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/lma_regioncrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/lma_regionStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/lma_regioncrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/lma_regioncrudapiErrorCode"
                },
        ...
        "lma_regionClickhouseParams": {
            "type": "object",
            "description": "Clickhouse parameters",
            "title": "Clickhouse Params",
            "x-displayname": "Clickhouse Params",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.ClickhouseParams",
            "properties": {
                "host": {
                    "type": "string",
        ...
        "lma_regionElasticParams": {
            "type": "object",
            "description": "Elastic parameters",
            "title": "Elastic Params",
            "x-displayname": "Elastic Params",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.ElasticParams",
            "properties": {
                "urls": {
                    "type": "array",
                    "description": " Elastic Search URL\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 8096\n",
                    "title": "Elastic Search URLs",
                    "items": {
                        "type": "string",
                        "maxLength": 8096
                    },
        ...
        "lma_regionGlobalSpecType": {
            "type": "object",
            "description": "Desired state for lma region",
            "title": "LMA Region specification",
            ...
            "properties": {
                ...
                "clickhouse_params": {
                    ...
                    "title": "Clickhouse params",
                    "$ref": "#/definitions/lma_regionClickhouseParams",
                    "x-displayname": "Clickhouse params",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "elastic_params": {
                    ...
                    "title": "Elastic params",
                    "$ref": "#/definitions/lma_regionElasticParams",
                    "x-displayname": "Elastic params",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "is_default": {
                    "type": "boolean",
                    "description": " Is this the default region\n\nExample: - true-",
                    "title": "Is Default",
                    "format": "boolean",
                    "x-displayname": "Is Default"
                },
                "kafka_params": {
                    "description": " Kafka Params\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Kafka params",
                    "$ref": "#/definitions/lma_regionKafkaParams",
        ...
        "lma_regionKafkaParams": {
            "type": "object",
            "description": "Kafka parameters",
            "title": "Kafka Params",
            "x-displayname": "Kafka Params",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.KafkaParams",
            "properties": {
                "bootstrap_servers": {
                    "type": "array",
                    "description": " Servers in a Kafka cluster that a client should use to bootstrap its connection to the cluster.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 8096\n",
        ...
        "lma_regionSpecType": {
            ...
            "title": "Specification for lma region",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/lma_regionGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "lma_regionStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for lma region",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "object_refs": {
                    ...
                    "x-displayname": "LMA Region Config Object"
                }
            }
        },
        "lma_regioncrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.data_privacy.lma_region.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/data_privacy/lma_region/crudapi/api.proto"
}`
