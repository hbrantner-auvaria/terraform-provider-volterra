...
const (
	...
	CreateRequestFQN = "ves.io.schema.data_privacy.lma_region.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.data_privacy.lma_region.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.data_privacy.lma_region.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.data_privacy.lma_region.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.data_privacy.lma_region.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.data_privacy.lma_region.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.data_privacy.lma_region.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.data_privacy.lma_region.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.data_privacy.lma_region.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.data_privacy.lma_region.DeleteResponse"
)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/lma_regions/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/lma_regions", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.data_privacy.lma_region.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.data_privacy.lma_region")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_privacy.lma_region.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_privacy.lma_region.API.List")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.data_privacy.lma_region.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.data_privacy.lma_region.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_privacy.lma_region.API.Get"); rvFn != nil {
	...
	rspMsgFQN := "ves.io.schema.data_privacy.lma_region.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_privacy.lma_region.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.data_privacy.lma_region.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/lma_regions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/lma_regionListResponse"
                        }
                    },
                    "401": {
            ...
            "x-ves-proto-service": "ves.io.schema.data_privacy.lma_region.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/lma_regions/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/lma_regionGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
    ...
    "definitions": {
        ...
        "lma_regionGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read lma_region",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.GetResponse",
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the lma region",
                    "title": "spec",
                    "$ref": "#/definitions/lma_regionGetSpecType",
                    "x-displayname": "Spec"
                },
                "status": {
                    "type": "array",
        ...
        "lma_regionGetResponseFormatCode": {
            "type": "string",
        ...
        "lma_regionGetSpecType": {
            "type": "object",
            "description": "Shape of the lma region specification",
            "title": "Get LMA Region",
        ...
        "lma_regionListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of lma_region",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/lma_regionListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "lma_regionListResponseItem": {
            "type": "object",
            "description": "By default a summary of lma_region is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of lma_region",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.data_privacy.lma_region.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates lma_region is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this lma_region\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this lma_region\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
    ...
    "x-displayname": "LMA Region",
    "x-ves-proto-file": "ves.io/schema/data_privacy/lma_region/public_crudapi.proto"
}`
