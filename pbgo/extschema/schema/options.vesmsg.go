...
func (m *ThreatLevelInfo) ToJSON() (string, error) {
	return codec.ToJSON(m)
}

func (m *ThreatLevelInfo) ToYAML() (string, error) {
	return codec.ToYAML(m)
}

func (m *ThreatLevelInfo) DeepCopy() *ThreatLevelInfo {
	if m == nil {
		return nil
	}
	ser, err := m.Marshal()
...
func (m *ThreatLevelInfo) DeepCopyProto() proto.Message {
	if m == nil {
		return nil
	}
	return m.DeepCopy()
...
func (m *ThreatLevelInfo) Validate(ctx context.Context, opts ...db.ValidateOpt) error {
	return ThreatLevelInfoValidator().Validate(ctx, m, opts...)
}

type ValidateThreatLevelInfo struct {
	FldValidators map[string]db.ValidatorFunc
}

func (v *ValidateThreatLevelInfo) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	m, ok := pm.(*ThreatLevelInfo)
	if !ok {
		switch t := pm.(type) {
		case nil:
			return nil
		default:
			return fmt.Errorf("Expected type *ThreatLevelInfo got type %s", t)
		}
	}
	if m == nil {
		return nil
	}
	if fv, exists := v.FldValidators["max_value"]; exists {
		vOpts := append(opts, db.WithValidateField("max_value"))
		if err := fv(ctx, m.GetMaxValue(), vOpts...); err != nil {
			return err
		}
	}
	if fv, exists := v.FldValidators["min_value"]; exists {
		vOpts := append(opts, db.WithValidateField("min_value"))
		if err := fv(ctx, m.GetMinValue(), vOpts...); err != nil {
			return err
		}
	}
	if fv, exists := v.FldValidators["name"]; exists {
...
// Well-known symbol for default validator implementation
var DefaultThreatLevelInfoValidator = func() *ValidateThreatLevelInfo {
	v := &ValidateThreatLevelInfo{FldValidators: map[string]db.ValidatorFunc{}}

	return v
}()

func ThreatLevelInfoValidator() db.Validator {
	return DefaultThreatLevelInfoValidator
}
