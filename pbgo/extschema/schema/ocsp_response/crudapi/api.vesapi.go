...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/ocsp_response"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.ocsp_response.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.ocsp_response.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.ocsp_response.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ocsp_response.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ocsp_response.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ocsp_response.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ocsp_response.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ocsp_response.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.ocsp_response.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.ocsp_response.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ocsp_response.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ocsp_response.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ocsp_response.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ocsp_response.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ocsp_response.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ocsp_response.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ocsp_response.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ocsp_response.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/ocsp_response/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.ocsp_response/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ocsp_response-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.ocsp_response.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ocsp_response-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.ocsp_response.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ocsp_response-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.ocsp_response.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ocsp_response",
            "x-ves-object-type": "ves.io.schema.ocsp_response.Object",
            "x-ves-proto-service": "ves.io.schema.ocsp_response.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.ocsp_response/Objects": {
            "get": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ocsp_response-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.ocsp_response.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ocsp_response-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.ocsp_response.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ocsp_response",
            "x-ves-object-type": "ves.io.schema.ocsp_response.Object",
        ...
        "/ves.io.schema.ocsp_response/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ocsp_response-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.ocsp_response.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ocsp_response",
            "x-ves-object-type": "ves.io.schema.ocsp_response.Object",
        ...
        "/ves.io.schema.ocsp_response/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ocsp_response/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ocsp_response/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.ocsp_response/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.ocsp_response.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/ocsp_responseSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ocsp_responsecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ocsp_responsecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ocsp_responseStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ocsp_responsecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ocsp_responsecrudapiErrorCode"
                },
        ...
        "ocsp_responseGlobalSpecType": {
            "type": "object",
            "description": "OCSP Response contains certificate status response (whether certificate is still valid) for certificate used for a virtual_host/advertise_policy.",
            "title": "OCSP Response Object",
            "x-displayname": "OCSP Response",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.GlobalSpecType",
            "properties": {
                "advertise_policies": {
                    "type": "array",
                    "description": " List of advertise policies using certificate for which this OCSP Reponse is valid",
                    "title": "Advertise Policies",
                    "items": {
                ...
                "certificate_url": {
                    "type": "string",
                    "description": " TLS Certificate URL",
                    "title": "Certificate URL",
                    "x-displayname": "Certificate URL"
                },
                "certificates": {
                    "type": "array",
                    "description": " List of certificates that can be used for a virtual_host/advertise_policy.",
                    "title": "Certificates",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "ocsp_response_base64": {
                    "type": "string",
                    "description": " OCSP Response contains certificate status response",
                    "title": "OCSP Response",
                    "x-displayname": "OCSP Response"
                },
                "ocsp_response_sha1_base64": {
                    "type": "string",
                    "description": " OCSP Response contains certificate status response with sha1 as IssuerHash method",
                    "title": "OCSP Response SHA1",
                    "x-displayname": "OCSP Response with sha1 HashAlgorithm"
                },
                "ocsp_response_sha256_base64": {
                    "type": "string",
                    "description": " OCSP Response contains certificate status response with sha256 as IssuerHash method",
                    "title": "OCSP Response SHA256",
                    "x-displayname": "OCSP Response with sha256 HashAlgorithm"
                },
                "virtual_hosts": {
                    "type": "array",
                    "description": " List of virtual hosts using certificate for which this OCSP Reponse is valid",
                    "title": "Virtual Hosts",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
        ...
        "ocsp_responseSpecType": {
            "type": "object",
            "description": "Shape of ocsp response object",
            "title": "Specification OCSP Response",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.SpecType",
            "properties": {
                "gc_spec": {
                    "description": " Specification of the ocsp response",
                    "title": "gc_spec",
                    "$ref": "#/definitions/ocsp_responseGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "ocsp_responseStatusObject": {
            "type": "object",
            "description": "Most recent observed status of the object",
            "title": "Status of OCSP Response object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.ocsp_response.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "ocsp_responsecrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.ocsp_response.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/ocsp_response/crudapi/api.proto"
}`
