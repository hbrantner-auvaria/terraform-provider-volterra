...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/addon_services/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/addon_services", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.pbac.addon_service.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.pbac.addon_service")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.pbac.addon_service.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.pbac.addon_service.API.List")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.pbac.addon_service.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.pbac.addon_service.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.addon_service.API.Get"); rvFn != nil {
	...
	rspMsgFQN := "ves.io.schema.pbac.addon_service.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.addon_service.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.pbac.addon_service.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{namespace}/addon_services": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/addon_serviceListResponse"
                        }
                    },
                    "401": {
            ...
            "x-ves-proto-service": "ves.io.schema.pbac.addon_service.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/addon_services/{name}": {
            "get": {
                "summary": "Get Addon Service",
                "description": "Get addon_service reads a given object from storage backend for metadata.namespace.",
                "operationId": "ves.io.schema.pbac.addon_service.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/addon_serviceGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
    ...
    "definitions": {
        ...
        "addon_serviceGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read addon_service",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.GetResponse",
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the addon_service",
                    "title": "spec",
                    "$ref": "#/definitions/pbacaddon_serviceGetSpecType",
                    "x-displayname": "Spec"
                },
                "status": {
                    "type": "array",
        ...
        "addon_serviceGetResponseFormatCode": {
            "type": "string",
        ...
        "addon_serviceListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of addon_service",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/addon_serviceListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "addon_serviceListResponseItem": {
            "type": "object",
            "description": "By default a summary of addon_service is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of addon_service",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates addon_service is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this addon_service\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this addon_service\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "pbacaddon_serviceGetSpecType": {
            "type": "object",
            "description": "Get addon_service reads a given object from storage backend for metadata.namespace.",
            "title": "Get addon service",
            "x-displayname": "Get Addon Service",
            "x-ves-displayorder": "1,3,4,5,6,8,9",
            "x-ves-oneof-field-activation_type_choice": "[\"managed_activation\",\"partially_managed_activation\",\"self_activation\"]",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.GetSpecType",
            "properties": {
                "api_groups": {
                    "type": "array",
                ...
                "dependent_services": {
                    ...
                    "title": "repeated ves.io.schema.ObjectRefType policy = 7 [(ves.io.schema.ref_to) = \"service_policy\"];",
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
    ...
    "x-displayname": "Addon Service",
    "x-ves-proto-file": "ves.io/schema/pbac/addon_service/public_crudapi.proto"
}`
