...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/pbac/addon_service"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.pbac.addon_service.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.pbac.addon_service.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.pbac.addon_service.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.pbac.addon_service.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.pbac.addon_service.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.pbac.addon_service.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.pbac.addon_service.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.pbac.addon_service.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.pbac.addon_service.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.pbac.addon_service.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.addon_service.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.pbac.addon_service.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.addon_service.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.pbac.addon_service.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.addon_service.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.addon_service.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.pbac.addon_service.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.pbac.addon_service.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/pbac/addon_service/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.pbac.addon_service/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-pbac-addon_service-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.addon_service.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-pbac-addon_service-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.addon_service.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-pbac-addon_service-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.addon_service.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "addon_service",
            "x-ves-object-type": "ves.io.schema.pbac.addon_service.Object",
            "x-ves-proto-service": "ves.io.schema.pbac.addon_service.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.pbac.addon_service/Objects": {
            "get": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-pbac-addon_service-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.addon_service.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-pbac-addon_service-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.addon_service.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "addon_service",
            "x-ves-object-type": "ves.io.schema.pbac.addon_service.Object",
        ...
        "/ves.io.schema.pbac.addon_service/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-pbac-addon_service-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.pbac.addon_service.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "addon_service",
            "x-ves-object-type": "ves.io.schema.pbac.addon_service.Object",
        ...
        "/ves.io.schema.pbac.addon_service/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.pbac.addon_service/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.pbac.addon_service/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.pbac.addon_service/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.pbac.addon_service.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "addon_serviceSpecType": {
            "type": "object",
            "description": "Shape of the addon_service specification",
            "title": "Specification for Addon Service",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/pbacaddon_serviceGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "addon_serviceStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for Addon Service",
            "x-displayname": "Addon Service",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "addon_servicecrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.pbac.addon_service.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/addon_serviceSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/addon_servicecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/addon_servicecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/addon_serviceStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/addon_servicecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/addon_servicecrudapiErrorCode"
                },
        ...
        "pbacaddon_serviceGlobalSpecType": {
            "type": "object",
            "description": "Shape of addon_service in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-oneof-field-activation_type_choice": "[\"managed_activation\",\"partially_managed_activation\",\"self_activation\"]",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.GlobalSpecType",
            "properties": {
                "api_groups": {
                    "type": "array",
                    "description": " List of references to all api_group objects that belong to this addon service.\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 32\n",
                    "title": "api_groups",
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                ...
                "dependent_services": {
                    "type": "array",
                    "description": " List of addon services this service dependent on.\n To subscribe/enable this service, all of dependent service should be enabled.\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "dependent_services",
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "display_name": {
                    "type": "string",
                    "description": " User friendly name for display purpose.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 512\n",
                    "title": "display_name",
                    "maxLength": 512,
                ...
                "included_services": {
                    "type": "array",
                    "description": " List of additional addon services automatically subscribed part of this subscription.\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.unique: true\n",
                ...
                "inheritable": {
                    "type": "boolean",
                    "description": " This flag is useful in the scenario of a operator tenant. If the operator tenant is subscribed to this addon then this addons comes on the active addon list even when the managed tenant\n is not subscribed to it (provided that the operator tenant is subscribed to it). This way the operator tenant can access services the managed tenant is not subscribed to.",
                    "title": "inheritable",
                    "format": "boolean",
                ...
                "restricted": {
                    "type": "boolean",
                    "description": " If true, that addon is not advertised for subscription if not already subscribed. Subscription to such addon has to happen via manual intervention.\n Such add-ons are mostly not meant for general audience.",
                    "title": "restricted",
                    "format": "boolean",
                    "x-displayname": "Restricted"
                },
                "self_activation": {
                    "description": "Exclusive with [managed_activation partially_managed_activation]\n Self Service Activation. No manual action required.",
                    "title": "self_activation",
                    "$ref": "#/definitions/addon_serviceSelfActivationType",
                    "x-displayname": "Self Activation"
                },
                "service_usage_type": {
                    "description": " ServiceUsageType represents the usage type information for the service\n\nExample: - \"{tierADVANCED,billing_doc_link: \u003curl\u003e,usage_types: {F5-V-O-ADN-MSH-PBVIP: {name: Anycast Public Virtual IP, unit: hour}F5-V-O-ADN-MSH-RLIM: {name: Rate Limiting enabled on App Connect Load balancers on Regional Edge (good requests to origin), unit: requests}}}\"-",
                    "title": "Service Usage Type",
                    "$ref": "#/definitions/pbacaddon_serviceServiceUsageType",
                    "x-displayname": "Service Usage Type",
                    "x-ves-example": "{tier: ADVANCED,billing_doc_link: \u003curl\u003e,usage_types: {F5-V-O-ADN-MSH-PBVIP: {name: Anycast Public Virtual IP, unit: hour}F5-V-O-ADN-MSH-RLIM: {name: Rate Limiting enabled on App Connect Load balancers on Regional Edge (good requests to origin), unit: requests}}}"
                },
                "tags": {
                    "type": "array",
                    "description": " Feature tag can flag an addon service as a feature (preview, new, beta, etc) and their combination",
                    "title": "Feature tag\nx-displayName: \"Feature tag\"\nFeature tag can flag an addon service as a feature (preview, new, beta, etc) and their combination",
                    "items": {
                        "$ref": "#/definitions/schemaFeatureTag"
                    },
                    "x-displayname": "Feature tag"
                },
                "tier": {
        ...
        "pbacaddon_serviceServiceUsageType": {
            "type": "object",
            "description": "x-example: \"{billing_doc_link: \u003curl\u003e,usage_types: {F5-V-O-ADN-MSH-PBVIP: {name: Anycast Public Virtual IP, unit: hour}F5-V-O-ADN-MSH-RLIM: {name: Rate Limiting enabled on App Connect Load balancers on Regional Edge (good requests to origin), unit: requests}}}\"\nServiceUsageType object",
            "title": "Service Usage Type",
            "x-displayname": "Service Usage Type",
            "x-ves-proto-message": "ves.io.schema.pbac.addon_service.ServiceUsageType",
            "properties": {
                "billing_doc_link": {
                    "type": "string",
                    "description": " BillingDocLink for the UsageType\n\nExample: - \"\u003cbilling_doc_url\u003e\"-",
                    "title": "Billing Doc Link",
                    "x-displayname": "Billing Doc Link",
                    "x-ves-example": "\u003cbilling_doc_url\u003e"
                },
                "usage_types": {
                    "type": "object",
                    "description": " Map of SKU ID and UsageType\n\nExample: - \"{F5-V-O-ADN-MSH-PBVIP{name: Anycast Public Virtual IP, unit: hour},F5-V-O-ADN-MSH-RLIM: {name: Rate Limiting enabled on App Connect Load balancers on Regional Edge (good requests to origin), unit: requests}}-\n\nValidation Rules:\n  ves.io.schema.rules.map.keys.string.pattern: ^[A-Z](?:[A-Z0-9]*-)?[A-Z0-9]+(?:-[A-Z0-9]+)*$\n",
                    "title": "Usage Types",
    ...
    "x-ves-proto-file": "ves.io/schema/pbac/addon_service/crudapi/api.proto"
}`
