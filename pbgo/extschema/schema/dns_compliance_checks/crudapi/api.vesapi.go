...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/dns_compliance_checks"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.dns_compliance_checks.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.dns_compliance_checks.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.dns_compliance_checks.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.dns_compliance_checks.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.dns_compliance_checks.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_compliance_checks.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_compliance_checks.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_compliance_checks.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/dns_compliance_checks/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.dns_compliance_checks/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_compliance_checks-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_compliance_checks.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_compliance_checks-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_compliance_checks.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_compliance_checks-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_compliance_checks.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_compliance_checks",
            "x-ves-object-type": "ves.io.schema.dns_compliance_checks.Object",
            "x-ves-proto-service": "ves.io.schema.dns_compliance_checks.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.dns_compliance_checks/Objects": {
            "get": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_compliance_checks-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_compliance_checks.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_compliance_checks-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_compliance_checks.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_compliance_checks",
            "x-ves-object-type": "ves.io.schema.dns_compliance_checks.Object",
        ...
        "/ves.io.schema.dns_compliance_checks/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_compliance_checks-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_compliance_checks.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_compliance_checks",
            "x-ves-object-type": "ves.io.schema.dns_compliance_checks.Object",
        ...
        "/ves.io.schema.dns_compliance_checks/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_compliance_checks/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_compliance_checks/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_compliance_checks/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.dns_compliance_checks.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/dns_compliance_checksSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_compliance_checkscrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_compliance_checkscrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_compliance_checkscrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_compliance_checkscrudapiErrorCode"
                },
        ...
        "dns_compliance_checksGlobalSpecType": {
            "type": "object",
            "description": "Desired state of DNS Compliance Checks Specification",
            "title": "GlobalSpecType",
            "x-displayname": "View Specification",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.GlobalSpecType",
            "properties": {
                "disallowed_query_type_list": {
                    "type": "array",
                    "description": " Disallowed Query Type Values\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 8\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Disallowed Query Type Values",
                    "maxItems": 8,
                    "items": {
                ...
                "disallowed_resource_record_type_list": {
                    ...
                    "title": "Disallowed Resource Record Types",
                    "maxItems": 8,
                    "items": {
        ...
        "dns_compliance_checksSpecType": {
            "type": "object",
            "description": "DNS Compliance Checks specification",
            "title": "DNS Compliance Checks specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/dns_compliance_checksGlobalSpecType",
        ...
        "dns_compliance_checkscrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.dns_compliance_checks.crudapi.ErrorCode"
        },
    ...
    "x-ves-proto-file": "ves.io/schema/dns_compliance_checks/crudapi/api.proto"
}`
