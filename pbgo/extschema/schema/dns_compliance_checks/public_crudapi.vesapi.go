...
const (
	...
	CreateRequestFQN = "ves.io.schema.dns_compliance_checks.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.dns_compliance_checks.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.dns_compliance_checks.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.dns_compliance_checks.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.dns_compliance_checks.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.dns_compliance_checks.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.dns_compliance_checks.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.dns_compliance_checks.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.dns_compliance_checks.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.dns_compliance_checks.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_compliance_checkss", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_compliance_checkss/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_compliance_checkss/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_compliance_checkss", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_compliance_checkss/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.dns_compliance_checks.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.dns_compliance_checks")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_compliance_checks.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.dns_compliance_checks.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.dns_compliance_checks.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_compliance_checks.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.dns_compliance_checks.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.dns_compliance_checks.API.Create' operation on 'dns_compliance_checks'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.dns_compliance_checks.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.dns_compliance_checks.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_compliance_checks.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.dns_compliance_checks.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.dns_compliance_checks.API.Replace' operation on 'dns_compliance_checks'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.dns_compliance_checks.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.dns_compliance_checks.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_compliance_checks.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_compliance_checks.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.dns_compliance_checks.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.dns_compliance_checks.API.Delete' operation on 'dns_compliance_checks'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.dns_compliance_checks.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/dns_compliance_checkss": {
            "post": {
                "summary": "Create DNS Compliance Checks",
                "description": "Create DNS Compliance Checks Specification in a given namespace. If one already exists it will give an error.",
                "operationId": "ves.io.schema.dns_compliance_checks.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_compliance_checksCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_compliance_checksCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.dns_compliance_checks.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/dns_compliance_checkss/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_compliance_checksReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_compliance_checksReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/dns_compliance_checkss": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_compliance_checksListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/dns_compliance_checkss/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_compliance_checksGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_compliance_checksDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "dns_compliance_checksCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of dns_compliance_checks",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Compliance Checks",
                    "title": "spec",
                    "$ref": "#/definitions/dns_compliance_checksCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "dns_compliance_checksCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Compliance Checks",
                    "title": "spec",
                    "$ref": "#/definitions/dns_compliance_checksGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "dns_compliance_checksCreateSpecType": {
            "type": "object",
            "description": "Create DNS Compliance Checks Specification in a given namespace. If one already exists it will give an error.",
            "title": "Create DNS Compliance Checks",
            "x-displayname": "Create DNS Compliance Checks",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.CreateSpecType",
            "properties": {
                "disallowed_query_type_list": {
                    "type": "array",
                    "description": " Disallowed Query Type Values\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 8\n  ves.io.schema.rules.repeated.unique: true\n",
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/dns_compliance_checksDisallowedQueryType"
                    },
                ...
                "disallowed_resource_record_type_list": {
                    "type": "array",
                    "description": " Disallowed Resource Record Type List\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 8\n  ves.io.schema.rules.repeated.unique: true\n",
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/dns_compliance_checksDisallowedResourceRecordType"
                    },
        ...
        "dns_compliance_checksDNSComplianceChecksDeploymentStatus": {
            "type": "string",
            "description": "Deployment Status of DNS Compliance Checks\n\nDNS Compliance Checks is successfully deployed and active\nDeployment of DNS Compliance Checks is pending\nDNS Compliance Checks has been disabled.\nDNS Compliance Checks deployment encountered an error.",
            "title": "DNS Compliance Checks Deployment Status",
            "enum": [
                "dns_compliance_checks_CONFIG_ACTIVE",
                "dns_compliance_checks_CONFIG_PENDING",
                "dns_compliance_checks_CONFIG_DISABLED",
                "dns_compliance_checks_CONFIG_FAILED"
            ],
            "default": "dns_compliance_checks_CONFIG_ACTIVE",
            "x-displayname": "DNS Compliance Checks Deployment Status",
            "x-ves-proto-enum": "ves.io.schema.dns_compliance_checks.DNSComplianceChecksDeploymentStatus"
        },
        "dns_compliance_checksDNSComplianceChecksStatus": {
            "type": "object",
            "description": "Status DNS Compliance Checks",
            "title": "DNS Compliance Checks Status",
            "x-displayname": "DNS Compliance Checks Status",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.DNSComplianceChecksStatus",
            "properties": {
                "deployment_status": {
                    "description": " Status of DNS Compliance Checks Deployment",
                    "title": "DNS Compliance Checks Deployment Status",
                    "$ref": "#/definitions/dns_compliance_checksDNSComplianceChecksDeploymentStatus",
                    "x-displayname": "DNS Compliance Checks Deployment Status"
                }
            }
        },
        "dns_compliance_checksDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a dns_compliance_checks",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "dns_compliance_checksDisallowedQueryType": {
            "type": "string",
            "description": "Disallowed Query Type\n\n - QUERY: QUERY\n\n - IQUERY: IQUERY\n\n - STATUS: STATUS\n\n - NOTIFY: NOTIFY\n\n - UPDATE: UPDATE\n",
            "title": "Disallowed Query Type",
            "enum": [
                "QUERY",
                "IQUERY",
                "STATUS",
            ...
            "x-ves-proto-enum": "ves.io.schema.dns_compliance_checks.DisallowedQueryType"
        },
        "dns_compliance_checksDisallowedResourceRecordType": {
            "type": "string",
            "description": "Disallowed Resource Record\n\n - T: T\n\n - A: A\n\n - NS: NS\n\n - MD: MD\n\n - MF: MF\n\n - CNAME: CNAME\n\n - SOA: SOA\n\n - MB: MB\n\n - MG: MG\n\n - MR: MR\n\n - NULL: NULL\n\n - WKS: WKS\n\n - PTR: PTR\n\n - HINFO: HINFO\n\n - MINFO: MINFO\n\n - MX: MX\n\n - TXT: TXT\n\n - RP: RP\n\n - AFSDB: AFSDB\n\n - X25: X25\n\n - ISDN: ISDN\n\n - RT: RT\n\n - NSAP: NSAP\n\n - NSAP_PTR: NSAP-PTR\n\n - SIG: SIG\n\n - KEY: KEY\n\n - PX: PX\n\n - GPOS: GPOS\n\n - AAAA: AAAA\n\n - LOC: LOC\n\n - NXT: NXT\n\n - EID: EID\n\n - NIMLOC: NIMLOC\n\n - SRV: SRV\n\n - ATMA: ATMA\n\n - NAPTR: NAPTR\n\n - KX: KX\n\n - CERT: CERT\n\n - A6: A6\n\n - DNAME: DNAME\n\n - SINK: SINK\n\n - OPT: OPT\n\n - APL: APL\n\n - DS: DS\n\n - SSHFP: SSHFP\n\n - IPSECKEY: IPSECKEY\n\n - RRSIG: RRSIG\n\n - NSEC: NSEC\n\n - DNSKEY: DNSKEY\n\n - DHCID: DHCID\n\n - NSEC3: NSEC3\n\n - NSEC3PARAM: NSEC3PARAM\n\n - TLSA: TLSA\n\n - SMIMEA: SMIMEA\n\n - HIP: HIP\n\n - NINFO: NINFO\n\n - RKEY: RKEY\n\n - TALINK: TALINK\n\n - CDS: CDS\n\n - CDNSKEY: CDNSKEY\n\n - OPENPGPKEY: OPENPGPKEY\n\n - CSYNC: CSYNC\n\n - SPF: SPF\n\n - UINFO: UINFO\n\n - UID: UID\n\n - GID: GID\n\n - UNSPEC: UNSPEC\n\n - NID: NID\n\n - L32: L32\n\n - L64: L64\n\n - LP: LP\n\n - EUI48: EUI48\n\n - EUI64: EUI64\n\n - TKEY: TKEY\n\n - TSIG: TSIG\n\n - IXFR: IXFR\n\n - AXFR: AXFR\n\n - MAILB: MAILB\n\n - MAILA: MAILA\n\n - URI: URI\n\n - CAA: CAA\n\n - TA: TA\n\n - DLV: DLV\n",
            "title": "DisallowedResourceRecord",
            "enum": [
                "T",
                "A",
                "NS",
            ...
            "x-ves-proto-enum": "ves.io.schema.dns_compliance_checks.DisallowedResourceRecordType"
        },
        "dns_compliance_checksGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read dns_compliance_checks",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/dns_compliance_checksStatusObject"
                    },
        ...
        "dns_compliance_checksGetResponseFormatCode": {
            "type": "string",
        ...
        "dns_compliance_checksGetSpecType": {
            "type": "object",
            "description": "Get DNS Compliance Checks details.",
            "title": "Get DNS Compliance Checks",
            "x-displayname": "Get DNS Compliance Checks ",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.GetSpecType",
            "properties": {
                "disallowed_query_type_list": {
                    "type": "array",
                    "description": " Disallowed Query Type Values\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 8\n  ves.io.schema.rules.repeated.unique: true\n",
                ...
                "protocol_inspection": {
                    "type": "array",
                    "description": " A list of protocol inspection configs using dns compliance checks",
                    "items": {
        ...
        "dns_compliance_checksListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of dns_compliance_checks",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/dns_compliance_checksListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "dns_compliance_checksListResponseItem": {
            "type": "object",
            "description": "By default a summary of dns_compliance_checks is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of dns_compliance_checks",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this dns_compliance_checks",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this dns_compliance_checks",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates dns_compliance_checks is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this dns_compliance_checks",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this dns_compliance_checks\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this dns_compliance_checks\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "dns_compliance_checksReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a dns_compliance_checks",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Compliance Checks",
                    "title": "spec",
                    "$ref": "#/definitions/dns_compliance_checksReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "dns_compliance_checksReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.ReplaceResponse"
        },
        "dns_compliance_checksReplaceSpecType": {
            "type": "object",
            "description": "Replace DNS Compliance Checks specification in a given namespace.",
            "title": "Replace DNS Compliance Checks",
            "x-displayname": "Replace DNS Compliance Checks ",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.ReplaceSpecType",
            "properties": {
                "disallowed_query_type_list": {
                    "type": "array",
                    "description": " Disallowed Query Type Values\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 8\n  ves.io.schema.rules.repeated.unique: true\n",
        ...
        "dns_compliance_checksStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of DNS Compliance Checks",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.dns_compliance_checks.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "verification_status": {
                    "description": " Verification Status of the DNS Compliance Checks",
                    "title": "Verification Status",
                    "$ref": "#/definitions/dns_compliance_checksDNSComplianceChecksStatus",
    ...
    "x-displayname": "Configure DNS Compliance Checks",
    "x-ves-proto-file": "ves.io/schema/dns_compliance_checks/public_crudapi.proto"
}`
