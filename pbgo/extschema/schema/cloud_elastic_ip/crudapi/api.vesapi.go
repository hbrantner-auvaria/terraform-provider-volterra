...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/cloud_elastic_ip"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.cloud_elastic_ip.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.cloud_elastic_ip.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.cloud_elastic_ip.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_elastic_ip.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.cloud_elastic_ip.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.cloud_elastic_ip.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_elastic_ip.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_elastic_ip.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_elastic_ip.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_elastic_ip.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/cloud_elastic_ip/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.cloud_elastic_ip/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_elastic_ip-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_elastic_ip.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_elastic_ip-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_elastic_ip.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_elastic_ip-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_elastic_ip.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cloud_elastic_ip",
            "x-ves-object-type": "ves.io.schema.cloud_elastic_ip.Object",
            "x-ves-proto-service": "ves.io.schema.cloud_elastic_ip.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.cloud_elastic_ip/Objects": {
            "get": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_elastic_ip-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_elastic_ip.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_elastic_ip-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_elastic_ip.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cloud_elastic_ip",
            "x-ves-object-type": "ves.io.schema.cloud_elastic_ip.Object",
        ...
        "/ves.io.schema.cloud_elastic_ip/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_elastic_ip-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_elastic_ip.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cloud_elastic_ip",
            "x-ves-object-type": "ves.io.schema.cloud_elastic_ip.Object",
        ...
        "/ves.io.schema.cloud_elastic_ip/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_elastic_ip/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_elastic_ip/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_elastic_ip/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.cloud_elastic_ip.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "cloud_elastic_ipElasticIPInfoType": {
            "type": "object",
            "description": "Includes deployment info",
            "title": "Elastic IP Info type",
            "x-displayname": "Elastic IP Status",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.ElasticIPInfoType",
            "properties": {
                "id": {
                    "type": "string",
        ...
        "cloud_elastic_ipElasticIPStatusType": {
            "type": "object",
            "description": "Includes deployment info",
            "title": "Elastic IP Status",
            "x-displayname": "Elastic IP Status ",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.ElasticIPStatusType",
            "properties": {
                "elactic_ip_infos": {
                    "type": "array",
                    "description": " Elastic IP infos",
                    "title": "Elastic IP infos",
                    "items": {
                        "$ref": "#/definitions/cloud_elastic_ipElasticIPInfoType"
                    },
                    "x-displayname": "Elastic IP infos"
                },
                "name": {
                    "type": "string",
                    "description": " VER node name\n\nExample: - \"master-0\"-",
                    "title": "node name",
        ...
        "cloud_elastic_ipGlobalSpecType": {
            "type": "object",
            "description": "Configuration specification for Cloud Elastic IP",
            "title": "GlobalSpecType",
            "x-displayname": "Global Configuration Specification",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.GlobalSpecType",
            "properties": {
                "count": {
                    "type": "integer",
                    "description": " number of Elastic Ips / Public Ips associated with this object per Node\n\nExample: - \"3\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 8\n",
                    "title": "count",
                    "format": "int64",
                ...
                "site_ref": {
                    "type": "array",
                    "description": " Site to which this cloud elastic ip object is attached\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 1\n",
        ...
        "cloud_elastic_ipSpecType": {
            "type": "object",
            "description": "Shape of the cloud elastic specification",
            "title": "Specification for Cloud Elastic IP",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/cloud_elastic_ipGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "cloud_elastic_ipStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for Cloud Elastic IP",
            "x-displayname": "Cloud Elastic IP",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "elastic_ip_status_type": {
                    "type": "array",
                    "description": " Elastic IP Status",
                    "title": "Elastic IP Status",
                    "items": {
                        "$ref": "#/definitions/cloud_elastic_ipElasticIPStatusType"
                    },
                    "x-displayname": "Elastic IP Status"
                },
                "metadata": {
        ...
        "cloud_elastic_ipcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.cloud_elastic_ip.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/cloud_elastic_ipSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cloud_elastic_ipcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cloud_elastic_ipcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/cloud_elastic_ipStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cloud_elastic_ipcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_elastic_ip.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cloud_elastic_ipcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/cloud_elastic_ip/crudapi/api.proto"
}`
