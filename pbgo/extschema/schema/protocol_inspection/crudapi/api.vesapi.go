...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/protocol_inspection"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.protocol_inspection.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.protocol_inspection.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.protocol_inspection.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_inspection.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_inspection.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_inspection.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_inspection.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_inspection.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.protocol_inspection.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.protocol_inspection.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_inspection.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.protocol_inspection.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_inspection.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.protocol_inspection.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_inspection.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_inspection.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_inspection.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.protocol_inspection.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/protocol_inspection/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.protocol_inspection/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_inspection-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_inspection.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_inspection-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_inspection.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_inspection-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_inspection.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "protocol_inspection",
            "x-ves-object-type": "ves.io.schema.protocol_inspection.Object",
            "x-ves-proto-service": "ves.io.schema.protocol_inspection.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.protocol_inspection/Objects": {
            "get": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_inspection-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_inspection.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_inspection-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_inspection.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "protocol_inspection",
            "x-ves-object-type": "ves.io.schema.protocol_inspection.Object",
        ...
        "/ves.io.schema.protocol_inspection/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_inspection-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_inspection.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "protocol_inspection",
            "x-ves-object-type": "ves.io.schema.protocol_inspection.Object",
        ...
        "/ves.io.schema.protocol_inspection/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.protocol_inspection/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.protocol_inspection/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.protocol_inspection/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.protocol_inspection.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/protocol_inspectionSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protocol_inspectioncrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protocol_inspectioncrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/protocol_inspectionStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protocol_inspectioncrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protocol_inspectioncrudapiErrorCode"
                },
        ...
        "protocol_inspectionEnableDisableComplianceChecks": {
            ...
            "properties": {
                "disable_compliance_checks": {
                    "description": "Exclusive with [enable_compliance_checks]\n",
                    "title": "Disable Compliance Check",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Disable"
                },
                "enable_compliance_checks": {
                    "description": "Exclusive with [disable_compliance_checks]\n Enabling compliance checks and selecting a type by default (right now this enables dns_compliance_checks)",
        ...
        "protocol_inspectionEnableDisableSignatures": {
            ...
            "properties": {
                "disable_signature": {
                    "description": "Exclusive with [enable_signature]\n",
                    "title": "Disable Signature",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Disable"
                },
                "enable_signature": {
                    "description": "Exclusive with [disable_signature]\n",
        ...
        "protocol_inspectionGlobalSpecType": {
            "type": "object",
            "description": "Desired state of Protocol Inspection specification",
            "title": "GlobalSpecType",
            "x-displayname": "View Specification",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.GlobalSpecType",
            "properties": {
                "action": {
                    "description": " Action to take based on inspection",
                    "title": "Action",
                    "$ref": "#/definitions/schemaprotocol_inspectionAction",
                    "x-displayname": "Action"
                },
                "dns_proxies": {
                    "type": "array",
                    "description": " The DNS proxy associated with Protocol Inspection\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 32\n",
                    "title": "backref_obj",
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/schemaviewsObjectRefType"
                ...
                "enable_disable_compliance_checks": {
                    ...
                    "title": "Enable/Disable Compliance Checks",
                    "$ref": "#/definitions/protocol_inspectionEnableDisableComplianceChecks",
                    "x-displayname": "Enable/Disable Compliance Checks",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "enable_disable_signatures": {
                    "description": " Confirmation of applying IPS\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "enable_disable_signatures",
                    "$ref": "#/definitions/protocol_inspectionEnableDisableSignatures",
        ...
        "protocol_inspectionProtocolInspectionStatus": {
            ...
            "properties": {
                "deployment_status": {
                    "description": " Status of Protocol Inspection Deployment",
                    "title": "Protocol Inspection Deployment Status",
                    "$ref": "#/definitions/protocol_inspectionProtocolInspectionDeploymentStatus",
                    "x-displayname": "Protocol Inspection Deployment Status"
                }
            }
        },
        "protocol_inspectionSpecType": {
            "type": "object",
            "description": "Protocol Inspection specification",
            "title": "Protocol Inspection specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.protocol_inspection.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/protocol_inspectionGlobalSpecType",
        ...
        "protocol_inspectionStatusObject": {
            ...
            "properties": {
                ...
                "verification_status": {
                    "description": " Verification Status of the PROTOCOL INSPECTION",
                    "title": "Verification Status",
                    "$ref": "#/definitions/protocol_inspectionProtocolInspectionStatus",
                    "x-displayname": "Verification Status"
                }
            }
        },
        "protocol_inspectioncrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.protocol_inspection.crudapi.ErrorCode"
        },
        "runtimeStreamError": {
            "type": "object",
            "properties": {
    ...
    "x-ves-proto-file": "ves.io/schema/protocol_inspection/crudapi/api.proto"
}`
