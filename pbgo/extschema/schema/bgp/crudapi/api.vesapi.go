...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/bgp"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.bgp.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.bgp.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.bgp.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/bgp/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.bgp/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.bgp.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.bgp.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.bgp.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bgp",
            "x-ves-object-type": "ves.io.schema.bgp.Object",
            "x-ves-proto-service": "ves.io.schema.bgp.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.bgp/Objects": {
            "get": {
                "operationId": "ves.io.schema.bgp.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.bgp.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bgp",
            "x-ves-object-type": "ves.io.schema.bgp.Object",
        ...
        "/ves.io.schema.bgp/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.bgp.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bgp",
            "x-ves-object-type": "ves.io.schema.bgp.Object",
        ...
        "/ves.io.schema.bgp/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.bgp.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bgp/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.bgp.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bgp/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.bgp.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bgp/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.bgp.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "bgpPeerExternal": {
            ...
            "properties": {
                ...
                "no_authentication": {
                    "description": "Exclusive with [md5_auth_key]\n No Authentication of BGP session",
                    "title": "no_authentication",
                    "$ref": "#/definitions/schemaEmpty",
        ...
        "bgpPeerFamilyParameters": {
            ...
            "properties": {
                ...
                "unicast_ipv4": {
                    "description": "x-displayName: \"Unicast IPv4\"\nIPv4 Unicast.",
                    "title": "unicast_ipv4",
                    "$ref": "#/definitions/bgpUnicastIPv4"
                },
                "unicast_ipv6": {
                    "description": "x-displayName: \"Unicast IPv6\"\nIPv6 Unicast.",
                    "title": "unicast_ipv6",
                    "$ref": "#/definitions/bgpUnicastIPv6"
                }
            }
        ...
        "bgpSpecType": {
            "type": "object",
            "description": "Shape of the bgp specification",
            "title": "BGP specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.bgp.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/bgpGlobalSpecType",
        ...
        "bgpcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.bgp.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/bgpSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "schemaSiteVirtualSiteRefSelector": {
            "type": "object",
            ...
            "title": "SiteVirtualSiteRefSelector",
    ...
    "x-ves-proto-file": "ves.io/schema/bgp/crudapi/api.proto"
}`
