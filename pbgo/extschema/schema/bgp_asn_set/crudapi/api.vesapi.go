...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/bgp_asn_set"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.bgp_asn_set.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.bgp_asn_set.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.bgp_asn_set.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_asn_set.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_asn_set.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_asn_set.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_asn_set.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_asn_set.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.bgp_asn_set.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.bgp_asn_set.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_asn_set.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp_asn_set.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_asn_set.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp_asn_set.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_asn_set.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_asn_set.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_asn_set.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp_asn_set.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/bgp_asn_set/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.bgp_asn_set/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp_asn_set-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp_asn_set.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp_asn_set-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp_asn_set.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp_asn_set-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp_asn_set.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bgp_asn_set",
            "x-ves-object-type": "ves.io.schema.bgp_asn_set.Object",
            "x-ves-proto-service": "ves.io.schema.bgp_asn_set.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.bgp_asn_set/Objects": {
            "get": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp_asn_set-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp_asn_set.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp_asn_set-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp_asn_set.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bgp_asn_set",
            "x-ves-object-type": "ves.io.schema.bgp_asn_set.Object",
        ...
        "/ves.io.schema.bgp_asn_set/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bgp_asn_set-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.bgp_asn_set.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bgp_asn_set",
            "x-ves-object-type": "ves.io.schema.bgp_asn_set.Object",
        ...
        "/ves.io.schema.bgp_asn_set/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bgp_asn_set/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bgp_asn_set/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bgp_asn_set/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.bgp_asn_set.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "bgp_asn_setGlobalSpecType": {
            "type": "object",
            "description": "Shape of bgp_asn_set in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.bgp_asn_set.GlobalSpecType",
            "properties": {
                "as_numbers": {
                    "type": "array",
                    "description": " An unordered set of RFC 6793 defined 4-byte AS numbers that can be used to create whitelists or blacklists for use in network policy or service policy.\n\nExample: - \"[713, 7932, 847325, 4683, 15269, 1000001]\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 256\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "as numbers",
                    "minItems": 1,
                    "maxItems": 256,
                    "items": {
        ...
        "bgp_asn_setSpecType": {
            "type": "object",
            "description": "Desired state for BGP ASN object.",
            "title": "Shape of the bgp_asn_set specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.bgp_asn_set.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/bgp_asn_setGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "bgp_asn_setStatusObject": {
            "type": "object",
            "title": "Most recently observed status of object",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.bgp_asn_set.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "bgp_asn_setcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.bgp_asn_set.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp_asn_set.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/bgp_asn_setSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp_asn_set.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/bgp_asn_setStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp_asn_set.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp_asn_set.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/bgp_asn_set/crudapi/api.proto"
}`
