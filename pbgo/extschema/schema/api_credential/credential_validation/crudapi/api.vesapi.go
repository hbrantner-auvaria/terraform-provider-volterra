...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/api_credential/credential_validation"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.api_credential.credential_validation.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.api_credential.credential_validation.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.api_credential.credential_validation.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_credential.credential_validation.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_credential.credential_validation.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_credential.credential_validation.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_credential.credential_validation.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_credential.credential_validation.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.api_credential.credential_validation.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.api_credential.credential_validation.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_credential.credential_validation.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_credential.credential_validation.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_credential.credential_validation.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_credential.credential_validation.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_credential.credential_validation.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_credential.credential_validation.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_credential.credential_validation.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_credential.credential_validation.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/api_credential/credential_validation/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.api_credential.credential_validation/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_credential-credential_validation-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_credential.credential_validation.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_credential-credential_validation-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_credential.credential_validation.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_credential-credential_validation-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_credential.credential_validation.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "credential_validation",
            "x-ves-object-type": "ves.io.schema.api_credential.credential_validation.Object",
            "x-ves-proto-service": "ves.io.schema.api_credential.credential_validation.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.api_credential.credential_validation/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_credential-credential_validation-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_credential.credential_validation.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_credential-credential_validation-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_credential.credential_validation.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "credential_validation",
            "x-ves-object-type": "ves.io.schema.api_credential.credential_validation.Object",
        ...
        "/ves.io.schema.api_credential.credential_validation/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_credential-credential_validation-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_credential.credential_validation.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "credential_validation",
            "x-ves-object-type": "ves.io.schema.api_credential.credential_validation.Object",
        ...
        "/ves.io.schema.api_credential.credential_validation/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_credential.credential_validation/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_credential.credential_validation/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_credential.credential_validation/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.api_credential.credential_validation.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "api_credentialcredential_validationGlobalSpecType": {
            "type": "object",
            "description": "Shape of credential_validation in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.GlobalSpecType",
            "properties": {
                "cname": {
                    "type": "string",
                ...
                "digest": {
                    "type": "string",
                    "description": " Base64-encoded SHA1 digest of credential",
                    "title": "Digest",
                ...
                "status": {
                    ...
                    "title": "Status",
                    "$ref": "#/definitions/credential_validationStatus",
                    "x-displayname": "Status"
                }
            }
        },
        "credential_validationSpecType": {
            "type": "object",
            "description": "Shape of the credential validation specification",
            "title": "Specification for Credential Validation",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/api_credentialcredential_validationGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "credential_validationStatus": {
            "type": "object",
            "description": "Status of the credential",
            "title": "Status",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.Status",
            "properties": {
                "active": {
                    "type": "boolean",
                ...
                "tenant_id": {
                    "type": "string",
                    "description": " Tenant id for which this credential is issued.",
                    "title": "TenantId",
                ...
                "user_name": {
                    "type": "string",
                    "description": "This contains the username which user logged in with.\n\nExample: - \"User Name\"-",
                    "title": "Username",
        ...
        "credential_validationcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.api_credential.credential_validation.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/credential_validationSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/credential_validationcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/credential_validationcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/credential_validationcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_credential.credential_validation.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/credential_validationcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/api_credential/credential_validation/crudapi/api.proto"
}`
