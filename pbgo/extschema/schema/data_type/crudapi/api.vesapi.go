...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/data_type"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.data_type.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.data_type.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.data_type.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_type.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_type.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_type.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_type.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.data_type.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_type.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.data_type.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_type.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.data_type.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_type.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_type.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.data_type.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.data_type.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/data_type/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.data_type/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.data_type.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_type-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_type.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.data_type.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_type-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_type.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.data_type.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_type-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_type.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "data_type",
            "x-ves-object-type": "ves.io.schema.data_type.Object",
            "x-ves-proto-service": "ves.io.schema.data_type.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.data_type/Objects": {
            "get": {
                "operationId": "ves.io.schema.data_type.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_type-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_type.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.data_type.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_type-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_type.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "data_type",
            "x-ves-object-type": "ves.io.schema.data_type.Object",
        ...
        "/ves.io.schema.data_type/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.data_type.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-data_type-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.data_type.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "data_type",
            "x-ves-object-type": "ves.io.schema.data_type.Object",
        ...
        "/ves.io.schema.data_type/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.data_type.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.data_type/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.data_type.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.data_type/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.data_type.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.data_type/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.data_type.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_type.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/data_typeSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_type.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/data_typecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_type.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/data_typecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_type.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/data_typeStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_type.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/data_typecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_type.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_type.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.data_type.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/data_typecrudapiErrorCode"
                },
        ...
        "data_typeDetectionRule": {
            "type": "object",
            "description": "The detection rule specifies patterns and values to detect data type by.",
            "title": "DetectionRule",
            ...
            "properties": {
                "key_pattern": {
                    ...
                    "title": "key pattern",
                    "$ref": "#/definitions/data_typeRulePatternType",
                ...
                "key_value_pattern": {
                    ...
                    "$ref": "#/definitions/data_typeKeyValuePattern",
        ...
        "data_typeExactValues": {
            "type": "object",
            "description": "List of exact values to match.",
            "title": "ExactValues",
            "x-displayname": "Exact Values",
            "x-ves-proto-message": "ves.io.schema.data_type.ExactValues",
            "properties": {
                "exact_values": {
                    "type": "array",
                    ...
                    "x-displayname": "Exact Values",
                    "x-ves-example": "email, Email, EMAIL",
                    "x-ves-required": "true",
        ...
        "data_typeGlobalSpecType": {
            "type": "object",
            "description": "Shape of data_type in the storage backend.",
            ...
            "properties": {
                ...
                "type": {
                    "description": " Is custom or predefined",
                    "title": "type",
                    "$ref": "#/definitions/data_typeOriginType",
                    "x-displayname": "Type"
                }
            }
        },
        "data_typeKeyValuePattern": {
            "type": "object",
        ...
        "data_typeOriginType": {
            "type": "object",
            "x-ves-oneof-field-type_choice": "[\"custom\",\"predefined\"]",
            "x-ves-proto-message": "ves.io.schema.data_type.OriginType",
            "properties": {
                "custom": {
                    "description": "Exclusive with [predefined]\n",
                    "title": "Custom",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Custom"
                },
                "predefined": {
                    "description": "Exclusive with [custom]\n",
                    "title": "Predefined",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Predefined"
                }
            }
        },
        "data_typeRulePatternType": {
            "type": "object",
            "description": "test",
            "title": "Rule Pattern Type",
            ...
            "properties": {
                ...
                "substring_value": {
                    "type": "string",
                    "description": "Exclusive with [exact_values regex_value]\n Search for values that include this substring\n\nExample: - \"email\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_bytes: 1024\n",
                    "title": "subtstring",
                    "maxLength": 1024,
        ...
        "data_typeSpecType": {
            "type": "object",
            "title": "Shape of the data type specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.data_type.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/data_typeGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "data_typeStatusObject": {
            "type": "object",
            "title": "Most recently observed status of object",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.data_type.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "data_typecrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.data_type.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/data_type/crudapi/api.proto"
}`
