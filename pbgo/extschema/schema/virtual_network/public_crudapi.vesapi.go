...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/virtual_networks", c.baseURL, namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_network.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_network.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_network.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_network.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_network.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.virtual_network.API.Create' operation on 'virtual_network'"
		if retErr == nil {
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.virtual_network.API.Replace' operation on 'virtual_network'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.virtual_network.API.Delete' operation on 'virtual_network'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
var APISwaggerJSON string = `{
    ...
    "definitions": {
        ...
        "virtual_networkSNATPoolSiteType": {
            "type": "object",
            "description": "x-displayName: \"Per Node SNAT pool for a Site\"\nPer node snat pool for a site",
            "title": "Per Node SNAT pool for a Site",
            "properties": {
                "node_snat_pool": {
                    "type": "object",
                    "description": "x-displayName: \"Per Node IPv4 Prefix\"\nx-required\nPer node ip v4 prefix for snat pool",
        ...
        "virtual_networkSegmentNetworkType": {
            "type": "object",
            "description": "x-displayName: \"Segment Network\"",
            "title": "SegmentNetworkType",
            "properties": {
                "internet_enabled": {
                    "type": "boolean",
                    "description": "x-displayName: \"Internet Enabled\"",
                    "title": "internet_enabled",
                    "format": "boolean"
                }
            }
        },
