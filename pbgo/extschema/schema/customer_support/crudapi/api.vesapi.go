...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/customer_support"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.customer_support.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.customer_support.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.customer_support.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.customer_support.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.customer_support.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.customer_support.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.customer_support.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.customer_support.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.customer_support.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.customer_support.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.customer_support.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.customer_support.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.customer_support.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.customer_support.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.customer_support.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.customer_support.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.customer_support.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.customer_support.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/customer_support/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.customer_support/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-customer_support-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.customer_support.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-customer_support-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.customer_support.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-customer_support-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.customer_support.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "customer_support",
            "x-ves-object-type": "ves.io.schema.customer_support.Object",
            "x-ves-proto-service": "ves.io.schema.customer_support.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.customer_support/Objects": {
            "get": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-customer_support-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.customer_support.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-customer_support-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.customer_support.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "customer_support",
            "x-ves-object-type": "ves.io.schema.customer_support.Object",
        ...
        "/ves.io.schema.customer_support/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-customer_support-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.customer_support.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "customer_support",
            "x-ves-object-type": "ves.io.schema.customer_support.Object",
        ...
        "/ves.io.schema.customer_support/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.customer_support/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.customer_support/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.customer_support/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.customer_support.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.customer_support.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/customer_supportSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.customer_support.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/customer_supportcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.customer_support.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/customer_supportcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.customer_support.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.customer_support.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/customer_supportcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.customer_support.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.customer_support.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.customer_support.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/customer_supportcrudapiErrorCode"
                },
        ...
        "customer_supportGlobalSpecType": {
            ...
            "properties": {
                ...
                "case_id": {
                    "type": "string",
                    "description": " ID assigned to this ticket by our support provider (not customer friendly).\n\nExample: - \"500dn000001oj4eAAA\"-",
                    "title": "Case Id",
                    "x-displayname": "Case ID",
                    "x-ves-example": "500dn000001oj4eAAA"
                },
                "category": {
                    "type": "string",
                ...
                "private": {
                    "type": "boolean",
                    "description": " Indicates a private ticket - i.e. a ticket that would be hidden for the user / from the UI",
                    "title": "Private flag",
                    "format": "boolean",
                ...
                "provider_id": {
                    "type": "string",
                    "description": " ProviderId represents a unique UID of the external support provider configuration.",
                    "title": "Provider Id",
        ...
        "customer_supportSpecType": {
            "type": "object",
            "description": "Shape of the customer support specification",
            "title": "Customer support spec",
            "x-displayname": "Customer suppor spec",
            "x-ves-proto-message": "ves.io.schema.customer_support.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/customer_supportGlobalSpecType",
        ...
        "customer_supportcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.customer_support.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/customer_support/crudapi/api.proto"
}`
