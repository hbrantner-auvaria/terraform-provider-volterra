...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	...
	vr["ves.io.schema.customer_support.GetCommentsRequest"] = GetCommentsRequestValidator()
	vr["ves.io.schema.customer_support.GetCommentsResponse"] = GetCommentsResponseValidator()
