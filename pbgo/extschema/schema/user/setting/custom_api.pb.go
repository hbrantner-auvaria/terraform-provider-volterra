...
type SetViewPreferenceRequest struct {
	...
	PersonaPreferences *PersonaPreferences `protobuf:"bytes,1,opt,name=persona_preferences,json=personaPreferences,proto3" json:"persona_preferences,omitempty"` // Deprecated: Do not use.
	// Advanced view
	//
	// x-displayName: "Advanced view"
	// If true then more options are displayed, otherwise a simplified view is displayed
	AdvancedView bool `protobuf:"varint,2,opt,name=advanced_view,json=advancedView,proto3" json:"advanced_view,omitempty"` // Deprecated: Do not use.
	// Advanced fields auto-expand
	//
	...
	WizardAdvancedAutoExpand bool `protobuf:"varint,3,opt,name=wizard_advanced_auto_expand,json=wizardAdvancedAutoExpand,proto3" json:"wizard_advanced_auto_expand,omitempty"`
}
...
func (m *SetViewPreferenceRequest) GetWizardAdvancedAutoExpand() bool {
	if m != nil {
		return m.WizardAdvancedAutoExpand
	}
	return false
}
...
type ViewPreference struct {
	...
	// x-displayName: "Advanced fields auto-expand"
	// If true then all advanced configuration fields are automatically expanded when creating a new object
	WizardAdvancedAutoExpand bool `protobuf:"varint,4,opt,name=wizard_advanced_auto_expand,json=wizardAdvancedAutoExpand,proto3" json:"wizard_advanced_auto_expand,omitempty"`
}
...
func (m *ViewPreference) GetWizardAdvancedAutoExpand() bool {
	if m != nil {
		return m.WizardAdvancedAutoExpand
	}
	return false
...
var fileDescriptor_ec837e6e53ab5524 = []byte{
	...
	,
}
...
func (this *SetViewPreferenceRequest) Equal(that interface{}) bool {
	...
	if this.WizardAdvancedAutoExpand != that1.WizardAdvancedAutoExpand {
		return false
	}
	return true
}
...
func (this *SetViewPreferenceRequest) GoString() string {
	...
	s = append(s, "WizardAdvancedAutoExpand: "+fmt.Sprintf("%#v", this.WizardAdvancedAutoExpand)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *SetViewPreferenceRequest) String() string {
	...
	s := strings.Join([]string{`&SetViewPreferenceRequest{`,
		...
		`WizardAdvancedAutoExpand:` + fmt.Sprintf("%v", this.WizardAdvancedAutoExpand) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SetViewPreferenceRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WizardAdvancedAutoExpand", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WizardAdvancedAutoExpand = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipCustomApi(dAtA[iNdEx:])
			if err != nil {
