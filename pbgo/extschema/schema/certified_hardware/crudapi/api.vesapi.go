...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/certified_hardware"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.certified_hardware.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.certified_hardware.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.certified_hardware.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.certified_hardware.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.certified_hardware.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.certified_hardware.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.certified_hardware.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.certified_hardware.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.certified_hardware.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.certified_hardware.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.certified_hardware.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.certified_hardware.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.certified_hardware.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.certified_hardware.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.certified_hardware.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.certified_hardware.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.certified_hardware.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.certified_hardware.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/certified_hardware/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.certified_hardware/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-certified_hardware-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.certified_hardware.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-certified_hardware-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.certified_hardware.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-certified_hardware-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.certified_hardware.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "certified_hardware",
            "x-ves-object-type": "ves.io.schema.certified_hardware.Object",
            "x-ves-proto-service": "ves.io.schema.certified_hardware.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.certified_hardware/Objects": {
            "get": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-certified_hardware-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.certified_hardware.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-certified_hardware-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.certified_hardware.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "certified_hardware",
            "x-ves-object-type": "ves.io.schema.certified_hardware.Object",
        ...
        "/ves.io.schema.certified_hardware/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-certified_hardware-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.certified_hardware.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "certified_hardware",
            "x-ves-object-type": "ves.io.schema.certified_hardware.Object",
        ...
        "/ves.io.schema.certified_hardware/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.certified_hardware/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.certified_hardware/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.certified_hardware/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.certified_hardware.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "certified_hardwareSpecType": {
            "type": "object",
            "description": "Shape of the certified_hardware specification",
            "title": "Certified Hardware Specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.SpecType",
            "properties": {
                "gc_spec": {
        ...
        "certified_hardwarecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.certified_hardware.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/certified_hardwareSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/certified_hardwarecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/certified_hardwarecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/certified_hardwarecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.certified_hardware.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/certified_hardwarecrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/certified_hardware/crudapi/api.proto"
}`
