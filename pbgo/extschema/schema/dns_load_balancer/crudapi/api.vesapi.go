...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/dns_load_balancer"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.dns_load_balancer.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.dns_load_balancer.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.dns_load_balancer.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.dns_load_balancer.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_load_balancer.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_load_balancer.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_load_balancer.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_load_balancer.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_load_balancer.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_load_balancer.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_load_balancer.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_load_balancer.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/dns_load_balancer/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.dns_load_balancer/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_load_balancer-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_load_balancer.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_load_balancer-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_load_balancer.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_load_balancer-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_load_balancer.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_load_balancer",
            "x-ves-object-type": "ves.io.schema.dns_load_balancer.Object",
            "x-ves-proto-service": "ves.io.schema.dns_load_balancer.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.dns_load_balancer/Objects": {
            "get": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_load_balancer-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_load_balancer.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_load_balancer-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_load_balancer.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_load_balancer",
            "x-ves-object-type": "ves.io.schema.dns_load_balancer.Object",
        ...
        "/ves.io.schema.dns_load_balancer/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_load_balancer-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_load_balancer.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_load_balancer",
            "x-ves-object-type": "ves.io.schema.dns_load_balancer.Object",
        ...
        "/ves.io.schema.dns_load_balancer/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_load_balancer/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_load_balancer/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_load_balancer/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.dns_load_balancer.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_load_balancercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_load_balancercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_load_balancercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_load_balancercrudapiErrorCode"
                },
        ...
        "dns_load_balancerLoadBalancingRule": {
            ...
            "properties": {
                ...
                "pool": {
                    ...
                    "title": "use pool",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Use DNS Load Balancer pool"
                },
                "score": {
                    "type": "integer",
                    "description": " When multiple load balancing rules match a query, the one with the highest score is chosen\n\nExample: - \"50\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 32767\n",
                    "title": "Score",
                    "format": "int64",
                    "x-displayname": "Score",
                    "x-ves-example": "50",
        ...
        "dns_load_balancerLoadBalancingRuleList": {
            "type": "object",
            "description": "List of the Load Balancing Rules",
            "title": "Load Balancing Rule List",
            "x-displayname": "Load Balancing Rule List",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.LoadBalancingRuleList",
            "properties": {
                "rules": {
                    "type": "array",
        ...
        "dns_load_balancerResourceRecordType": {
            ...
            "x-ves-proto-enum": "ves.io.schema.dns_load_balancer.ResourceRecordType"
        },
        "dns_load_balancerResponseCache": {
            "type": "object",
            ...
            "properties": {
                "default_response_cache_parameters": {
                    "description": "Exclusive with [disable response_cache_parameters]\n Default Parameters for caching the DNS responses",
                    "title": "Default Response Cache Parameters",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Default Response Cache Parameters"
                },
                "disable": {
                    "description": "Exclusive with [default_response_cache_parameters response_cache_parameters]\n When Response Cache is disabled, responses will be computed for each request",
                    "title": "Disable Response Cache",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Disable Response Cache"
                },
                "response_cache_parameters": {
                    "description": "Exclusive with [default_response_cache_parameters disable]\n Customize the parameters for Response cache",
                    "title": "Response Cache Parameters",
                    "$ref": "#/definitions/dns_load_balancerResponseCacheParameters",
                    "x-displayname": "Response Cache Parameters"
                }
            }
        },
        "dns_load_balancerResponseCacheParameters": {
            "type": "object",
            "title": "Response Cache Parameters",
            "x-displayname": "Response Cache Parameters",
            "x-ves-proto-message": "ves.io.schema.dns_load_balancer.ResponseCacheParameters",
            "properties": {
                "cache_cidr_ipv4": {
                    "type": "integer",
                    "description": " Length of CIDR masks used to group IPv4 clients\n\nExample: - \"24\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 32\n",
                    "title": "Length of IPv4 CIDR masks",
                    "format": "int64",
                ...
                "cache_cidr_ipv6": {
                    "type": "integer",
                    "description": " Length of CIDR masks used to group IPv6 clients\n\nExample: - \"56\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 128\n",
                    "title": "Length of IPv6 CIDR masks",
                    "format": "int64",
                ...
                "cache_ttl": {
                    "type": "integer",
                    "description": " TTL for response cache\n\nExample: - \"3600\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n",
                    "title": "TTL",
                    "format": "int64",
                    "x-displayname": "TTL",
                    "x-ves-example": "3600",
        ...
        "dns_load_balancercrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.dns_load_balancer.crudapi.ErrorCode"
        },
    ...
    "x-ves-proto-file": "ves.io/schema/dns_load_balancer/crudapi/api.proto"
}`
