...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	...
	vr["ves.io.schema.namespace.BIGIPVirtualServerInventoryFilterType"] = BIGIPVirtualServerInventoryFilterTypeValidator()
	vr["ves.io.schema.namespace.BIGIPVirtualServerInventoryType"] = BIGIPVirtualServerInventoryTypeValidator()
	vr["ves.io.schema.namespace.BIGIPVirtualServerResultType"] = BIGIPVirtualServerResultTypeValidator()
