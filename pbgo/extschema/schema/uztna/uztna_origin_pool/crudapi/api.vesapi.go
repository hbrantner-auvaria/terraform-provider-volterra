...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/uztna/uztna_origin_pool"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.uztna.uztna_origin_pool.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.uztna_origin_pool.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.uztna.uztna_origin_pool.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/uztna/uztna_origin_pool/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.uztna.uztna_origin_pool/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Get",
                "responses": {
                    "200": {
            ...
            "delete": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "put": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "x-displayname": "",
            "x-ves-object-kind": "uztna_origin_pool",
            "x-ves-object-type": "ves.io.schema.uztna.uztna_origin_pool.Object",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.uztna.uztna_origin_pool/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "post": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
        ...
        "/ves.io.schema.uztna.uztna_origin_pool/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.ListStream",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_origin_pool/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_origin_pool/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_origin_pool/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_origin_pool/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.uztna.uztna_origin_pool.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/uztna_origin_poolSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_origin_poolcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_origin_poolcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uztna_origin_poolStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_origin_poolcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_origin_poolcrudapiErrorCode"
                },
        ...
        "uztna_origin_poolOriginServerPrivateIP": {
            "type": "object",
        ...
        "uztna_origin_poolOriginServerPrivateName": {
            "type": "object",
            "description": "x-displayName: \"DNS Name on given Sites\"\nSpecify origin server with private or public DNS name and site information",
        ...
        "uztna_origin_poolOriginServerType": {
            "type": "object",
            "description": "Various options to specify origin server",
            "title": "OriginServerType",
            "x-displayname": "Origin Server",
            "x-ves-oneof-field-choice": "[\"private_ip\"]",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.OriginServerType",
            "properties": {
                "labels": {
                    "type": "object",
                ...
                "private_ip": {
                    ...
                    "title": "OriginServerPrivateIP",
                    "$ref": "#/definitions/uztna_origin_poolOriginServerPrivateIP",
                    "x-displayname": "IP address of Origin Server on given Sites"
                }
            }
        },
        "uztna_origin_poolSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/uztnauztna_origin_poolGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "uztna_origin_poolStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Healthcheck Status",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "uztna_origin_poolcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.uztna.uztna_origin_pool.crudapi.ErrorCode"
        },
        "uztnauztna_origin_poolGlobalSpecType": {
            "type": "object",
            "description": "Shape of the origin pool specification",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.GlobalSpecType",
            "properties": {
                "loadbalancer_algorithm": {
                    ...
                    "$ref": "#/definitions/uztnauztna_origin_poolLoadbalancerAlgorithm",
                ...
                "origin_servers": {
                    ...
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/uztna_origin_poolOriginServerType"
                    },
        ...
        "uztnauztna_origin_poolLoadbalancerAlgorithm": {
            "type": "object",
            "description": "Algorithm the Load Balancer should use to select the upstream endpoint",
            "title": "LoadbalancerAlgorithm",
            "x-displayname": "Load Balancer Algorithm",
            "x-ves-oneof-field-algo_choice": "[\"LEAST_CONNECTIONS\",\"ROUND_ROBIN\"]",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_origin_pool.LoadbalancerAlgorithm",
            "properties": {
                "LEAST_CONNECTIONS": {
                    "description": "Exclusive with [ROUND_ROBIN]\n Policy/Algorithm which loadbalancer picks the upstream endpoint which has the fewest active requests",
                    "title": "LEAST_CONNECTIONS",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Least Connections"
                },
                "ROUND_ROBIN": {
                    "description": "Exclusive with [LEAST_CONNECTIONS]\n Policy/Algorithm which each healthy/available upstream endpoint is selected in round robin order.",
                    "title": "ROUND_ROBIN",
                    "$ref": "#/definitions/schemaEmpty",
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/uztna_origin_pool/crudapi/api.proto"
}`
