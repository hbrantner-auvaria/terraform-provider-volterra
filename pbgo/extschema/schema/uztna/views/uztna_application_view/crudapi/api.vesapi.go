...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/uztna/views/uztna_application_view"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.uztna.views.uztna_application_view.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.views.uztna_application_view.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.uztna.views.uztna_application_view.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.views.uztna_application_view.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/uztna/views/uztna_application_view/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.uztna.views.uztna_application_view/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Get",
                "responses": {
                    "200": {
            ...
            "delete": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "put": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "x-displayname": "",
            "x-ves-object-kind": "uztna_application_view",
            "x-ves-object-type": "ves.io.schema.uztna.views.uztna_application_view.Object",
            "x-ves-proto-service": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.uztna.views.uztna_application_view/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "post": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
        ...
        "/ves.io.schema.uztna.views.uztna_application_view/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.ListStream",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.views.uztna_application_view/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.views.uztna_application_view/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.views.uztna_application_view/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.views.uztna_application_view/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.uztna.views.uztna_application_view.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/uztna_application_viewSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_application_viewcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_application_viewcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uztna_application_viewStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_application_viewcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_application_viewcrudapiErrorCode"
                },
        ...
        "uztna_application_viewApplicationTags": {
            "type": "object",
            "description": "\nUZTNA Application tags are used for managing access to Applications",
            "title": "ApplicationTags",
            "x-displayname": "Tags",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.ApplicationTags",
            "properties": {
                "app_tags": {
                    "type": "array",
        ...
        "uztna_application_viewGlobalSpecType": {
            "type": "object",
            "description": "\nDefines shape of application",
            "title": "GlobalSpecType",
            "x-displayname": "GlobalSpecType",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.GlobalSpecType",
            "properties": {
                "app_tags": {
                    "description": " List of Tags to be associated with the Application\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "ApplicationTags",
                    "$ref": "#/definitions/uztna_application_viewApplicationTags",
                    "x-displayname": "Tags",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "fqdn": {
                    ...
                    "title": "FQDN for the application",
                    "minLength": 1,
                    "maxLength": 256,
                    "x-displayname": "FQDN",
                ...
                "location": {
                    "description": " BIG-IP Next sites to onboard the Application\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Location",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                ...
                "origin": {
                    ...
                    "title": "Origin",
                    "$ref": "#/definitions/uztna_application_viewOrigin",
                ...
                "protocol": {
                    ...
                    "title": "Protocol",
                    "$ref": "#/definitions/uztna_application_viewProtocol",
        ...
        "uztna_application_viewOrigin": {
            "type": "object",
            "description": "\nOrigin Pool for the Application",
            "title": "Origin",
            "x-displayname": "Origin",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.Origin",
            "properties": {
                "origin_pool": {
                    "type": "array",
        ...
        "uztna_application_viewProtocol": {
            "type": "object",
        ...
        "uztna_application_viewSpecType": {
            "type": "object",
            "description": "Actual Shape of the Application",
            "title": "Specification of Application object",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/uztna_application_viewGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "uztna_application_viewStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object\nDisplays status of an object",
            "title": "Status for User object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.uztna.views.uztna_application_view.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "uztna_application_viewcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.uztna.views.uztna_application_view.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/views/uztna_application_view/crudapi/api.proto"
}`
