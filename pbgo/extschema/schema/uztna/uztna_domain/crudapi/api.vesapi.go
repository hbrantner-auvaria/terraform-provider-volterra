...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/uztna/uztna_domain"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.uztna.uztna_domain.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.uztna_domain.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.uztna.uztna_domain.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_domain.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_domain.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_domain.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_domain.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_domain.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/uztna/uztna_domain/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.uztna.uztna_domain/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.Get",
                "responses": {
                    "200": {
            ...
            "delete": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "put": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "x-displayname": "",
            "x-ves-object-kind": "uztna_domain",
            "x-ves-object-type": "ves.io.schema.uztna.uztna_domain.Object",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_domain.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.uztna.uztna_domain/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "post": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
        ...
        "/ves.io.schema.uztna.uztna_domain/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.ListStream",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_domain/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_domain/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_domain/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_domain/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.uztna.uztna_domain.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/uztna_domainSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_domaincrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_domaincrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uztna_domainStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_domaincrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_domaincrudapiErrorCode"
                },
        ...
        "uztna_domainCloudGatewayAdvertisement": {
            "type": "object",
            "description": "\nAdvertise on all Cloud Gateways or some selective",
            "title": "Cloud Gateway Advertisement",
            "x-displayname": "Cloud Gateway Advertisement",
            "x-ves-oneof-field-cloud_gateway_choice": "[\"all_cloud\",\"re_sites\"]",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.CloudGatewayAdvertisement",
            "properties": {
                "all_cloud": {
                ...
                "re_sites": {
                    "description": "Exclusive with [all_cloud]\n\n This option will allow advertise on selected Cloud Gateways",
                    "title": "Specific",
                    "$ref": "#/definitions/uztna_domainCloudGateways",
                    "x-displayname": "Advertise on Selected Cloud Gateways"
                }
            }
        },
        "uztna_domainCloudGateways": {
            "type": "object",
            "description": "\nSelected Cloud Gateways",
            "title": "Cloud Gateway",
            "x-displayname": "Cloud Gateway",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.CloudGateways",
            "properties": {
                "cloud_gateway": {
                    "type": "array",
        ...
        "uztna_domainGateways": {
            ...
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.Gateways",
            "properties": {
                "bigip_site": {
                    "type": "array",
                ...
                "perimeter_re": {
                    ...
                    "$ref": "#/definitions/uztna_domainCloudGatewayAdvertisement",
                    "x-displayname": "Cloud Gateways"
                }
            }
        },
        "uztna_domainGlobalSpecType": {
            "type": "object",
            "description": "Shape of the view internal specification",
            "title": "GlobalSpecType",
            "x-displayname": "ZeroTrust Domain Info Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.GlobalSpecType",
            "properties": {
                "access_fqdn": {
                    "type": "string",
                ...
                "app_vip_pool": {
                    "description": " Appliacation VIP Pools",
                    "title": "Selected VIP Pools",
                    "$ref": "#/definitions/uztna_domainAppVIPPool",
                    "x-displayname": "Application VIP Pools"
                },
                "app_vip_subnet": {
                    "type": "array",
                    "description": " Application VIP prefix holds array of subnet, under which Global ip allocator allocates ip on this range\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.ip_prefix: true\n  ves.io.schema.rules.repeated.items.string.not_empty: true\n  ves.io.schema.rules.repeated.max_items: 10\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "APPLICATION VIP PREFIX",
                    "minItems": 1,
                    "maxItems": 10,
                    "items": {
                        "type": "string"
                ...
                "cert": {
                    ...
                    "title": "Certificate",
                    "$ref": "#/definitions/uztna_domainCertificate",
                    "x-displayname": "Certificate",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "gateways": {
                    "description": " List of all Cloud Gateways and Big-IP Edge Gateways\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Gateways",
                    "$ref": "#/definitions/uztna_domainGateways",
                    "x-displayname": "Gateways",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "lease_pool": {
                    "description": " The Lease Pool List assigned to the Zero Trust Domain.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Lease Pools",
                    "$ref": "#/definitions/uztna_domainLeasePoolList",
                ...
                "policy": {
                    "description": " This is used to import or create new ZTNA Policy\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "ZTNA Policy",
                    "$ref": "#/definitions/uztna_domainPolicy",
        ...
        "uztna_domainIPv4Leasepool": {
            ...
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.IPv4Leasepool",
            "properties": {
                "ipv4_leasepool": {
                    "type": "array",
                    "description": " Select or create new IPv4 Lease Pool\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "IPv4 Lease Pool",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/ioschemaObjectRefType"
        ...
        "uztna_domainLeasePoolList": {
            "type": "object",
            "description": "\nLease Pool For UZTNA Domain View.",
            "title": "Lease Pools",
            "x-displayname": "Lease Pools",
            "x-ves-oneof-field-ipaddress_type": "[\"ipv4_leasepool\"]",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.LeasePoolList",
            "properties": {
                "ipv4_leasepool": {
                    "description": "Exclusive with []\n IPv4 Lease Pools\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "IPv4 Lease Pool",
        ...
        "uztna_domainPolicy": {
            ...
            "title": "ZTNA Policy",
            "x-displayname": "ZTNA Policy",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_domain.Policy",
            "properties": {
                "policy": {
                    "type": "array",
        ...
        "uztna_domaincrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.uztna.uztna_domain.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/uztna_domain/crudapi/api.proto"
}`
