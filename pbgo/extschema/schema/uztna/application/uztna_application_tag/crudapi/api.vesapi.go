...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/uztna/application/uztna_application_tag"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.uztna.application.uztna_application_tag.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.application.uztna_application_tag.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.uztna.application.uztna_application_tag.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.application.uztna_application_tag.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.application.uztna_application_tag.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/uztna/application/uztna_application_tag/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.uztna.application.uztna_application_tag/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_application_tag",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_application_tag.Object",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.uztna.application.uztna_application_tag/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_application_tag",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_application_tag.Object",
        ...
        "/ves.io.schema.uztna.application.uztna_application_tag/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application_tag-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_application_tag",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_application_tag.Object",
        ...
        "/ves.io.schema.uztna.application.uztna_application_tag/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_application_tag/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_application_tag/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_application_tag/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/uztna_application_tagSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_application_tagcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_application_tagcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uztna_application_tagStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_application_tagcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_application_tagcrudapiErrorCode"
                },
        ...
        "uztna_application_tagGlobalSpecType": {
            "type": "object",
            "description": "Defines shape of UZTNA Application Tag",
            "title": "GlobalSpecType",
            "x-displayname": "GlobalSpecType",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.GlobalSpecType",
            "properties": {
                "tag": {
                    "type": "string",
                    "description": " This field is used to create a tag that will be attached to the application.\n\nExample: - \"APPGRP-MKTG\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_bytes: 1024\n  ves.io.schema.rules.string.min_bytes: 1\n",
                    "title": "Tag",
                    "minLength": 1,
                    "maxLength": 1024,
                    "x-displayname": "Tag",
                    "x-ves-example": "APPGRP-MKTG",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.max_bytes": "1024",
        ...
        "uztna_application_tagSpecType": {
            "type": "object",
            "description": "Shape of the User specification",
            "title": "Specification for User object",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/uztna_application_tagGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "uztna_application_tagStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for User object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application_tag.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "uztna_application_tagcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.uztna.application.uztna_application_tag.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/application/uztna_application_tag/crudapi/api.proto"
}`
