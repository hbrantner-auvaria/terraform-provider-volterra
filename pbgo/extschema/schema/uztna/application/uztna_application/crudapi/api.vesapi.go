...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/uztna/application/uztna_application"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.uztna.application.uztna_application.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.application.uztna_application.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.uztna.application.uztna_application.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_application.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.application.uztna_application.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.application.uztna_application.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_application.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_application.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/uztna/application/uztna_application/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.uztna.application.uztna_application/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_application",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_application.Object",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_application.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.uztna.application.uztna_application/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_application",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_application.Object",
        ...
        "/ves.io.schema.uztna.application.uztna_application/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_application-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_application.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_application",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_application.Object",
        ...
        "/ves.io.schema.uztna.application.uztna_application/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_application/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_application/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_application/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.uztna.application.uztna_application.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/uztna_applicationSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_applicationcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_applicationcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uztna_applicationStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_applicationcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_applicationcrudapiErrorCode"
                },
        ...
        "uztna_applicationAppCertificate": {
            "type": "object",
            "description": "\nThis is used to import or create new certificate for tls communication",
            "title": "TLS Certificate",
            "x-displayname": "Certificate",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.AppCertificate",
            "properties": {
                "certificate": {
                    "type": "array",
        ...
        "uztna_applicationGlobalSpecType": {
            "type": "object",
            "description": "\nDefines shape of the Application",
            "title": "GlobalSpecType",
            "x-displayname": "GlobalSpecType",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.GlobalSpecType",
            "properties": {
                "app_tags": {
                    "type": "array",
                    "description": " ZTNA Application tags to associate with Application\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.max_len: 256\n  ves.io.schema.rules.repeated.unique: true\n",
                ...
                "location": {
                    "type": "array",
                    "description": " BIG-IP Next site to deploy the Application onto\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "Location",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/ioschemaObjectRefType"
                ...
                "origin": {
                    ...
                    "title": "Origin",
                    "$ref": "#/definitions/uztna_applicationOrigin",
                    "x-displayname": "Origin"
                },
                "port": {
                    "type": "integer",
                    "description": " The Port on which the Application listens on\n\nExample: - \"443\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 65535\n",
                    "title": "port",
                    "format": "int64",
                    "x-displayname": "Port",
                    "x-ves-example": "443",
                ...
                "protocol": {
                    ...
                    "title": "Protocol",
                    "$ref": "#/definitions/uztna_applicationProtocol",
                    "x-displayname": "Protocol"
                },
                "url": {
                    "type": "string",
                    "description": " Hostname of the Application to be onboarded\n\nExample: - \"test.f5net.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.hostname: true\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "URL for the Application",
                    "minLength": 1,
                    "maxLength": 256,
                    "x-displayname": "URL",
                    "x-ves-example": "test.f5net.com",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.hostname": "true",
                ...
                "uztna_domain_ref": {
                    "type": "array",
                    "description": " Reference to the UZTNA Domain Non-View Object\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "UZTNA Domain Reference",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/ioschemaObjectRefType"
                    },
        ...
        "uztna_applicationOrigin": {
            "type": "object",
            "description": "\nShape of Origin Pool and SNAT Pool",
            "title": "Origin",
            "x-displayname": "Origin",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.Origin",
            "properties": {
                "origin_pool": {
                    "type": "array",
        ...
        "uztna_applicationProtocol": {
            "type": "object",
            "description": "\nIt specifies the possible Protocols",
            "title": "Protocol",
            "x-displayname": "Protocol",
            "x-ves-oneof-field-protocol_choice": "[\"HTTP\",\"HTTPS\",\"TCP\",\"UDP\"]",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.Protocol",
            "properties": {
                "HTTP": {
                ...
                "HTTPS": {
                    ...
                    "$ref": "#/definitions/uztna_applicationAppCertificate",
                    "x-displayname": "HTTPS"
                },
                "TCP": {
        ...
        "uztna_applicationSpecType": {
            "type": "object",
            "description": "Actual Shape of the Application",
            "title": "Specification of Application object",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/uztna_applicationGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "uztna_applicationStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for User object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_application.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "uztna_applicationcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.uztna.application.uztna_application.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/application/uztna_application/crudapi/api.proto"
}`
