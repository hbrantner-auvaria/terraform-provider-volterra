...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/uztna/application/uztna_snat_pool"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.uztna.application.uztna_snat_pool.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.uztna.application.uztna_snat_pool.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/uztna/application/uztna_snat_pool/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.uztna.application.uztna_snat_pool/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_snat_pool",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_snat_pool.Object",
            "x-ves-proto-service": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.uztna.application.uztna_snat_pool/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_snat_pool",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_snat_pool.Object",
        ...
        "/ves.io.schema.uztna.application.uztna_snat_pool/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-uztna-application-uztna_snat_pool-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "uztna_snat_pool",
            "x-ves-object-type": "ves.io.schema.uztna.application.uztna_snat_pool.Object",
        ...
        "/ves.io.schema.uztna.application.uztna_snat_pool/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_snat_pool/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_snat_pool/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.application.uztna_snat_pool/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "applicationuztna_snat_poolGlobalSpecType": {
            "type": "object",
            "description": "\nShape of the UZTNA SNAT Pool",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.GlobalSpecType",
            "properties": {
                "ip_addresses": {
                    "type": "array",
                    "description": "\n Each IP Address could be IPV4 or IPV6,\n Combination of IPV4 and IPV6 can exist in the list.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.min_items: 1\n",
                    "title": "Network",
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/schemaIpAddressType"
                    },
                    "x-displayname": "IP Address List",
                    "x-ves-required": "true",
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/uztna_snat_poolSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_snat_poolcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_snat_poolcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uztna_snat_poolStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_snat_poolcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_snat_poolcrudapiErrorCode"
                },
        ...
        "uztna_snat_poolSpecType": {
            "type": "object",
            "description": "Shape of the User specification\nSpecification for User object",
            "title": "Specification for User object",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/applicationuztna_snat_poolGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "uztna_snat_poolStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object\nDisplays status of an object",
            "title": "Status for User object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.uztna.application.uztna_snat_pool.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "uztna_snat_poolcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.uztna.application.uztna_snat_pool.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/application/uztna_snat_pool/crudapi/api.proto"
}`
