...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/uztna/uztna_flow"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.uztna.uztna_flow.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.uztna.uztna_flow.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.uztna.uztna_flow.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_flow.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_flow.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_flow.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_flow.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.uztna.uztna_flow.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.uztna.uztna_flow.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.uztna.uztna_flow.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_flow.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_flow.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_flow.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_flow.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_flow.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_flow.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.uztna.uztna_flow.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.uztna.uztna_flow.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/uztna/uztna_flow/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.uztna.uztna_flow/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.Get",
                "responses": {
                    "200": {
            ...
            "delete": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "put": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "x-displayname": "",
            "x-ves-object-kind": "uztna_flow",
            "x-ves-object-type": "ves.io.schema.uztna.uztna_flow.Object",
            "x-ves-proto-service": "ves.io.schema.uztna.uztna_flow.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.uztna.uztna_flow/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "post": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
        ...
        "/ves.io.schema.uztna.uztna_flow/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.ListStream",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_flow/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_flow/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_flow/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.uztna.uztna_flow/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.uztna.uztna_flow.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/uztna_flowSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_flowcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_flowcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/uztna_flowStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_flowcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/uztna_flowcrudapiErrorCode"
                },
        ...
        "uztna_flowApplicationTagging": {
            "type": "object",
            "title": "Application Tagging",
            "x-displayname": "ApplicationTagging",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.ApplicationTagging",
            "properties": {
                "saml_app_tag": {
                    "type": "string",
        ...
        "uztna_flowCertificate": {
            ...
            "properties": {
                "certificate": {
                    "type": "array",
                    "description": " Select/Add one or more TLS Certificate objects to associate with this uztna flow",
        ...
        "uztna_flowFlowType": {
            ...
            "x-ves-oneof-field-flow_type_choice": "[\"geo_match\",\"saml_message\"]",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.FlowType",
            "properties": {
                "geo_match": {
                    "description": "Exclusive with [saml_message]\n Geolocation Match",
                    "title": "Geolocation Match",
                    "$ref": "#/definitions/uztna_flowGeoMatch",
                    "x-displayname": "Geolocation Match"
                },
                "saml_message": {
                    "description": "Exclusive with [geo_match]\n Security Assertion Markup Language (SAML) is an open federation standard that\n allows an identity provider (IdP) and a service provider (SP) to exchange user\n authentication and authorization data and enables\n a single sign-on (SSO) experience for your applications.",
                    "title": "SAML configuration",
                    "$ref": "#/definitions/uztna_flowSAMLMessage",
        ...
        "uztna_flowGeoMatch": {
            ...
            "title": "Geolocation Match",
            "x-displayname": "Geolocation match",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.GeoMatch",
            "properties": {
                "match_cri": {
                    "type": "array",
                    "description": " Select multiple geolocations\n Rules to add Matching criteria\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 3\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Geolocation Selector",
                    "minItems": 1,
                    "maxItems": 3,
                    "items": {
                        "$ref": "#/definitions/uztna_flowMatchingCriteria"
                    },
        ...
        "uztna_flowMatchingCriteria": {
            ...
            "x-displayname": "Matching Criteria",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.MatchingCriteria",
            "properties": {
        ...
        "uztna_flowSAMLMessage": {
            "type": "object",
            "description": "\nSAML Flow type",
            "title": "SAML Message",
            "x-displayname": "SAML Message",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.SAMLMessage",
            "properties": {
                "application_tag": {
                    "description": " Application Tagging\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Application Tagging",
                    "$ref": "#/definitions/uztna_flowApplicationTagging",
                ...
                "service_provider_properties": {
                    "description": " Service Provider Properties\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Service Provider Properties",
                    "$ref": "#/definitions/uztna_flowServiceProviderProperties",
        ...
        "uztna_flowServiceProviderProperties": {
            "type": "object",
            "description": "Service Provider Properties.",
            "title": "Service Provider Properties",
            "x-displayname": "Service Provider Properties",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.ServiceProviderProperties",
            "properties": {
                "audience_uri": {
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Audience URI",
                    "$ref": "#/definitions/uztna_flowAudienceUri",
                ...
                "sign_authentication_request": {
                    ...
                    "$ref": "#/definitions/uztna_flowSignAuthenticationRequest",
                ...
                "type": {
                    "description": " Binding  message\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Assertion Consumer Service Binding",
                    "$ref": "#/definitions/uztna_flowAssertionConsumerServiceBinding",
                    "x-displayname": "Assertion Consumer Service Binding",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "want_encrypted_assertion": {
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Want Encrypted Assertion",
                    "$ref": "#/definitions/uztna_flowWantEncryptedRequest",
        ...
        "uztna_flowSignAuthenticationRequest": {
            "type": "object",
            "description": "Sign_Authentication_Request\nx-required",
            "title": "Sign_Authentication_Request",
            "x-displayname": "Sign_Authentication_Request",
            "x-ves-oneof-field-sign_auth_type_choice": "[\"no_auth_req\",\"sign_auth\"]",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.SignAuthenticationRequest",
            "properties": {
                "no_auth_req": {
                    "description": "Exclusive with [sign_auth]\n No Authentication is default authentication",
                    "title": "No Authentication",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "No Authentication"
                },
                "sign_auth": {
                    "description": "Exclusive with [no_auth_req]\n Sign Authentication Request, upload certificate for key and certificate.",
        ...
        "uztna_flowSpecType": {
            ...
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/uztnauztna_flowGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "uztna_flowStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object\nDisplays status of an object",
            "title": "Status for User object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "uztna_flowcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.uztna.uztna_flow.crudapi.ErrorCode"
        },
        "uztnauztna_flowGlobalSpecType": {
            "type": "object",
            "description": "\nShape of the UZTNA flow",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-proto-message": "ves.io.schema.uztna.uztna_flow.GlobalSpecType",
            "properties": {
                "flow_type": {
    ...
    "x-ves-proto-file": "ves.io/schema/uztna/uztna_flow/crudapi/api.proto"
}`
