...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/cloud_region"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.cloud_region.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.cloud_region.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.cloud_region.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_region.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_region.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_region.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_region.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_region.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.cloud_region.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.cloud_region.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_region.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_region.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_region.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_region.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_region.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_region.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_region.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_region.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/cloud_region/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.cloud_region/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_region-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_region.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_region-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_region.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_region-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_region.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cloud_region",
            "x-ves-object-type": "ves.io.schema.cloud_region.Object",
            "x-ves-proto-service": "ves.io.schema.cloud_region.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.cloud_region/Objects": {
            "get": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_region-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_region.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_region-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_region.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cloud_region",
            "x-ves-object-type": "ves.io.schema.cloud_region.Object",
        ...
        "/ves.io.schema.cloud_region/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_region-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_region.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cloud_region",
            "x-ves-object-type": "ves.io.schema.cloud_region.Object",
        ...
        "/ves.io.schema.cloud_region/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_region/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_region/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_region/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.cloud_region.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "cloud_regionGlobalSpecType": {
            "type": "object",
            "description": "Desired state for Cloud Region spec",
            "title": "Cloud Region specification",
            "x-displayname": "Specification",
            "x-ves-oneof-field-policy_group_choice": "[\"default_policy_group\",\"policy_group\"]",
            "x-ves-proto-message": "ves.io.schema.cloud_region.GlobalSpecType",
            "properties": {
                "default_policy_group": {
                    "description": "Exclusive with [policy_group]\n Use Unified Policy Group named default-unified-policy-group",
                    "title": "Use default-unified-policy-group",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Use default-unified-policy-group"
                },
                "policy_group": {
                    "description": "Exclusive with [default_policy_group]\n Specify unified policy group for this cloud connect",
                    "title": "Specify Unified Policy Group",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Unified Policy Group"
                }
            }
        },
        "cloud_regionSpecType": {
            "type": "object",
            "description": "Shape of the Cloud Region  specification",
            "title": "Specification for Cloud Region",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.cloud_region.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/cloud_regionGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "cloud_regionStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for Cloud Region",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.cloud_region.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "cloud_regioncrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.cloud_region.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_region.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/cloud_regionSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_region.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cloud_regioncrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_region.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cloud_regioncrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_region.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/cloud_regionStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_region.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cloud_regioncrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_region.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_region.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_region.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cloud_regioncrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/cloud_region/crudapi/api.proto"
}`
