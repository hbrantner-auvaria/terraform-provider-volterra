...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/alert_receiver"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.alert_receiver.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.alert_receiver.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.alert_receiver.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.alert_receiver.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.alert_receiver.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.alert_receiver.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.alert_receiver.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.alert_receiver.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.alert_receiver.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.alert_receiver.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_receiver.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.alert_receiver.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_receiver.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.alert_receiver.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_receiver.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_receiver.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.alert_receiver.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.alert_receiver.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/alert_receiver/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.alert_receiver/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-alert_receiver-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_receiver.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-alert_receiver-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_receiver.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-alert_receiver-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_receiver.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "alert_receiver",
            "x-ves-object-type": "ves.io.schema.alert_receiver.Object",
            "x-ves-proto-service": "ves.io.schema.alert_receiver.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.alert_receiver/Objects": {
            "get": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-alert_receiver-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_receiver.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-alert_receiver-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_receiver.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "alert_receiver",
            "x-ves-object-type": "ves.io.schema.alert_receiver.Object",
        ...
        "/ves.io.schema.alert_receiver/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-alert_receiver-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.alert_receiver.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "alert_receiver",
            "x-ves-object-type": "ves.io.schema.alert_receiver.Object",
        ...
        "/ves.io.schema.alert_receiver/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.alert_receiver/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.alert_receiver/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.alert_receiver/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.alert_receiver.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "alert_receiverGlobalSpecType": {
            ...
            "properties": {
                ...
                "webhook": {
                    "description": "Exclusive with [email opsgenie pagerduty slack sms]\n Send alert notifications to Webhook",
                    "title": "Webhook",
                    "$ref": "#/definitions/alert_receiverWebhookConfig",
        ...
        "alert_receiverOpsGenieConfig": {
            ...
            "properties": {
                "api_key": {
                    "description": " API integration key to send alert notifications using REST API to OpsGenie service.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "API Key",
                    "$ref": "#/definitions/schemaSecretType",
        ...
        "alert_receiverPagerDutyConfig": {
            ...
            "properties": {
                "routing_key": {
                    "description": " PagerDuty integration key (choose Integration Type: Events API v2)\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Routing Key",
                    "$ref": "#/definitions/schemaSecretType",
        ...
        "alert_receiverSpecType": {
            "type": "object",
            "description": "Shape of the Alert Receiver specification",
            "title": "Specification for Alert Receiver",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/alert_receiverGlobalSpecType",
        ...
        "alert_receivercrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.alert_receiver.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/alert_receiverSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/alert_receivercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/alert_receivercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/alert_receiverStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/alert_receivercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.alert_receiver.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/alert_receivercrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/alert_receiver/crudapi/api.proto"
}`
