...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	...
	vr["ves.io.schema.DualStackAddressType"] = DualStackAddressTypeValidator()
	...
	vr["ves.io.schema.MatchCondition"] = MatchConditionValidator()
	vr["ves.io.schema.MatchPath"] = MatchPathValidator()
	vr["ves.io.schema.ProgressiveDisclosure"] = ProgressiveDisclosureValidator()
