...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bgp_routing_policys", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bgp_routing_policys/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bgp_routing_policys/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/bgp_routing_policys", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bgp_routing_policys/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.bgp_routing_policy.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.bgp_routing_policy")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_routing_policy.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_routing_policy.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_routing_policy.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_routing_policy.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bgp_routing_policy.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_routing_policy.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp_routing_policy.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.bgp_routing_policy.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.bgp_routing_policy.API.Create' operation on 'bgp_routing_policy'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.bgp_routing_policy.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.bgp_routing_policy.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_routing_policy.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp_routing_policy.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.bgp_routing_policy.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.bgp_routing_policy.API.Replace' operation on 'bgp_routing_policy'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.bgp_routing_policy.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_routing_policy.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.bgp_routing_policy.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_routing_policy.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bgp_routing_policy.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bgp_routing_policy.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.bgp_routing_policy.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.bgp_routing_policy.API.Delete' operation on 'bgp_routing_policy'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.bgp_routing_policy.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/bgp_routing_policys": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bgp_routing_policyCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.bgp_routing_policy.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/bgp_routing_policys/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bgp_routing_policyReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bgp_routing_policyReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/bgp_routing_policys": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bgp_routing_policyListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/bgp_routing_policys/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bgp_routing_policyGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bgp_routing_policyDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "bgp_routing_policyBgpCommunity": {
            "type": "object",
            "description": "List of BGP communities",
            "title": "BGP Community",
            "x-displayname": "BGP Community list",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.BgpCommunity",
            "properties": {
                "community": {
                    "type": "array",
                    ...
                    "x-ves-example": "[65535:65281, 65535:65284]",
                    "x-ves-required": "true",
        ...
        "bgp_routing_policyBgpPrefixMatch": {
            "type": "object",
            "description": "A list of IP prefixes amongst which atleast one should match BGP route",
            "title": "IP Prefix list",
            "x-displayname": "Prefix list",
            "x-ves-oneof-field-prefix_length_match": "[\"equal_or_longer_than\",\"exact_match\",\"longer_than\"]",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.BgpPrefixMatch",
            "properties": {
                "equal_or_longer_than": {
                    "description": "Exclusive with [exact_match longer_than]\n Choose a prefix equal orlonger than a particular prefix. For example\n if you choose 10.1.1.0/20 this encompasses a range from 10.1.0.0 to to\n 10.1.15.255. Any prefix in the routing table that falls within this\n range will be matched e.g. 10.1.2.0/24, 10.1.3.0/24. This would also\n match the 10.1.1.0/20.",
                    "title": "ge_match",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Equal or Longer than"
                },
                "exact_match": {
                    "description": "Exclusive with [equal_or_longer_than longer_than]\n Match the exact prefix length specified in IP prefix",
                    "title": "exact_match",
                    "$ref": "#/definitions/ioschemaEmpty",
                ...
                "ip_prefixes": {
                    "type": "string",
                    "description": " IP prefix to match on BGP route\n\nValidation Rules:\n  ves.io.schema.rules.string.ip_prefix: true\n",
                    "title": "IP Prefix",
                ...
                "longer_than": {
                    "description": "Exclusive with [equal_or_longer_than exact_match]\n Choose a prefix longer than a particular prefix. For example if you choose\n 10.1.1.0/20 this encompasses a range from 10.1.0.0 to to 10.1.15.255. Any prefix\n in the routing table that falls within this range will be matched e.g.\n 10.1.2.0/24, 10.1.3.0/24. This wouldn’t match the 10.1.1.0/20.",
                    "title": "longer_than",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Longer than"
                }
            }
        },
        "bgp_routing_policyBgpPrefixMatchList": {
            "type": "object",
            "description": "List of IP prefix and prefix length range match condition",
            "title": "BGP Prefix List",
            "x-displayname": "BGP Prefix List",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.BgpPrefixMatchList",
            "properties": {
                "prefixes": {
                    "type": "array",
                    "description": " List of IP prefix\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 8\n  ves.io.schema.rules.repeated.min_items: 1\n",
                    "title": "BGP Prefix Match List",
                    "minItems": 1,
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/bgp_routing_policyBgpPrefixMatch"
                    },
                    "x-displayname": "Prefix list",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "bgp_routing_policyBgpRouteAction": {
            "type": "object",
        ...
        "bgp_routing_policyBgpRouteMatch": {
            "type": "object",
            "description": "Predicates which have to match information in route for action to be applied",
            "title": "BGP Route Match",
            "x-displayname": "BGP Route Match",
            "x-ves-oneof-field-type_of_match": "[\"as_path\",\"community\",\"ip_prefixes\"]",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.BgpRouteMatch",
            "properties": {
                "as_path": {
                    "type": "string",
                    "description": "Exclusive with [community ip_prefixes]\n AS path can also be a regex, which will be matched against route\n information\n\nExample: - \"^300*\"-",
                    "title": "AS path",
                    "x-displayname": "AS path to match",
                    "x-ves-example": "^300*"
                },
                "community": {
                    "description": "Exclusive with [as_path ip_prefixes]\n List of BGP communities to match in route information\n\nExample: - \"65534:100\"-",
                    "title": "BGP Community",
                    "$ref": "#/definitions/bgp_routing_policyBgpCommunity",
                    "x-displayname": "BGP Community list",
                    "x-ves-example": "65534:100"
                },
                "ip_prefixes": {
                    "description": "Exclusive with [as_path community]\n Select a prefix or group of prefix",
                    "title": "ip_prefixes",
                    "$ref": "#/definitions/bgp_routing_policyBgpPrefixMatchList",
                    "x-displayname": "Prefix"
                }
            }
        },
        "bgp_routing_policyBgpRoutePolicy": {
            "type": "object",
            "description": "BGP route filter is a collection of match condition and action to be taken on match.\nAll the fields to evaluate match criteria will be extracted from BGP route being processed.\nIP prefix, BGP community and AS PATH, all fields which can be specified and\nall the fields must match with BGP route for action to be applied",
            "title": "BGP Route Filter",
            "x-displayname": "BGP Route Filter",
            "x-ves-displayorder": "1,2",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.BgpRoutePolicy",
            "properties": {
                "action": {
                    "description": " Actions to be applied if route matches the rule",
                    "title": "Action",
                    "$ref": "#/definitions/bgp_routing_policyBgpRouteAction",
                    "x-displayname": "Action"
                },
                "match": {
                    "description": " Predicates which have to match information in route for action to be applied",
                    "title": "Match",
                    "$ref": "#/definitions/bgp_routing_policyBgpRouteMatch",
                    "x-displayname": "Match"
                }
            }
        },
        "bgp_routing_policyCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of bgp_routing_policy",
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/schemabgp_routing_policyCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "bgp_routing_policyCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of BGP",
                    "title": "spec",
                    "$ref": "#/definitions/schemabgp_routing_policyGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "bgp_routing_policyDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a bgp_routing_policy",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "bgp_routing_policyGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read bgp_routing_policy",
        ...
        "bgp_routing_policyGetResponseFormatCode": {
            "type": "string",
        ...
        "bgp_routing_policyListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of bgp_routing_policy",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/bgp_routing_policyListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "bgp_routing_policyListResponseItem": {
            "type": "object",
            "description": "By default a summary of bgp_routing_policy is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of bgp_routing_policy",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this bgp_routing_policy",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this bgp_routing_policy",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates bgp_routing_policy is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this bgp_routing_policy",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this bgp_routing_policy\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this bgp_routing_policy\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "bgp_routing_policyReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a bgp_routing_policy",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of BGP",
                    "title": "spec",
                    "$ref": "#/definitions/schemabgp_routing_policyReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "bgp_routing_policyReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.ReplaceResponse"
        },
        "ioschemaEmpty": {
            "type": "object",
        ...
        "schemabgp_routing_policyCreateSpecType": {
            "type": "object",
            "description": "BGP Routing Policy is a list of rules containing match criteria\nand action to be applied. These rules help contol routes which are\nimported or exported to BGP peers",
            "title": "Create bgp routing policy",
            "x-displayname": "Create BGP Routing Policy",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.CreateSpecType",
            "properties": {
                "rules": {
                    "type": "array",
                    "description": " A BGP Routing policy is composed of one or more rules. Note that the order\n of rules is critical as rules are applied top to bottom.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n",
                    "minItems": 1,
                    "maxItems": 16,
                    "items": {
                        "$ref": "#/definitions/bgp_routing_policyBgpRoutePolicy"
                    },
                    "x-displayname": "Rules",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "schemabgp_routing_policyGetSpecType": {
            "type": "object",
            "description": "BGP Routing Policy is a list of rules containing match criteria\nand action to be applied. These rules help contol routes which are\nimported or exported to BGP peers",
            "title": "Get bgp routing policy",
            "x-displayname": "Get BGP Routing Policy",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.GetSpecType",
            "properties": {
                "rules": {
                    "type": "array",
                    "description": " A BGP Routing policy is composed of one or more rules. Note that the order\n of rules is critical as rules are applied top to bottom.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n",
        ...
        "schemabgp_routing_policyReplaceSpecType": {
            "type": "object",
            "description": "BGP Routing Policy is a list of rules containing match criteria\nand action to be applied. These rules help contol routes which are\nimported or exported to BGP peers",
            "title": "Replace bgp routing policy",
            "x-displayname": "Replace BGP Routing Policy",
            "x-ves-proto-message": "ves.io.schema.bgp_routing_policy.ReplaceSpecType",
            "properties": {
                "rules": {
                    "type": "array",
                    "description": " A BGP Routing policy is composed of one or more rules. Note that the order\n of rules is critical as rules are applied top to bottom.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n",
    ...
    "x-displayname": "BGP Routing Policy",
    "x-ves-proto-file": "ves.io/schema/bgp_routing_policy/public_crudapi.proto"
}`
