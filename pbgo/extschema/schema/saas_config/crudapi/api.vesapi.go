...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/saas_config"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.saas_config.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.saas_config.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.saas_config.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.saas_config.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.saas_config.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.saas_config.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.saas_config.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.saas_config.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.saas_config.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.saas_config.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.saas_config.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.saas_config.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.saas_config.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.saas_config.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.saas_config.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.saas_config.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.saas_config.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.saas_config.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/saas_config/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.saas_config/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-saas_config-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.saas_config.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-saas_config-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.saas_config.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-saas_config-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.saas_config.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "saas_config",
            "x-ves-object-type": "ves.io.schema.saas_config.Object",
            "x-ves-proto-service": "ves.io.schema.saas_config.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.saas_config/Objects": {
            "get": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-saas_config-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.saas_config.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-saas_config-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.saas_config.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "saas_config",
            "x-ves-object-type": "ves.io.schema.saas_config.Object",
        ...
        "/ves.io.schema.saas_config/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-saas_config-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.saas_config.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "saas_config",
            "x-ves-object-type": "ves.io.schema.saas_config.Object",
        ...
        "/ves.io.schema.saas_config/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.saas_config/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.saas_config/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.saas_config/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.saas_config.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/saas_configSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/saas_configcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/saas_configcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/saas_configcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/saas_configcrudapiErrorCode"
                },
        ...
        "saas_configGlobalSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.saas_config.GlobalSpecType",
            "properties": {
                "addon_services_subscribed": {
                    "type": "array",
                    "description": " List of addon service names currently subscribed by the tenant.\n\nExample: - \"shape-bot\"-\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 128\n",
                    "title": "addon_services_subscribed",
                    "maxItems": 128,
                    "items": {
                        "type": "string"
                    },
        ...
        "saas_configSpecType": {
            "type": "object",
            "description": "Shape of the saas config specification",
            "title": "SpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.saas_config.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/saas_configGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "saas_configcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.saas_config.crudapi.ErrorCode"
        },
        "schemaCRMInfo": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/saas_config/crudapi/api.proto"
}`
