...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/container_registry"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.container_registry.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.container_registry.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.container_registry.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.container_registry.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.container_registry.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.container_registry.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.container_registry.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.container_registry.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.container_registry.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.container_registry.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.container_registry.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.container_registry.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.container_registry.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.container_registry.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.container_registry.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.container_registry.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.container_registry.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.container_registry.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/container_registry/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.container_registry/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-container_registry-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.container_registry.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-container_registry-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.container_registry.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-container_registry-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.container_registry.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "container_registry",
            "x-ves-object-type": "ves.io.schema.container_registry.Object",
            "x-ves-proto-service": "ves.io.schema.container_registry.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.container_registry/Objects": {
            "get": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-container_registry-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.container_registry.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-container_registry-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.container_registry.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "container_registry",
            "x-ves-object-type": "ves.io.schema.container_registry.Object",
        ...
        "/ves.io.schema.container_registry/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-container_registry-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.container_registry.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "container_registry",
            "x-ves-object-type": "ves.io.schema.container_registry.Object",
        ...
        "/ves.io.schema.container_registry/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.container_registry/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.container_registry/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.container_registry/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.container_registry.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "container_registryGlobalSpecType": {
            "type": "object",
            "description": "Specification for Container Registry",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-proto-message": "ves.io.schema.container_registry.GlobalSpecType",
            "properties": {
                "email": {
                    "type": "string",
                    "description": " Email used for the registry\n\nExample: - \"joe@gmail.com\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.email: true\n",
                    "title": "Email",
                    "x-displayname": "Email",
                    "x-ves-example": "joe@gmail.com",
                ...
                "registry": {
                    "type": "string",
                    "description": " Fully qualified name of the registry login server\n\nExample: - \"quay.io\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.hostname: true\n",
                    "title": "Name",
                    "x-displayname": "Server FQDN",
                    "x-ves-example": "quay.io",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.hostname": "true"
                ...
                "user_name": {
                    "type": "string",
                    "description": " Username used to access the registry\n\nExample: - \"joe\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 128\n",
                    "title": "UserName",
                    "maxLength": 128,
        ...
        "container_registrySpecType": {
            "type": "object",
            "description": "Shape of the Container Registry specification",
            "title": "Specification for Container Registry",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.container_registry.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/container_registryGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "container_registryStatusObject": {
            "type": "object",
            "description": "Most recently observed status of the Container Registry",
            "title": "Status of Container Registry",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.container_registry.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "container_registrycrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.container_registry.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.container_registry.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.container_registry.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/container_registryStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.container_registry.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.container_registry.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/container_registry/crudapi/api.proto"
}`
