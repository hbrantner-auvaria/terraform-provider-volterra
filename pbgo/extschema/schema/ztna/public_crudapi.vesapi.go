...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ztnas", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ztnas/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ztnas/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/ztnas", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ztnas/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.ztna.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.ztna")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.ztna.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.ztna.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ztna.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.ztna.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.ztna.API.Create' operation on 'ztna'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.ztna.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.ztna.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ztna.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.ztna.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.ztna.API.Replace' operation on 'ztna'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.ztna.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.ztna.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ztna.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.ztna.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.ztna.API.Delete' operation on 'ztna'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
var APISwaggerJSON string = `{
    ...
    "info": {
        "title": "Ztna Policy",
        "description": "\nRepresents schema for a ztna policy",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/ztnas": {
            "post": {
                "summary": "Create Ztna Policy",
                "description": "Creates a new Ztna Policy Object",
                "operationId": "ves.io.schema.ztna.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ztnaCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ztnaCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna.API.Create"
            },
            "x-displayname": "Ztna Policy",
            "x-ves-proto-service": "ves.io.schema.ztna.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/ztnas/{metadata.name}": {
            "put": {
                "summary": "Replace Ztna Policy",
                "description": "Replaces the content of the Ztna policy object",
                "operationId": "ves.io.schema.ztna.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ztnaReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ztnaReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna.API.Replace"
            },
            "x-displayname": "Ztna Policy",
            "x-ves-proto-service": "ves.io.schema.ztna.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/ztnas": {
            "get": {
                "summary": "List Ztna Policy",
                "description": "List the set of ztna in a namespace",
                "operationId": "ves.io.schema.ztna.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ztnaListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    {
                        "name": "namespace",
                        "description": "namespace\n\nx-example: \"ns1\"\nNamespace to scope the listing of ztna",
                        "in": "path",
                        "required": true,
                        "type": "string",
                        "x-displayname": "Namespace"
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna.API.List"
            },
            "x-displayname": "Ztna Policy",
            "x-ves-proto-service": "ves.io.schema.ztna.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/ztnas/{name}": {
            "get": {
                "summary": "Get Ztna Policy",
                "description": "Get the ztna policy object",
                "operationId": "ves.io.schema.ztna.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ztnaGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna.API.Get"
            },
            "delete": {
                "summary": "Delete Ztna Policy",
                "description": "Delete the specified ztna",
                "operationId": "ves.io.schema.ztna.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ztnaDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna.API.Delete"
            },
            "x-displayname": "Ztna Policy",
            "x-ves-proto-service": "ves.io.schema.ztna.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "ztnaAclResourceEntry": {
            "type": "object",
            "description": "x-displayName: \"Acl Resource Entry\"\n\nList of configuration for acl resource type.",
            "title": "AclResourceEntry",
            "properties": {
                "entries": {
                    "type": "array",
                    "description": "x-displayName: \"Entries\"\n\nEntries Config for Acl Resource",
                    "title": "entries",
                    "items": {
                        "$ref": "#/definitions/ztnaEntry"
                    }
                }
            }
        },
        "ztnaActionType": {
            ...
            "x-ves-oneof-field-item_type": "[\"active_directory_auth\",\"active_directory_query\",\"log_on\",\"resource_assign\"]",
            "x-ves-proto-message": "ves.io.schema.ztna.ActionType",
            "properties": {
                "active_directory_auth": {
                    "description": "Exclusive with [active_directory_query log_on resource_assign]\n\n Action type is active Directory auth.",
                    "title": "Active Directory Auth",
                    "$ref": "#/definitions/ztnaActiveDirectoryAuth",
                    "x-displayname": "Active Directory Auth"
                },
                "active_directory_query": {
                    "description": "Exclusive with [active_directory_auth log_on resource_assign]\n\n Action type is active Directory query.",
                    "title": "Active Directory Query",
                    "$ref": "#/definitions/ztnaActiveDirectoryQuery",
                ...
                "resource_assign": {
                    "description": "Exclusive with [active_directory_auth active_directory_query log_on]\n\n Action type is resource assign.",
        ...
        "ztnaActiveDirectoryAuth": {
            "type": "object",
            "description": "\nList of configuration of Active directory Auth.",
            "title": "Active Directory Auth",
            "x-displayname": "AAA Active Directory Auth",
            "x-ves-proto-message": "ves.io.schema.ztna.ActiveDirectoryAuth",
            "properties": {
                "active_directory_query": {
                    "type": "array",
                    "description": " Send active directory query configuration on success of allow directory auth.",
                    "title": "AAA Active Directory success",
                    "items": {
                        "$ref": "#/definitions/ztnaActiveDirectoryQuery"
                    },
                ...
                "deny_name": {
                    "type": "string",
                    "description": " Send deny as next item in case it fails to find the query.\n\nExample: - \"Deny\"-",
                    "title": "AAA Active Directory Failure",
                    "x-displayname": "AAA Active Directory Failure",
                    "x-ves-example": "Deny"
                },
                "expression": {
                    "type": "string",
                    "description": " Expression string to filter the Directory query.\n\nExample: - \"expr {[mcget {session.ad.last.authresult}] == 1}\"-",
                    "title": "Expression",
                    "x-displayname": "Expression",
                    "x-ves-example": "expr {[mcget {session.ad.last.authresult}] == 1}"
                },
                "server": {
                    "type": "string",
                    "description": " Server name on which log on is success.\n\nExample: - \"ad_auth_server\"-",
                    "title": "Server Name",
        ...
        "ztnaActiveDirectoryQuery": {
            "type": "object",
            "description": "\nSend active directory query configuration on success of active directory Auth.",
            "title": "Active Directory Query",
            "x-displayname": "Active Directory Query",
            "x-ves-proto-message": "ves.io.schema.ztna.ActiveDirectoryQuery",
            "properties": {
                "deny_name": {
                    "type": "string",
                    "description": " Send deny as next item if query gets failed.\n\nExample: - \"Deny\"-",
                    "title": "Active Directory Query Failure",
                ...
                "server": {
                    "type": "string",
                    "description": " Name of the server which gets assigned.\n\nExample: - \"ad_auth_server\"-",
                    "title": "Server Name",
                    "x-displayname": "Server",
                    "x-ves-example": "ad_auth_server"
                }
        ...
        "ztnaAllowResourceAssign": {
            ...
            "properties": {
                "allow_name": {
                    "type": "string",
                    "description": " Send allow as next item in case of success\n\nExample: - \"Allow\"-",
                    "title": "Resource Assign Success",
                    "x-displayname": "Resource Assign Success Configuration",
                    "x-ves-example": "Allow"
                },
                "deny_name": {
                    "type": "string",
                    "description": " Send deny as next item in case of failure\n\nExample: - \"Deny\"-",
                    "title": "Resource Assign Failure",
        ...
        "ztnaConnectivity": {
            ...
            "title": "Ztna Connectivity Policy",
            "enum": [
                "PPP",
                "DTLS"
            ],
            ...
            "x-ves-proto-enum": "ves.io.schema.ztna.Connectivity"
        },
        "ztnaConnectivityPolicyType": {
            "type": "object",
            "description": "List of Ztna Connectivity Policy type.",
            "title": "Ztna ConnectivityPolicyType",
            "x-displayname": "Ztna Connectivity Policy Type",
            "x-ves-proto-message": "ves.io.schema.ztna.ConnectivityPolicyType",
            "properties": {
                "connectivities": {
                    "description": " Connectivity policy configuration. Select connectivity policy as PPP/DTLS",
                    "title": "Connectivities",
                    "$ref": "#/definitions/ztnaConnectivity",
        ...
        "ztnaCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of ztna",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.ztna.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the policy of the ztna",
                    "title": "spec",
                    "$ref": "#/definitions/ztnaCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "ztnaCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ztna.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the policy of the ztna",
                    "title": "spec",
                    "$ref": "#/definitions/ztnaGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "ztnaCreateSpecType": {
            ...
            "properties": {
                ...
                "per_session": {
                    "description": " List of configuration for per session policy type.",
                    "$ref": "#/definitions/ztnaPerSessionPolicyType",
        ...
        "ztnaCustmization": {
            ...
            "x-ves-proto-message": "ves.io.schema.ztna.Custmization",
            "properties": {
                "password": {
                ...
                "user_name": {
                    "type": "string",
                    "description": "This contains the user name to log on.\n\nExample: - \"User Name\"-",
                    "title": "Username",
                    "x-displayname": "User Name",
                    "x-ves-example": "User Name"
                }
            }
        },
        "ztnaDeleteRequest": {
            ...
            "title": "DeleteRequest is used to delete a ztna",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.ztna.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "ztnaExternalServers": {
            "type": "object",
            "description": "x-displayName: \"External Servers\"\n\nExternal server is list of server for ztna per session policy.",
            "title": "Ztna Policy ExternalServers",
            "properties": {
                "admin_password": {
                ...
                "admin_username": {
                    "type": "string",
                    "description": "x-displayName: \"Admin Name\"\nx-example: \"Admin\"\nCredentials used for external server",
                    "title": "adminName"
                },
                "domain": {
                    "type": "string",
                ...
                "server_type": {
                    "description": "x-displayName: \"Server Type\"\n\nserverType of External server",
                    "title": "serverType",
                    "$ref": "#/definitions/ztnaServerType"
                }
            }
        },
        "ztnaGetResponse": {
            ...
            "title": "GetResponse is the shape of a read ztna",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.ztna.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/ztnaStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "ztnaLeasePoolMember": {
            "type": "object",
            "description": "x-displayName: \"Lease Pools Member\"\n\nThe lease pool member is pool member for per session policy.",
            "title": "Ztna Policy Lease Pools Members",
            "properties": {
                "end_address": {
        ...
        "ztnaListResponse": {
            ...
            "title": "ListResponse is the collection of ztna",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.ztna.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/ztnaListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "ztnaListResponseItem": {
            "type": "object",
            "description": "By default a summary of ztna is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of ztna",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.ztna.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this ztna",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this ztna",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates ztna is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this ztna",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this ztna\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
        ...
        "ztnaLogonItemType": {
            ...
            "title": "Log on as nextItem",
            "x-displayname": "Log On Next Item",
            "x-ves-proto-message": "ves.io.schema.ztna.LogonItemType",
            "properties": {
                "active_directory_auth": {
                    "type": "array",
                ...
                "customization": {
                    ...
                    "title": "Credentials",
                    "items": {
                        "$ref": "#/definitions/ztnaCustmization"
                    },
                    "x-displayname": "Credentials"
                }
            }
        },
        "ztnaPerSessionPolicyType": {
            "type": "object",
            "description": "List of Per Session Policy type.",
            "title": "Ztna Per Session Type",
            "x-displayname": "Session Policy Type",
            "x-ves-proto-message": "ves.io.schema.ztna.PerSessionPolicyType",
            "properties": {
                "external_server": {
                    "type": "object",
                ...
                "lease_pool_member": {
                    "type": "object",
                    "description": " List of Lease pool member for Session Policy\n\nValidation Rules:\n  ves.io.schema.rules.map.keys.string.max_len: 256\n  ves.io.schema.rules.map.keys.string.min_len: 1\n  ves.io.schema.rules.map.max_pairs: 64\n",
                    "title": "Lease Pool Member",
                ...
                "per_session_policy_name": {
                    "type": "string",
                    "description": " This contains the name of session policy",
                    "title": "Name",
                    "x-displayname": "Session Policy Name"
                },
                "resources": {
                    "type": "object",
                    "description": " List of the Policy of session type.\n\nValidation Rules:\n  ves.io.schema.rules.map.keys.string.max_len: 256\n  ves.io.schema.rules.map.keys.string.min_len: 1\n  ves.io.schema.rules.map.max_pairs: 64\n",
        ...
        "ztnaReplaceRequest": {
            ...
            "title": "ReplaceRequest is used to replace contents of a ztna",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.ztna.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the policy of the ztna",
                    "title": "spec",
                    "$ref": "#/definitions/ztnaReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "ztnaReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ztna.ReplaceResponse"
        },
        "ztnaReplaceSpecType": {
            "type": "object",
            "description": "Replaces the content of the Ztna policy object",
            "title": "Replace Ztna Policy",
        ...
        "ztnaResource": {
            ...
            "title": "Resource for Per Session Policy",
            "properties": {
                "acl": {
                    "description": "x-displayName: \"Acl Resource Entry\"\n\nResource type is ACL.",
                    "title": "AclResourceEntry",
                    "$ref": "#/definitions/ztnaAclResourceEntry"
                },
                "connectivity": {
                    "description": "x-displayName: \"Connectivity Resource Network Access\"\n\nResource type is connectivity .",
                    "title": "ConnectivityResourceNetworkAccess",
                    "$ref": "#/definitions/ioschemaEmpty"
                },
                "web": {
                    "description": "x-displayName: \"Webtop Full Resource Type\"\n\nResource type is webtopfull.",
                    "title": "WebtopFullResourceType",
                    "$ref": "#/definitions/ioschemaEmpty"
                }
            }
        },
        "ztnaResourceAssign": {
            ...
            "title": "Resource Assign",
            "x-displayname": "Resource Assign",
            "x-ves-proto-message": "ves.io.schema.ztna.ResourceAssign",
            "properties": {
                "allow": {
                    "type": "array",
                    ...
                    "title": "Resource Assign",
                    "items": {
                        "$ref": "#/definitions/ztnaAllowResourceAssign"
                    },
        ...
        "ztnaRules": {
            ...
            "x-ves-proto-message": "ves.io.schema.ztna.Rules",
            "properties": {
                "acls": {
                    "type": "array",
                    "description": " Put the list of all acls resource type name.\n\nExample: - \"acltest1\"-",
                    "title": "Acls",
                    "items": {
                        "type": "string"
                    },
                    "x-displayname": "Acls",
                    "x-ves-example": "acltest1"
                },
                "network_access_rule": {
                    "type": "array",
                    "description": " List of network access rules configuration\n\nExample: - \"cp-demo\"-",
                    "title": "Network access rules",
                    "items": {
                        "type": "string"
                    },
                    "x-displayname": "Network Access Rules",
                    "x-ves-example": "cp-demo"
                },
                "web_top_name": {
                    "type": "string",
                    "description": " Put the name of webtopfull resource type\n\nExample: - \"webtop1\"-",
                    "title": "Web Top Name",
                    "x-displayname": "Web Top Name",
                    "x-ves-example": "webtop1"
                }
            }
        },
        "ztnaSequenceAction": {
        ...
        "ztnaStatusObject": {
            ...
            "title": "Status of Ztna Policy Configuration",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.ztna.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-displayname": "Ztna Policy",
    "x-ves-proto-file": "ves.io/schema/ztna/public_crudapi.proto"
}`
