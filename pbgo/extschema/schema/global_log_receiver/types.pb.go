...
// Configuration for request logs with sampling choice.
// Allows selection between sampled (default) or unsampled (full) request logs.
type RequestLogsConfig struct {
	// Sampling Selection
	//
	// x-displayName: "Log Sampling"
	// x-required
	// Choose how Request Logs are collected
	//
	// Types that are valid to be assigned to SamplingChoice:
	//	*RequestLogsConfig_Sampled
	//	*RequestLogsConfig_Unsampled
	SamplingChoice isRequestLogsConfig_SamplingChoice `protobuf_oneof:"sampling_choice"`
}

func (m *RequestLogsConfig) Reset()      { *m = RequestLogsConfig{} }
func (*RequestLogsConfig) ProtoMessage() {}
func (*RequestLogsConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ef22f1dd0dc1f3e, []int{21}
}
func (m *RequestLogsConfig) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestLogsConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RequestLogsConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestLogsConfig.Merge(m, src)
}
func (m *RequestLogsConfig) XXX_Size() int {
	return m.Size()
}
func (m *RequestLogsConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestLogsConfig.DiscardUnknown(m)
}

var xxx_messageInfo_RequestLogsConfig proto.InternalMessageInfo

type isRequestLogsConfig_SamplingChoice interface {
	isRequestLogsConfig_SamplingChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type RequestLogsConfig_Sampled struct {
	Sampled *schema.Empty `protobuf:"bytes,2,opt,name=sampled,proto3,oneof" json:"sampled,omitempty"`
}
type RequestLogsConfig_Unsampled struct {
	Unsampled *schema.Empty `protobuf:"bytes,3,opt,name=unsampled,proto3,oneof" json:"unsampled,omitempty"`
}

func (*RequestLogsConfig_Sampled) isRequestLogsConfig_SamplingChoice()   {}
func (*RequestLogsConfig_Unsampled) isRequestLogsConfig_SamplingChoice() {}

func (m *RequestLogsConfig) GetSamplingChoice() isRequestLogsConfig_SamplingChoice {
	if m != nil {
		return m.SamplingChoice
	}
	return nil
}

func (m *RequestLogsConfig) GetSampled() *schema.Empty {
	if x, ok := m.GetSamplingChoice().(*RequestLogsConfig_Sampled); ok {
		return x.Sampled
	}
	return nil
}

func (m *RequestLogsConfig) GetUnsampled() *schema.Empty {
	if x, ok := m.GetSamplingChoice().(*RequestLogsConfig_Unsampled); ok {
		return x.Unsampled
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*RequestLogsConfig) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*RequestLogsConfig_Sampled)(nil),
		(*RequestLogsConfig_Unsampled)(nil),
	}
}
...
type GlobalSpecType_FileReceiver struct {
	FileReceiver *schema.Empty `protobuf:"bytes,25,opt,name=file_receiver,json=fileReceiver,proto3,oneof" json:"file_receiver,omitempty"`
}
type GlobalSpecType_RequestLogs struct {
	RequestLogs *RequestLogsConfig `protobuf:"bytes,15,opt,name=request_logs,json=requestLogs,proto3,oneof" json:"request_logs,omitempty"`
}
...
func (*GlobalSpecType_FileReceiver) isGlobalSpecType_Receiver()           {}
...
func (m *GlobalSpecType) GetFileReceiver() *schema.Empty {
	if x, ok := m.GetReceiver().(*GlobalSpecType_FileReceiver); ok {
		return x.FileReceiver
	}
	return nil
}

func (m *GlobalSpecType) GetRequestLogs() *RequestLogsConfig {
...
func (*GlobalSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GlobalSpecType_FileReceiver)(nil),
...
type CreateSpecType_FileReceiver struct {
	FileReceiver *schema.Empty `protobuf:"bytes,25,opt,name=file_receiver,json=fileReceiver,proto3,oneof" json:"file_receiver,omitempty"`
}
...
func (*CreateSpecType_FileReceiver) isCreateSpecType_Receiver()           {}
...
func (m *CreateSpecType) GetFileReceiver() *schema.Empty {
	if x, ok := m.GetReceiver().(*CreateSpecType_FileReceiver); ok {
		return x.FileReceiver
	}
	return nil
}

func (m *CreateSpecType) GetRequestLogs() *RequestLogsConfig {
...
func (*CreateSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*CreateSpecType_FileReceiver)(nil),
...
type ReplaceSpecType_FileReceiver struct {
	FileReceiver *schema.Empty `protobuf:"bytes,25,opt,name=file_receiver,json=fileReceiver,proto3,oneof" json:"file_receiver,omitempty"`
}
...
func (*ReplaceSpecType_FileReceiver) isReplaceSpecType_Receiver()           {}
...
func (m *ReplaceSpecType) GetFileReceiver() *schema.Empty {
	if x, ok := m.GetReceiver().(*ReplaceSpecType_FileReceiver); ok {
		return x.FileReceiver
	}
	return nil
}

func (m *ReplaceSpecType) GetRequestLogs() *RequestLogsConfig {
...
func (*ReplaceSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ReplaceSpecType_FileReceiver)(nil),
...
func (*GetSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ef22f1dd0dc1f3e, []int{25}
}
...
type GetSpecType_FileReceiver struct {
	FileReceiver *schema.Empty `protobuf:"bytes,25,opt,name=file_receiver,json=fileReceiver,proto3,oneof" json:"file_receiver,omitempty"`
}
...
func (*GetSpecType_FileReceiver) isGetSpecType_Receiver()           {}
...
func (m *GetSpecType) GetFileReceiver() *schema.Empty {
	if x, ok := m.GetReceiver().(*GetSpecType_FileReceiver); ok {
		return x.FileReceiver
	}
	return nil
}

func (m *GetSpecType) GetRequestLogs() *RequestLogsConfig {
...
func init() {
	...
	proto.RegisterType((*RequestLogsConfig)(nil), "ves.io.schema.global_log_receiver.RequestLogsConfig")
...
var fileDescriptor_2ef22f1dd0dc1f3e = []byte{
	...
	,
}
...
func (this *RequestLogsConfig) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RequestLogsConfig)
	if !ok {
		that2, ok := that.(RequestLogsConfig)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.SamplingChoice == nil {
		if this.SamplingChoice != nil {
			return false
		}
	} else if this.SamplingChoice == nil {
		return false
	} else if !this.SamplingChoice.Equal(that1.SamplingChoice) {
		return false
	}
	return true
}
func (this *RequestLogsConfig_Sampled) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RequestLogsConfig_Sampled)
	if !ok {
		that2, ok := that.(RequestLogsConfig_Sampled)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.Sampled.Equal(that1.Sampled) {
		return false
	}
	return true
}
func (this *RequestLogsConfig_Unsampled) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RequestLogsConfig_Unsampled)
	if !ok {
		that2, ok := that.(RequestLogsConfig_Unsampled)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.Unsampled.Equal(that1.Unsampled) {
		return false
	}
	return true
}
...
func (this *GlobalSpecType_FileReceiver) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_FileReceiver)
	if !ok {
		that2, ok := that.(GlobalSpecType_FileReceiver)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.FileReceiver.Equal(that1.FileReceiver) {
		return false
	}
	return true
}
...
func (this *CreateSpecType_FileReceiver) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_FileReceiver)
	if !ok {
		that2, ok := that.(CreateSpecType_FileReceiver)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_FileReceiver) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_FileReceiver)
	if !ok {
		that2, ok := that.(ReplaceSpecType_FileReceiver)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_FileReceiver) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_FileReceiver)
	if !ok {
		that2, ok := that.(GetSpecType_FileReceiver)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *RequestLogsConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&global_log_receiver.RequestLogsConfig{")
	if this.SamplingChoice != nil {
		s = append(s, "SamplingChoice: "+fmt.Sprintf("%#v", this.SamplingChoice)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *RequestLogsConfig_Sampled) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&global_log_receiver.RequestLogsConfig_Sampled{` +
		`Sampled:` + fmt.Sprintf("%#v", this.Sampled) + `}`}, ", ")
	return s
}
func (this *RequestLogsConfig_Unsampled) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&global_log_receiver.RequestLogsConfig_Unsampled{` +
		`Unsampled:` + fmt.Sprintf("%#v", this.Unsampled) + `}`}, ", ")
	return s
}
...
func (this *GlobalSpecType_FileReceiver) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&global_log_receiver.GlobalSpecType_FileReceiver{` +
		`FileReceiver:` + fmt.Sprintf("%#v", this.FileReceiver) + `}`}, ", ")
	return s
}
...
func (this *CreateSpecType_FileReceiver) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&global_log_receiver.CreateSpecType_FileReceiver{` +
		`FileReceiver:` + fmt.Sprintf("%#v", this.FileReceiver) + `}`}, ", ")
	return s
}
...
func (this *ReplaceSpecType_FileReceiver) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&global_log_receiver.ReplaceSpecType_FileReceiver{` +
		`FileReceiver:` + fmt.Sprintf("%#v", this.FileReceiver) + `}`}, ", ")
	return s
}
...
func (this *GetSpecType_FileReceiver) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&global_log_receiver.GetSpecType_FileReceiver{` +
		`FileReceiver:` + fmt.Sprintf("%#v", this.FileReceiver) + `}`}, ", ")
	return s
}
...
func (m *RequestLogsConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestLogsConfig) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestLogsConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.SamplingChoice != nil {
		{
			size := m.SamplingChoice.Size()
			i -= size
			if _, err := m.SamplingChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *RequestLogsConfig_Sampled) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestLogsConfig_Sampled) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Sampled != nil {
		{
			size, err := m.Sampled.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestLogsConfig_Unsampled) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestLogsConfig_Unsampled) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Unsampled != nil {
		{
			size, err := m.Unsampled.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_FileReceiver) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_FileReceiver) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FileReceiver != nil {
		{
			size, err := m.FileReceiver.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CreateSpecType_FileReceiver) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_FileReceiver) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FileReceiver != nil {
		{
			size, err := m.FileReceiver.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_FileReceiver) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_FileReceiver) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FileReceiver != nil {
		{
			size, err := m.FileReceiver.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_FileReceiver) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_FileReceiver) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FileReceiver != nil {
		{
			size, err := m.FileReceiver.MarshalToSizedBuffer(dAtA[:i])
...
func (m *RequestLogsConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SamplingChoice != nil {
		n += m.SamplingChoice.Size()
	}
	return n
}

func (m *RequestLogsConfig_Sampled) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestLogsConfig_Unsampled) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GlobalSpecType_FileReceiver) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_FileReceiver) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_FileReceiver) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_FileReceiver) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *RequestLogsConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RequestLogsConfig{`,
		`SamplingChoice:` + fmt.Sprintf("%v", this.SamplingChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *RequestLogsConfig_Sampled) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RequestLogsConfig_Sampled{`,
		`Sampled:` + strings.Replace(fmt.Sprintf("%v", this.Sampled), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *RequestLogsConfig_Unsampled) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RequestLogsConfig_Unsampled{`,
		`Unsampled:` + strings.Replace(fmt.Sprintf("%v", this.Unsampled), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *GlobalSpecType_RequestLogs) String() string {
	...
	s := strings.Join([]string{`&GlobalSpecType_RequestLogs{`,
		`RequestLogs:` + strings.Replace(fmt.Sprintf("%v", this.RequestLogs), "RequestLogsConfig", "RequestLogsConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *GlobalSpecType_FileReceiver) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_FileReceiver{`,
		`FileReceiver:` + strings.Replace(fmt.Sprintf("%v", this.FileReceiver), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *CreateSpecType_FileReceiver) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_FileReceiver{`,
		`FileReceiver:` + strings.Replace(fmt.Sprintf("%v", this.FileReceiver), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ReplaceSpecType_FileReceiver) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_FileReceiver{`,
		`FileReceiver:` + strings.Replace(fmt.Sprintf("%v", this.FileReceiver), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetSpecType_FileReceiver) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_FileReceiver{`,
		`FileReceiver:` + strings.Replace(fmt.Sprintf("%v", this.FileReceiver), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *RequestLogsConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestLogsConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestLogsConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
			...
			m.SamplingChoice = &RequestLogsConfig_Sampled{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Unsampled", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SamplingChoice = &RequestLogsConfig_Unsampled{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *GlobalSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FileReceiver", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Receiver = &GlobalSpecType_FileReceiver{v}
			iNdEx = postIndex
		case 1000:
			if wireType != 2 {
...
func (m *CreateSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			...
			m.Receiver = &CreateSpecType_FileReceiver{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ReplaceSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			...
			m.Receiver = &ReplaceSpecType_FileReceiver{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *GetSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			...
			m.Receiver = &GetSpecType_FileReceiver{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
