...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/jwt"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.jwt.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.jwt.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.jwt.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.jwt.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.jwt.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.jwt.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.jwt.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.jwt.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.jwt.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.jwt.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/jwt/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.jwt/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.jwt.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.jwt.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.jwt.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "jwt",
            "x-ves-object-type": "ves.io.schema.jwt.Object",
            "x-ves-proto-service": "ves.io.schema.jwt.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.jwt/Objects": {
            "get": {
                "operationId": "ves.io.schema.jwt.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.jwt.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "jwt",
            "x-ves-object-type": "ves.io.schema.jwt.Object",
        ...
        "/ves.io.schema.jwt/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.jwt.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-jwt-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.jwt.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "jwt",
            "x-ves-object-type": "ves.io.schema.jwt.Object",
        ...
        "/ves.io.schema.jwt/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.jwt.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.jwt/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.jwt.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.jwt/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.jwt.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.jwt/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.jwt.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/jwtSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/jwtcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/jwtcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/jwtStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/jwtcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.jwt.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/jwtcrudapiErrorCode"
                },
        ...
        "jwtAlwaysAllowJwt": {
            "type": "object",
            "description": "Specified in JwtRequirement.\nThe requirement is always satisfied even if JWT is missing or the JWT\nverification fails. A typical usage is: this filter is used to only verify\nJWTs and pass the verified JWT payloads to another filter, the other filter\nwill make decision. In this mode, all JWT tokens will be verified.",
            "title": "AlwaysAllowJwt",
            "x-displayname": "Always Allow JWT",
            "x-ves-proto-message": "ves.io.schema.jwt.AlwaysAllowJwt",
            "properties": {
                "allow_missing_or_failed": {
                    "description": " The requirement is always satisfied even if JWT is missing or the JWT\n verification fails.",
                    "title": "Allow missing JWT or failed JWT verifications",
        ...
        "jwtGlobalSpecType": {
            ...
            "x-ves-proto-message": "ves.io.schema.jwt.GlobalSpecType",
            "properties": {
                "absent_token_action": {
                    "description": " Action on absent token\n\nExample: - \"BLOCK\"-",
                    "title": "absent token",
                ...
                "rules": {
                    "type": "array",
                    "description": " Specifies requirements based on the route matches. The first matched requirement will be\n applied. If there are overlapped match conditions, please put the most specific match first.",
                    "title": "JWT Requirement rules",
                    "items": {
                        "$ref": "#/definitions/jwtRequirementRule"
                    },
        ...
        "jwtJwtRequirement": {
            "type": "object",
            "description": "Specifies the Jwt requirement, e.g. which provider is required.\nAn empty message means JWT verification is not required",
            "title": "JwtRequirement",
            "x-displayname": "JWT Requirement",
            "x-ves-oneof-field-requires_type": "[\"allow_missing_or_failed\",\"provider\",\"provider_and_audiences\"]",
            "x-ves-proto-message": "ves.io.schema.jwt.JwtRequirement",
            "properties": {
                "allow_missing_or_failed": {
                    "description": "Exclusive with [provider provider_and_audiences]\n The requirement is always satisfied even if JWT is missing or the JWT\n verification fails. A typical usage is: this filter is used to only verify\n JWTs and pass the verified JWT payloads to another filter, the other filter\n will make decision. In this mode, all JWT tokens will be verified.",
                    "title": "Always Allow JWT",
                    "$ref": "#/definitions/jwtAlwaysAllowJwt",
                    "x-displayname": "Allow Missing or Failed"
                },
                "provider": {
                    "description": "Exclusive with [allow_missing_or_failed provider_and_audiences]\n Specify a required provider",
                    "title": "Provider for JWT verification",
                    "$ref": "#/definitions/jwtProvider",
                    "x-displayname": "JWT Provider"
                },
                "provider_and_audiences": {
                    "description": "Exclusive with [allow_missing_or_failed provider]\n Specify a required provider with audiences.",
                    "title": "Provider with audiences for JWT verification",
                    "$ref": "#/definitions/jwtProviderWithAudiences",
        ...
        "jwtProvider": {
            "type": "object",
            "description": "A Provider specifies how a JSON Web Token (JWT) can be verified.",
            "title": "Provider",
            "x-displayname": "JWT Provider",
            "x-ves-proto-message": "ves.io.schema.jwt.Provider",
            "properties": {
                "provider": {
                    "type": "array",
                    "description": " Specify a required provider\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "provider",
                    "items": {
        ...
        "jwtProviderWithAudiences": {
            "type": "object",
            "description": "Specify a required provider with audiences.",
            "title": "ProviderWithAudiences",
            "x-displayname": "JWT Provider with Audiences",
            "x-ves-proto-message": "ves.io.schema.jwt.ProviderWithAudiences",
            "properties": {
                "audiences": {
                    "type": "array",
                    "description": " The list of JWT audiences that are are allowed to access.\n A JWT containing any of these audiences will be accepted.\n This field overrides the one specified in the JwtProvider.\n\nExample: - \"bookstore_android.apps.googleusercontent.com\"-",
                    "title": "audiences",
                    "items": {
                        "type": "string"
                    },
        ...
        "jwtRequirementRule": {
            ...
            "properties": {
                ...
                "requires": {
                    "description": " Specify the JWT Requirement, e.g. which provider is required\n An empty message means JWT verification is not required\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Jwt Requirement",
                    "$ref": "#/definitions/jwtJwtRequirement",
                    "x-displayname": "JWT Requirement",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
        ...
        "jwtSpecType": {
            ...
            "title": "Specification of JWT",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.jwt.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/jwtGlobalSpecType",
        ...
        "jwtStatusObject": {
            ...
            "title": "Status for JWT object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.jwt.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "jwtcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.jwt.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/jwt/crudapi/api.proto"
}`
