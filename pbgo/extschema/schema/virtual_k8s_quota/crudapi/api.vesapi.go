...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/virtual_k8s_quota"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.virtual_k8s_quota.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.virtual_k8s_quota.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.virtual_k8s_quota.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_k8s_quota.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_k8s_quota.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_k8s_quota.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_k8s_quota.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.virtual_k8s_quota.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.virtual_k8s_quota.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.virtual_k8s_quota.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.virtual_k8s_quota.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.virtual_k8s_quota.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.virtual_k8s_quota.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.virtual_k8s_quota.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.virtual_k8s_quota.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.virtual_k8s_quota.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.virtual_k8s_quota.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.virtual_k8s_quota.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/virtual_k8s_quota/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.virtual_k8s_quota/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-virtual_k8s_quota-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.virtual_k8s_quota.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-virtual_k8s_quota-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.virtual_k8s_quota.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-virtual_k8s_quota-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.virtual_k8s_quota.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "virtual_k8s_quota",
            "x-ves-object-type": "ves.io.schema.virtual_k8s_quota.Object",
            "x-ves-proto-service": "ves.io.schema.virtual_k8s_quota.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.virtual_k8s_quota/Objects": {
            "get": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-virtual_k8s_quota-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.virtual_k8s_quota.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-virtual_k8s_quota-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.virtual_k8s_quota.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "virtual_k8s_quota",
            "x-ves-object-type": "ves.io.schema.virtual_k8s_quota.Object",
        ...
        "/ves.io.schema.virtual_k8s_quota/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-virtual_k8s_quota-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.virtual_k8s_quota.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "virtual_k8s_quota",
            "x-ves-object-type": "ves.io.schema.virtual_k8s_quota.Object",
        ...
        "/ves.io.schema.virtual_k8s_quota/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.virtual_k8s_quota/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.virtual_k8s_quota/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.virtual_k8s_quota/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.virtual_k8s_quota.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/virtual_k8s_quotaSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/virtual_k8s_quotacrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/virtual_k8s_quotacrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/virtual_k8s_quotaStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/virtual_k8s_quotacrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/virtual_k8s_quotacrudapiErrorCode"
                },
        ...
        "schemavirtual_k8s_quotaGlobalSpecType": {
            "type": "object",
            "description": "Configuration specification for Virtual K8s Quota",
            "title": "GlobalSpecType",
            "x-displayname": "Global Configuration Specification",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.GlobalSpecType",
            "properties": {
                "object_counts": {
                    "type": "object",
                    "description": " Object Counts defines limit on the number of K8s object per type that can be instantiated in the Virtual K8s.\n The key of object_counts is K8s object kind e.g. \"deployments, statefulsets\".",
                    "title": "object_counts",
                    "x-displayname": "Object Counts"
                },
                "resource_limits_per_re_site": {
                    "type": "object",
                    "description": " Resource Limits defines a per F5XC Regional Edge (RE) site limit on the consumption of compute (cpu, memory) resources\n by K8s workload objects (pods, persistent volume claims) instantiated in the Virtual K8s. The unit of CPU resource is vCPU.\n Each vCPU is a thread on a CPU core. The unit of memory resource is MiB (mebibyte), power of 2. One MiB is 1,048,576 bytes.\n The key of resource_limits is the name of the resource. e.g. \"cpu, memory\".",
                    "title": "resource_limits_per_re_site",
                    "x-displayname": "Resource Limits per Regional Edge"
                },
                "virtual_k8s_refs": {
                    "type": "array",
                    "description": " Reference to the virtual K8s object to which this quota applies\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "virtual_k8s_refs",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
        ...
        "usageFloatUsagesType": {
            "type": "object",
            "description": "x-displayName: \"UsagesType (float)\"\nFloatUsagesType is used to indicate usage for a group of objects or resources.",
            "title": "FloatUsagesType",
            "properties": {
                "usages": {
                    "type": "object",
                    "description": "x-displayName: \"Usages\"\nUsages is the map of objects or resources to their current usage.",
                    "title": "usages"
                }
            }
        },
        "virtual_k8s_quotaSpecType": {
            "type": "object",
            "description": "Shape of the Virtual K8s Quota configuration specification",
            "title": "Specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemavirtual_k8s_quotaGlobalSpecType",
                    "x-displayname": "Global Specification"
                }
            }
        },
        "virtual_k8s_quotaStatusObject": {
            "type": "object",
            "description": "Most recently observed status of the Virtual K8s Quota object",
            "title": "Status Object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.virtual_k8s_quota.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "object_counts": {
                    "type": "object",
                    "description": " Object Counts is the configured limit on the number of K8s object per type that can be instantiated in the Virtual K8s.\n The key of the object_counts map is K8s object kind e.g. \"deployments, statefulsets\".",
                    "title": "object_counts",
                    "x-displayname": "Configured Object Counts"
                },
                "object_refs": {
                    "type": "array",
                    "description": " Reference to the Virtual K8s Quota object",
                    "title": "object_refs",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
        ...
        "virtual_k8s_quotacrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.virtual_k8s_quota.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/virtual_k8s_quota/crudapi/api.proto"
}`
