...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/resource_policy"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.resource_policy.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.resource_policy.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.resource_policy.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.resource_policy.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.resource_policy.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.resource_policy.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.resource_policy.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.resource_policy.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.resource_policy.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.resource_policy.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.resource_policy.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.resource_policy.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.resource_policy.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.resource_policy.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.resource_policy.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.resource_policy.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.resource_policy.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.resource_policy.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/resource_policy/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.resource_policy/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-resource_policy-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.resource_policy.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-resource_policy-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.resource_policy.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-resource_policy-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.resource_policy.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "resource_policy",
            "x-ves-object-type": "ves.io.schema.resource_policy.Object",
            "x-ves-proto-service": "ves.io.schema.resource_policy.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.resource_policy/Objects": {
            "get": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-resource_policy-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.resource_policy.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-resource_policy-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.resource_policy.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "resource_policy",
            "x-ves-object-type": "ves.io.schema.resource_policy.Object",
        ...
        "/ves.io.schema.resource_policy/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-resource_policy-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.resource_policy.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "resource_policy",
            "x-ves-object-type": "ves.io.schema.resource_policy.Object",
        ...
        "/ves.io.schema.resource_policy/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.resource_policy/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.resource_policy/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.resource_policy/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.resource_policy.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.resource_policy.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/resource_policySpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.resource_policy.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/resource_policycrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.resource_policy.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/resource_policycrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.resource_policy.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/resource_policyStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.resource_policy.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/resource_policycrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.resource_policy.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.resource_policy.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.resource_policy.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/resource_policycrudapiErrorCode"
                },
        ...
        "resource_policyGlobalSpecType": {
            "type": "object",
            "description": "Configuration specification for Resource Policy",
            "title": "GlobalSpecType",
            "x-displayname": "Global Configuration Specification",
            "x-ves-proto-message": "ves.io.schema.resource_policy.GlobalSpecType",
            "properties": {
                "rule_list": {
                    "type": "array",
                    "description": " List of resource access rules\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1024\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Policy Rule List",
                    "maxItems": 1024,
                    "items": {
                        "$ref": "#/definitions/resource_policyPolicyRuleType"
                    },
                ...
                "rules": {
                    "type": "array",
                    "description": " Generated Rules if rule_list is non-empty. These rules will get overwritten by system if rule_list is non-empty",
                    "title": "Rules",
                    "items": {
                        "$ref": "#/definitions/resource_policyRuleType"
                    },
                    "x-displayname": "Rules"
                }
            }
        },
        "resource_policyPolicyRuleType": {
            "type": "object",
            "description": "Rule for role permission",
            "title": "Policy Rule",
            "x-displayname": "Policy Rule",
            "x-ves-oneof-field-rule_choice": "[\"namespace_share\"]",
            "x-ves-proto-message": "ves.io.schema.resource_policy.PolicyRuleType",
            "properties": {
                "namespace_share": {
                    "description": "Exclusive with []\n Rule to access a given resource  within a tenant\n Implicit rule to access all resources in shared namespace with all namespace exist automatically",
                    "title": "User Resource Access Rule",
                    "$ref": "#/definitions/resource_policyUserRuleType",
                    "x-displayname": "User Resource Access Rule"
                }
            }
        },
        "resource_policyResourceListType": {
            "type": "object",
            "description": "List of resources in terms of resource-types/resource-instances and verbs",
            "title": "Resource List",
            "x-displayname": "Resource List",
            "x-ves-proto-message": "ves.io.schema.resource_policy.ResourceListType",
            "properties": {
                "resource_instances": {
                    "type": "array",
                    "description": " list of resource instances within the matched resource types, match any one.\n Use * for all resource instances\n\nExample: - \"private-network-tenant1\"-\n\nValidation Rules:\n  ves.io.schema.rules.repeated.items.string.max_bytes: 256\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.unique: true\n",
                    ...
                    "x-ves-example": "private-network-tenant1",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.repeated.items.string.max_bytes": "256",
                        "ves.io.schema.rules.repeated.max_items": "16",
                        "ves.io.schema.rules.repeated.unique": "true"
                ...
                "resource_types": {
                    "type": "array",
                    "description": " list of resource types, match any one\n\nExample: - \"virtual_network\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.max_bytes: 256\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Resource Type",
                    "minItems": 1,
                    "maxItems": 16,
                    "items": {
                ...
                "verbs": {
                    "type": "array",
                    "description": " Allowed list of verbs(operations) on resources. Use * for all operations\n\nExample: - \"get\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.in: [ \\\"*\\\", \\\"create\\\", \\\"get\\\", \\\"list\\\", \\\"replace\\\", \\\"use\\\"]\n  ves.io.schema.rules.repeated.items.string.max_bytes: 256\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Access Type",
                    "minItems": 1,
                    "maxItems": 16,
                    "items": {
        ...
        "resource_policyRuleType": {
            "type": "object",
            "description": "Access policy rule specification",
            "title": "Rule",
            "x-displayname": "Rule",
            "x-ves-proto-message": "ves.io.schema.resource_policy.RuleType",
            "properties": {
                "resource": {
                    "description": " Match access to the resource type/instance/access-type\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Resource Access Match",
                    "$ref": "#/definitions/resource_policyResourceListType",
                ...
                "subjects": {
                    "type": "array",
                    "description": " Allowed subjects who can access\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Allowed Tenant and Role",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/resource_policySubjectType"
                    },
        ...
        "resource_policySpecType": {
            "type": "object",
            "description": "Shape of the resource_policy specification",
            "title": "Specification for Resource Policy",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.resource_policy.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/resource_policyGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "resource_policyStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for Resource Policy",
            "x-displayname": "Resource Policy",
            "x-ves-proto-message": "ves.io.schema.resource_policy.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "resource_policySubjectType": {
            "type": "object",
            "description": "Allowed tuple  Of {tenant, namespace, role}",
            "title": "Subject Type",
            "x-displayname": "Subject Type",
            "x-ves-proto-message": "ves.io.schema.resource_policy.SubjectType",
            "properties": {
                "namespace": {
                    "type": "string",
                    "description": " namespace that is allowed access, * means all namespaces, empty means ignore namespace\n\nExample: - \"production\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_bytes: 64\n",
                    "title": "NameSpace",
                    "maxLength": 64,
                ...
                "role": {
                    "type": "string",
                    "description": " role within matching tenant and namespace is allowed access, * means all roles\n\nExample: - \"admin\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_bytes: 64\n  ves.io.schema.rules.string.min_bytes: 1\n",
                    "title": "Role",
                    "minLength": 1,
                    "maxLength": 64,
                    "x-displayname": "admin",
                ...
                "tenant": {
                    "type": "string",
                    "description": " tenant that is allowed access, * means all tenants, empty means ignore tenant\n\nExample: - \"tenant-1\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_bytes: 64\n",
                    "title": "Tenant",
                    "maxLength": 64,
        ...
        "resource_policyTenantRuleType": {
            "type": "object",
            "description": "x-displayName: \"Rule\"\nAccess policy rule specification",
            "title": "Rule",
            "properties": {
                "resource": {
                    "description": "x-displayName: \"Resource Access Match\"\nx-required\nMatch access to the resource type/instance/access-type",
                    "title": "Resource Access Match",
                    "$ref": "#/definitions/resource_policyResourceListType"
                },
                "tenants": {
                    "type": "array",
                    "description": "x-displayName: \"Allowed Tenant and Role\"\nx-required\nMatch access to the resource type/instance/access-type",
                    "title": "Allowed Tenant and Role",
                    "items": {
                        "$ref": "#/definitions/resource_policyTenantSubjectType"
                    }
                }
            }
        },
        "resource_policyTenantSubjectType": {
            "type": "object",
            "description": "x-displayName: \"Tenant Subject Type\"\nAllowed tuple  Of {tenant and role}",
            "title": "Tenant Subject Type",
            "properties": {
                "role": {
                    "type": "string",
        ...
        "resource_policyUserRuleType": {
            "type": "object",
            "description": "Access policy rule specification",
            "title": "Rule",
            "x-displayname": "Rule",
            "x-ves-proto-message": "ves.io.schema.resource_policy.UserRuleType",
            "properties": {
                "resource": {
                    "description": " Match access to the resource type/instance/access-type\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Resource Access Match",
                ...
                "users": {
                    "type": "array",
                    "description": " Allowed subjects who can access\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Allowed Namespace and Role",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/resource_policyUserSubjectType"
                    },
        ...
        "resource_policyUserSubjectType": {
            "type": "object",
            "description": "Allowed tuple  Of {namespace, role}",
            "title": "User Subject Type",
            "x-displayname": "User Subject Type",
            "x-ves-proto-message": "ves.io.schema.resource_policy.UserSubjectType",
            "properties": {
                "namespace": {
                    "type": "string",
                    "description": " namespace that is allowed access, * means all namespaces, empty means current namespace\n\nExample: - \"production\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_bytes: 64\n",
                    "title": "Namespace",
                    "maxLength": 64,
                    "x-displayname": "Namespace",
                    "x-ves-example": "production",
                ...
                "role": {
                    "type": "string",
                    "description": " role within matching namespace is allowed access, * means all role\n\nExample: - \"admin\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_bytes: 64\n  ves.io.schema.rules.string.min_bytes: 1\n",
                    "title": "Role",
                    "minLength": 1,
                    "maxLength": 64,
                    "x-displayname": "admin",
        ...
        "resource_policycrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.resource_policy.crudapi.ErrorCode"
        },
        "runtimeStreamError": {
            "type": "object",
            "properties": {
    ...
    "x-ves-proto-file": "ves.io/schema/resource_policy/crudapi/api.proto"
}`
