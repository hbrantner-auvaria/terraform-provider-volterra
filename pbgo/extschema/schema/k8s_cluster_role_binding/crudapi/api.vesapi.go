...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/k8s_cluster_role_binding"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.k8s_cluster_role_binding.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.k8s_cluster_role_binding.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.k8s_cluster_role_binding.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.k8s_cluster_role_binding.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.k8s_cluster_role_binding.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role_binding.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/k8s_cluster_role_binding/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.k8s_cluster_role_binding/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role_binding-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role_binding-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role_binding-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_cluster_role_binding",
            "x-ves-object-type": "ves.io.schema.k8s_cluster_role_binding.Object",
            "x-ves-proto-service": "ves.io.schema.k8s_cluster_role_binding.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.k8s_cluster_role_binding/Objects": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role_binding-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role_binding-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_cluster_role_binding",
            "x-ves-object-type": "ves.io.schema.k8s_cluster_role_binding.Object",
        ...
        "/ves.io.schema.k8s_cluster_role_binding/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role_binding-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_cluster_role_binding",
            "x-ves-object-type": "ves.io.schema.k8s_cluster_role_binding.Object",
        ...
        "/ves.io.schema.k8s_cluster_role_binding/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_cluster_role_binding/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_cluster_role_binding/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_cluster_role_binding/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.k8s_cluster_role_binding.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/k8s_cluster_role_bindingSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_cluster_role_bindingcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_cluster_role_bindingcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/k8s_cluster_role_bindingStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_cluster_role_bindingcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_cluster_role_bindingcrudapiErrorCode"
                },
        ...
        "k8s_cluster_role_bindingGlobalSpecType": {
            "type": "object",
            "description": "Configuration specification for Cluster Role Binding",
            "title": "GlobalSpecType",
            "x-displayname": "Global Configuration Specification",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.GlobalSpecType",
            "properties": {
                "k8s_cluster_role": {
                    "description": " K8s Cluster Role for which bindings are defined.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "subjects": {
                    ...
                    "maxItems": 256,
                    "items": {
                        "$ref": "#/definitions/k8s_cluster_role_bindingSubjectType"
                    },
        ...
        "k8s_cluster_role_bindingServiceAccountType": {
            ...
            "properties": {
                "name": {
                    "type": "string",
                    "description": " Name of the service account\n\nExample: - \"cd-app-controller\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 64\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "Name",
                    "minLength": 1,
                    "maxLength": 64,
                    "x-displayname": "Name",
                    "x-ves-example": "cd-app-controller",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.max_len": "64",
                ...
                "namespace": {
                    "type": "string",
                    "description": " Namespace of the service account\n\nExample: - \"cd-app-namespace\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 64\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "Namespace",
                    "minLength": 1,
                    "maxLength": 64,
                    "x-displayname": "Namespace",
                    "x-ves-example": "cd-app-namespace",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.max_len": "64",
        ...
        "k8s_cluster_role_bindingSpecType": {
            "type": "object",
            "description": "Shape of the k8s_cluster_role_binding specification",
            "title": "Specification for K8s Cluster Role Binding",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/k8s_cluster_role_bindingGlobalSpecType",
        ...
        "k8s_cluster_role_bindingStatusObject": {
            ...
            "title": "Status for K8s Cluster Role Binding",
            "x-displayname": "K8s Cluster Role Binding",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "k8s_cluster_role_bindingSubjectType": {
            "type": "object",
            "description": "Subject can be user or service account.",
            "title": "Subject",
            "x-displayname": "Subject",
            "x-ves-oneof-field-subject_choice": "[\"group\",\"service_account\",\"user\"]",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role_binding.SubjectType",
            "properties": {
                "group": {
                    "type": "string",
        ...
        "k8s_cluster_role_bindingcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.k8s_cluster_role_binding.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/k8s_cluster_role_binding/crudapi/api.proto"
}`
