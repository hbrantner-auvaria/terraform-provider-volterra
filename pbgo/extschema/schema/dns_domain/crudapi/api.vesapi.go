...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/dns_domain"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.dns_domain.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.dns_domain.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.dns_domain.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_domain.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_domain.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_domain.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_domain.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_domain.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.dns_domain.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.dns_domain.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_domain.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_domain.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_domain.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_domain.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_domain.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_domain.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_domain.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_domain.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/dns_domain/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.dns_domain/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_domain-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_domain.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_domain-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_domain.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_domain-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_domain.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_domain",
            "x-ves-object-type": "ves.io.schema.dns_domain.Object",
            "x-ves-proto-service": "ves.io.schema.dns_domain.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.dns_domain/Objects": {
            "get": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_domain-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_domain.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_domain-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_domain.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_domain",
            "x-ves-object-type": "ves.io.schema.dns_domain.Object",
        ...
        "/ves.io.schema.dns_domain/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-dns_domain-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.dns_domain.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "dns_domain",
            "x-ves-object-type": "ves.io.schema.dns_domain.Object",
        ...
        "/ves.io.schema.dns_domain/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_domain/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_domain/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.dns_domain/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.dns_domain.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_domain.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/dns_domainSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_domain.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_domaincrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_domain.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_domaincrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_domain.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dns_domainStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_domain.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_domaincrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_domain.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_domain.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_domain.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/dns_domaincrudapiErrorCode"
                },
        ...
        "dns_domainDNSDomainStatus": {
            "type": "object",
            "description": "Status DNS Domain",
            "title": "DNS Domain Status",
            "x-displayname": "DNS Domain Status",
            "x-ves-proto-message": "ves.io.schema.dns_domain.DNSDomainStatus",
            "properties": {
                "dnssec_status": {
                    "description": " Status of DNSSEC on the dns domain",
                    "title": "DNSSEC Status",
                    "$ref": "#/definitions/dns_domainDNSSECStatus",
                    "x-displayname": "DNSSEC Status"
                },
                "domain_verification": {
                    "description": " Status of DNS domain verification process.",
                    "title": "Domain Verification status",
                    "$ref": "#/definitions/dns_domainDNSDomainVerificationType",
        ...
        "dns_domainDNSDomainVerificationType": {
            "type": "string",
            "description": "Verification Status of DNS Domain\n\nVerification Status of DNS Domain has not succeeded yet\nVerification Status of DNS Domain is successful, sub domain can be used now\nVerification Status of DNS Domain has failed and this domain cannot be used.",
            "title": "DNS Domain Verification Type",
            "enum": [
                "DNS_DOMAIN_VERIFICATION_PENDING",
                "DNS_DOMAIN_VERIFICATION_SUCCESS",
                "DNS_DOMAIN_VERIFICATION_FAILED"
            ],
            "default": "DNS_DOMAIN_VERIFICATION_PENDING",
            "x-displayname": "DNS Domain Verification Type",
            "x-ves-proto-enum": "ves.io.schema.dns_domain.DNSDomainVerificationType"
        },
        "dns_domainDNSSECMode": {
            "type": "string",
            "description": "Enable or disable DNSSEC on the DNS Domain\n\nDNSSEC is disabled\nDNSSEC is enabled",
            "title": "DNSSEC Mode",
            "enum": [
                "DNSSEC_DISABLE",
                "DNSSEC_ENABLE"
            ],
            "default": "DNSSEC_DISABLE",
            "x-displayname": "DNSSEC Mode",
            "x-ves-proto-enum": "ves.io.schema.dns_domain.DNSSECMode"
        },
        "dns_domainDNSSECStatus": {
            "type": "object",
            "description": "Status of DNSSEC in DNS Domain",
            "title": "DNSSEC Status",
            "x-displayname": "DNSSEC Status",
            "x-ves-proto-message": "ves.io.schema.dns_domain.DNSSECStatus",
            "properties": {
                "algorithm": {
                    "type": "string",
                ...
                "digest": {
                    "type": "string",
                    "description": " DNSSEC Digest",
                    "title": "Digest",
                    "x-displayname": "Digest"
                },
                "digest_type": {
                    "type": "string",
                    "description": " Type of DNSSEC digest that follows",
                    "title": "Digest Type",
                    "x-displayname": "Digest Type"
                },
                "flags": {
                    "type": "string",
                    "description": " DNSSEC Flags",
                    "title": "Flags",
                    "x-displayname": "Flags"
                },
                "key_tag": {
                    "type": "string",
                    "description": " Key tag of DNSSEC, when enabled",
                    "title": "Key Tag",
                    "x-displayname": "Key Tag"
                },
                "mode": {
                    "description": " Indicate whether DNSSEC is enabled or disabled on the DNS domain",
                    "title": "DNSSEC Mode",
                ...
                "public_key": {
                    "type": "string",
                    "description": " The zone's public key",
                    "title": "Public Key",
                    "x-displayname": "Public Key"
                },
                "ttl": {
                    "type": "integer",
                    "description": " TTL value for DS record",
                    "title": "TTL",
                    "format": "int64",
                    "x-displayname": "TTL"
                }
        ...
        "dns_domainGlobalSpecType": {
            ...
            "properties": {
                "dnssec_mode": {
                    "description": " Control whether DNSSEC is enabled on the dns domain or not",
                    "title": "DNSSEC Mode",
                    "$ref": "#/definitions/dns_domainDNSSECMode",
                    "x-displayname": "DNSSEC Mode"
                },
        ...
        "dns_domainSpecType": {
            "type": "object",
            "description": "Shape of the DNS Domain specification",
            "title": "DNS Domain specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.dns_domain.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/dns_domainGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "dns_domainStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of DNS Domain",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.dns_domain.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "verification_status": {
                    ...
                    "$ref": "#/definitions/dns_domainDNSDomainStatus",
                    "x-displayname": "Verification Status"
                }
            }
        },
        "dns_domaincrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.dns_domain.crudapi.ErrorCode"
        },
    ...
    "x-ves-proto-file": "ves.io/schema/dns_domain/crudapi/api.proto"
}`
