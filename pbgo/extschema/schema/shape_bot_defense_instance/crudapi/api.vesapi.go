...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/shape_bot_defense_instance"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.shape_bot_defense_instance.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape_bot_defense_instance.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.shape_bot_defense_instance.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape_bot_defense_instance.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape_bot_defense_instance.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape_bot_defense_instance.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape_bot_defense_instance.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape_bot_defense_instance.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape_bot_defense_instance.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape_bot_defense_instance.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape_bot_defense_instance.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape_bot_defense_instance.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape_bot_defense_instance.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape_bot_defense_instance.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape_bot_defense_instance.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape_bot_defense_instance.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape_bot_defense_instance.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape_bot_defense_instance.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/shape_bot_defense_instance/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.shape_bot_defense_instance/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape_bot_defense_instance-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape_bot_defense_instance-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape_bot_defense_instance-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "shape_bot_defense_instance",
            "x-ves-object-type": "ves.io.schema.shape_bot_defense_instance.Object",
            "x-ves-proto-service": "ves.io.schema.shape_bot_defense_instance.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.shape_bot_defense_instance/Objects": {
            "get": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape_bot_defense_instance-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape_bot_defense_instance.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape_bot_defense_instance-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "shape_bot_defense_instance",
            "x-ves-object-type": "ves.io.schema.shape_bot_defense_instance.Object",
        ...
        "/ves.io.schema.shape_bot_defense_instance/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape_bot_defense_instance-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape_bot_defense_instance.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "shape_bot_defense_instance",
            "x-ves-object-type": "ves.io.schema.shape_bot_defense_instance.Object",
        ...
        "/ves.io.schema.shape_bot_defense_instance/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape_bot_defense_instance/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape_bot_defense_instance/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape_bot_defense_instance/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.shape_bot_defense_instance.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/schemashape_bot_defense_instanceSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/shape_bot_defense_instancecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/shape_bot_defense_instancecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/shape_bot_defense_instancecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/shape_bot_defense_instancecrudapiErrorCode"
                },
        ...
        "schemashape_bot_defense_instanceGlobalSpecType": {
            "type": "object",
            "description": "Configuration specification for VirtualHost",
            "title": "GlobalSpecType",
            "x-displayname": "Global Configuration Specification",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.GlobalSpecType",
            "properties": {
                "js_cluster": {
                    "type": "array",
                    "description": " Cluster for shared JS service",
                    "title": "Cluster for shared JS service (Horus js bundle generator)",
                    "items": {
                        "$ref": "#/definitions/ioschemaObjectRefType"
                    },
                ...
                "mobile": {
                    "description": " SSE Instance for Mobile traffic",
                    "title": "SSE Instance for Mobile traffic",
        ...
        "schemashape_bot_defense_instanceSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemashape_bot_defense_instanceGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "shape_bot_defense_instanceInstance": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape_bot_defense_instance.Instance",
            "properties": {
                "api_key": {
                    "description": " Shape API Key which is defined by DEX policy",
                    "title": "API key",
                ...
                "telemetry_prefix": {
                    "type": "string",
                    "description": " Shape Telemetry Prefix which is defined by DEX policy.\n\nExample: - \"Xa4vrhYP3Q-\"-",
                    "title": "Telemetry Prefix",
                    "x-displayname": "Telemetry Prefix",
                    "x-ves-example": "Xa4vrhYP3Q-"
                },
                "url": {
                    "type": "string",
                    "description": " URL of deployed shared Shape Bot Defense Instance.\n\nExample: - \"https://ibd-webus.fastcache.net/\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "URL of Shape Instance",
                    "x-displayname": "URL",
                    "x-ves-example": "https://ibd-webus.fastcache.net/",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
        ...
        "shape_bot_defense_instancecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.shape_bot_defense_instance.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/shape_bot_defense_instance/crudapi/api.proto"
}`
