...
// Request to fetch security evidence
type SecurityEvidenceRequest struct {
	...
	//
	// x-displayName: "Query"
	// x-example: "query={evidence_id="evd_2026021315_abc123"}"
	// query is used to specify the list of matchers
	// syntax for query := {[<matcher>]}
	// <matcher> := <field_name><operator>"<value>"
	// <field_name> := string
	...
	// x-displayName: "Start Time"
	// x-example: "1570007981"
	// fetch security evidence whose timestamp >= start_time
	// format: unix_timestamp|rfc 3339
	//
	// Optional: If not specified, then the start_time will be evaluated to end_time-10m
	//           If end_time is not specified, then the start_time will be evaluated to <current time>-10m
	...
	// x-displayName: "End Time"
	// x-example: "1570007981"
	// fetch security evidence whose timestamp <= end_time
	// format: unix_timestamp|rfc 3339
	//
	// Optional: If not specified, then the end_time will be evaluated to start_time+10m
	//           If start_time is not specified, then the end_time will be evaluated to <current time>
	...
	// x-displayName: "Limit"
	// x-example: "100"
	// limits the number of security evidence returned in the response
	...
	//
	// x-displayName: "Aggregations"
	// Aggregations provide summary/analytics data over the security evidence response. If the number of security evidence that matched the query
	// is large and cannot be returned in a single response message, user can get helpful insights/summary using aggregations.
	// The aggregations are key'ed by user-defined aggregation name. The response will be key'ed with the same name.
	// Optional
	Aggs map[string]*AggregationRequest `protobuf:"bytes,7,rep,name=aggs,proto3" json:"aggs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// search after
	//
	// x-displayName: "Search After"
	// x-example: "true"
	...
	// Note: Search After is used for processing large amount of data and therefore is not intended for real time user request.
	// Optional: default is false
	SearchAfter bool `protobuf:"varint,8,opt,name=search_after,json=searchAfter,proto3" json:"search_after,omitempty"`
	// sort values
	//
	// x-displayName: "Sort Values"
	// x-example: "{last_timestamp: 1745695692759, last_doc_id: -8881051689166072872}"
	// List of sort values that can be used to retrieve the next batch of log messages.
	SortValues *SearchAfterSortValues `protobuf:"bytes,9,opt,name=sort_values,json=sortValues,proto3" json:"sort_values,omitempty"`
	// sort by
	//
	// x-displayName: "Sort By"
	// Optional: default is sort by last_event_time
...
func (m *SecurityEvidenceRequest) Reset()      { *m = SecurityEvidenceRequest{} }
func (*SecurityEvidenceRequest) ProtoMessage() {}
func (*SecurityEvidenceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a9bb0a693f4ed96, []int{24}
}
func (m *SecurityEvidenceRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SecurityEvidenceRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SecurityEvidenceRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SecurityEvidenceRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SecurityEvidenceRequest.Merge(m, src)
}
func (m *SecurityEvidenceRequest) XXX_Size() int {
	return m.Size()
}
func (m *SecurityEvidenceRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SecurityEvidenceRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SecurityEvidenceRequest proto.InternalMessageInfo

func (m *SecurityEvidenceRequest) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *SecurityEvidenceRequest) GetQuery() string {
	if m != nil {
		return m.Query
	}
	return ""
...
func (m *SecurityEvidenceRequest) GetStartTime() string {
	if m != nil {
		return m.StartTime
	}
	return ""
...
func (m *SecurityEvidenceRequest) GetEndTime() string {
	if m != nil {
		return m.EndTime
	}
	return ""
...
func (m *SecurityEvidenceRequest) GetSort() schema.SortOrder {
	if m != nil {
		return m.Sort
	}
	return schema.DESCENDING
...
func (m *SecurityEvidenceRequest) GetLimit() int32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *SecurityEvidenceRequest) GetAggs() map[string]*AggregationRequest {
	if m != nil {
		return m.Aggs
	}
	return nil
...
func (m *SecurityEvidenceRequest) GetSearchAfter() bool {
	if m != nil {
		return m.SearchAfter
	}
	return false
...
func (m *SecurityEvidenceRequest) GetSortValues() *SearchAfterSortValues {
	if m != nil {
		return m.SortValues
	}
	return nil
...
func (m *SecurityEvidenceRequest) GetSortBy() string {
	if m != nil {
		return m.SortBy
	}
	return ""
...
//
// x-displayName: "Security Incidents Response"
// Response message for SecurityEvidenceRequest
type SecurityEvidenceResponse struct {
	...
	Evidences []string `protobuf:"bytes,1,rep,name=evidences,proto3" json:"evidences,omitempty"`
	// total hits
	//
	// x-displayName: "Total Hits"
	// x-example: "0"
	...
	//
	// x-displayName: "Aggregations"
	// Aggregations provide summary/analytics data over the security evidences response. If the number of security evidences
	// that matched the query is large and cannot be returned in a single response message, user can get helpful
	// insights/summary using aggregations.
	Aggs map[string]*log.LogAggregationData `protobuf:"bytes,3,rep,name=aggs,proto3" json:"aggs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// last sort values
	...
	// Empty list indicates no more messages to scroll (EOF).
	// Note: This is stateless and hence more performant than the scroll API.
	LastSortValues *SearchAfterSortValues `protobuf:"bytes,4,opt,name=last_sort_values,json=lastSortValues,proto3" json:"last_sort_values,omitempty"`
}

func (m *SecurityEvidenceResponse) Reset()      { *m = SecurityEvidenceResponse{} }
func (*SecurityEvidenceResponse) ProtoMessage() {}
func (*SecurityEvidenceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a9bb0a693f4ed96, []int{25}
}
func (m *SecurityEvidenceResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SecurityEvidenceResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SecurityEvidenceResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SecurityEvidenceResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SecurityEvidenceResponse.Merge(m, src)
}
func (m *SecurityEvidenceResponse) XXX_Size() int {
	return m.Size()
}
func (m *SecurityEvidenceResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SecurityEvidenceResponse.DiscardUnknown(m)
}

var xxx_messageInfo_SecurityEvidenceResponse proto.InternalMessageInfo

func (m *SecurityEvidenceResponse) GetEvidences() []string {
	if m != nil {
		return m.Evidences
	}
	return nil
...
func (m *SecurityEvidenceResponse) GetTotalHits() uint64 {
	if m != nil {
		return m.TotalHits
	}
	return 0
...
func (m *SecurityEvidenceResponse) GetAggs() map[string]*log.LogAggregationData {
	if m != nil {
		return m.Aggs
	}
	return nil
...
func (m *SecurityEvidenceResponse) GetLastSortValues() *SearchAfterSortValues {
	if m != nil {
		return m.LastSortValues
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SecurityEvidenceRequest)(nil), "ves.io.schema.app_security.SecurityEvidenceRequest")
	golang_proto.RegisterType((*SecurityEvidenceRequest)(nil), "ves.io.schema.app_security.SecurityEvidenceRequest")
	proto.RegisterMapType((map[string]*AggregationRequest)(nil), "ves.io.schema.app_security.SecurityEvidenceRequest.AggsEntry")
	golang_proto.RegisterMapType((map[string]*AggregationRequest)(nil), "ves.io.schema.app_security.SecurityEvidenceRequest.AggsEntry")
	proto.RegisterType((*SecurityEvidenceResponse)(nil), "ves.io.schema.app_security.SecurityEvidenceResponse")
	golang_proto.RegisterType((*SecurityEvidenceResponse)(nil), "ves.io.schema.app_security.SecurityEvidenceResponse")
	proto.RegisterMapType((map[string]*log.LogAggregationData)(nil), "ves.io.schema.app_security.SecurityEvidenceResponse.AggsEntry")
	golang_proto.RegisterMapType((map[string]*log.LogAggregationData)(nil), "ves.io.schema.app_security.SecurityEvidenceResponse.AggsEntry")
}
...
var fileDescriptor_0a9bb0a693f4ed96 = []byte{
	...
	,
}
...
func (this *SecurityEvidenceRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SecurityEvidenceRequest)
	if !ok {
		that2, ok := that.(SecurityEvidenceRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SecurityEvidenceResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SecurityEvidenceResponse)
	if !ok {
		that2, ok := that.(SecurityEvidenceResponse)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.Evidences) != len(that1.Evidences) {
		return false
	}
	for i := range this.Evidences {
		if this.Evidences[i] != that1.Evidences[i] {
			return false
		}
	}
	if this.TotalHits != that1.TotalHits {
...
func (this *SecurityEvidenceRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 14)
	s = append(s, "&app_security.SecurityEvidenceRequest{")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
	s = append(s, "Query: "+fmt.Sprintf("%#v", this.Query)+",\n")
	s = append(s, "StartTime: "+fmt.Sprintf("%#v", this.StartTime)+",\n")
	s = append(s, "EndTime: "+fmt.Sprintf("%#v", this.EndTime)+",\n")
...
func (this *SecurityEvidenceResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&app_security.SecurityEvidenceResponse{")
	s = append(s, "Evidences: "+fmt.Sprintf("%#v", this.Evidences)+",\n")
	s = append(s, "TotalHits: "+fmt.Sprintf("%#v", this.TotalHits)+",\n")
	keysForAggs := make([]string, 0, len(this.Aggs))
	for k, _ := range this.Aggs {
		keysForAggs = append(keysForAggs, k)
...
type AppSecurityMonitoringAPIClient interface {
	...
	// Security Evidence Query
	//
	// x-displayName: "Security Evidence Query"
	// Get security evidence for the given namespace.
	SecurityEvidenceQuery(ctx context.Context, in *SecurityEvidenceRequest, opts ...grpc.CallOption) (*SecurityEvidenceResponse, error)
}
...
func (c *appSecurityMonitoringAPIClient) SecurityEvidenceQuery(ctx context.Context, in *SecurityEvidenceRequest, opts ...grpc.CallOption) (*SecurityEvidenceResponse, error) {
	out := new(SecurityEvidenceResponse)
	err := c.cc.Invoke(ctx, "/ves.io.schema.app_security.AppSecurityMonitoringAPI/SecurityEvidenceQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppSecurityMonitoringAPIServer interface {
	...
	// x-displayName: "Security Evidence Query"
	// Get security evidence for the given namespace.
	SecurityEvidenceQuery(context.Context, *SecurityEvidenceRequest) (*SecurityEvidenceResponse, error)
}
...
func (*UnimplementedAppSecurityMonitoringAPIServer) SecurityEvidenceQuery(ctx context.Context, req *SecurityEvidenceRequest) (*SecurityEvidenceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SecurityEvidenceQuery not implemented")
}
...
func _AppSecurityMonitoringAPI_SecurityEvidenceQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SecurityEvidenceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppSecurityMonitoringAPIServer).SecurityEvidenceQuery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.app_security.AppSecurityMonitoringAPI/SecurityEvidenceQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppSecurityMonitoringAPIServer).SecurityEvidenceQuery(ctx, req.(*SecurityEvidenceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AppSecurityMonitoringAPI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SecurityEvidenceQuery",
			Handler:    _AppSecurityMonitoringAPI_SecurityEvidenceQuery_Handler,
		},
	},
...
func (m *SecurityEvidenceRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SecurityEvidenceRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SecurityEvidenceRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SecurityEvidenceResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SecurityEvidenceResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SecurityEvidenceResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Evidences) > 0 {
		for iNdEx := len(m.Evidences) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Evidences[iNdEx])
			copy(dAtA[i:], m.Evidences[iNdEx])
			i = encodeVarintPublicMonitoringApi(dAtA, i, uint64(len(m.Evidences[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *SecurityEvidenceRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SecurityEvidenceResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *SecurityEvidenceRequest) String() string {
	if this == nil {
		return "nil"
	}
	keysForAggs := make([]string, 0, len(this.Aggs))
	...
	mapStringForAggs += "}"
	s := strings.Join([]string{`&SecurityEvidenceRequest{`,
		`Namespace:` + fmt.Sprintf("%v", this.Namespace) + `,`,
		`Query:` + fmt.Sprintf("%v", this.Query) + `,`,
		`StartTime:` + fmt.Sprintf("%v", this.StartTime) + `,`,
		`EndTime:` + fmt.Sprintf("%v", this.EndTime) + `,`,
...
func (this *SecurityEvidenceResponse) String() string {
	if this == nil {
		return "nil"
	}
	keysForAggs := make([]string, 0, len(this.Aggs))
	...
	mapStringForAggs += "}"
	s := strings.Join([]string{`&SecurityEvidenceResponse{`,
		`Evidences:` + fmt.Sprintf("%v", this.Evidences) + `,`,
		`TotalHits:` + fmt.Sprintf("%v", this.TotalHits) + `,`,
		`Aggs:` + mapStringForAggs + `,`,
		`LastSortValues:` + strings.Replace(this.LastSortValues.String(), "SearchAfterSortValues", "SearchAfterSortValues", 1) + `,`,
		`}`,
...
func (m *SecurityEvidenceRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SecurityEvidenceRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SecurityEvidenceRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SecurityEvidenceResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SecurityEvidenceResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SecurityEvidenceResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Evidences = append(m.Evidences, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalHits", wireType)
