...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ztna_applications", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ztna_applications/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ztna_applications/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/ztna_applications", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.ztna_application.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.ztna_application")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna_application.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna_application.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna_application.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna_application.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.ztna_application.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.ztna_application.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.ztna_application.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna_application.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ztna_application.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.ztna_application.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.ztna_application.API.Create' operation on 'ztna_application'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.ztna_application.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.ztna_application.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna_application.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ztna_application.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.ztna_application.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.ztna_application.API.Replace' operation on 'ztna_application'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.ztna_application.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna_application.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.ztna_application.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna_application.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.ztna_application.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.ztna_application.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.ztna_application.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.ztna_application.API.Delete' operation on 'ztna_application'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.ztna_application.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Represents ztna application configuration for a given tenant",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/ztna_applications": {
            "post": {
                "summary": "Create User",
                "operationId": "ves.io.schema.ztna_application.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ztna_applicationCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ztna_applicationCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna_application-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna_application.API.Create"
            },
            "x-displayname": "Application configuration",
            "x-ves-proto-service": "ves.io.schema.ztna_application.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/ztna_applications/{metadata.name}": {
            "put": {
                "summary": "Replace User",
                "operationId": "ves.io.schema.ztna_application.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ztna_applicationReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ztna_applicationReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna_application-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna_application.API.Replace"
            },
            "x-displayname": "Application configuration",
            "x-ves-proto-service": "ves.io.schema.ztna_application.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/ztna_applications": {
            "get": {
                "summary": "List Application configuration",
                "description": "List the set of ztna_application in a namespace",
                "operationId": "ves.io.schema.ztna_application.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ztna_applicationListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    {
                        "name": "namespace",
                        "description": "namespace\n\nx-example: \"ns1\"\nNamespace to scope the listing of ztna_application",
                        "in": "path",
                        "required": true,
                        "type": "string",
                        "x-displayname": "Namespace"
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna_application-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna_application.API.List"
            },
            "x-displayname": "Application configuration",
            "x-ves-proto-service": "ves.io.schema.ztna_application.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/ztna_applications/{name}": {
            "get": {
                "summary": "Get User",
                "operationId": "ves.io.schema.ztna_application.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ztna_applicationGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna_application-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna_application.API.Get"
            },
            "delete": {
                "summary": "Delete Application configuration",
                "description": "Delete the specified ztna_application",
                "operationId": "ves.io.schema.ztna_application.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ztna_applicationDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-ztna_application-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.ztna_application.API.Delete"
            },
            "x-displayname": "Application configuration",
            "x-ves-proto-service": "ves.io.schema.ztna_application.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "ztna_applicationCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of ztna_application",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.ztna_application.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the ztna_application",
                    "title": "spec",
                    "$ref": "#/definitions/ztna_applicationCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "ztna_applicationCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ztna_application.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the ztna_application",
                    "title": "spec",
                    "$ref": "#/definitions/ztna_applicationGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "ztna_applicationCreateSpecType": {
            "type": "object",
            "title": "CreateSpecType",
            "x-displayname": "Create User",
            "x-ves-proto-message": "ves.io.schema.ztna_application.CreateSpecType",
            "properties": {
                "domain_name": {
                    "type": "string",
                    "description": " ztna_application's Domain name\n\nExample: - \"my.example.com\"-",
                    "x-displayname": "Domain name",
                    "x-ves-example": "my.example.com"
                },
                "msg": {
                    "description": " Denotes the service IP address and port",
                    "$ref": "#/definitions/ztna_applicationServiceDetails",
                    "x-displayname": "Service details"
                },
                "policies": {
                    "description": " Denotes the ZTNA policies",
                    "$ref": "#/definitions/ztna_applicationZTNApolicies",
                    "x-displayname": "ZTNA policies"
                },
                "proxy_advertisement": {
                    "description": " Proxy Advertisement choice",
                    "$ref": "#/definitions/ztna_applicationProxyAdvertisementType",
        ...
        "ztna_applicationDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a ztna_application",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.ztna_application.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "ztna_applicationGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read ztna_application",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.ztna_application.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/ztna_applicationStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "ztna_applicationGetResponseFormatCode": {
            "type": "string",
        ...
        "ztna_applicationGetSpecType": {
            "type": "object",
            "title": "GetSpecType",
            "x-displayname": "Get User",
            "x-ves-proto-message": "ves.io.schema.ztna_application.GetSpecType",
            "properties": {
                "domain_name": {
                    "type": "string",
                    "description": " ztna_application's Domain name\n\nExample: - \"my.example.com\"-",
        ...
        "ztna_applicationListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of ztna_application",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.ztna_application.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/ztna_applicationListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "ztna_applicationListResponseItem": {
            "type": "object",
            "description": "By default a summary of ztna_application is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of ztna_application",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.ztna_application.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this ztna_application",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this ztna_application",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates ztna_application is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this ztna_application",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this ztna_application\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this ztna_application\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "ztna_applicationProxyAdvertisementType": {
            "type": "object",
            ...
            "x-ves-proto-message": "ves.io.schema.ztna_application.ProxyAdvertisementType",
            "properties": {
                "advertise_custom": {
        ...
        "ztna_applicationReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a ztna_application",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.ztna_application.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the ztna_application",
                    "title": "spec",
                    "$ref": "#/definitions/ztna_applicationReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "ztna_applicationReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.ztna_application.ReplaceResponse"
        },
        "ztna_applicationReplaceSpecType": {
            "type": "object",
            "title": "ReplaceSpecType",
            "x-displayname": "Replace User",
            "x-ves-proto-message": "ves.io.schema.ztna_application.ReplaceSpecType",
            "properties": {
                "domain_name": {
                    "type": "string",
                    "description": " ztna_application's Domain name\n\nExample: - \"my.example.com\"-",
        ...
        "ztna_applicationServiceDetails": {
            "type": "object",
            "description": "Object represents a service IP in the system.\nThis message is part of the ZTNA application schema.",
            "title": "Service Details",
            "x-displayname": "Service Details",
            "x-ves-proto-message": "ves.io.schema.ztna_application.ServiceDetails",
            "properties": {
                "ip": {
                    "description": " Used to set the Service IP",
                    "title": "Service IP",
        ...
        "ztna_applicationTransportType": {
            ...
            "default": "UDP",
            "x-displayname": "Transport Type",
            "x-ves-proto-enum": "ves.io.schema.ztna_application.TransportType"
        },
        "ztna_applicationZTNApolicies": {
            "type": "object",
            "description": "Object represents a policy in the system.\nThis message is part of the ZTNA application schema.",
            "title": "ZTNA policies",
            "x-displayname": "ZTNA policies",
            "x-ves-proto-message": "ves.io.schema.ztna_application.ZTNApolicies",
            "properties": {
                "connectivity_policy_name": {
                    "type": "string",
                    "description": " Used to set the Connectivity policy name\n\nExample: - \"connectivity_demo\"-",
                ...
                "message_policy_name": {
                    "type": "string",
                    "description": " Used to set the Message policy name\n\nExample: - \"msg_demo\"-",
                    "title": "Message policy name",
                    "x-displayname": "Message policy name ",
                    "x-ves-example": "msg_demo"
                },
                "session_policy_name": {
                    "type": "string",
                    "description": " Used to set the session policy name\n\nExample: - \"ara_p1\"-",
                    "title": "session policy name",
                    "x-displayname": "session policy name",
                    "x-ves-example": "ara_p1"
                }
            }
        }
    },
    "x-displayname": "Application configuration",
    "x-ves-proto-file": "ves.io/schema/ztna_application/public_crudapi.proto"
}`
