...
func initializeRPCRegistry(mdr *svcfw.MDRegistry) {
	mdr.RPCSubscriptionFieldsRegistry["ves.io.schema.ztna_application.API.Create"] = []svcfw.SubscriptionField{
		{
			FieldPath:     "ves.io.schema.ztna_application.CreateRequest.spec.proxy_advertisement.advertise_choice.advertise_custom.advertise_where.choice.advertise_dualstack_on_public",
			AddonServices: []string{"f5xc-ipv6-standard"},
		},
		{
			FieldPath:     "ves.io.schema.ztna_application.CreateRequest.spec.proxy_advertisement.advertise_choice.advertise_custom.advertise_where.choice.advertise_v6_on_public",
			AddonServices: []string{"f5xc-ipv6-standard"},
		},
		{
	...
	mdr.RPCSubscriptionFieldsRegistry["ves.io.schema.ztna_application.API.Replace"] = []svcfw.SubscriptionField{
		{
			FieldPath:     "ves.io.schema.ztna_application.ReplaceRequest.spec.proxy_advertisement.advertise_choice.advertise_custom.advertise_where.choice.advertise_dualstack_on_public",
			AddonServices: []string{"f5xc-ipv6-standard"},
		},
		{
			FieldPath:     "ves.io.schema.ztna_application.ReplaceRequest.spec.proxy_advertisement.advertise_choice.advertise_custom.advertise_where.choice.advertise_v6_on_public",
			AddonServices: []string{"f5xc-ipv6-standard"},
		},
		{
