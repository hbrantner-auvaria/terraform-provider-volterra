...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/k8s_cluster_role"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.k8s_cluster_role.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.k8s_cluster_role.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.k8s_cluster_role.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_cluster_role.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.k8s_cluster_role.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.k8s_cluster_role.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_cluster_role.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_cluster_role.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/k8s_cluster_role/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.k8s_cluster_role/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_cluster_role",
            "x-ves-object-type": "ves.io.schema.k8s_cluster_role.Object",
            "x-ves-proto-service": "ves.io.schema.k8s_cluster_role.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.k8s_cluster_role/Objects": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_cluster_role.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role-crudapi-api-create"
                },
        ...
        "/ves.io.schema.k8s_cluster_role/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_cluster_role-crudapi-api-liststream"
                },
        ...
        "/ves.io.schema.k8s_cluster_role/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_cluster_role/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_cluster_role/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_cluster_role/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.k8s_cluster_role.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/k8s_cluster_roleSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_cluster_rolecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_cluster_rolecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/k8s_cluster_roleStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_cluster_rolecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_cluster_rolecrudapiErrorCode"
                },
        ...
        "k8s_cluster_roleGlobalSpecType": {
            "type": "object",
            "description": "Configuration specification for K8s Cluster Role",
            "title": "GlobalSpecType",
            "x-displayname": "Global Configuration Specification",
            "x-ves-oneof-field-rule_choice": "[\"k8s_cluster_role_selector\",\"policy_rule_list\",\"yaml\"]",
        ...
        "k8s_cluster_roleNonResourceURLListType": {
            ...
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.NonResourceURLListType",
            "properties": {
                "urls": {
                    "type": "array",
                ...
                "verbs": {
                    "type": "array",
                    "description": " Allowed list of verbs(operations) on resources. Use VerbAll for all operations\n\nExample: - \"get\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.max_bytes: 256\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Allowed Verbs",
                    "minItems": 1,
                    "maxItems": 16,
                    "items": {
        ...
        "k8s_cluster_rolePolicyRuleListType": {
            ...
            "title": "Policy Rule List",
            "x-displayname": "Policy Rule List",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.PolicyRuleListType",
            "properties": {
                "policy_rule": {
                    "type": "array",
                    "description": " List of rules for role permissions\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    ...
                    "maxItems": 16,
                    "items": {
                        "$ref": "#/definitions/k8s_cluster_rolePolicyRuleType"
                    },
        ...
        "k8s_cluster_rolePolicyRuleType": {
            ...
            "x-ves-oneof-field-resource_choice": "[\"non_resource_url_list\",\"resource_list\"]",
        ...
        "k8s_cluster_roleResourceListType": {
            ...
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.ResourceListType",
            "properties": {
                "api_groups": {
                    "type": "array",
                    "description": " Allowed list of API group that contains resources, all resources of a given api group\n\nExample: - \"rbac.authorization.k8s.io\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.max_bytes: 256\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "API Groups",
                    "minItems": 1,
                    "maxItems": 16,
                    "items": {
                    ...
                    "x-ves-example": "rbac.authorization.k8s.io",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.repeated.items.string.max_bytes": "256",
                ...
                "resource_instances": {
                    "type": "array",
                    "description": " Allowed list of resource instances within the resource types.\n\nExample: - \"admin\"-\n\nValidation Rules:\n  ves.io.schema.rules.repeated.items.string.max_bytes: 256\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.unique: true\n",
                ...
                "resource_types": {
                    "type": "array",
                    "description": " Allowed list of resource types within the api groups.\n\nExample: - \"role\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.max_bytes: 256\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Resource Type",
                    "minItems": 1,
                    "maxItems": 16,
                    "items": {
        ...
        "k8s_cluster_roleSpecType": {
            "type": "object",
            "description": "Shape of the k8s_cluster_role specification",
            "title": "Specification for K8s Cluster Role",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/k8s_cluster_roleGlobalSpecType",
        ...
        "k8s_cluster_roleStatusObject": {
            ...
            "title": "Status for K8s Cluster Role",
            "x-displayname": "K8s Cluster Role",
            "x-ves-proto-message": "ves.io.schema.k8s_cluster_role.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "k8s_cluster_rolecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.k8s_cluster_role.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/k8s_cluster_role/crudapi/api.proto"
}`
