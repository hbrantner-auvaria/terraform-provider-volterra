...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/infraprotect_asn_prefix"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.infraprotect_asn_prefix.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.infraprotect_asn_prefix.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.infraprotect_asn_prefix.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn_prefix.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.infraprotect_asn_prefix.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.infraprotect_asn_prefix.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn_prefix.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn_prefix.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn_prefix.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn_prefix.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.infraprotect_asn_prefix.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/infraprotect_asn_prefix/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.infraprotect_asn_prefix/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn_prefix-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn_prefix-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn_prefix-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_asn_prefix",
            "x-ves-object-type": "ves.io.schema.infraprotect_asn_prefix.Object",
            "x-ves-proto-service": "ves.io.schema.infraprotect_asn_prefix.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.infraprotect_asn_prefix/Objects": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn_prefix-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn_prefix-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_asn_prefix",
            "x-ves-object-type": "ves.io.schema.infraprotect_asn_prefix.Object",
        ...
        "/ves.io.schema.infraprotect_asn_prefix/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-infraprotect_asn_prefix-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "infraprotect_asn_prefix",
            "x-ves-object-type": "ves.io.schema.infraprotect_asn_prefix.Object",
        ...
        "/ves.io.schema.infraprotect_asn_prefix/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_asn_prefix/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_asn_prefix/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.infraprotect_asn_prefix/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.infraprotect_asn_prefix.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/infraprotect_asn_prefixSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_asn_prefixcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_asn_prefixcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/infraprotect_asn_prefixStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_asn_prefixcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/infraprotect_asn_prefixcrudapiErrorCode"
                },
        ...
        "infraprotect_asn_prefixGlobalSpecType": {
            "type": "object",
            "description": "DDos Transit Prefix spec",
            ...
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.GlobalSpecType",
            "properties": {
                "asn": {
                ...
                "irr_status_missing": {
                    "description": "Exclusive with [irr_status_unverified irr_status_valid]\n Missing",
                    "title": "Missing",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Missing"
                },
                "irr_status_unverified": {
                    "description": "Exclusive with [irr_status_missing irr_status_valid]\n Unverified",
                    "title": "Unverified",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Unverified"
                },
                "irr_status_valid": {
                    "description": "Exclusive with [irr_status_missing irr_status_unverified]\n Valid",
                    "title": "Valid",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Valid"
                },
                ...
                "review_type_approved": {
                    "description": "Exclusive with [review_type_grace review_type_pending review_type_rejected]\n Approved",
                    "title": "Approved",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Approved"
                },
                "review_type_grace": {
                    "description": "Exclusive with [review_type_approved review_type_pending review_type_rejected]\n A prefix losing its valid status will transition to grace notify before being rejected",
                    "title": "Grace Notify",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Grace Notify"
                },
                "review_type_pending": {
                    "description": "Exclusive with [review_type_approved review_type_grace review_type_rejected]\n Pending",
                    "title": "Pending",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Pending"
                },
                "review_type_rejected": {
                    "description": "Exclusive with [review_type_approved review_type_grace review_type_pending]\n Rejected",
                    "title": "Rejected",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Rejected"
                },
                "rpki_status_invalid": {
                    "description": "Exclusive with [rpki_status_unknown rpki_status_unverified rpki_status_valid]\n Invalid",
                    "title": "Invalid",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Invalid"
                },
                "rpki_status_unknown": {
                    "description": "Exclusive with [rpki_status_invalid rpki_status_unverified rpki_status_valid]\n Unknown",
                    "title": "Unknown",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Unknown"
                },
                "rpki_status_unverified": {
                    "description": "Exclusive with [rpki_status_invalid rpki_status_unknown rpki_status_valid]\n Unverified",
                    "title": "Unverified",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Unverified"
                },
                "rpki_status_valid": {
                    "description": "Exclusive with [rpki_status_invalid rpki_status_unknown rpki_status_unverified]\n Valid",
                    "title": "Valid",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Valid"
                },
        ...
        "infraprotect_asn_prefixSpecType": {
            "type": "object",
            "description": "Infraprotect ASN Prefix Object",
            "title": "Infraprotect ASN Prefix Specification",
            "x-displayname": "ASN Prefix Specification",
            "x-ves-proto-message": "ves.io.schema.infraprotect_asn_prefix.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/infraprotect_asn_prefixGlobalSpecType",
        ...
        "infraprotect_asn_prefixcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.infraprotect_asn_prefix.crudapi.ErrorCode"
        },
    ...
    "x-ves-proto-file": "ves.io/schema/infraprotect_asn_prefix/crudapi/api.proto"
}`
