...
const (
	ObjectDefTblName = "ves.io.schema.traffic_policy.Object.default"
	ObjectType       = "ves.io.schema.traffic_policy.Object"

	StatusObjectDefTblName = "ves.io.schema.traffic_policy.StatusObject.default"
	StatusObjectType       = "ves.io.schema.traffic_policy.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.traffic_policy.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.traffic_policy.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.traffic_policy.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.traffic_policy.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.traffic_policy.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "traffic_policy.Object")
	if err != nil {
