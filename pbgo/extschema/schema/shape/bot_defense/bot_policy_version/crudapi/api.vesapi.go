...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/shape/bot_defense/bot_policy_version"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.shape.bot_defense.bot_policy_version.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/shape/bot_defense/bot_policy_version/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.shape.bot_defense.bot_policy_version/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_policy_version-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_policy_version-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_policy_version-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bot_policy_version",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.bot_policy_version.Object",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.shape.bot_defense.bot_policy_version/Objects": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_policy_version-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_policy_version-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bot_policy_version",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.bot_policy_version.Object",
        ...
        "/ves.io.schema.shape.bot_defense.bot_policy_version/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_policy_version-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bot_policy_version",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.bot_policy_version.Object",
        ...
        "/ves.io.schema.shape.bot_defense.bot_policy_version/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.bot_policy_version/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.bot_policy_version/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.bot_policy_version/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "bot_policy_versionGlobalSpecType": {
            "type": "object",
            "description": "Configures Bot Allowlist Policy Version",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-oneof-field-policy_choice": "[\"allowlist_policy_content\",\"endpoint_policy_content\",\"network_policy_content\"]",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.GlobalSpecType",
            "properties": {
                "allowlist_policy_content": {
                    "description": "Exclusive with [endpoint_policy_content network_policy_content]\n IP Allowlists for Allowlist Policy",
                    "title": "IP Allowlists for Allowlist Policy",
                    "$ref": "#/definitions/bot_defenseIPAllowlists",
                    "x-displayname": "IP Allowlists"
                },
                "bot_infra_names": {
                    "type": "array",
                    "description": " The Bot Infra Names which are using this the version",
                    "title": "The list of Bot Infrastructure Name",
                    "items": {
                        "type": "string"
                    },
                ...
                "version_status": {
                    "description": " Version status: draft, in use, published",
                    "title": "Policy Version status",
                    "$ref": "#/definitions/bot_policy_versionVersionStatus",
                    "x-displayname": "Policy Version Status"
                }
            }
        },
        "bot_policy_versionSpecType": {
            "type": "object",
            "description": "Bot Infra Policy Version specification",
            "title": "Specification of Bot Infra Policy Version",
            "x-displayname": "Specification of Bot Infra Policy Version",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/bot_policy_versionGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "bot_policy_versionStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "bot_policy_versionVersionStatus": {
            "type": "object",
            "description": "Version status",
            "title": "The status of Version",
            "x-displayname": "Version Status Type",
            "x-ves-oneof-field-status_type_choice": "[\"in_use\",\"published\"]",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.VersionStatus",
            "properties": {
                "in_use": {
                    "description": "Exclusive with [published]\n In-user status",
                    "title": "In-use status",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "In Use"
                },
                "published": {
                    "description": "Exclusive with [in_use]\n published status",
        ...
        "bot_policy_versioncrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/bot_policy_versionSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bot_policy_versioncrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bot_policy_versioncrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/bot_policy_versionStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bot_policy_versioncrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_policy_version.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bot_policy_versioncrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/shape/bot_defense/bot_policy_version/crudapi/api.proto"
}`
