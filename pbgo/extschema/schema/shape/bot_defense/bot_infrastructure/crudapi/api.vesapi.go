...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/shape/bot_defense/bot_infrastructure"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/shape/bot_defense/bot_infrastructure/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.shape.bot_defense.bot_infrastructure/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bot_infrastructure",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.bot_infrastructure.Object",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.shape.bot_defense.bot_infrastructure/Objects": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bot_infrastructure",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.bot_infrastructure.Object",
        ...
        "/ves.io.schema.shape.bot_defense.bot_infrastructure/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bot_infrastructure",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.bot_infrastructure.Object",
        ...
        "/ves.io.schema.shape.bot_defense.bot_infrastructure/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.bot_infrastructure/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.bot_infrastructure/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.bot_infrastructure/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "bot_defensebot_infrastructureGlobalSpecType": {
            "type": "object",
            "description": "Configures Bot Infrastructure by Bot Defense",
            ...
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.GlobalSpecType",
            "properties": {
                "bot_allowlist_policy_metadata": {
                    "title": "Bot Allowlist Policy Metadata",
                ...
                "bot_network_policy_metadata": {
                    "title": "Bot Network Policy Metadata",
                    "$ref": "#/definitions/bot_infrastructurePolicyMetadata",
                ...
                "bot_ti_package_information": {
                    ...
                    "title": "Bot Threat Intelligence Package Information",
        ...
        "bot_infrastructureSpecType": {
            "type": "object",
            "description": "Shape of Bot Infrastructure specification",
            "title": "Specification of Bot Infrastructure",
            "x-displayname": "Specification of Bot Infrastructure ",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/bot_defensebot_infrastructureGlobalSpecType",
        ...
        "bot_infrastructurecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/bot_infrastructureSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bot_infrastructurecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bot_infrastructurecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bot_infrastructurecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bot_infrastructurecrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/shape/bot_defense/bot_infrastructure/crudapi/api.proto"
}`
