...
const (
	...
	SYNC_STATUS_UNKNOWN SyncStatus = 0
	// x-displayName: "Out of Sync"
	// The Kubernetes cluster is out of sync with the latest policies
	SYNC_STATUS_OUT_OF_SYNC SyncStatus = 1
	// x-displayName: "In Sync"
	// The Kubernetes cluster is in sync with the latest policies
	SYNC_STATUS_IN_SYNC SyncStatus = 2
)

var SyncStatus_name = map[int32]string{
	0: "SYNC_STATUS_UNKNOWN",
	1: "SYNC_STATUS_OUT_OF_SYNC",
	2: "SYNC_STATUS_IN_SYNC",
}

var SyncStatus_value = map[string]int32{
	"SYNC_STATUS_UNKNOWN":     0,
	"SYNC_STATUS_OUT_OF_SYNC": 1,
	"SYNC_STATUS_IN_SYNC":     2,
}
...
// The status of certificate application to the ingress
type CertificateStatus int32

const (
	// x-displayName: "Undefined"
	// Certificate status is undefined (initial state, before first sync)
	CERT_STATUS_UNDEFINED CertificateStatus = 0
	// x-displayName: "Applied"
	// Certificate has been successfully applied to the ingress
	CERT_STATUS_APPLIED CertificateStatus = 1
	// x-displayName: "Not Applied"
	// Certificate is not applied
	CERT_STATUS_NOT_APPLIED CertificateStatus = 2
)

var CertificateStatus_name = map[int32]string{
	0: "CERT_STATUS_UNDEFINED",
	1: "CERT_STATUS_APPLIED",
	2: "CERT_STATUS_NOT_APPLIED",
}

var CertificateStatus_value = map[string]int32{
	"CERT_STATUS_UNDEFINED":   0,
	"CERT_STATUS_APPLIED":     1,
	"CERT_STATUS_NOT_APPLIED": 2,
}
...
type GlobalSpecType struct {
	...
	// x-displayName: "Infra Type"
	// x-required
	// Identifies if this is an F5 Cloud Hosted, F5 Hosted, Kubernetes or On-Premises infrastructure.
	//
	...
	// By default, the mode will be Reverse Proxy. You need to submit a support ticket to request for API mode.
	DeploymentMode bot_defense.DeploymentMode `protobuf:"varint,26,opt,name=deployment_mode,json=deploymentMode,proto3,enum=ves.io.schema.shape.bot_defense.DeploymentMode" json:"deployment_mode,omitempty"`
	// Infra Tag
	//
	// x-displayName: "Infra Tag"
	// x-example: "infratag"
	// Infra Tag
	ClusterTag string `protobuf:"bytes,27,opt,name=cluster_tag,json=clusterTag,proto3" json:"cluster_tag,omitempty"`
	// Bot Threat Intelligence Package Information
	//
	// x-displayName: "Bot Threat Intelligence Package"
	// Specifies the threat intelligence package to be used for bot detection and mitigation.
	BotTiPackageInformation *TIPackageInformation `protobuf:"bytes,29,opt,name=bot_ti_package_information,json=botTiPackageInformation,proto3" json:"bot_ti_package_information,omitempty"`
}
...
type GlobalSpecType_Kubernetes struct {
	Kubernetes *InfraContainerizedHosted `protobuf:"bytes,28,opt,name=kubernetes,proto3,oneof" json:"kubernetes,omitempty"`
}
...
func (*GlobalSpecType_Kubernetes) isGlobalSpecType_BotInfraChoice()              {}
...
func (m *GlobalSpecType) GetKubernetes() *InfraContainerizedHosted {
	if x, ok := m.GetBotInfraChoice().(*GlobalSpecType_Kubernetes); ok {
		return x.Kubernetes
	}
	return nil
}
...
func (m *GlobalSpecType) GetClusterTag() string {
	if m != nil {
		return m.ClusterTag
	}
	return ""
...
func (m *GlobalSpecType) GetBotTiPackageInformation() *TIPackageInformation {
	if m != nil {
		return m.BotTiPackageInformation
	}
	return nil
}
...
// F5 Containerized Hosted
//
// x-displayName: "Containerized Hosted"
type InfraContainerizedHosted struct {
	// Infra host name
	//
	// x-displayName: "Infra Host Name"
	// x-example: "www.example.com"
	...
	// Targeted Firmware Version is the new version.
	...
	KubernetesCluster []*KubernetesCluster `protobuf:"bytes,3,rep,name=kubernetes_cluster,json=kubernetesCluster,proto3" json:"kubernetes_cluster,omitempty"`
	// Infra Sync Status
	//
	// x-displayName: "Infra Sync Status"
	// The sync status of the containerized hosted infrastructure
	InfraSyncStatus SyncStatus `protobuf:"varint,4,opt,name=infra_sync_status,json=infraSyncStatus,proto3,enum=ves.io.schema.shape.bot_defense.bot_infrastructure.SyncStatus" json:"infra_sync_status,omitempty"`
	// Last Updated By
	//
	// x-displayName: "Last Updated By"
	// The identifier of the last user that updated the infrastructure configuration.
	LastUpdatedBy string `protobuf:"bytes,5,opt,name=last_updated_by,json=lastUpdatedBy,proto3" json:"last_updated_by,omitempty"`
}

func (m *InfraContainerizedHosted) Reset()      { *m = InfraContainerizedHosted{} }
func (*InfraContainerizedHosted) ProtoMessage() {}
func (*InfraContainerizedHosted) Descriptor() ([]byte, []int) {
	return fileDescriptor_841e8f848b141fd8, []int{3}
}
func (m *InfraContainerizedHosted) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *InfraContainerizedHosted) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *InfraContainerizedHosted) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InfraContainerizedHosted.Merge(m, src)
}
func (m *InfraContainerizedHosted) XXX_Size() int {
	return m.Size()
}
func (m *InfraContainerizedHosted) XXX_DiscardUnknown() {
	xxx_messageInfo_InfraContainerizedHosted.DiscardUnknown(m)
}

var xxx_messageInfo_InfraContainerizedHosted proto.InternalMessageInfo

func (m *InfraContainerizedHosted) GetInfraHostName() string {
	if m != nil {
		return m.InfraHostName
	}
	return ""
...
func (m *InfraContainerizedHosted) GetTargetFirmwareVersion() string {
	if m != nil {
		return m.TargetFirmwareVersion
	}
	return ""
}

func (m *InfraContainerizedHosted) GetKubernetesCluster() []*KubernetesCluster {
	if m != nil {
...
func (m *InfraContainerizedHosted) GetInfraSyncStatus() SyncStatus {
	if m != nil {
		return m.InfraSyncStatus
	}
	return SYNC_STATUS_UNKNOWN
}

func (m *InfraContainerizedHosted) GetLastUpdatedBy() string {
	if m != nil {
...
// Represents a single Kubernetes cluster associated with the Containerized Hosted infrastructure.
...
type KubernetesCluster struct {
	...
	// The cluster tag of the Kubernetes cluster
	ClusterTag string `protobuf:"bytes,1,opt,name=cluster_tag,json=clusterTag,proto3" json:"cluster_tag,omitempty"`
	// Firmware Version
	//
	// x-displayName: "Firmware Version"
	// The version of firmware for the Kubernetes cluster
	FirmwareVersion string `protobuf:"bytes,2,opt,name=firmware_version,json=firmwareVersion,proto3" json:"firmware_version,omitempty"`
	// Sync Status
	//
	// x-displayName: "Sync Status"
	// The sync status of the Kubernetes cluster
	SyncStatus SyncStatus `protobuf:"varint,5,opt,name=sync_status,json=syncStatus,proto3,enum=ves.io.schema.shape.bot_defense.bot_infrastructure.SyncStatus" json:"sync_status,omitempty"`
	// Deployed Endpoint Policy
	//
	// x-displayName: "Deployed Endpoint Policy"
	// Endpoint policy deployed in the cluster
	DeployedEndpointPolicyMetadata *PolicyMetadata `protobuf:"bytes,6,opt,name=deployed_endpoint_policy_metadata,json=deployedEndpointPolicyMetadata,proto3" json:"deployed_endpoint_policy_metadata,omitempty"`
	// Deployed Network Policy
	//
	// x-displayName: "Deployed Network Policy"
	// Network policy deployed in the cluster
	DeployedNetworkPolicyMetadata *PolicyMetadata `protobuf:"bytes,7,opt,name=deployed_network_policy_metadata,json=deployedNetworkPolicyMetadata,proto3" json:"deployed_network_policy_metadata,omitempty"`
	// Deployed Allowlist Policy
	//
	// x-displayName: "Deployed Allowlist Policy"
	// Allowlist policy deployed in the cluster
	DeployedAllowlistPolicyMetadata *PolicyMetadata `protobuf:"bytes,8,opt,name=deployed_allowlist_policy_metadata,json=deployedAllowlistPolicyMetadata,proto3" json:"deployed_allowlist_policy_metadata,omitempty"`
	// Deployed Bot Threat Intelligence Package
	//
	// x-displayName: "Deployed Bot Threat Intelligence Package"
	// Bot Threat Intelligence Package deployed in the cluster
	DeployedBotThreatIntelligencePackageName string `protobuf:"bytes,9,opt,name=deployed_bot_threat_intelligence_package_name,json=deployedBotThreatIntelligencePackageName,proto3" json:"deployed_bot_threat_intelligence_package_name,omitempty"`
}
...
func (m *KubernetesCluster) GetClusterTag() string {
	if m != nil {
		return m.ClusterTag
	}
	return ""
...
func (m *KubernetesCluster) GetFirmwareVersion() string {
	if m != nil {
		return m.FirmwareVersion
	}
	return ""
...
func (m *KubernetesCluster) GetSyncStatus() SyncStatus {
	if m != nil {
		return m.SyncStatus
	}
	return SYNC_STATUS_UNKNOWN
...
func (m *KubernetesCluster) GetDeployedEndpointPolicyMetadata() *PolicyMetadata {
	if m != nil {
		return m.DeployedEndpointPolicyMetadata
	}
	return nil
}

func (m *KubernetesCluster) GetDeployedNetworkPolicyMetadata() *PolicyMetadata {
	if m != nil {
		return m.DeployedNetworkPolicyMetadata
	}
	return nil
}

func (m *KubernetesCluster) GetDeployedAllowlistPolicyMetadata() *PolicyMetadata {
	if m != nil {
		return m.DeployedAllowlistPolicyMetadata
	}
	return nil
}

func (m *KubernetesCluster) GetDeployedBotThreatIntelligencePackageName() string {
	if m != nil {
		return m.DeployedBotThreatIntelligencePackageName
	}
	return ""
}
...
// Threat Intelligence Package Metadata
//
// x-displayName: "Threat Intelligence Package"
// The metadata of threat intelligence policy.
type TIPackageInformation struct {
	// Threat Intelligence Package Name
	//
	// x-displayName: "TI Package Name"
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
}

func (m *TIPackageInformation) Reset()      { *m = TIPackageInformation{} }
func (*TIPackageInformation) ProtoMessage() {}
func (*TIPackageInformation) Descriptor() ([]byte, []int) {
	return fileDescriptor_841e8f848b141fd8, []int{10}
}
func (m *TIPackageInformation) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TIPackageInformation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *TIPackageInformation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TIPackageInformation.Merge(m, src)
}
func (m *TIPackageInformation) XXX_Size() int {
	return m.Size()
}
func (m *TIPackageInformation) XXX_DiscardUnknown() {
	xxx_messageInfo_TIPackageInformation.DiscardUnknown(m)
}

var xxx_messageInfo_TIPackageInformation proto.InternalMessageInfo

func (m *TIPackageInformation) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
type Ingress struct {
	...
	CertStatus CertificateStatus `protobuf:"varint,7,opt,name=cert_status,json=certStatus,proto3,enum=ves.io.schema.shape.bot_defense.bot_infrastructure.CertificateStatus" json:"cert_status,omitempty"`
	// Certificate ID
	//
	// x-displayName: "Certificate ID"
	// x-example: "6990a584f0526500012a1723"
	// The ID of the certificate to be applied to this ingress (desired state)
	CertId string `protobuf:"bytes,8,opt,name=cert_id,json=certId,proto3" json:"cert_id,omitempty"`
}
...
func (m *Ingress) GetCertStatus() CertificateStatus {
	if m != nil {
		return m.CertStatus
	}
...
func (m *Ingress) GetCertId() string {
	if m != nil {
		return m.CertId
	}
	return ""
...
func (*GetSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_841e8f848b141fd8, []int{15}
}
...
type GetSpecType_Kubernetes struct {
	Kubernetes *InfraContainerizedHosted `protobuf:"bytes,28,opt,name=kubernetes,proto3,oneof" json:"kubernetes,omitempty"`
}
...
func (*GetSpecType_Kubernetes) isGetSpecType_BotInfraChoice()     {}
...
func (m *GetSpecType) GetKubernetes() *InfraContainerizedHosted {
	if x, ok := m.GetBotInfraChoice().(*GetSpecType_Kubernetes); ok {
		return x.Kubernetes
	}
	return nil
}
...
func (m *GetSpecType) GetBotTiPackageInformation() *TIPackageInformation {
	if m != nil {
		return m.BotTiPackageInformation
	}
	return nil
...
func (*CreateSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_841e8f848b141fd8, []int{16}
}
...
func (m *CreateSpecType) GetDeploymentMode() bot_defense.DeploymentMode {
	if m != nil {
		return m.DeploymentMode
	}
	return bot_defense.REVERSE_PROXY
...
func (*ReplaceSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_841e8f848b141fd8, []int{17}
}
...
type ReplaceSpecType_Kubernetes struct {
	Kubernetes *InfraContainerizedHosted `protobuf:"bytes,28,opt,name=kubernetes,proto3,oneof" json:"kubernetes,omitempty"`
}
...
func (*ReplaceSpecType_Kubernetes) isReplaceSpecType_BotInfraChoice()     {}
...
func (m *ReplaceSpecType) GetKubernetes() *InfraContainerizedHosted {
	if x, ok := m.GetBotInfraChoice().(*ReplaceSpecType_Kubernetes); ok {
		return x.Kubernetes
	}
	return nil
}
...
func (*ReplaceSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ReplaceSpecType_Kubernetes)(nil),
	}
}
...
func init() {
	...
	proto.RegisterEnum("ves.io.schema.shape.bot_defense.bot_infrastructure.SyncStatus", SyncStatus_name, SyncStatus_value)
	golang_proto.RegisterEnum("ves.io.schema.shape.bot_defense.bot_infrastructure.SyncStatus", SyncStatus_name, SyncStatus_value)
	...
	proto.RegisterEnum("ves.io.schema.shape.bot_defense.bot_infrastructure.CertificateStatus", CertificateStatus_name, CertificateStatus_value)
	golang_proto.RegisterEnum("ves.io.schema.shape.bot_defense.bot_infrastructure.CertificateStatus", CertificateStatus_name, CertificateStatus_value)
	...
	proto.RegisterType((*InfraContainerizedHosted)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.InfraContainerizedHosted")
	golang_proto.RegisterType((*InfraContainerizedHosted)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.InfraContainerizedHosted")
	proto.RegisterType((*KubernetesCluster)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.KubernetesCluster")
	golang_proto.RegisterType((*KubernetesCluster)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.KubernetesCluster")
	...
	proto.RegisterType((*TIPackageInformation)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.TIPackageInformation")
	golang_proto.RegisterType((*TIPackageInformation)(nil), "ves.io.schema.shape.bot_defense.bot_infrastructure.TIPackageInformation")
...
var fileDescriptor_841e8f848b141fd8 = []byte{
	...
	,
}
...
func (x CertificateStatus) String() string {
	s, ok := CertificateStatus_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *GlobalSpecType) Equal(that interface{}) bool {
	...
	if this.ClusterTag != that1.ClusterTag {
		return false
	}
	if !this.BotTiPackageInformation.Equal(that1.BotTiPackageInformation) {
		return false
	}
	return true
}
...
func (this *GlobalSpecType_Kubernetes) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_Kubernetes)
	if !ok {
		that2, ok := that.(GlobalSpecType_Kubernetes)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *InfraContainerizedHosted) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*InfraContainerizedHosted)
	if !ok {
		that2, ok := that.(InfraContainerizedHosted)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.TargetFirmwareVersion != that1.TargetFirmwareVersion {
		return false
	}
	if len(this.KubernetesCluster) != len(that1.KubernetesCluster) {
		return false
	}
	for i := range this.KubernetesCluster {
		if !this.KubernetesCluster[i].Equal(that1.KubernetesCluster[i]) {
			return false
		}
	}
	if this.InfraSyncStatus != that1.InfraSyncStatus {
		return false
	}
	if this.LastUpdatedBy != that1.LastUpdatedBy {
		return false
	}
	return true
}
func (this *KubernetesCluster) Equal(that interface{}) bool {
	...
	if this.SyncStatus != that1.SyncStatus {
		return false
	}
	if !this.DeployedEndpointPolicyMetadata.Equal(that1.DeployedEndpointPolicyMetadata) {
		return false
	}
	if !this.DeployedNetworkPolicyMetadata.Equal(that1.DeployedNetworkPolicyMetadata) {
		return false
	}
	if !this.DeployedAllowlistPolicyMetadata.Equal(that1.DeployedAllowlistPolicyMetadata) {
		return false
	}
	if this.DeployedBotThreatIntelligencePackageName != that1.DeployedBotThreatIntelligencePackageName {
		return false
	}
	return true
}
...
func (this *TIPackageInformation) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TIPackageInformation)
	if !ok {
		that2, ok := that.(TIPackageInformation)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_Kubernetes) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_Kubernetes)
	if !ok {
		that2, ok := that.(GetSpecType_Kubernetes)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_Kubernetes) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_Kubernetes)
	if !ok {
		that2, ok := that.(ReplaceSpecType_Kubernetes)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GlobalSpecType) GoString() string {
	...
	s = append(s, "ClusterTag: "+fmt.Sprintf("%#v", this.ClusterTag)+",\n")
	if this.BotTiPackageInformation != nil {
		s = append(s, "BotTiPackageInformation: "+fmt.Sprintf("%#v", this.BotTiPackageInformation)+",\n")
	}
	s = append(s, "}")
...
func (this *GlobalSpecType_Kubernetes) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&bot_infrastructure.GlobalSpecType_Kubernetes{` +
...
func (this *InfraContainerizedHosted) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&bot_infrastructure.InfraContainerizedHosted{")
	s = append(s, "InfraHostName: "+fmt.Sprintf("%#v", this.InfraHostName)+",\n")
	s = append(s, "TargetFirmwareVersion: "+fmt.Sprintf("%#v", this.TargetFirmwareVersion)+",\n")
	if this.KubernetesCluster != nil {
		s = append(s, "KubernetesCluster: "+fmt.Sprintf("%#v", this.KubernetesCluster)+",\n")
	}
	s = append(s, "InfraSyncStatus: "+fmt.Sprintf("%#v", this.InfraSyncStatus)+",\n")
	s = append(s, "LastUpdatedBy: "+fmt.Sprintf("%#v", this.LastUpdatedBy)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *KubernetesCluster) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 11)
	s = append(s, "&bot_infrastructure.KubernetesCluster{")
	s = append(s, "ClusterTag: "+fmt.Sprintf("%#v", this.ClusterTag)+",\n")
	s = append(s, "FirmwareVersion: "+fmt.Sprintf("%#v", this.FirmwareVersion)+",\n")
	s = append(s, "SyncStatus: "+fmt.Sprintf("%#v", this.SyncStatus)+",\n")
	if this.DeployedEndpointPolicyMetadata != nil {
		s = append(s, "DeployedEndpointPolicyMetadata: "+fmt.Sprintf("%#v", this.DeployedEndpointPolicyMetadata)+",\n")
	}
	if this.DeployedNetworkPolicyMetadata != nil {
		s = append(s, "DeployedNetworkPolicyMetadata: "+fmt.Sprintf("%#v", this.DeployedNetworkPolicyMetadata)+",\n")
	}
	if this.DeployedAllowlistPolicyMetadata != nil {
		s = append(s, "DeployedAllowlistPolicyMetadata: "+fmt.Sprintf("%#v", this.DeployedAllowlistPolicyMetadata)+",\n")
	}
	s = append(s, "DeployedBotThreatIntelligencePackageName: "+fmt.Sprintf("%#v", this.DeployedBotThreatIntelligencePackageName)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *TIPackageInformation) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&bot_infrastructure.TIPackageInformation{")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *GetSpecType_Kubernetes) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&bot_infrastructure.GetSpecType_Kubernetes{` +
		`Kubernetes:` + fmt.Sprintf("%#v", this.Kubernetes) + `}`}, ", ")
	return s
}
...
func (this *ReplaceSpecType_Kubernetes) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&bot_infrastructure.ReplaceSpecType_Kubernetes{` +
		`Kubernetes:` + fmt.Sprintf("%#v", this.Kubernetes) + `}`}, ", ")
	return s
}
...
func (m *GlobalSpecType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.BotTiPackageInformation != nil {
		{
			size, err := m.BotTiPackageInformation.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.ClusterTag) > 0 {
		i -= len(m.ClusterTag)
		copy(dAtA[i:], m.ClusterTag)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.ClusterTag)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xda
	...
	if len(m.InfraRegion) > 0 {
		dAtA4 := make([]byte, len(m.InfraRegion)*10)
		var j3 int
...
func (m *GlobalSpecType_Kubernetes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_Kubernetes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Kubernetes != nil {
		{
...
func (m *InfraCloudHosted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.InfraRegion) > 0 {
		dAtA17 := make([]byte, len(m.InfraRegion)*10)
		var j16 int
		for _, num := range m.InfraRegion {
			for num >= 1<<7 {
...
func (m *InfraContainerizedHosted) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *InfraContainerizedHosted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InfraContainerizedHosted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.LastUpdatedBy) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.LastUpdatedBy)))
		i--
		dAtA[i] = 0x2a
	}
	if m.InfraSyncStatus != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.InfraSyncStatus))
		i--
		dAtA[i] = 0x20
	}
	if len(m.KubernetesCluster) > 0 {
		for iNdEx := len(m.KubernetesCluster) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.KubernetesCluster[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.TargetFirmwareVersion) > 0 {
		i -= len(m.TargetFirmwareVersion)
		copy(dAtA[i:], m.TargetFirmwareVersion)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.TargetFirmwareVersion)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.InfraHostName) > 0 {
...
func (m *KubernetesCluster) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DeployedBotThreatIntelligencePackageName) > 0 {
		i -= len(m.DeployedBotThreatIntelligencePackageName)
		copy(dAtA[i:], m.DeployedBotThreatIntelligencePackageName)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.DeployedBotThreatIntelligencePackageName)))
		i--
		dAtA[i] = 0x4a
	}
	if m.DeployedAllowlistPolicyMetadata != nil {
		{
			size, err := m.DeployedAllowlistPolicyMetadata.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.DeployedNetworkPolicyMetadata != nil {
		{
			size, err := m.DeployedNetworkPolicyMetadata.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.DeployedEndpointPolicyMetadata != nil {
		{
			size, err := m.DeployedEndpointPolicyMetadata.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.SyncStatus != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.SyncStatus))
		i--
		dAtA[i] = 0x28
	}
	if len(m.FirmwareVersion) > 0 {
...
func (m *TIPackageInformation) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TIPackageInformation) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TIPackageInformation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Ingress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CertId) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.CertId)))
		i--
		dAtA[i] = 0x42
	}
	if m.CertStatus != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.CertStatus))
		i--
		dAtA[i] = 0x38
	}
	if m.Region != 0 {
...
func (m *GetSpecType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.InfraRegion) > 0 {
		dAtA26 := make([]byte, len(m.InfraRegion)*10)
		var j25 int
		for _, num := range m.InfraRegion {
			for num >= 1<<7 {
...
func (m *GetSpecType_Kubernetes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_Kubernetes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Kubernetes != nil {
		{
			size, err := m.Kubernetes.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_Kubernetes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_Kubernetes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Kubernetes != nil {
		{
			size, err := m.Kubernetes.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GlobalSpecType) Size() (n int) {
	...
	if m.DeploymentMode != 0 {
		n += 2 + sovTypes(uint64(m.DeploymentMode))
	}
	l = len(m.ClusterTag)
	if l > 0 {
		n += 2 + l + sovTypes(uint64(l))
	...
	if m.BotTiPackageInformation != nil {
		l = m.BotTiPackageInformation.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *GlobalSpecType_Kubernetes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InfraContainerizedHosted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.TargetFirmwareVersion)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	if len(m.KubernetesCluster) > 0 {
		for _, e := range m.KubernetesCluster {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
	if m.InfraSyncStatus != 0 {
		n += 1 + sovTypes(uint64(m.InfraSyncStatus))
	}
...
func (m *KubernetesCluster) Size() (n int) {
	...
	if m.SyncStatus != 0 {
		n += 1 + sovTypes(uint64(m.SyncStatus))
	}
	if m.DeployedEndpointPolicyMetadata != nil {
		l = m.DeployedEndpointPolicyMetadata.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	if m.DeployedNetworkPolicyMetadata != nil {
		l = m.DeployedNetworkPolicyMetadata.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	if m.DeployedAllowlistPolicyMetadata != nil {
		l = m.DeployedAllowlistPolicyMetadata.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.DeployedBotThreatIntelligencePackageName)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
...
func (m *TIPackageInformation) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Ingress) Size() (n int) {
	...
	if m.CertStatus != 0 {
		n += 1 + sovTypes(uint64(m.CertStatus))
	}
	l = len(m.CertId)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
...
func (m *GetSpecType_Kubernetes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_Kubernetes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GlobalSpecType) String() string {
	...
	s := strings.Join([]string{`&GlobalSpecType{`,
		...
		`ClusterTag:` + fmt.Sprintf("%v", this.ClusterTag) + `,`,
		`BotTiPackageInformation:` + strings.Replace(this.BotTiPackageInformation.String(), "TIPackageInformation", "TIPackageInformation", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *GlobalSpecType_Kubernetes) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_Kubernetes{`,
		`Kubernetes:` + strings.Replace(fmt.Sprintf("%v", this.Kubernetes), "InfraContainerizedHosted", "InfraContainerizedHosted", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *InfraContainerizedHosted) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForKubernetesCluster := "[]*KubernetesCluster{"
	for _, f := range this.KubernetesCluster {
		repeatedStringForKubernetesCluster += strings.Replace(f.String(), "KubernetesCluster", "KubernetesCluster", 1) + ","
	}
	repeatedStringForKubernetesCluster += "}"
	s := strings.Join([]string{`&InfraContainerizedHosted{`,
		`InfraHostName:` + fmt.Sprintf("%v", this.InfraHostName) + `,`,
		`TargetFirmwareVersion:` + fmt.Sprintf("%v", this.TargetFirmwareVersion) + `,`,
		`KubernetesCluster:` + repeatedStringForKubernetesCluster + `,`,
		`InfraSyncStatus:` + fmt.Sprintf("%v", this.InfraSyncStatus) + `,`,
		`LastUpdatedBy:` + fmt.Sprintf("%v", this.LastUpdatedBy) + `,`,
		`}`,
	}, "")
	return s
}
func (this *KubernetesCluster) String() string {
	...
	s := strings.Join([]string{`&KubernetesCluster{`,
		...
		`DeployedEndpointPolicyMetadata:` + strings.Replace(this.DeployedEndpointPolicyMetadata.String(), "PolicyMetadata", "PolicyMetadata", 1) + `,`,
		`DeployedNetworkPolicyMetadata:` + strings.Replace(this.DeployedNetworkPolicyMetadata.String(), "PolicyMetadata", "PolicyMetadata", 1) + `,`,
		`DeployedAllowlistPolicyMetadata:` + strings.Replace(this.DeployedAllowlistPolicyMetadata.String(), "PolicyMetadata", "PolicyMetadata", 1) + `,`,
		`DeployedBotThreatIntelligencePackageName:` + fmt.Sprintf("%v", this.DeployedBotThreatIntelligencePackageName) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *TIPackageInformation) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TIPackageInformation{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetSpecType_Kubernetes) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_Kubernetes{`,
		`Kubernetes:` + strings.Replace(fmt.Sprintf("%v", this.Kubernetes), "InfraContainerizedHosted", "InfraContainerizedHosted", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ReplaceSpecType_Kubernetes) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_Kubernetes{`,
		`Kubernetes:` + strings.Replace(fmt.Sprintf("%v", this.Kubernetes), "InfraContainerizedHosted", "InfraContainerizedHosted", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *GlobalSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClusterTag", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ClusterTag = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 28:
			if wireType != 2 {
			...
			v := &InfraContainerizedHosted{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.BotInfraChoice = &GlobalSpecType_Kubernetes{v}
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BotTiPackageInformation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BotTiPackageInformation == nil {
				m.BotTiPackageInformation = &TIPackageInformation{}
			}
			if err := m.BotTiPackageInformation.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *InfraContainerizedHosted) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InfraContainerizedHosted: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InfraContainerizedHosted: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetFirmwareVersion", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TargetFirmwareVersion = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.KubernetesCluster = append(m.KubernetesCluster, &KubernetesCluster{})
			if err := m.KubernetesCluster[len(m.KubernetesCluster)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InfraSyncStatus", wireType)
			}
			m.InfraSyncStatus = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InfraSyncStatus |= SyncStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *KubernetesCluster) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeployedEndpointPolicyMetadata", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DeployedEndpointPolicyMetadata == nil {
				m.DeployedEndpointPolicyMetadata = &PolicyMetadata{}
			}
			if err := m.DeployedEndpointPolicyMetadata.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeployedNetworkPolicyMetadata", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DeployedNetworkPolicyMetadata == nil {
				m.DeployedNetworkPolicyMetadata = &PolicyMetadata{}
			}
			if err := m.DeployedNetworkPolicyMetadata.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeployedAllowlistPolicyMetadata", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DeployedAllowlistPolicyMetadata == nil {
				m.DeployedAllowlistPolicyMetadata = &PolicyMetadata{}
			}
			if err := m.DeployedAllowlistPolicyMetadata.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeployedBotThreatIntelligencePackageName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeployedBotThreatIntelligencePackageName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *TIPackageInformation) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TIPackageInformation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TIPackageInformation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			...
			m.BotInfraChoice = &GetSpecType_Kubernetes{v}
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BotTiPackageInformation", wireType)
...
func (m *ReplaceSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			...
			m.BotInfraChoice = &ReplaceSpecType_Kubernetes{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
