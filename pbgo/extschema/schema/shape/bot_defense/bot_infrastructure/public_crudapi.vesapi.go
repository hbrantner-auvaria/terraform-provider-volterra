...
const (
	...
	CreateRequestFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.shape.bot_defense.bot_infrastructure.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bot_infrastructures", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bot_infrastructures/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bot_infrastructures/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/bot_infrastructures", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape.bot_defense.bot_infrastructure.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.shape.bot_defense.bot_infrastructure")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_infrastructure.API.List")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape.bot_defense.bot_infrastructure.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape.bot_defense.bot_infrastructure.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_infrastructure.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.shape.bot_defense.bot_infrastructure.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.shape.bot_defense.bot_infrastructure.API.Create' operation on 'bot_infrastructure'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.shape.bot_defense.bot_infrastructure.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.bot_infrastructure.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_infrastructure.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.bot_infrastructure.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.shape.bot_defense.bot_infrastructure.API.Replace' operation on 'bot_infrastructure'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.bot_infrastructure.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.shape.bot_defense.bot_infrastructure.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_infrastructure.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
var APISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Configures Bot Infrastructure by bot infrastructure",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/bot_infrastructures": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/bot_infrastructureCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bot_infrastructureCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.API.Create"
            },
            "x-displayname": "Bot Infrastructure",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_infrastructure.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/bot_infrastructures/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bot_infrastructureReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bot_infrastructureReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.API.Replace"
            },
            "x-displayname": "Bot Infrastructure",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_infrastructure.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/bot_infrastructures": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bot_infrastructureListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.API.List"
            },
            "x-displayname": "Bot Infrastructure",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_infrastructure.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/bot_infrastructures/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bot_infrastructureGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_infrastructure-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_infrastructure.API.Get"
            },
            "x-displayname": "Bot Infrastructure",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_infrastructure.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "bot_defensebot_infrastructureGetSpecType": {
            ...
            "properties": {
                ...
                "bot_endpoint_policy_metadata": {
                    "$ref": "#/definitions/bot_infrastructureEndpointPolicyMetadata",
                    "x-displayname": "Bot Endpoint Policy Metadata"
                },
                "bot_network_policy_metadata": {
                    "$ref": "#/definitions/bot_infrastructurePolicyMetadata",
                ...
                "environment_type": {
                    ...
                    "$ref": "#/definitions/bot_infrastructureEnvironmentType",
                ...
                "traffic_type": {
                    "description": " The type of traffic that is routed to and processed by this infrastructure (Web or Mobile).\n\nExample: - \"web\"-",
        ...
        "bot_defensebot_infrastructureReplaceSpecType": {
            "type": "object",
            "description": "Replace Bot Infrastructure",
        ...
        "bot_infrastructureClusterState": {
            ...
            "enum": [
                ...
                "UPDATING_POLICY",
                "WAITING_ACTIVE",
                "WAITING_START_TIMEOUT"
            ],
            "default": "ACTIVE",
            "x-displayname": "F5 On Premises or F5 Hosted Cluster State",
            "x-ves-proto-enum": "ves.io.schema.shape.bot_defense.bot_infrastructure.ClusterState"
        },
        "bot_infrastructureCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of bot_infrastructure",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.CreateRequest",
            "properties": {
                "metadata": {
        ...
        "bot_infrastructureCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "bot_infrastructureCreateSpecInfraCloudHosted": {
            "type": "object",
            "title": "F5 Cloud Hosted - for creating a new object",
            "x-displayname": "F5 Cloud Hosted",
            "x-ves-oneof-field-type_choice": "[\"production\",\"testing\"]",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.CreateSpecInfraCloudHosted",
            "properties": {
                "ip_addresses": {
                    "type": "array",
                    "description": " Only traffic from these IP addresses is allowed to access this Bot Defense infrastructure.\n\nValidation Rules:\n  ves.io.schema.rules.string.ip: true\n",
                    "title": "IP Allowlist",
                    "items": {
                        "type": "string"
                    },
                ...
                "testing": {
                    "description": "Exclusive with [production]\n Test Evaluate new features, settings, and system performance.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Testing",
                    "$ref": "#/definitions/bot_infrastructureTesting",
        ...
        "bot_infrastructureCreateSpecType": {
            "type": "object",
            "description": "Create Bot Infrastructure",
            "title": "Create Bot Infrastructure",
            "x-displayname": "Create Bot Infrastructure",
            "x-ves-oneof-field-create_bot_infra_choice": "[\"create_cloud_hosted\"]",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.CreateSpecType",
            "properties": {
                "create_cloud_hosted": {
                    "description": "Exclusive with []\n Associates an F5 Cloud Hosted service node to the Bot Defense infrastructure",
                    "$ref": "#/definitions/bot_infrastructureCreateSpecInfraCloudHosted",
                    "x-displayname": "F5 Cloud Hosted"
                },
                "traffic_type": {
                    "description": " The type of traffic that is routed to and processed by this infrastructure (Web or Mobile).\n\nExample: - \"web\"-",
        ...
        "bot_infrastructureDevice": {
            "type": "object",
            "description": "The device details",
            "title": "Devices",
            "x-displayname": "Device",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.Device",
            "properties": {
                ...
                "device_firmware_version": {
                    "type": "string",
                    "description": " The firmware version in device",
                ...
                "ip_info": {
                    "description": " The IP address information for the device",
                    "title": "IP infomation",
                    "$ref": "#/definitions/bot_infrastructureIPInfo",
                    "x-displayname": "IP Address"
                }
            }
        },
        "bot_infrastructureEgress": {
            "type": "object",
            "description": "Egress",
            "title": "Egress",
            "x-displayname": "Egress",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.Egress",
            "properties": {
                "ip_address": {
                    "type": "string",
        ...
        "bot_infrastructureEndpointPolicyMetadata": {
            "type": "object",
            "description": "on associated endpoint policy object.",
            "title": "Bot Endpoint Policy Metadata",
            "x-displayname": "Bot Endpoint Policy",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.EndpointPolicyMetadata",
            "properties": {
                "name": {
                    "type": "string",
        ...
        "bot_infrastructureEnvironmentType": {
            "type": "string",
            "description": "Identifies the environment as either Production or Testing. Production environments have two infrastructure regions in an Active-Active configuration where traffic is routed equally between the two regions. Test environments have a single infrastructure region.\n\nProduction Protect live production applications and services from automated attacks.\nTest Evaluate new features, settings, and system performance.",
            ...
            "default": "PRODUCTION",
            "x-displayname": "Environment Type",
            "x-ves-proto-enum": "ves.io.schema.shape.bot_defense.bot_infrastructure.EnvironmentType"
        },
        "bot_infrastructureGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read bot_infrastructure",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/bot_infrastructureStatusObject"
                    },
        ...
        "bot_infrastructureGetResponseFormatCode": {
            "type": "string",
        ...
        "bot_infrastructureIPInfo": {
            "type": "object",
            "description": "The IP address information for the device",
            "title": "IP infomation",
            "x-displayname": "IP Address",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.IPInfo",
            "properties": {
                "local": {
                    "type": "string",
        ...
        "bot_infrastructureInfraCloudHosted": {
            "type": "object",
            "title": "F5 Cloud Hosted",
            "x-displayname": "F5 Cloud Hosted",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.InfraCloudHosted",
            "properties": {
                "egress": {
                    "type": "array",
                    ...
                    "title": "Egress",
                    "items": {
                        "$ref": "#/definitions/bot_infrastructureEgress"
                    },
                    "x-displayname": "Egress",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.repeated.unique": "true"
                ...
                "firmware_version": {
                    "type": "string",
                    "description": " The version of firmware for the cluster",
                    "title": "Firmware Version",
                    "x-displayname": "Firmware Version"
                },
                "host_names": {
                    "type": "array",
                    "description": " Only traffic from machines with these host names is allowed to access this Bot Defense infrastructure\n\nValidation Rules:\n  ves.io.schema.rules.string.hostname: true\n",
                ...
                "ingress": {
                    "type": "array",
                    "description": " Ingress Host Names or IP Addresses\n\nValidation Rules:\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Ingress",
                    "items": {
                        "$ref": "#/definitions/bot_infrastructureIngress"
                    },
        ...
        "bot_infrastructureInfraF5HostedOnPrem": {
            ...
            "title": "F5 On Premises or F5 Physical Hosted",
            "x-displayname": "F5 On Premises or F5 Hosted",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.InfraF5HostedOnPrem",
            "properties": {
                "devices": {
                    "type": "array",
                    "description": " The devices assgined to the cluster",
                    "title": "Devices",
                    "items": {
                        "$ref": "#/definitions/bot_infrastructureDevice"
                    },
                ...
                "infra_host_name": {
                    "type": "string",
                    "description": " Infra host name should be \"N/A\"",
                    "title": "Infra host name",
                    "x-displayname": "Infra Host Name"
                }
            }
        },
        "bot_infrastructureInfraType": {
            "type": "string",
            "description": "x-displayName: \"Infra Type\"\nInfra Type\n\n - F5_CLOUD_HOSTED: x-displayName: \"F5 Cloud Hosted\"\nYour application are on the internet using the F5 Cloud Hosted",
            "title": "InfraType",
            "enum": [
                "F5_CLOUD_HOSTED"
            ],
            "default": "F5_CLOUD_HOSTED"
        },
        "bot_infrastructureIngress": {
            "type": "object",
            "description": "Ingress",
            "title": "Ingress",
            "x-displayname": "Ingress",
        ...
        "bot_infrastructureListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of bot_infrastructure",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/bot_infrastructureListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "bot_infrastructureListResponseItem": {
            "type": "object",
            "description": "By default a summary of bot_infrastructure is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of bot_infrastructure",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this bot_infrastructure",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this bot_infrastructure",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates bot_infrastructure is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this bot_infrastructure",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this bot_infrastructure\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this bot_infrastructure\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "bot_infrastructurePolicyMetadata": {
            "type": "object",
            "description": "on associated Policy object.",
            "title": "Policy Metadata",
            "x-displayname": "Policy",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.PolicyMetadata",
            "properties": {
                "name": {
                    "type": "string",
                    "description": " Policy Name\n\nValidation Rules:\n  ves.io.schema.rules.string.not_empty: true\n",
        ...
        "bot_infrastructureProduction": {
            "type": "object",
            "title": "Production",
            "x-displayname": "Production",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.Production",
            "properties": {
                "region_1": {
                    "type": "string",
                    "description": " This is an Active-Active Infrastructure configuration where traffic is routed equally between the two regions.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Bot Infrastructure Regions",
        ...
        "bot_infrastructureReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a bot_infrastructure",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "bot_infrastructureReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.ReplaceResponse"
        },
        "bot_infrastructureStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "bot_infrastructureTesting": {
            "type": "object",
            "title": "Testing",
            "x-displayname": "Testing",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_infrastructure.Testing",
            "properties": {
                "region_1": {
                    "type": "string",
                    "description": " This is an Active-Passive Infrastructure configuration where traffic is routed to a single region.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Bot Infrastructure Regions",
                    "x-displayname": "Ingress Region 1",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "bot_infrastructureTrafficType": {
            ...
            "default": "WEB",
            "x-displayname": "Traffic Type",
            "x-ves-proto-enum": "ves.io.schema.shape.bot_defense.bot_infrastructure.TrafficType"
        },
    ...
    "x-displayname": "Bot Infrastructure",
    "x-ves-proto-file": "ves.io/schema/shape/bot_defense/bot_infrastructure/public_crudapi.proto"
}`
