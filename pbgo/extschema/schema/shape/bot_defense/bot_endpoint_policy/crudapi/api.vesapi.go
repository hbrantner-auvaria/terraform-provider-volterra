    ...
    "definitions": {
        ...
        "bot_defensebot_endpoint_policyGlobalSpecType": {
            ...
            "properties": {
                "api_key": {
                    "type": "string",
                    "description": " API key associated with the latest policy version. It only has value for API mode.",
                    "title": "API Key",
                ...
                "telemetry_prefix": {
                    "type": "string",
                    "description": " Telemetry prefix associated with the latest policy version.",
