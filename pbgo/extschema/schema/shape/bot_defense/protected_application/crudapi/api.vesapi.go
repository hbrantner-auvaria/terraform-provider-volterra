...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/shape/bot_defense/protected_application"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.shape.bot_defense.protected_application.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape.bot_defense.protected_application.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.shape.bot_defense.protected_application.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape.bot_defense.protected_application.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape.bot_defense.protected_application.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.protected_application.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/shape/bot_defense/protected_application/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.shape.bot_defense.protected_application/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-protected_application-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-protected_application-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-protected_application-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "protected_application",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.protected_application.Object",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.shape.bot_defense.protected_application/Objects": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-protected_application-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-protected_application-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "protected_application",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.protected_application.Object",
        ...
        "/ves.io.schema.shape.bot_defense.protected_application/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-protected_application-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "protected_application",
            "x-ves-object-type": "ves.io.schema.shape.bot_defense.protected_application.Object",
        ...
        "/ves.io.schema.shape.bot_defense.protected_application/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.protected_application/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.protected_application/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.shape.bot_defense.protected_application/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.shape.bot_defense.protected_application.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "bot_defenseprotected_applicationGlobalSpecType": {
            "type": "object",
            "description": "Configures applications protected by Bot Defense",
            ...
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.GlobalSpecType",
            "properties": {
                "adobe_commerce_connector": {
                    ...
                    "title": "Adobe Commerce template connector",
                ...
                "custom_connector": {
                    ...
                    "title": "Custom template connector",
                    "$ref": "#/definitions/schemaEmpty",
                ...
                "f5_big_ip": {
                    ...
                    "title": "F5 BIG-IP(V17.0 or greater) template connector",
                    "$ref": "#/definitions/schemaEmpty",
                ...
                "salesforce_commerce_connector": {
                    ...
                    "title": "Salesforce Commerce template connector",
                    "$ref": "#/definitions/schemaEmpty",
                ...
                "xc_mesh": {
                    ...
                    "title": "HTTP Load Balancer connector",
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/protected_applicationSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protected_applicationcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protected_applicationcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protected_applicationcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protected_applicationcrudapiErrorCode"
                },
        ...
        "protected_applicationSpecType": {
            "type": "object",
            "description": "Shape of protected application specification",
            "title": "Specification of Protected Application",
            "x-displayname": "Specification of Protected Application",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.protected_application.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/bot_defenseprotected_applicationGlobalSpecType",
        ...
        "protected_applicationcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.shape.bot_defense.protected_application.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/shape/bot_defense/protected_application/crudapi/api.proto"
}`
