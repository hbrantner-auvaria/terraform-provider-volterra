...
const (
	...
	CreateRequestFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.shape.bot_defense.bot_allowlist_policy.DeleteResponse"
)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bot_allowlist_policys/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bot_allowlist_policys/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/bot_allowlist_policys", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape.bot_defense.bot_allowlist_policy.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.shape.bot_defense.bot_allowlist_policy")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.List")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape.bot_defense.bot_allowlist_policy.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape.bot_defense.bot_allowlist_policy.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Replace' operation on 'bot_allowlist_policy'"
		if retErr == nil {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.shape.bot_defense.bot_allowlist_policy.GetResponse"
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.shape.bot_defense.bot_allowlist_policy.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/bot_allowlist_policys/{metadata.name}": {
            "put": {
                "summary": "Replace Bot allowlist Policy",
                "description": "Replace Bot allowlist Policy",
                "operationId": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bot_allowlist_policyReplaceResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bot_allowlist_policyReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_allowlist_policy-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Replace"
            },
            "x-displayname": "Bot allowlist Policy",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/bot_allowlist_policys": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bot_allowlist_policyListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_allowlist_policy-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.List"
            },
            "x-displayname": "Bot allowlist Policy",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/bot_allowlist_policys/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bot_allowlist_policyGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-bot_defense-bot_allowlist_policy-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API.Get"
            },
            "x-displayname": "Bot allowlist Policy",
            "x-ves-proto-service": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "bot_allowlist_policyGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read bot_allowlist_policy",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.GetResponse",
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the bot allowlist policy object",
                    "title": "spec",
                    "$ref": "#/definitions/bot_allowlist_policyGetSpecType",
                    "x-displayname": "Spec"
                },
                "status": {
                    "type": "array",
        ...
        "bot_allowlist_policyGetResponseFormatCode": {
            "type": "string",
        ...
        "bot_allowlist_policyGetSpecType": {
            "type": "object",
            "description": "Get Bot allowlist Policy",
            "title": "Get Bot allowlist Policy",
            "x-displayname": "Get Bot allowlist Policy",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.GetSpecType",
            "properties": {
        ...
        "bot_allowlist_policyListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of bot_allowlist_policy",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/bot_allowlist_policyListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "bot_allowlist_policyListResponseItem": {
            "type": "object",
            "description": "By default a summary of bot_allowlist_policy is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of bot_allowlist_policy",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this bot_allowlist_policy",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this bot_allowlist_policy",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates bot_allowlist_policy is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this bot_allowlist_policy",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this bot_allowlist_policy\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this bot_allowlist_policy\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "bot_allowlist_policyReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a bot_allowlist_policy",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "bot_allowlist_policyReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.bot_defense.bot_allowlist_policy.ReplaceResponse"
        },
    ...
    "x-displayname": "Bot allowlist Policy",
    "x-ves-proto-file": "ves.io/schema/shape/bot_defense/bot_allowlist_policy/public_crudapi.proto"
}`
