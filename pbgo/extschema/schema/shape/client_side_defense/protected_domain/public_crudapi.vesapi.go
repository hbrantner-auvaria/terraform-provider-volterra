...
const (
	...
	CreateRequestFQN = "ves.io.schema.shape.client_side_defense.protected_domain.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.shape.client_side_defense.protected_domain.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.shape.client_side_defense.protected_domain.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.shape.client_side_defense.protected_domain.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.shape.client_side_defense.protected_domain.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.shape.client_side_defense.protected_domain.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.shape.client_side_defense.protected_domain.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.shape.client_side_defense.protected_domain.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.shape.client_side_defense.protected_domain.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.shape.client_side_defense.protected_domain.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/protected_domains", c.baseURL, namespace)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/protected_domains/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/protected_domains", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/protected_domains/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.shape.client_side_defense.protected_domain.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.shape.client_side_defense.protected_domain")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.client_side_defense.protected_domain.API.Create")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.client_side_defense.protected_domain.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.client_side_defense.protected_domain.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.shape.client_side_defense.protected_domain.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.shape.client_side_defense.protected_domain.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.shape.client_side_defense.protected_domain.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.client_side_defense.protected_domain.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.client_side_defense.protected_domain.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.shape.client_side_defense.protected_domain.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.shape.client_side_defense.protected_domain.API.Create' operation on 'protected_domain'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.shape.client_side_defense.protected_domain.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.shape.client_side_defense.protected_domain.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.client_side_defense.protected_domain.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.shape.client_side_defense.protected_domain.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.client_side_defense.protected_domain.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.shape.client_side_defense.protected_domain.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.shape.client_side_defense.protected_domain.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.shape.client_side_defense.protected_domain.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.shape.client_side_defense.protected_domain.API.Delete' operation on 'protected_domain'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.shape.client_side_defense.protected_domain.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Client-Side Defense Domain to Protect",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/protected_domains": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/protected_domainCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/protected_domainCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-client_side_defense-protected_domain-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.client_side_defense.protected_domain.API.Create"
            },
            "x-displayname": "Client-Side Defense Domain to Protect",
            "x-ves-proto-service": "ves.io.schema.shape.client_side_defense.protected_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/protected_domains": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/protected_domainListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-client_side_defense-protected_domain-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.client_side_defense.protected_domain.API.List"
            },
            "x-displayname": "Client-Side Defense Domain to Protect",
            "x-ves-proto-service": "ves.io.schema.shape.client_side_defense.protected_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/protected_domains/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/protected_domainGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-client_side_defense-protected_domain-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.client_side_defense.protected_domain.API.Get"
            },
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/protected_domainDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-shape-client_side_defense-protected_domain-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.shape.client_side_defense.protected_domain.API.Delete"
            },
            "x-displayname": "Client-Side Defense Domain to Protect",
            "x-ves-proto-service": "ves.io.schema.shape.client_side_defense.protected_domain.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "protected_domainCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of protected_domain",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the client_side_defense",
                    "title": "spec",
                    "$ref": "#/definitions/protected_domainCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "protected_domainCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the client_side_defense",
                    "title": "spec",
                    "$ref": "#/definitions/protected_domainGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "protected_domainCreateSpecType": {
            "type": "object",
            "description": "Create Domain to protect",
            "title": "Create Domain to protect",
            "x-displayname": "Create Domain to protect",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.CreateSpecType",
            "properties": {
                "protected_domain": {
                    "type": "string",
        ...
        "protected_domainDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a protected_domain",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "protected_domainGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read protected_domain",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/protected_domainStatusObject"
                    },
        ...
        "protected_domainGetResponseFormatCode": {
            "type": "string",
        ...
        "protected_domainGetSpecType": {
            "type": "object",
            "description": "Get Domain to protect",
            "title": "Get Domain to protect",
            "x-displayname": "Get Protected Domain",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.GetSpecType",
            "properties": {
                "date_added": {
                    "type": "string",
                    "description": " The date when user adds the setting\n\nExample: - \"2021-09-21:44:34.171543432Z\"-",
                    "format": "date-time",
        ...
        "protected_domainListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of protected_domain",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/protected_domainListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "protected_domainListResponseItem": {
            "type": "object",
            "description": "By default a summary of protected_domain is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of protected_domain",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this protected_domain",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this protected_domain",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates protected_domain is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this protected_domain",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this protected_domain\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this protected_domain\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "protected_domainStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.shape.client_side_defense.protected_domain.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-displayname": "Client-Side Defense Domain to Protect",
    "x-ves-proto-file": "ves.io/schema/shape/client_side_defense/protected_domain/public_crudapi.proto"
}`
