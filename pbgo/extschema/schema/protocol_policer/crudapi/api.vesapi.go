...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/protocol_policer"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.protocol_policer.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.protocol_policer.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.protocol_policer.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.protocol_policer.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.protocol_policer.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.protocol_policer.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_policer.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.protocol_policer.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/protocol_policer/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.protocol_policer/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_policer-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_policer.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_policer-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_policer.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_policer-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_policer.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "protocol_policer",
            "x-ves-object-type": "ves.io.schema.protocol_policer.Object",
            "x-ves-proto-service": "ves.io.schema.protocol_policer.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.protocol_policer/Objects": {
            "get": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_policer-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.protocol_policer.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_policer-crudapi-api-create"
                },
        ...
        "/ves.io.schema.protocol_policer/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-protocol_policer-crudapi-api-liststream"
                },
        ...
        "/ves.io.schema.protocol_policer/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.protocol_policer/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.protocol_policer/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.protocol_policer/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.protocol_policer.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/protocol_policerSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protocol_policercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protocol_policercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protocol_policercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/protocol_policercrudapiErrorCode"
                },
        ...
        "protocol_policerDnsType": {
            "type": "object",
            "description": "Match all DNS packets inclusing UDP and TCP",
            "title": "DNS packets",
            "x-displayname": "DNS Packets",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.DnsType"
        },
        "protocol_policerGlobalSpecType": {
            "type": "object",
            "description": "Configuration specification for protocol policer",
            "title": "GlobalSpecType",
            "x-displayname": "Global Configuration Specification",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.GlobalSpecType",
            "properties": {
                "protocol_policer": {
                    "type": "array",
                    ...
                    "maxItems": 64,
                    "items": {
                        "$ref": "#/definitions/protocol_policerProtocolPolicerType"
                    },
        ...
        "protocol_policerProtocolPolicerType": {
            "type": "object",
            ...
            "title": "Protocol Policer Type",
            "x-displayname": "Protocol Policer",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.ProtocolPolicerType",
            "properties": {
                "policer": {
                    "type": "array",
                ...
                "protocol": {
                    "description": " Protocol specifys L4 match criteria in a packet\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "protocol",
                    "$ref": "#/definitions/protocol_policerProtocolType",
        ...
        "protocol_policerSpecType": {
            "type": "object",
            "description": "Shape of Protocol policer object",
            "title": "Specification",
            "x-displayname": "Specification",
            "x-ves-displayorder": "2",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/protocol_policerGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "protocol_policerStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status Object",
            "x-ves-displayorder": "1,2,3",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "protocol_policerTcpType": {
            "type": "object",
            "description": "Specification of TCP flag to be matched in a TCP packet",
            "title": "TCP packet type",
            "x-displayname": "TCP Packet Type",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.TcpType",
            "properties": {
                "flags": {
                    "type": "array",
        ...
        "protocol_policerUdpType": {
            "type": "object",
            "description": "Match all UDP packets",
            "title": "All UDP packets",
            "x-displayname": "UDP Packets",
            "x-ves-proto-message": "ves.io.schema.protocol_policer.UdpType"
        },
        "protocol_policercrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.protocol_policer.crudapi.ErrorCode"
        },
        "runtimeStreamError": {
            "type": "object",
            "properties": {
    ...
    "x-ves-proto-file": "ves.io/schema/protocol_policer/crudapi/api.proto"
}`
