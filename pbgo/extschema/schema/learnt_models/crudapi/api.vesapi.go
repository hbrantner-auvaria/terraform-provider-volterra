...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/learnt_models"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.learnt_models.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.learnt_models.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.learnt_models.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.learnt_models.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.learnt_models.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.learnt_models.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.learnt_models.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.learnt_models.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.learnt_models.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.learnt_models.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.learnt_models.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.learnt_models.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.learnt_models.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.learnt_models.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.learnt_models.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.learnt_models.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.learnt_models.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.learnt_models.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/learnt_models/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.learnt_models/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-learnt_models-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.learnt_models.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-learnt_models-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.learnt_models.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-learnt_models-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.learnt_models.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "learnt_models",
            "x-ves-object-type": "ves.io.schema.learnt_models.Object",
            "x-ves-proto-service": "ves.io.schema.learnt_models.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.learnt_models/Objects": {
            "get": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-learnt_models-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.learnt_models.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-learnt_models-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.learnt_models.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "learnt_models",
            "x-ves-object-type": "ves.io.schema.learnt_models.Object",
        ...
        "/ves.io.schema.learnt_models/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-learnt_models-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.learnt_models.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "learnt_models",
            "x-ves-object-type": "ves.io.schema.learnt_models.Object",
        ...
        "/ves.io.schema.learnt_models/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.learnt_models/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.learnt_models/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.learnt_models/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.learnt_models.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.learnt_models.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/learnt_modelsSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.learnt_models.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/learnt_modelscrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.learnt_models.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/learnt_modelscrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.learnt_models.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/learnt_modelsStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.learnt_models.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/learnt_modelscrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.learnt_models.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.learnt_models.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.learnt_models.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/learnt_modelscrudapiErrorCode"
                },
        ...
        "learnt_modelsGlobalSpecType": {
            "type": "object",
            "description": "Shape of learnt models in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.learnt_models.GlobalSpecType",
            "properties": {
                "benign_bot_heuristic_fp_handle": {
                    "type": "string",
                    "description": " Handle point to the location of benign bot fp model in azure",
                    "title": "Benign Bot Heuristics False Positives Handle",
                    "x-displayname": "Benign Bot Heuristics False Positives Handle"
                },
                "distinct_users_heuristic_fp_handle": {
                    "type": "string",
                    "description": " Handle point to the location of distinct users fp model in azure",
                    "title": "Distinct Users Heuristics False Positives Handle",
                    "x-displayname": "Distinct Users Heuristics False Positives Handle"
                },
                "http_req_random_data_fp_handle": {
                    "type": "string",
                    "description": " Handle point to the location of http req random data fp model in azure",
                    "title": "HTTP Req Random Data False Positives Handle",
                    "x-displayname": "HTTP Req Random Data False Positives Handle"
                },
                "models": {
                    "type": "object",
                    "description": " Map contains details of all models",
                    "title": "model_map",
                    "x-displayname": "Models"
                },
                "threat_mesh_extended_file_handle": {
                    "type": "string",
                    "description": " Handle point to the location of detailed Threat mesh DB in azure\n\nExample: - \"filename.txt\"-",
                    "title": "Threat Mesh Extended File Handle",
                    "x-displayname": "Threat Mesh Extended File Handle",
                    "x-ves-example": "filename.txt"
                },
                "threat_mesh_file_handle": {
                    "type": "string",
                    "description": " Handle point to the location of Threat mesh DB in azure\n\nExample: - \"filename.txt\"-",
                    "title": "Threat Mesh File Handle",
                    "x-displayname": "Threat Mesh File Handle",
                    "x-ves-example": "filename.txt"
                },
                "threat_mesh_zipped_extended_file_handle": {
                    "type": "string",
                    "description": " Handle point to the location of zipped detailed Threat mesh DB in azure\n\nExample: - \"filename.csv.tar.gz\"-",
                    "title": "Threat Mesh Zipped Extended File Handle",
                    "x-displayname": "Threat Mesh Zipped Extended File Handle",
                    "x-ves-example": "filename.csv.tar.gz"
                }
            }
        },
        "learnt_modelsModel": {
            "type": "object",
            "description": "x-displayName: \"Model\"\nDetail of model",
            "title": "model",
            "properties": {
                "url": {
                    "type": "string",
        ...
        "learnt_modelsSpecType": {
            "type": "object",
            "description": "Shape of the learnt_models specification",
            "title": "Specification for learnt models",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.learnt_models.SpecType",
            "properties": {
                "gc_spec": {
                    "description": " Shape of the learnt_models specification",
                    "title": "gc_spec",
                    "$ref": "#/definitions/learnt_modelsGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "learnt_modelsStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of Learnt models",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.learnt_models.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "learnt_modelscrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.learnt_models.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/learnt_models/crudapi/api.proto"
}`
