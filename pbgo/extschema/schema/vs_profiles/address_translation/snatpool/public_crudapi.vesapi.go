...
const (
	...
	CreateRequestFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.vs_profiles.address_translation.snatpool.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/snatpools", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/snatpools/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/snatpools/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/snatpools", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/snatpools/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.vs_profiles.address_translation.snatpool.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.vs_profiles.address_translation.snatpool")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.address_translation.snatpool.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.address_translation.snatpool.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.address_translation.snatpool.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.address_translation.snatpool.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.address_translation.snatpool.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.vs_profiles.address_translation.snatpool.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.vs_profiles.address_translation.snatpool.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.address_translation.snatpool.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.address_translation.snatpool.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.vs_profiles.address_translation.snatpool.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.vs_profiles.address_translation.snatpool.API.Create' operation on 'snatpool'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.vs_profiles.address_translation.snatpool.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.address_translation.snatpool.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.address_translation.snatpool.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.address_translation.snatpool.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.address_translation.snatpool.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.vs_profiles.address_translation.snatpool.API.Replace' operation on 'snatpool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.address_translation.snatpool.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.address_translation.snatpool.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.vs_profiles.address_translation.snatpool.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.address_translation.snatpool.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.address_translation.snatpool.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.address_translation.snatpool.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.address_translation.snatpool.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.vs_profiles.address_translation.snatpool.API.Delete' operation on 'snatpool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.vs_profiles.address_translation.snatpool.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        "title": "Snatpool",
        "description": "Collections of SNAT translation addresses",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/snatpools": {
            "post": {
                "summary": "Create Snatpool",
                "description": "Collections of SNAT translation addresses",
                "operationId": "ves.io.schema.vs_profiles.address_translation.snatpool.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/snatpoolCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/snatpoolCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-address_translation-snatpool-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.address_translation.snatpool.API.Create"
            },
            "x-displayname": "Snatpool",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.address_translation.snatpool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/snatpools/{metadata.name}": {
            "put": {
                "summary": "Replace Snatpool",
                "description": "Collections of SNAT translation addresses",
                "operationId": "ves.io.schema.vs_profiles.address_translation.snatpool.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/snatpoolReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/snatpoolReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-address_translation-snatpool-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.address_translation.snatpool.API.Replace"
            },
            "x-displayname": "Snatpool",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.address_translation.snatpool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/snatpools": {
            "get": {
                "summary": "List Snatpool",
                "description": "List the set of snatpool in a namespace",
                "operationId": "ves.io.schema.vs_profiles.address_translation.snatpool.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/snatpoolListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-address_translation-snatpool-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.address_translation.snatpool.API.List"
            },
            "x-displayname": "Snatpool",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.address_translation.snatpool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/snatpools/{name}": {
            "get": {
                "summary": "Get Snatpool",
                "description": "Collections of SNAT translation addresses",
                "operationId": "ves.io.schema.vs_profiles.address_translation.snatpool.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/snatpoolGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-address_translation-snatpool-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.address_translation.snatpool.API.Get"
            },
            "delete": {
                "summary": "Delete Snatpool",
                "description": "Delete the specified snatpool",
                "operationId": "ves.io.schema.vs_profiles.address_translation.snatpool.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/snatpoolDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-address_translation-snatpool-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.address_translation.snatpool.API.Delete"
            },
            "x-displayname": "Snatpool",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.address_translation.snatpool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "snatpoolCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of snatpool",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/snatpoolCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "snatpoolCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior",
                    "title": "spec",
                    "$ref": "#/definitions/snatpoolGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "snatpoolCreateSpecType": {
            "type": "object",
            "description": "Collections of SNAT translation addresses",
            "title": "Create Snatpool",
            "x-displayname": "Create Snatpool",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.CreateSpecType",
            "properties": {
                "app_service": {
                    "type": "string",
                ...
                "full_path": {
                    "type": "string",
                    "description": " Specifies the canonical, system-wide unique path combining partition, optional sub_path, and name",
                    "x-displayname": "Full Path"
                },
                "members": {
                    "type": "array",
                    "description": " Specifies a translation address (IPv4 or IPv6) to add to or delete from a SNAT pool.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.ip: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                        "type": "string"
                ...
                "sub_path": {
                    "type": "string",
                    "description": " Optional folder under the partition where the object resides",
                    "x-displayname": "Sub Path"
                },
                "traffic_acceleration_status": {
                    "description": " Defines the available traffic-acceleration allocation modes for the SNAT pool.",
                    "$ref": "#/definitions/snatpoolTrafficAccelerationStatusChoice",
                    "x-displayname": "Traffic Acceleration Status"
                }
            }
        },
        "snatpoolDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a snatpool",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "snatpoolGetResponse": {
            ...
            "title": "GetResponse is the shape of a read snatpool",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/snatpoolStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "snatpoolGetSpecType": {
            ...
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.GetSpecType",
            "properties": {
                "app_service": {
                    "type": "string",
                    "description": " The application service to which the object belongs.",
        ...
        "snatpoolListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of snatpool",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/snatpoolListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "snatpoolListResponseItem": {
            "type": "object",
            "description": "By default a summary of snatpool is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of snatpool",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this snatpool",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this snatpool",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates snatpool is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this snatpool",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this snatpool\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
        ...
        "snatpoolReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a snatpool",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior",
                    "title": "spec",
                    "$ref": "#/definitions/snatpoolReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "snatpoolReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.ReplaceResponse"
        },
        "snatpoolReplaceSpecType": {
            "type": "object",
            "description": "Collections of SNAT translation addresses",
            "title": "Replace Snatpool",
            "x-displayname": "Replace Snatpool",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.ReplaceSpecType",
            "properties": {
                "app_service": {
                    "type": "string",
                    "description": " The application service to which the object belongs.",
        ...
        "snatpoolStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.address_translation.snatpool.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "object_refs": {
                    "type": "array",
                    "description": " Snatpool Profile object direct reference",
                    "title": "object_refs",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
        ...
        "snatpoolTrafficAccelerationStatusChoice": {
            "type": "string",
            "description": "\n - TRAFFIC_ACCELERATION_STATUS_UNSPECIFIED: Unspecified\n - TRAFFIC_ACCELERATION_STATUS_NONE: None\n - TRAFFIC_ACCELERATION_STATUS_NON_DEDICATED: Non Dedicated\n - TRAFFIC_ACCELERATION_STATUS_DEDICATED: Dedicated\n - TRAFFIC_ACCELERATION_STATUS_SHARED: Shared",
            "title": "TrafficAccelerationStatusChoice",
            "enum": [
                "TRAFFIC_ACCELERATION_STATUS_UNSPECIFIED",
                "TRAFFIC_ACCELERATION_STATUS_NONE",
                "TRAFFIC_ACCELERATION_STATUS_NON_DEDICATED",
                "TRAFFIC_ACCELERATION_STATUS_DEDICATED",
                "TRAFFIC_ACCELERATION_STATUS_SHARED"
            ],
            "default": "TRAFFIC_ACCELERATION_STATUS_UNSPECIFIED",
            "x-displayname": "Traffic Acceleration Status Choice",
            "x-ves-proto-enum": "ves.io.schema.vs_profiles.address_translation.snatpool.TrafficAccelerationStatusChoice"
        }
    },
    "x-displayname": "Snatpool",
    "x-ves-proto-file": "ves.io/schema/vs_profiles/address_translation/snatpool/public_crudapi.proto"
}`
