...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["metadata"] = ves_io_schema.ObjectMetaTypeValidator().Validate
	v.FldValidators["system_metadata"] = ves_io_schema.SystemObjectMetaTypeValidator().Validate
	v.FldValidators["status"] = ves_io_schema_vs_profiles_services_websocket_profile.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_vs_profiles_services_websocket_profile.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_vs_profiles_services_websocket_profile.DBObject)
	}
	_ = f
