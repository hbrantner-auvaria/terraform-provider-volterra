...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/vs_profiles/services/http_profile"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.vs_profiles.services.http_profile.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.vs_profiles.services.http_profile.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.vs_profiles.services.http_profile.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.vs_profiles.services.http_profile.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.vs_profiles.services.http_profile.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.services.http_profile.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/vs_profiles/services/http_profile/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.vs_profiles.services.http_profile/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-services-http_profile-crudapi-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-services-http_profile-crudapi-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-services-http_profile-crudapi-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "http_profile",
            "x-ves-object-type": "ves.io.schema.vs_profiles.services.http_profile.Object",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.vs_profiles.services.http_profile/Objects": {
            "get": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-services-http_profile-crudapi-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-services-http_profile-crudapi-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "http_profile",
            "x-ves-object-type": "ves.io.schema.vs_profiles.services.http_profile.Object",
        ...
        "/ves.io.schema.vs_profiles.services.http_profile/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-services-http_profile-crudapi-api-liststream"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "http_profile",
            "x-ves-object-type": "ves.io.schema.vs_profiles.services.http_profile.Object",
        ...
        "/ves.io.schema.vs_profiles.services.http_profile/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.vs_profiles.services.http_profile/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.vs_profiles.services.http_profile/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.vs_profiles.services.http_profile/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.vs_profiles.services.http_profile.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/http_profileSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/http_profilecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/http_profilecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/http_profilecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/http_profilecrudapiErrorCode"
                },
        ...
        "http_profileGlobalSpecType": {
            "type": "object",
            "description": "Virtual Server HTTP traffic profile configuration",
            "title": "GlobalSpecType",
            "x-displayname": "ProfileHttp Specification",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.GlobalSpecType",
            "properties": {
                "accept_xff": {
                ...
                "expiration_micros": {
                    "type": "integer",
                    "title": "expiration_micros",
                    "format": "int32",
                    "x-displayname": "Expiration Micros"
                },
                "explicit_proxy": {
                    "title": "explicit_proxy",
                ...
                "response_chunking_choice": {
                    ...
                    "title": "response_chunking_choice",
                ...
                "response_headers_permitted": {
                    ...
                    "title": "response_headers_permitted",
                    "items": {
                        "type": "string"
                    },
        ...
        "http_profileSpecType": {
            "type": "object",
            "description": "Desired state of the HTTP Profile Object",
            "title": "Shape of the HTTP Profile Object",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.services.http_profile.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/http_profileGlobalSpecType",
        ...
        "http_profilecrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.vs_profiles.services.http_profile.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/vs_profiles/services/http_profile/crudapi/api.proto"
}`
