...
const (
	ObjectDefTblName = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.Object.default"
	ObjectType       = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.Object"

	StatusObjectDefTblName = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.StatusObject.default"
	StatusObjectType       = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.StatusObject"
)

// augmented methods on protoc/std generated struct
func (e *Object) Type() string {
	return "ves.io.schema.vs_profiles.ssl.ssl_server_profile.Object"
}
...
func (e *DBObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	if fdrInfos, err := e.GetSpecDRefInfo(); err != nil {
		...
		for i := range fdrInfos {
			...
			dri.DRField = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.Object." + dri.DRField
			dri.RefrType = e.Type()
			dri.RefrUID = refrUID
...
func FindObjectStatus(ctx context.Context, d db.Interface, objUid string) ([]*StatusObject, error) {
	statusDBEntries, err := d.GetEntryBackrefs(ctx, objUid, ObjectType, db.WithBackrefTypes([]string{"ves.io.schema.vs_profiles.ssl.ssl_server_profile.StatusObject"}))
	if err != nil {
		return nil, err
	}
...
func (e *StatusObject) Type() string {
	return "ves.io.schema.vs_profiles.ssl.ssl_server_profile.StatusObject"
}
...
func (e *DBStatusObject) GetDRefInfo() ([]db.DRefInfo, error) {
	...
	for i := range drInfos {
		dri := &drInfos[i]
		// Convert Spec.LcSpec.vnRefs to ves.io.examplesvc.objectone.Object.Spec.LcSpec.vnRefs
		dri.DRField = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.StatusObject." + dri.DRField
		dri.RefrType = e.Type()
		dri.RefrUID = refrUID
...
func (e *DBStatusObject) GetObjectRefsDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	...
	refdType, err := d.TypeForEntryKind(e.Type(), refrUID, "ssl_server_profile.Object")
	if err != nil {
