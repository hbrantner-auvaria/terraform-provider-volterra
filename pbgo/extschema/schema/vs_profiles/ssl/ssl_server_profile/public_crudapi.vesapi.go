...
const (
	...
	CreateRequestFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.vs_profiles.ssl.ssl_server_profile.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ssl_server_profiles", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ssl_server_profiles/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ssl_server_profiles/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/ssl_server_profiles", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ssl_server_profiles/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.vs_profiles.ssl.ssl_server_profile.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.vs_profiles.ssl.ssl_server_profile")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.vs_profiles.ssl.ssl_server_profile.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.vs_profiles.ssl.ssl_server_profile.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.vs_profiles.ssl.ssl_server_profile.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Create' operation on 'ssl_server_profile'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.vs_profiles.ssl.ssl_server_profile.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Replace' operation on 'ssl_server_profile'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.vs_profiles.ssl.ssl_server_profile.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Delete' operation on 'ssl_server_profile'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.vs_profiles.ssl.ssl_server_profile.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Virtual server server-side proxy SSL profile",
        "description": "Virtual server server-side proxy SSL profile configuration",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/ssl_server_profiles": {
            "post": {
                "summary": "Create Virtual server server-side proxy SSL profile",
                "description": "Virtual server server-side proxy SSL profile configuration",
                "operationId": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ssl_server_profileCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ssl_server_profileCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ssl_server_profile-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Create"
            },
            "x-displayname": "Virtual server server-side proxy SSL profile",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/ssl_server_profiles/{metadata.name}": {
            "put": {
                "summary": "Replace ServerSsl",
                "description": "Virtual server server-side proxy SSL profile configuration",
                "operationId": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ssl_server_profileReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ssl_server_profileReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ssl_server_profile-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Replace"
            },
            "x-displayname": "Virtual server server-side proxy SSL profile",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/ssl_server_profiles": {
            "get": {
                "summary": "List Virtual server server-side proxy SSL profile",
                "description": "List the set of ssl_server_profile in a namespace",
                "operationId": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ssl_server_profileListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    {
                        "name": "namespace",
                        "description": "namespace\n\nx-example: \"ns1\"\nNamespace to scope the listing of ssl_server_profile",
                        "in": "path",
                        "required": true,
                        "type": "string",
                        "x-displayname": "Namespace"
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ssl_server_profile-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.List"
            },
            "x-displayname": "Virtual server server-side proxy SSL profile",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/ssl_server_profiles/{name}": {
            "get": {
                "summary": "Get Virtual server server-side proxy SSL profile",
                "description": "Virtual server server-side proxy SSL profile configuration",
                "operationId": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ssl_server_profileGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ssl_server_profile-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Get"
            },
            "delete": {
                "summary": "Delete Virtual server server-side proxy SSL profile",
                "description": "Delete the specified ssl_server_profile",
                "operationId": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ssl_server_profileDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ssl_server_profile-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API.Delete"
            },
            "x-displayname": "Virtual server server-side proxy SSL profile",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "ssl_server_profileCertificateList": {
            "type": "object",
            "description": "List of certificates",
            "title": "CertificateList",
            "x-displayname": "Certificate List",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.CertificateList",
            "properties": {
                "certificates": {
                    "type": "array",
        ...
        "ssl_server_profileCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of ssl_server_profile",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/ssl_server_profileCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "ssl_server_profileCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior",
                    "title": "spec",
                    "$ref": "#/definitions/ssl_server_profileGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "ssl_server_profileCreateSpecType": {
            "type": "object",
            "description": "Virtual server server-side proxy SSL profile configuration",
            "title": "Create Virtual server server-side proxy SSL profile",
            ...
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.CreateSpecType",
            "properties": {
                "alert_timeout": {
                    "type": "string",
                ...
                "authenticate_depth": {
                    "type": "integer",
                    "description": " Specifies the client certificate chain maximum traversal depth.\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 15\n",
                    "format": "int64",
                ...
                "authenticate_name": {
                    "type": "string",
                    "description": " Specifies a Common Name (CN) that is embedded in a server certificate. The system authenticates a server based on the specified CN.",
                    "x-displayname": "Authenticate Name"
                },
                "bypass_on_client_cert_fail": {
                    "description": " Specifies whether bypass SSL forward proxy traffic when fails to retrieve the Client Certificate from the BIGIP that Server ask for. The default value is disabled.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                    "x-displayname": "Bypass On Client Cert Fail"
                },
                "bypass_on_handshake_alert": {
                    "description": " Specifies whether bypass SSL forward proxy traffic when receiving handshake_failure(40) Alert. The default value is disabled.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                    "x-displayname": "Bypass On Handshake Alert"
                },
                "c3d_cert_lifespan": {
                    "type": "integer",
                    "description": " Specifies the lifespan of the certificate generated using SSL client certificate constrained delegation. The default value is 24 hours.\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 24\n  ves.io.schema.rules.uint32.lte: 720\n",
                    "format": "int64",
                ...
                "cache_timeout": {
                    "type": "integer",
                    "description": " Specifies the SSL session cache timeout value, which is the usable lifetime seconds of negotiated SSL session IDs. The default value is 3600 seconds. Acceptable values are integers greater than or equal to 0 and less than or equal to 86400.\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 86400\n",
                    "format": "int64",
                ...
                "certificates": {
                    ...
                    "$ref": "#/definitions/ssl_server_profileCertificateList",
                    "x-displayname": "Certificates"
                },
                "cipher_group": {
                    "type": "string",
                ...
                "data_0rtt": {
                    "description": " Specifies if TLSv1.3 should send 0-RTT early data when available. The default value is disabled.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                    "x-displayname": "Data 0-RTT"
                },
                "expire_cert_response_control": {
                    "description": " Specifies the action for the BIG-IP system to take when the server certificate has expired. The default value is drop, which causes the connection to be dropped. Conversely, you can specify ignore to cause the connection to ignore the error and continue or you can specify mask in case of SSL forward proxy to mask server certificate errors and continue with handshake and forge a good certificate on client-side. Note that drop works only if the certificate is trusted.",
                ...
                "mod_ssl_methods": {
                    "description": " Enables or disables ModSSL method emulation. Use enabled when OpenSSL methods are inadequate. For example, you can enable ModSSL method emulation when you want to use SSL compression over TLSv1.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                    "x-displayname": "Mod SSL Methods"
                },
                "mode": {
                    "description": " Enables or disables SSL processing. The default value is enabled.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                    "x-displayname": "Mode"
                },
                "ocsp": {
                    "type": "array",
                    "description": " Specifies the name of ocsp profile for purpose of validating status of server certificate. Specifying none disables ocsp validation of server certificate. The default value is none.\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "retain_certificate": {
                    "description": " When true, server certificate is retained in SSL session.",
                    "$ref": "#/definitions/vs_profilesTrueFalseChoice",
                    "x-displayname": "Retain Certificate"
                },
                "revoked_cert_status_response_control": {
                    "description": " Specifies the system action when the server certificate status is revoked. The default value is drop, which causes the connection to be dropped. You can specify ignore to cause the connection to ignore the error and continue handshake. You can specify mask in case of SSL forward proxy to mask server certificate status error and continue handshake.",
                    "$ref": "#/definitions/vs_profilesAcceptRejectChoice",
                    "x-displayname": "Revoked Cert Status Response Control"
                },
                "secure_renegotiation": {
                    "description": " Controls secure renegotiation. The default value is require-strict.",
                ...
                "sni_require": {
                    "description": " When true, SNI support is required for the peer. If a client connection does not specify a known server name, or does not specify any server name at all, the connection will be rejected. The default value is false.",
                    "$ref": "#/definitions/vs_profilesTrueFalseChoice",
                ...
                "ssl_forward_proxy": {
                    "description": " Specifies if the SSL Forward Proxy feature is enabled. The default value is disabled.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                    "x-displayname": "SSL Forward Proxy"
                },
                "ssl_forward_proxy_bypass": {
                    "description": " Specifies if the SSL Forward Proxy Bypass feature is enabled. The default value is disabled.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                ...
                "strict_resume": {
                    "description": " You can enable or disable the resumption of SSL sessions after an unclean shutdown. The default value is disabled, which indicates that the SSL profile refuses to resume SSL sessions after an unclean shutdown.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                    "x-displayname": "Strict Resume"
                },
                "unclean_shutdown": {
                    "description": " By default, the SSL profile performs unclean shutdowns of all SSL connections, which means that underlying TCP connections are closed without exchanging the required SSL shutdown alerts. If you want to force the SSL profile to perform a clean shutdown of all SSL connections, you can disable this.",
                    "$ref": "#/definitions/vs_profilesEnableDisableChoice",
                    "x-displayname": "Unclean Shutdown"
                },
                "unknown_cert_status_response_control": {
                    "description": " Specifies the system action when the server certificate status is unknown. The default value is ignore, which causes the connection to ignore the error and continue handshake. You can specify drop which causes the connection to be dropped. You can specify mask in case of SSL forward proxy to mask server certificate status error and continue handshake.",
                    "$ref": "#/definitions/vs_profilesAcceptRejectChoice",
                    "x-displayname": "Unknown Cert Status Response Control"
                },
                "untrusted_cert_response_control": {
                    "description": " Specifies the system action when the server certificate has untrusted CA. The default value is drop, which causes the connection to be dropped. Conversely, you can specify ignore to cause the connection to ignore the error and continue or you can specify mask in case of SSL forward proxy to mask server certificate errors and continue with handshake and forge a good certificate on client-side.",
                    "$ref": "#/definitions/vs_profilesAcceptRejectChoice",
        ...
        "ssl_server_profileDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a ssl_server_profile",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "ssl_server_profileGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read ssl_server_profile",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/ssl_server_profileStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "ssl_server_profileGetResponseFormatCode": {
            "type": "string",
        ...
        "ssl_server_profileGetSpecType": {
            "type": "object",
            "description": "Virtual server server-side proxy SSL profile configuration",
            "title": "Get Virtual server server-side proxy SSL profile",
            "x-displayname": "Get Virtual server server-side proxy SSL profile",
            "x-ves-oneof-field-certificates_choice": "[\"certificates\"]",
            "x-ves-oneof-field-cipher_config": "[\"cipher_group\",\"ciphers\"]",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.GetSpecType",
            "properties": {
                "alert_timeout": {
                    "type": "string",
                    "description": " Specifies the alert timeout in seconds. You can also specify indefinite or immediate.\n\nValidation Rules:\n  ves.io.schema.rules.string.pattern: ^(indefinite|[0-9]+)$\n",
        ...
        "ssl_server_profileListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of ssl_server_profile",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/ssl_server_profileListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "ssl_server_profileListResponseItem": {
            "type": "object",
            "description": "By default a summary of ssl_server_profile is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of ssl_server_profile",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this ssl_server_profile",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this ssl_server_profile",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates ssl_server_profile is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this ssl_server_profile",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this ssl_server_profile\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this ssl_server_profile\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "ssl_server_profileReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a ssl_server_profile",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior",
                    "title": "spec",
                    "$ref": "#/definitions/ssl_server_profileReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "ssl_server_profileReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ReplaceResponse"
        },
        "ssl_server_profileReplaceSpecType": {
            "type": "object",
            "description": "Virtual server server-side proxy SSL profile configuration",
            "title": "Replace ServerSsl",
            "x-displayname": "Replace ServerSsl",
            "x-ves-oneof-field-certificates_choice": "[\"certificates\"]",
            "x-ves-oneof-field-cipher_config": "[\"cipher_group\",\"ciphers\"]",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.ReplaceSpecType",
            "properties": {
                "alert_timeout": {
                    "type": "string",
                    "description": " Specifies the alert timeout in seconds. You can also specify indefinite or immediate.\n\nValidation Rules:\n  ves.io.schema.rules.string.pattern: ^(indefinite|[0-9]+)$\n",
        ...
        "ssl_server_profileStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ssl_server_profile.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "object_refs": {
                    "type": "array",
                    "description": " SSL Server Profile object direct reference",
                    "title": "object_refs",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
    ...
    "x-displayname": "Virtual server server-side proxy SSL profile",
    "x-ves-proto-file": "ves.io/schema/vs_profiles/ssl/ssl_server_profile/public_crudapi.proto"
}`
