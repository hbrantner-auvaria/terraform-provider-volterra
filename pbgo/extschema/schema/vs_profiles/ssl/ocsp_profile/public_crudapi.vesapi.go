...
const (
	...
	CreateRequestFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.vs_profiles.ssl.ocsp_profile.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ocsp_profiles", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ocsp_profiles/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ocsp_profiles/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/ocsp_profiles", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/ocsp_profiles/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.vs_profiles.ssl.ocsp_profile.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.vs_profiles.ssl.ocsp_profile")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.vs_profiles.ssl.ocsp_profile.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.vs_profiles.ssl.ocsp_profile.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.vs_profiles.ssl.ocsp_profile.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Create' operation on 'ocsp_profile'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.vs_profiles.ssl.ocsp_profile.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Replace' operation on 'ocsp_profile'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.vs_profiles.ssl.ocsp_profile.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ocsp_profile.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Delete' operation on 'ocsp_profile'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.vs_profiles.ssl.ocsp_profile.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        "title": "OCSP profile",
        "description": "OCSP profile configuration\nOCSP Profile Object",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/ocsp_profiles": {
            "post": {
                "summary": "Create OCSP profile",
                "description": "OCSP profile configuration",
                "operationId": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ocsp_profileCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ocsp_profileCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ocsp_profile-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Create"
            },
            "x-displayname": "OCSP profile",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/ocsp_profiles/{metadata.name}": {
            "put": {
                "summary": "Replace OCSP profile",
                "description": "OCSP profile configuration",
                "operationId": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ocsp_profileReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ocsp_profileReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ocsp_profile-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Replace"
            },
            "x-displayname": "OCSP profile",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/ocsp_profiles": {
            "get": {
                "summary": "List OCSP profile",
                "description": "List the set of ocsp_profile in a namespace",
                "operationId": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ocsp_profileListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ocsp_profile-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.List"
            },
            "x-displayname": "OCSP profile",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/ocsp_profiles/{name}": {
            "get": {
                "summary": "Get OCSP profile",
                "description": "OCSP profile configuration",
                "operationId": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/ocsp_profileGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ocsp_profile-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Get"
            },
            "delete": {
                "summary": "Delete OCSP profile",
                "description": "Delete the specified ocsp_profile",
                "operationId": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ocsp_profileDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-vs_profiles-ssl-ocsp_profile-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API.Delete"
            },
            "x-displayname": "OCSP profile",
            "x-ves-proto-service": "ves.io.schema.vs_profiles.ssl.ocsp_profile.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "ocsp_profileCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of ocsp_profile",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/ocsp_profileCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "ocsp_profileCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior",
                    "title": "spec",
                    "$ref": "#/definitions/ocsp_profileGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "ocsp_profileCreateSpecType": {
            "type": "object",
            "description": "OCSP profile configuration",
            "title": "Create OCSP profile",
            "x-displayname": "Create OCSP profile",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.CreateSpecType",
            "properties": {
                "full_path": {
                    "type": "string",
                ...
                "max_age": {
                    "type": "integer",
                    "description": " Specifies the value for HTTP Response cache control header max-age. The max-age header sent to client is the lesser of the configured value and validity of OCSP response. Default value is 604800 seconds.\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 4294967295\n",
                    "format": "int64",
                ...
                "nonce": {
                    "description": " Specifies whether OCSP Nonce Request Extension is supported by the OCSP profile. Default value is Enabled.",
        ...
        "ocsp_profileDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a ocsp_profile",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "ocsp_profileGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read ocsp_profile",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/ocsp_profileStatusObject"
                    },
        ...
        "ocsp_profileGetResponseFormatCode": {
            "type": "string",
        ...
        "ocsp_profileGetSpecType": {
            "type": "object",
            "description": "OCSP profile configuration",
            "title": "Get OCSP profile",
            "x-displayname": "Get OCSP profile",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.GetSpecType",
            "properties": {
                "full_path": {
                    "type": "string",
                    "x-displayname": "Full Path"
        ...
        "ocsp_profileListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of ocsp_profile",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/ocsp_profileListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "ocsp_profileListResponseItem": {
            "type": "object",
            "description": "By default a summary of ocsp_profile is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of ocsp_profile",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this ocsp_profile",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this ocsp_profile",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates ocsp_profile is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this ocsp_profile",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this ocsp_profile\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this ocsp_profile\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "ocsp_profileReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a ocsp_profile",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior",
                    "title": "spec",
                    "$ref": "#/definitions/ocsp_profileReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "ocsp_profileReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.ReplaceResponse"
        },
        "ocsp_profileReplaceSpecType": {
            "type": "object",
            "description": "OCSP profile configuration",
            "title": "Replace OCSP profile",
            "x-displayname": "Replace OCSP profile",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.ReplaceSpecType",
            "properties": {
                "full_path": {
                    "type": "string",
                    "x-displayname": "Full Path"
        ...
        "ocsp_profileStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.vs_profiles.ssl.ocsp_profile.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "object_refs": {
                    "type": "array",
                    "description": " OCSP Profile object direct reference",
                    "title": "object_refs",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
    ...
    "x-ves-proto-file": "ves.io/schema/vs_profiles/ssl/ocsp_profile/public_crudapi.proto"
}`
