...
var DefaultObjectCreateReqValidator = func() *ValidateObjectCreateReq {
	...
	v.FldValidators["spec"] = ves_io_schema_vs_profiles_protocol_tcp_profile.SpecTypeValidator().Validate
...
var DefaultObjectGetRspValidator = func() *ValidateObjectGetRsp {
	...
	v.FldValidators["system_metadata"] = ves_io_schema.SystemObjectMetaTypeValidator().Validate
	v.FldValidators["spec"] = ves_io_schema_vs_profiles_protocol_tcp_profile.SpecTypeValidator().Validate
	v.FldValidators["status"] = ves_io_schema_vs_profiles_protocol_tcp_profile.StatusObjectValidator().Validate
...
func (m *ObjectCreateReq) fromObject(e db.Entry, withDeepCopy bool) {
	f := e.(*ves_io_schema_vs_profiles_protocol_tcp_profile.DBObject)
	if withDeepCopy {
		f = e.DeepCopy().(*ves_io_schema_vs_profiles_protocol_tcp_profile.DBObject)
	}
	_ = f
