...
/*
Package tcp_profile is a reverse proxy.
...
var (
	pattern_API_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"public", "namespaces", "metadata.namespace", "tcp_profiles"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_API_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"public", "namespaces", "namespace", "tcp_profiles", "name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_API_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"public", "namespaces", "namespace", "tcp_profiles"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_API_Replace_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"public", "namespaces", "metadata.namespace", "tcp_profiles", "metadata.name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_API_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"public", "namespaces", "namespace", "tcp_profiles", "name"}, "", runtime.AssumeColonVerbOpt(false)))
)
