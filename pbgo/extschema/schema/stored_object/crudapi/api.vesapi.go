...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/stored_object"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.stored_object.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.stored_object.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.stored_object.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.stored_object.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.stored_object.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.stored_object.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.stored_object.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.stored_object.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.stored_object.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.stored_object.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.stored_object.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.stored_object.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/stored_object/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.stored_object/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-stored_object-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.stored_object.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-stored_object-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.stored_object.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-stored_object-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.stored_object.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "stored_object",
            "x-ves-object-type": "ves.io.schema.stored_object.Object",
            "x-ves-proto-service": "ves.io.schema.stored_object.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.stored_object/Objects": {
            "get": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-stored_object-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.stored_object.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-stored_object-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.stored_object.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "stored_object",
            "x-ves-object-type": "ves.io.schema.stored_object.Object",
        ...
        "/ves.io.schema.stored_object/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-stored_object-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.stored_object.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "stored_object",
            "x-ves-object-type": "ves.io.schema.stored_object.Object",
        ...
        "/ves.io.schema.stored_object/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.stored_object/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.stored_object/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.stored_object/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.stored_object.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.stored_object.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/stored_objectSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.stored_object.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/stored_objectcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.stored_object.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/stored_objectcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.stored_object.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/stored_objectStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.stored_object.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/stored_objectcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.stored_object.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.stored_object.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.stored_object.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/stored_objectcrudapiErrorCode"
                },
        ...
        "stored_objectContentTransport": {
            "type": "string",
            "description": "The content transport represents how the actual content was transported from the user. Bytes or string.",
            "title": "ContentTransport",
            "enum": [
                "CONTENT_TRANSPORT_NONE",
                "CONTENT_TRANSPORT_STRING",
                "CONTENT_TRANSPORT_BYTES"
            ],
            "default": "CONTENT_TRANSPORT_NONE"
        },
        "stored_objectGlobalSpecType": {
            "type": "object",
        ...
        "stored_objectSpecType": {
            "type": "object",
            "title": "Shape of the Stored Object specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.stored_object.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/stored_objectGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "stored_objectStatusObject": {
            "type": "object",
            "title": "Most recently observed status of object",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.stored_object.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "stored_objectcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.stored_object.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/stored_object/crudapi/api.proto"
}`
