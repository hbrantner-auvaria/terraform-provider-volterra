...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/tunnels", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/tunnels/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/tunnels/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/tunnels", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/tunnels/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.tunnel.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.tunnel")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tunnel.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tunnel.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tunnel.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tunnel.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.tunnel.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tunnel.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tunnel.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.tunnel.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.tunnel.API.Create' operation on 'tunnel'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.tunnel.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.tunnel.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tunnel.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tunnel.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.tunnel.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.tunnel.API.Replace' operation on 'tunnel'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.tunnel.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tunnel.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.tunnel.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tunnel.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.tunnel.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.tunnel.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.tunnel.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.tunnel.API.Delete' operation on 'tunnel'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.tunnel.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/tunnels": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/tunnelCreateResponse"
                        }
                    },
                    "401": {
            ...
            "x-ves-proto-service": "ves.io.schema.tunnel.API",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/tunnelReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/tunnelReplaceRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/tunnelListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/tunnelGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/tunnelDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "schematunnelCreateSpecType": {
            ...
            "properties": {
                "local_ip": {
                    ...
                    "$ref": "#/definitions/tunnelLocalIpAddressSelector",
                ...
                "params": {
                    "description": " Configuration for supported tunnel types",
                    "$ref": "#/definitions/tunnelTunnelParams",
                    "x-displayname": "Tunnel Parameters"
                },
                "remote_ip": {
                    "description": " Selects remote endpoint IP address configuration for tunnel\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/tunnelRemoteIpAddressSelector",
        ...
        "schematunnelReplaceSpecType": {
            "type": "object",
            "description": "Replace tunnel in a given namespace.",
            "title": "Replace tunnel",
        ...
        "tunnelCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of tunnel",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Tunnel",
                    "title": "spec",
                    "$ref": "#/definitions/schematunnelCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "tunnelCreateResponse": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Tunnel",
                    "title": "spec",
                    "$ref": "#/definitions/schematunnelGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "tunnelDeleteRequest": {
            ...
            "title": "DeleteRequest is used to delete a tunnel",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.tunnel.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "tunnelGetResponse": {
            ...
            "title": "GetResponse is the shape of a read tunnel",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/tunnelStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "tunnelInterfaceType": {
            ...
            "x-ves-proto-message": "ves.io.schema.tunnel.InterfaceType",
            "properties": {
                "local_intf": {
                    "type": "array",
        ...
        "tunnelIpsecTunnelParams": {
            "type": "object",
            "description": "Configuration for IPSec encapsulation are:\n1. PSK - pre shared key to be used by IKE",
            "title": "IPSec tunnel configuration parameters",
            "x-displayname": "IPSEC tunnel parameters",
            "x-ves-proto-message": "ves.io.schema.tunnel.IpsecTunnelParams",
            "properties": {
                "ipsec_psk": {
                    "description": " Pre shared key, valid for tunnel type IPSEC_PSK, SA are computed by IKE dynamically",
                    "title": "IPSec Pre shared key",
        ...
        "tunnelListResponse": {
            ...
            "title": "ListResponse is the collection of tunnel",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.tunnel.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/tunnelListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "tunnelListResponseItem": {
            "type": "object",
            "description": "By default a summary of tunnel is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of tunnel",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.tunnel.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this tunnel",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this tunnel",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates tunnel is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this tunnel",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
        ...
        "tunnelRemoteEndpointType": {
            "type": "object",
            "description": "Provides a map of ver node name to remote node attributes\nVer node should use these attributes to configure as remote tunnel",
            "title": "Remote Endpoint Type",
            "x-displayname": "Remote Endpoint Type",
            "x-ves-proto-message": "ves.io.schema.tunnel.RemoteEndpointType",
            "properties": {
                "endpoints": {
                    "type": "object",
                    "description": " Map of remote attributes to which tunnel will be established on per site node basis\n Every node can have a different attributes and IP address to connect to\n Key is ver node name and value is Remote node attributes\n\nValidation Rules:\n  ves.io.schema.rules.map.keys.string.max_len: 256\n  ves.io.schema.rules.map.keys.string.min_len: 1\n  ves.io.schema.rules.map.max_pairs: 128\n",
        ...
        "tunnelRemoteIpAddressSelector": {
            "type": "object",
            "description": "Defines the options to select remote ip address for tunnel object\nOptions available are -\n1. IP Address - Specifies the remote IP to which tunnel has to be connected\n2. Remote endpoint - Is a map of IP address on per ver node basis",
            "title": "Remote IP Address Selector",
            "x-displayname": "Remote IP Address Selector",
        ...
        "tunnelRemoteNodeAttributes": {
            "type": "object",
            "description": "x-displayName: \"Remote Node Attributes\"\nRemote node attributes specify parameters needed to be configured for remote node",
            "title": "Remote Node Atributes",
            "properties": {
                "ip": {
        ...
        "tunnelReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a tunnel",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Tunnel",
                    "title": "spec",
                    "$ref": "#/definitions/schematunnelReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "tunnelReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.tunnel.ReplaceResponse"
        },
        "tunnelStatusObject": {
            "type": "object",
            ...
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.tunnel.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "tunnelTunnelParams": {
            "type": "object",
            "description": "Tunnel configuration parameters for supported encapsulation\n1. IPSec is supported with PSK for which PSK can be configured",
        ...
        "tunnelTunnelType": {
            ...
            "default": "IPSEC_PSK",
            "x-displayname": "Tunnel Type",
            "x-ves-proto-enum": "ves.io.schema.tunnel.TunnelType"
        }
    },
    "x-displayname": "Tunnel",
    "x-ves-proto-file": "ves.io/schema/tunnel/public_crudapi.proto"
}`
