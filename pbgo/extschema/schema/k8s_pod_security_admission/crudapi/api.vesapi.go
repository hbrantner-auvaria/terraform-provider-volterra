...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/k8s_pod_security_admission"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.k8s_pod_security_admission.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.k8s_pod_security_admission.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.k8s_pod_security_admission.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_admission.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_admission.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_admission.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_admission.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_admission.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.k8s_pod_security_admission.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.k8s_pod_security_admission.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_admission.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_pod_security_admission.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_admission.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_pod_security_admission.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_admission.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_admission.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_admission.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_pod_security_admission.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/k8s_pod_security_admission/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.k8s_pod_security_admission/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_admission-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_admission-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_admission-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_pod_security_admission",
            "x-ves-object-type": "ves.io.schema.k8s_pod_security_admission.Object",
            "x-ves-proto-service": "ves.io.schema.k8s_pod_security_admission.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.k8s_pod_security_admission/Objects": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_admission-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_admission.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_admission-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_pod_security_admission",
            "x-ves-object-type": "ves.io.schema.k8s_pod_security_admission.Object",
        ...
        "/ves.io.schema.k8s_pod_security_admission/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_admission-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_admission.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_pod_security_admission",
            "x-ves-object-type": "ves.io.schema.k8s_pod_security_admission.Object",
        ...
        "/ves.io.schema.k8s_pod_security_admission/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_pod_security_admission/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_pod_security_admission/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_pod_security_admission/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.k8s_pod_security_admission.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/k8s_pod_security_admissionSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_pod_security_admissioncrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_pod_security_admissioncrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/k8s_pod_security_admissionStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_pod_security_admissioncrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_pod_security_admissioncrudapiErrorCode"
                },
        ...
        "k8s_pod_security_admissionGlobalSpecType": {
            "type": "object",
            "description": "Specifications for Pod Security Admission",
            "title": "GlobalSpecType",
            "x-displayname": "Global Configuration Specification",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.GlobalSpecType",
            "properties": {
                "pod_security_admission_specs": {
                    ...
                    "maxItems": 9,
                    "items": {
                        "$ref": "#/definitions/k8s_pod_security_admissionPodSecurityAdmissionSpec"
                    },
        ...
        "k8s_pod_security_admissionPodSecurityAdmissionSpec": {
            "type": "object",
            "description": "Pod Security Admission Spec is combination of policy type and admission mode",
            "title": "PodSecurityAdmissionSpec",
            "x-displayname": "Pod Security Admission Spec",
            "x-ves-oneof-field-admission_mode_choice": "[\"audit\",\"enforce\",\"warn\"]",
            "x-ves-oneof-field-policy_type_choice": "[\"baseline\",\"privileged\",\"restricted\"]",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.PodSecurityAdmissionSpec",
            "properties": {
                "audit": {
                    "description": "Exclusive with [enforce warn]\n Policy violations will trigger the addition of an audit annotation to the event recorded in the audit log, but are otherwise allowed.",
                    "title": "Audit Mode",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Audit Mode"
                },
                "baseline": {
                    "description": "Exclusive with [privileged restricted]\n Minimally restrictive policy which prevents known privilege escalations",
                    "title": "Baseline policy",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Baseline policy"
                },
                "enforce": {
                    "description": "Exclusive with [audit warn]\n Policy violations will cause the pod to be rejected.",
                    "title": "Enforce Mode",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Enforce Mode"
                },
                "privileged": {
                    "description": "Exclusive with [baseline restricted]\n Unrestricted policy, providing the widest possible level of permissions",
                    "title": "Privileged policy",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Privileged policy"
                },
                "restricted": {
                    "description": "Exclusive with [baseline privileged]\n Heavily restricted policy, following current Pod hardening best practices.",
                    "title": "Restricted policy",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Restricted policy"
                },
                "warn": {
                    "description": "Exclusive with [audit enforce]\n Policy violations will trigger a user-facing warning, but are otherwise allowed.",
                    "title": "Warn Mode",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Warn Mode"
                }
            }
        },
        "k8s_pod_security_admissionSpecType": {
            "type": "object",
            "description": "Shape of the k8s_pod_security_admission specification",
            "title": "Specification for K8s Pod Security Policy",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/k8s_pod_security_admissionGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "k8s_pod_security_admissionStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for K8s Pod Security Policy",
            "x-displayname": "K8s Pod Security Policy",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_admission.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "k8s_pod_security_admissioncrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.k8s_pod_security_admission.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/k8s_pod_security_admission/crudapi/api.proto"
}`
