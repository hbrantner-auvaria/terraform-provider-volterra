...
type HttpHealthCheck struct {
	...
	// x-required
	//
	// Types that are valid to be assigned to VirtualHostChoice:
	//	*HttpHealthCheck_DisableVirtualHost
	//	*HttpHealthCheck_VirtualHost
	//	*HttpHealthCheck_InheritLoadBalancerFqdn
	VirtualHostChoice isHttpHealthCheck_VirtualHostChoice `protobuf_oneof:"virtual_host_choice"`
}
...
type isHttpHealthCheck_VirtualHostChoice interface {
	isHttpHealthCheck_VirtualHostChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type HttpHealthCheck_DisableVirtualHost struct {
	DisableVirtualHost *schema.Empty `protobuf:"bytes,6,opt,name=disable_virtual_host,json=disableVirtualHost,proto3,oneof" json:"disable_virtual_host,omitempty"`
}
type HttpHealthCheck_VirtualHost struct {
	VirtualHost string `protobuf:"bytes,7,opt,name=virtual_host,json=virtualHost,proto3,oneof" json:"virtual_host,omitempty"`
}
type HttpHealthCheck_InheritLoadBalancerFqdn struct {
	InheritLoadBalancerFqdn *schema.Empty `protobuf:"bytes,8,opt,name=inherit_load_balancer_fqdn,json=inheritLoadBalancerFqdn,proto3,oneof" json:"inherit_load_balancer_fqdn,omitempty"`
}

func (*HttpHealthCheck_DisableVirtualHost) isHttpHealthCheck_VirtualHostChoice()      {}
func (*HttpHealthCheck_VirtualHost) isHttpHealthCheck_VirtualHostChoice()             {}
func (*HttpHealthCheck_InheritLoadBalancerFqdn) isHttpHealthCheck_VirtualHostChoice() {}

func (m *HttpHealthCheck) GetVirtualHostChoice() isHttpHealthCheck_VirtualHostChoice {
	if m != nil {
		return m.VirtualHostChoice
	}
	return nil
}
...
func (m *HttpHealthCheck) GetDisableVirtualHost() *schema.Empty {
	if x, ok := m.GetVirtualHostChoice().(*HttpHealthCheck_DisableVirtualHost); ok {
		return x.DisableVirtualHost
	}
	return nil
}

func (m *HttpHealthCheck) GetVirtualHost() string {
	if x, ok := m.GetVirtualHostChoice().(*HttpHealthCheck_VirtualHost); ok {
		return x.VirtualHost
	}
	return ""
}

func (m *HttpHealthCheck) GetInheritLoadBalancerFqdn() *schema.Empty {
	if x, ok := m.GetVirtualHostChoice().(*HttpHealthCheck_InheritLoadBalancerFqdn); ok {
		return x.InheritLoadBalancerFqdn
	}
	return nil
}
...
func (*HttpHealthCheck) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*HttpHealthCheck_DisableVirtualHost)(nil),
		(*HttpHealthCheck_VirtualHost)(nil),
		(*HttpHealthCheck_InheritLoadBalancerFqdn)(nil),
	}
}
...
var fileDescriptor_6febe8700ef285c8 = []byte{
	...
	,
}
...
func (this *HttpHealthCheck) Equal(that interface{}) bool {
	...
	if that1.VirtualHostChoice == nil {
		if this.VirtualHostChoice != nil {
			return false
		}
	} else if this.VirtualHostChoice == nil {
		return false
	} else if !this.VirtualHostChoice.Equal(that1.VirtualHostChoice) {
		return false
	}
	return true
}
func (this *HttpHealthCheck_DisableVirtualHost) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HttpHealthCheck_DisableVirtualHost)
	if !ok {
		that2, ok := that.(HttpHealthCheck_DisableVirtualHost)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DisableVirtualHost.Equal(that1.DisableVirtualHost) {
		return false
	}
	return true
}
func (this *HttpHealthCheck_VirtualHost) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HttpHealthCheck_VirtualHost)
	if !ok {
		that2, ok := that.(HttpHealthCheck_VirtualHost)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *HttpHealthCheck_InheritLoadBalancerFqdn) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HttpHealthCheck_InheritLoadBalancerFqdn)
	if !ok {
		that2, ok := that.(HttpHealthCheck_InheritLoadBalancerFqdn)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.InheritLoadBalancerFqdn.Equal(that1.InheritLoadBalancerFqdn) {
		return false
	}
	return true
}
...
func (this *HttpHealthCheck) GoString() string {
	...
	if this.VirtualHostChoice != nil {
		s = append(s, "VirtualHostChoice: "+fmt.Sprintf("%#v", this.VirtualHostChoice)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *HttpHealthCheck_DisableVirtualHost) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dns_lb_health_check.HttpHealthCheck_DisableVirtualHost{` +
		`DisableVirtualHost:` + fmt.Sprintf("%#v", this.DisableVirtualHost) + `}`}, ", ")
	return s
}
func (this *HttpHealthCheck_VirtualHost) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dns_lb_health_check.HttpHealthCheck_VirtualHost{` +
		`VirtualHost:` + fmt.Sprintf("%#v", this.VirtualHost) + `}`}, ", ")
	return s
}
func (this *HttpHealthCheck_InheritLoadBalancerFqdn) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dns_lb_health_check.HttpHealthCheck_InheritLoadBalancerFqdn{` +
		`InheritLoadBalancerFqdn:` + fmt.Sprintf("%#v", this.InheritLoadBalancerFqdn) + `}`}, ", ")
	return s
}
...
func (m *HttpHealthCheck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.VirtualHostChoice != nil {
		{
			size := m.VirtualHostChoice.Size()
			i -= size
			if _, err := m.VirtualHostChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *HttpHealthCheck_DisableVirtualHost) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HttpHealthCheck_DisableVirtualHost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableVirtualHost != nil {
		{
			size, err := m.DisableVirtualHost.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HttpHealthCheck_VirtualHost) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HttpHealthCheck_VirtualHost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.VirtualHost)
...
func (m *HttpHealthCheck_InheritLoadBalancerFqdn) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HttpHealthCheck_InheritLoadBalancerFqdn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.InheritLoadBalancerFqdn != nil {
		{
			size, err := m.InheritLoadBalancerFqdn.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HttpHealthCheck) Size() (n int) {
	...
	if m.VirtualHostChoice != nil {
		n += m.VirtualHostChoice.Size()
	}
	return n
}

func (m *HttpHealthCheck_DisableVirtualHost) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DisableVirtualHost != nil {
		l = m.DisableVirtualHost.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *HttpHealthCheck_VirtualHost) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HttpHealthCheck_InheritLoadBalancerFqdn) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.InheritLoadBalancerFqdn != nil {
		l = m.InheritLoadBalancerFqdn.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (this *HttpHealthCheck) String() string {
	...
	s := strings.Join([]string{`&HttpHealthCheck{`,
		...
		`VirtualHostChoice:` + fmt.Sprintf("%v", this.VirtualHostChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HttpHealthCheck_DisableVirtualHost) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HttpHealthCheck_DisableVirtualHost{`,
		`DisableVirtualHost:` + strings.Replace(fmt.Sprintf("%v", this.DisableVirtualHost), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HttpHealthCheck_VirtualHost) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HttpHealthCheck_VirtualHost{`,
		`VirtualHost:` + fmt.Sprintf("%v", this.VirtualHost) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HttpHealthCheck_InheritLoadBalancerFqdn) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HttpHealthCheck_InheritLoadBalancerFqdn{`,
		`InheritLoadBalancerFqdn:` + strings.Replace(fmt.Sprintf("%v", this.InheritLoadBalancerFqdn), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *HttpHealthCheck) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableVirtualHost", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VirtualHostChoice = &HttpHealthCheck_DisableVirtualHost{v}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
			...
			m.VirtualHostChoice = &HttpHealthCheck_VirtualHost{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InheritLoadBalancerFqdn", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VirtualHostChoice = &HttpHealthCheck_InheritLoadBalancerFqdn{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
