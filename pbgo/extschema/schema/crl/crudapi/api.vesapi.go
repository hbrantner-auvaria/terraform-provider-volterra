...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/crl"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.crl.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.crl.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.crl.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.crl.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.crl.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.crl.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.crl.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.crl.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.crl.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.crl.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.crl.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.crl.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.crl.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.crl.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.crl.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.crl.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.crl.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.crl.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/crl/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.crl/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.crl.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-crl-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.crl.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.crl.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-crl-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.crl.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.crl.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-crl-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.crl.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "crl",
            "x-ves-object-type": "ves.io.schema.crl.Object",
            "x-ves-proto-service": "ves.io.schema.crl.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.crl/Objects": {
            "get": {
                "operationId": "ves.io.schema.crl.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-crl-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.crl.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.crl.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-crl-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.crl.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "crl",
            "x-ves-object-type": "ves.io.schema.crl.Object",
        ...
        "/ves.io.schema.crl/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.crl.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-crl-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.crl.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "crl",
            "x-ves-object-type": "ves.io.schema.crl.Object",
        ...
        "/ves.io.schema.crl/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.crl.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.crl/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.crl.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.crl/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.crl.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.crl/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.crl.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crlGlobalSpecType": {
            "type": "object",
            "description": "Desired state of CRL",
            "title": "Specification for CRL",
            "x-displayname": "Specification",
            "x-ves-oneof-field-access_info_choice": "[\"http_access\"]",
            "x-ves-proto-message": "ves.io.schema.crl.GlobalSpecType",
            "properties": {
                "http_access": {
                    "description": "Exclusive with []\n HTTP URL to download the CRL file. GET operaion is done on\n http://\u003cserver_address\u003e:\u003cserver_port\u003e/\u003cpath\u003e",
                    "title": "Use the HTTP access for downloading the CRL file",
                    "$ref": "#/definitions/crlHTTPAccessInfo",
                    "x-displayname": "Use HTTP to download the CRL"
                },
                "refresh_interval": {
                    "type": "integer",
                    "description": " CRL refresh interval, in hours.\n\nExample: - \"24\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 6\n  ves.io.schema.rules.uint32.lte: 168\n",
                ...
                "server_address": {
                    "type": "string",
                    "description": " CRL server address or hostname\n\nExample: - \"mycrl.it.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.hostname_or_ip: true\n  ves.io.schema.rules.string.max_len: 255\n",
                    "title": "CRL server",
                    "maxLength": 255,
                    "x-displayname": "CRL Server address",
                    "x-ves-example": "mycrl.it.com",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.hostname_or_ip": "true",
                ...
                "server_port": {
                    "type": "integer",
                    "description": " Set CRL Server port number\n\nExample: - \"80\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 65535\n",
                    "title": "CRL Server Port Number",
                    "format": "int64",
                ...
                "timeout": {
                    "type": "integer",
                    "description": " CRL download wait time, in seconds\n\nExample: - \"10\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 180\n",
        ...
        "crlHTTPAccessInfo": {
            "type": "object",
            "title": "HTTPAccessInfo",
            "x-displayname": "HTTPAccessInfo",
            "x-ves-proto-message": "ves.io.schema.crl.HTTPAccessInfo",
            "properties": {
                "path": {
                    "type": "string",
                    "description": " CRL file location\n\nExample: - \"/repo/latest.crl\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.http_path: true\n  ves.io.schema.rules.string.max_len: 256\n",
                    "title": "path",
                    "maxLength": 256,
                    "x-displayname": "CRL File path",
                    "x-ves-example": "/repo/latest.crl",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.string.http_path": "true",
                        "ves.io.schema.rules.string.max_len": "256"
                    }
        ...
        "crlSpecType": {
            "type": "object",
            "description": "Shape of the crl specification",
            "title": "Specification for CRL object",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.crl.SpecType",
            "properties": {
                "gc_spec": {
                    "description": " desired state of crl",
                    "title": "gc_spec",
                    "$ref": "#/definitions/crlGlobalSpecType",
        ...
        "crlStatusObject": {
            ...
            "title": "CRL Status Object",
            "x-displayname": "CRL Status",
            "x-ves-proto-message": "ves.io.schema.crl.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "crlcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.crl.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.crl.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/crlSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.crl.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crlcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.crl.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crlcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.crl.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/crlStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.crl.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crlcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.crl.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.crl.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.crl.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/crlcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/crl/crudapi/api.proto"
}`
