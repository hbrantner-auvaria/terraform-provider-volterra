...
func (v *ValidateBFSecretChoice) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *BFSecretChoice_VesBrmDataDeliverySecret:
		if fv, exists := v.FldValidators["choice.ves_brm_data_delivery_secret"]; exists {
			val := m.GetChoice().(*BFSecretChoice_VesBrmDataDeliverySecret).VesBrmDataDeliverySecret
			vOpts := append(opts,
				db.WithValidateField("choice"),
				db.WithValidateField("ves_brm_data_delivery_secret"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
		}
	case *BFSecretChoice_VesSiteAdminPasswordSecret:
		if fv, exists := v.FldValidators["choice.ves_site_admin_password_secret"]; exists {
			val := m.GetChoice().(*BFSecretChoice_VesSiteAdminPasswordSecret).VesSiteAdminPasswordSecret
			vOpts := append(opts,
				db.WithValidateField("choice"),
				db.WithValidateField("ves_site_admin_password_secret"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
		}
	case *BFSecretChoice_VesApisecSecret:
		if fv, exists := v.FldValidators["choice.ves_apisec_secret"]; exists {
			val := m.GetChoice().(*BFSecretChoice_VesApisecSecret).VesApisecSecret
			vOpts := append(opts,
				db.WithValidateField("choice"),
				db.WithValidateField("ves_apisec_secret"),
			)
			if err := fv(ctx, val, vOpts...); err != nil {
				return err
			}
...
func (v *ValidateServiceSlugChoice) Validate(ctx context.Context, pm interface{}, opts ...db.ValidateOpt) error {
	...
	case *ServiceSlugChoice_Bigipconnector:
		if fv, exists := v.FldValidators["choice.bigipconnector"]; exists {
			val := m.GetChoice().(*ServiceSlugChoice_Bigipconnector).Bigipconnector
			vOpts := append(opts,
				db.WithValidateField("choice"),
	...
	case *ServiceSlugChoice_Maurice:
		if fv, exists := v.FldValidators["choice.maurice"]; exists {
			val := m.GetChoice().(*ServiceSlugChoice_Maurice).Maurice
			vOpts := append(opts,
				db.WithValidateField("choice"),
	...
	case *ServiceSlugChoice_Gia:
		if fv, exists := v.FldValidators["choice.gia"]; exists {
			val := m.GetChoice().(*ServiceSlugChoice_Gia).Gia
			vOpts := append(opts,
				db.WithValidateField("choice"),
	...
	case *ServiceSlugChoice_Discovery:
		if fv, exists := v.FldValidators["choice.discovery"]; exists {
			val := m.GetChoice().(*ServiceSlugChoice_Discovery).Discovery
			vOpts := append(opts,
				db.WithValidateField("choice"),
