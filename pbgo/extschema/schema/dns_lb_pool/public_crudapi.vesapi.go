...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_lb_pools", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_lb_pools/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_lb_pools/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_lb_pools", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_lb_pools/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.dns_lb_pool.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.dns_lb_pool")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_lb_pool.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_lb_pool.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_lb_pool.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_lb_pool.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_lb_pool.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.dns_lb_pool.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.dns_lb_pool.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_lb_pool.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_lb_pool.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.dns_lb_pool.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.dns_lb_pool.API.Create' operation on 'dns_lb_pool'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.dns_lb_pool.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.dns_lb_pool.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_lb_pool.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_lb_pool.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.dns_lb_pool.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.dns_lb_pool.API.Replace' operation on 'dns_lb_pool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.dns_lb_pool.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_lb_pool.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.dns_lb_pool.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_lb_pool.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_lb_pool.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_lb_pool.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.dns_lb_pool.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.dns_lb_pool.API.Delete' operation on 'dns_lb_pool'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/dns_lb_pools": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dns_lb_poolCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_lb_poolCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.dns_lb_pool.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/dns_lb_pools/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_lb_poolReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_lb_poolReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/dns_lb_pools": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_lb_poolListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/dns_lb_pools/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_lb_poolGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_lb_poolDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "dns_lb_poolAAAAPool": {
            ...
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.AAAAPool",
            "properties": {
                "max_answers": {
                    "type": "integer",
                    "description": " Limit on number of Resource Records to be included in the response to query\n\nExample: - \"1\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 32\n",
                ...
                "members": {
                    ...
                    "title": "Collection of AAAA record members",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/dns_lb_poolAddressMember"
                    },
        ...
        "dns_lb_poolAPool": {
            ...
            "properties": {
                "disable_health_check": {
                    "description": "Exclusive with [health_check]\n When health check is disabled, the pool member is presumed to be always healthy",
                    "title": "Disable health check",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Disable Health Check"
                },
                "health_check": {
                    "description": "Exclusive with [disable_health_check]\n Select the health check to be applied to all the pool members",
                    "title": "Health Check",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Enable Health Check"
                },
                "max_answers": {
                    "type": "integer",
                    "description": " Limit on number of Resource Records to be included in the response to query\n\nExample: - \"1\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 32\n",
                ...
                "members": {
                    "type": "array",
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Collection of A record members",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/dns_lb_poolAddressMember"
        ...
        "dns_lb_poolAddressMember": {
            ...
            "properties": {
                "disable": {
                    "type": "boolean",
                    "description": " A value of true will disable the pool-member\n\nExample: - \"true\"-",
                    "title": "Disable pool-member",
                    "format": "boolean",
                ...
                "priority": {
                    "type": "integer",
                    "description": " Used if the pool’s load balancing mode is set to Priority\n\nExample: - \"10\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 255\n",
                    "title": "Priority",
                    "format": "int64",
        ...
        "dns_lb_poolCNAMEMember": {
            ...
            "properties": {
                ...
                "final_translation": {
                    "type": "boolean",
                    "description": " If this flag is true, the CNAME record will not be translated further.",
        ...
        "dns_lb_poolCNAMEPool": {
            "type": "object",
            "title": "CNAME Pool",
            "x-displayname": "Pool for CNAME Record",
            "x-ves-oneof-field-health_check_choice": "[\"disable_health_check\",\"health_check\"]",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.CNAMEPool",
            "properties": {
                "disable_health_check": {
                    "description": "Exclusive with [health_check]\n When health check is disabled, the pool member is presumed to be always healthy",
                    "title": "Disable health check",
                ...
                "members": {
                    "type": "array",
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Collection of CNAME record members",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/dns_lb_poolCNAMEMember"
                    },
                    "x-displayname": "Pool Members",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "dns_lb_poolCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of dns_lb_pool",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Load Balancer Pool",
                    "title": "spec",
                    "$ref": "#/definitions/dns_lb_poolCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "dns_lb_poolCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Load Balancer Pool",
                    "title": "spec",
                    "$ref": "#/definitions/dns_lb_poolGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "dns_lb_poolCreateSpecType": {
            "type": "object",
            "description": "Create DNS Load Balancer Pool in a given namespace. If one already exist it will give a error.",
            "title": "Create DNS Load Balancer Pool",
            "x-displayname": "Create DNS Load Balancer Pool",
            "x-ves-oneof-field-pool_type_choice": "[\"a_pool\",\"aaaa_pool\",\"cname_pool\",\"mx_pool\",\"srv_pool\"]",
            "x-ves-oneof-field-ttl_choice": "[\"ttl\",\"use_rrset_ttl\"]",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.CreateSpecType",
            "properties": {
                "a_pool": {
                    "description": "Exclusive with [aaaa_pool cname_pool mx_pool srv_pool]\n",
                    "$ref": "#/definitions/dns_lb_poolAPool",
                    "x-displayname": "A"
                },
                "aaaa_pool": {
                    "description": "Exclusive with [a_pool cname_pool mx_pool srv_pool]\n",
                    "$ref": "#/definitions/dns_lb_poolAAAAPool",
                    "x-displayname": "AAAA"
                },
                "cname_pool": {
                    "description": "Exclusive with [a_pool aaaa_pool mx_pool srv_pool]\n",
                    "$ref": "#/definitions/dns_lb_poolCNAMEPool",
                    "x-displayname": "CNAME"
                },
                "load_balancing_mode": {
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/dns_lb_poolLoadBalancingMode",
                ...
                "mx_pool": {
                    "description": "Exclusive with [a_pool aaaa_pool cname_pool srv_pool]\n",
                    "$ref": "#/definitions/dns_lb_poolMXPool",
                    "x-displayname": "MX"
                },
                "srv_pool": {
                    "description": "Exclusive with [a_pool aaaa_pool cname_pool mx_pool]\n",
                    "$ref": "#/definitions/dns_lb_poolSRVPool",
                    "x-displayname": "SRV"
                },
                "ttl": {
                    "type": "integer",
                    "description": "Exclusive with [use_rrset_ttl]\n Custom TTL in seconds (default 30) for responses from this pool\n\nExample: - \"3600\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 2147483647\n",
                    "format": "int64",
                    "x-displayname": "TTL",
                    "x-ves-example": "3600",
                    "x-ves-validation-rules": {
                ...
                "use_rrset_ttl": {
                    "description": "Exclusive with [ttl]\n Use TTL specified in the RRSet of the DNS Load Balancer Record which uses the pool",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Use RRSet TTL"
                }
            }
        },
        "dns_lb_poolDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a dns_lb_pool",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "dns_lb_poolGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read dns_lb_pool",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/dns_lb_poolStatusObject"
                    },
        ...
        "dns_lb_poolGetResponseFormatCode": {
            "type": "string",
        ...
        "dns_lb_poolGetSpecType": {
            "type": "object",
            "description": "Get DNS Load Balancer Pool details.",
            "title": "Get DNS Load Balancer Pool",
        ...
        "dns_lb_poolListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of dns_lb_pool",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/dns_lb_poolListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "dns_lb_poolListResponseItem": {
            "type": "object",
            "description": "By default a summary of dns_lb_pool is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of dns_lb_pool",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this dns_lb_pool",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this dns_lb_pool",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates dns_lb_pool is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this dns_lb_pool",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this dns_lb_pool\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this dns_lb_pool\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "dns_lb_poolLoadBalancingMode": {
            ...
            "x-ves-proto-enum": "ves.io.schema.dns_lb_pool.LoadBalancingMode"
        },
        "dns_lb_poolMXMember": {
            "type": "object",
            ...
            "properties": {
                ...
                "ratio": {
                    "type": "integer",
                    "description": " Load Balancing Ratio\n\nExample: - \"10\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 100\n",
                    "title": "Ratio",
                    "format": "int64",
                    "x-displayname": "Load Balancing Ratio",
                    "x-ves-example": "10",
        ...
        "dns_lb_poolMXPool": {
            ...
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.MXPool",
            "properties": {
                "max_answers": {
                    "type": "integer",
                    "description": " Limit on number of Resource Records to be included in the response to query\n\nExample: - \"1\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 32\n",
                ...
                "members": {
                    "type": "array",
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Collection of MX record members",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/dns_lb_poolMXMember"
                    },
                    "x-displayname": "Pool Members",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "dns_lb_poolReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a dns_lb_pool",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Load Balancer Pool",
                    "title": "spec",
                    "$ref": "#/definitions/dns_lb_poolReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "dns_lb_poolReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.ReplaceResponse"
        },
        "dns_lb_poolReplaceSpecType": {
            "type": "object",
            "description": "Replace DNS Load Balancer Pool in a given namespace.",
            "title": "Replace DNS Load Balancer Pool",
        ...
        "dns_lb_poolSRVMember": {
            "type": "object",
            "description": "SRV Record which can be a member of a SRV type pool",
            "title": "SRVMember",
            "x-displayname": "SRV member",
            "x-ves-displayorder": "1,5,2,3,4,7,6",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.SRVMember",
            "properties": {
                "final_translation": {
                    "type": "boolean",
                    "description": " If this flag is true, the SRV record will not be translated further.",
                    "title": "Final Translation",
                    "format": "boolean",
                    "x-displayname": "Final Translation"
                },
        ...
        "dns_lb_poolSRVPool": {
            ...
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.SRVPool",
            "properties": {
                "max_answers": {
                    "type": "integer",
                    "description": " Limit on number of Resource Records to be included in the response to query\n\nExample: - \"1\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 32\n",
                ...
                "members": {
                    "type": "array",
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Collection of SRV record members",
                    "minItems": 1,
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/dns_lb_poolSRVMember"
                    },
                    "x-displayname": "Pool Members",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "dns_lb_poolStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "DNS Load Balancer Pool Status Object",
            "x-displayname": "DNS Load Balancer Pool Status Object",
            "x-ves-proto-message": "ves.io.schema.dns_lb_pool.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-displayname": "DNS Load Balancer Pool",
    "x-ves-proto-file": "ves.io/schema/dns_lb_pool/public_crudapi.proto"
}`
