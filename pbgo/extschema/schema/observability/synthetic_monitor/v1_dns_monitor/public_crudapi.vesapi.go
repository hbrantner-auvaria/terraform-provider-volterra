...
const (
	...
	CreateRequestFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/v1_dns_monitors", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/v1_dns_monitors/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/v1_dns_monitors/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/v1_dns_monitors", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/v1_dns_monitors/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.observability.synthetic_monitor.v1_dns_monitor")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Create' operation on 'v1_dns_monitor'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Replace' operation on 'v1_dns_monitor'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API.Delete' operation on 'v1_dns_monitor'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/v1_dns_monitors": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/v1_dns_monitorCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1_dns_monitorCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/v1_dns_monitors/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/v1_dns_monitorReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1_dns_monitorReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/v1_dns_monitors": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/v1_dns_monitorListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/v1_dns_monitors/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/v1_dns_monitorGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1_dns_monitorDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "synthetic_monitorAWSRegionsExternal": {
            "type": "object",
            "description": "x-example: \"us-east-1\"\nA specific source location within AWS",
            "title": "AWS Regions",
            "x-displayname": "Regions",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.AWSRegionsExternal",
            "properties": {
                "regions": {
                    "type": "array",
        ...
        "synthetic_monitorRegionalEdgeExternal": {
            "type": "object",
            "description": "A specific source location within F5 Distributed Cloud",
            "title": "F5 Distributed Cloud Regions",
            "x-displayname": "Regions",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.RegionalEdgeExternal",
            "properties": {
                "regions": {
                    "type": "array",
                    "description": " A specific source location within F5 Distributed Cloud\n\nExample: - \"ves-io-us\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.not_empty: true\n  ves.io.schema.rules.repeated.unique: true\n",
        ...
        "synthetic_monitorSourceExternal": {
            "type": "object",
            ...
            "properties": {
                "aws": {
                    ...
                    "title": "AWS Region",
                    "$ref": "#/definitions/synthetic_monitorAWSRegionsExternal",
                    "x-displayname": "AWS"
                },
                "f5xc": {
                    "description": "Exclusive with [aws]\n F5 Distributed Cloud",
                    "title": "F5 Distributed Cloud",
                    "$ref": "#/definitions/synthetic_monitorRegionalEdgeExternal",
        ...
        "v1_dns_monitorCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of v1_dns_monitor",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Monitor",
                    "title": "spec",
                    "$ref": "#/definitions/v1_dns_monitorCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "v1_dns_monitorCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Monitor",
                    "title": "spec",
                    "$ref": "#/definitions/v1_dns_monitorGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "v1_dns_monitorCreateSpecType": {
            ...
            "x-ves-oneof-field-on_failure_to_choice": "[\"on_failure_to_all\",\"on_failure_to_any\"]",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.CreateSpecType",
            "properties": {
                "domain": {
                    "type": "string",
                ...
                "external_sources": {
                    ...
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/synthetic_monitorSourceExternal"
                    },
                ...
                "name_servers": {
                    ...
                    "description": "\n\nExample: - \"\"-",
                    "items": {
                        "$ref": "#/definitions/v1_dns_monitorNameServer"
                    },
                ...
                "on_failure_to_all": {
                    "description": "Exclusive with [on_failure_to_any]\n",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "ALL"
                },
                "on_failure_to_any": {
                    "description": "Exclusive with [on_failure_to_all]\n",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "ANY"
                },
                "protocol": {
        ...
        "v1_dns_monitorDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a v1_dns_monitor",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "v1_dns_monitorGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read v1_dns_monitor",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/v1_dns_monitorStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "v1_dns_monitorGetResponseFormatCode": {
            "type": "string",
        ...
        "v1_dns_monitorGetSpecType": {
            "type": "object",
            "description": "Get a DNS Monitor",
            "title": "Get DNS Monitor",
            "x-displayname": "Get DNS Monitor",
            "x-ves-oneof-field-interval_choice": "[\"interval_12_hours\",\"interval_15_mins\",\"interval_1_day\",\"interval_1_hour\",\"interval_1_min\",\"interval_30_mins\",\"interval_30_secs\",\"interval_5_mins\",\"interval_6_hours\"]",
            "x-ves-oneof-field-on_failure_to_choice": "[\"on_failure_to_all\",\"on_failure_to_any\"]",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.GetSpecType",
            "properties": {
                "domain": {
                    "type": "string",
                    "description": "\nExample: - \"www.example.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.hostname: true\n  ves.io.schema.rules.string.max_len: 2048\n  ves.io.schema.rules.string.not_empty: true\n",
        ...
        "v1_dns_monitorListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of v1_dns_monitor",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/v1_dns_monitorListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "v1_dns_monitorListResponseItem": {
            "type": "object",
            "description": "By default a summary of v1_dns_monitor is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of v1_dns_monitor",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this v1_dns_monitor",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this v1_dns_monitor",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates v1_dns_monitor is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this v1_dns_monitor",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this v1_dns_monitor\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this v1_dns_monitor\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "v1_dns_monitorNameServer": {
            "type": "object",
            "description": "Custom nameserver to execute the monitor against",
            "title": "Custom Name Server",
            "x-displayname": "Custom Name Server",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.NameServer",
            "properties": {
                "name_server": {
                    "type": "string",
                    "description": " IP address of the nameserver to execute the monitor against\n\nExample: - \"1.1.1.1\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.ipv4: true\n",
                    "title": "Name Server",
                ...
                "port": {
                    "type": "integer",
                    "description": " Port of the nameserver to execute the monitor against\n\nExample: - \"53\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 65535\n",
                    "title": "Port",
                    "format": "int64",
                    "x-displayname": "Port",
                    "x-ves-example": "53",
        ...
        "v1_dns_monitorReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a v1_dns_monitor",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Monitor",
                    "title": "spec",
                    "$ref": "#/definitions/v1_dns_monitorReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "v1_dns_monitorReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.ReplaceResponse"
        },
        "v1_dns_monitorReplaceSpecType": {
            "type": "object",
            "description": "Replace the contents of a DNS Monitor",
            "title": "Replace DNS Monitor",
            "x-displayname": "Replace DNS Monitor",
            "x-ves-oneof-field-interval_choice": "[\"interval_12_hours\",\"interval_15_mins\",\"interval_1_day\",\"interval_1_hour\",\"interval_1_min\",\"interval_30_mins\",\"interval_30_secs\",\"interval_5_mins\",\"interval_6_hours\"]",
            "x-ves-oneof-field-on_failure_to_choice": "[\"on_failure_to_all\",\"on_failure_to_any\"]",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.ReplaceSpecType",
            "properties": {
                "domain": {
                    "type": "string",
                    "description": "\nExample: - \"www.example.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.hostname: true\n  ves.io.schema.rules.string.max_len: 2048\n  ves.io.schema.rules.string.not_empty: true\n",
        ...
        "v1_dns_monitorStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.observability.synthetic_monitor.v1_dns_monitor.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-displayname": "DNS Monitor",
    "x-ves-proto-file": "ves.io/schema/observability/synthetic_monitor/v1_dns_monitor/public_crudapi.proto"
}`
