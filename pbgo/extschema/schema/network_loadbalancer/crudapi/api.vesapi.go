...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/network_loadbalancer"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.network_loadbalancer.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.network_loadbalancer.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.network_loadbalancer.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_loadbalancer.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_loadbalancer.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_loadbalancer.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_loadbalancer.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_loadbalancer.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.network_loadbalancer.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.network_loadbalancer.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_loadbalancer.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_loadbalancer.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_loadbalancer.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_loadbalancer.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_loadbalancer.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_loadbalancer.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_loadbalancer.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_loadbalancer.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/network_loadbalancer/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.network_loadbalancer/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_loadbalancer-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_loadbalancer.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_loadbalancer-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_loadbalancer.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_loadbalancer-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_loadbalancer.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "network_loadbalancer",
            "x-ves-object-type": "ves.io.schema.network_loadbalancer.Object",
            "x-ves-proto-service": "ves.io.schema.network_loadbalancer.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.network_loadbalancer/Objects": {
            "get": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_loadbalancer-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_loadbalancer.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_loadbalancer-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_loadbalancer.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "network_loadbalancer",
            "x-ves-object-type": "ves.io.schema.network_loadbalancer.Object",
        ...
        "/ves.io.schema.network_loadbalancer/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_loadbalancer-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_loadbalancer.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "network_loadbalancer",
            "x-ves-object-type": "ves.io.schema.network_loadbalancer.Object",
        ...
        "/ves.io.schema.network_loadbalancer/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_loadbalancer/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_loadbalancer/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_loadbalancer/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.network_loadbalancer.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/network_loadbalancerSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_loadbalancercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_loadbalancercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/network_loadbalancerStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_loadbalancercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_loadbalancercrudapiErrorCode"
                },
        ...
        "network_loadbalancerOperGlobalSpecType": {
            "type": "object",
        ...
        "network_loadbalancerOriginServerEndpointK8SServiceType": {
            "type": "object",
            "description": "Specify origin server for a K8S Service",
            "title": "OriginServerEndpointK8SServiceType",
            "x-displayname": "K8S Service origin server",
            "x-ves-displayorder": "1",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.OriginServerEndpointK8SServiceType",
            "properties": {
                "k8s_service": {
        ...
        "network_loadbalancerOriginServerEndpointNFVServiceType": {
            "type": "object",
            "description": "Specify origin server with a reference to nfv service",
            "title": "OriginServerEndpointNFVService",
            "x-displayname": "NFV Service origin server",
            "x-ves-displayorder": "1",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.OriginServerEndpointNFVServiceType",
            "properties": {
                "endpoint_nfv_service": {
                    "description": " Reference to an endpoint nfv service object\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Endpoint NFV Service",
        ...
        "network_loadbalancerOriginServerWithWeight": {
            "type": "object",
            "description": "Origin Server with Weights\n\nWeight and Type of origin server",
            "title": "Origin Server with Weights",
            "x-displayname": "Origin Server with Weights",
            "x-ves-oneof-field-origin_server_choice": "[\"endpoint_nfv_service\",\"k8s_service\"]",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.OriginServerWithWeight",
            "properties": {
                "endpoint_nfv_service": {
                    "description": "Exclusive with [k8s_service]\n Specify origin server as endpoint NFV service",
                    "title": "OriginServerEndpointNFVService",
                    "$ref": "#/definitions/network_loadbalancerOriginServerEndpointNFVServiceType",
                    "x-displayname": "Endpoint NFV Service"
                },
                "k8s_service": {
                    "description": "Exclusive with [endpoint_nfv_service]\n Specify origin server as endpoint K8S service",
                    "title": "OriginServerEndpointK8SService",
                    "$ref": "#/definitions/network_loadbalancerOriginServerEndpointK8SServiceType",
                    "x-displayname": "Endpoint K8S Service"
                },
                "weight": {
                    "type": "integer",
                    "description": " Weight of this origin server, valid only with multiple origin servers. Value of 0 will disable the pool",
                    "title": "Weight",
                    "format": "int64",
        ...
        "network_loadbalancerSpecType": {
            "type": "object",
            "description": "Shape of the Network Loadbalancer specification",
            "title": "Specification for Network Loadbalancer",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemanetwork_loadbalancerGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "network_loadbalancerStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for Network Loadbalancer",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "network_loadbalancercrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.network_loadbalancer.crudapi.ErrorCode"
        },
        ...
        "schemanetwork_loadbalancerGlobalSpecType": {
            "type": "object",
            "description": "Desired state for Network Loadbalancer",
            "title": "Network Loadbalancer specification",
            "x-displayname": "Specification",
            "x-ves-oneof-field-nlb_choice": "[\"nlb_type_dnat\",\"nlb_type_dsr\",\"nlb_type_snat_dnat\"]",
            "x-ves-oneof-field-tcp_port_choice": "[\"custom_tcp_ports\",\"no_tcp_ports\"]",
            "x-ves-oneof-field-udp_port_choice": "[\"custom_udp_ports\",\"no_udp_ports\"]",
            "x-ves-oneof-field-vip_choice": "[\"advertise_custom\",\"advertise_on_public\",\"advertise_on_public_default_vip\",\"do_not_advertise\"]",
            "x-ves-proto-message": "ves.io.schema.network_loadbalancer.GlobalSpecType",
            "properties": {
                "advertise_custom": {
                ...
                "custom_tcp_ports": {
                    "description": "Exclusive with [no_tcp_ports]\n select custom tcp ports",
                ...
                "nlb_type_dnat": {
                    "description": "Exclusive with [nlb_type_dsr nlb_type_snat_dnat]\n Configure Network Load balancer for DNAT, Original ip packet's destination will be modified",
                    "title": "Network Loadbalancer with DNAT",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Load Balancer with DNAT"
                },
                "nlb_type_dsr": {
                    "description": "Exclusive with [nlb_type_dnat nlb_type_snat_dnat]\n Configure Network Load balancer for Direct Server Return, Original ip packet will not be modified",
                    "title": "Network Loadbalancer with DSR",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Load Balancer with DSR"
                },
                "nlb_type_snat_dnat": {
                    "description": "Exclusive with [nlb_type_dnat nlb_type_dsr]\n Configure Network Load balancer for SNAT/DNAT, Original ip packet's source and destination addresses will be modified",
                    "title": "Network Loadbalancer with SNAT/DNAT",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Load Balancer with SNAT/DNAT"
                },
                "no_tcp_ports": {
                    "description": "Exclusive with [custom_tcp_ports]\n do not select tcp ports",
                    "title": "No TCP Ports",
                    "$ref": "#/definitions/schemaEmpty",
                ...
                "origin_pools": {
                    "type": "array",
                    "description": " Origin Servers for this network load balancer\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 16\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Origin Servers",
                    "minItems": 1,
                    "maxItems": 16,
                    "items": {
                        "$ref": "#/definitions/network_loadbalancerOriginServerWithWeight"
                    },
    ...
    "x-ves-proto-file": "ves.io/schema/network_loadbalancer/crudapi/api.proto"
}`
