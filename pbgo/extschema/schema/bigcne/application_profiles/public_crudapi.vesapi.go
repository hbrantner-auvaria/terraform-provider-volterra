...
const (
	...
	CreateRequestFQN = "ves.io.schema.bigcne.application_profiles.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.bigcne.application_profiles.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.bigcne.application_profiles.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.bigcne.application_profiles.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.bigcne.application_profiles.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.bigcne.application_profiles.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.bigcne.application_profiles.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.bigcne.application_profiles.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.bigcne.application_profiles.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.bigcne.application_profiles.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/application_profiless", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/application_profiless/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/application_profiless/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/application_profiless", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/application_profiless/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.bigcne.application_profiles.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.bigcne.application_profiles")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.bigcne.application_profiles.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.bigcne.application_profiles.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigcne.application_profiles.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.bigcne.application_profiles.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.bigcne.application_profiles.API.Create' operation on 'application_profiles'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.bigcne.application_profiles.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.bigcne.application_profiles.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigcne.application_profiles.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.bigcne.application_profiles.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.bigcne.application_profiles.API.Replace' operation on 'application_profiles'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.bigcne.application_profiles.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.bigcne.application_profiles.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigcne.application_profiles.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.bigcne.application_profiles.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.bigcne.application_profiles.API.Delete' operation on 'application_profiles'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.bigcne.application_profiles.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Global Spec defines the various settings that can be used in CRUD, to create and manage\nApplication Profiles for BIG-IP Proxy.",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/application_profiless": {
            "post": {
                "summary": "Create Application Profiles",
                "description": "Create Application Profiles in a given namespace. If one already exists it will give an error.",
                "operationId": "ves.io.schema.bigcne.application_profiles.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/application_profilesCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application_profilesCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-displayname": "Configure Application Profiles",
            "x-ves-proto-service": "ves.io.schema.bigcne.application_profiles.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/application_profiless/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/application_profilesReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application_profilesReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/application_profiless": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/application_profilesListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/application_profiless/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/application_profilesGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application_profilesDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "application_profilesAdvancedTCPProfile": {
            "type": "object",
            "description": "BIG-IP Advanced TCP Profile",
            "title": "BIG-IP Advanced TCP Profile",
            ...
            "properties": {
                "disable_tcp_advanced_profile": {
                    "description": "Exclusive with [enable_tcp_advanced_profile]\n",
                    "title": "Disable DDoS Protection",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Disable"
                },
                "enable_tcp_advanced_profile": {
                    "description": "Exclusive with [disable_tcp_advanced_profile]\n",
        ...
        "application_profilesCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of application_profiles",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of Application Profiles",
                    "title": "spec",
                    "$ref": "#/definitions/application_profilesCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "application_profilesCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of Application Profiles",
                    "title": "spec",
                    "$ref": "#/definitions/application_profilesGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "application_profilesCreateSpecType": {
            "type": "object",
            "description": "Create Application Profiles in a given namespace. If one already exists it will give an error.",
            "title": "Create Application Profiles",
            ...
            "properties": {
                "advanced_tcp_profile": {
                    "description": " Options for enabling and disabling the BIG-IP TCP profile for the Proxy\n On enabling this feature, a default profile is applied to the Proxy",
                    "$ref": "#/definitions/application_profilesAdvancedTCPProfile",
                    "x-displayname": "BigIP TCP Advanced Profile"
                },
                "ddos_profile": {
                    "description": " Options for enabling and disabling the DDoS profile for the BIG-IP Proxy\n On enabling this feature, a default DDoS profile is applied to the Proxy\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "virtual_server": {
                    ...
                    "$ref": "#/definitions/application_profilesVirtualServerType",
        ...
        "application_profilesDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a application_profiles",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "application_profilesGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read application_profiles",
        ...
        "application_profilesGetResponseFormatCode": {
            "type": "string",
        ...
        "application_profilesGetSpecType": {
            "type": "object",
            "description": "Get Application Profiles details.",
        ...
        "application_profilesListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of application_profiles",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/application_profilesListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "application_profilesListResponseItem": {
            "type": "object",
            "description": "By default a summary of application_profiles is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of application_profiles",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this application_profiles",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this application_profiles",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates application_profiles is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this application_profiles",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this application_profiles\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this application_profiles\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "application_profilesReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a application_profiles",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of Application Profiles",
                    "title": "spec",
                    "$ref": "#/definitions/application_profilesReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "application_profilesReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.ReplaceResponse"
        },
        "application_profilesReplaceSpecType": {
            "type": "object",
            "description": "Replace Application Profiles in a given namespace.",
            "title": "Replace Application Profiles",
        ...
        "application_profilesTCPProfileType": {
            "type": "object",
            "title": "TCP",
        ...
        "application_profilesVirtualServerType": {
            "type": "object",
            "description": "Specifies configuration related to virtual server",
            ...
            "properties": {
                ...
                "clone_pool_client": {
                    "type": "array",
                    "description": " Replicates client-side traffic (that is, prior to address translation) to a member of the specified pool.\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Clone Pool (Client)",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "default_persistence_profile": {
                    "type": "array",
                    "description": "\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Default Persistence Profile",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                ...
                "fallback_persistence_profile": {
                    "type": "array",
                    "description": "\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Fallback Persistence Profile",
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
    ...
    "x-displayname": "Configure Application Profiles",
    "x-ves-proto-file": "ves.io/schema/bigcne/application_profiles/public_crudapi.proto"
}`
