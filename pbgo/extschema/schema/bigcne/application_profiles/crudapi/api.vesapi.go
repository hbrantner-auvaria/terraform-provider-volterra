...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/bigcne/application_profiles"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.bigcne.application_profiles.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.bigcne.application_profiles.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.bigcne.application_profiles.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.bigcne.application_profiles.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.bigcne.application_profiles.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.bigcne.application_profiles.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigcne.application_profiles.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigcne.application_profiles.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.bigcne.application_profiles.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.bigcne.application_profiles.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/bigcne/application_profiles/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.bigcne.application_profiles/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigcne-application_profiles-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigcne.application_profiles.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigcne-application_profiles-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigcne.application_profiles.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigcne-application_profiles-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigcne.application_profiles.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "application_profiles",
            "x-ves-object-type": "ves.io.schema.bigcne.application_profiles.Object",
            "x-ves-proto-service": "ves.io.schema.bigcne.application_profiles.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.bigcne.application_profiles/Objects": {
            "get": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigcne-application_profiles-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigcne.application_profiles.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigcne-application_profiles-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigcne.application_profiles.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "application_profiles",
            "x-ves-object-type": "ves.io.schema.bigcne.application_profiles.Object",
        ...
        "/ves.io.schema.bigcne.application_profiles/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-bigcne-application_profiles-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.bigcne.application_profiles.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "application_profiles",
            "x-ves-object-type": "ves.io.schema.bigcne.application_profiles.Object",
        ...
        "/ves.io.schema.bigcne.application_profiles/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bigcne.application_profiles/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bigcne.application_profiles/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.bigcne.application_profiles/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.bigcne.application_profiles.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "application_profilesGlobalSpecType": {
            "type": "object",
            "description": "Desired state of Application Profiles Specification",
            "title": "GlobalSpecType",
            "x-displayname": "Application Profiles Global Specification",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.GlobalSpecType",
            "properties": {
                "advanced_tcp_profile": {
                    ...
                    "title": "Advanced TCP Profile Choice",
        ...
        "application_profilesSpecType": {
            "type": "object",
            "description": "Application Profiles Specification",
            "title": "BIG-IP Application Profiles Specification",
            "x-displayname": "BIG-IP Application Profiles Specification",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/application_profilesGlobalSpecType",
        ...
        "application_profilescrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.bigcne.application_profiles.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/application_profilesSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/application_profilescrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/application_profilescrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/application_profilescrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.bigcne.application_profiles.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/application_profilescrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/bigcne/application_profiles/crudapi/api.proto"
}`
