...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/cdn_cache_rule"
)
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	...
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.cdn_cache_rule.crudapi")
	}
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cdn_cache_rule.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cdn_cache_rule.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cdn_cache_rule.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cdn_cache_rule.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cdn_cache_rule.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cdn_cache_rule.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cdn_cache_rule.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cdn_cache_rule.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cdn_cache_rule.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/cdn_cache_rule/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.cdn_cache_rule/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cdn_cache_rule-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.cdn_cache_rule.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cdn_cache_rule-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.cdn_cache_rule.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cdn_cache_rule-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.cdn_cache_rule.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cdn_cache_rule",
            "x-ves-object-type": "ves.io.schema.cdn_cache_rule.Object",
            "x-ves-proto-service": "ves.io.schema.cdn_cache_rule.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.cdn_cache_rule/Objects": {
            "get": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cdn_cache_rule-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.cdn_cache_rule.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cdn_cache_rule-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.cdn_cache_rule.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cdn_cache_rule",
            "x-ves-object-type": "ves.io.schema.cdn_cache_rule.Object",
        ...
        "/ves.io.schema.cdn_cache_rule/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cdn_cache_rule-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.cdn_cache_rule.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cdn_cache_rule",
            "x-ves-object-type": "ves.io.schema.cdn_cache_rule.Object",
        ...
        "/ves.io.schema.cdn_cache_rule/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cdn_cache_rule/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cdn_cache_rule/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cdn_cache_rule/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.cdn_cache_rule.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "cdn_cache_ruleCDNCacheRule": {
            ...
            "properties": {
                ...
                "rule_expression_list": {
                    ...
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/cdn_cache_ruleCDNCacheRuleExpressionList"
                    },
        ...
        "cdn_cache_ruleCDNCacheRuleExpression": {
            ...
            "properties": {
                "cache_headers": {
                    ...
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/cdn_cache_ruleCacheHeaderMatcherType"
                    },
                ...
                "cookie_matcher": {
                    ...
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/cdn_cache_ruleCacheCookieMatcherType"
                    },
                ...
                "path_match": {
                    ...
                    "title": "path_match",
                    "$ref": "#/definitions/cdn_cache_ruleCDNPathMatcherType",
                ...
                "query_parameters": {
                    ...
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/cdn_cache_ruleCacheQueryParameterMatcherType"
                    },
        ...
        "cdn_cache_ruleCDNCacheRuleExpressionList": {
            ...
            "properties": {
                "cache_rule_expression": {
                    ...
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/cdn_cache_ruleCDNCacheRuleExpression"
                    },
                    "x-displayname": "Terms",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "cdn_cache_ruleCacheEligibleOptions": {
            ...
            "properties": {
                "scheme_proxy_host_request_uri": {
                    ...
                    "$ref": "#/definitions/cdn_cache_ruleCacheTTLEnableProps",
        ...
        "cdn_cache_ruleSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemacdn_cache_ruleGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "cdn_cache_rulecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.cdn_cache_rule.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/cdn_cache_ruleSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cdn_cache_rulecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cdn_cache_rulecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cdn_cache_rulecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cdn_cache_rulecrudapiErrorCode"
                },
        ...
        "schemacdn_cache_ruleGlobalSpecType": {
            "type": "object",
            "description": "Shape of the CDN cache rule specification",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-proto-message": "ves.io.schema.cdn_cache_rule.GlobalSpecType",
            "properties": {
                "cache_rules": {
                    ...
                    "$ref": "#/definitions/cdn_cache_ruleCDNCacheRule",
    ...
    "x-ves-proto-file": "ves.io/schema/cdn_cache_rule/crudapi/api.proto"
}`
