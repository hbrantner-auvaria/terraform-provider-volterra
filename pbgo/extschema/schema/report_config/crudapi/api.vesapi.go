...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/report_config"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.report_config.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.report_config.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.report_config.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.report_config.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.report_config.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.report_config.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.report_config.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.report_config.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.report_config.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.report_config.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.report_config.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.report_config.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.report_config.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.report_config.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.report_config.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.report_config.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.report_config.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.report_config.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/report_config/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.report_config/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.report_config.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-report_config-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.report_config.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.report_config.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-report_config-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.report_config.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.report_config.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-report_config-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.report_config.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "report_config",
            "x-ves-object-type": "ves.io.schema.report_config.Object",
            "x-ves-proto-service": "ves.io.schema.report_config.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.report_config/Objects": {
            "get": {
                "operationId": "ves.io.schema.report_config.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-report_config-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.report_config.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.report_config.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-report_config-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.report_config.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "report_config",
            "x-ves-object-type": "ves.io.schema.report_config.Object",
        ...
        "/ves.io.schema.report_config/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.report_config.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-report_config-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.report_config.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "report_config",
            "x-ves-object-type": "ves.io.schema.report_config.Object",
        ...
        "/ves.io.schema.report_config/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.report_config.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.report_config/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.report_config.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.report_config/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.report_config.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.report_config/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.report_config.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.report_config.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/report_configSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.report_config.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/report_configcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.report_config.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/report_configcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.report_config.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/report_configStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.report_config.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/report_configcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.report_config.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.report_config.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.report_config.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/report_configcrudapiErrorCode"
                },
        ...
        "report_configReportFreqMonthly": {
            ...
            "properties": {
                "date": {
                    "description": " Choose the date of the month, when the report should be generated\n\nExample: - \"3\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.enum.not_in: 0\n  ves.io.schema.rules.message.required: true\n",
                    "title": "day report is generated",
                    "$ref": "#/definitions/report_configReportGenerationDate",
        ...
        "report_configReportFreqWeekly": {
            ...
            "properties": {
                "day": {
                    "description": " Choose the day of the week, when the report should be generated\n\nExample: - \"Monday\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.enum.not_in: 0\n  ves.io.schema.rules.message.required: true\n",
                    "title": "report day",
                    "$ref": "#/definitions/report_configReportGenerationWeekday",
                    "x-displayname": "Report Generation Weekday",
                    "x-ves-example": "Monday",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.enum.not_in": "0",
                        "ves.io.schema.rules.message.required": "true"
        ...
        "report_configReportTypeBotDefense": {
            "type": "object",
            "description": "Report Type Bot Defense",
            "title": "Report Type Bot Defense",
            "x-displayname": "Report Type BotDefense",
            "x-ves-oneof-field-report_frequency": "[\"system_default\"]",
            "x-ves-oneof-field-report_namespaces": "[\"all_namespaces\"]",
            "x-ves-proto-message": "ves.io.schema.report_config.ReportTypeBotDefense",
            "properties": {
                "all_namespaces": {
                    "description": "Exclusive with []\n Report will include data from all namespaces.",
                    "title": "All namespaces in a tenant",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "All namespaces"
                },
                "system_default": {
                    "description": "Exclusive with []\n Monthly report generated by the first day of each month.",
                    "title": "First of every month",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "1st of every month"
                }
            }
        },
        "report_configReportTypeWaap": {
            ...
            "properties": {
                "current_namespace": {
                    "description": "Exclusive with [namespaces]\n Report will include data from current namespace",
                    "title": "Current namespace",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Current namespace"
                },
                "daily": {
                    "description": "Exclusive with [monthly weekly]\n\n\nExample: - \"08:30:00 PM\"-",
                    "title": "report frequency daily",
                    "$ref": "#/definitions/report_configReportFreqDaily",
                    "x-displayname": "Every Day",
                    "x-ves-example": "08:30:00 PM"
                },
                "monthly": {
                    "description": "Exclusive with [daily weekly]\n\n\nExample: - \"January\"-",
                    "title": "report frequency monthly",
                    "$ref": "#/definitions/report_configReportFreqMonthly",
                    "x-displayname": "Every Month",
                    "x-ves-example": "January"
                },
                "namespaces": {
                    "description": "Exclusive with [current_namespace]\n Report will include only data from selected namespaces.",
                    "title": "List of namespaces",
                    "$ref": "#/definitions/report_configNamespaces",
                    "x-displayname": "Specific namespaces"
                },
                "weekly": {
                    "description": "Exclusive with [daily monthly]\n\n\nExample: - \"Monday\"-",
                    "title": "report frequency weekly",
                    "$ref": "#/definitions/report_configReportFreqWeekly",
                    "x-displayname": "Every Week",
                    "x-ves-example": "Monday"
                }
            }
        },
        "report_configSpecType": {
            "type": "object",
            "description": "Shape of the report configuration specification",
            "title": "Route Config Specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.report_config.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemareport_configGlobalSpecType",
        ...
        "report_configStatusObject": {
            ...
            "properties": {
                ...
                "report_delivery_status": {
                    "description": " report delivery status\n\nExample: - \"Pending, June 3 8PM 2022\"-",
                    "title": "report delivery status",
                    "$ref": "#/definitions/reportReportDeliveryStatus",
                    "x-displayname": "Report Delivery Status",
                    "x-ves-example": "Pending, June 3 8PM 2022"
                },
                "report_generation_status": {
                    "description": " report generation status\n\nExample: - \"Error, June 3 8PM 2022\"-",
                    "title": "report generation status",
                    "$ref": "#/definitions/reportReportGenerationStatus",
                    "x-displayname": "Report Generation Status",
                    "x-ves-example": "Error, June 3 8PM 2022"
                },
                "reports": {
                    "type": "array",
        ...
        "report_configcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.report_config.crudapi.ErrorCode"
        },
        "runtimeStreamError": {
            "type": "object",
            "properties": {
        ...
        "schemareport_configGlobalSpecType": {
            "type": "object",
            ...
            "x-ves-proto-message": "ves.io.schema.report_config.GlobalSpecType",
            "properties": {
                "bot_defense": {
                    "description": "Exclusive with [waap]\n",
                    "title": "type",
                    "$ref": "#/definitions/report_configReportTypeBotDefense",
                    "x-displayname": "Bot Defense"
                },
                "report_recipients": {
                    "description": " list of recipients to send the report",
                    "title": "Report recipients",
                    "$ref": "#/definitions/report_configReportRecipients",
                    "x-displayname": "Report recipients"
                },
                "waap": {
                    "description": "Exclusive with [bot_defense]\n",
                    "title": "type",
                    "$ref": "#/definitions/report_configReportTypeWaap",
    ...
    "x-ves-proto-file": "ves.io/schema/report_config/crudapi/api.proto"
}`
