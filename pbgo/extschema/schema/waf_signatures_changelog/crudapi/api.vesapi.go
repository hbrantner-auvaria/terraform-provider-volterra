...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/waf_signatures_changelog"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.waf_signatures_changelog.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.waf_signatures_changelog.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.waf_signatures_changelog.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_signatures_changelog.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_signatures_changelog.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_signatures_changelog.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_signatures_changelog.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_signatures_changelog.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.waf_signatures_changelog.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.waf_signatures_changelog.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_signatures_changelog.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_signatures_changelog.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_signatures_changelog.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_signatures_changelog.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_signatures_changelog.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_signatures_changelog.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_signatures_changelog.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_signatures_changelog.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/waf_signatures_changelog/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.waf_signatures_changelog/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_signatures_changelog-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_signatures_changelog.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_signatures_changelog-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_signatures_changelog.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_signatures_changelog-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_signatures_changelog.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_signatures_changelog",
            "x-ves-object-type": "ves.io.schema.waf_signatures_changelog.Object",
            "x-ves-proto-service": "ves.io.schema.waf_signatures_changelog.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.waf_signatures_changelog/Objects": {
            "get": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_signatures_changelog-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_signatures_changelog.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_signatures_changelog-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_signatures_changelog.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_signatures_changelog",
            "x-ves-object-type": "ves.io.schema.waf_signatures_changelog.Object",
        ...
        "/ves.io.schema.waf_signatures_changelog/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_signatures_changelog-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_signatures_changelog.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_signatures_changelog",
            "x-ves-object-type": "ves.io.schema.waf_signatures_changelog.Object",
        ...
        "/ves.io.schema.waf_signatures_changelog/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_signatures_changelog/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_signatures_changelog/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_signatures_changelog/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.waf_signatures_changelog.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/waf_signatures_changelogSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_signatures_changelog.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/waf_signatures_changelogStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_signatures_changelog.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_signatures_changelog.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "waf_signatures_changelogSpecType": {
            "type": "object",
            "description": "Shape of the Signatures Changelog Object specification",
            "title": "Signatures Changelog Object Specification",
            "x-displayname": "Signatures Changelog Object Specification",
            "x-ves-proto-message": "ves.io.schema.waf_signatures_changelog.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
        ...
        "waf_signatures_changelogStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Signatures Changelog Status",
            "x-displayname": "Signatures Changelog Status Object",
            "x-ves-proto-message": "ves.io.schema.waf_signatures_changelog.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-ves-proto-file": "ves.io/schema/waf_signatures_changelog/crudapi/api.proto"
}`
