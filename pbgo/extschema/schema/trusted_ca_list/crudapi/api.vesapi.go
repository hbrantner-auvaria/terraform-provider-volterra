...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/trusted_ca_list"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.trusted_ca_list.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.trusted_ca_list.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.trusted_ca_list.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.trusted_ca_list.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.trusted_ca_list.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.trusted_ca_list.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.trusted_ca_list.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.trusted_ca_list.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.trusted_ca_list.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.trusted_ca_list.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.trusted_ca_list.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.trusted_ca_list.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.trusted_ca_list.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.trusted_ca_list.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/trusted_ca_list/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.trusted_ca_list/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-trusted_ca_list-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.trusted_ca_list.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-trusted_ca_list-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.trusted_ca_list.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-trusted_ca_list-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.trusted_ca_list.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "trusted_ca_list",
            "x-ves-object-type": "ves.io.schema.trusted_ca_list.Object",
            "x-ves-proto-service": "ves.io.schema.trusted_ca_list.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.trusted_ca_list/Objects": {
            "get": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-trusted_ca_list-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.trusted_ca_list.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-trusted_ca_list-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.trusted_ca_list.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "trusted_ca_list",
            "x-ves-object-type": "ves.io.schema.trusted_ca_list.Object",
        ...
        "/ves.io.schema.trusted_ca_list/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-trusted_ca_list-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.trusted_ca_list.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "trusted_ca_list",
            "x-ves-object-type": "ves.io.schema.trusted_ca_list.Object",
        ...
        "/ves.io.schema.trusted_ca_list/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.trusted_ca_list/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.trusted_ca_list/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.trusted_ca_list/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.trusted_ca_list.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/trusted_ca_listSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/trusted_ca_listcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/trusted_ca_listcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/trusted_ca_listStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/trusted_ca_listcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/trusted_ca_listcrudapiErrorCode"
                },
        ...
        "trusted_ca_listGlobalSpecType": {
            "type": "object",
            "description": "Root CA Certificate specification",
            "title": "Global Specification",
            "x-displayname": "Global Specification",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.GlobalSpecType",
            "properties": {
                "infos": {
                    "type": "array",
                    "description": " Information about Trusted CA certificates.",
                    "title": "Information",
                    "items": {
                ...
                "trusted_ca_url": {
                    "type": "string",
                    "description": " Trusted CA certificates for validating certificates\n\nExample: - \"cert\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 512000\n  ves.io.schema.rules.string.truststore_url: true\n",
                    "title": "Trusted CA URL",
                    "maxLength": 512000,
        ...
        "trusted_ca_listSpecType": {
            "type": "object",
            "description": "Shape of the Trusted CA List specification",
            "title": "Trusted CA List Specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/trusted_ca_listGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "trusted_ca_listStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Trusted CA List Status",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.trusted_ca_list.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "trusted_ca_listcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.trusted_ca_list.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/trusted_ca_list/crudapi/api.proto"
}`
