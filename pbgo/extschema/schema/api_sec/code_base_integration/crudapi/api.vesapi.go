...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/api_sec/code_base_integration"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.api_sec.code_base_integration.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.api_sec.code_base_integration.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.api_sec.code_base_integration.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.code_base_integration.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.code_base_integration.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.code_base_integration.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.code_base_integration.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.code_base_integration.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.code_base_integration.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.code_base_integration.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.code_base_integration.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.code_base_integration.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.code_base_integration.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.code_base_integration.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.code_base_integration.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.code_base_integration.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/api_sec/code_base_integration/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.api_sec.code_base_integration/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-code_base_integration-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-code_base_integration-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-code_base_integration-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "code_base_integration",
            "x-ves-object-type": "ves.io.schema.api_sec.code_base_integration.Object",
            "x-ves-proto-service": "ves.io.schema.api_sec.code_base_integration.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.api_sec.code_base_integration/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-code_base_integration-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.code_base_integration.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-code_base_integration-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "code_base_integration",
            "x-ves-object-type": "ves.io.schema.api_sec.code_base_integration.Object",
        ...
        "/ves.io.schema.api_sec.code_base_integration/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-code_base_integration-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.code_base_integration.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "code_base_integration",
            "x-ves-object-type": "ves.io.schema.api_sec.code_base_integration.Object",
        ...
        "/ves.io.schema.api_sec.code_base_integration/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.code_base_integration/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.code_base_integration/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.code_base_integration/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.api_sec.code_base_integration.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "code_base_integrationAzureReposIntegration": {
            "type": "object",
        ...
        "code_base_integrationBitBucketCloudIntegration": {
            "type": "object",
        ...
        "code_base_integrationBitBucketServerIntegration": {
            "type": "object",
        ...
        "code_base_integrationCodeBaseIntegration": {
            "type": "object",
            ...
            "properties": {
                "azure_repos": {
                    "description": "Exclusive with [bitbucket bitbucket_server github github_enterprise gitlab gitlab_enterprise]\n",
                    "title": "Azure Repos Integration",
                    "$ref": "#/definitions/code_base_integrationAzureReposIntegration",
                    "x-displayname": "Azure Repos Integration"
                },
                "bitbucket": {
                    "description": "Exclusive with [azure_repos bitbucket_server github github_enterprise gitlab gitlab_enterprise]\n",
                    "title": "BitBucket Cloud Integration",
                    "$ref": "#/definitions/code_base_integrationBitBucketCloudIntegration",
                    "x-displayname": "BitBucket Cloud Integration"
                },
                "bitbucket_server": {
                    "description": "Exclusive with [azure_repos bitbucket github github_enterprise gitlab gitlab_enterprise]\n",
                    "title": "BitBucket Server Integration",
                    "$ref": "#/definitions/code_base_integrationBitBucketServerIntegration",
                    "x-displayname": "BitBucket Server Integration"
                },
                "github": {
                    "description": "Exclusive with [azure_repos bitbucket bitbucket_server github_enterprise gitlab gitlab_enterprise]\n",
                    "title": "Github Integration",
                    "$ref": "#/definitions/code_base_integrationGithubIntegration",
                    "x-displayname": "Github Integration"
                },
                "github_enterprise": {
                    "description": "Exclusive with [azure_repos bitbucket bitbucket_server github gitlab gitlab_enterprise]\n",
                    "title": "Github Enterprise Integration",
                    "$ref": "#/definitions/code_base_integrationGithubEnterpriseIntegration",
                    "x-displayname": "Github Enterprise Integration"
                },
                "gitlab": {
                    "description": "Exclusive with [azure_repos bitbucket bitbucket_server github github_enterprise gitlab_enterprise]\n",
                    "title": "GitLab Cloud Integration",
                    "$ref": "#/definitions/code_base_integrationGitlabCloudIntegration",
                    "x-displayname": "GitLab Cloud Integration"
                },
                "gitlab_enterprise": {
                    "description": "Exclusive with [azure_repos bitbucket bitbucket_server github github_enterprise gitlab]\n",
                    "title": "GitLab Enterprise Integration",
                    "$ref": "#/definitions/code_base_integrationGitlabEnterpriseIntegration",
                    "x-displayname": "GitLab Enterprise Integration"
                }
            }
        },
        "code_base_integrationGithubEnterpriseIntegration": {
            "type": "object",
            "title": "Github Enterprise Integration",
            "x-displayname": "GitHub Enterprise Integration",
        ...
        "code_base_integrationGithubIntegration": {
            "type": "object",
            "title": "Github Integration",
            "x-displayname": "Github Integration",
        ...
        "code_base_integrationGitlabCloudIntegration": {
            "type": "object",
            "title": "GitLab Cloud Integration",
            "x-displayname": "GitLab Cloud Integration",
        ...
        "code_base_integrationGitlabEnterpriseIntegration": {
            "type": "object",
            "title": "GitLab Enterprise Integration",
            "x-displayname": "GitLab Enterprise Integration",
        ...
        "code_base_integrationGlobalSpecType": {
            "type": "object",
            "description": "Code Base Integration Specification",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.GlobalSpecType",
            "properties": {
                "code_base_integration": {
                    "description": " Choose your code base (e.g. GitHub, GitLab, Bitbucket, Azure) and provide credentials and connection details",
                    "title": "Code Base",
                    "$ref": "#/definitions/code_base_integrationCodeBaseIntegration",
                    "x-displayname": "Integration Data"
                },
                "integration_health": {
                    "description": " Indicates the code base integration health status\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "number_of_api_repos": {
                    "type": "integer",
                    "description": " Number of API repositories found in the code base",
                    "title": "Number of API Repositories",
                    "format": "int32",
                    "x-displayname": "Number of API Repositories"
                },
                "number_of_repos": {
                    "type": "integer",
                    "description": " Number of repositories found in the code base",
                ...
                "updated_at": {
                    "type": "string",
                    "description": " The last time where the coed base was scanned",
                    "title": "Last Scan",
                    "format": "date-time",
        ...
        "code_base_integrationSpecType": {
            "type": "object",
            "description": "Shape of the code_base_integration specification",
            "title": "Specification of code_base_integration object",
            "x-displayname": "Code Base Integration Specification",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/code_base_integrationGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "code_base_integrationStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of a code_base_integration",
            "x-displayname": "Code Base Integration object status",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "code_base_integrationcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.api_sec.code_base_integration.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/code_base_integrationSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/code_base_integrationcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/code_base_integrationcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/code_base_integrationStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/code_base_integrationcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.code_base_integration.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/code_base_integrationcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/api_sec/code_base_integration/crudapi/api.proto"
}`
