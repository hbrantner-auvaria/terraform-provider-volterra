...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/api_sec/api_testing"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.api_sec.api_testing.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.api_sec.api_testing.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.api_sec.api_testing.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_testing.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_testing.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_testing.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_testing.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_testing.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.api_sec.api_testing.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.api_sec.api_testing.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_testing.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.api_testing.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_testing.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.api_testing.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_testing.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_testing.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_testing.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.api_testing.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/api_sec/api_testing/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.api_sec.api_testing/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_testing-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_testing.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_testing-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_testing.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_testing-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_testing.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_testing",
            "x-ves-object-type": "ves.io.schema.api_sec.api_testing.Object",
            "x-ves-proto-service": "ves.io.schema.api_sec.api_testing.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.api_sec.api_testing/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_testing-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_testing.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_testing-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_testing.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_testing",
            "x-ves-object-type": "ves.io.schema.api_sec.api_testing.Object",
        ...
        "/ves.io.schema.api_sec.api_testing/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_testing-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_testing.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_testing",
            "x-ves-object-type": "ves.io.schema.api_sec.api_testing.Object",
        ...
        "/ves.io.schema.api_sec.api_testing/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.api_testing/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.api_testing/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.api_testing/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.api_sec.api_testing.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "api_testingApiKey": {
            ...
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.ApiKey",
            "properties": {
                "key": {
                    "type": "string",
        ...
        "api_testingBasicAuthentication": {
            "type": "object",
        ...
        "api_testingCredentials": {
            "type": "object",
            "description": "Select the type of your credential, their values and roles.",
            "title": "Credentials",
            ...
            "properties": {
                "admin": {
                    "description": "Exclusive with [standard]\n",
                    "title": "Admin Role",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Admin"
                },
                "api_key": {
                    "description": "Exclusive with [basic_auth bearer_token login_endpoint]\n",
                    "title": "Field Aggregation",
                    "$ref": "#/definitions/api_testingApiKey",
                    "x-displayname": "API Key"
                },
                "basic_auth": {
                    "description": "Exclusive with [api_key bearer_token login_endpoint]\n",
                    "title": "Basic authentication",
                    "$ref": "#/definitions/api_testingBasicAuthentication",
                    "x-displayname": "Basic Authentication"
                },
                "bearer_token": {
                    "description": "Exclusive with [api_key basic_auth login_endpoint]\n",
                    "title": "Bearer Token",
                    "$ref": "#/definitions/api_testingBearer",
                ...
                "login_endpoint": {
                    "description": "Exclusive with [api_key basic_auth bearer_token]\n",
                    "title": "Login Endpoint",
                    "$ref": "#/definitions/api_testingLoginEndpoint",
                    "x-displayname": "Login Endpoint"
                },
                "standard": {
                    "description": "Exclusive with [admin]\n",
                    "title": "Standard Role",
                    "$ref": "#/definitions/schemaEmpty",
        ...
        "api_testingDomainConfiguration": {
            ...
            "properties": {
                ...
                "credentials": {
                    ...
                    "items": {
                        "$ref": "#/definitions/api_testingCredentials"
                    },
        ...
        "api_testingGlobalSpecType": {
            "type": "object",
            "title": "API Testing",
            "x-displayname": "API Testing",
            "x-ves-oneof-field-frequency_choice": "[\"every_day\",\"every_month\",\"every_week\"]",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.GlobalSpecType",
            "properties": {
                "custom_header_value": {
                    "type": "string",
                ...
                "domains": {
                    ...
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/api_testingDomainConfiguration"
                    },
                ...
                "every_day": {
                    "description": "Exclusive with [every_month every_week]\n",
                    "title": "Every Day",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Every Day"
                },
                "every_month": {
                    "description": "Exclusive with [every_day every_week]\n",
                    "title": "Every Month",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Every Month"
                },
                "every_week": {
                    "description": "Exclusive with [every_day every_month]\n",
                    "title": "Every Week",
                    "$ref": "#/definitions/schemaEmpty",
        ...
        "api_testingSpecType": {
            ...
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/api_testingGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "api_testingStatusObject": {
            "type": "object",
            "title": "Most recently observed status of object",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "api_testingcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.api_sec.api_testing.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/api_testingSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_testingcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_testingcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api_testingStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_testingcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_testing.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_testingcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/api_sec/api_testing/crudapi/api.proto"
}`
