...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/api_sec/api_discovery"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.api_sec.api_discovery.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.api_sec.api_discovery.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.api_sec.api_discovery.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_discovery.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_discovery.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_discovery.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_discovery.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_sec.api_discovery.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.api_sec.api_discovery.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.api_sec.api_discovery.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_discovery.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.api_discovery.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_discovery.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.api_discovery.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_discovery.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_discovery.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_sec.api_discovery.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_sec.api_discovery.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/api_sec/api_discovery/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.api_sec.api_discovery/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_discovery-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_discovery.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_discovery-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_discovery.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_discovery-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_discovery.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_discovery",
            "x-ves-object-type": "ves.io.schema.api_sec.api_discovery.Object",
            "x-ves-proto-service": "ves.io.schema.api_sec.api_discovery.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.api_sec.api_discovery/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_discovery-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_discovery.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_discovery-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_discovery.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_discovery",
            "x-ves-object-type": "ves.io.schema.api_sec.api_discovery.Object",
        ...
        "/ves.io.schema.api_sec.api_discovery/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_sec-api_discovery-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_sec.api_discovery.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_discovery",
            "x-ves-object-type": "ves.io.schema.api_sec.api_discovery.Object",
        ...
        "/ves.io.schema.api_sec.api_discovery/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.api_discovery/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.api_discovery/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_sec.api_discovery/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.api_sec.api_discovery.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "api_discoveryGlobalSpecType": {
            "type": "object",
            "description": "Shape of api_discovery in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-displayorder": "2,1",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.GlobalSpecType",
            "properties": {
                "custom_auth_types": {
                    "type": "array",
                    "description": " Select your custom authentication types to be detected in the API discovery\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 10\n",
                    "title": "custom_auth_types",
                    "maxItems": 10,
                    "items": {
                ...
                "user_defined_api_discovery_policy": {
                    ...
                    "title": "user_defined_api_discovery_policy",
        ...
        "api_discoverySpecType": {
            "type": "object",
            "description": "Shape of the api group specification",
            "title": "api_discovery specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/api_discoveryGlobalSpecType",
        ...
        "api_discoverycrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.api_sec.api_discovery.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/api_discoverySpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_discoverycrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_discoverycrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_discoverycrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_sec.api_discovery.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_discoverycrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/api_sec/api_discovery/crudapi/api.proto"
}`
