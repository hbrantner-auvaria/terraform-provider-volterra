...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/subnet"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.subnet.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.subnet.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.subnet.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.subnet.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.subnet.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.subnet.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.subnet.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.subnet.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.subnet.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.subnet.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.subnet.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.subnet.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.subnet.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.subnet.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.subnet.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.subnet.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.subnet.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.subnet.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/subnet/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.subnet/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.subnet.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-subnet-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.subnet.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.subnet.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-subnet-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.subnet.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.subnet.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-subnet-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.subnet.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "subnet",
            "x-ves-object-type": "ves.io.schema.subnet.Object",
            "x-ves-proto-service": "ves.io.schema.subnet.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.subnet/Objects": {
            "get": {
                "operationId": "ves.io.schema.subnet.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-subnet-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.subnet.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.subnet.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-subnet-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.subnet.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "subnet",
            "x-ves-object-type": "ves.io.schema.subnet.Object",
        ...
        "/ves.io.schema.subnet/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.subnet.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-subnet-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.subnet.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "subnet",
            "x-ves-object-type": "ves.io.schema.subnet.Object",
        ...
        "/ves.io.schema.subnet/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.subnet.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.subnet/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.subnet.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.subnet/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.subnet.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.subnet/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.subnet.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subnet.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subnet.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/subnetcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subnet.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/subnetcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subnet.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subnet.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/subnetcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subnet.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subnet.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.subnet.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/subnetcrudapiErrorCode"
                },
        ...
        "schemasubnetDHCPNetworkType": {
            "type": "object",
            "description": "DHCPNetworkType will be a subset of network_interface.DHCPNetworkType",
            "title": "DHCPNetworkType",
            "x-displayname": "DHCP Network",
            "x-ves-displayorder": "1",
            "x-ves-oneof-field-network_prefix_choice": "[\"network_prefix\"]",
            "x-ves-proto-message": "ves.io.schema.subnet.DHCPNetworkType",
            "properties": {
                "network_prefix": {
                    "type": "string",
                    "description": "Exclusive with []\n Network prefix for subnet\n\nExample: - \"10.1.1.0/24\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.ipv4_prefix: true\n",
                    "title": "Network Prefix",
                    "x-displayname": "Network Prefix",
                    "x-ves-example": "10.1.1.0/24",
                    "x-ves-validation-rules": {
                ...
                "network_prefix_ipv6": {
                    "type": "string",
                    "description": " Network prefix for IPV6 subnet\n\nExample: - \"2001::1/64\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.ipv6_prefix: true\n",
                    "title": "Network IPV6 Prefix",
                    "x-displayname": "Network IPV6 Prefix",
        ...
        "schemasubnetDHCPServerParametersType": {
            "type": "object",
            "description": "Subnet DHCP parameters will be a subset of network_interface.DHCPServerParametersType as all\nfeatures in network_interface.DHCPServerParametersType may not be supported in a subnet.",
            "title": "DHCPServerParametersType",
            "x-displayname": "Subnet DHCP parameters",
            "x-ves-proto-message": "ves.io.schema.subnet.DHCPServerParametersType",
            "properties": {
                "dhcp_networks": {
                    "type": "array",
        ...
        "schemasubnetGlobalSpecType": {
            "type": "object",
            "description": "Subnet configuration is applied to an interface of a pod/VM.",
            "title": "Subnet object global spec",
            "x-displayname": "Global Specification",
            "x-ves-oneof-field-connection_choice": "[\"connect_to_layer2\",\"connect_to_slo\",\"isolated_nw\"]",
            "x-ves-proto-message": "ves.io.schema.subnet.GlobalSpecType",
            "properties": {
                "connect_to_layer2": {
                    "description": "Exclusive with [connect_to_slo isolated_nw]\n",
                    "title": "Connect to Layer2 interface",
                    "$ref": "#/definitions/subnetConnectToLayer2",
                    "x-displayname": "Connect to Layer2 Interface"
                },
                "connect_to_slo": {
                    "description": "Exclusive with [connect_to_layer2 isolated_nw]\n",
                    "title": "Connect to site-local-outside-network",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Connect to Site Local Outside Network"
                },
                "isolated_nw": {
                    "description": "Exclusive with [connect_to_layer2 connect_to_slo]\n",
                    "title": "Isolated network",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Not Connected to Other Network"
                },
                "site_dhcp_server_params_internal": {
                    "type": "array",
                    "description": " Site DHCP server parameters internal structure is stored\n in the db and exists to reuse the network_interface\n DHCPServerParametersType message. Not all fields of the\n network_interface DHCPServerParametersType object may be\n relevant to a subnet, so we will always have a separate\n object for the subnet DHCP server parameters.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "subnetSiteSubnetParametersType": {
            ...
            "properties": {
                ...
                "static_ip": {
                    "description": "Exclusive with [dhcp]\n Subnet uses static IP addresses",
                    "title": "Static IP",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Static IP"
                },
                "subnet_dhcp_server_params": {
                    "description": " DHCP parameters for a subnet on a site",
        ...
        "subnetSpecType": {
            "type": "object",
            "description": "Shape of the Subnet specification",
            "title": "Specification for subnet",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.subnet.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
        ...
        "subnetStatusObject": {
            "type": "object",
            "description": "Most recently observed status of subnet",
            "title": "Status of subnet object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.subnet.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "subnetSubnetDHCPServerParametersType": {
            ...
            "properties": {
                ...
                "subnet_dhcp_server_params": {
                    "description": " DHCP parameters for a subnet on a site. This reuses the\n DHCPServerParametersType from network_interface.",
        ...
        "subnetcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.subnet.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/subnet/crudapi/api.proto"
}`
