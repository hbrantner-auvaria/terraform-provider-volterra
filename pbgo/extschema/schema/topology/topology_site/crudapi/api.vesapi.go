...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_site"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.topology.topology_site.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.topology.topology_site.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_site.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_site.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_site.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_site.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_site.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_site.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_site.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_site.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/topology/topology_site/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.topology.topology_site/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_site-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_site.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_site-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_site.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_site-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_site.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_site",
            "x-ves-object-type": "ves.io.schema.topology.topology_site.Object",
            "x-ves-proto-service": "ves.io.schema.topology.topology_site.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.topology.topology_site/Objects": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_site-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_site.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_site-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_site.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_site",
            "x-ves-object-type": "ves.io.schema.topology.topology_site.Object",
        ...
        "/ves.io.schema.topology.topology_site/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_site-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_site.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_site",
            "x-ves-object-type": "ves.io.schema.topology.topology_site.Object",
        ...
        "/ves.io.schema.topology.topology_site/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_site/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_site/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_site/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.topology.topology_site.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/topology_siteSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_sitecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_sitecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_sitecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_sitecrudapiErrorCode"
                },
        ...
        "topology_siteSpecType": {
            "type": "object",
            "description": "Shape of the topology site specification",
            "title": "Topology site specification",
            "x-displayname": "site specification",
            "x-ves-proto-message": "ves.io.schema.topology.topology_site.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/topologytopology_siteGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "topology_sitecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.topology.topology_site.crudapi.ErrorCode"
        },
        "topologytopology_siteGlobalSpecType": {
            "type": "object",
            "description": " A node represents a site in the topology graph.",
            "title": "Topology Site",
            "x-displayname": "Site",
    ...
    "x-ves-proto-file": "ves.io/schema/topology/topology_site/crudapi/api.proto"
}`
