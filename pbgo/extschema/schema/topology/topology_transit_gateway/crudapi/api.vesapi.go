...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_transit_gateway"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.topology.topology_transit_gateway.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.topology.topology_transit_gateway.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.topology.topology_transit_gateway.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_transit_gateway.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_transit_gateway.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_transit_gateway.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_transit_gateway.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_transit_gateway.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_transit_gateway.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/topology/topology_transit_gateway/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.topology.topology_transit_gateway/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Get",
                "responses": {
                    "200": {
            ...
            "delete": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "put": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "x-displayname": "",
            "x-ves-object-kind": "topology_transit_gateway",
            "x-ves-object-type": "ves.io.schema.topology.topology_transit_gateway.Object",
            "x-ves-proto-service": "ves.io.schema.topology.topology_transit_gateway.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.topology.topology_transit_gateway/Objects": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
            ...
            "post": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
        ...
        "/ves.io.schema.topology.topology_transit_gateway/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.ListStream",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_transit_gateway/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_transit_gateway/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_transit_gateway/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_transit_gateway/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.topology.topology_transit_gateway.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/topology_transit_gatewaySpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_transit_gatewaycrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_transit_gatewaycrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_transit_gatewaycrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_transit_gatewaycrudapiErrorCode"
                },
        ...
        "topology_transit_gatewaySpecType": {
            "type": "object",
            ...
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/topologytopology_transit_gatewayGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "topology_transit_gatewaycrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.topology.topology_transit_gateway.crudapi.ErrorCode"
        },
        "topologytopology_transit_gatewayGlobalSpecType": {
            "type": "object",
            "description": " A node represents transit gateway in the topology graph.",
            "title": "Topology Transit Gateway",
            "x-displayname": "Transit Gateway",
            "x-ves-proto-message": "ves.io.schema.topology.topology_transit_gateway.GlobalSpecType",
            "properties": {
                "topology_metadata": {
    ...
    "x-ves-proto-file": "ves.io/schema/topology/topology_transit_gateway/crudapi/api.proto"
}`
