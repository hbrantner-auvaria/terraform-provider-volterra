...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_cloud_policy"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.topology.topology_cloud_policy.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.topology.topology_cloud_policy.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.topology.topology_cloud_policy.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_cloud_policy.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.topology.topology_cloud_policy.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.topology.topology_cloud_policy.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_cloud_policy.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_cloud_policy.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_cloud_policy.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_cloud_policy.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_cloud_policy.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/topology/topology_cloud_policy/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.topology.topology_cloud_policy/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_cloud_policy-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_cloud_policy-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_cloud_policy-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_cloud_policy",
            "x-ves-object-type": "ves.io.schema.topology.topology_cloud_policy.Object",
            "x-ves-proto-service": "ves.io.schema.topology.topology_cloud_policy.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.topology.topology_cloud_policy/Objects": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_cloud_policy-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_cloud_policy-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_cloud_policy",
            "x-ves-object-type": "ves.io.schema.topology.topology_cloud_policy.Object",
        ...
        "/ves.io.schema.topology.topology_cloud_policy/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_cloud_policy-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_cloud_policy",
            "x-ves-object-type": "ves.io.schema.topology.topology_cloud_policy.Object",
        ...
        "/ves.io.schema.topology.topology_cloud_policy/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_cloud_policy/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_cloud_policy/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_cloud_policy/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.topology.topology_cloud_policy.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/topology_cloud_policySpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_cloud_policycrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_cloud_policycrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_cloud_policycrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_cloud_policycrudapiErrorCode"
                },
        ...
        "topologyAWSPolicyType": {
            "type": "object",
            "description": "AWS policy info",
            "title": "AWSPolicyType",
            "x-displayname": "AWS Policy Type",
            "x-ves-proto-message": "ves.io.schema.topology.AWSPolicyType",
            "properties": {
                "missing_permissions_aws_tgw_site": {
                    "type": "array",
                    "description": " List of missing permissions at AWS TGW Site\"",
                    "title": "\"Missing Permissions At AWS TGW Site\"",
                    "items": {
                        "type": "string"
                    },
                    "x-displayname": "Missing Permissions At AWS TGW Site"
                },
                "missing_permissions_aws_vpc_site": {
                    "type": "array",
                    "description": " List of missing permissions at AWS VPC Site\"",
                    "title": "\"Missing Permissions At AWS VPC Site\"",
                    "items": {
                        "type": "string"
                    },
                    "x-displayname": "Missing Permissions At AWS VPC Site"
                },
                "support_aws_tgw_site": {
                    "type": "boolean",
                    "description": " Is aws tgw site enabled",
                    "title": "\"AWS TGW Site Support\"",
                    "format": "boolean",
                    "x-displayname": "AWS TGW Site Support"
                },
                "support_aws_vpc_site": {
                    "type": "boolean",
                    "description": " Is aws vpc site enabled",
                    "title": "AWS VPC Site Support",
                    "format": "boolean",
                    "x-displayname": "AWS VPC Site Support"
                }
            }
        },
        "topologyCloudPolicyType": {
            "type": "object",
            "description": "Cloud related policy info",
            "title": "CloudPolicyType",
            "x-displayname": "Cloud Policy Type",
            "x-ves-oneof-field-cloud_type": "[\"aws\"]",
            "x-ves-proto-message": "ves.io.schema.topology.CloudPolicyType",
            "properties": {
                "aws": {
                    "description": "Exclusive with []\n",
                    "title": "AWS policy type",
                    "$ref": "#/definitions/topologyAWSPolicyType",
                    "x-displayname": "AWS Policy Type"
                },
                "cloud_provider_error": {
                    "type": "string",
                    "description": " Cloud provider error when retreiving permissions",
                    "title": "\"Cloud Provider Error\"",
                    "x-displayname": "Cloud Provider Error"
                },
                "permissions_populated": {
                    "type": "boolean",
                    "description": " Are Permissions populated",
                    "title": "\"Are Permissions Populated\"",
                    "format": "boolean",
        ...
        "topology_cloud_policySpecType": {
            "type": "object",
            "description": "Shape of the topology cloud policy specification",
            "title": "Topology cloud policy specification",
            "x-displayname": "cloud policy specification",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/topologytopology_cloud_policyGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "topology_cloud_policycrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.topology.topology_cloud_policy.crudapi.ErrorCode"
        },
        "topologytopology_cloud_policyGlobalSpecType": {
            "type": "object",
            "description": " A node represents cloud policy in the topology graph.",
            "title": "Topology Cloud Policy",
            "x-displayname": "Cloud Policy",
            "x-ves-proto-message": "ves.io.schema.topology.topology_cloud_policy.GlobalSpecType",
            "properties": {
                "topology_metadata": {
                ...
                "topology_spec": {
                    "description": " A canonical spec for this topology node.",
                    "title": "Topology Spec",
                    "$ref": "#/definitions/topologyCloudPolicyType",
                    "x-displayname": "Spec"
                }
            }
        }
    ...
    "x-ves-proto-file": "ves.io/schema/topology/topology_cloud_policy/crudapi/api.proto"
}`
