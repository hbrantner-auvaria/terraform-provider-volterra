...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/topology/topology_network_peer"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.topology.topology_network_peer.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.topology.topology_network_peer.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.topology.topology_network_peer.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_network_peer.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_network_peer.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_network_peer.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_network_peer.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.topology.topology_network_peer.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_network_peer.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_network_peer.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_network_peer.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_network_peer.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_network_peer.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_network_peer.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.topology.topology_network_peer.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.topology.topology_network_peer.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/topology/topology_network_peer/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.topology.topology_network_peer/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_network_peer-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_network_peer.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_network_peer-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_network_peer.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_network_peer-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_network_peer.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_network_peer",
            "x-ves-object-type": "ves.io.schema.topology.topology_network_peer.Object",
            "x-ves-proto-service": "ves.io.schema.topology.topology_network_peer.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.topology.topology_network_peer/Objects": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_network_peer-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_network_peer.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_network_peer-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_network_peer.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_network_peer",
            "x-ves-object-type": "ves.io.schema.topology.topology_network_peer.Object",
        ...
        "/ves.io.schema.topology.topology_network_peer/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-topology-topology_network_peer-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.topology.topology_network_peer.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "topology_network_peer",
            "x-ves-object-type": "ves.io.schema.topology.topology_network_peer.Object",
        ...
        "/ves.io.schema.topology.topology_network_peer/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_network_peer/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_network_peer/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.topology.topology_network_peer/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.topology.topology_network_peer.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/topology_network_peerSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_network_peercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_network_peercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_network_peercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/topology_network_peercrudapiErrorCode"
                },
        ...
        "topologyAzureVnetPeer": {
            "type": "object",
            "description": "AzureVnetPeer",
            "title": "AzureVnetPeer",
            "x-displayname": "AzureVnetPeer",
            "x-ves-proto-message": "ves.io.schema.topology.AzureVnetPeer",
            "properties": {
                "peer_network": {
                    "type": "array",
                    "description": " Reference to source of Network.",
                    "title": "Azure VNET Peer Network",
                    "items": {
                        "$ref": "#/definitions/ioschemaObjectRefType"
                    },
                ...
                "peering_state": {
                    ...
                    "title": "Peering State",
                    "$ref": "#/definitions/topologyPeeringStateEnum",
        ...
        "topologyNetworkPeerType": {
            "type": "object",
            "description": "A canonical form of the NetworkPeerType",
            "title": "NetworkPeerType",
            "x-displayname": "NetworkPeerType",
            "x-ves-oneof-field-peer_choice": "[\"vnet_peer\"]",
            "x-ves-proto-message": "ves.io.schema.topology.NetworkPeerType",
            "properties": {
                "vnet_peer": {
                    "description": "Exclusive with []\n Azure Vnet Peer",
                    "title": "Azure Vnet Peer",
                    "$ref": "#/definitions/topologyAzureVnetPeer",
                    "x-displayname": "Azure Vnet Peer"
                }
            }
        },
        ...
        "topology_network_peerSpecType": {
            "type": "object",
            "description": "Shape of the topology network peer specification",
            "title": "Topology Network Peer specification",
            "x-displayname": "Topology Network Peer specification",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/topologytopology_network_peerGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "topology_network_peercrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.topology.topology_network_peer.crudapi.ErrorCode"
        },
        "topologytopology_network_peerGlobalSpecType": {
            "type": "object",
            "description": "Topology Network Peer",
            "title": "Topology Network Peer",
            "x-displayname": "Topology Network Peer",
            "x-ves-proto-message": "ves.io.schema.topology.topology_network_peer.GlobalSpecType",
            "properties": {
                "topology_metadata": {
                ...
                "topology_spec": {
                    ...
                    "title": "Topology Spec",
                    "$ref": "#/definitions/topologyNetworkPeerType",
                    "x-displayname": "Spec"
                }
            }
        }
    ...
    "x-ves-proto-file": "ves.io/schema/topology/topology_network_peer/crudapi/api.proto"
}`
