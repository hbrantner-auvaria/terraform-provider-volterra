...
const (
	...
	// VMware backend
	PROVIDER_TYPE_VMWARE ProviderType = 5
	// x-displayName: "KVM"
	// KVM backend
	PROVIDER_TYPE_KVM ProviderType = 6
	// x-displayName: "OCI"
	// OCI backend
	PROVIDER_TYPE_OCI ProviderType = 7
	// x-displayName: "Baremetal"
	// Baremetal backend
	PROVIDER_TYPE_BAREMETAL ProviderType = 8
	// x-displayName: "F5 rSeries"
	// F5 rSeries backend
	PROVIDER_TYPE_F5RSERIES ProviderType = 9
	// x-displayName: "CE on k8s"
	// CE on k8s backend
	PROVIDER_TYPE_K8S ProviderType = 10
)
...
var ProviderType_name = map[int32]string{
	...
	5:  "PROVIDER_TYPE_VMWARE",
	6:  "PROVIDER_TYPE_KVM",
	7:  "PROVIDER_TYPE_OCI",
	8:  "PROVIDER_TYPE_BAREMETAL",
	9:  "PROVIDER_TYPE_F5RSERIES",
	10: "PROVIDER_TYPE_K8S",
}
...
var ProviderType_value = map[string]int32{
	...
	"PROVIDER_TYPE_VMWARE":      5,
	"PROVIDER_TYPE_KVM":         6,
	"PROVIDER_TYPE_OCI":         7,
	"PROVIDER_TYPE_BAREMETAL":   8,
	"PROVIDER_TYPE_F5RSERIES":   9,
	"PROVIDER_TYPE_K8S":         10,
}
...
// Orchestration mode of a given site
type OrchestrationMode int32

const (
	// Unmanaged mode
	//
	// x-displayName: "Unmanaged mode"
	// Unmanaged mode
	NOT_MANAGED OrchestrationMode = 0
	// Managed mode
	//
	// x-displayName: "Managed mode"
	// Managed mode
	MANAGED OrchestrationMode = 1
)

var OrchestrationMode_name = map[int32]string{
	0: "NOT_MANAGED",
	1: "MANAGED",
}

var OrchestrationMode_value = map[string]int32{
	"NOT_MANAGED": 0,
	"MANAGED":     1,
}
...
const (
	...
	// SEGMENT Interface
	//
	// x-displayName: "Segment Interface"
	SEGMENT InterfaceTypeEnum = 4
)
...
type MetaType struct {
	...
	// Reference to cloud user account to fetch cloud resources.
	CloudUserAccounts []*schema.ObjectRefType `protobuf:"bytes,10,rep,name=cloud_user_accounts,json=cloudUserAccounts,proto3" json:"cloud_user_accounts,omitempty"`
}
...
func (m *MetaType) GetCloudUserAccounts() []*schema.ObjectRefType {
	if m != nil {
		return m.CloudUserAccounts
	}
	return nil
}
...
func (m *AWSTGWAttachment) GetTags() map[string]string {
	if m != nil {
		return m.Tags
	}
	return nil
...
func (m *SiteType) GetOrchestrationMode() OrchestrationMode {
	if m != nil {
		return m.OrchestrationMode
	}
	return NOT_MANAGED
}
...
func init() {
	...
	proto.RegisterEnum("ves.io.schema.topology.OrchestrationMode", OrchestrationMode_name, OrchestrationMode_value)
	golang_proto.RegisterEnum("ves.io.schema.topology.OrchestrationMode", OrchestrationMode_name, OrchestrationMode_value)
	...
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.topology.AWSTGWAttachment.TagsEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.topology.AWSTGWAttachment.TagsEntry")
...
var fileDescriptor_e89c101129b5baba = []byte{
	...
	,
}
...
func (x OrchestrationMode) String() string {
	s, ok := OrchestrationMode_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *MetaType) Equal(that interface{}) bool {
	...
	if len(this.CloudUserAccounts) != len(that1.CloudUserAccounts) {
		return false
	}
	for i := range this.CloudUserAccounts {
		if !this.CloudUserAccounts[i].Equal(that1.CloudUserAccounts[i]) {
			return false
		}
	}
	return true
...
func (this *SiteType) Equal(that interface{}) bool {
	...
	if this.OrchestrationMode != that1.OrchestrationMode {
		return false
	}
	return true
}
...
func (this *MetaType) GoString() string {
	...
	if this.CloudUserAccounts != nil {
		s = append(s, "CloudUserAccounts: "+fmt.Sprintf("%#v", this.CloudUserAccounts)+",\n")
	}
	s = append(s, "}")
...
func (this *SiteType) GoString() string {
	...
	s = append(s, "OrchestrationMode: "+fmt.Sprintf("%#v", this.OrchestrationMode)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *MetaType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CloudUserAccounts) > 0 {
		for iNdEx := len(m.CloudUserAccounts) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CloudUserAccounts[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *SiteType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.OrchestrationMode != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.OrchestrationMode))
		i--
		dAtA[i] = 0x40
	}
	if m.AppType != 0 {
...
func (m *MetaType) Size() (n int) {
	...
	if len(m.CloudUserAccounts) > 0 {
		for _, e := range m.CloudUserAccounts {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *SiteType) Size() (n int) {
	...
	if m.OrchestrationMode != 0 {
		n += 1 + sovTypes(uint64(m.OrchestrationMode))
	}
	return n
}
...
func (this *MetaType) String() string {
	...
	repeatedStringForCloudUserAccounts := "[]*ObjectRefType{"
	for _, f := range this.CloudUserAccounts {
		repeatedStringForCloudUserAccounts += strings.Replace(fmt.Sprintf("%v", f), "ObjectRefType", "schema.ObjectRefType", 1) + ","
	}
	repeatedStringForCloudUserAccounts += "}"
	keysForTags := make([]string, 0, len(this.Tags))
	for k, _ := range this.Tags {
		keysForTags = append(keysForTags, k)
	}
	...
	s := strings.Join([]string{`&MetaType{`,
		...
		`CloudUserAccounts:` + repeatedStringForCloudUserAccounts + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *SiteType) String() string {
	...
	s := strings.Join([]string{`&SiteType{`,
		...
		`OrchestrationMode:` + fmt.Sprintf("%v", this.OrchestrationMode) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *MetaType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudUserAccounts", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CloudUserAccounts = append(m.CloudUserAccounts, &schema.ObjectRefType{})
			if err := m.CloudUserAccounts[len(m.CloudUserAccounts)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SiteType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrchestrationMode", wireType)
			}
			m.OrchestrationMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OrchestrationMode |= OrchestrationMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
