...
type Key struct {
	...
	// Exclude Empty
	//
	// x-displayName "Exclude Empty"
	// When true, exclude empty/zero values from unique index checks.
	// This allows multiple objects to have empty values for this key field
	// without violating uniqueness constraints.
	ExcludeEmpty bool `protobuf:"varint,3,opt,name=exclude_empty,json=excludeEmpty,proto3" json:"exclude_empty,omitempty"`
}
...
func (m *Key) GetExcludeEmpty() bool {
	if m != nil {
		return m.ExcludeEmpty
	}
	return false
}
...
func (m *MetricDef) GetSubsystem() string {
	if m != nil {
		return m.Subsystem
	}
	return ""
...
var fileDescriptor_8562c0a0fb65343f = []byte{
	...
	,
}
...
func (this *Key) Equal(that interface{}) bool {
	...
	if this.ExcludeEmpty != that1.ExcludeEmpty {
		return false
	}
	return true
}
...
func (this *MetricDef) Equal(that interface{}) bool {
	...
	if this.Subsystem != that1.Subsystem {
		return false
	}
	return true
}
...
func (this *Key) GoString() string {
	...
	s = append(s, "FieldPath: "+fmt.Sprintf("%#v", this.FieldPath)+",\n")
	s = append(s, "Type: "+fmt.Sprintf("%#v", this.Type)+",\n")
	s = append(s, "ExcludeEmpty: "+fmt.Sprintf("%#v", this.ExcludeEmpty)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *MetricDef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Subsystem) > 0 {
		...
		i = encodeVarintOptions(dAtA, i, uint64(len(m.Subsystem)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Buckets) > 0 {
...
func (this *Key) String() string {
	...
	s := strings.Join([]string{`&Key{`,
		`FieldPath:` + fmt.Sprintf("%v", this.FieldPath) + `,`,
		`Type:` + fmt.Sprintf("%v", this.Type) + `,`,
		`ExcludeEmpty:` + fmt.Sprintf("%v", this.ExcludeEmpty) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Key) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExcludeEmpty", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
