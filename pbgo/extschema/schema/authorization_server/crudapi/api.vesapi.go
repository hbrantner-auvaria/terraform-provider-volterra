...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/authorization_server"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.authorization_server.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.authorization_server.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.authorization_server.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authorization_server.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.authorization_server.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.authorization_server.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authorization_server.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authorization_server.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authorization_server.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authorization_server.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/authorization_server/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.authorization_server/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authorization_server-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.authorization_server.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authorization_server-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.authorization_server.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authorization_server-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.authorization_server.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "authorization_server",
            "x-ves-object-type": "ves.io.schema.authorization_server.Object",
            "x-ves-proto-service": "ves.io.schema.authorization_server.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.authorization_server/Objects": {
            "get": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authorization_server-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.authorization_server.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authorization_server-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.authorization_server.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "authorization_server",
            "x-ves-object-type": "ves.io.schema.authorization_server.Object",
        ...
        "/ves.io.schema.authorization_server/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authorization_server-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.authorization_server.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "authorization_server",
            "x-ves-object-type": "ves.io.schema.authorization_server.Object",
        ...
        "/ves.io.schema.authorization_server/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.authorization_server/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.authorization_server/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.authorization_server/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.authorization_server.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "authorization_serverGlobalSpecType": {
            ...
            "properties": {
                ...
                "last_fetch_status": {
                    "description": " Indicates the result of the most recent attempt to fetch the JWKS file from the Authorization Server.",
                    "title": "last_fetch_status",
                    "$ref": "#/definitions/authorization_serverStatus",
                    "x-displayname": "Last Fetch Status"
                },
                "last_successful_fetch": {
                    "type": "string",
                    "description": "\n\nExample: - \"01-01-1970T00:00:00Z\"-",
                    "title": "last_successful_fetch",
                    "format": "date-time",
        ...
        "authorization_serverSpecType": {
            "type": "object",
            "description": "Shape of the authorization_server specification",
            "title": "Specification of authorization server",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.authorization_server.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/authorization_serverGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "authorization_serverStatus": {
            "type": "string",
            ...
            "enum": [
                ...
                "STATUS_SUCCEEDED",
                "STATUS_FAILED",
                "STATUS_SUCCEEDED_WITH_ERROR"
            ],
            "default": "STATUS_UNKNOWN",
            "x-displayname": "Status",
            "x-ves-proto-enum": "ves.io.schema.authorization_server.Status"
        },
        "authorization_serverStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of authorization server",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.authorization_server.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "authorization_servercrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.authorization_server.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/authorization_serverSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/authorization_servercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/authorization_servercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/authorization_serverStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/authorization_servercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authorization_server.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/authorization_servercrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/authorization_server/crudapi/api.proto"
}`
