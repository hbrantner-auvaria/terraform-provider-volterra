...
type CbipDiscoveryType struct {
	...
	// x-required
	// List of BIG-IP clusters. A BIG-IP cluster is a set of BIG-IP devices which
...
type ThirdPartyDiscoveryType struct {
	...
	// Defines names to identify and distinguish log source system or platforms
	...
	// Defines IP ranges allowed to send logs using CIDR notation (e.g., 192.168.1.0/24).
...
type CbipCluster struct {
	...
	// IP Addresses of BIG-IP devices. Hostname is not supported.
	...
	HaSync *HASync `protobuf:"bytes,11,opt,name=ha_sync,json=haSync,proto3" json:"ha_sync,omitempty"`
}
...
func (m *CbipCluster) GetHaSync() *HASync {
	if m != nil {
		return m.HaSync
	}
	return nil
...
type HASync struct {
	// Sync Type
	//
	// x-displayName: "Sync Type"
	// x-example: "Not Applicable"
	//
	// Types that are valid to be assigned to SyncType:
	//	*HASync_NotApplicable
	//	*HASync_ManualSync
	//	*HASync_XcManagedSync
	SyncType isHASync_SyncType `protobuf_oneof:"sync_type"`
}

func (m *HASync) Reset()      { *m = HASync{} }
func (*HASync) ProtoMessage() {}
func (*HASync) Descriptor() ([]byte, []int) {
	return fileDescriptor_1beabb40327c3d92, []int{19}
}
func (m *HASync) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HASync) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *HASync) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HASync.Merge(m, src)
}
func (m *HASync) XXX_Size() int {
	return m.Size()
}
func (m *HASync) XXX_DiscardUnknown() {
	xxx_messageInfo_HASync.DiscardUnknown(m)
}

var xxx_messageInfo_HASync proto.InternalMessageInfo

type isHASync_SyncType interface {
	isHASync_SyncType()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
...
type HASync_NotApplicable struct {
	NotApplicable *schema.Empty `protobuf:"bytes,2,opt,name=not_applicable,json=notApplicable,proto3,oneof" json:"not_applicable,omitempty"`
}
type HASync_ManualSync struct {
	ManualSync *schema.Empty `protobuf:"bytes,3,opt,name=manual_sync,json=manualSync,proto3,oneof" json:"manual_sync,omitempty"`
}
type HASync_XcManagedSync struct {
	XcManagedSync *schema.Empty `protobuf:"bytes,4,opt,name=xc_managed_sync,json=xcManagedSync,proto3,oneof" json:"xc_managed_sync,omitempty"`
}

func (*HASync_NotApplicable) isHASync_SyncType() {}
func (*HASync_ManualSync) isHASync_SyncType()    {}
func (*HASync_XcManagedSync) isHASync_SyncType() {}

func (m *HASync) GetSyncType() isHASync_SyncType {
	if m != nil {
		return m.SyncType
	}
	return nil
...
func (m *HASync) GetNotApplicable() *schema.Empty {
	if x, ok := m.GetSyncType().(*HASync_NotApplicable); ok {
		return x.NotApplicable
	}
	return nil
}

func (m *HASync) GetManualSync() *schema.Empty {
	if x, ok := m.GetSyncType().(*HASync_ManualSync); ok {
		return x.ManualSync
	}
	return nil
}

func (m *HASync) GetXcManagedSync() *schema.Empty {
	if x, ok := m.GetSyncType().(*HASync_XcManagedSync); ok {
		return x.XcManagedSync
	}
	return nil
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*HASync) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*HASync_NotApplicable)(nil),
		(*HASync_ManualSync)(nil),
		(*HASync_XcManagedSync)(nil),
	}
}
...
func (*GetSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_1beabb40327c3d92, []int{34}
}
...
func init() {
	...
	proto.RegisterType((*HASync)(nil), "ves.io.schema.discovery.HASync")
	golang_proto.RegisterType((*HASync)(nil), "ves.io.schema.discovery.HASync")
...
var fileDescriptor_1beabb40327c3d92 = []byte{
	...
	,
}
...
func (this *CbipCluster) Equal(that interface{}) bool {
	...
	if !this.HaSync.Equal(that1.HaSync) {
		return false
	}
	return true
}
...
func (this *HASync) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HASync)
	if !ok {
		that2, ok := that.(HASync)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.SyncType == nil {
		if this.SyncType != nil {
			return false
		}
	} else if this.SyncType == nil {
		return false
	} else if !this.SyncType.Equal(that1.SyncType) {
		return false
	}
	return true
}
func (this *HASync_NotApplicable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HASync_NotApplicable)
	if !ok {
		that2, ok := that.(HASync_NotApplicable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.NotApplicable.Equal(that1.NotApplicable) {
		return false
	}
	return true
}
func (this *HASync_ManualSync) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HASync_ManualSync)
	if !ok {
		that2, ok := that.(HASync_ManualSync)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.ManualSync.Equal(that1.ManualSync) {
		return false
	}
	return true
}
func (this *HASync_XcManagedSync) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HASync_XcManagedSync)
	if !ok {
		that2, ok := that.(HASync_XcManagedSync)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.XcManagedSync.Equal(that1.XcManagedSync) {
		return false
	}
	return true
}
...
func (this *CbipCluster) GoString() string {
	...
	if this.HaSync != nil {
		s = append(s, "HaSync: "+fmt.Sprintf("%#v", this.HaSync)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *HASync) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&discovery.HASync{")
	if this.SyncType != nil {
		s = append(s, "SyncType: "+fmt.Sprintf("%#v", this.SyncType)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *HASync_NotApplicable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&discovery.HASync_NotApplicable{` +
		`NotApplicable:` + fmt.Sprintf("%#v", this.NotApplicable) + `}`}, ", ")
	return s
}
func (this *HASync_ManualSync) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&discovery.HASync_ManualSync{` +
		`ManualSync:` + fmt.Sprintf("%#v", this.ManualSync) + `}`}, ", ")
	return s
}
func (this *HASync_XcManagedSync) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&discovery.HASync_XcManagedSync{` +
		`XcManagedSync:` + fmt.Sprintf("%#v", this.XcManagedSync) + `}`}, ", ")
	return s
}
...
func (m *CbipCluster) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HaSync != nil {
		{
			size, err := m.HaSync.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HASync) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HASync) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HASync) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.SyncType != nil {
		{
			size := m.SyncType.Size()
			i -= size
			if _, err := m.SyncType.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *HASync_NotApplicable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HASync_NotApplicable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NotApplicable != nil {
		{
			size, err := m.NotApplicable.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HASync_ManualSync) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HASync_ManualSync) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ManualSync != nil {
		{
			size, err := m.ManualSync.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HASync_XcManagedSync) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HASync_XcManagedSync) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.XcManagedSync != nil {
		{
			size, err := m.XcManagedSync.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HASync_NotApplicable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.NotApplicable != nil {
		l = m.NotApplicable.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *HASync_ManualSync) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HASync_XcManagedSync) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *CbipCluster) String() string {
	...
	s := strings.Join([]string{`&CbipCluster{`,
		...
		`HaSync:` + strings.Replace(this.HaSync.String(), "HASync", "HASync", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *HASync) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HASync{`,
		`SyncType:` + fmt.Sprintf("%v", this.SyncType) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HASync_NotApplicable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HASync_NotApplicable{`,
		`NotApplicable:` + strings.Replace(fmt.Sprintf("%v", this.NotApplicable), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HASync_ManualSync) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HASync_ManualSync{`,
		`ManualSync:` + strings.Replace(fmt.Sprintf("%v", this.ManualSync), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HASync_XcManagedSync) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HASync_XcManagedSync{`,
		`XcManagedSync:` + strings.Replace(fmt.Sprintf("%v", this.XcManagedSync), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CbipCluster) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			if err := m.HaSync.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *HASync) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HASync: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HASync: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NotApplicable", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SyncType = &HASync_NotApplicable{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.SyncType = &HASync_ManualSync{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field XcManagedSync", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SyncType = &HASync_XcManagedSync{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
