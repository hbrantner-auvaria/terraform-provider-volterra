...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/service_policy_rule"
)
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_policy_rule.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_policy_rule.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_policy_rule.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_policy_rule.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.service_policy_rule.crudapi.API.Delete")
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        ...
        "/ves.io.schema.service_policy_rule/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.service_policy_rule.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.service_policy_rule/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.service_policy_rule.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.service_policy_rule/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.service_policy_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.service_policy_rule/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.service_policy_rule.crudapi.API.Create",
                "responses": {
                    "200": {
