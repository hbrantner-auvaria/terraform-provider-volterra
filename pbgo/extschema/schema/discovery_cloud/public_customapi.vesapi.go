...
func (c *CustomAPIGrpcClient) doRPCSuggestValues(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.discovery_cloud.SuggestValuesReq", yamlReq)
	}
...
func (c *CustomAPIRestClient) doRPCSuggestValues(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &SuggestValuesReq{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.discovery_cloud.SuggestValuesReq: %s", yamlReq, err)
	}
	...
	if err := codec.FromJSON(string(body), pbRsp); err != nil {
		return nil, errors.Wrapf(err, "JSON Response %s is not of type *ves.io.schema.discovery_cloud.SuggestValuesResp", body)
	}
...
func (c *customAPIInprocClient) SuggestValues(ctx context.Context, in *SuggestValuesReq, opts ...grpc.CallOption) (*SuggestValuesResp, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.discovery_cloud.CustomAPI.SuggestValues")
...
func (s *customAPISrv) SuggestValues(ctx context.Context, in *SuggestValuesReq) (*SuggestValuesResp, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.discovery_cloud.CustomAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.discovery_cloud.SuggestValuesReq", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomAPI.SuggestValues' operation on 'discovery_cloud'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.discovery_cloud.CustomAPI.SuggestValues"); rvFn != nil {
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.svc, "ves.io.schema.discovery_cloud.SuggestValuesResp", rsp)...)
...
var CustomAPISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Discovery Cloud Custom API",
        "description": "Custom API's for discovery cloud",
    ...
    "paths": {
        "/public/namespaces/{namespace}/suggest-values": {
            "post": {
                ...
                "operationId": "ves.io.schema.discovery_cloud.CustomAPI.SuggestValues",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudSuggestValuesResp"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudSuggestValuesReq"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-discovery_cloud-customapi-suggestvalues"
                },
                "x-ves-proto-rpc": "ves.io.schema.discovery_cloud.CustomAPI.SuggestValues"
            },
            "x-displayname": "Discovery Cloud Custom API",
            "x-ves-proto-service": "ves.io.schema.discovery_cloud.CustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PUBLIC"
        }
    },
    "definitions": {
        "discovery_cloudSuggestValuesReq": {
            "type": "object",
            "description": "Request body of SuggestValues request",
            "title": "SuggestValuesReq",
            "x-displayname": "Request for SuggestValues",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.SuggestValuesReq",
            "properties": {
                "field_path": {
                    "type": "string",
        ...
        "discovery_cloudSuggestValuesResp": {
            ...
            "properties": {
                "items": {
                    ...
                    "title": "item_lists",
                    "items": {
                        "$ref": "#/definitions/discovery_cloudSuggestedItem"
                    },
                    "x-displayname": "Suggested Items"
                }
            }
        },
        "discovery_cloudSuggestedItem": {
            "type": "object",
            ...
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.SuggestedItem",
            "properties": {
                "description": {
                    "type": "string",
    ...
    "x-ves-proto-file": "ves.io/schema/discovery_cloud/public_customapi.proto"
}`
