...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/discovery_clouds", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/discovery_clouds/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/discovery_clouds/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/discovery_clouds", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/discovery_clouds/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.discovery_cloud.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.discovery_cloud")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.discovery_cloud.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.discovery_cloud.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.discovery_cloud.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.discovery_cloud.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.discovery_cloud.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.discovery_cloud.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.discovery_cloud.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.discovery_cloud.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.discovery_cloud.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.discovery_cloud.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.discovery_cloud.API.Create' operation on 'discovery_cloud'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.discovery_cloud.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.discovery_cloud.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.discovery_cloud.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.discovery_cloud.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.discovery_cloud.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.discovery_cloud.API.Replace' operation on 'discovery_cloud'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.discovery_cloud.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.discovery_cloud.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.discovery_cloud.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.discovery_cloud.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.discovery_cloud.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.discovery_cloud.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.discovery_cloud.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.discovery_cloud.API.Delete' operation on 'discovery_cloud'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.discovery_cloud.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        ...
        "description": "Service discovery in the cloud",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/discovery_clouds": {
            "post": {
                "summary": "Create Discovery Cloud",
                "description": "API to create discovery_cloud object",
                "operationId": "ves.io.schema.discovery_cloud.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-discovery_cloud-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.discovery_cloud.API.Create"
            },
            "x-displayname": "Discovery Cloud",
            "x-ves-proto-service": "ves.io.schema.discovery_cloud.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/discovery_clouds/{metadata.name}": {
            "put": {
                "summary": "Replace Discovery Cloud",
                "description": "API to replace discovery_cloud object",
                "operationId": "ves.io.schema.discovery_cloud.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-discovery_cloud-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.discovery_cloud.API.Replace"
            },
            "x-displayname": "Discovery Cloud",
            "x-ves-proto-service": "ves.io.schema.discovery_cloud.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/discovery_clouds": {
            "get": {
                "summary": "List Discovery Cloud",
                "description": "List the set of discovery_cloud in a namespace",
                "operationId": "ves.io.schema.discovery_cloud.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-discovery_cloud-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.discovery_cloud.API.List"
            },
            "x-displayname": "Discovery Cloud",
            "x-ves-proto-service": "ves.io.schema.discovery_cloud.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/discovery_clouds/{name}": {
            "get": {
                "summary": "Get Discovery Cloud",
                "description": "API to Get discovery_cloud object",
                "operationId": "ves.io.schema.discovery_cloud.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-discovery_cloud-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.discovery_cloud.API.Get"
            },
            "delete": {
                "summary": "Delete Discovery Cloud",
                "description": "Delete the specified discovery_cloud",
                "operationId": "ves.io.schema.discovery_cloud.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/discovery_cloudDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-discovery_cloud-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.discovery_cloud.API.Delete"
            },
            "x-displayname": "Discovery Cloud",
            "x-ves-proto-service": "ves.io.schema.discovery_cloud.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        "discovery_cloudAwsDiscovery": {
            "type": "object",
            "description": "Discovery of services from Amazon Web Services (AWS)",
            "title": "AWS Discovery",
            "x-displayname": "AWS",
            "x-ves-oneof-field-access_info": "[\"cloud_user_account_ref\"]",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.AwsDiscovery",
            "properties": {
                "cloud_user_account_ref": {
                    "description": "Exclusive with []\n Cloud user account to discover services from\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "vpc_configs": {
                    "type": "array",
                    "description": " Configuration of Virtual Private Clouds (VPCs) to discover from\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 50\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Virtual Private Cloud (VPC) Configs",
                    "minItems": 1,
                    "maxItems": 50,
                    "items": {
                        "$ref": "#/definitions/discovery_cloudAwsVpcConfig"
                    },
                    "x-displayname": "VPCs",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "discovery_cloudAwsServiceTypeConfig": {
            "type": "object",
            "description": "Configuration for discovering a specific type of AWS service",
            "title": "AWS Service Type Config",
            "x-displayname": "AWS Service Type Config",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.AwsServiceTypeConfig",
            "properties": {
                "selector": {
                    "type": "string",
                    "description": " Service tag selector for selecting services to discovery. Uses kubernetes style label expression for selections.\n\nExample: - \"app in (svc1, svc2), env == prod\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.k8s_label_selector: true\n  ves.io.schema.rules.string.max_len: 4096\n",
                    "title": "Selector",
                    "maxLength": 4096,
                    "x-displayname": "Tags to match Service Type",
                    "x-ves-example": "app in (svc1, svc2), env == prod",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.string.k8s_label_selector": "true",
                        "ves.io.schema.rules.string.max_len": "4096"
                    }
        ...
        "discovery_cloudAwsVpcConfig": {
            "type": "object",
            "description": "Configuration for discovering services within an AWS virtual private cloud (VPC)",
            "title": "AWS VPC Config",
            "x-displayname": "AWS VPC Configuration",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.AwsVpcConfig",
            "properties": {
                "region": {
                ...
                "service_types": {
                    "type": "array",
                    "description": " Types of services to discover\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 50\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "Service Types",
                    "minItems": 1,
                    "maxItems": 50,
                    "items": {
                        "$ref": "#/definitions/discovery_cloudAwsServiceTypeConfig"
                    },
                ...
                "vpc_name": {
                    "type": "string",
                    "description": " Name of VPC to discover from\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "VPC Name",
                    "x-displayname": "VPC",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                ...
                "where": {
                    "description": " Where discovered service endpoints will be hosted",
                    "title": "Where",
                    "$ref": "#/definitions/discovery_cloudSiteSelector",
                    "x-displayname": "Site or vSite"
                }
            }
        },
        "discovery_cloudCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of discovery_cloud",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the discovery cloud",
                    "title": "spec",
                    "$ref": "#/definitions/discovery_cloudCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "discovery_cloudCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the discovery cloud",
                    "title": "spec",
                    "$ref": "#/definitions/discovery_cloudGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "discovery_cloudCreateSpecType": {
            "type": "object",
            "description": "API to create discovery_cloud object",
            "title": "Create discovery_cloud",
            "x-displayname": "Create Discovery Cloud",
            "x-ves-oneof-field-discovery_choice": "[\"aws_discovery\"]",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.CreateSpecType",
            "properties": {
                "aws_discovery": {
                    "description": "Exclusive with []\n Discovery of AWS services",
                    "$ref": "#/definitions/discovery_cloudAwsDiscovery",
                    "x-displayname": "AWS"
                }
            }
        },
        "discovery_cloudDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a discovery_cloud",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "discovery_cloudGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read discovery_cloud",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/discovery_cloudStatusObject"
                    },
        ...
        "discovery_cloudGetResponseFormatCode": {
            "type": "string",
        ...
        "discovery_cloudGetSpecType": {
            "type": "object",
            "description": "API to Get discovery_cloud object",
            "title": "Get discovery_cloud",
            "x-displayname": "Get Discovery Cloud",
            "x-ves-oneof-field-discovery_choice": "[\"aws_discovery\"]",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.GetSpecType",
            "properties": {
                "aws_discovery": {
                    "description": "Exclusive with []\n Discovery of AWS services",
                    "$ref": "#/definitions/discovery_cloudAwsDiscovery",
        ...
        "discovery_cloudListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of discovery_cloud",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/discovery_cloudListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "discovery_cloudListResponseItem": {
            "type": "object",
            "description": "By default a summary of discovery_cloud is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of discovery_cloud",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this discovery_cloud",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this discovery_cloud",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates discovery_cloud is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this discovery_cloud",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this discovery_cloud\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this discovery_cloud\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "discovery_cloudReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a discovery_cloud",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the discovery cloud",
                    "title": "spec",
                    "$ref": "#/definitions/discovery_cloudReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "discovery_cloudReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.ReplaceResponse"
        },
        "discovery_cloudReplaceSpecType": {
            "type": "object",
            "description": "API to replace discovery_cloud object",
            "title": "Replace discovery_cloud",
            "x-displayname": "Replace Discovery Cloud",
            "x-ves-oneof-field-discovery_choice": "[\"aws_discovery\"]",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.ReplaceSpecType",
            "properties": {
                "aws_discovery": {
                    "description": "Exclusive with []\n Discovery of AWS services",
                    "$ref": "#/definitions/discovery_cloudAwsDiscovery",
        ...
        "discovery_cloudSiteSelector": {
            "type": "object",
            "description": "SiteSelector defines a union of reference to site or reference to virtual_site\nIt used to refer site or a group of sites indicated by virtual site.",
            "title": "SiteSelector",
            "x-displayname": "Site or Virtual Site Reference",
            "x-ves-oneof-field-site_selector": "[\"site\",\"virtual_site\"]",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.SiteSelector",
            "properties": {
                "site": {
        ...
        "discovery_cloudStatusObject": {
            "type": "object",
            "description": "Status of discovery cloud object",
            "title": "Discovery Cloud Status Object",
            "x-displayname": "Discovery Cloud Status",
            "x-ves-proto-message": "ves.io.schema.discovery_cloud.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                    "description": " Current state of discovery cloud",
                    "title": "conditions",
                    "items": {
    ...
    "x-displayname": "Discovery Cloud",
    "x-ves-proto-file": "ves.io/schema/discovery_cloud/public_crudapi.proto"
}`
