...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/srv6_network_slice"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.srv6_network_slice.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.srv6_network_slice.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.srv6_network_slice.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.srv6_network_slice.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.srv6_network_slice.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.srv6_network_slice.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.srv6_network_slice.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.srv6_network_slice.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.srv6_network_slice.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.srv6_network_slice.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/srv6_network_slice/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.srv6_network_slice/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-srv6_network_slice-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.srv6_network_slice.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-srv6_network_slice-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.srv6_network_slice.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-srv6_network_slice-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.srv6_network_slice.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "srv6_network_slice",
            "x-ves-object-type": "ves.io.schema.srv6_network_slice.Object",
            "x-ves-proto-service": "ves.io.schema.srv6_network_slice.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.srv6_network_slice/Objects": {
            "get": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-srv6_network_slice-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.srv6_network_slice.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-srv6_network_slice-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.srv6_network_slice.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "srv6_network_slice",
            "x-ves-object-type": "ves.io.schema.srv6_network_slice.Object",
        ...
        "/ves.io.schema.srv6_network_slice/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-srv6_network_slice-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.srv6_network_slice.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "srv6_network_slice",
            "x-ves-object-type": "ves.io.schema.srv6_network_slice.Object",
        ...
        "/ves.io.schema.srv6_network_slice/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.srv6_network_slice/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.srv6_network_slice/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.srv6_network_slice/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.srv6_network_slice.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/srv6_network_sliceSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/srv6_network_slicecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/srv6_network_slicecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/srv6_network_sliceStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/srv6_network_slicecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/srv6_network_slicecrudapiErrorCode"
                },
        ...
        "schemasrv6_network_sliceGlobalSpecType": {
            "type": "object",
            "description": "Shape of srv6_network_slice in the storage backend.",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.GlobalSpecType",
            "properties": {
                "connect_to_access_networks": {
                    "type": "boolean",
                    "description": " Connect all SRv6 Virtual Networks in this slice to their corresponding access networks by importing route\n targets specified in the virtual network.",
                    "title": "connect_to_access_networks",
                    "format": "boolean",
                    "x-displayname": "Connect To Access Networks"
                },
                "connect_to_enterprise_networks": {
                    "type": "boolean",
                    "description": " Connect all SRv6 Virtual Networks in this slice to their corresponding enterprise networks by importing route\n targets specified in the virtual network.",
                    "title": "connect_to_enterprise_networks",
                    "format": "boolean",
                    "x-displayname": "Connect To Enterprise Networks"
                },
                "connect_to_internet": {
                    "type": "boolean",
                    "description": " Connect all SRv6 Virtual Networks in this slice to the Internet by importing route targets specified in the\n virtual network.",
                    "title": "connect_to_internet",
                    "format": "boolean",
                    "x-displayname": "Connect To Internet"
                },
                "sid_prefixes": {
                    "type": "array",
                    "description": " A SID Locator from the prefix is allocated automatically for each node in each site.\n\nExample: - \"cafe:f00d::0/32\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.ipv6_prefix: true\n  ves.io.schema.rules.repeated.items.string.max_ip_prefix_length: 32\n  ves.io.schema.rules.repeated.items.string.min_ip_prefix_length: 32\n  ves.io.schema.rules.repeated.max_items: 1\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "sid_prefixes",
                    "minItems": 1,
                    "maxItems": 1,
                    "items": {
        ...
        "srv6_network_sliceSpecType": {
            "type": "object",
            "description": "Shape of the srv6_network_slice specification",
            "title": "specification for srv6_network_slice",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemasrv6_network_sliceGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "srv6_network_sliceStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for srv6_network_slice",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.srv6_network_slice.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "srv6_network_slicecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.srv6_network_slice.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/srv6_network_slice/crudapi/api.proto"
}`
