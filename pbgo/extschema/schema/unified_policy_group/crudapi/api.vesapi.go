...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/unified_policy_group"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.unified_policy_group.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.unified_policy_group.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.unified_policy_group.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.unified_policy_group.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.unified_policy_group.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.unified_policy_group.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.unified_policy_group.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.unified_policy_group.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.unified_policy_group.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.unified_policy_group.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/unified_policy_group/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.unified_policy_group/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-crudapi-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-crudapi-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-crudapi-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "unified_policy_group",
            "x-ves-object-type": "ves.io.schema.unified_policy_group.Object",
            "x-ves-proto-service": "ves.io.schema.unified_policy_group.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.unified_policy_group/Objects": {
            "get": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-crudapi-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-crudapi-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "unified_policy_group",
            "x-ves-object-type": "ves.io.schema.unified_policy_group.Object",
        ...
        "/ves.io.schema.unified_policy_group/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-unified_policy_group-crudapi-api-liststream"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.unified_policy_group.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "unified_policy_group",
            "x-ves-object-type": "ves.io.schema.unified_policy_group.Object",
        ...
        "/ves.io.schema.unified_policy_group/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.unified_policy_group/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.unified_policy_group/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.unified_policy_group/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.unified_policy_group.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/unified_policy_groupSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/unified_policy_groupcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/unified_policy_groupcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/unified_policy_groupStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/unified_policy_groupcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/unified_policy_groupcrudapiErrorCode"
                },
        ...
        "policyActiveEnhancedFirewallPoliciesType": {
            "type": "object",
            ...
            "x-ves-proto-message": "ves.io.schema.policy.ActiveEnhancedFirewallPoliciesType",
            "properties": {
                "enhanced_firewall_policies": {
                    "type": "array",
                    "description": " Ordered List of Enhaned Firewall Policies\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 128\n  ves.io.schema.rules.repeated.min_items: 1\n",
        ...
        "policyActiveServicePoliciesType": {
            "type": "object",
            "description": "Active service policies for the proxy",
            "title": "Active Service Policies",
            "x-displayname": "Active Service Policies",
            "x-ves-proto-message": "ves.io.schema.policy.ActiveServicePoliciesType",
            "properties": {
                "service_policies": {
                    "type": "array",
        ...
        "policySecurityPoliciesType": {
            "type": "object",
            "description": "Security Policies",
            "title": "Security Policies",
            "x-displayname": "Security Policies",
            "x-ves-oneof-field-firewall_policy_choice": "[\"active_enhanced_firewall_policies\",\"no_firewall_policy\"]",
            "x-ves-oneof-field-forward_proxy_choice": "[\"active_forward_proxy_policies\",\"active_service_policies\",\"no_forward_proxy\"]",
            "x-ves-proto-message": "ves.io.schema.policy.SecurityPoliciesType",
            "properties": {
                "active_enhanced_firewall_policies": {
                    "description": "Exclusive with [no_firewall_policy]\n",
                    "title": "Manage Enhanced Firewall Policy",
                    "$ref": "#/definitions/policyActiveEnhancedFirewallPoliciesType",
                    "x-displayname": "Enable Enhanced Firewall Policies"
                },
                "active_forward_proxy_policies": {
                    "description": "Exclusive with [active_service_policies no_forward_proxy]\n",
                    "title": "Enable Forward Proxy and Manage Policies",
                    "$ref": "#/definitions/policyActiveForwardProxyPoliciesType",
                ...
                "active_service_policies": {
                    ...
                    "title": "Enable Service Policy",
                    "$ref": "#/definitions/policyActiveServicePoliciesType",
                    "x-displayname": "Enable Service Policies"
                },
                "no_firewall_policy": {
                    "description": "Exclusive with [active_enhanced_firewall_policies]\n",
                    "title": "Disable Firewall Policy",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Disable Enhanced Firewall Policies"
                },
                "no_forward_proxy": {
                    "description": "Exclusive with [active_forward_proxy_policies active_service_policies]\n",
        ...
        "schemaunified_policy_groupGlobalSpecType": {
            "type": "object",
            "description": "Shape of unified_policy_group specification",
            "title": "GlobalSpecType",
            "x-displayname": "Specification",
            "x-ves-displayorder": "3,4",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.GlobalSpecType",
            "properties": {
                "east_west_policy": {
                    "description": " Manage policies for inter and intra segment traffic",
                    "title": "East West Policies",
                    "$ref": "#/definitions/unified_policy_groupEastWestPolicyType",
                    "x-displayname": "East West Policies"
                },
                "internet_policy": {
                    "description": " Manage policies internet traffic",
                    "title": "Internet Policies",
                    "$ref": "#/definitions/unified_policy_groupInternetPolicyType",
        ...
        "unified_policy_groupEastWestPolicyType": {
            "type": "object",
            "description": "Policies applied for connections between different segments",
            "title": "East West Policy Type",
            "x-displayname": "East West Policy Type",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.EastWestPolicyType",
            "properties": {
                "policies": {
                    "title": "Policies",
                    "$ref": "#/definitions/policySecurityPoliciesType",
                    "x-displayname": "Policies"
                }
            }
        },
        "unified_policy_groupInternetPolicyType": {
            "type": "object",
            "description": "Policies that will apply when segments connect to internet",
            "title": "Internet Policy Type",
            "x-displayname": "Internet Policy Type",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.InternetPolicyType",
            "properties": {
                "policies": {
                    "title": "Policies",
                    "$ref": "#/definitions/policySecurityPoliciesType",
        ...
        "unified_policy_groupSpecType": {
            "type": "object",
            "description": "Shape of the unified_policy_group specification",
            "title": "Specification of Unified Policy Group",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemaunified_policy_groupGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "unified_policy_groupStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of Unified Policy Group",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.unified_policy_group.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "unified_policy_groupcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.unified_policy_group.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/unified_policy_group/crudapi/api.proto"
}`
