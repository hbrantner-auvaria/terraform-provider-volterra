...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/known_label"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.known_label.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.known_label.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.known_label.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.known_label.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.known_label.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.known_label.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.known_label.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.known_label.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.known_label.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.known_label.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.known_label.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.known_label.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.known_label.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.known_label.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.known_label.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.known_label.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.known_label.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.known_label.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/known_label/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.known_label/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.known_label.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-known_label-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.known_label.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.known_label.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-known_label-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.known_label.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.known_label.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-known_label-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.known_label.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "known_label",
            "x-ves-object-type": "ves.io.schema.known_label.Object",
            "x-ves-proto-service": "ves.io.schema.known_label.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.known_label/Objects": {
            "get": {
                "operationId": "ves.io.schema.known_label.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-known_label-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.known_label.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.known_label.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-known_label-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.known_label.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "known_label",
            "x-ves-object-type": "ves.io.schema.known_label.Object",
        ...
        "/ves.io.schema.known_label/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.known_label.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-known_label-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.known_label.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "known_label",
            "x-ves-object-type": "ves.io.schema.known_label.Object",
        ...
        "/ves.io.schema.known_label/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.known_label.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.known_label/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.known_label.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.known_label/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.known_label.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.known_label/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.known_label.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.known_label.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/known_labelSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.known_label.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/known_labelcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.known_label.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/known_labelcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.known_label.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/known_labelStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.known_label.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/known_labelcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.known_label.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.known_label.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.known_label.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/known_labelcrudapiErrorCode"
                },
        ...
        "known_labelGlobalSpecType": {
            "type": "object",
            "description": "Global specification, not exposed to customers",
            "title": "Global Specifications",
            "x-displayname": "Global Specifications",
            "x-ves-proto-message": "ves.io.schema.known_label.GlobalSpecType",
            "properties": {
                "key_ref": {
                    "type": "array",
                    "description": " Link to the corresponding known_label_key object. Created internally",
                    "title": "Reference to known label key",
                    "items": {
                        "$ref": "#/definitions/schemaObjectRefType"
                    },
                    "x-displayname": "Reference to Known Label Key"
                }
            }
        },
        "known_labelSpecType": {
            "type": "object",
            "description": "Shape of the known label specification. This not exposed to customers",
            "title": "Specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.known_label.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/known_labelGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "known_labelStatusObject": {
            "type": "object",
            "description": "Most recently observed status of the object",
            "title": "Status for Known Label",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.known_label.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "known_labelcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.known_label.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/known_label/crudapi/api.proto"
}`
