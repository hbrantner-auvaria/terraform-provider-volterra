...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/fast_acl_set"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.fast_acl_set.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.fast_acl_set.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.fast_acl_set.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.fast_acl_set.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.fast_acl_set.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.fast_acl_set.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.fast_acl_set.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.fast_acl_set.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.fast_acl_set.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.fast_acl_set.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.fast_acl_set.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.fast_acl_set.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.fast_acl_set.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.fast_acl_set.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/fast_acl_set/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.fast_acl_set/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-fast_acl_set-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-fast_acl_set-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-fast_acl_set-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "fast_acl_set",
            "x-ves-object-type": "ves.io.schema.fast_acl_set.Object",
            "x-ves-proto-service": "ves.io.schema.fast_acl_set.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.fast_acl_set/Objects": {
            "get": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-fast_acl_set-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-fast_acl_set-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "fast_acl_set",
            "x-ves-object-type": "ves.io.schema.fast_acl_set.Object",
        ...
        "/ves.io.schema.fast_acl_set/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-fast_acl_set-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.fast_acl_set.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "fast_acl_set",
            "x-ves-object-type": "ves.io.schema.fast_acl_set.Object",
        ...
        "/ves.io.schema.fast_acl_set/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.fast_acl_set/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.fast_acl_set/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.fast_acl_set/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.fast_acl_set.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/fast_acl_setcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/fast_acl_setcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/fast_acl_setStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/fast_acl_setcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/fast_acl_setcrudapiErrorCode"
                },
        ...
        "fast_acl_setSpecType": {
            "type": "object",
            "description": "Shape of the Fast ACL Set specification",
            "title": "Fast ACL set specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.fast_acl_set.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/fast_acl_setGlobalSpecType",
        ...
        "fast_acl_setcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.fast_acl_set.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/fast_acl_set/crudapi/api.proto"
}`
