...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/cloud_credentials"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.cloud_credentials.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.cloud_credentials.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.cloud_credentials.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_credentials.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_credentials.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_credentials.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_credentials.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cloud_credentials.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.cloud_credentials.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.cloud_credentials.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_credentials.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_credentials.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_credentials.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_credentials.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_credentials.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_credentials.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cloud_credentials.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cloud_credentials.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/cloud_credentials/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.cloud_credentials/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_credentials-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_credentials.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_credentials-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_credentials.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_credentials-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_credentials.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cloud_credentials",
            "x-ves-object-type": "ves.io.schema.cloud_credentials.Object",
            "x-ves-proto-service": "ves.io.schema.cloud_credentials.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.cloud_credentials/Objects": {
            "get": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_credentials-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.cloud_credentials.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_credentials-crudapi-api-create"
                },
        ...
        "/ves.io.schema.cloud_credentials/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cloud_credentials-crudapi-api-liststream"
                },
        ...
        "/ves.io.schema.cloud_credentials/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_credentials/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_credentials/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cloud_credentials/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.cloud_credentials.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "cloud_credentialsAWSSecretType": {
            ...
            "title": "AWS Programmatic Access Credentials type",
            "x-displayname": "AWS Programmatic Access Credentials",
            "x-ves-displayorder": "1,2",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.AWSSecretType",
            "properties": {
                "access_key": {
                    "type": "string",
        ...
        "cloud_credentialsAzurePfxType": {
            "type": "object",
            "description": "Azure Credentials Client Certificate type",
            "title": "Azure Credential Client Certificate type",
            "x-displayname": "Client Certificate",
            "x-ves-displayorder": "1,2,3,4,5",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.AzurePfxType",
            "properties": {
                "certificate_url": {
                    "type": "string",
                ...
                "password": {
                    "description": " Password for your '.p12' or '.pfx' file whose certificate is linked to service principal object\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Azure Client Certificate password",
                    "$ref": "#/definitions/schemaSecretType",
        ...
        "cloud_credentialsAzureSecretType": {
            "type": "object",
            "description": "Azure Credentials Client Secret type",
            "title": "Azure Credential Client Secret type",
            "x-displayname": "Azure Client Secret",
            "x-ves-displayorder": "1,2,3,4",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.AzureSecretType",
            "properties": {
                "client_id": {
                    "type": "string",
                    "description": " Client ID for your Azure service principal\n\nExample: - \"value\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 64\n",
        ...
        "cloud_credentialsGCPCredFileType": {
            "type": "object",
            "description": "GCP Credentials type",
            "title": "GCP Credentials type",
            "x-displayname": "GCP Credentials",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.GCPCredFileType",
            "properties": {
                "credential_file": {
                    "description": " Content of Credential File for your GCP account\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "GCP credential file",
                    "$ref": "#/definitions/schemaSecretType",
                    "x-displayname": "GCP Credentials",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "cloud_credentialsGlobalSpecType": {
            "type": "object",
        ...
        "cloud_credentialsSpecType": {
            "type": "object",
            "description": "Shape of the cloud_credentials specification",
            "title": "Specification for Cloud Credentials object",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.SpecType",
            "properties": {
                "gc_spec": {
                    "description": " desired state of cloud_credentials",
                    "title": "gc_spec",
                    "$ref": "#/definitions/cloud_credentialsGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "cloud_credentialsStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Cloud Credentials Status Object",
            "x-displayname": "Cloud Credentials Status",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "cloud_credentialscrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.cloud_credentials.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/cloud_credentialsSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cloud_credentials.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/cloud_credentials/crudapi/api.proto"
}`
