...
const (
	...
	CreateRequestFQN = "ves.io.schema.site_segment_static_routes.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.site_segment_static_routes.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.site_segment_static_routes.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.site_segment_static_routes.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.site_segment_static_routes.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.site_segment_static_routes.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.site_segment_static_routes.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.site_segment_static_routes.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.site_segment_static_routes.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.site_segment_static_routes.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/site_segment_static_routess", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/site_segment_static_routess/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/site_segment_static_routess/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/site_segment_static_routess", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/site_segment_static_routess/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.site_segment_static_routes.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.site_segment_static_routes")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.site_segment_static_routes.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.site_segment_static_routes.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.site_segment_static_routes.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.site_segment_static_routes.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.site_segment_static_routes.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.site_segment_static_routes.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.site_segment_static_routes.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.site_segment_static_routes.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.site_segment_static_routes.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.site_segment_static_routes.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.site_segment_static_routes.API.Create' operation on 'site_segment_static_routes'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.site_segment_static_routes.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.site_segment_static_routes.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.site_segment_static_routes.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.site_segment_static_routes.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.site_segment_static_routes.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.site_segment_static_routes.API.Replace' operation on 'site_segment_static_routes'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.site_segment_static_routes.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.site_segment_static_routes.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.site_segment_static_routes.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.site_segment_static_routes.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.site_segment_static_routes.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.site_segment_static_routes.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.site_segment_static_routes.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.site_segment_static_routes.API.Delete' operation on 'site_segment_static_routes'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Site Segment Static Routes object",
        "description": "Siste Segment Static Routes is the child object created for holding the static routes per segment per site",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/site_segment_static_routess": {
            "post": {
                "summary": "Create Site Segment Static Routes",
                "description": "Create Site Segment Static Routes\nchild object",
                "operationId": "ves.io.schema.site_segment_static_routes.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/site_segment_static_routesCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/site_segment_static_routesCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-site_segment_static_routes-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.site_segment_static_routes.API.Create"
            },
            "x-displayname": "Site Segment Static Routes",
            "x-ves-proto-service": "ves.io.schema.site_segment_static_routes.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/site_segment_static_routess/{metadata.name}": {
            "put": {
                "summary": "Replace Site Segment Static Routes",
                "description": "Replace Site Segment Static Routes\nchild object",
                "operationId": "ves.io.schema.site_segment_static_routes.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/site_segment_static_routesReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/site_segment_static_routesReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-site_segment_static_routes-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.site_segment_static_routes.API.Replace"
            },
            "x-displayname": "Site Segment Static Routes",
            "x-ves-proto-service": "ves.io.schema.site_segment_static_routes.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/site_segment_static_routess": {
            "get": {
                "summary": "List Site Segment Static Routes",
                "description": "List the set of site_segment_static_routes in a namespace",
                "operationId": "ves.io.schema.site_segment_static_routes.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/site_segment_static_routesListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    {
                        "name": "namespace",
                        "description": "namespace\n\nx-example: \"ns1\"\nNamespace to scope the listing of site_segment_static_routes",
                        "in": "path",
                        "required": true,
                        "type": "string",
                        "x-displayname": "Namespace"
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-site_segment_static_routes-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.site_segment_static_routes.API.List"
            },
            "x-displayname": "Site Segment Static Routes",
            "x-ves-proto-service": "ves.io.schema.site_segment_static_routes.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/site_segment_static_routess/{name}": {
            "get": {
                "summary": "Get Site Segment Static Routes",
                "description": "Gets Site Segment Static Routes\nchild object",
                "operationId": "ves.io.schema.site_segment_static_routes.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/site_segment_static_routesGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-site_segment_static_routes-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.site_segment_static_routes.API.Get"
            },
            "delete": {
                "summary": "Delete Site Segment Static Routes",
                "description": "Delete the specified site_segment_static_routes",
                "operationId": "ves.io.schema.site_segment_static_routes.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/site_segment_static_routesDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-site_segment_static_routes-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.site_segment_static_routes.API.Delete"
            },
            "x-displayname": "Site Segment Static Routes",
            "x-ves-proto-service": "ves.io.schema.site_segment_static_routes.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "schemasite_segment_static_routesCreateSpecType": {
            "type": "object",
            "description": "Create Site Segment Static Routes\nchild object",
            "title": "Create Site Segment Static Routes",
            "x-displayname": "Create Site Segment Static Routes",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.CreateSpecType",
            "properties": {
                "nameserver_v4": {
                    "type": "string",
                ...
                "static_v6_routes": {
                    "type": "array",
                    "description": " List of IPV6 static routes on the Site\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 165\n  ves.io.schema.rules.repeated.unique: true\n",
                    "maxItems": 165,
                    "items": {
                        "$ref": "#/definitions/schemaStaticRouteType"
                    },
        ...
        "schemasite_segment_static_routesGetSpecType": {
            "type": "object",
            "description": "Gets Site Segment Static Routes\nchild object",
            "title": "Get Site Segment Static Routes",
            "x-displayname": "Get Site Segment Static Routes",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.GetSpecType",
            "properties": {
                "nameserver_v4": {
                    "type": "string",
                    "description": " Optional IPv4 DNS server to be used for name resolution\n\nExample: - \"10.1.1.1\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.ipv4: true\n",
        ...
        "schemasite_segment_static_routesReplaceSpecType": {
            "type": "object",
            "description": "Replace Site Segment Static Routes\nchild object",
            "title": "Replace Site Segment Static Routes",
            "x-displayname": "Replace Site Segment Static Routes",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.ReplaceSpecType",
            "properties": {
                "nameserver_v4": {
                    "type": "string",
                    "description": " Optional IPv4 DNS server to be used for name resolution\n\nExample: - \"10.1.1.1\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.ipv4: true\n",
        ...
        "site_segment_static_routesCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of site_segment_static_routes",
            "x-displayname": "Create Request",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.CreateRequest",
            "properties": {
                "metadata": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Site Segment Static Routes",
                    "title": "spec",
                    "$ref": "#/definitions/schemasite_segment_static_routesCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "site_segment_static_routesCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
        ...
        "site_segment_static_routesDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a site_segment_static_routes",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "site_segment_static_routesGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read site_segment_static_routes",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.GetResponse",
            "properties": {
                "create_form": {
        ...
        "site_segment_static_routesListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of site_segment_static_routes",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/site_segment_static_routesListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "site_segment_static_routesListResponseItem": {
            "type": "object",
            "description": "By default a summary of site_segment_static_routes is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of site_segment_static_routes",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this site_segment_static_routes",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this site_segment_static_routes",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates site_segment_static_routes is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this site_segment_static_routes",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this site_segment_static_routes\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this site_segment_static_routes\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "site_segment_static_routesReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a site_segment_static_routes",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.site_segment_static_routes.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the Site Segment Static Routes",
                    "title": "spec",
                    "$ref": "#/definitions/schemasite_segment_static_routesReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
    ...
    "x-displayname": "Site Segment Static Routes",
    "x-ves-proto-file": "ves.io/schema/site_segment_static_routes/public_crudapi.proto"
}`
