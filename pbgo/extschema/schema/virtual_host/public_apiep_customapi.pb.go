...
// APIEPDiscoverySource
//
// x-displayName: "API Endpoint Discovery Source"
// API Endpoint Discovery Source
type APIEPDiscoverySource int32

const (
	// x-displayName: "Merged Sources"
	// Merging all source types to one spec
	MERGED APIEPDiscoverySource = 0
	// x-displayName: "Traffic"
	// Discovery spec from traffic data
	TRAFFIC APIEPDiscoverySource = 1
	// x-displayName: "Crawler"
	// Discovery spec from crawler engine
	CRAWLER APIEPDiscoverySource = 2
	// x-displayName: "Code Scan"
	// Discovery spec from code scan
	CODE_SCAN APIEPDiscoverySource = 3
)

var APIEPDiscoverySource_name = map[int32]string{
	0: "MERGED",
	1: "TRAFFIC",
	2: "CRAWLER",
	3: "CODE_SCAN",
...
var APIEPDiscoverySource_value = map[string]int32{
	"MERGED":    0,
	"TRAFFIC":   1,
	"CRAWLER":   2,
	"CODE_SCAN": 3,
...
func (APIEPDiscoverySource) EnumDescriptor() ([]byte, []int) {
...
// API endpoint open-api request Per Virtual Host for specific sources
//
// x-displayName: "API endpoint Open API Schema request per source"
// shape of request to get API endpoint Open API Schema request for specific sources
type APIEPSourceOpenApiSchemaReq struct {
	// Namespace
	//
	// x-displayName: "Namespace"
	// x-example: "blogging-app"
	...
	//
	// x-displayName: "Discovery Source Types"
	// List of wanted discovery source types
	DiscoverySourceTypes []APIEPDiscoverySource `protobuf:"varint,4,rep,packed,name=discovery_source_types,json=discoverySourceTypes,proto3,enum=ves.io.schema.virtual_host.APIEPDiscoverySource" json:"discovery_source_types,omitempty"`
}

func (m *APIEPSourceOpenApiSchemaReq) Reset()      { *m = APIEPSourceOpenApiSchemaReq{} }
func (*APIEPSourceOpenApiSchemaReq) ProtoMessage() {}
func (*APIEPSourceOpenApiSchemaReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ff43449ad67ea61, []int{11}
}
func (m *APIEPSourceOpenApiSchemaReq) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *APIEPSourceOpenApiSchemaReq) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_APIEPSourceOpenApiSchemaReq.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *APIEPSourceOpenApiSchemaReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_APIEPSourceOpenApiSchemaReq.Merge(m, src)
}
func (m *APIEPSourceOpenApiSchemaReq) XXX_Size() int {
	return m.Size()
}
func (m *APIEPSourceOpenApiSchemaReq) XXX_DiscardUnknown() {
	xxx_messageInfo_APIEPSourceOpenApiSchemaReq.DiscardUnknown(m)
}

var xxx_messageInfo_APIEPSourceOpenApiSchemaReq proto.InternalMessageInfo

func (m *APIEPSourceOpenApiSchemaReq) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *APIEPSourceOpenApiSchemaReq) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *APIEPSourceOpenApiSchemaReq) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *APIEPSourceOpenApiSchemaReq) GetDiscoverySourceTypes() []APIEPDiscoverySource {
	if m != nil {
		return m.DiscoverySourceTypes
	}
	return nil
}

// APIEPSourceOpenApiSchemaRsp GET response
//
// x-displayName: "API endpoint Open API Schema per sources response"
// shape of response to get API endpoint Open API Schema request for specific sources
type APIEPSourceOpenApiSchemaRsp struct {
	// API Specifications
	//
	// x-displayName: "API Specifications"
	// Discovered API Specifications based on discovery Source.
...
func (m *APIEPSourceOpenApiSchemaRsp) Reset()      { *m = APIEPSourceOpenApiSchemaRsp{} }
func (*APIEPSourceOpenApiSchemaRsp) ProtoMessage() {}
func (*APIEPSourceOpenApiSchemaRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ff43449ad67ea61, []int{12}
}
func (m *APIEPSourceOpenApiSchemaRsp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *APIEPSourceOpenApiSchemaRsp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_APIEPSourceOpenApiSchemaRsp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *APIEPSourceOpenApiSchemaRsp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_APIEPSourceOpenApiSchemaRsp.Merge(m, src)
}
func (m *APIEPSourceOpenApiSchemaRsp) XXX_Size() int {
	return m.Size()
}
func (m *APIEPSourceOpenApiSchemaRsp) XXX_DiscardUnknown() {
	xxx_messageInfo_APIEPSourceOpenApiSchemaRsp.DiscardUnknown(m)
}

var xxx_messageInfo_APIEPSourceOpenApiSchemaRsp proto.InternalMessageInfo

func (m *APIEPSourceOpenApiSchemaRsp) GetApiSpecs() map[string]string {
	if m != nil {
		return m.ApiSpecs
	}
	return nil
...
// Unmerge certain endpoint source
//
// x-displayName: "Unmerge Source from endpoint"
// Unmerge Source from endpoint
type UnmergeAPIEPSourceOpenApiSchemaReq struct {
	// Namespace
	//
	// x-displayName: "Namespace"
	// x-example: "blogging-app"
	...
	// Wanted discovery source type
	DiscoverySourceType APIEPDiscoverySource `protobuf:"varint,4,opt,name=discovery_source_type,json=discoverySourceType,proto3,enum=ves.io.schema.virtual_host.APIEPDiscoverySource" json:"discovery_source_type,omitempty"`
}

func (m *UnmergeAPIEPSourceOpenApiSchemaReq) Reset()      { *m = UnmergeAPIEPSourceOpenApiSchemaReq{} }
func (*UnmergeAPIEPSourceOpenApiSchemaReq) ProtoMessage() {}
func (*UnmergeAPIEPSourceOpenApiSchemaReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ff43449ad67ea61, []int{13}
}
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UnmergeAPIEPSourceOpenApiSchemaReq.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnmergeAPIEPSourceOpenApiSchemaReq.Merge(m, src)
}
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) XXX_Size() int {
	return m.Size()
}
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) XXX_DiscardUnknown() {
	xxx_messageInfo_UnmergeAPIEPSourceOpenApiSchemaReq.DiscardUnknown(m)
}

var xxx_messageInfo_UnmergeAPIEPSourceOpenApiSchemaReq proto.InternalMessageInfo

func (m *UnmergeAPIEPSourceOpenApiSchemaReq) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) GetDiscoverySourceType() APIEPDiscoverySource {
	if m != nil {
		return m.DiscoverySourceType
	}
	return MERGED
}
...
type APIEndpointsRsp struct {
	...
	// The API endpoints Last Update timestamp indicates most recent update of API endpoints happened
	// The API Discovery periodically updates the API endpoints list based on application's traffic
	LastUpdate *types.Timestamp `protobuf:"bytes,2,opt,name=last_update,json=lastUpdate,proto3" json:"last_update,omitempty"`
}
...
func (m *APIEndpointsRsp) GetLastUpdate() *types.Timestamp {
	if m != nil {
		return m.LastUpdate
	}
	return nil
...
type Vulnerability struct {
	...
	OwaspCategories []*schema.OwaspCategory `protobuf:"bytes,16,rep,name=owasp_categories,json=owaspCategories,proto3" json:"owasp_categories,omitempty"`
	// objects
	//
	// x-displayName: "Objects"
	// x-example: ["/documents/group/{dyn}"]
	// Objects which the vulnerability refers to
	Objects []string `protobuf:"bytes,17,rep,name=objects,proto3" json:"objects,omitempty"`
	// object_type
	//
	// x-displayName: "Object Type"
	// x-example: "Cookie"
	// Type of the objects which the vulnerability refers to
	ObjectType string `protobuf:"bytes,18,opt,name=object_type,json=objectType,proto3" json:"object_type,omitempty"`
}
...
func (m *Vulnerability) GetOwaspCategories() []*schema.OwaspCategory {
	if m != nil {
		return m.OwaspCategories
	}
	return nil
}

func (m *Vulnerability) GetObjects() []string {
	if m != nil {
		return m.Objects
	}
	return nil
...
func (m *Vulnerability) GetObjectType() string {
	if m != nil {
		return m.ObjectType
	}
	return ""
...
type VulnEvidence struct {
	...
	Samples []*VulnEvidenceSample `protobuf:"bytes,1,rep,name=samples,proto3" json:"samples,omitempty"` // Deprecated: Do not use.
	// start_time
	//
	// x-displayName: "Start Time"
	...
	EvidenceType VulnEvidenceType `protobuf:"varint,3,opt,name=evidence_type,json=evidenceType,proto3,enum=ves.io.schema.virtual_host.VulnEvidenceType" json:"evidence_type,omitempty"` // Deprecated: Do not use.
	// end_time
	//
	// x-displayName: "End Time"
	...
	// UUID of the evidence document stored in ElasticSearch
	...
	// List of security incident IDs that triggered this vulnerability.
	// Populated only for incident-based vulnerabilities
	// Empty for request-based vulnerabilities.
	IncidentIds []string `protobuf:"bytes,6,rep,name=incident_ids,json=incidentIds,proto3" json:"incident_ids,omitempty"`
	// message
	//
	// x-displayName: "Message"
	// x-example: "References to Broken Function Level Authorization Incident"
	// Vulnerability message derived from a security incident
...
func (m *VulnEvidence) GetEvidenceId() string {
	if m != nil {
		return m.EvidenceId
	}
	return ""
...
func (m *VulnEvidence) GetIncidentIds() []string {
	if m != nil {
...
func (m *VulnEvidence) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (*VulnEvidenceSample) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ff43449ad67ea61, []int{41}
}
...
func (*UpdateVulnerabilitiesStateReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ff43449ad67ea61, []int{42}
}
...
func (*UpdateVulnerabilitiesStateRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ff43449ad67ea61, []int{43}
}
...
func init() {
	...
	proto.RegisterEnum("ves.io.schema.virtual_host.APIEPDiscoverySource", APIEPDiscoverySource_name, APIEPDiscoverySource_value)
	golang_proto.RegisterEnum("ves.io.schema.virtual_host.APIEPDiscoverySource", APIEPDiscoverySource_name, APIEPDiscoverySource_value)
	...
	proto.RegisterType((*APIEPSourceOpenApiSchemaReq)(nil), "ves.io.schema.virtual_host.APIEPSourceOpenApiSchemaReq")
	golang_proto.RegisterType((*APIEPSourceOpenApiSchemaReq)(nil), "ves.io.schema.virtual_host.APIEPSourceOpenApiSchemaReq")
	proto.RegisterType((*APIEPSourceOpenApiSchemaRsp)(nil), "ves.io.schema.virtual_host.APIEPSourceOpenApiSchemaRsp")
	golang_proto.RegisterType((*APIEPSourceOpenApiSchemaRsp)(nil), "ves.io.schema.virtual_host.APIEPSourceOpenApiSchemaRsp")
	proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.virtual_host.APIEPSourceOpenApiSchemaRsp.ApiSpecsEntry")
	golang_proto.RegisterMapType((map[string]string)(nil), "ves.io.schema.virtual_host.APIEPSourceOpenApiSchemaRsp.ApiSpecsEntry")
	proto.RegisterType((*UnmergeAPIEPSourceOpenApiSchemaReq)(nil), "ves.io.schema.virtual_host.UnmergeAPIEPSourceOpenApiSchemaReq")
	golang_proto.RegisterType((*UnmergeAPIEPSourceOpenApiSchemaReq)(nil), "ves.io.schema.virtual_host.UnmergeAPIEPSourceOpenApiSchemaReq")
...
var fileDescriptor_6ff43449ad67ea61 = []byte{
	// 4487 bytes of a gzipped FileDescriptorProto
	,
}
...
func (x APIEPDiscoverySource) String() string {
	s, ok := APIEPDiscoverySource_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *APIEPSourceOpenApiSchemaReq) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*APIEPSourceOpenApiSchemaReq)
	if !ok {
		that2, ok := that.(APIEPSourceOpenApiSchemaReq)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.DiscoverySourceTypes) != len(that1.DiscoverySourceTypes) {
		return false
	}
	for i := range this.DiscoverySourceTypes {
		if this.DiscoverySourceTypes[i] != that1.DiscoverySourceTypes[i] {
			return false
		}
	}
	return true
}
func (this *APIEPSourceOpenApiSchemaRsp) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*APIEPSourceOpenApiSchemaRsp)
	if !ok {
		that2, ok := that.(APIEPSourceOpenApiSchemaRsp)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *UnmergeAPIEPSourceOpenApiSchemaReq) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UnmergeAPIEPSourceOpenApiSchemaReq)
	if !ok {
		that2, ok := that.(UnmergeAPIEPSourceOpenApiSchemaReq)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.DiscoverySourceType != that1.DiscoverySourceType {
		return false
	}
	return true
}
...
func (this *Vulnerability) Equal(that interface{}) bool {
	...
	if len(this.OwaspCategories) != len(that1.OwaspCategories) {
		return false
	}
	for i := range this.OwaspCategories {
		if !this.OwaspCategories[i].Equal(that1.OwaspCategories[i]) {
			return false
		}
	}
	...
	for i := range this.Objects {
		if this.Objects[i] != that1.Objects[i] {
			return false
		}
	}
...
func (this *VulnEvidence) Equal(that interface{}) bool {
	...
	if len(this.IncidentIds) != len(that1.IncidentIds) {
		return false
	}
	for i := range this.IncidentIds {
		if this.IncidentIds[i] != that1.IncidentIds[i] {
			return false
		}
	}
...
func (this *APIEPSourceOpenApiSchemaReq) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&virtual_host.APIEPSourceOpenApiSchemaReq{")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "Id: "+fmt.Sprintf("%#v", this.Id)+",\n")
	s = append(s, "DiscoverySourceTypes: "+fmt.Sprintf("%#v", this.DiscoverySourceTypes)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *APIEPSourceOpenApiSchemaRsp) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&virtual_host.APIEPSourceOpenApiSchemaRsp{")
...
func (this *UnmergeAPIEPSourceOpenApiSchemaReq) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&virtual_host.UnmergeAPIEPSourceOpenApiSchemaReq{")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "Id: "+fmt.Sprintf("%#v", this.Id)+",\n")
	s = append(s, "DiscoverySourceType: "+fmt.Sprintf("%#v", this.DiscoverySourceType)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *Vulnerability) GoString() string {
	...
	if this.OwaspCategories != nil {
		s = append(s, "OwaspCategories: "+fmt.Sprintf("%#v", this.OwaspCategories)+",\n")
	}
...
func (this *VulnEvidence) GoString() string {
	...
	s = append(s, "EvidenceId: "+fmt.Sprintf("%#v", this.EvidenceId)+",\n")
	s = append(s, "IncidentIds: "+fmt.Sprintf("%#v", this.IncidentIds)+",\n")
...
type ApiepCustomAPIClient interface {
	...
	// Get Learnt Schema per API endpoint
	//
	// x-displayName: "Get relevant source OpenApi schema per API endpoint"
	// Get openapi schema per API endpoint for a given source types and Virtual Host
	GetAPIEPSourceOpenApiSchema(ctx context.Context, in *APIEPSourceOpenApiSchemaReq, opts ...grpc.CallOption) (*APIEPSourceOpenApiSchemaRsp, error)
	// Unmerge Api Endpoint Discovery Source
	//
	// x-displayName: "Unmerge Source from Api Endpoint"
	// Unmerge Source Discovered schema from Api Endpoint merged schema
	UnmergeAPIEPSourceOpenApiSchema(ctx context.Context, in *UnmergeAPIEPSourceOpenApiSchemaReq, opts ...grpc.CallOption) (*types.Empty, error)
...
func (c *apiepCustomAPIClient) GetAPIEPSourceOpenApiSchema(ctx context.Context, in *APIEPSourceOpenApiSchemaReq, opts ...grpc.CallOption) (*APIEPSourceOpenApiSchemaRsp, error) {
	out := new(APIEPSourceOpenApiSchemaRsp)
	err := c.cc.Invoke(ctx, "/ves.io.schema.virtual_host.ApiepCustomAPI/GetAPIEPSourceOpenApiSchema", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiepCustomAPIClient) UnmergeAPIEPSourceOpenApiSchema(ctx context.Context, in *UnmergeAPIEPSourceOpenApiSchemaReq, opts ...grpc.CallOption) (*types.Empty, error) {
	out := new(types.Empty)
	err := c.cc.Invoke(ctx, "/ves.io.schema.virtual_host.ApiepCustomAPI/UnmergeAPIEPSourceOpenApiSchema", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiepCustomAPIServer interface {
	...
	// x-displayName: "Get relevant source OpenApi schema per API endpoint"
	// Get openapi schema per API endpoint for a given source types and Virtual Host
	GetAPIEPSourceOpenApiSchema(context.Context, *APIEPSourceOpenApiSchemaReq) (*APIEPSourceOpenApiSchemaRsp, error)
	// Unmerge Api Endpoint Discovery Source
	//
	// x-displayName: "Unmerge Source from Api Endpoint"
	// Unmerge Source Discovered schema from Api Endpoint merged schema
	UnmergeAPIEPSourceOpenApiSchema(context.Context, *UnmergeAPIEPSourceOpenApiSchemaReq) (*types.Empty, error)
	// Get Swagger Spec for App Type
	//
	// x-displayName: "Get Swagger Spec for App Type"
	// Get the corresponding Swagger spec for the given app type
...
func (*UnimplementedApiepCustomAPIServer) GetAPIEPSourceOpenApiSchema(ctx context.Context, req *APIEPSourceOpenApiSchemaReq) (*APIEPSourceOpenApiSchemaRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAPIEPSourceOpenApiSchema not implemented")
}
func (*UnimplementedApiepCustomAPIServer) UnmergeAPIEPSourceOpenApiSchema(ctx context.Context, req *UnmergeAPIEPSourceOpenApiSchemaReq) (*types.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnmergeAPIEPSourceOpenApiSchema not implemented")
}
...
func _ApiepCustomAPI_GetAPIEPSourceOpenApiSchema_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(APIEPSourceOpenApiSchemaReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiepCustomAPIServer).GetAPIEPSourceOpenApiSchema(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.virtual_host.ApiepCustomAPI/GetAPIEPSourceOpenApiSchema",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiepCustomAPIServer).GetAPIEPSourceOpenApiSchema(ctx, req.(*APIEPSourceOpenApiSchemaReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiepCustomAPI_UnmergeAPIEPSourceOpenApiSchema_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnmergeAPIEPSourceOpenApiSchemaReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiepCustomAPIServer).UnmergeAPIEPSourceOpenApiSchema(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ves.io.schema.virtual_host.ApiepCustomAPI/UnmergeAPIEPSourceOpenApiSchema",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiepCustomAPIServer).UnmergeAPIEPSourceOpenApiSchema(ctx, req.(*UnmergeAPIEPSourceOpenApiSchemaReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ApiepCustomAPI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAPIEPSourceOpenApiSchema",
			Handler:    _ApiepCustomAPI_GetAPIEPSourceOpenApiSchema_Handler,
		},
		{
			MethodName: "UnmergeAPIEPSourceOpenApiSchema",
			Handler:    _ApiepCustomAPI_UnmergeAPIEPSourceOpenApiSchema_Handler,
		},
		{
...
func (m *APIEPSourceOpenApiSchemaReq) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *APIEPSourceOpenApiSchemaReq) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *APIEPSourceOpenApiSchemaReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.DiscoverySourceTypes) > 0 {
		dAtA8 := make([]byte, len(m.DiscoverySourceTypes)*10)
		var j7 int
		for _, num := range m.DiscoverySourceTypes {
			for num >= 1<<7 {
	...
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintPublicApiepCustomapi(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Name) > 0 {
...
func (m *APIEPSourceOpenApiSchemaRsp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *APIEPSourceOpenApiSchemaRsp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *APIEPSourceOpenApiSchemaRsp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UnmergeAPIEPSourceOpenApiSchemaReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.DiscoverySourceType != 0 {
		i = encodeVarintPublicApiepCustomapi(dAtA, i, uint64(m.DiscoverySourceType))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Id) > 0 {
...
func (m *APIEndpointReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ApiEndpointInfoRequest) > 0 {
		dAtA15 := make([]byte, len(m.ApiEndpointInfoRequest)*10)
		var j14 int
		for _, num := range m.ApiEndpointInfoRequest {
			for num >= 1<<7 {
...
func (m *APIEPSummaryFilter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.ApiepCategory) > 0 {
		dAtA22 := make([]byte, len(m.ApiepCategory)*10)
		var j21 int
		for _, num := range m.ApiepCategory {
			for num >= 1<<7 {
		...
		i = encodeVarintPublicApiepCustomapi(dAtA, i, uint64(j21))
		i--
		dAtA[i] = 0x22
	}
	if len(m.EndTime) > 0 {
...
func (m *Vulnerability) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ObjectType) > 0 {
		...
		i = encodeVarintPublicApiepCustomapi(dAtA, i, uint64(len(m.ObjectType)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	...
	if len(m.Objects) > 0 {
		for iNdEx := len(m.Objects) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPublicApiepCustomapi(dAtA, i, uint64(len(m.Objects[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x8a
	...
	if len(m.OwaspCategories) > 0 {
		for iNdEx := len(m.OwaspCategories) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OwaspCategories[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *VulnEvidence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Message) > 0 {
		...
		i = encodeVarintPublicApiepCustomapi(dAtA, i, uint64(len(m.Message)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.IncidentIds) > 0 {
		for iNdEx := len(m.IncidentIds) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.IncidentIds[iNdEx])
			copy(dAtA[i:], m.IncidentIds[iNdEx])
			i = encodeVarintPublicApiepCustomapi(dAtA, i, uint64(len(m.IncidentIds[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
	if len(m.EvidenceId) > 0 {
		...
		i = encodeVarintPublicApiepCustomapi(dAtA, i, uint64(len(m.EvidenceId)))
		i--
		dAtA[i] = 0x2a
	}
	if m.EndTime != nil {
...
func (m *APIEPSourceOpenApiSchemaReq) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.DiscoverySourceTypes) > 0 {
		l = 0
		for _, e := range m.DiscoverySourceTypes {
			l += sovPublicApiepCustomapi(uint64(e))
		}
		n += 1 + sovPublicApiepCustomapi(uint64(l)) + l
	}
...
func (m *APIEPSourceOpenApiSchemaRsp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.DiscoverySourceType != 0 {
		n += 1 + sovPublicApiepCustomapi(uint64(m.DiscoverySourceType))
	}
	return n
}
...
func (m *Vulnerability) Size() (n int) {
	...
	if len(m.OwaspCategories) > 0 {
		for _, e := range m.OwaspCategories {
			l = e.Size()
			n += 2 + l + sovPublicApiepCustomapi(uint64(l))
		}
	}
	if len(m.Objects) > 0 {
...
func (this *APIEPSourceOpenApiSchemaReq) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&APIEPSourceOpenApiSchemaReq{`,
		`Namespace:` + fmt.Sprintf("%v", this.Namespace) + `,`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Id:` + fmt.Sprintf("%v", this.Id) + `,`,
		`DiscoverySourceTypes:` + fmt.Sprintf("%v", this.DiscoverySourceTypes) + `,`,
		`}`,
	}, "")
	return s
}
func (this *APIEPSourceOpenApiSchemaRsp) String() string {
	if this == nil {
		return "nil"
	}
	keysForApiSpecs := make([]string, 0, len(this.ApiSpecs))
	...
	mapStringForApiSpecs += "}"
	s := strings.Join([]string{`&APIEPSourceOpenApiSchemaRsp{`,
		`ApiSpecs:` + mapStringForApiSpecs + `,`,
		`}`,
	}, "")
	return s
}
func (this *UnmergeAPIEPSourceOpenApiSchemaReq) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&UnmergeAPIEPSourceOpenApiSchemaReq{`,
		`Namespace:` + fmt.Sprintf("%v", this.Namespace) + `,`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Id:` + fmt.Sprintf("%v", this.Id) + `,`,
		`DiscoverySourceType:` + fmt.Sprintf("%v", this.DiscoverySourceType) + `,`,
		`}`,
	}, "")
	return s
}
func (this *APIEndpointsRsp) String() string {
	...
	s := strings.Join([]string{`&APIEndpointsRsp{`,
		...
		`LastUpdate:` + strings.Replace(fmt.Sprintf("%v", this.LastUpdate), "Timestamp", "types.Timestamp", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Vulnerability) String() string {
	...
	repeatedStringForOwaspCategories := "[]*OwaspCategory{"
	for _, f := range this.OwaspCategories {
		repeatedStringForOwaspCategories += strings.Replace(fmt.Sprintf("%v", f), "OwaspCategory", "schema.OwaspCategory", 1) + ","
	}
	repeatedStringForOwaspCategories += "}"
	s := strings.Join([]string{`&Vulnerability{`,
		...
		`OwaspCategories:` + repeatedStringForOwaspCategories + `,`,
...
func (this *VulnEvidence) String() string {
	...
	s := strings.Join([]string{`&VulnEvidence{`,
		...
		`EvidenceId:` + fmt.Sprintf("%v", this.EvidenceId) + `,`,
		`IncidentIds:` + fmt.Sprintf("%v", this.IncidentIds) + `,`,
...
func (m *APIEPSourceOpenApiSchemaReq) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: APIEPSourceOpenApiSchemaReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: APIEPSourceOpenApiSchemaReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= APIEPDiscoverySource(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.DiscoverySourceTypes = append(m.DiscoverySourceTypes, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				var elementCount int
				if elementCount != 0 && len(m.DiscoverySourceTypes) == 0 {
					m.DiscoverySourceTypes = make([]APIEPDiscoverySource, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v APIEPDiscoverySource
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field DiscoverySourceTypes", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipPublicApiepCustomapi(dAtA[iNdEx:])
...
func (m *APIEPSourceOpenApiSchemaRsp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: APIEPSourceOpenApiSchemaRsp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: APIEPSourceOpenApiSchemaRsp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 3:
			if wireType != 2 {
...
func (m *UnmergeAPIEPSourceOpenApiSchemaReq) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnmergeAPIEPSourceOpenApiSchemaReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnmergeAPIEPSourceOpenApiSchemaReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DiscoverySourceType", wireType)
			}
			m.DiscoverySourceType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPublicApiepCustomapi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DiscoverySourceType |= APIEPDiscoverySource(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Vulnerability) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OwaspCategories", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OwaspCategories = append(m.OwaspCategories, &schema.OwaspCategory{})
			if err := m.OwaspCategories[len(m.OwaspCategories)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 17:
...
func (m *VulnEvidence) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IncidentIds", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IncidentIds = append(m.IncidentIds, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
