...
type StringRules struct {
	...
	//
	// x-displayName "displayname"
	// Glob specifies that this field must match against the specified
	// glob expression.
	GlobPattern string `protobuf:"bytes,62,opt,name=glob_pattern,json=globPattern,proto3" json:"glob_pattern,omitempty"`
	// Title
	//
	// x-displayName "displayname"
	// not_empty specifies that the field must be non-empty
	NotEmpty bool `protobuf:"varint,27,opt,name=not_empty,json=notEmpty,proto3" json:"not_empty,omitempty"`
	// Title
	//
	// x-displayName "displayname"
	...
	//	*StringRules_IntermediateCertificateChainUrl
	//	*StringRules_TruststoreUrl
	//	*StringRules_TemplatedHttpPath
	//	*StringRules_Glob
	//	*StringRules_VesServiceNamespaceName
	//	*StringRules_HttpStatusRange
	//	*StringRules_QueryTime
	//	*StringRules_QueryStep
	//	*StringRules_Ipv4PrefixStrict
	//	*StringRules_Ipv6PrefixStrict
	//	*StringRules_IpPrefixStrict
	//	*StringRules_CookieName
	//	*StringRules_UniquePortRangeList
	//	*StringRules_IpGloballyRoutable
	//	*StringRules_Ipv4GloballyRoutable
	//	*StringRules_Ipv6GloballyRoutable
	//	*StringRules_HttpValidMethods
	//	*StringRules_UrlOrUriRef
	//	*StringRules_Ipv4PrefixGloballyRoutable
	//	*StringRules_Ipv6PrefixGloballyRoutable
	//	*StringRules_IpPrefixGloballyRoutable
	//	*StringRules_VhDomainOrIp
	WellKnown isStringRules_WellKnown `protobuf_oneof:"well_known"`
	// Maximum Ports
	//
	// x-displayName "Max Ports"
	// MaxPorts specifies the maximum number of ports in port range string
	MaxPorts uint64 `protobuf:"varint,74,opt,name=max_ports,json=maxPorts,proto3" json:"max_ports,omitempty"`
}
...
type StringRules_IntermediateCertificateChainUrl struct {
	IntermediateCertificateChainUrl bool `protobuf:"varint,72,opt,name=intermediate_certificate_chain_url,json=intermediateCertificateChainUrl,proto3,oneof" json:"intermediate_certificate_chain_url,omitempty"`
}
...
type StringRules_TemplatedHttpPath struct {
	TemplatedHttpPath bool `protobuf:"varint,50,opt,name=templated_http_path,json=templatedHttpPath,proto3,oneof" json:"templated_http_path,omitempty"`
}
type StringRules_Glob struct {
	Glob bool `protobuf:"varint,63,opt,name=glob,proto3,oneof" json:"glob,omitempty"`
}
type StringRules_VesServiceNamespaceName struct {
	VesServiceNamespaceName bool `protobuf:"varint,65,opt,name=ves_service_namespace_name,json=vesServiceNamespaceName,proto3,oneof" json:"ves_service_namespace_name,omitempty"`
}
type StringRules_HttpStatusRange struct {
	HttpStatusRange bool `protobuf:"varint,66,opt,name=http_status_range,json=httpStatusRange,proto3,oneof" json:"http_status_range,omitempty"`
}
type StringRules_QueryTime struct {
	QueryTime bool `protobuf:"varint,67,opt,name=query_time,json=queryTime,proto3,oneof" json:"query_time,omitempty"`
}
type StringRules_QueryStep struct {
	QueryStep bool `protobuf:"varint,68,opt,name=query_step,json=queryStep,proto3,oneof" json:"query_step,omitempty"`
}
type StringRules_Ipv4PrefixStrict struct {
	Ipv4PrefixStrict bool `protobuf:"varint,69,opt,name=ipv4_prefix_strict,json=ipv4PrefixStrict,proto3,oneof" json:"ipv4_prefix_strict,omitempty"`
}
type StringRules_Ipv6PrefixStrict struct {
	Ipv6PrefixStrict bool `protobuf:"varint,70,opt,name=ipv6_prefix_strict,json=ipv6PrefixStrict,proto3,oneof" json:"ipv6_prefix_strict,omitempty"`
}
type StringRules_IpPrefixStrict struct {
	IpPrefixStrict bool `protobuf:"varint,71,opt,name=ip_prefix_strict,json=ipPrefixStrict,proto3,oneof" json:"ip_prefix_strict,omitempty"`
}
type StringRules_CookieName struct {
	CookieName bool `protobuf:"varint,73,opt,name=cookie_name,json=cookieName,proto3,oneof" json:"cookie_name,omitempty"`
}
type StringRules_UniquePortRangeList struct {
	UniquePortRangeList bool `protobuf:"varint,75,opt,name=unique_port_range_list,json=uniquePortRangeList,proto3,oneof" json:"unique_port_range_list,omitempty"`
}
type StringRules_IpGloballyRoutable struct {
	IpGloballyRoutable bool `protobuf:"varint,76,opt,name=ip_globally_routable,json=ipGloballyRoutable,proto3,oneof" json:"ip_globally_routable,omitempty"`
}
type StringRules_Ipv4GloballyRoutable struct {
	Ipv4GloballyRoutable bool `protobuf:"varint,77,opt,name=ipv4_globally_routable,json=ipv4GloballyRoutable,proto3,oneof" json:"ipv4_globally_routable,omitempty"`
}
type StringRules_Ipv6GloballyRoutable struct {
	Ipv6GloballyRoutable bool `protobuf:"varint,78,opt,name=ipv6_globally_routable,json=ipv6GloballyRoutable,proto3,oneof" json:"ipv6_globally_routable,omitempty"`
}
type StringRules_HttpValidMethods struct {
	HttpValidMethods bool `protobuf:"varint,79,opt,name=http_valid_methods,json=httpValidMethods,proto3,oneof" json:"http_valid_methods,omitempty"`
}
type StringRules_UrlOrUriRef struct {
	UrlOrUriRef bool `protobuf:"varint,80,opt,name=url_or_uri_ref,json=urlOrUriRef,proto3,oneof" json:"url_or_uri_ref,omitempty"`
}
type StringRules_Ipv4PrefixGloballyRoutable struct {
	Ipv4PrefixGloballyRoutable bool `protobuf:"varint,81,opt,name=ipv4_prefix_globally_routable,json=ipv4PrefixGloballyRoutable,proto3,oneof" json:"ipv4_prefix_globally_routable,omitempty"`
}
type StringRules_Ipv6PrefixGloballyRoutable struct {
	Ipv6PrefixGloballyRoutable bool `protobuf:"varint,82,opt,name=ipv6_prefix_globally_routable,json=ipv6PrefixGloballyRoutable,proto3,oneof" json:"ipv6_prefix_globally_routable,omitempty"`
}
type StringRules_IpPrefixGloballyRoutable struct {
	IpPrefixGloballyRoutable bool `protobuf:"varint,83,opt,name=ip_prefix_globally_routable,json=ipPrefixGloballyRoutable,proto3,oneof" json:"ip_prefix_globally_routable,omitempty"`
}
type StringRules_VhDomainOrIp struct {
	VhDomainOrIp bool `protobuf:"varint,85,opt,name=vh_domain_or_ip,json=vhDomainOrIp,proto3,oneof" json:"vh_domain_or_ip,omitempty"`
}
...
func (*StringRules_IntermediateCertificateChainUrl) isStringRules_WellKnown() {}
func (*StringRules_TruststoreUrl) isStringRules_WellKnown()                   {}
func (*StringRules_TemplatedHttpPath) isStringRules_WellKnown()               {}
func (*StringRules_Glob) isStringRules_WellKnown()                            {}
func (*StringRules_VesServiceNamespaceName) isStringRules_WellKnown()         {}
func (*StringRules_HttpStatusRange) isStringRules_WellKnown()                 {}
func (*StringRules_QueryTime) isStringRules_WellKnown()                       {}
func (*StringRules_QueryStep) isStringRules_WellKnown()                       {}
func (*StringRules_Ipv4PrefixStrict) isStringRules_WellKnown()                {}
func (*StringRules_Ipv6PrefixStrict) isStringRules_WellKnown()                {}
func (*StringRules_IpPrefixStrict) isStringRules_WellKnown()                  {}
func (*StringRules_CookieName) isStringRules_WellKnown()                      {}
func (*StringRules_UniquePortRangeList) isStringRules_WellKnown()             {}
func (*StringRules_IpGloballyRoutable) isStringRules_WellKnown()              {}
func (*StringRules_Ipv4GloballyRoutable) isStringRules_WellKnown()            {}
func (*StringRules_Ipv6GloballyRoutable) isStringRules_WellKnown()            {}
func (*StringRules_HttpValidMethods) isStringRules_WellKnown()                {}
func (*StringRules_UrlOrUriRef) isStringRules_WellKnown()                     {}
func (*StringRules_Ipv4PrefixGloballyRoutable) isStringRules_WellKnown()      {}
func (*StringRules_Ipv6PrefixGloballyRoutable) isStringRules_WellKnown()      {}
func (*StringRules_IpPrefixGloballyRoutable) isStringRules_WellKnown()        {}
func (*StringRules_VhDomainOrIp) isStringRules_WellKnown()                    {}
...
func (m *StringRules) GetGlobPattern() string {
	if m != nil {
...
func (m *StringRules) GetIntermediateCertificateChainUrl() bool {
	if x, ok := m.GetWellKnown().(*StringRules_IntermediateCertificateChainUrl); ok {
		return x.IntermediateCertificateChainUrl
	}
	return false
}
...
func (m *StringRules) GetTemplatedHttpPath() bool {
	if x, ok := m.GetWellKnown().(*StringRules_TemplatedHttpPath); ok {
		return x.TemplatedHttpPath
	}
	return false
}

func (m *StringRules) GetGlob() bool {
	if x, ok := m.GetWellKnown().(*StringRules_Glob); ok {
		return x.Glob
	}
	return false
}

func (m *StringRules) GetVesServiceNamespaceName() bool {
	if x, ok := m.GetWellKnown().(*StringRules_VesServiceNamespaceName); ok {
		return x.VesServiceNamespaceName
	}
	return false
}

func (m *StringRules) GetHttpStatusRange() bool {
	if x, ok := m.GetWellKnown().(*StringRules_HttpStatusRange); ok {
		return x.HttpStatusRange
	}
	return false
}

func (m *StringRules) GetQueryTime() bool {
	if x, ok := m.GetWellKnown().(*StringRules_QueryTime); ok {
		return x.QueryTime
	}
	return false
}

func (m *StringRules) GetQueryStep() bool {
	if x, ok := m.GetWellKnown().(*StringRules_QueryStep); ok {
		return x.QueryStep
	}
	return false
}

func (m *StringRules) GetIpv4PrefixStrict() bool {
	if x, ok := m.GetWellKnown().(*StringRules_Ipv4PrefixStrict); ok {
		return x.Ipv4PrefixStrict
	}
	return false
}

func (m *StringRules) GetIpv6PrefixStrict() bool {
	if x, ok := m.GetWellKnown().(*StringRules_Ipv6PrefixStrict); ok {
		return x.Ipv6PrefixStrict
	}
	return false
}

func (m *StringRules) GetIpPrefixStrict() bool {
	if x, ok := m.GetWellKnown().(*StringRules_IpPrefixStrict); ok {
		return x.IpPrefixStrict
	}
	return false
}

func (m *StringRules) GetCookieName() bool {
	if x, ok := m.GetWellKnown().(*StringRules_CookieName); ok {
		return x.CookieName
	}
	return false
}

func (m *StringRules) GetUniquePortRangeList() bool {
	if x, ok := m.GetWellKnown().(*StringRules_UniquePortRangeList); ok {
		return x.UniquePortRangeList
	}
	return false
}

func (m *StringRules) GetIpGloballyRoutable() bool {
	if x, ok := m.GetWellKnown().(*StringRules_IpGloballyRoutable); ok {
		return x.IpGloballyRoutable
	}
	return false
}

func (m *StringRules) GetIpv4GloballyRoutable() bool {
	if x, ok := m.GetWellKnown().(*StringRules_Ipv4GloballyRoutable); ok {
		return x.Ipv4GloballyRoutable
	}
	return false
}

func (m *StringRules) GetIpv6GloballyRoutable() bool {
	if x, ok := m.GetWellKnown().(*StringRules_Ipv6GloballyRoutable); ok {
		return x.Ipv6GloballyRoutable
	}
	return false
}

func (m *StringRules) GetHttpValidMethods() bool {
	if x, ok := m.GetWellKnown().(*StringRules_HttpValidMethods); ok {
		return x.HttpValidMethods
	}
	return false
}

func (m *StringRules) GetUrlOrUriRef() bool {
	if x, ok := m.GetWellKnown().(*StringRules_UrlOrUriRef); ok {
		return x.UrlOrUriRef
	}
	return false
}

func (m *StringRules) GetIpv4PrefixGloballyRoutable() bool {
	if x, ok := m.GetWellKnown().(*StringRules_Ipv4PrefixGloballyRoutable); ok {
		return x.Ipv4PrefixGloballyRoutable
	}
	return false
}

func (m *StringRules) GetIpv6PrefixGloballyRoutable() bool {
	if x, ok := m.GetWellKnown().(*StringRules_Ipv6PrefixGloballyRoutable); ok {
		return x.Ipv6PrefixGloballyRoutable
	}
	return false
}

func (m *StringRules) GetIpPrefixGloballyRoutable() bool {
	if x, ok := m.GetWellKnown().(*StringRules_IpPrefixGloballyRoutable); ok {
		return x.IpPrefixGloballyRoutable
	}
	return false
}

func (m *StringRules) GetVhDomainOrIp() bool {
	if x, ok := m.GetWellKnown().(*StringRules_VhDomainOrIp); ok {
		return x.VhDomainOrIp
	}
	return false
}

func (m *StringRules) GetMaxPorts() uint64 {
	if m != nil {
		return m.MaxPorts
	}
	return 0
...
func (*StringRules) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*StringRules_IntermediateCertificateChainUrl)(nil),
		(*StringRules_TruststoreUrl)(nil),
		(*StringRules_TemplatedHttpPath)(nil),
		(*StringRules_Glob)(nil),
		(*StringRules_VesServiceNamespaceName)(nil),
		(*StringRules_HttpStatusRange)(nil),
		(*StringRules_QueryTime)(nil),
		(*StringRules_QueryStep)(nil),
		(*StringRules_Ipv4PrefixStrict)(nil),
		(*StringRules_Ipv6PrefixStrict)(nil),
		(*StringRules_IpPrefixStrict)(nil),
		(*StringRules_CookieName)(nil),
		(*StringRules_UniquePortRangeList)(nil),
		(*StringRules_IpGloballyRoutable)(nil),
		(*StringRules_Ipv4GloballyRoutable)(nil),
		(*StringRules_Ipv6GloballyRoutable)(nil),
		(*StringRules_HttpValidMethods)(nil),
		(*StringRules_UrlOrUriRef)(nil),
		(*StringRules_Ipv4PrefixGloballyRoutable)(nil),
		(*StringRules_Ipv6PrefixGloballyRoutable)(nil),
		(*StringRules_IpPrefixGloballyRoutable)(nil),
		(*StringRules_VhDomainOrIp)(nil),
	}
}

// Title
//
// x-displayName "Bytes Rules"
...
type BytesRules struct {
	...
	// regular expression (RE2 syntax). The included expression should elide
	// any delimiters.
	Pattern string `protobuf:"bytes,4,opt,name=pattern,proto3" json:"pattern,omitempty"` // Deprecated: Do not use.
	// Title
	//
	// x-displayName: "displayname"
	// Prefix specifies that this field must have the specified bytes at the
	// beginning of the string.
	Prefix []byte `protobuf:"bytes,5,opt,name=prefix,proto3" json:"prefix,omitempty"` // Deprecated: Do not use.
	// Title
	//
	// x-displayName: "displayname"
	// Suffix specifies that this field must have the specified bytes at the
	// end of the string.
	Suffix []byte `protobuf:"bytes,6,opt,name=suffix,proto3" json:"suffix,omitempty"` // Deprecated: Do not use.
	// Title
	//
	// x-displayName: "displayname"
	// Contains specifies that this field must have the specified bytes
	// anywhere in the string.
	Contains []byte `protobuf:"bytes,7,opt,name=contains,proto3" json:"contains,omitempty"` // Deprecated: Do not use.
	// Title
	//
	// x-displayName: "displayname"
	// In specifies that this field must be equal to one of the specified
	// values
	In [][]byte `protobuf:"bytes,8,rep,name=in,proto3" json:"in,omitempty"` // Deprecated: Do not use.
	// Title
	//
	// x-displayName: "displayname"
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn [][]byte `protobuf:"bytes,9,rep,name=not_in,json=notIn,proto3" json:"not_in,omitempty"` // Deprecated: Do not use.
	// Title
	//
	// x-displayName: "displayname"
...
type MessageRules struct {
	...
	//
	// x-displayName "file_content_max_bytes"
	// Max length of file content in bytes
	FileContentMaxBytes uint32 `protobuf:"varint,5,opt,name=file_content_max_bytes,json=fileContentMaxBytes,proto3" json:"file_content_max_bytes,omitempty"`
	// file_content_min_bytes
	//
	// x-displayName "file_content_min_bytes"
	// Minium length of file content in bytes
	FileContentMinBytes uint32 `protobuf:"varint,6,opt,name=file_content_min_bytes,json=fileContentMinBytes,proto3" json:"file_content_min_bytes,omitempty"`
	// date_range
	//
	// x-displayName: "Date Range"
	// Date Range rules that can be applied on DateRange message
	DateRange *DateRangeRules `protobuf:"bytes,9,opt,name=date_range,json=dateRange,proto3" json:"date_range,omitempty"`
	// ip_range
	//
	// x-displayName: "IPv4 Range"
	// IP Address Range rules that can be applied on IPv4 Range message
	// End IP address should be greater than start IP address.
	ValidateIpv4Range bool `protobuf:"varint,10,opt,name=validate_ipv4_range,json=validateIpv4Range,proto3" json:"validate_ipv4_range,omitempty"`
	// ipv6_range
	//
	// x-displayName: "IPv6 Range"
	// IP Address Range rules that can be applied on IPv6 Range message
	// End IP address should be greater than start IP address.
	ValidateIpv6Range bool `protobuf:"varint,11,opt,name=validate_ipv6_range,json=validateIpv6Range,proto3" json:"validate_ipv6_range,omitempty"`
}
...
func (m *MessageRules) GetFileContentMaxBytes() uint32 {
	if m != nil {
		return m.FileContentMaxBytes
	}
	return 0
}

func (m *MessageRules) GetFileContentMinBytes() uint32 {
	if m != nil {
		return m.FileContentMinBytes
	}
	return 0
}

func (m *MessageRules) GetDateRange() *DateRangeRules {
	if m != nil {
		return m.DateRange
	}
	return nil
...
func (m *MessageRules) GetValidateIpv4Range() bool {
	if m != nil {
		return m.ValidateIpv4Range
	}
	return false
}

func (m *MessageRules) GetValidateIpv6Range() bool {
	if m != nil {
		return m.ValidateIpv6Range
	}
	return false
}
...
type DateRangeRules struct {
	// min_duration
	//
	// x-displayName: "Minimum Duration"
	// Minimum duration that is allowed in the daterange.
	// It should be specified in the format that can be parsed as Duration using ParseDuration eg. "1h", "2m" etc
	MinDuration string `protobuf:"bytes,3,opt,name=min_duration,json=minDuration,proto3" json:"min_duration,omitempty"`
	// max_duration
	//
	// x-displayName: "Maximum Duration"
	// Maximum duration that is allowed in the daterange
	// It should be specified in the format that can be parsed as Duration using ParseDuration eg. "1h", "2m" etc
	MaxDuration string `protobuf:"bytes,4,opt,name=max_duration,json=maxDuration,proto3" json:"max_duration,omitempty"`
}

func (m *DateRangeRules) Reset()      { *m = DateRangeRules{} }
func (*DateRangeRules) ProtoMessage() {}
func (*DateRangeRules) Descriptor() ([]byte, []int) {
	return fileDescriptor_24f6720636939b16, []int{23}
}
func (m *DateRangeRules) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DateRangeRules) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DateRangeRules.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DateRangeRules) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DateRangeRules.Merge(m, src)
}
func (m *DateRangeRules) XXX_Size() int {
	return m.Size()
}
func (m *DateRangeRules) XXX_DiscardUnknown() {
	xxx_messageInfo_DateRangeRules.DiscardUnknown(m)
}

var xxx_messageInfo_DateRangeRules proto.InternalMessageInfo

func (m *DateRangeRules) GetMinDuration() string {
	if m != nil {
...
func (m *DateRangeRules) GetMaxDuration() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*DateRangeRules)(nil), "ves.io.schema.DateRangeRules")
...
var fileDescriptor_24f6720636939b16 = []byte{
	...
	,
}
...
func (this *StringRules) Equal(that interface{}) bool {
	...
	if this.MaxPorts != that1.MaxPorts {
		return false
	}
	return true
}
...
func (this *StringRules_IntermediateCertificateChainUrl) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_IntermediateCertificateChainUrl)
	if !ok {
		that2, ok := that.(StringRules_IntermediateCertificateChainUrl)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.IntermediateCertificateChainUrl != that1.IntermediateCertificateChainUrl {
		return false
	}
	return true
}
...
func (this *StringRules_TemplatedHttpPath) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_TemplatedHttpPath)
	if !ok {
		that2, ok := that.(StringRules_TemplatedHttpPath)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.TemplatedHttpPath != that1.TemplatedHttpPath {
		return false
	}
	return true
}
func (this *StringRules_Glob) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_Glob)
	if !ok {
		that2, ok := that.(StringRules_Glob)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StringRules_VesServiceNamespaceName) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_VesServiceNamespaceName)
	if !ok {
		that2, ok := that.(StringRules_VesServiceNamespaceName)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.VesServiceNamespaceName != that1.VesServiceNamespaceName {
		return false
	}
	return true
}
func (this *StringRules_HttpStatusRange) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_HttpStatusRange)
	if !ok {
		that2, ok := that.(StringRules_HttpStatusRange)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.HttpStatusRange != that1.HttpStatusRange {
		return false
	}
	return true
}
func (this *StringRules_QueryTime) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_QueryTime)
	if !ok {
		that2, ok := that.(StringRules_QueryTime)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StringRules_QueryStep) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_QueryStep)
	if !ok {
		that2, ok := that.(StringRules_QueryStep)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.QueryStep != that1.QueryStep {
		return false
	}
	return true
}
func (this *StringRules_Ipv4PrefixStrict) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_Ipv4PrefixStrict)
	if !ok {
		that2, ok := that.(StringRules_Ipv4PrefixStrict)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.Ipv4PrefixStrict != that1.Ipv4PrefixStrict {
		return false
	}
	return true
}
func (this *StringRules_Ipv6PrefixStrict) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_Ipv6PrefixStrict)
	if !ok {
		that2, ok := that.(StringRules_Ipv6PrefixStrict)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.Ipv6PrefixStrict != that1.Ipv6PrefixStrict {
		return false
	}
	return true
}
func (this *StringRules_IpPrefixStrict) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_IpPrefixStrict)
	if !ok {
		that2, ok := that.(StringRules_IpPrefixStrict)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.IpPrefixStrict != that1.IpPrefixStrict {
		return false
	}
	return true
}
func (this *StringRules_CookieName) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_CookieName)
	if !ok {
		that2, ok := that.(StringRules_CookieName)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StringRules_UniquePortRangeList) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_UniquePortRangeList)
	if !ok {
		that2, ok := that.(StringRules_UniquePortRangeList)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.UniquePortRangeList != that1.UniquePortRangeList {
		return false
	}
	return true
}
func (this *StringRules_IpGloballyRoutable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_IpGloballyRoutable)
	if !ok {
		that2, ok := that.(StringRules_IpGloballyRoutable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.IpGloballyRoutable != that1.IpGloballyRoutable {
		return false
	}
	return true
}
func (this *StringRules_Ipv4GloballyRoutable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_Ipv4GloballyRoutable)
	if !ok {
		that2, ok := that.(StringRules_Ipv4GloballyRoutable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.Ipv4GloballyRoutable != that1.Ipv4GloballyRoutable {
		return false
	}
	return true
}
func (this *StringRules_Ipv6GloballyRoutable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_Ipv6GloballyRoutable)
	if !ok {
		that2, ok := that.(StringRules_Ipv6GloballyRoutable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.Ipv6GloballyRoutable != that1.Ipv6GloballyRoutable {
		return false
	}
	return true
}
func (this *StringRules_HttpValidMethods) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_HttpValidMethods)
	if !ok {
		that2, ok := that.(StringRules_HttpValidMethods)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.HttpValidMethods != that1.HttpValidMethods {
		return false
	}
	return true
}
func (this *StringRules_UrlOrUriRef) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_UrlOrUriRef)
	if !ok {
		that2, ok := that.(StringRules_UrlOrUriRef)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.UrlOrUriRef != that1.UrlOrUriRef {
		return false
	}
	return true
}
func (this *StringRules_Ipv4PrefixGloballyRoutable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_Ipv4PrefixGloballyRoutable)
	if !ok {
		that2, ok := that.(StringRules_Ipv4PrefixGloballyRoutable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.Ipv4PrefixGloballyRoutable != that1.Ipv4PrefixGloballyRoutable {
		return false
	}
	return true
}
func (this *StringRules_Ipv6PrefixGloballyRoutable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_Ipv6PrefixGloballyRoutable)
	if !ok {
		that2, ok := that.(StringRules_Ipv6PrefixGloballyRoutable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.Ipv6PrefixGloballyRoutable != that1.Ipv6PrefixGloballyRoutable {
		return false
	}
	return true
}
func (this *StringRules_IpPrefixGloballyRoutable) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_IpPrefixGloballyRoutable)
	if !ok {
		that2, ok := that.(StringRules_IpPrefixGloballyRoutable)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.IpPrefixGloballyRoutable != that1.IpPrefixGloballyRoutable {
		return false
	}
	return true
}
func (this *StringRules_VhDomainOrIp) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringRules_VhDomainOrIp)
	if !ok {
		that2, ok := that.(StringRules_VhDomainOrIp)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.VhDomainOrIp != that1.VhDomainOrIp {
		return false
	}
	return true
}
...
func (this *MessageRules) Equal(that interface{}) bool {
	...
	if this.FileContentMaxBytes != that1.FileContentMaxBytes {
		return false
	}
	if this.FileContentMinBytes != that1.FileContentMinBytes {
		return false
	}
	if !this.DateRange.Equal(that1.DateRange) {
		return false
	}
	if this.ValidateIpv4Range != that1.ValidateIpv4Range {
		return false
	}
	if this.ValidateIpv6Range != that1.ValidateIpv6Range {
		return false
	}
	return true
}
...
func (this *DateRangeRules) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*DateRangeRules)
	if !ok {
		that2, ok := that.(DateRangeRules)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.MinDuration != that1.MinDuration {
		return false
	}
...
func (this *StringRules) GoString() string {
	...
	s = append(s, "NotEmpty: "+fmt.Sprintf("%#v", this.NotEmpty)+",\n")
	if this.WellKnown != nil {
		s = append(s, "WellKnown: "+fmt.Sprintf("%#v", this.WellKnown)+",\n")
	}
	s = append(s, "MaxPorts: "+fmt.Sprintf("%#v", this.MaxPorts)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *StringRules_IntermediateCertificateChainUrl) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_IntermediateCertificateChainUrl{` +
		`IntermediateCertificateChainUrl:` + fmt.Sprintf("%#v", this.IntermediateCertificateChainUrl) + `}`}, ", ")
	return s
}
...
func (this *StringRules_TemplatedHttpPath) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_TemplatedHttpPath{` +
		`TemplatedHttpPath:` + fmt.Sprintf("%#v", this.TemplatedHttpPath) + `}`}, ", ")
	return s
}
func (this *StringRules_Glob) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_Glob{` +
		`Glob:` + fmt.Sprintf("%#v", this.Glob) + `}`}, ", ")
	return s
}
func (this *StringRules_VesServiceNamespaceName) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_VesServiceNamespaceName{` +
		`VesServiceNamespaceName:` + fmt.Sprintf("%#v", this.VesServiceNamespaceName) + `}`}, ", ")
	return s
}
func (this *StringRules_HttpStatusRange) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_HttpStatusRange{` +
		`HttpStatusRange:` + fmt.Sprintf("%#v", this.HttpStatusRange) + `}`}, ", ")
	return s
}
func (this *StringRules_QueryTime) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_QueryTime{` +
		`QueryTime:` + fmt.Sprintf("%#v", this.QueryTime) + `}`}, ", ")
	return s
}
func (this *StringRules_QueryStep) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_QueryStep{` +
		`QueryStep:` + fmt.Sprintf("%#v", this.QueryStep) + `}`}, ", ")
	return s
}
func (this *StringRules_Ipv4PrefixStrict) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_Ipv4PrefixStrict{` +
		`Ipv4PrefixStrict:` + fmt.Sprintf("%#v", this.Ipv4PrefixStrict) + `}`}, ", ")
	return s
}
func (this *StringRules_Ipv6PrefixStrict) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_Ipv6PrefixStrict{` +
		`Ipv6PrefixStrict:` + fmt.Sprintf("%#v", this.Ipv6PrefixStrict) + `}`}, ", ")
	return s
}
func (this *StringRules_IpPrefixStrict) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_IpPrefixStrict{` +
		`IpPrefixStrict:` + fmt.Sprintf("%#v", this.IpPrefixStrict) + `}`}, ", ")
	return s
}
func (this *StringRules_CookieName) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_CookieName{` +
		`CookieName:` + fmt.Sprintf("%#v", this.CookieName) + `}`}, ", ")
	return s
}
func (this *StringRules_UniquePortRangeList) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_UniquePortRangeList{` +
		`UniquePortRangeList:` + fmt.Sprintf("%#v", this.UniquePortRangeList) + `}`}, ", ")
	return s
}
func (this *StringRules_IpGloballyRoutable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_IpGloballyRoutable{` +
		`IpGloballyRoutable:` + fmt.Sprintf("%#v", this.IpGloballyRoutable) + `}`}, ", ")
	return s
}
func (this *StringRules_Ipv4GloballyRoutable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_Ipv4GloballyRoutable{` +
		`Ipv4GloballyRoutable:` + fmt.Sprintf("%#v", this.Ipv4GloballyRoutable) + `}`}, ", ")
	return s
}
func (this *StringRules_Ipv6GloballyRoutable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_Ipv6GloballyRoutable{` +
		`Ipv6GloballyRoutable:` + fmt.Sprintf("%#v", this.Ipv6GloballyRoutable) + `}`}, ", ")
	return s
}
func (this *StringRules_HttpValidMethods) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_HttpValidMethods{` +
		`HttpValidMethods:` + fmt.Sprintf("%#v", this.HttpValidMethods) + `}`}, ", ")
	return s
}
func (this *StringRules_UrlOrUriRef) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_UrlOrUriRef{` +
		`UrlOrUriRef:` + fmt.Sprintf("%#v", this.UrlOrUriRef) + `}`}, ", ")
	return s
}
func (this *StringRules_Ipv4PrefixGloballyRoutable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_Ipv4PrefixGloballyRoutable{` +
		`Ipv4PrefixGloballyRoutable:` + fmt.Sprintf("%#v", this.Ipv4PrefixGloballyRoutable) + `}`}, ", ")
	return s
}
func (this *StringRules_Ipv6PrefixGloballyRoutable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_Ipv6PrefixGloballyRoutable{` +
		`Ipv6PrefixGloballyRoutable:` + fmt.Sprintf("%#v", this.Ipv6PrefixGloballyRoutable) + `}`}, ", ")
	return s
}
func (this *StringRules_IpPrefixGloballyRoutable) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_IpPrefixGloballyRoutable{` +
		`IpPrefixGloballyRoutable:` + fmt.Sprintf("%#v", this.IpPrefixGloballyRoutable) + `}`}, ", ")
	return s
}
func (this *StringRules_VhDomainOrIp) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&schema.StringRules_VhDomainOrIp{` +
		`VhDomainOrIp:` + fmt.Sprintf("%#v", this.VhDomainOrIp) + `}`}, ", ")
	return s
}
...
func (this *MessageRules) GoString() string {
	...
	s = append(s, "FileContentMaxBytes: "+fmt.Sprintf("%#v", this.FileContentMaxBytes)+",\n")
	s = append(s, "FileContentMinBytes: "+fmt.Sprintf("%#v", this.FileContentMinBytes)+",\n")
	if this.DateRange != nil {
		s = append(s, "DateRange: "+fmt.Sprintf("%#v", this.DateRange)+",\n")
	}
	s = append(s, "ValidateIpv4Range: "+fmt.Sprintf("%#v", this.ValidateIpv4Range)+",\n")
	s = append(s, "ValidateIpv6Range: "+fmt.Sprintf("%#v", this.ValidateIpv6Range)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *DateRangeRules) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&schema.DateRangeRules{")
	s = append(s, "MinDuration: "+fmt.Sprintf("%#v", this.MinDuration)+",\n")
...
func (m *StringRules) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MaxPorts != 0 {
		i = encodeVarintValidate(dAtA, i, uint64(m.MaxPorts))
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xd0
	...
	if len(m.GlobPattern) > 0 {
		...
		i = encodeVarintValidate(dAtA, i, uint64(len(m.GlobPattern)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xf2
...
func (m *StringRules_TemplatedHttpPath) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_TemplatedHttpPath) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.TemplatedHttpPath {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_Glob) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_Glob) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Glob {
		dAtA[i] = 1
...
func (m *StringRules_VesServiceNamespaceName) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_VesServiceNamespaceName) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.VesServiceNamespaceName {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_HttpStatusRange) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_HttpStatusRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
...
func (m *StringRules_QueryTime) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_QueryTime) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.QueryTime {
		dAtA[i] = 1
...
func (m *StringRules_QueryStep) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_QueryStep) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.QueryStep {
		dAtA[i] = 1
...
func (m *StringRules_Ipv4PrefixStrict) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_Ipv4PrefixStrict) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Ipv4PrefixStrict {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_Ipv6PrefixStrict) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_Ipv6PrefixStrict) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Ipv6PrefixStrict {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_IpPrefixStrict) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_IpPrefixStrict) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.IpPrefixStrict {
		dAtA[i] = 1
...
func (m *StringRules_IntermediateCertificateChainUrl) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_IntermediateCertificateChainUrl) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.IntermediateCertificateChainUrl {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_CookieName) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_CookieName) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.CookieName {
		dAtA[i] = 1
...
func (m *StringRules_UniquePortRangeList) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_UniquePortRangeList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.UniquePortRangeList {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_IpGloballyRoutable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_IpGloballyRoutable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.IpGloballyRoutable {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_Ipv4GloballyRoutable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_Ipv4GloballyRoutable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Ipv4GloballyRoutable {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_Ipv6GloballyRoutable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_Ipv6GloballyRoutable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Ipv6GloballyRoutable {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_HttpValidMethods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_HttpValidMethods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.HttpValidMethods {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_UrlOrUriRef) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_UrlOrUriRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.UrlOrUriRef {
		dAtA[i] = 1
...
func (m *StringRules_Ipv4PrefixGloballyRoutable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_Ipv4PrefixGloballyRoutable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Ipv4PrefixGloballyRoutable {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_Ipv6PrefixGloballyRoutable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_Ipv6PrefixGloballyRoutable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.Ipv6PrefixGloballyRoutable {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_IpPrefixGloballyRoutable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_IpPrefixGloballyRoutable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.IpPrefixGloballyRoutable {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *StringRules_VhDomainOrIp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringRules_VhDomainOrIp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i--
	if m.VhDomainOrIp {
		dAtA[i] = 1
...
func (m *MessageRules) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FileContentMinBytes != 0 {
		i = encodeVarintValidate(dAtA, i, uint64(m.FileContentMinBytes))
		i--
		dAtA[i] = 0x30
	}
	if m.FileContentMaxBytes != 0 {
		i = encodeVarintValidate(dAtA, i, uint64(m.FileContentMaxBytes))
		i--
		dAtA[i] = 0x28
	}
...
func (m *DateRangeRules) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DateRangeRules) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DateRangeRules) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.MaxDuration) > 0 {
		...
		i = encodeVarintValidate(dAtA, i, uint64(len(m.MaxDuration)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.MinDuration) > 0 {
		i -= len(m.MinDuration)
		copy(dAtA[i:], m.MinDuration)
		i = encodeVarintValidate(dAtA, i, uint64(len(m.MinDuration)))
		i--
		dAtA[i] = 0x1a
	}
	return len(dAtA) - i, nil
...
func (m *StringRules) Size() (n int) {
	...
	if m.MaxPorts != 0 {
		n += 2 + sovValidate(uint64(m.MaxPorts))
	}
	return n
}
...
func (m *StringRules_TemplatedHttpPath) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_Glob) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_VesServiceNamespaceName) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_HttpStatusRange) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_QueryTime) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_QueryStep) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_Ipv4PrefixStrict) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_Ipv6PrefixStrict) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_IpPrefixStrict) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_IntermediateCertificateChainUrl) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_CookieName) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_UniquePortRangeList) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_IpGloballyRoutable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_Ipv4GloballyRoutable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_Ipv6GloballyRoutable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_HttpValidMethods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_UrlOrUriRef) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_Ipv4PrefixGloballyRoutable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_Ipv6PrefixGloballyRoutable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_IpPrefixGloballyRoutable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StringRules_VhDomainOrIp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MessageRules) Size() (n int) {
	...
	if m.FileContentMaxBytes != 0 {
		n += 1 + sovValidate(uint64(m.FileContentMaxBytes))
	}
	if m.FileContentMinBytes != 0 {
		n += 1 + sovValidate(uint64(m.FileContentMinBytes))
	}
	if m.DateRange != nil {
		l = m.DateRange.Size()
		n += 1 + l + sovValidate(uint64(l))
...
func (m *DateRangeRules) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *StringRules) String() string {
	...
	s := strings.Join([]string{`&StringRules{`,
		...
		`MaxPorts:` + fmt.Sprintf("%v", this.MaxPorts) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *StringRules_TemplatedHttpPath) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_TemplatedHttpPath{`,
		`TemplatedHttpPath:` + fmt.Sprintf("%v", this.TemplatedHttpPath) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_Glob) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_Glob{`,
		`Glob:` + fmt.Sprintf("%v", this.Glob) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_VesServiceNamespaceName) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_VesServiceNamespaceName{`,
		`VesServiceNamespaceName:` + fmt.Sprintf("%v", this.VesServiceNamespaceName) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_HttpStatusRange) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_HttpStatusRange{`,
		`HttpStatusRange:` + fmt.Sprintf("%v", this.HttpStatusRange) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_QueryTime) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_QueryTime{`,
		`QueryTime:` + fmt.Sprintf("%v", this.QueryTime) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_QueryStep) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_QueryStep{`,
		`QueryStep:` + fmt.Sprintf("%v", this.QueryStep) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_Ipv4PrefixStrict) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_Ipv4PrefixStrict{`,
		`Ipv4PrefixStrict:` + fmt.Sprintf("%v", this.Ipv4PrefixStrict) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_Ipv6PrefixStrict) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_Ipv6PrefixStrict{`,
		`Ipv6PrefixStrict:` + fmt.Sprintf("%v", this.Ipv6PrefixStrict) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_IpPrefixStrict) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_IpPrefixStrict{`,
		`IpPrefixStrict:` + fmt.Sprintf("%v", this.IpPrefixStrict) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_IntermediateCertificateChainUrl) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_IntermediateCertificateChainUrl{`,
		`IntermediateCertificateChainUrl:` + fmt.Sprintf("%v", this.IntermediateCertificateChainUrl) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_CookieName) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_CookieName{`,
		`CookieName:` + fmt.Sprintf("%v", this.CookieName) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_UniquePortRangeList) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_UniquePortRangeList{`,
		`UniquePortRangeList:` + fmt.Sprintf("%v", this.UniquePortRangeList) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_IpGloballyRoutable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_IpGloballyRoutable{`,
		`IpGloballyRoutable:` + fmt.Sprintf("%v", this.IpGloballyRoutable) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_Ipv4GloballyRoutable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_Ipv4GloballyRoutable{`,
		`Ipv4GloballyRoutable:` + fmt.Sprintf("%v", this.Ipv4GloballyRoutable) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_Ipv6GloballyRoutable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_Ipv6GloballyRoutable{`,
		`Ipv6GloballyRoutable:` + fmt.Sprintf("%v", this.Ipv6GloballyRoutable) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_HttpValidMethods) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_HttpValidMethods{`,
		`HttpValidMethods:` + fmt.Sprintf("%v", this.HttpValidMethods) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_UrlOrUriRef) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_UrlOrUriRef{`,
		`UrlOrUriRef:` + fmt.Sprintf("%v", this.UrlOrUriRef) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_Ipv4PrefixGloballyRoutable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_Ipv4PrefixGloballyRoutable{`,
		`Ipv4PrefixGloballyRoutable:` + fmt.Sprintf("%v", this.Ipv4PrefixGloballyRoutable) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_Ipv6PrefixGloballyRoutable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_Ipv6PrefixGloballyRoutable{`,
		`Ipv6PrefixGloballyRoutable:` + fmt.Sprintf("%v", this.Ipv6PrefixGloballyRoutable) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_IpPrefixGloballyRoutable) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_IpPrefixGloballyRoutable{`,
		`IpPrefixGloballyRoutable:` + fmt.Sprintf("%v", this.IpPrefixGloballyRoutable) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StringRules_VhDomainOrIp) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StringRules_VhDomainOrIp{`,
		`VhDomainOrIp:` + fmt.Sprintf("%v", this.VhDomainOrIp) + `,`,
		`}`,
	}, "")
	return s
...
func (this *MessageRules) String() string {
	...
	s := strings.Join([]string{`&MessageRules{`,
		...
		`FileContentMaxBytes:` + fmt.Sprintf("%v", this.FileContentMaxBytes) + `,`,
		`FileContentMinBytes:` + fmt.Sprintf("%v", this.FileContentMinBytes) + `,`,
		`DateRange:` + strings.Replace(this.DateRange.String(), "DateRangeRules", "DateRangeRules", 1) + `,`,
		`ValidateIpv4Range:` + fmt.Sprintf("%v", this.ValidateIpv4Range) + `,`,
		`ValidateIpv6Range:` + fmt.Sprintf("%v", this.ValidateIpv6Range) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *DateRangeRules) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DateRangeRules{`,
		`MinDuration:` + fmt.Sprintf("%v", this.MinDuration) + `,`,
...
func (m *StringRules) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 50:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TemplatedHttpPath", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_TemplatedHttpPath{b}
		case 60:
			if wireType != 2 {
		...
		case 63:
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_Glob{b}
		case 65:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VesServiceNamespaceName", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_VesServiceNamespaceName{b}
		case 66:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpStatusRange", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_HttpStatusRange{b}
		case 67:
			if wireType != 0 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_QueryTime{b}
		case 68:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryStep", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_QueryStep{b}
		case 69:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ipv4PrefixStrict", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_Ipv4PrefixStrict{b}
		case 70:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ipv6PrefixStrict", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_Ipv6PrefixStrict{b}
		case 71:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IpPrefixStrict", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_IpPrefixStrict{b}
		case 72:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IntermediateCertificateChainUrl", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_IntermediateCertificateChainUrl{b}
		case 73:
			if wireType != 0 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_CookieName{b}
		case 74:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxPorts", wireType)
			}
			m.MaxPorts = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxPorts |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 75:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UniquePortRangeList", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_UniquePortRangeList{b}
		case 76:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IpGloballyRoutable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_IpGloballyRoutable{b}
		case 77:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ipv4GloballyRoutable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_Ipv4GloballyRoutable{b}
		case 78:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ipv6GloballyRoutable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_Ipv6GloballyRoutable{b}
		case 79:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpValidMethods", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_HttpValidMethods{b}
		case 80:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UrlOrUriRef", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_UrlOrUriRef{b}
		case 81:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ipv4PrefixGloballyRoutable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_Ipv4PrefixGloballyRoutable{b}
		case 82:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ipv6PrefixGloballyRoutable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_Ipv6PrefixGloballyRoutable{b}
		case 83:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IpPrefixGloballyRoutable", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_IpPrefixGloballyRoutable{b}
		case 85:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VhDomainOrIp", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.WellKnown = &StringRules_VhDomainOrIp{b}
		default:
			iNdEx = preIndex
			skippy, err := skipValidate(dAtA[iNdEx:])
			if err != nil {
...
func (m *MessageRules) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FileContentMaxBytes", wireType)
			}
			m.FileContentMaxBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowValidate
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FileContentMaxBytes |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FileContentMinBytes", wireType)
			}
			m.FileContentMinBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowValidate
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FileContentMinBytes |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidateIpv4Range", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ValidateIpv4Range = bool(v != 0)
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidateIpv6Range", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *DateRangeRules) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DateRangeRules: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DateRangeRules: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 3:
			if wireType != 2 {
			...
			m.MinDuration = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
