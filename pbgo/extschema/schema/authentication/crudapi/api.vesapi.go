...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/authentication"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.authentication.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.authentication.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.authentication.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authentication.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authentication.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authentication.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authentication.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.authentication.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.authentication.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.authentication.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authentication.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authentication.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authentication.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authentication.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authentication.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authentication.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.authentication.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.authentication.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/authentication/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.authentication/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.authentication.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authentication-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.authentication.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.authentication.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authentication-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.authentication.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.authentication.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authentication-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.authentication.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "authentication",
            "x-ves-object-type": "ves.io.schema.authentication.Object",
            "x-ves-proto-service": "ves.io.schema.authentication.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.authentication/Objects": {
            "get": {
                "operationId": "ves.io.schema.authentication.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authentication-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.authentication.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.authentication.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authentication-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.authentication.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "authentication",
            "x-ves-object-type": "ves.io.schema.authentication.Object",
        ...
        "/ves.io.schema.authentication/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.authentication.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-authentication-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.authentication.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "authentication",
            "x-ves-object-type": "ves.io.schema.authentication.Object",
        ...
        "/ves.io.schema.authentication/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.authentication.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.authentication/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.authentication.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.authentication/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.authentication.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.authentication/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.authentication.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "authenticationGlobalSpecType": {
            "type": "object",
            "description": "Shape of Authentication Object",
            "title": "GlobalSpecType",
            "x-displayname": "Authentication Specification",
            "x-ves-oneof-field-auth_type_choice": "[\"oidc_auth\"]",
            "x-ves-proto-message": "ves.io.schema.authentication.GlobalSpecType",
            "properties": {
                "cookie_params": {
                    "description": " Cookie configuration details for this Object\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Cookie Configuration details",
        ...
        "authenticationOIDCAuthType": {
            ...
            "properties": {
                "client_secret": {
                    "description": " Client secret used while sending token verification request to OIDC server\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "authenticationSpecType": {
            "type": "object",
            "description": "Shape of the Authentication specification",
            "title": "Specification of Authentication",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.authentication.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/authenticationGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "authenticationStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of Authentication Object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.authentication.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "authenticationcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.authentication.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authentication.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/authenticationSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authentication.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/authenticationcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authentication.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/authenticationcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authentication.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/authenticationStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authentication.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/authenticationcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authentication.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authentication.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.authentication.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/authenticationcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/authentication/crudapi/api.proto"
}`
