...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/endpoints", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/endpoints/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/endpoints/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/endpoints", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.endpoint.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.endpoint")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.endpoint.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.endpoint.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.endpoint.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.endpoint.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.endpoint.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	reqMsgFQN := "ves.io.schema.endpoint.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.endpoint.API.Create' operation on 'endpoint'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.endpoint.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.endpoint.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.endpoint.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.endpoint.API.Replace' operation on 'endpoint'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.endpoint.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.endpoint.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.endpoint.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.endpoint.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.endpoint.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.endpoint.API.Delete' operation on 'endpoint'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.endpoint.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/endpoints": {
            ...
            "x-ves-proto-service": "ves.io.schema.endpoint.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/endpoints/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/endpointReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/endpoints": {
            "get": {
        ...
        "/public/namespaces/{namespace}/endpoints/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/endpointGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
    ...
    "definitions": {
        "endpointConsulInfo": {
            "type": "object",
            "description": "Service instance resolved from Consul discovery",
            "title": "ConsulInfo",
            "x-displayname": "Consul Info",
            "x-ves-proto-message": "ves.io.schema.endpoint.ConsulInfo",
            "properties": {
                "instance_name": {
                    "type": "array",
                    "description": " Consul Service instance name",
                    "title": "x-displayName: \"Consul resolved service instance\"\nx-example: \"web.service.consul\"\nConsul Service instance name",
                    "items": {
                        "type": "string"
                    },
                    "x-displayname": "Consul resolved service instance",
                    "x-ves-example": "web.service.consul"
                },
                "labels": {
                    "type": "object",
        ...
        "endpointCreateRequest": {
            ...
            "title": "CreateRequest is used to create an instance of endpoint",
        ...
        "endpointDNSInfo": {
            "type": "object",
            "description": "Addresses resolved from DNS discovery",
            "title": "DNSInfo",
            "x-displayname": "DNS Info",
            "x-ves-proto-message": "ves.io.schema.endpoint.DNSInfo",
            "properties": {
                "resolved_ips": {
                    "type": "array",
                    "description": " IP addresses from DNS resolution",
                    "title": "x-displayName: \"DNS resolved addresses\"\nx-example: \"13.84.78.21\"\nIP addresses from DNS resolution",
                    "items": {
                        "type": "string"
                    },
                    "x-displayname": "DNS resolved addresses",
                    "x-ves-example": "13.84.78.21"
                }
            }
        },
        ...
        "endpointDiscoveredInfoType": {
            ...
            "title": "DiscoveredInfoType",
            "x-displayname": "Discovered Info Type",
            "x-ves-oneof-field-discovered_info": "[\"consul_info\",\"dns_info\",\"k8s_info\"]",
        ...
        "endpointGetResponse": {
            ...
            "title": "GetResponse is the shape of a read endpoint",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/endpointStatusObject"
                    },
        ...
        "endpointK8SInfo": {
            "type": "object",
            "description": "Discovered Information for Kubernetes endpoints",
            "title": "K8SInfo",
            "x-displayname": "K8s Info",
            "x-ves-proto-message": "ves.io.schema.endpoint.K8SInfo",
            "properties": {
                "in_cluster_discovery": {
                    "type": "boolean",
                    "description": " Specifies whether discovery is from local Kubernetes cluster\n\nExample: - true-",
                ...
                "pod_name": {
                    "type": "array",
                    "description": " Pod Names of the endpoint\n\nExample: - \"ver-l99cw\"-",
                    "title": "pod_name",
                    "items": {
                        "type": "string"
                    },
        ...
        "endpointListResponse": {
            ...
            "title": "ListResponse is the collection of endpoint",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.endpoint.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/endpointListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "endpointListResponseItem": {
            "type": "object",
            "description": "By default a summary of endpoint is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of endpoint",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.endpoint.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this endpoint",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this endpoint",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates endpoint is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this endpoint",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this endpoint\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
        ...
        "endpointReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a endpoint",
        ...
        "endpointServiceInfoType": {
            ...
            "properties": {
                ...
                "service_selector": {
                    "description": "Exclusive with [service_name]\n Labels of the service to discover\n By default services will be discovered from all discovery objects for the site.\n If user want to restrict discovery from specific discovery object, then\n he can configure implicit label with \"name.ves.io/discovery-cluster\" as key and\n the value as the cluster identifier of the discovery object in which\n discovery has to happen. This implicit label is added to service_selector",
        ...
        "endpointVerStatusType": {
            "type": "object",
            "description": "Status information sent for endpoints",
            "title": "VerStatusType",
            "x-displayname": "VER Status Type",
            "x-ves-proto-message": "ves.io.schema.endpoint.VerStatusType",
            "properties": {
                "allocated_ip": {
                    "description": " Allocated AIN IP of the endpoint",
                    "title": "allocated_ip",
                ...
                "discovered_info": {
                    "description": " Discovered Information for endpoints",
                    "title": "DiscoveredInfoType",
                    "$ref": "#/definitions/endpointDiscoveredInfoType",
                    "x-displayname": "Discovered Info"
                },
                "discovered_ip": {
                    "description": " Discovered IP of the endpoint",
                    "title": "discovered_ip",
                ...
                "discovered_port": {
                    "type": "integer",
                    "description": " Discovered port of the endpoint\n\nExample: - 9080-",
                ...
                "site": {
                    "type": "string",
                    "description": " site name of the endpoint\n\nExample: - \"ce01\"-",
                    "title": "site",
                    "x-displayname": "Site",
                    "x-ves-example": "ce01"
                }
    ...
    "x-displayname": "Endpoint",
    "x-ves-proto-file": "ves.io/schema/endpoint/public_crudapi.proto"
}`
