...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/endpoint"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.endpoint.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.endpoint.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/endpoint/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.endpoint/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-endpoint-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.endpoint.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-endpoint-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.endpoint.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-endpoint-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.endpoint.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "endpoint",
            "x-ves-object-type": "ves.io.schema.endpoint.Object",
            "x-ves-proto-service": "ves.io.schema.endpoint.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.endpoint/Objects": {
            "get": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-endpoint-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.endpoint.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-endpoint-crudapi-api-create"
                },
        ...
        "/ves.io.schema.endpoint/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-endpoint-crudapi-api-liststream"
                },
        ...
        "/ves.io.schema.endpoint/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.endpoint/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.endpoint/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.endpoint/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.endpoint.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.endpoint.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.endpoint.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.endpoint.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "endpointSpecType": {
            "type": "object",
            "description": "Shape of the endpoint specification",
            "title": "Specification for Endpoint",
            ...
            "properties": {
                "gc_spec": {
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemaendpointGlobalSpecType",
        ...
        "endpointTMMPoolMemberType": {
            "type": "object",
            "title": "TMM Pool Member",
            "x-displayname": "TMM Pool Member",
            "x-ves-proto-message": "ves.io.schema.endpoint.TMMPoolMemberType",
            "properties": {
                "member_selection": {
        ...
        "schemaendpointGlobalSpecType": {
            ...
            "x-ves-oneof-field-endpoint_type": "[\"default_endpoint\",\"tmm_pool_member_endpoint\"]",
            ...
            "properties": {
                "default_endpoint": {
                    "description": "Exclusive with [tmm_pool_member_endpoint]\n",
                    "title": "Default",
                    "$ref": "#/definitions/schemaEmpty",
                ...
                "tmm_pool_member_endpoint": {
                    "description": "Exclusive with [default_endpoint]\n Supporting config which is configured only for TMM Pool member, This option is hidden and will not be set for non-TMM usecase",
                    "title": "TMM Pool Member",
                    "$ref": "#/definitions/endpointTMMPoolMemberType",
                    "x-displayname": "TMM Pool Member"
                },
                "where": {
    ...
    "x-ves-proto-file": "ves.io/schema/endpoint/crudapi/api.proto"
}`
