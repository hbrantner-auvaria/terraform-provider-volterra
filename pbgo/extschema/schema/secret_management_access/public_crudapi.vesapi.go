...
const (
	...
	CreateRequestFQN = "ves.io.schema.secret_management_access.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.secret_management_access.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.secret_management_access.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.secret_management_access.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.secret_management_access.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.secret_management_access.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.secret_management_access.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.secret_management_access.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.secret_management_access.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.secret_management_access.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/secret_management_accesss", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/secret_management_accesss/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/secret_management_accesss/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/secret_management_accesss", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/secret_management_accesss/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.secret_management_access.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.secret_management_access")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.secret_management_access.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.secret_management_access.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.secret_management_access.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.secret_management_access.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.secret_management_access.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.secret_management_access.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.secret_management_access.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.secret_management_access.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.secret_management_access.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.secret_management_access.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.secret_management_access.API.Create' operation on 'secret_management_access'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.secret_management_access.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.secret_management_access.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.secret_management_access.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.secret_management_access.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.secret_management_access.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.secret_management_access.API.Replace' operation on 'secret_management_access'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.secret_management_access.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.secret_management_access.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.secret_management_access.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.secret_management_access.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.secret_management_access.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.secret_management_access.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.secret_management_access.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.secret_management_access.API.Delete' operation on 'secret_management_access'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.secret_management_access.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "Secret Management Access config object",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/secret_management_accesss": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/secret_management_accessCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/secret_management_accessCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.secret_management_access.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/secret_management_accesss/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/secret_management_accessReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/secret_management_accessReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/secret_management_accesss": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/secret_management_accessListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/secret_management_accesss/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/secret_management_accessGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/secret_management_accessDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "schemaAppRoleAuthInfoType": {
            "type": "object",
            "description": "AppRoleAuthInfoType contains parameters for AppRole authentication in Hashicorp Vault",
            "title": "AppRoleAuthInfoType",
            "x-displayname": "Vault AppRole Authentication Parameters",
            "x-ves-proto-message": "ves.io.schema.AppRoleAuthInfoType",
            "properties": {
                "role_id": {
                    "type": "string",
                    "description": " role-id to be used for authentication\n\nExample: - \"value\"-",
                    "title": "role-id",
                    "x-displayname": "Role ID",
                    "x-ves-example": "value"
                },
                "secret_id": {
                    "description": " F5XC Secret. Secret-id to be used for authentication. secret-id has to be long lived.",
                    "title": "secret-id",
        ...
        "schemaAuthnTypeBasicAuth": {
            ...
            "properties": {
                ...
                "username": {
                    "type": "string",
                    "description": " The username to encode in Basic Auth scheme\n\nExample: - \"value\"-",
                    "title": "username",
        ...
        "schemaHostAccessInfoType": {
            ...
            "properties": {
                "rest_auth_info": {
                    "description": "Exclusive with [vault_auth_info]\n Authentication parameters to be used against the REST backend",
                    "title": "rest_auth_info",
                    "$ref": "#/definitions/schemaRestAuthInfoType",
                    "x-displayname": "Rest Authentication Parameters"
                },
                "scheme": {
                    "description": " URL scheme to use for connection",
                    "title": "scheme",
                    "$ref": "#/definitions/schemaURLSchemeType",
                    "x-displayname": "URL Scheme"
                },
                "server_endpoint": {
                    "type": "string",
                    "description": " endpoint to connect to, in host:port format\n\nExample: - \"webserver:443\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "server_endpoint",
                    "minLength": 1,
                    "maxLength": 256,
                    "x-displayname": "Server Endpoint and Port",
                    "x-ves-example": "webserver:443",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.max_len": "256",
                ...
                "vault_auth_info": {
                    "description": "Exclusive with [rest_auth_info]\n Authentication parameters to be used against Hashicorp Vault backend",
                    "title": "vault_auth_info",
                    "$ref": "#/definitions/schemaVaultAuthInfoType",
        ...
        "schemaRestAuthInfoType": {
            ...
            "properties": {
                "basic_auth": {
                    "description": "Exclusive with [headers_auth query_params_auth]\n BasicAuth parameters for authentication",
                    "title": "basic_auth",
                    "$ref": "#/definitions/schemaAuthnTypeBasicAuth",
                    "x-displayname": "BasicAuth Parameters"
                },
                "headers_auth": {
                    "description": "Exclusive with [basic_auth query_params_auth]\n This needs to be used if the authentication parameters are to be passed in request header",
                    "title": "headers_auth",
                    "$ref": "#/definitions/schemaAuthnTypeHeaders",
                    "x-displayname": "Headers Based Auth"
                },
                "query_params_auth": {
                    "description": "Exclusive with [basic_auth headers_auth]\n This needs to be used if the authentication parameters are to be passed as query params in URL",
                    "title": "query_params_auth",
                    "$ref": "#/definitions/schemaAuthnTypeQueryParams",
                    "x-displayname": "Authentication QueryParams"
                }
            }
        },
        ...
        "schemaVaultAuthInfoType": {
            "type": "object",
            "description": "Authentication parameters for Hashicorp Vault hosts",
            "title": "VaultAuthTypeInfo",
            "x-displayname": "Vault Authentication Parameters",
            "x-ves-oneof-field-auth_params": "[\"app_role_auth\",\"token\"]",
            "x-ves-proto-message": "ves.io.schema.VaultAuthInfoType",
            "properties": {
                "app_role_auth": {
                    "description": "Exclusive with [token]\n app_role_auth is specified if approle method is to be used for authentication",
                    "title": "app_role_auth",
                    "$ref": "#/definitions/schemaAppRoleAuthInfoType",
                    "x-displayname": "AppRole Authentication"
                },
                "token": {
                    "description": "Exclusive with [app_role_auth]\n token is specified if token method is to be used for authentication. This token has to be long lived.",
                    "title": "token_auth",
                    "$ref": "#/definitions/schemaSecretType",
        ...
        "secret_management_accessCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of secret_management_access",
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/secret_management_accessCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "secret_management_accessCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the discovery",
                    "title": "spec",
                    "$ref": "#/definitions/secret_management_accessGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "secret_management_accessCreateSpecType": {
            "type": "object",
            "description": "Create secret_management_access creates a new object in storage backend for metadata.namespace.",
            "title": "Create Secret Management Access Object",
            "x-displayname": "Create Secret Management Access",
            "x-ves-displayorder": "2,3,1",
            "x-ves-proto-message": "ves.io.schema.secret_management_access.CreateSpecType",
            "properties": {
                "access_info": {
                    "description": " access_info contains information about how to connect to remote secret management host\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/schemaHostAccessInfoType",
                    "x-displayname": "Secret Management Access Information",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
                ...
                "provider_name": {
                    "type": "string",
                    "description": " Name given to this secret management backend. site.provider needs to be unique, and will be referenced for using this object\n\nExample: - \"vault_backend\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.min_len: 1\n",
                    "minLength": 1,
                    "maxLength": 256,
                    "x-displayname": "Provider Name",
                    "x-ves-example": "vault_backend",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.max_len": "256",
                ...
                "where": {
                    "description": " Site or network where to advertise this secret_management_access  object.",
                    "$ref": "#/definitions/schemaNetworkSiteRefSelector",
                    "x-displayname": "Where"
                }
            }
        },
        "secret_management_accessDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a secret_management_access",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.secret_management_access.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "secret_management_accessGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read secret_management_access",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/secret_management_accessStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "secret_management_accessGetResponseFormatCode": {
            "type": "string",
        ...
        "secret_management_accessGetSpecType": {
            "type": "object",
            "description": "Get secret_management_access reads a given object from storage backend for metadata.namespace.",
            "title": "Get Secret Management Access Object",
            "x-displayname": "Get Secret Management Access",
            "x-ves-displayorder": "2,3,1",
        ...
        "secret_management_accessListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of secret_management_access",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.secret_management_access.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/secret_management_accessListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "secret_management_accessListResponseItem": {
            "type": "object",
            "description": "By default a summary of secret_management_access is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of secret_management_access",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.secret_management_access.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates secret_management_access is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this secret_management_access\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this secret_management_access\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "secret_management_accessReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a secret_management_access",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the discovery",
                    "title": "spec",
                    "$ref": "#/definitions/secret_management_accessReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "secret_management_accessReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.secret_management_access.ReplaceResponse"
        },
        "secret_management_accessReplaceSpecType": {
            "type": "object",
            "description": "Replace secret_management_access replaces an existing object in storage backend for metadata.namespace.",
            "title": "Replace Secret Management Access Object",
            "x-displayname": "Replace Secret Management Access",
            "x-ves-displayorder": "2,3,1",
        ...
        "secret_management_accessStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status for secret managment access",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.secret_management_access.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-displayname": "Secret Management Access",
    "x-ves-proto-file": "ves.io/schema/secret_management_access/public_crudapi.proto"
}`
