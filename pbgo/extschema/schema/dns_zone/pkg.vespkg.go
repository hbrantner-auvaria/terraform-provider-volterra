...
func initializeValidatorRegistry(vr map[string]db.Validator) {
	vr["ves.io.schema.dns_zone.CryptoKey"] = CryptoKeyValidator()
	...
	vr["ves.io.schema.dns_zone.AddCryptoKeyRequest"] = AddCryptoKeyRequestValidator()
	vr["ves.io.schema.dns_zone.AddCryptoKeyResponse"] = AddCryptoKeyResponseValidator()
	vr["ves.io.schema.dns_zone.CloneReq"] = CloneReqValidator()
	vr["ves.io.schema.dns_zone.CloneResp"] = CloneRespValidator()
	vr["ves.io.schema.dns_zone.DeleteCryptoKeyRequest"] = DeleteCryptoKeyRequestValidator()
	vr["ves.io.schema.dns_zone.DeleteCryptoKeyResponse"] = DeleteCryptoKeyResponseValidator()
	vr["ves.io.schema.dns_zone.EditCryptoKeyRequest"] = EditCryptoKeyRequestValidator()
	vr["ves.io.schema.dns_zone.EditCryptoKeyResponse"] = EditCryptoKeyResponseValidator()
	...
	vr["ves.io.schema.dns_zone.GetCryptoKeysRequest"] = GetCryptoKeysRequestValidator()
	vr["ves.io.schema.dns_zone.GetCryptoKeysResponse"] = GetCryptoKeysResponseValidator()
	...
	vr["ves.io.schema.dns_zone.GetLocalZoneRecordNamesRequest"] = GetLocalZoneRecordNamesRequestValidator()
	vr["ves.io.schema.dns_zone.GetLocalZoneRecordNamesResponse"] = GetLocalZoneRecordNamesResponseValidator()
	...
	vr["ves.io.schema.dns_zone.InitiateZoneTransferRequest"] = InitiateZoneTransferRequestValidator()
	vr["ves.io.schema.dns_zone.InitiateZoneTransferResponse"] = InitiateZoneTransferResponseValidator()
