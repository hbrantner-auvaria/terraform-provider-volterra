...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/waf_violations"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.waf_violations.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.waf_violations.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.waf_violations.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_violations.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_violations.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_violations.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_violations.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_violations.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.waf_violations.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.waf_violations.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_violations.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_violations.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_violations.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_violations.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_violations.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_violations.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_violations.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_violations.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/waf_violations/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.waf_violations/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_violations-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_violations.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_violations-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_violations.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_violations-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_violations.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_violations",
            "x-ves-object-type": "ves.io.schema.waf_violations.Object",
            "x-ves-proto-service": "ves.io.schema.waf_violations.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.waf_violations/Objects": {
            "get": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_violations-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_violations.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_violations-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_violations.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_violations",
            "x-ves-object-type": "ves.io.schema.waf_violations.Object",
        ...
        "/ves.io.schema.waf_violations/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_violations-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_violations.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_violations",
            "x-ves-object-type": "ves.io.schema.waf_violations.Object",
        ...
        "/ves.io.schema.waf_violations/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_violations/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_violations/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_violations/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.waf_violations.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/waf_violationsSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/waf_violationscrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/waf_violationscrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/waf_violationsStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/waf_violationscrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/waf_violationscrudapiErrorCode"
                },
        ...
        "schemawaf_violationsGlobalSpecType": {
            "type": "object",
            "title": "GlobalSpecType",
            "x-displayname": "Violations default settings Specification",
            "x-ves-proto-message": "ves.io.schema.waf_violations.GlobalSpecType",
            "properties": {
                "violations": {
                    "type": "array",
                    "description": " List of violation types and their default settings\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 256\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "violations default settings",
                    "minItems": 1,
                    "maxItems": 256,
                    "items": {
                        "$ref": "#/definitions/waf_violationsViolationDefaultSettings"
                    },
        ...
        "waf_violationsSpecType": {
            "type": "object",
            "description": "Shape of the WAF violations Object specification",
            "title": "WAF violations Object Specification",
            "x-displayname": "WAF violations Object Specification",
            "x-ves-proto-message": "ves.io.schema.waf_violations.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemawaf_violationsGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "waf_violationsStatusObject": {
            "type": "object",
            "description": "WAF violations Object to configure violations default settings.",
            "title": "WAF violations Object",
            "x-displayname": "WAF violations Object",
            "x-ves-proto-message": "ves.io.schema.waf_violations.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "waf_violationsViolationDefaultSettings": {
            "type": "object",
            "description": "Configuration of violations default settings",
            "title": "Violation Default Settings",
            "x-displayname": "Violation Default Settings",
            "x-ves-oneof-field-default_state_choice": "[\"disabled\",\"enabled\"]",
            "x-ves-proto-message": "ves.io.schema.waf_violations.ViolationDefaultSettings",
            "properties": {
                "description": {
                    "type": "string",
                ...
                "title": {
                    "type": "string",
                    "description": " violation title\n\nExample: - \"IIS Unicode Codepoints\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "violation title",
                    "x-displayname": "Violation title",
                    "x-ves-example": "IIS Unicode Codepoints",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
        ...
        "waf_violationscrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.waf_violations.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/waf_violations/crudapi/api.proto"
}`
