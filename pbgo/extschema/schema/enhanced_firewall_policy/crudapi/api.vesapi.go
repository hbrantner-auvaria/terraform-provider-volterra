...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/enhanced_firewall_policy"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.enhanced_firewall_policy.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.enhanced_firewall_policy.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.enhanced_firewall_policy.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.enhanced_firewall_policy.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.enhanced_firewall_policy.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.enhanced_firewall_policy.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.enhanced_firewall_policy.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.enhanced_firewall_policy.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.enhanced_firewall_policy.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.enhanced_firewall_policy.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.enhanced_firewall_policy.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.enhanced_firewall_policy.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.enhanced_firewall_policy.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.enhanced_firewall_policy.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.enhanced_firewall_policy.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.enhanced_firewall_policy.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/enhanced_firewall_policy/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.enhanced_firewall_policy/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-enhanced_firewall_policy-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-enhanced_firewall_policy-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-enhanced_firewall_policy-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "enhanced_firewall_policy",
            "x-ves-object-type": "ves.io.schema.enhanced_firewall_policy.Object",
            "x-ves-proto-service": "ves.io.schema.enhanced_firewall_policy.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.enhanced_firewall_policy/Objects": {
            "get": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-enhanced_firewall_policy-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.enhanced_firewall_policy.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-enhanced_firewall_policy-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "enhanced_firewall_policy",
            "x-ves-object-type": "ves.io.schema.enhanced_firewall_policy.Object",
        ...
        "/ves.io.schema.enhanced_firewall_policy/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-enhanced_firewall_policy-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.enhanced_firewall_policy.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "enhanced_firewall_policy",
            "x-ves-object-type": "ves.io.schema.enhanced_firewall_policy.Object",
        ...
        "/ves.io.schema.enhanced_firewall_policy/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.enhanced_firewall_policy/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.enhanced_firewall_policy/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.enhanced_firewall_policy/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.enhanced_firewall_policy.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/enhanced_firewall_policySpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/enhanced_firewall_policycrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/enhanced_firewall_policycrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/enhanced_firewall_policyStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/enhanced_firewall_policycrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/enhanced_firewall_policycrudapiErrorCode"
                },
        ...
        "enhanced_firewall_policyEnhancedFirewallPolicyRuleListType": {
            ...
            "properties": {
                "rules": {
                    ...
                    "maxItems": 128,
                    "items": {
                        "$ref": "#/definitions/enhanced_firewall_policyEnhancedFirewallPolicyRuleType"
                    },
        ...
        "enhanced_firewall_policyEnhancedFirewallPolicyRuleType": {
            ...
            "properties": {
                "advanced_action": {
                    "description": " Log any connection matching the rule",
                ...
                "allow": {
                    "description": "Exclusive with [deny insert_service]\n Allow any connection matching the rule",
                    "title": "Allow",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Allow"
                },
                ...
                "deny": {
                    "description": "Exclusive with [allow insert_service]\n Deny any connection matching the rule",
                    "title": "Deny",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Deny"
                },
                ...
                "label_matcher": {
                    "description": " A list of label keys that identify the label values that need to be the same for the source and destination. Note that the actual label values are\n not specified here, just the label keys. This facilitates reuse of policies across multiple dimensions such as deployment, environment, and location.",
                    "title": "Common Label Matcher for Source and Destination",
                ...
                "outside_sources": {
                    ...
                    "title": "All Source Reachable via all outside interfaces",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Addresses Reachable On Outside Network"
                },
                "protocol_port_range": {
                ...
                "source_ip_prefix_set": {
                    "description": "Exclusive with [all_sources inside_sources outside_sources source_aws_vpc_ids source_label_selector source_prefix_list]\n Addresses that match one of the prefix in the ip-prefix-set",
                    "title": "IP Prefix Set",
                    "$ref": "#/definitions/schemaIpPrefixSetRefType",
                    "x-displayname": "IP Prefix Set"
                },
                "source_label_selector": {
                    "description": "Exclusive with [all_sources inside_sources outside_sources source_aws_vpc_ids source_ip_prefix_set source_prefix_list]\n Source is a set of addresses determined by label selector expression.\n These labels can be cloud tags defined on the vpc resource, labels on the global network or others.\n\nExample: - \"app != web\"-",
                ...
                "source_prefix_list": {
                    "description": "Exclusive with [all_sources inside_sources outside_sources source_aws_vpc_ids source_ip_prefix_set source_label_selector]\n Addresses that match one of the prefix in the list\n list contains sublist of both v4 and v6 prfix list",
                    "title": "ip prefix list",
                    "$ref": "#/definitions/viewsPrefixStringListType",
                    "x-displayname": "IP Prefix List"
                }
        ...
        "enhanced_firewall_policyOperGlobalSpecType": {
            ...
            "properties": {
                ...
                "nfv_service": {
                    "type": "array",
                    "description": "x-displayName: \"NFV Service\"\nReference to a nfv-service object",
                    "title": "NFV Service reference",
                    "items": {
                        "$ref": "#/definitions/ioschemaObjectRefType"
                    }
                }
        ...
        "enhanced_firewall_policyServiceActionType": {
            ...
            "properties": {
                "nfv_service": {
                    "description": " Select External Service, to which the traffic should be forwarded to. Forwarding to Palo Alto Networks external service is supported.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "enhanced_firewall_policySpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemaenhanced_firewall_policyGlobalSpecType",
        ...
        "enhanced_firewall_policycrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.enhanced_firewall_policy.crudapi.ErrorCode"
        },
        ...
        "schemaenhanced_firewall_policyGlobalSpecType": {
            "type": "object",
            "description": "Desired state for Enhanced Firewall Policy",
            ...
            "x-ves-proto-message": "ves.io.schema.enhanced_firewall_policy.GlobalSpecType",
            "properties": {
                "allow_all": {
                    "description": "Exclusive with [allowed_destinations allowed_sources denied_destinations denied_sources deny_all rule_list]\n Allow all connections from any source to any destination",
                    "title": "Allow all connections",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Allow all connections"
                },
                "allowed_destinations": {
                    "description": "Exclusive with [allow_all allowed_sources denied_destinations denied_sources deny_all rule_list]\n Allow all connections to list of destinations from any source",
                    "title": "List of allowed destination prefixes",
                    "$ref": "#/definitions/schemaPrefixListType",
                    "x-displayname": "Allowed destination prefixes"
                },
                "allowed_sources": {
                    "description": "Exclusive with [allow_all allowed_destinations denied_destinations denied_sources deny_all rule_list]\n Allow all connections from list of sources to any destination",
                    "title": "List of allowed source prefixes",
                    "$ref": "#/definitions/schemaPrefixListType",
                    "x-displayname": "Allowed source prefixes"
                },
                "denied_destinations": {
                    "description": "Exclusive with [allow_all allowed_destinations allowed_sources denied_sources deny_all rule_list]\n Deny all connections to list of destinations from any source",
                    "title": "List of denied destination prefixes",
                    "$ref": "#/definitions/schemaPrefixListType",
                    "x-displayname": "Denied destination prefixes"
                },
                "denied_sources": {
                    "description": "Exclusive with [allow_all allowed_destinations allowed_sources denied_destinations deny_all rule_list]\n Deny all connections from list of sources to any destination",
                    "title": "List of denied source prefixes",
                    "$ref": "#/definitions/schemaPrefixListType",
                    "x-displayname": "Denied source prefixes"
                },
                "deny_all": {
                    "description": "Exclusive with [allow_all allowed_destinations allowed_sources denied_destinations denied_sources rule_list]\n Deny all connections from any source to any destination",
                    "title": "Deny all connections",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Deny all connections"
                },
                "rule_list": {
    ...
    "x-ves-proto-file": "ves.io/schema/enhanced_firewall_policy/crudapi/api.proto"
}`
