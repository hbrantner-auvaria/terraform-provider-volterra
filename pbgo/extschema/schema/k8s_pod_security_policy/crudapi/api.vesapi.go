...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/k8s_pod_security_policy"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.k8s_pod_security_policy.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.k8s_pod_security_policy.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.k8s_pod_security_policy.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_policy.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_policy.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_policy.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_policy.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.k8s_pod_security_policy.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.k8s_pod_security_policy.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.k8s_pod_security_policy.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_policy.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_pod_security_policy.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_policy.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_pod_security_policy.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_policy.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_policy.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.k8s_pod_security_policy.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.k8s_pod_security_policy.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/k8s_pod_security_policy/crudapi/api.proto",
    ...
    "paths": {
        "/ves.io.schema.k8s_pod_security_policy/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_policy-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_policy-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_policy-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_pod_security_policy",
            "x-ves-object-type": "ves.io.schema.k8s_pod_security_policy.Object",
            "x-ves-proto-service": "ves.io.schema.k8s_pod_security_policy.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.k8s_pod_security_policy/Objects": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_policy-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_policy.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_policy-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_pod_security_policy",
            "x-ves-object-type": "ves.io.schema.k8s_pod_security_policy.Object",
        ...
        "/ves.io.schema.k8s_pod_security_policy/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-k8s_pod_security_policy-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.k8s_pod_security_policy.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_pod_security_policy",
            "x-ves-object-type": "ves.io.schema.k8s_pod_security_policy.Object",
        ...
        "/ves.io.schema.k8s_pod_security_policy/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_pod_security_policy/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_pod_security_policy/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.k8s_pod_security_policy/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.k8s_pod_security_policy.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/k8s_pod_security_policySpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_pod_security_policycrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_pod_security_policycrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/k8s_pod_security_policyStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_pod_security_policycrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_pod_security_policycrudapiErrorCode"
                },
        ...
        "k8s_pod_security_policyCapabilityListType": {
            "type": "object",
            "description": "List of capabilities that docker container has.",
            "title": "Capability List",
            "x-displayname": "Capability List",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.CapabilityListType",
            "properties": {
                "capabilities": {
                    "type": "array",
        ...
        "k8s_pod_security_policyGlobalSpecType": {
            "type": "object",
            "description": "Configuration specification for K8s Pod Security Policy",
        ...
        "k8s_pod_security_policyHostPathType": {
            "type": "object",
            "description": "Host path and read/write or read-only",
            "title": "Host Path",
            "x-displayname": "Host Path",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.HostPathType",
            "properties": {
                "path_prefix": {
                    "type": "string",
                ...
                "read_only": {
                    "type": "boolean",
                    "description": " This volume will be allowed to mount read only.",
                    "title": "Read Only",
                    "format": "boolean",
        ...
        "k8s_pod_security_policyIDStrategyOptionsType": {
            "type": "object",
            "description": "ID ranges and rules",
            "title": "ID(User,Group,FSGroup) Strategy",
            "x-displayname": "ID(User,Group,FSGroup) Strategy",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.IDStrategyOptionsType",
            "properties": {
                "id_ranges": {
                    "type": "array",
        ...
        "k8s_pod_security_policyPodSecurityPolicySpecType": {
            "type": "object",
            ...
            "properties": {
                "allow_privilege_escalation": {
                    "type": "boolean",
                    "description": " Pod can request to privilege escalation",
                ...
                "default_allow_privilege_escalation": {
                    "type": "boolean",
                    "description": " Pod has permission for privilege escalation by default",
                ...
                "host_ipc": {
                    "type": "boolean",
                    "description": " Host IPC determines if the policy allows the use of host IPC in the pod spec.",
                    "title": "Host IPC",
                    "format": "boolean",
                ...
                "host_network": {
                    "type": "boolean",
                    "description": " Host Network determines if the policy allows the use of host network in the pod spec.",
                    "title": "Host Network",
                    "format": "boolean",
                ...
                "host_pid": {
                    "type": "boolean",
                    "description": " Host PID determines if the policy allows the use of host PID in the pod spec.",
                    "title": "Host PID",
                    "format": "boolean",
                ...
                "read_only_root_filesystem": {
                    "type": "boolean",
                    "description": " Containers can only run with read only root filesystem.",
        ...
        "k8s_pod_security_policySpecType": {
            "type": "object",
            "description": "Shape of the k8s_pod_security_policy specification",
            "title": "Specification for K8s Pod Security Policy",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/k8s_pod_security_policyGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "k8s_pod_security_policyStatusObject": {
            "type": "object",
            ...
            "x-ves-proto-message": "ves.io.schema.k8s_pod_security_policy.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "k8s_pod_security_policycrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.k8s_pod_security_policy.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/k8s_pod_security_policy/crudapi/api.proto"
}`
