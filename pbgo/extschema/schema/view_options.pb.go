...
// match_condition
//
// x-displayName: "Match Condition"
// Contains info regarding match type and values to match for field.
type MatchCondition struct {
	// match_type
	//
	// x-displayName: "Match type"
	// Match type for field at field path.
	...
	// List of values for a field to match based on match type.
...
func (m *MatchCondition) GetMatchType() string {
	if m != nil {
		return m.MatchType
	}
	return ""
...
func (m *MatchCondition) GetValues() []string {
	if m != nil {
		return m.Values
	}
	return nil
...
//
// x-displayName: "Progressive Disclosure"
// Contains info regarding field_path and match conditions.
type ProgressiveDisclosure struct {
	// field_name
	//
	// x-displayName: "Field Name"
	// Name of field whose values needs to be matched.
	FieldName string `protobuf:"bytes,1,opt,name=field_name,json=fieldName,proto3" json:"field_name,omitempty"`
	// match_condition
	//
	// x-displayName: "Match Condition"
	// Match values for field specified by field_name based on info in match condition.
	MatchCondition *MatchCondition `protobuf:"bytes,2,opt,name=match_condition,json=matchCondition,proto3" json:"match_condition,omitempty"`
}

func (m *ProgressiveDisclosure) Reset()      { *m = ProgressiveDisclosure{} }
func (*ProgressiveDisclosure) ProtoMessage() {}
func (*ProgressiveDisclosure) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e60bc66177b50a0, []int{12}
}
func (m *ProgressiveDisclosure) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProgressiveDisclosure) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ProgressiveDisclosure) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProgressiveDisclosure.Merge(m, src)
}
func (m *ProgressiveDisclosure) XXX_Size() int {
	return m.Size()
}
func (m *ProgressiveDisclosure) XXX_DiscardUnknown() {
	xxx_messageInfo_ProgressiveDisclosure.DiscardUnknown(m)
}

var xxx_messageInfo_ProgressiveDisclosure proto.InternalMessageInfo

func (m *ProgressiveDisclosure) GetFieldName() string {
	if m != nil {
		return m.FieldName
	}
	return ""
...
func (m *ProgressiveDisclosure) GetMatchCondition() *MatchCondition {
	if m != nil {
...
func (*HintWithAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e60bc66177b50a0, []int{34}
}
...
func (*HintWithLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e60bc66177b50a0, []int{35}
}
...
var E_ProgressiveDisclosure = &proto.ExtensionDesc{
	ExtendedType:  (*descriptor.FieldOptions)(nil),
	ExtensionType: (*ProgressiveDisclosure)(nil),
	Field:         3031,
	Name:          "ves.io.schema.progressive_disclosure",
	Tag:           "bytes,3031,opt,name=progressive_disclosure",
	Filename:      "ves.io/schema/view_options.proto",
}
...
func init() {
	...
	proto.RegisterType((*MatchCondition)(nil), "ves.io.schema.MatchCondition")
	golang_proto.RegisterType((*MatchCondition)(nil), "ves.io.schema.MatchCondition")
	proto.RegisterType((*ProgressiveDisclosure)(nil), "ves.io.schema.ProgressiveDisclosure")
	golang_proto.RegisterType((*ProgressiveDisclosure)(nil), "ves.io.schema.ProgressiveDisclosure")
	...
	proto.RegisterExtension(E_ProgressiveDisclosure)
...
var fileDescriptor_2e60bc66177b50a0 = []byte{
	...
	,
}
...
func (this *MatchCondition) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MatchCondition)
	if !ok {
		that2, ok := that.(MatchCondition)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ProgressiveDisclosure) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ProgressiveDisclosure)
	if !ok {
		that2, ok := that.(ProgressiveDisclosure)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.MatchCondition.Equal(that1.MatchCondition) {
		return false
	}
	return true
}
...
func (this *MatchCondition) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&schema.MatchCondition{")
	s = append(s, "MatchType: "+fmt.Sprintf("%#v", this.MatchType)+",\n")
	s = append(s, "Values: "+fmt.Sprintf("%#v", this.Values)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ProgressiveDisclosure) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&schema.ProgressiveDisclosure{")
	s = append(s, "FieldName: "+fmt.Sprintf("%#v", this.FieldName)+",\n")
	if this.MatchCondition != nil {
		s = append(s, "MatchCondition: "+fmt.Sprintf("%#v", this.MatchCondition)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *MatchCondition) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Values) > 0 {
		for iNdEx := len(m.Values) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintViewOptions(dAtA, i, uint64(len(m.Values[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.MatchType) > 0 {
		...
		i = encodeVarintViewOptions(dAtA, i, uint64(len(m.MatchType)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ProgressiveDisclosure) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ProgressiveDisclosure) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProgressiveDisclosure) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MatchCondition != nil {
		{
			size, err := m.MatchCondition.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.FieldName) > 0 {
		...
		i = encodeVarintViewOptions(dAtA, i, uint64(len(m.FieldName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ProgressiveDisclosure) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ProgressiveDisclosure) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ProgressiveDisclosure{`,
		`FieldName:` + fmt.Sprintf("%v", this.FieldName) + `,`,
		`MatchCondition:` + strings.Replace(this.MatchCondition.String(), "MatchCondition", "MatchCondition", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ProgressiveDisclosure) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProgressiveDisclosure: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProgressiveDisclosure: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.MatchCondition == nil {
				m.MatchCondition = &MatchCondition{}
			}
