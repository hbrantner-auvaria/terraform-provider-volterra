...
func (m *GetSpecType) GetVirtualSitesDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range refs {
		if ref == nil {
			return nil, fmt.Errorf("GetSpecType.virtual_sites[%d] has a nil value", i)
		}
...
func (m *GetSpecType) GetVirtualSitesDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	var entries []db.Entry
	refdType, err := d.TypeForEntryKind("", "", "virtual_site.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: virtual_site")
	}
	for _, ref := range m.GetVirtualSites() {
...
func (v *ValidateGetSpecType) VirtualSitesValidationRuleHandler(rules map[string]string) (db.ValidatorFunc, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "Message ValidationRuleHandler for virtual_sites")
	}
	...
	if err != nil {
		return nil, errors.Wrap(err, "Repeated ValidationRuleHandler for virtual_sites")
	}
	...
	validatorFn := func(ctx context.Context, val interface{}, opts ...db.ValidateOpt) error {
		...
		if err := repValFn(ctx, l, opts...); err != nil {
			return errors.Wrap(err, "repeated virtual_sites")
		}
		if err := itemsValidatorFn(ctx, elems, opts...); err != nil {
			return errors.Wrap(err, "items virtual_sites")
		}
		return nil
	}
...
var DefaultGetSpecTypeValidator = func() *ValidateGetSpecType {
	...
	vrhVirtualSites := v.VirtualSitesValidationRuleHandler
	rulesVirtualSites := map[string]string{
		"ves.io.schema.rules.repeated.max_items": "1",
	}
	vFn, err = vrhVirtualSites(rulesVirtualSites)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for GetSpecType.virtual_sites: %s", err)
		panic(errMsg)
	}
...
func (m *GlobalSpecType) GetVirtualSitesDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range refs {
		if ref == nil {
			return nil, fmt.Errorf("GlobalSpecType.virtual_sites[%d] has a nil value", i)
		}
		// resolve kind to type if needed at DBObject.GetDRefInfo()
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "virtual_site.Object",
...
// GetVirtualSitesDBEntries returns the db.Entry corresponding to the ObjRefType from the default Table
func (m *GlobalSpecType) GetVirtualSitesDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	var entries []db.Entry
	refdType, err := d.TypeForEntryKind("", "", "virtual_site.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: virtual_site")
...
var DefaultGlobalSpecTypeValidator = func() *ValidateGlobalSpecType {
	...
	vFn, err = vrhVirtualSites(rulesVirtualSites)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for GlobalSpecType.virtual_sites: %s", err)
		panic(errMsg)
	}
	v.FldValidators["virtual_sites"] = vFn
...
func (m *ReplaceSpecType) GetVirtualSitesDRefInfo() ([]db.DRefInfo, error) {
	...
	for i, ref := range refs {
		if ref == nil {
			return nil, fmt.Errorf("ReplaceSpecType.virtual_sites[%d] has a nil value", i)
		}
		// resolve kind to type if needed at DBObject.GetDRefInfo()
		drInfos = append(drInfos, db.DRefInfo{
			RefdType:   "virtual_site.Object",
...
// GetVirtualSitesDBEntries returns the db.Entry corresponding to the ObjRefType from the default Table
func (m *ReplaceSpecType) GetVirtualSitesDBEntries(ctx context.Context, d db.Interface) ([]db.Entry, error) {
	var entries []db.Entry
	refdType, err := d.TypeForEntryKind("", "", "virtual_site.Object")
	if err != nil {
		return nil, errors.Wrap(err, "Cannot find type for kind: virtual_site")
...
var DefaultReplaceSpecTypeValidator = func() *ValidateReplaceSpecType {
	...
	vFn, err = vrhVirtualSites(rulesVirtualSites)
	if err != nil {
		errMsg := fmt.Sprintf("ValidationRuleHandler for ReplaceSpecType.virtual_sites: %s", err)
		panic(errMsg)
	}
	v.FldValidators["virtual_sites"] = vFn
