...
type SimpleRule struct {
	...
	// Malware Protection Action
	//
	// x-displayName: "Malware Protection Action"
	// Specifies how Malware Protection is handled
	MalwareProtectionAction *policy.ModifyAction `protobuf:"bytes,56,opt,name=malware_protection_action,json=malwareProtectionAction,proto3" json:"malware_protection_action,omitempty"`
	// Malware Protection Settings
	//
	// x-displayName: "Malware Protection Settings"
	// Malware protection settings for this request
	MalwareProtectionSettings *policy.MalwareProtectionSettings `protobuf:"bytes,57,opt,name=malware_protection_settings,json=malwareProtectionSettings,proto3" json:"malware_protection_settings,omitempty"`
	// Bot Advanced Endpoints
	//
	// x-displayName: "Bot Advanced Endpoints"
	// Specify endpoints that need to be matched for advanced bot protection
	BotAdvancedEndpointMatcher *policy.BotAdvancedEndpointMatcherType `protobuf:"bytes,58,opt,name=bot_advanced_endpoint_matcher,json=botAdvancedEndpointMatcher,proto3" json:"bot_advanced_endpoint_matcher,omitempty"`
	// Mobiler Identifier Matcher Action
	//
	// x-displayName: "Mobiler Identifier Matcher Action"
	// Specifies mobile requests can be matched when both web and mobile traffic types are set
	MobileIdentifierMatcherAction *policy.MobileIdentifierMatcherAction `protobuf:"bytes,59,opt,name=mobile_identifier_matcher_action,json=mobileIdentifierMatcherAction,proto3" json:"mobile_identifier_matcher_action,omitempty"`
	// Log Rule Evaluation
	//
	...
	LogRuleEvaluation bool `protobuf:"varint,60,opt,name=log_rule_evaluation,json=logRuleEvaluation,proto3" json:"log_rule_evaluation,omitempty"`
	// Bot Defense Request Leg Identifier
	//
	// x-displayName: "Bot Defense Request Leg Identifier"
	// Identifies the request leg for bot inline routing
	BotDefenseRequestLegIdentifier *policy.BotDefenseRequestLegIdentifier `protobuf:"bytes,61,opt,name=bot_defense_request_leg_identifier,json=botDefenseRequestLegIdentifier,proto3" json:"bot_defense_request_leg_identifier,omitempty"`
	// Bot Full Site Action
	//
	// x-displayName: "Bot Full Site Action"
	// Action to be taken for full site bot protection based on risk score assessment.
	BotFullSiteAction *policy.BotFullSiteAction `protobuf:"bytes,62,opt,name=bot_full_site_action,json=botFullSiteAction,proto3" json:"bot_full_site_action,omitempty"`
}
...
func (m *SimpleRule) GetMalwareProtectionAction() *policy.ModifyAction {
	if m != nil {
		return m.MalwareProtectionAction
	}
	return nil
}

func (m *SimpleRule) GetMalwareProtectionSettings() *policy.MalwareProtectionSettings {
	if m != nil {
		return m.MalwareProtectionSettings
	}
	return nil
}

func (m *SimpleRule) GetBotAdvancedEndpointMatcher() *policy.BotAdvancedEndpointMatcherType {
	if m != nil {
		return m.BotAdvancedEndpointMatcher
	}
	return nil
}

func (m *SimpleRule) GetMobileIdentifierMatcherAction() *policy.MobileIdentifierMatcherAction {
	if m != nil {
		return m.MobileIdentifierMatcherAction
	}
	return nil
}

func (m *SimpleRule) GetLogRuleEvaluation() bool {
	if m != nil {
		return m.LogRuleEvaluation
	}
	return false
}

func (m *SimpleRule) GetBotDefenseRequestLegIdentifier() *policy.BotDefenseRequestLegIdentifier {
	if m != nil {
		return m.BotDefenseRequestLegIdentifier
	}
	return nil
}

func (m *SimpleRule) GetBotFullSiteAction() *policy.BotFullSiteAction {
	if m != nil {
		return m.BotFullSiteAction
	}
	return nil
}
...
type SourceList struct {
	...
	//
	// x-displayName: "IP Prefix List"
	// Addresses that are covered by the given list of IPv4 or IPv6 prefixes
...
var fileDescriptor_27dbd931e83f25b2 = []byte{
	// 5622 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *SimpleRule) Equal(that interface{}) bool {
	...
	if !this.MalwareProtectionAction.Equal(that1.MalwareProtectionAction) {
		return false
	}
	if !this.MalwareProtectionSettings.Equal(that1.MalwareProtectionSettings) {
		return false
	}
	if !this.BotAdvancedEndpointMatcher.Equal(that1.BotAdvancedEndpointMatcher) {
		return false
	}
	if !this.MobileIdentifierMatcherAction.Equal(that1.MobileIdentifierMatcherAction) {
		return false
	}
	if this.LogRuleEvaluation != that1.LogRuleEvaluation {
		return false
	}
	if !this.BotDefenseRequestLegIdentifier.Equal(that1.BotDefenseRequestLegIdentifier) {
		return false
	}
	if !this.BotFullSiteAction.Equal(that1.BotFullSiteAction) {
		return false
	}
	return true
}
...
func (this *SimpleRule) GoString() string {
	...
	if this.MalwareProtectionAction != nil {
		s = append(s, "MalwareProtectionAction: "+fmt.Sprintf("%#v", this.MalwareProtectionAction)+",\n")
	}
	if this.MalwareProtectionSettings != nil {
		s = append(s, "MalwareProtectionSettings: "+fmt.Sprintf("%#v", this.MalwareProtectionSettings)+",\n")
	}
	if this.BotAdvancedEndpointMatcher != nil {
		s = append(s, "BotAdvancedEndpointMatcher: "+fmt.Sprintf("%#v", this.BotAdvancedEndpointMatcher)+",\n")
	}
	if this.MobileIdentifierMatcherAction != nil {
		s = append(s, "MobileIdentifierMatcherAction: "+fmt.Sprintf("%#v", this.MobileIdentifierMatcherAction)+",\n")
	}
	s = append(s, "LogRuleEvaluation: "+fmt.Sprintf("%#v", this.LogRuleEvaluation)+",\n")
	if this.BotDefenseRequestLegIdentifier != nil {
		s = append(s, "BotDefenseRequestLegIdentifier: "+fmt.Sprintf("%#v", this.BotDefenseRequestLegIdentifier)+",\n")
	}
	if this.BotFullSiteAction != nil {
		s = append(s, "BotFullSiteAction: "+fmt.Sprintf("%#v", this.BotFullSiteAction)+",\n")
	}
	s = append(s, "}")
...
func (m *SimpleRule) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.BotFullSiteAction != nil {
		{
			size, err := m.BotFullSiteAction.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.BotDefenseRequestLegIdentifier != nil {
		{
			size, err := m.BotDefenseRequestLegIdentifier.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.MobileIdentifierMatcherAction != nil {
		{
			size, err := m.MobileIdentifierMatcherAction.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.BotAdvancedEndpointMatcher != nil {
		{
			size, err := m.BotAdvancedEndpointMatcher.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.MalwareProtectionSettings != nil {
		{
			size, err := m.MalwareProtectionSettings.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.MalwareProtectionAction != nil {
		{
			size, err := m.MalwareProtectionAction.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SourceList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TlsFingerprintClasses) > 0 {
		dAtA44 := make([]byte, len(m.TlsFingerprintClasses)*10)
		var j43 int
	...
	if len(m.CountryList) > 0 {
		dAtA46 := make([]byte, len(m.CountryList)*10)
		var j45 int
...
func (m *SimpleRule) Size() (n int) {
	...
	if m.MalwareProtectionAction != nil {
		l = m.MalwareProtectionAction.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	if m.MalwareProtectionSettings != nil {
		l = m.MalwareProtectionSettings.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	if m.BotAdvancedEndpointMatcher != nil {
		l = m.BotAdvancedEndpointMatcher.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	if m.MobileIdentifierMatcherAction != nil {
		l = m.MobileIdentifierMatcherAction.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	if m.LogRuleEvaluation {
		n += 3
	...
	if m.BotDefenseRequestLegIdentifier != nil {
		l = m.BotDefenseRequestLegIdentifier.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	if m.BotFullSiteAction != nil {
		l = m.BotFullSiteAction.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (this *SimpleRule) String() string {
	...
	s := strings.Join([]string{`&SimpleRule{`,
		...
		`MalwareProtectionAction:` + strings.Replace(fmt.Sprintf("%v", this.MalwareProtectionAction), "ModifyAction", "policy.ModifyAction", 1) + `,`,
		`MalwareProtectionSettings:` + strings.Replace(fmt.Sprintf("%v", this.MalwareProtectionSettings), "MalwareProtectionSettings", "policy.MalwareProtectionSettings", 1) + `,`,
		`BotAdvancedEndpointMatcher:` + strings.Replace(fmt.Sprintf("%v", this.BotAdvancedEndpointMatcher), "BotAdvancedEndpointMatcherType", "policy.BotAdvancedEndpointMatcherType", 1) + `,`,
		`MobileIdentifierMatcherAction:` + strings.Replace(fmt.Sprintf("%v", this.MobileIdentifierMatcherAction), "MobileIdentifierMatcherAction", "policy.MobileIdentifierMatcherAction", 1) + `,`,
		`LogRuleEvaluation:` + fmt.Sprintf("%v", this.LogRuleEvaluation) + `,`,
		`BotDefenseRequestLegIdentifier:` + strings.Replace(fmt.Sprintf("%v", this.BotDefenseRequestLegIdentifier), "BotDefenseRequestLegIdentifier", "policy.BotDefenseRequestLegIdentifier", 1) + `,`,
		`BotFullSiteAction:` + strings.Replace(fmt.Sprintf("%v", this.BotFullSiteAction), "BotFullSiteAction", "policy.BotFullSiteAction", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SimpleRule) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 56:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MalwareProtectionAction", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MalwareProtectionAction == nil {
				m.MalwareProtectionAction = &policy.ModifyAction{}
			}
			if err := m.MalwareProtectionAction.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 57:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MalwareProtectionSettings", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MalwareProtectionSettings == nil {
				m.MalwareProtectionSettings = &policy.MalwareProtectionSettings{}
			}
			if err := m.MalwareProtectionSettings.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 58:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BotAdvancedEndpointMatcher", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BotAdvancedEndpointMatcher == nil {
				m.BotAdvancedEndpointMatcher = &policy.BotAdvancedEndpointMatcherType{}
			}
			if err := m.BotAdvancedEndpointMatcher.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 59:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MobileIdentifierMatcherAction", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MobileIdentifierMatcherAction == nil {
				m.MobileIdentifierMatcherAction = &policy.MobileIdentifierMatcherAction{}
			}
			if err := m.MobileIdentifierMatcherAction.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 60:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LogRuleEvaluation", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LogRuleEvaluation = bool(v != 0)
		case 61:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BotDefenseRequestLegIdentifier", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BotDefenseRequestLegIdentifier == nil {
				m.BotDefenseRequestLegIdentifier = &policy.BotDefenseRequestLegIdentifier{}
			}
			if err := m.BotDefenseRequestLegIdentifier.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 62:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BotFullSiteAction", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BotFullSiteAction == nil {
				m.BotFullSiteAction = &policy.BotFullSiteAction{}
			}
			if err := m.BotFullSiteAction.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
