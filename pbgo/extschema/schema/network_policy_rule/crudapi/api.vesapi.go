...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/network_policy_rule"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.network_policy_rule.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.network_policy_rule.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.network_policy_rule.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy_rule.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy_rule.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy_rule.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy_rule.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_policy_rule.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.network_policy_rule.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.network_policy_rule.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_rule.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy_rule.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_rule.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy_rule.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_rule.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_rule.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.network_policy_rule.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.network_policy_rule.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/network_policy_rule/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.network_policy_rule/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy_rule-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy_rule.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy_rule-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy_rule.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy_rule-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy_rule.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "network_policy_rule",
            "x-ves-object-type": "ves.io.schema.network_policy_rule.Object",
            "x-ves-proto-service": "ves.io.schema.network_policy_rule.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.network_policy_rule/Objects": {
            "get": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy_rule-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.network_policy_rule.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy_rule-crudapi-api-create"
                },
        ...
        "/ves.io.schema.network_policy_rule/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-network_policy_rule-crudapi-api-liststream"
                },
        ...
        "/ves.io.schema.network_policy_rule/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_policy_rule/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_policy_rule/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.network_policy_rule/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.network_policy_rule.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/network_policy_ruleSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_policy_rulecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_policy_rulecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/network_policy_ruleStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_policy_rulecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_policy_rulecrudapiErrorCode"
                },
        ...
        "network_policy_ruleGlobalSpecType": {
            "type": "object",
            "description": "Desired state of the network policy rule",
            "title": "Network Policy Rule Specification",
            "x-displayname": "Specification",
            "x-ves-oneof-field-remote_endpoint": "[\"ip_prefix_set\",\"prefix\",\"prefix_selector\"]",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.GlobalSpecType",
            "properties": {
                "action": {
        ...
        "network_policy_ruleSpecType": {
            "type": "object",
            "description": "Shape of the Network policy rule specification",
            "title": "Specification Network policy rule",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.network_policy_rule.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/network_policy_ruleGlobalSpecType",
        ...
        "network_policy_rulecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.network_policy_rule.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/network_policy_rule/crudapi/api.proto"
}`
