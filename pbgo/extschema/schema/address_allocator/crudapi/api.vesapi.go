...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/address_allocator"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.address_allocator.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.address_allocator.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.address_allocator.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.address_allocator.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.address_allocator.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.address_allocator.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.address_allocator.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.address_allocator.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.address_allocator.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.address_allocator.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.address_allocator.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.address_allocator.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.address_allocator.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.address_allocator.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.address_allocator.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.address_allocator.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/address_allocator/crudapi/api.proto",
    ...
    "paths": {
        "/ves.io.schema.address_allocator/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-address_allocator-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-address_allocator-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-address_allocator-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "address_allocator",
            "x-ves-object-type": "ves.io.schema.address_allocator.Object",
            "x-ves-proto-service": "ves.io.schema.address_allocator.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.address_allocator/Objects": {
            "get": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-address_allocator-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-address_allocator-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "address_allocator",
            "x-ves-object-type": "ves.io.schema.address_allocator.Object",
        ...
        "/ves.io.schema.address_allocator/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-address_allocator-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.address_allocator.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "address_allocator",
            "x-ves-object-type": "ves.io.schema.address_allocator.Object",
        ...
        "/ves.io.schema.address_allocator/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.address_allocator/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.address_allocator/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.address_allocator/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.address_allocator.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "address_allocatorAllocationScheme": {
            "type": "object",
            ...
            "x-ves-proto-message": "ves.io.schema.address_allocator.AllocationScheme",
            "properties": {
                "allocation_unit": {
                    "type": "integer",
                ...
                "local_interface_address_type": {
                    ...
                    "title": "Local Interface Address Type",
                    "$ref": "#/definitions/address_allocatorLocalInterfaceAddressType",
                    "x-displayname": "Local Interface Address Type"
                }
            }
        },
        "address_allocatorAllocatorMode": {
            "type": "string",
            "description": "Mode of the address allocator\n\nAddress allocator is for VERs within the local cluster or site\nAllocation is per site and then per node",
            "title": "Allocator Mode",
            "enum": [
                "LOCAL",
            ...
            "x-ves-proto-enum": "ves.io.schema.address_allocator.AllocatorMode"
        },
        "address_allocatorGlobalSpecType": {
            "type": "object",
            "description": "Address Allocator specification",
        ...
        "address_allocatorLocalInterfaceAddressType": {
            ...
            "x-displayname": "Local Interface Address Type",
            "x-ves-proto-enum": "ves.io.schema.address_allocator.LocalInterfaceAddressType"
        },
        ...
        "address_allocatorNodePrefixType": {
            "type": "object",
            "description": "x-displayName: \"Node Allocation\"\nAddresses allocated to Node",
        ...
        "address_allocatorSpecType": {
            "type": "object",
            "description": "Shape of the address allocator specification",
            "title": "Address Allocator Specification",
            "x-displayname": "Address Allocator Specification",
            "x-ves-proto-message": "ves.io.schema.address_allocator.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/address_allocatorGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "address_allocatorStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of Address Allocator",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.address_allocator.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "address_allocatorcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.address_allocator.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.address_allocator.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/address_allocatorSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.address_allocator.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.address_allocator.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.address_allocator.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/address_allocator/crudapi/api.proto"
}`
