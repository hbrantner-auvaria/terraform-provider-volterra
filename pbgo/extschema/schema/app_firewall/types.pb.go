...
const (
	// x-displayName: "Block"
	// Log and block
	SIG_BLOCK SignatureAction = 0
	// x-displayName: "Report"
	// Log only
	SIG_REPORT SignatureAction = 1
	// x-displayName: "Ignore"
	// Disable detection
	SIG_IGNORE SignatureAction = 2
)

var SignatureAction_name = map[int32]string{
	0: "SIG_BLOCK",
	1: "SIG_REPORT",
	2: "SIG_IGNORE",
}

var SignatureAction_value = map[string]int32{
	"SIG_BLOCK":  0,
	"SIG_REPORT": 1,
	"SIG_IGNORE": 2,
}
...
type GlobalSpecType struct {
	...
	// Enhance with AI
	//
	// x-displayName: "Enhance with AI"
	// x-required
	// This setting controls whether enforcement decisions consider AI-powered risk evaluations.
	// When activated, machine learning models provide additional context to improve detection
	// accuracy and help prioritize responses based on the assessed threat level. When inactive,
	// enforcement relies solely on traditional, signature-based policy evaluations.
	//
	// Types that are valid to be assigned to EnhanceWithAiChoice:
	//	*GlobalSpecType_DisableAiEnhancements
	//	*GlobalSpecType_EnableAiEnhancements
	//	*GlobalSpecType_AiEnhancements
	EnhanceWithAiChoice isGlobalSpecType_EnhanceWithAiChoice `protobuf_oneof:"enhance_with_ai_choice"`
}
...
type isGlobalSpecType_EnhanceWithAiChoice interface {
	isGlobalSpecType_EnhanceWithAiChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GlobalSpecType_DisableAiEnhancements struct {
	DisableAiEnhancements *schema.Empty `protobuf:"bytes,23,opt,name=disable_ai_enhancements,json=disableAiEnhancements,proto3,oneof" json:"disable_ai_enhancements,omitempty"`
}
type GlobalSpecType_EnableAiEnhancements struct {
	EnableAiEnhancements *AIEnhancementsConfig `protobuf:"bytes,24,opt,name=enable_ai_enhancements,json=enableAiEnhancements,proto3,oneof" json:"enable_ai_enhancements,omitempty"`
}
type GlobalSpecType_AiEnhancements struct {
	AiEnhancements *AiRiskBasedBlocking `protobuf:"bytes,25,opt,name=ai_enhancements,json=aiEnhancements,proto3,oneof" json:"ai_enhancements,omitempty"`
}
...
func (*GlobalSpecType_DisableAiEnhancements) isGlobalSpecType_EnhanceWithAiChoice()        {}
func (*GlobalSpecType_EnableAiEnhancements) isGlobalSpecType_EnhanceWithAiChoice()         {}
func (*GlobalSpecType_AiEnhancements) isGlobalSpecType_EnhanceWithAiChoice()               {}
...
func (m *GlobalSpecType) GetEnhanceWithAiChoice() isGlobalSpecType_EnhanceWithAiChoice {
	if m != nil {
		return m.EnhanceWithAiChoice
	}
	return nil
}
...
func (m *GlobalSpecType) GetDisableAiEnhancements() *schema.Empty {
	if x, ok := m.GetEnhanceWithAiChoice().(*GlobalSpecType_DisableAiEnhancements); ok {
		return x.DisableAiEnhancements
	}
	return nil
}

func (m *GlobalSpecType) GetEnableAiEnhancements() *AIEnhancementsConfig {
	if x, ok := m.GetEnhanceWithAiChoice().(*GlobalSpecType_EnableAiEnhancements); ok {
		return x.EnableAiEnhancements
	}
	return nil
}

func (m *GlobalSpecType) GetAiEnhancements() *AiRiskBasedBlocking {
	if x, ok := m.GetEnhanceWithAiChoice().(*GlobalSpecType_AiEnhancements); ok {
		return x.AiEnhancements
	}
	return nil
}
...
func (*GlobalSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GlobalSpecType_DisableAiEnhancements)(nil),
		(*GlobalSpecType_EnableAiEnhancements)(nil),
		(*GlobalSpecType_AiEnhancements)(nil),
	}
}
...
type DetectionSetting struct {
	...
	ViolationsView []*ViolationConfigView `protobuf:"bytes,19,rep,name=violations_view,json=violationsView,proto3" json:"violations_view,omitempty"`
	// Configured Violations will be used for enforcement by the backend. This config is coming from the violations_view. Only violations with non-default config will be stored here.
	//
	// x-displayName: "Configured Violations"
	// Will store the list of violations with config that are different from the default violation config
	ConfiguredViolations []*ViolationConfiguration `protobuf:"bytes,20,rep,name=configured_violations,json=configuredViolations,proto3" json:"configured_violations,omitempty"`
}
...
func (m *DetectionSetting) GetViolationsView() []*ViolationConfigView {
	if m != nil {
		return m.ViolationsView
	}
	return nil
}

func (m *DetectionSetting) GetConfiguredViolations() []*ViolationConfiguration {
	if m != nil {
		return m.ConfiguredViolations
	}
	return nil
}
...
// App Firewall violation configuration changes to be applied
type ViolationConfiguration struct {
	// Violation
	//
	...
	//	*ViolationConfiguration_Enabled
	//	*ViolationConfiguration_Disabled
	StateChoice isViolationConfiguration_StateChoice `protobuf_oneof:"state_choice"`
}

func (m *ViolationConfiguration) Reset()      { *m = ViolationConfiguration{} }
func (*ViolationConfiguration) ProtoMessage() {}
func (*ViolationConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3c53032614c5085, []int{2}
}
func (m *ViolationConfiguration) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ViolationConfiguration) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ViolationConfiguration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ViolationConfiguration.Merge(m, src)
}
func (m *ViolationConfiguration) XXX_Size() int {
	return m.Size()
}
func (m *ViolationConfiguration) XXX_DiscardUnknown() {
	xxx_messageInfo_ViolationConfiguration.DiscardUnknown(m)
}

var xxx_messageInfo_ViolationConfiguration proto.InternalMessageInfo

type isViolationConfiguration_StateChoice interface {
	isViolationConfiguration_StateChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type ViolationConfiguration_Enabled struct {
	Enabled *schema.Empty `protobuf:"bytes,3,opt,name=enabled,proto3,oneof" json:"enabled,omitempty"`
}
type ViolationConfiguration_Disabled struct {
	Disabled *schema.Empty `protobuf:"bytes,4,opt,name=disabled,proto3,oneof" json:"disabled,omitempty"`
}

func (*ViolationConfiguration_Enabled) isViolationConfiguration_StateChoice()  {}
func (*ViolationConfiguration_Disabled) isViolationConfiguration_StateChoice() {}

func (m *ViolationConfiguration) GetStateChoice() isViolationConfiguration_StateChoice {
	if m != nil {
...
func (m *ViolationConfiguration) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ViolationConfiguration) GetEnabled() *schema.Empty {
	if x, ok := m.GetStateChoice().(*ViolationConfiguration_Enabled); ok {
		return x.Enabled
	}
	return nil
}

func (m *ViolationConfiguration) GetDisabled() *schema.Empty {
	if x, ok := m.GetStateChoice().(*ViolationConfiguration_Disabled); ok {
		return x.Disabled
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ViolationConfiguration) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ViolationConfiguration_Enabled)(nil),
		(*ViolationConfiguration_Disabled)(nil),
	}
}
...
type ViolationConfigView struct {
	// name
	//
	// x-displayName: "Title"
	...
	EnabledByDefault string `protobuf:"bytes,6,opt,name=enabled_by_default,json=enabledByDefault,proto3" json:"enabled_by_default,omitempty"`
...
func (m *ViolationConfigView) Reset()      { *m = ViolationConfigView{} }
func (*ViolationConfigView) ProtoMessage() {}
func (*ViolationConfigView) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3c53032614c5085, []int{3}
}
func (m *ViolationConfigView) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ViolationConfigView) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ViolationConfigView) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ViolationConfigView.Merge(m, src)
}
func (m *ViolationConfigView) XXX_Size() int {
	return m.Size()
}
func (m *ViolationConfigView) XXX_DiscardUnknown() {
	xxx_messageInfo_ViolationConfigView.DiscardUnknown(m)
}

var xxx_messageInfo_ViolationConfigView proto.InternalMessageInfo

func (m *ViolationConfigView) GetTitle() string {
	if m != nil {
		return m.Title
	}
	return ""
...
func (m *ViolationConfigView) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ViolationConfigView) GetDescription() string {
	if m != nil {
...
func (m *ViolationConfigView) GetEnabledByDefault() string {
	if m != nil {
...
func (m *ViolationConfigView) GetEnabled() bool {
	if m != nil {
		return m.Enabled
	}
	return false
...
type SignatureSelectionSetting struct {
	...
	// Signature Settings by Accuracy
	//
	// x-displayName: "Signature Settings by Accuracy"
	// Accuracy indicates the ability of the Attack Signatures to identify the attack including susceptibility to false-positive alarms.
	// Low: Indicates a high likelihood of false positives.
	// Medium: Indicates some likelihood of false positives.
	// High: Indicates a low likelihood of false positives.
	//
	// Types that are valid to be assigned to SignatureProtectionChoice:
	//	*SignatureSelectionSetting_DefaultSignatureSetting
	//	*SignatureSelectionSetting_SignatureSettingsByAccuracy
	SignatureProtectionChoice isSignatureSelectionSetting_SignatureProtectionChoice `protobuf_oneof:"signature_protection_choice"`
}
...
type isSignatureSelectionSetting_SignatureProtectionChoice interface {
	isSignatureSelectionSetting_SignatureProtectionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type SignatureSelectionSetting_DefaultSignatureSetting struct {
	DefaultSignatureSetting *schema.Empty `protobuf:"bytes,10,opt,name=default_signature_setting,json=defaultSignatureSetting,proto3,oneof" json:"default_signature_setting,omitempty"`
}
type SignatureSelectionSetting_SignatureSettingsByAccuracy struct {
	SignatureSettingsByAccuracy *SignatureProtectionSetting `protobuf:"bytes,11,opt,name=signature_settings_by_accuracy,json=signatureSettingsByAccuracy,proto3,oneof" json:"signature_settings_by_accuracy,omitempty"`
}
...
func (*SignatureSelectionSetting_DefaultSignatureSetting) isSignatureSelectionSetting_SignatureProtectionChoice() {
}
func (*SignatureSelectionSetting_SignatureSettingsByAccuracy) isSignatureSelectionSetting_SignatureProtectionChoice() {
}
...
func (m *SignatureSelectionSetting) GetSignatureProtectionChoice() isSignatureSelectionSetting_SignatureProtectionChoice {
	if m != nil {
		return m.SignatureProtectionChoice
	}
	return nil
}
...
func (m *SignatureSelectionSetting) GetDefaultSignatureSetting() *schema.Empty {
	if x, ok := m.GetSignatureProtectionChoice().(*SignatureSelectionSetting_DefaultSignatureSetting); ok {
		return x.DefaultSignatureSetting
	}
	return nil
}

func (m *SignatureSelectionSetting) GetSignatureSettingsByAccuracy() *SignatureProtectionSetting {
	if x, ok := m.GetSignatureProtectionChoice().(*SignatureSelectionSetting_SignatureSettingsByAccuracy); ok {
		return x.SignatureSettingsByAccuracy
	}
	return nil
}
...
func (*SignatureSelectionSetting) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*SignatureSelectionSetting_DefaultSignatureSetting)(nil),
		(*SignatureSelectionSetting_SignatureSettingsByAccuracy)(nil),
	}
}

// SignatureProtectionSetting
//
// x-displayName: "Signature Protection"
// Configuration of WAF Signature Protection
type SignatureProtectionSetting struct {
	// high_accuracy_action
	//
	// x-displayName: "High Accuracy"
	// High Accuracy signatures level are associated with attack behaviors that are accurately identified and have a low false positive rate.
	HighAccuracyAction SignatureAction `protobuf:"varint,1,opt,name=high_accuracy_action,json=highAccuracyAction,proto3,enum=ves.io.schema.app_firewall.SignatureAction" json:"high_accuracy_action,omitempty"`
	// medium_accuracy_action
	//
	// x-displayName: "Medium Accuracy"
	// Medium Accuracy signatures are associated with attack behaviors that are accurately identified but have a higher false positive rate than high accuracy signatures.
	MediumAccuracyAction SignatureAction `protobuf:"varint,2,opt,name=medium_accuracy_action,json=mediumAccuracyAction,proto3,enum=ves.io.schema.app_firewall.SignatureAction" json:"medium_accuracy_action,omitempty"`
	// low_accuracy_action
	//
	// x-displayName: "Low Accuracy"
	// Low Accuracy signatures are associated with attack behaviors that have a high false positive rate. It is advisable to set low accuracy signatures to ignore to reduce false positives.
	LowAccuracyAction SignatureAction `protobuf:"varint,3,opt,name=low_accuracy_action,json=lowAccuracyAction,proto3,enum=ves.io.schema.app_firewall.SignatureAction" json:"low_accuracy_action,omitempty"`
}

func (m *SignatureProtectionSetting) Reset()      { *m = SignatureProtectionSetting{} }
func (*SignatureProtectionSetting) ProtoMessage() {}
func (*SignatureProtectionSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3c53032614c5085, []int{5}
}
func (m *SignatureProtectionSetting) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SignatureProtectionSetting) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *SignatureProtectionSetting) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignatureProtectionSetting.Merge(m, src)
}
func (m *SignatureProtectionSetting) XXX_Size() int {
	return m.Size()
}
func (m *SignatureProtectionSetting) XXX_DiscardUnknown() {
	xxx_messageInfo_SignatureProtectionSetting.DiscardUnknown(m)
}

var xxx_messageInfo_SignatureProtectionSetting proto.InternalMessageInfo

func (m *SignatureProtectionSetting) GetHighAccuracyAction() SignatureAction {
	if m != nil {
		return m.HighAccuracyAction
	}
	return SIG_BLOCK
}

func (m *SignatureProtectionSetting) GetMediumAccuracyAction() SignatureAction {
	if m != nil {
		return m.MediumAccuracyAction
	}
	return SIG_BLOCK
}

func (m *SignatureProtectionSetting) GetLowAccuracyAction() SignatureAction {
	if m != nil {
		return m.LowAccuracyAction
	}
	return SIG_BLOCK
}
...
type ViolationSettings struct {
	...
	DisabledViolationTypes []AppFirewallViolationType `protobuf:"varint,1,rep,packed,name=disabled_violation_types,json=disabledViolationTypes,proto3,enum=ves.io.schema.app_firewall.AppFirewallViolationType" json:"disabled_violation_types,omitempty"` // Deprecated: Do not use.
}
...
type AIEnhancementsConfig struct {
	// Action By Risk Score
	//
	// x-displayName: "Action By Risk Score"
	// x-required
	// Determines which risk levels will trigger mitigation when AI-based risk evaluation is enabled
	//
	// Types that are valid to be assigned to RiskScoreActionChoice:
	//	*AIEnhancementsConfig_MitigateHighRiskAction
	//	*AIEnhancementsConfig_MitigateHighMediumRiskAction
	RiskScoreActionChoice isAIEnhancementsConfig_RiskScoreActionChoice `protobuf_oneof:"risk_score_action_choice"`
}

func (m *AIEnhancementsConfig) Reset()      { *m = AIEnhancementsConfig{} }
func (*AIEnhancementsConfig) ProtoMessage() {}
func (*AIEnhancementsConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3c53032614c5085, []int{18}
}
func (m *AIEnhancementsConfig) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AIEnhancementsConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AIEnhancementsConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AIEnhancementsConfig.Merge(m, src)
}
func (m *AIEnhancementsConfig) XXX_Size() int {
	return m.Size()
}
func (m *AIEnhancementsConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_AIEnhancementsConfig.DiscardUnknown(m)
}

var xxx_messageInfo_AIEnhancementsConfig proto.InternalMessageInfo

type isAIEnhancementsConfig_RiskScoreActionChoice interface {
	isAIEnhancementsConfig_RiskScoreActionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type AIEnhancementsConfig_MitigateHighRiskAction struct {
	MitigateHighRiskAction *schema.Empty `protobuf:"bytes,2,opt,name=mitigate_high_risk_action,json=mitigateHighRiskAction,proto3,oneof" json:"mitigate_high_risk_action,omitempty"`
}
type AIEnhancementsConfig_MitigateHighMediumRiskAction struct {
	MitigateHighMediumRiskAction *schema.Empty `protobuf:"bytes,3,opt,name=mitigate_high_medium_risk_action,json=mitigateHighMediumRiskAction,proto3,oneof" json:"mitigate_high_medium_risk_action,omitempty"`
}

func (*AIEnhancementsConfig_MitigateHighRiskAction) isAIEnhancementsConfig_RiskScoreActionChoice() {}
func (*AIEnhancementsConfig_MitigateHighMediumRiskAction) isAIEnhancementsConfig_RiskScoreActionChoice() {
}

func (m *AIEnhancementsConfig) GetRiskScoreActionChoice() isAIEnhancementsConfig_RiskScoreActionChoice {
	if m != nil {
		return m.RiskScoreActionChoice
	}
	return nil
}

func (m *AIEnhancementsConfig) GetMitigateHighRiskAction() *schema.Empty {
	if x, ok := m.GetRiskScoreActionChoice().(*AIEnhancementsConfig_MitigateHighRiskAction); ok {
		return x.MitigateHighRiskAction
	}
	return nil
}

func (m *AIEnhancementsConfig) GetMitigateHighMediumRiskAction() *schema.Empty {
	if x, ok := m.GetRiskScoreActionChoice().(*AIEnhancementsConfig_MitigateHighMediumRiskAction); ok {
		return x.MitigateHighMediumRiskAction
	}
	return nil
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*AIEnhancementsConfig) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AIEnhancementsConfig_MitigateHighRiskAction)(nil),
		(*AIEnhancementsConfig_MitigateHighMediumRiskAction)(nil),
	}
}
...
type CreateSpecType struct {
	...
	// Types that are valid to be assigned to EnhanceWithAiChoice:
	//	*CreateSpecType_DisableAiEnhancements
	//	*CreateSpecType_EnableAiEnhancements
	//	*CreateSpecType_AiEnhancements
	EnhanceWithAiChoice isCreateSpecType_EnhanceWithAiChoice `protobuf_oneof:"enhance_with_ai_choice"`
}

func (m *CreateSpecType) Reset()      { *m = CreateSpecType{} }
func (*CreateSpecType) ProtoMessage() {}
func (*CreateSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3c53032614c5085, []int{19}
}
...
type isCreateSpecType_EnhanceWithAiChoice interface {
	isCreateSpecType_EnhanceWithAiChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type CreateSpecType_DisableAiEnhancements struct {
	DisableAiEnhancements *schema.Empty `protobuf:"bytes,23,opt,name=disable_ai_enhancements,json=disableAiEnhancements,proto3,oneof" json:"disable_ai_enhancements,omitempty"`
}
type CreateSpecType_EnableAiEnhancements struct {
	EnableAiEnhancements *AIEnhancementsConfig `protobuf:"bytes,24,opt,name=enable_ai_enhancements,json=enableAiEnhancements,proto3,oneof" json:"enable_ai_enhancements,omitempty"`
}
type CreateSpecType_AiEnhancements struct {
	AiEnhancements *AiRiskBasedBlocking `protobuf:"bytes,25,opt,name=ai_enhancements,json=aiEnhancements,proto3,oneof" json:"ai_enhancements,omitempty"`
}
...
func (*CreateSpecType_DisableAiEnhancements) isCreateSpecType_EnhanceWithAiChoice()        {}
func (*CreateSpecType_EnableAiEnhancements) isCreateSpecType_EnhanceWithAiChoice()         {}
func (*CreateSpecType_AiEnhancements) isCreateSpecType_EnhanceWithAiChoice()               {}
...
func (m *CreateSpecType) GetEnhanceWithAiChoice() isCreateSpecType_EnhanceWithAiChoice {
	if m != nil {
		return m.EnhanceWithAiChoice
	}
	return nil
...
func (m *CreateSpecType) GetDisableAiEnhancements() *schema.Empty {
	if x, ok := m.GetEnhanceWithAiChoice().(*CreateSpecType_DisableAiEnhancements); ok {
		return x.DisableAiEnhancements
	}
	return nil
}

func (m *CreateSpecType) GetEnableAiEnhancements() *AIEnhancementsConfig {
	if x, ok := m.GetEnhanceWithAiChoice().(*CreateSpecType_EnableAiEnhancements); ok {
		return x.EnableAiEnhancements
	}
	return nil
}

func (m *CreateSpecType) GetAiEnhancements() *AiRiskBasedBlocking {
	if x, ok := m.GetEnhanceWithAiChoice().(*CreateSpecType_AiEnhancements); ok {
		return x.AiEnhancements
	}
	return nil
}
...
func (*CreateSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*CreateSpecType_DisableAiEnhancements)(nil),
		(*CreateSpecType_EnableAiEnhancements)(nil),
		(*CreateSpecType_AiEnhancements)(nil),
	}
}
...
type ReplaceSpecType struct {
	...
	// Types that are valid to be assigned to EnhanceWithAiChoice:
	//	*ReplaceSpecType_DisableAiEnhancements
	//	*ReplaceSpecType_EnableAiEnhancements
	//	*ReplaceSpecType_AiEnhancements
	EnhanceWithAiChoice isReplaceSpecType_EnhanceWithAiChoice `protobuf_oneof:"enhance_with_ai_choice"`
}

func (m *ReplaceSpecType) Reset()      { *m = ReplaceSpecType{} }
func (*ReplaceSpecType) ProtoMessage() {}
func (*ReplaceSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3c53032614c5085, []int{20}
}
...
type isReplaceSpecType_EnhanceWithAiChoice interface {
	isReplaceSpecType_EnhanceWithAiChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type ReplaceSpecType_DisableAiEnhancements struct {
	DisableAiEnhancements *schema.Empty `protobuf:"bytes,23,opt,name=disable_ai_enhancements,json=disableAiEnhancements,proto3,oneof" json:"disable_ai_enhancements,omitempty"`
}
type ReplaceSpecType_EnableAiEnhancements struct {
	EnableAiEnhancements *AIEnhancementsConfig `protobuf:"bytes,24,opt,name=enable_ai_enhancements,json=enableAiEnhancements,proto3,oneof" json:"enable_ai_enhancements,omitempty"`
}
type ReplaceSpecType_AiEnhancements struct {
	AiEnhancements *AiRiskBasedBlocking `protobuf:"bytes,25,opt,name=ai_enhancements,json=aiEnhancements,proto3,oneof" json:"ai_enhancements,omitempty"`
}
...
func (*ReplaceSpecType_DisableAiEnhancements) isReplaceSpecType_EnhanceWithAiChoice()        {}
func (*ReplaceSpecType_EnableAiEnhancements) isReplaceSpecType_EnhanceWithAiChoice()         {}
func (*ReplaceSpecType_AiEnhancements) isReplaceSpecType_EnhanceWithAiChoice()               {}
...
func (m *ReplaceSpecType) GetEnhanceWithAiChoice() isReplaceSpecType_EnhanceWithAiChoice {
	if m != nil {
		return m.EnhanceWithAiChoice
	}
	return nil
...
func (m *ReplaceSpecType) GetDisableAiEnhancements() *schema.Empty {
	if x, ok := m.GetEnhanceWithAiChoice().(*ReplaceSpecType_DisableAiEnhancements); ok {
		return x.DisableAiEnhancements
	}
	return nil
}

func (m *ReplaceSpecType) GetEnableAiEnhancements() *AIEnhancementsConfig {
	if x, ok := m.GetEnhanceWithAiChoice().(*ReplaceSpecType_EnableAiEnhancements); ok {
		return x.EnableAiEnhancements
	}
	return nil
}

func (m *ReplaceSpecType) GetAiEnhancements() *AiRiskBasedBlocking {
	if x, ok := m.GetEnhanceWithAiChoice().(*ReplaceSpecType_AiEnhancements); ok {
		return x.AiEnhancements
	}
	return nil
}
...
func (*ReplaceSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ReplaceSpecType_DisableAiEnhancements)(nil),
		(*ReplaceSpecType_EnableAiEnhancements)(nil),
		(*ReplaceSpecType_AiEnhancements)(nil),
	}
}
...
type GetSpecType struct {
	...
	// Types that are valid to be assigned to EnhanceWithAiChoice:
	//	*GetSpecType_DisableAiEnhancements
	//	*GetSpecType_EnableAiEnhancements
	//	*GetSpecType_AiEnhancements
	EnhanceWithAiChoice isGetSpecType_EnhanceWithAiChoice `protobuf_oneof:"enhance_with_ai_choice"`
}

func (m *GetSpecType) Reset()      { *m = GetSpecType{} }
func (*GetSpecType) ProtoMessage() {}
func (*GetSpecType) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3c53032614c5085, []int{21}
}
...
type isGetSpecType_EnhanceWithAiChoice interface {
	isGetSpecType_EnhanceWithAiChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GetSpecType_DisableAiEnhancements struct {
	DisableAiEnhancements *schema.Empty `protobuf:"bytes,23,opt,name=disable_ai_enhancements,json=disableAiEnhancements,proto3,oneof" json:"disable_ai_enhancements,omitempty"`
}
type GetSpecType_EnableAiEnhancements struct {
	EnableAiEnhancements *AIEnhancementsConfig `protobuf:"bytes,24,opt,name=enable_ai_enhancements,json=enableAiEnhancements,proto3,oneof" json:"enable_ai_enhancements,omitempty"`
}
type GetSpecType_AiEnhancements struct {
	AiEnhancements *AiRiskBasedBlocking `protobuf:"bytes,25,opt,name=ai_enhancements,json=aiEnhancements,proto3,oneof" json:"ai_enhancements,omitempty"`
}
...
func (*GetSpecType_DisableAiEnhancements) isGetSpecType_EnhanceWithAiChoice()        {}
func (*GetSpecType_EnableAiEnhancements) isGetSpecType_EnhanceWithAiChoice()         {}
func (*GetSpecType_AiEnhancements) isGetSpecType_EnhanceWithAiChoice()               {}
...
func (m *GetSpecType) GetEnhanceWithAiChoice() isGetSpecType_EnhanceWithAiChoice {
	if m != nil {
		return m.EnhanceWithAiChoice
	}
	return nil
...
func (m *GetSpecType) GetDisableAiEnhancements() *schema.Empty {
	if x, ok := m.GetEnhanceWithAiChoice().(*GetSpecType_DisableAiEnhancements); ok {
		return x.DisableAiEnhancements
	}
	return nil
}

func (m *GetSpecType) GetEnableAiEnhancements() *AIEnhancementsConfig {
	if x, ok := m.GetEnhanceWithAiChoice().(*GetSpecType_EnableAiEnhancements); ok {
		return x.EnableAiEnhancements
	}
	return nil
}

func (m *GetSpecType) GetAiEnhancements() *AiRiskBasedBlocking {
	if x, ok := m.GetEnhanceWithAiChoice().(*GetSpecType_AiEnhancements); ok {
		return x.AiEnhancements
	}
	return nil
}
...
func (*GetSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GetSpecType_DisableAiEnhancements)(nil),
		(*GetSpecType_EnableAiEnhancements)(nil),
		(*GetSpecType_AiEnhancements)(nil),
	}
}
...
func init() {
	...
	proto.RegisterEnum("ves.io.schema.app_firewall.SignatureAction", SignatureAction_name, SignatureAction_value)
	...
	proto.RegisterType((*ViolationConfiguration)(nil), "ves.io.schema.app_firewall.ViolationConfiguration")
	proto.RegisterType((*ViolationConfigView)(nil), "ves.io.schema.app_firewall.ViolationConfigView")
	proto.RegisterType((*SignatureSelectionSetting)(nil), "ves.io.schema.app_firewall.SignatureSelectionSetting")
	proto.RegisterType((*SignatureProtectionSetting)(nil), "ves.io.schema.app_firewall.SignatureProtectionSetting")
	...
	proto.RegisterType((*AIEnhancementsConfig)(nil), "ves.io.schema.app_firewall.AIEnhancementsConfig")
...
var fileDescriptor_f3c53032614c5085 = []byte{
	...
	,
}
...
func (x SignatureAction) String() string {
	s, ok := SignatureAction_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *GlobalSpecType) Equal(that interface{}) bool {
	...
	if that1.EnhanceWithAiChoice == nil {
		if this.EnhanceWithAiChoice != nil {
			return false
		}
	} else if this.EnhanceWithAiChoice == nil {
		return false
	} else if !this.EnhanceWithAiChoice.Equal(that1.EnhanceWithAiChoice) {
		return false
	}
	return true
}
...
func (this *GlobalSpecType_DisableAiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_DisableAiEnhancements)
	if !ok {
		that2, ok := that.(GlobalSpecType_DisableAiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DisableAiEnhancements.Equal(that1.DisableAiEnhancements) {
		return false
	}
	return true
}
func (this *GlobalSpecType_EnableAiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_EnableAiEnhancements)
	if !ok {
		that2, ok := that.(GlobalSpecType_EnableAiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.EnableAiEnhancements.Equal(that1.EnableAiEnhancements) {
		return false
	}
	return true
}
func (this *GlobalSpecType_AiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_AiEnhancements)
	if !ok {
		that2, ok := that.(GlobalSpecType_AiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.AiEnhancements.Equal(that1.AiEnhancements) {
		return false
	}
	return true
}
func (this *DetectionSetting) Equal(that interface{}) bool {
	...
	if len(this.ViolationsView) != len(that1.ViolationsView) {
		return false
	}
	for i := range this.ViolationsView {
		if !this.ViolationsView[i].Equal(that1.ViolationsView[i]) {
			return false
		}
	}
	if len(this.ConfiguredViolations) != len(that1.ConfiguredViolations) {
		return false
	}
	for i := range this.ConfiguredViolations {
		if !this.ConfiguredViolations[i].Equal(that1.ConfiguredViolations[i]) {
			return false
		}
	}
	return true
...
func (this *ViolationConfiguration) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ViolationConfiguration)
	if !ok {
		that2, ok := that.(ViolationConfiguration)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ViolationConfiguration_Enabled) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ViolationConfiguration_Enabled)
	if !ok {
		that2, ok := that.(ViolationConfiguration_Enabled)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ViolationConfiguration_Disabled) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ViolationConfiguration_Disabled)
	if !ok {
		that2, ok := that.(ViolationConfiguration_Disabled)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ViolationConfigView) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ViolationConfigView)
	if !ok {
		that2, ok := that.(ViolationConfigView)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.EnabledByDefault != that1.EnabledByDefault {
		return false
	}
...
func (this *SignatureSelectionSetting) Equal(that interface{}) bool {
	...
	if that1.SignatureProtectionChoice == nil {
		if this.SignatureProtectionChoice != nil {
			return false
		}
	} else if this.SignatureProtectionChoice == nil {
		return false
	} else if !this.SignatureProtectionChoice.Equal(that1.SignatureProtectionChoice) {
		return false
	}
	return true
}
...
func (this *SignatureSelectionSetting_DefaultSignatureSetting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SignatureSelectionSetting_DefaultSignatureSetting)
	if !ok {
		that2, ok := that.(SignatureSelectionSetting_DefaultSignatureSetting)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DefaultSignatureSetting.Equal(that1.DefaultSignatureSetting) {
		return false
	}
	return true
}
func (this *SignatureSelectionSetting_SignatureSettingsByAccuracy) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SignatureSelectionSetting_SignatureSettingsByAccuracy)
	if !ok {
		that2, ok := that.(SignatureSelectionSetting_SignatureSettingsByAccuracy)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.SignatureSettingsByAccuracy.Equal(that1.SignatureSettingsByAccuracy) {
		return false
	}
	return true
}
func (this *SignatureProtectionSetting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SignatureProtectionSetting)
	if !ok {
		that2, ok := that.(SignatureProtectionSetting)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.HighAccuracyAction != that1.HighAccuracyAction {
		return false
	}
	if this.MediumAccuracyAction != that1.MediumAccuracyAction {
		return false
	}
	if this.LowAccuracyAction != that1.LowAccuracyAction {
		return false
	}
	return true
}
...
func (this *AIEnhancementsConfig) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AIEnhancementsConfig)
	if !ok {
		that2, ok := that.(AIEnhancementsConfig)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.RiskScoreActionChoice == nil {
		if this.RiskScoreActionChoice != nil {
			return false
		}
	} else if this.RiskScoreActionChoice == nil {
		return false
	} else if !this.RiskScoreActionChoice.Equal(that1.RiskScoreActionChoice) {
		return false
	}
	return true
}
func (this *AIEnhancementsConfig_MitigateHighRiskAction) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AIEnhancementsConfig_MitigateHighRiskAction)
	if !ok {
		that2, ok := that.(AIEnhancementsConfig_MitigateHighRiskAction)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.MitigateHighRiskAction.Equal(that1.MitigateHighRiskAction) {
		return false
	}
	return true
}
func (this *AIEnhancementsConfig_MitigateHighMediumRiskAction) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AIEnhancementsConfig_MitigateHighMediumRiskAction)
	if !ok {
		that2, ok := that.(AIEnhancementsConfig_MitigateHighMediumRiskAction)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.MitigateHighMediumRiskAction.Equal(that1.MitigateHighMediumRiskAction) {
		return false
	}
	return true
}
...
func (this *CreateSpecType_DisableAiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_DisableAiEnhancements)
	if !ok {
		that2, ok := that.(CreateSpecType_DisableAiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_EnableAiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_EnableAiEnhancements)
	if !ok {
		that2, ok := that.(CreateSpecType_EnableAiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_AiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_AiEnhancements)
	if !ok {
		that2, ok := that.(CreateSpecType_AiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_DisableAiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_DisableAiEnhancements)
	if !ok {
		that2, ok := that.(ReplaceSpecType_DisableAiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_EnableAiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_EnableAiEnhancements)
	if !ok {
		that2, ok := that.(ReplaceSpecType_EnableAiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_AiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_AiEnhancements)
	if !ok {
		that2, ok := that.(ReplaceSpecType_AiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_DisableAiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_DisableAiEnhancements)
	if !ok {
		that2, ok := that.(GetSpecType_DisableAiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_EnableAiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_EnableAiEnhancements)
	if !ok {
		that2, ok := that.(GetSpecType_EnableAiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_AiEnhancements) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_AiEnhancements)
	if !ok {
		that2, ok := that.(GetSpecType_AiEnhancements)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GlobalSpecType) GoString() string {
	...
	if this.EnhanceWithAiChoice != nil {
		s = append(s, "EnhanceWithAiChoice: "+fmt.Sprintf("%#v", this.EnhanceWithAiChoice)+",\n")
	}
	s = append(s, "}")
...
func (this *GlobalSpecType_DisableAiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.GlobalSpecType_DisableAiEnhancements{` +
		`DisableAiEnhancements:` + fmt.Sprintf("%#v", this.DisableAiEnhancements) + `}`}, ", ")
	return s
}
func (this *GlobalSpecType_EnableAiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.GlobalSpecType_EnableAiEnhancements{` +
		`EnableAiEnhancements:` + fmt.Sprintf("%#v", this.EnableAiEnhancements) + `}`}, ", ")
	return s
}
func (this *GlobalSpecType_AiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.GlobalSpecType_AiEnhancements{` +
		`AiEnhancements:` + fmt.Sprintf("%#v", this.AiEnhancements) + `}`}, ", ")
	return s
}
func (this *DetectionSetting) GoString() string {
	...
	if this.ViolationsView != nil {
		s = append(s, "ViolationsView: "+fmt.Sprintf("%#v", this.ViolationsView)+",\n")
	}
	if this.ConfiguredViolations != nil {
		s = append(s, "ConfiguredViolations: "+fmt.Sprintf("%#v", this.ConfiguredViolations)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *ViolationConfiguration) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&app_firewall.ViolationConfiguration{")
...
func (this *ViolationConfiguration_Enabled) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.ViolationConfiguration_Enabled{` +
		`Enabled:` + fmt.Sprintf("%#v", this.Enabled) + `}`}, ", ")
	return s
}
func (this *ViolationConfiguration_Disabled) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.ViolationConfiguration_Disabled{` +
		`Disabled:` + fmt.Sprintf("%#v", this.Disabled) + `}`}, ", ")
	return s
}
func (this *ViolationConfigView) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&app_firewall.ViolationConfigView{")
	s = append(s, "Title: "+fmt.Sprintf("%#v", this.Title)+",\n")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "Description: "+fmt.Sprintf("%#v", this.Description)+",\n")
	s = append(s, "EnabledByDefault: "+fmt.Sprintf("%#v", this.EnabledByDefault)+",\n")
...
func (this *SignatureSelectionSetting) GoString() string {
	...
	if this.SignatureProtectionChoice != nil {
		s = append(s, "SignatureProtectionChoice: "+fmt.Sprintf("%#v", this.SignatureProtectionChoice)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *SignatureSelectionSetting_DefaultSignatureSetting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.SignatureSelectionSetting_DefaultSignatureSetting{` +
		`DefaultSignatureSetting:` + fmt.Sprintf("%#v", this.DefaultSignatureSetting) + `}`}, ", ")
	return s
}
func (this *SignatureSelectionSetting_SignatureSettingsByAccuracy) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.SignatureSelectionSetting_SignatureSettingsByAccuracy{` +
		`SignatureSettingsByAccuracy:` + fmt.Sprintf("%#v", this.SignatureSettingsByAccuracy) + `}`}, ", ")
	return s
}
func (this *SignatureProtectionSetting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&app_firewall.SignatureProtectionSetting{")
	s = append(s, "HighAccuracyAction: "+fmt.Sprintf("%#v", this.HighAccuracyAction)+",\n")
	s = append(s, "MediumAccuracyAction: "+fmt.Sprintf("%#v", this.MediumAccuracyAction)+",\n")
	s = append(s, "LowAccuracyAction: "+fmt.Sprintf("%#v", this.LowAccuracyAction)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *AIEnhancementsConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&app_firewall.AIEnhancementsConfig{")
	if this.RiskScoreActionChoice != nil {
		s = append(s, "RiskScoreActionChoice: "+fmt.Sprintf("%#v", this.RiskScoreActionChoice)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *AIEnhancementsConfig_MitigateHighRiskAction) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.AIEnhancementsConfig_MitigateHighRiskAction{` +
		`MitigateHighRiskAction:` + fmt.Sprintf("%#v", this.MitigateHighRiskAction) + `}`}, ", ")
	return s
}
func (this *AIEnhancementsConfig_MitigateHighMediumRiskAction) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.AIEnhancementsConfig_MitigateHighMediumRiskAction{` +
		`MitigateHighMediumRiskAction:` + fmt.Sprintf("%#v", this.MitigateHighMediumRiskAction) + `}`}, ", ")
	return s
}
...
func (this *CreateSpecType_DisableAiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.CreateSpecType_DisableAiEnhancements{` +
		`DisableAiEnhancements:` + fmt.Sprintf("%#v", this.DisableAiEnhancements) + `}`}, ", ")
	return s
}
func (this *CreateSpecType_EnableAiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.CreateSpecType_EnableAiEnhancements{` +
		`EnableAiEnhancements:` + fmt.Sprintf("%#v", this.EnableAiEnhancements) + `}`}, ", ")
	return s
}
func (this *CreateSpecType_AiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.CreateSpecType_AiEnhancements{` +
		`AiEnhancements:` + fmt.Sprintf("%#v", this.AiEnhancements) + `}`}, ", ")
	return s
}
...
func (this *ReplaceSpecType_DisableAiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.ReplaceSpecType_DisableAiEnhancements{` +
		`DisableAiEnhancements:` + fmt.Sprintf("%#v", this.DisableAiEnhancements) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_EnableAiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.ReplaceSpecType_EnableAiEnhancements{` +
		`EnableAiEnhancements:` + fmt.Sprintf("%#v", this.EnableAiEnhancements) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_AiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.ReplaceSpecType_AiEnhancements{` +
		`AiEnhancements:` + fmt.Sprintf("%#v", this.AiEnhancements) + `}`}, ", ")
	return s
}
...
func (this *GetSpecType_DisableAiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.GetSpecType_DisableAiEnhancements{` +
		`DisableAiEnhancements:` + fmt.Sprintf("%#v", this.DisableAiEnhancements) + `}`}, ", ")
	return s
}
func (this *GetSpecType_EnableAiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.GetSpecType_EnableAiEnhancements{` +
		`EnableAiEnhancements:` + fmt.Sprintf("%#v", this.EnableAiEnhancements) + `}`}, ", ")
	return s
}
func (this *GetSpecType_AiEnhancements) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&app_firewall.GetSpecType_AiEnhancements{` +
		`AiEnhancements:` + fmt.Sprintf("%#v", this.AiEnhancements) + `}`}, ", ")
	return s
}
...
func (m *GlobalSpecType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.EnhanceWithAiChoice != nil {
		{
			size := m.EnhanceWithAiChoice.Size()
			i -= size
			if _, err := m.EnhanceWithAiChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *GlobalSpecType_DisableAiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_DisableAiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableAiEnhancements != nil {
		{
			size, err := m.DisableAiEnhancements.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_EnableAiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_EnableAiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnableAiEnhancements != nil {
		{
			size, err := m.EnableAiEnhancements.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_AiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_AiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AiEnhancements != nil {
		{
			size, err := m.AiEnhancements.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DetectionSetting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ConfiguredViolations) > 0 {
		for iNdEx := len(m.ConfiguredViolations) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ConfiguredViolations[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.ViolationsView) > 0 {
		for iNdEx := len(m.ViolationsView) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ViolationsView[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ViolationConfiguration) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ViolationConfiguration) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ViolationConfiguration) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ViolationConfiguration_Enabled) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ViolationConfiguration_Enabled) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Enabled != nil {
		{
...
func (m *ViolationConfiguration_Disabled) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ViolationConfiguration_Disabled) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Disabled != nil {
		{
...
func (m *ViolationConfigView) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ViolationConfigView) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ViolationConfigView) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EnabledByDefault) > 0 {
		i -= len(m.EnabledByDefault)
		copy(dAtA[i:], m.EnabledByDefault)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.EnabledByDefault)))
		i--
		dAtA[i] = 0x32
	}
	if m.Enabled {
...
func (m *SignatureSelectionSetting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.SignatureProtectionChoice != nil {
		{
			size := m.SignatureProtectionChoice.Size()
			i -= size
			if _, err := m.SignatureProtectionChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *SignatureSelectionSetting_DefaultSignatureSetting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignatureSelectionSetting_DefaultSignatureSetting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DefaultSignatureSetting != nil {
		{
			size, err := m.DefaultSignatureSetting.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SignatureSelectionSetting_SignatureSettingsByAccuracy) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignatureSelectionSetting_SignatureSettingsByAccuracy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignatureSettingsByAccuracy != nil {
		{
			size, err := m.SignatureSettingsByAccuracy.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SignatureProtectionSetting) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SignatureProtectionSetting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignatureProtectionSetting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.LowAccuracyAction != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.LowAccuracyAction))
		i--
		dAtA[i] = 0x18
	}
	if m.MediumAccuracyAction != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MediumAccuracyAction))
		i--
		dAtA[i] = 0x10
	}
	if m.HighAccuracyAction != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.HighAccuracyAction))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AttackTypeSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DisabledAttackTypes) > 0 {
		dAtA41 := make([]byte, len(m.DisabledAttackTypes)*10)
		var j40 int
...
func (m *ViolationSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DisabledViolationTypes) > 0 {
		dAtA43 := make([]byte, len(m.DisabledViolationTypes)*10)
		var j42 int
...
func (m *AllowedResponseCodes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ResponseCode) > 0 {
		dAtA45 := make([]byte, len(m.ResponseCode)*10)
		var j44 int
...
func (m *AIEnhancementsConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AIEnhancementsConfig) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AIEnhancementsConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.RiskScoreActionChoice != nil {
		{
			size := m.RiskScoreActionChoice.Size()
			i -= size
			if _, err := m.RiskScoreActionChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *AIEnhancementsConfig_MitigateHighRiskAction) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AIEnhancementsConfig_MitigateHighRiskAction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.MitigateHighRiskAction != nil {
		{
			size, err := m.MitigateHighRiskAction.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AIEnhancementsConfig_MitigateHighMediumRiskAction) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AIEnhancementsConfig_MitigateHighMediumRiskAction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.MitigateHighMediumRiskAction != nil {
		{
			size, err := m.MitigateHighMediumRiskAction.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CreateSpecType_DisableAiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_DisableAiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableAiEnhancements != nil {
		{
			size, err := m.DisableAiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_EnableAiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_EnableAiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnableAiEnhancements != nil {
		{
			size, err := m.EnableAiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_AiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_AiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AiEnhancements != nil {
		{
			size, err := m.AiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_DisableAiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_DisableAiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableAiEnhancements != nil {
		{
			size, err := m.DisableAiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_EnableAiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_EnableAiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnableAiEnhancements != nil {
		{
			size, err := m.EnableAiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_AiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_AiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AiEnhancements != nil {
		{
			size, err := m.AiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_DisableAiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_DisableAiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableAiEnhancements != nil {
		{
			size, err := m.DisableAiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_EnableAiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_EnableAiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnableAiEnhancements != nil {
		{
			size, err := m.EnableAiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_AiEnhancements) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_AiEnhancements) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AiEnhancements != nil {
		{
			size, err := m.AiEnhancements.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GlobalSpecType_DisableAiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DisableAiEnhancements != nil {
		l = m.DisableAiEnhancements.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *GlobalSpecType_EnableAiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.EnableAiEnhancements != nil {
		l = m.EnableAiEnhancements.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *GlobalSpecType_AiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DetectionSetting) Size() (n int) {
	...
	if len(m.ViolationsView) > 0 {
		for _, e := range m.ViolationsView {
			l = e.Size()
			n += 2 + l + sovTypes(uint64(l))
		}
	}
	if len(m.ConfiguredViolations) > 0 {
		for _, e := range m.ConfiguredViolations {
			l = e.Size()
			n += 2 + l + sovTypes(uint64(l))
		}
	}
...
func (m *ViolationConfiguration) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ViolationConfiguration_Enabled) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ViolationConfiguration_Disabled) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ViolationConfigView) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SignatureSelectionSetting) Size() (n int) {
	...
	if m.SignatureProtectionChoice != nil {
		n += m.SignatureProtectionChoice.Size()
	}
	return n
}
...
func (m *SignatureSelectionSetting_DefaultSignatureSetting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DefaultSignatureSetting != nil {
		l = m.DefaultSignatureSetting.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *SignatureSelectionSetting_SignatureSettingsByAccuracy) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignatureSettingsByAccuracy != nil {
		l = m.SignatureSettingsByAccuracy.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *SignatureProtectionSetting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.HighAccuracyAction != 0 {
		n += 1 + sovTypes(uint64(m.HighAccuracyAction))
	}
	if m.MediumAccuracyAction != 0 {
		n += 1 + sovTypes(uint64(m.MediumAccuracyAction))
	}
	if m.LowAccuracyAction != 0 {
		n += 1 + sovTypes(uint64(m.LowAccuracyAction))
	}
	return n
}
...
func (m *AIEnhancementsConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.RiskScoreActionChoice != nil {
		n += m.RiskScoreActionChoice.Size()
	}
	return n
}

func (m *AIEnhancementsConfig_MitigateHighRiskAction) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MitigateHighRiskAction != nil {
		l = m.MitigateHighRiskAction.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *AIEnhancementsConfig_MitigateHighMediumRiskAction) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MitigateHighMediumRiskAction != nil {
		l = m.MitigateHighMediumRiskAction.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *CreateSpecType_DisableAiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_EnableAiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_AiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_DisableAiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_EnableAiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_AiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_DisableAiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_EnableAiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_AiEnhancements) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GlobalSpecType) String() string {
	...
	s := strings.Join([]string{`&GlobalSpecType{`,
		...
		`EnhanceWithAiChoice:` + fmt.Sprintf("%v", this.EnhanceWithAiChoice) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *GlobalSpecType_DisableAiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_DisableAiEnhancements{`,
		`DisableAiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.DisableAiEnhancements), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GlobalSpecType_EnableAiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_EnableAiEnhancements{`,
		`EnableAiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.EnableAiEnhancements), "AIEnhancementsConfig", "AIEnhancementsConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GlobalSpecType_AiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_AiEnhancements{`,
		`AiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.AiEnhancements), "AiRiskBasedBlocking", "AiRiskBasedBlocking", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *DetectionSetting) String() string {
	...
	repeatedStringForViolationsView := "[]*ViolationConfigView{"
	for _, f := range this.ViolationsView {
		repeatedStringForViolationsView += strings.Replace(f.String(), "ViolationConfigView", "ViolationConfigView", 1) + ","
	}
	repeatedStringForViolationsView += "}"
	repeatedStringForConfiguredViolations := "[]*ViolationConfiguration{"
	for _, f := range this.ConfiguredViolations {
		repeatedStringForConfiguredViolations += strings.Replace(f.String(), "ViolationConfiguration", "ViolationConfiguration", 1) + ","
	}
	repeatedStringForConfiguredViolations += "}"
	s := strings.Join([]string{`&DetectionSetting{`,
		...
		`BotProtectionChoice:` + fmt.Sprintf("%v", this.BotProtectionChoice) + `,`,
		`ViolationsView:` + repeatedStringForViolationsView + `,`,
		`ConfiguredViolations:` + repeatedStringForConfiguredViolations + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *ViolationConfiguration) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ViolationConfiguration{`,
...
func (this *ViolationConfiguration_Enabled) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ViolationConfiguration_Enabled{`,
		`Enabled:` + strings.Replace(fmt.Sprintf("%v", this.Enabled), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ViolationConfiguration_Disabled) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ViolationConfiguration_Disabled{`,
		`Disabled:` + strings.Replace(fmt.Sprintf("%v", this.Disabled), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ViolationConfigView) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ViolationConfigView{`,
		`Title:` + fmt.Sprintf("%v", this.Title) + `,`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Description:` + fmt.Sprintf("%v", this.Description) + `,`,
		`Enabled:` + fmt.Sprintf("%v", this.Enabled) + `,`,
		`EnabledByDefault:` + fmt.Sprintf("%v", this.EnabledByDefault) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SignatureSelectionSetting) String() string {
	...
	s := strings.Join([]string{`&SignatureSelectionSetting{`,
		...
		`SignatureProtectionChoice:` + fmt.Sprintf("%v", this.SignatureProtectionChoice) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *SignatureSelectionSetting_DefaultSignatureSetting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SignatureSelectionSetting_DefaultSignatureSetting{`,
		`DefaultSignatureSetting:` + strings.Replace(fmt.Sprintf("%v", this.DefaultSignatureSetting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SignatureSelectionSetting_SignatureSettingsByAccuracy) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SignatureSelectionSetting_SignatureSettingsByAccuracy{`,
		`SignatureSettingsByAccuracy:` + strings.Replace(fmt.Sprintf("%v", this.SignatureSettingsByAccuracy), "SignatureProtectionSetting", "SignatureProtectionSetting", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SignatureProtectionSetting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SignatureProtectionSetting{`,
		`HighAccuracyAction:` + fmt.Sprintf("%v", this.HighAccuracyAction) + `,`,
		`MediumAccuracyAction:` + fmt.Sprintf("%v", this.MediumAccuracyAction) + `,`,
		`LowAccuracyAction:` + fmt.Sprintf("%v", this.LowAccuracyAction) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *AIEnhancementsConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AIEnhancementsConfig{`,
		`RiskScoreActionChoice:` + fmt.Sprintf("%v", this.RiskScoreActionChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AIEnhancementsConfig_MitigateHighRiskAction) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AIEnhancementsConfig_MitigateHighRiskAction{`,
		`MitigateHighRiskAction:` + strings.Replace(fmt.Sprintf("%v", this.MitigateHighRiskAction), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AIEnhancementsConfig_MitigateHighMediumRiskAction) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AIEnhancementsConfig_MitigateHighMediumRiskAction{`,
		`MitigateHighMediumRiskAction:` + strings.Replace(fmt.Sprintf("%v", this.MitigateHighMediumRiskAction), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *CreateSpecType_DisableAiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_DisableAiEnhancements{`,
		`DisableAiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.DisableAiEnhancements), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_EnableAiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_EnableAiEnhancements{`,
		`EnableAiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.EnableAiEnhancements), "AIEnhancementsConfig", "AIEnhancementsConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_AiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_AiEnhancements{`,
		`AiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.AiEnhancements), "AiRiskBasedBlocking", "AiRiskBasedBlocking", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ReplaceSpecType_DisableAiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_DisableAiEnhancements{`,
		`DisableAiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.DisableAiEnhancements), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_EnableAiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_EnableAiEnhancements{`,
		`EnableAiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.EnableAiEnhancements), "AIEnhancementsConfig", "AIEnhancementsConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_AiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_AiEnhancements{`,
		`AiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.AiEnhancements), "AiRiskBasedBlocking", "AiRiskBasedBlocking", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetSpecType_DisableAiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_DisableAiEnhancements{`,
		`DisableAiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.DisableAiEnhancements), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_EnableAiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_EnableAiEnhancements{`,
		`EnableAiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.EnableAiEnhancements), "AIEnhancementsConfig", "AIEnhancementsConfig", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_AiEnhancements) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_AiEnhancements{`,
		`AiEnhancements:` + strings.Replace(fmt.Sprintf("%v", this.AiEnhancements), "AiRiskBasedBlocking", "AiRiskBasedBlocking", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *GlobalSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableAiEnhancements", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnhanceWithAiChoice = &GlobalSpecType_DisableAiEnhancements{v}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableAiEnhancements", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &AIEnhancementsConfig{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.EnhanceWithAiChoice = &GlobalSpecType_EnableAiEnhancements{v}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AiEnhancements", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnhanceWithAiChoice = &GlobalSpecType_AiEnhancements{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *DetectionSetting) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ViolationsView", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ViolationsView = append(m.ViolationsView, &ViolationConfigView{})
			if err := m.ViolationsView[len(m.ViolationsView)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConfiguredViolations", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ConfiguredViolations = append(m.ConfiguredViolations, &ViolationConfiguration{})
			if err := m.ConfiguredViolations[len(m.ConfiguredViolations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ViolationConfiguration) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ViolationConfiguration: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ViolationConfiguration: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.StateChoice = &ViolationConfiguration_Enabled{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.StateChoice = &ViolationConfiguration_Disabled{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ViolationConfigView) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ViolationConfigView: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ViolationConfigView: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnabledByDefault", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnabledByDefault = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *SignatureSelectionSetting) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultSignatureSetting", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SignatureProtectionChoice = &SignatureSelectionSetting_DefaultSignatureSetting{v}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignatureSettingsByAccuracy", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SignatureProtectionSetting{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.SignatureProtectionChoice = &SignatureSelectionSetting_SignatureSettingsByAccuracy{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *SignatureProtectionSetting) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SignatureProtectionSetting: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SignatureProtectionSetting: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HighAccuracyAction", wireType)
			}
			m.HighAccuracyAction = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HighAccuracyAction |= SignatureAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MediumAccuracyAction", wireType)
			}
			m.MediumAccuracyAction = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MediumAccuracyAction |= SignatureAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LowAccuracyAction", wireType)
			}
			m.LowAccuracyAction = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LowAccuracyAction |= SignatureAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *AIEnhancementsConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AIEnhancementsConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AIEnhancementsConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MitigateHighRiskAction", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RiskScoreActionChoice = &AIEnhancementsConfig_MitigateHighRiskAction{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MitigateHighMediumRiskAction", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RiskScoreActionChoice = &AIEnhancementsConfig_MitigateHighMediumRiskAction{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *CreateSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			...
			m.EnhanceWithAiChoice = &CreateSpecType_DisableAiEnhancements{v}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableAiEnhancements", wireType)
			...
			m.EnhanceWithAiChoice = &CreateSpecType_EnableAiEnhancements{v}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AiEnhancements", wireType)
			...
			m.EnhanceWithAiChoice = &CreateSpecType_AiEnhancements{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ReplaceSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			...
			m.EnhanceWithAiChoice = &ReplaceSpecType_DisableAiEnhancements{v}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableAiEnhancements", wireType)
			...
			m.EnhanceWithAiChoice = &ReplaceSpecType_EnableAiEnhancements{v}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AiEnhancements", wireType)
			...
			m.EnhanceWithAiChoice = &ReplaceSpecType_AiEnhancements{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *GetSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			...
			m.EnhanceWithAiChoice = &GetSpecType_DisableAiEnhancements{v}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableAiEnhancements", wireType)
			...
			m.EnhanceWithAiChoice = &GetSpecType_EnableAiEnhancements{v}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AiEnhancements", wireType)
			...
			m.EnhanceWithAiChoice = &GetSpecType_AiEnhancements{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
