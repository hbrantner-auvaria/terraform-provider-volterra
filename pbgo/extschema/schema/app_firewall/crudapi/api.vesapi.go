...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/app_firewall"
)
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.app_firewall.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.app_firewall.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.app_firewall.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.app_firewall.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.app_firewall.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.app_firewall.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.app_firewall.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.app_firewall.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.app_firewall.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.app_firewall.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.app_firewall.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.app_firewall.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.app_firewall.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.app_firewall.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.app_firewall.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/app_firewall/crudapi/api.proto",
    ...
    "paths": {
        "/ves.io.schema.app_firewall/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.app_firewall.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.app_firewall.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.app_firewall.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "app_firewall",
            "x-ves-object-type": "ves.io.schema.app_firewall.Object",
            "x-ves-proto-service": "ves.io.schema.app_firewall.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.app_firewall/Objects": {
            "get": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.app_firewall.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.app_firewall.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "app_firewall",
            "x-ves-object-type": "ves.io.schema.app_firewall.Object",
        ...
        "/ves.io.schema.app_firewall/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-app_firewall-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.app_firewall.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "app_firewall",
            "x-ves-object-type": "ves.io.schema.app_firewall.Object",
        ...
        "/ves.io.schema.app_firewall/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.app_firewall/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.app_firewall/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.app_firewall/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.app_firewall.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "app_firewallDetectionSetting": {
            ...
            "properties": {
                ...
                "violations_view": {
                    ...
                    "items": {
                        "$ref": "#/definitions/app_firewallViolationConfigView"
                    },
        ...
        "app_firewallGlobalSpecType": {
            ...
            "properties": {
                ...
                "disable_ai_enhancements": {
                    "description": "Exclusive with [enable_ai_enhancements]\n Risk-base AI evaluations will not factor into enforcement actions",
                    "title": "Disable AI Enhancements",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Disable"
                },
                ...
                "enable_ai_enhancements": {
                    "description": "Exclusive with [disable_ai_enhancements]\n Evaluations for enforcement actions will be complimented by the additional intelligence\n of the F5 AI Powered Risk-based analysis",
                    "title": "Enable AI Enhancements",
                    "$ref": "#/definitions/app_firewallAIEnhancementsConfig",
                    "x-displayname": "Enable"
                },
                "monitoring": {
        ...
        "app_firewallSpecType": {
            "type": "object",
            "description": "Shape of the Application Firewall specification",
            "title": "Application Firewall Object Specification",
            "x-displayname": "Application Firewall Object Specification",
            "x-ves-proto-message": "ves.io.schema.app_firewall.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
        ...
        "app_firewallViolationConfiguration": {
            "type": "object",
            "description": "x-displayName: \"Violation Configuration\"\nApp Firewall violation configuration changes to be applied",
            "title": "Violation Configuration",
            "properties": {
                "disabled": {
                ...
                "name": {
                    "type": "string",
                    "description": "x-displayName: \"Violation\"\nx-example: \"VIOL_MANDATORY_HEADER\"\nx-required",
                    "title": "Violation"
                }
            }
        },
        ...
        "app_firewallcrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.app_firewall.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.app_firewall.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/app_firewallSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.app_firewall.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/app_firewallcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.app_firewall.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/app_firewallcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.app_firewall.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.app_firewall.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/app_firewallcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.app_firewall.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.app_firewall.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.app_firewall.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/app_firewallcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/app_firewall/crudapi/api.proto"
}`
