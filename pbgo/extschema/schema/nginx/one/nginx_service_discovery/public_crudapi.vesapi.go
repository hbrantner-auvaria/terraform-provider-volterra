...
const (
	...
	CreateRequestFQN = "ves.io.schema.nginx.one.nginx_service_discovery.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.nginx.one.nginx_service_discovery.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.nginx.one.nginx_service_discovery.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.nginx.one.nginx_service_discovery.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.nginx.one.nginx_service_discovery.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.nginx.one.nginx_service_discovery.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.nginx.one.nginx_service_discovery.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.nginx.one.nginx_service_discovery.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.nginx.one.nginx_service_discovery.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.nginx.one.nginx_service_discovery.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nginx_service_discoverys", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nginx_service_discoverys/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nginx_service_discoverys/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/nginx_service_discoverys", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/nginx_service_discoverys/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.nginx.one.nginx_service_discovery.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.nginx.one.nginx_service_discovery")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.nginx.one.nginx_service_discovery.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.nginx.one.nginx_service_discovery.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.nginx.one.nginx_service_discovery.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.nginx.one.nginx_service_discovery.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.nginx.one.nginx_service_discovery.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.nginx.one.nginx_service_discovery.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.nginx.one.nginx_service_discovery.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nginx.one.nginx_service_discovery.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.nginx.one.nginx_service_discovery.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.nginx.one.nginx_service_discovery.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.nginx.one.nginx_service_discovery.API.Create' operation on 'nginx_service_discovery'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.nginx.one.nginx_service_discovery.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.nginx.one.nginx_service_discovery.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nginx.one.nginx_service_discovery.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.nginx.one.nginx_service_discovery.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.nginx.one.nginx_service_discovery.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.nginx.one.nginx_service_discovery.API.Replace' operation on 'nginx_service_discovery'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.nginx.one.nginx_service_discovery.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nginx.one.nginx_service_discovery.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.nginx.one.nginx_service_discovery.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nginx.one.nginx_service_discovery.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.nginx.one.nginx_service_discovery.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.nginx.one.nginx_service_discovery.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.nginx.one.nginx_service_discovery.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.nginx.one.nginx_service_discovery.API.Delete' operation on 'nginx_service_discovery'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.nginx.one.nginx_service_discovery.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/nginx_service_discoverys": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/nginx_service_discoveryCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/nginx_service_discoveryCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-ves-proto-service": "ves.io.schema.nginx.one.nginx_service_discovery.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/nginx_service_discoverys/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/nginx_service_discoveryReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/nginx_service_discoveryReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/nginx_service_discoverys": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/nginx_service_discoveryListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/nginx_service_discoverys/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/nginx_service_discoveryGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/nginx_service_discoveryDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "nginx_service_discoveryConfigSyncGroup": {
            "type": "object",
            "description": "x-required\nSelect new ConfigSyncGroup",
            "title": "NGINX Config Sync Group",
            "x-displayname": "ConfigSyncGroup Reference",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_service_discovery.ConfigSyncGroup",
            "properties": {
                "config_sync_group": {
                    "type": "array",
                    "description": " Select new ConfigSyncGroup\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "Config Sync Group",
                    "maxItems": 1,
                    "items": {
        ...
        "nginx_service_discoveryCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of nginx_service_discovery",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the NGINX Service Discovery",
                    "title": "spec",
                    "$ref": "#/definitions/nginx_service_discoveryCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "nginx_service_discoveryCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the NGINX Service Discovery",
                    "title": "spec",
                    "$ref": "#/definitions/nginx_service_discoveryGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "nginx_service_discoveryCreateSpecType": {
            "type": "object",
            "description": "API to create NGINX Service Discovery object for a site or virtual site in system namespace",
            "title": "Create NGINX Service Discovery",
        ...
        "nginx_service_discoveryDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a nginx_service_discovery",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_service_discovery.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "nginx_service_discoveryDiscoveryTarget": {
            "type": "object",
            ...
            "properties": {
                "config_sync_group": {
                    ...
                    "title": "Config Sync Group",
                    "$ref": "#/definitions/nginx_service_discoveryConfigSyncGroup",
                    "x-displayname": "NGINX Config Sync Group"
                },
                "nginx_instance": {
                    "description": "Exclusive with [config_sync_group]\n",
                    "title": "NGINX Instance",
                    "$ref": "#/definitions/nginx_service_discoveryNGINXInstance",
                    "x-displayname": "NGINX Instance"
                }
            }
        },
        "nginx_service_discoveryGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read nginx_service_discovery",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/nginx_service_discoveryStatusObject"
                    },
        ...
        "nginx_service_discoveryGetResponseFormatCode": {
            "type": "string",
        ...
        "nginx_service_discoveryGetSpecType": {
            "type": "object",
            "description": "API to Get NGINX Service Discovery object for a site or virtual site in system namespace",
            "title": "Get NGINX Service Discovery",
        ...
        "nginx_service_discoveryListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of nginx_service_discovery",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_service_discovery.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/nginx_service_discoveryListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "nginx_service_discoveryListResponseItem": {
            "type": "object",
            "description": "By default a summary of nginx_service_discovery is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of nginx_service_discovery",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_service_discovery.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates nginx_service_discovery is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this nginx_service_discovery\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this nginx_service_discovery\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "nginx_service_discoveryNGINXInstance": {
            "type": "object",
            "description": "x-required\nSelect new NGINX Instance",
            "title": "NGINX Instance",
            "x-displayname": "NGINXInstance Reference",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_service_discovery.NGINXInstance",
            "properties": {
                "nginx_instance": {
                    "type": "array",
        ...
        "nginx_service_discoveryReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a nginx_service_discovery",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the NGINX Service Discovery",
                    "title": "spec",
                    "$ref": "#/definitions/nginx_service_discoveryReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "nginx_service_discoveryReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_service_discovery.ReplaceResponse"
        },
        "nginx_service_discoveryReplaceSpecType": {
            "type": "object",
            "description": "API to replace NGINX Service Discovery object for a site or virtual site in system namespace",
            "title": "Replace NGINX Service Discovery",
        ...
        "nginx_service_discoveryServerBlockFilter": {
            "type": "object",
            "title": "Server Block Filter",
            "x-displayname": "Server Block Filter",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_service_discovery.ServerBlockFilter",
            "properties": {
                "name_regex": {
                    "type": "string",
                    "description": " Regular expression to match the server name or domain that must be discovered\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 256\n  ves.io.schema.rules.string.regex: true\n",
                    "title": "Regex To Match Server name or Domain",
                    "maxLength": 256,
        ...
        "nginx_service_discoveryStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "NGINX Service Discovery Status Object",
            "x-displayname": "NGINX Service Discovery Status",
            "x-ves-proto-message": "ves.io.schema.nginx.one.nginx_service_discovery.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
    ...
    "x-displayname": "NGINX Service Discovery",
    "x-ves-proto-file": "ves.io/schema/nginx/one/nginx_service_discovery/public_crudapi.proto"
}`
