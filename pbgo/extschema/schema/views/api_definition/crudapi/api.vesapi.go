...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/api_definition"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.api_definition.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.api_definition.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.api_definition.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.api_definition.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_definition.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.api_definition.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_definition.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.api_definition.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_definition.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_definition.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_definition.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.api_definition.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/api_definition/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.api_definition/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_definition-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_definition.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_definition-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_definition.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_definition-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_definition.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_definition",
            "x-ves-object-type": "ves.io.schema.views.api_definition.Object",
            "x-ves-proto-service": "ves.io.schema.views.api_definition.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.api_definition/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_definition-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_definition.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_definition-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_definition.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_definition",
            "x-ves-object-type": "ves.io.schema.views.api_definition.Object",
        ...
        "/ves.io.schema.views.api_definition/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_definition-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_definition.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_definition",
            "x-ves-object-type": "ves.io.schema.views.api_definition.Object",
        ...
        "/ves.io.schema.views.api_definition/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.api_definition/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.api_definition/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.api_definition/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.api_definition.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "api_definitionSpecType": {
            ...
            "x-ves-proto-message": "ves.io.schema.views.api_definition.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
        ...
        "api_definitionStatusObject": {
            "type": "object",
            "title": "Most recently observed status of object",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "api_definitioncrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.api_definition.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/api_definitionSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_definitioncrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_definitioncrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api_definitionStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_definitioncrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_definition.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_definitioncrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/views/api_definition/crudapi/api.proto"
}`
