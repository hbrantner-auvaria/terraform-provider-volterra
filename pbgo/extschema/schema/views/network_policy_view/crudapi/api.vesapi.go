...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/network_policy_view"
)
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.network_policy_view.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.views.network_policy_view.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.network_policy_view.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.network_policy_view.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.network_policy_view.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.network_policy_view.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.network_policy_view.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.network_policy_view.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.network_policy_view.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.network_policy_view.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.network_policy_view.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/network_policy_view/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.network_policy_view/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-network_policy_view-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.network_policy_view.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-network_policy_view-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.network_policy_view.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-network_policy_view-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.network_policy_view.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "network_policy_view",
            "x-ves-object-type": "ves.io.schema.views.network_policy_view.Object",
            "x-ves-proto-service": "ves.io.schema.views.network_policy_view.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.network_policy_view/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-network_policy_view-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.network_policy_view.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-network_policy_view-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.network_policy_view.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "network_policy_view",
            "x-ves-object-type": "ves.io.schema.views.network_policy_view.Object",
        ...
        "/ves.io.schema.views.network_policy_view/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-network_policy_view-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.network_policy_view.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "network_policy_view",
            "x-ves-object-type": "ves.io.schema.views.network_policy_view.Object",
        ...
        "/ves.io.schema.views.network_policy_view/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.network_policy_view/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.network_policy_view/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.network_policy_view/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.network_policy_view.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.network_policy_view.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.network_policy_view.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_policy_viewcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.network_policy_view.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_policy_viewcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.network_policy_view.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.network_policy_view.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_policy_viewcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.network_policy_view.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.network_policy_view.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.network_policy_view.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/network_policy_viewcrudapiErrorCode"
                },
        ...
        "network_policy_viewcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.network_policy_view.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/views/network_policy_view/crudapi/api.proto"
}`
