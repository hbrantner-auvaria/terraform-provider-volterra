...
const (
	...
	CreateRequestFQN = "ves.io.schema.views.external_connector.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.views.external_connector.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.views.external_connector.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.views.external_connector.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.views.external_connector.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.views.external_connector.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.views.external_connector.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.views.external_connector.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.views.external_connector.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.views.external_connector.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/external_connectors", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/external_connectors/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/external_connectors/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/external_connectors", c.baseURL, req.Namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.external_connector.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.views.external_connector")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.external_connector.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.external_connector.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.external_connector.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.external_connector.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.external_connector.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.external_connector.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.external_connector.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.external_connector.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.external_connector.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.views.external_connector.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.external_connector.API.Create' operation on 'external_connector'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.views.external_connector.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.external_connector.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.external_connector.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.external_connector.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.views.external_connector.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.views.external_connector.API.Replace' operation on 'external_connector'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.external_connector.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.external_connector.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.views.external_connector.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.external_connector.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.external_connector.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.external_connector.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.views.external_connector.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.views.external_connector.API.Delete' operation on 'external_connector'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "External Connector Configuration",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/external_connectors": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/external_connectorCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/external_connectorCreateRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{metadata.namespace}/external_connectors/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/external_connectorReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/external_connectorReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/external_connectors": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/external_connectorListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/external_connectors/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/external_connectorGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/external_connectorDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "external_connectorConnectionTypeDirect": {
            "type": "object",
        ...
        "external_connectorConnectionTypeIPSec": {
            "type": "object",
            ...
            "properties": {
                "ike_parameters": {
                    "description": " This section involves choosing the IKE parameters including the Phase 1 \u0026 Phase 2 Policies as well as other parameters.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "IKE Parameters",
                    "$ref": "#/definitions/external_connectorIkeParameters",
                ...
                "ipsec_tunnel_parameters": {
                    ...
                    "$ref": "#/definitions/external_connectorTunnelParameters",
        ...
        "external_connectorCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of external_connector",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the external connector",
                    "title": "spec",
                    "$ref": "#/definitions/external_connectorCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "external_connectorCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the external connector",
                    "title": "spec",
                    "$ref": "#/definitions/external_connectorGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "external_connectorCreateSpecType": {
            "type": "object",
            "description": "Shape of the external_connector configuration specification",
            ...
            "properties": {
                "ce_site_reference": {
                    "description": " Choose a CE site that will terminate the tunnel\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "external_connectorDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a external_connector",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.views.external_connector.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "external_connectorDpdKeepAliveTimer": {
            "type": "object",
            "title": "Keepalive Timer",
            "x-displayname": "Keepalive Timer",
            "x-ves-proto-message": "ves.io.schema.views.external_connector.DpdKeepAliveTimer",
            "properties": {
                "timeout": {
                    "type": "integer",
        ...
        "external_connectorGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read external_connector",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/external_connectorStatusObject"
                    },
        ...
        "external_connectorGetResponseFormatCode": {
            "type": "string",
        ...
        "external_connectorIkeParameters": {
            "type": "object",
            ...
            "properties": {
                ...
                "dpd_keep_alive_timer": {
                    "description": "Exclusive with [dpd_disabled]\n Enable Dead Peer Detection (DPD) by setting the keepalive timer.",
                    "title": "Enabled",
                    "$ref": "#/definitions/external_connectorDpdKeepAliveTimer",
                    "x-displayname": "Enabled"
                },
                "ike_phase1_profile": {
                    "description": " IKE Phase 1 profile defines mainly the encryption and authentication algorithms to be used for IKE SA\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "IKE Phase 1 Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                ...
                "ike_phase2_profile": {
                    "description": " IKE Phase 2 profile defines mainly the encryption and authentication algorithms to be used for ESP SA\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "IKE Phase 2 Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                ...
                "rm_ip_address": {
                    "description": "Exclusive with [rm_hostname use_default_remote_ike_id]\n Configure an IP address as Remote IKE ID",
                    "title": "IP Address",
                ...
                "use_default_local_ike_id": {
                    ...
                    "title": "Use Default Local IKE ID (IP Address)",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Use Default Local IKE ID (IP Address)"
                },
                "use_default_remote_ike_id": {
                    "description": "Exclusive with [rm_hostname rm_ip_address]\n Use default remote IKE ID (IP address of tunnel gateway)",
                    "title": "Use Default Remote IKE ID",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Use Default Remote IKE ID (IP address)"
                }
            }
        },
        "external_connectorListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of external_connector",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.views.external_connector.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/external_connectorListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "external_connectorListResponseItem": {
            "type": "object",
            "description": "By default a summary of external_connector is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of external_connector",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.views.external_connector.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                ...
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates external_connector is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                    "x-displayname": "Disabled"
                },
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this external_connector\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this external_connector\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "external_connectorReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a external_connector",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the external connector",
                    "title": "spec",
                    "$ref": "#/definitions/external_connectorReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "external_connectorReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.external_connector.ReplaceResponse"
        },
        "external_connectorReplaceSpecType": {
            "type": "object",
            "description": "Shape of the external_connector configuration specification",
        ...
        "external_connectorStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.views.external_connector.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "external_connectorTunnelEndpoint": {
            "type": "object",
            "description": "Configure tunnel endpoints, local and remote IP addresses",
            "title": "Tunnel Endpoint",
            "x-displayname": "Tunnel Endpoint",
            "x-ves-displayorder": "1,2,5,6",
            "x-ves-proto-message": "ves.io.schema.views.external_connector.TunnelEndpoint",
            "properties": {
                "interface": {
                    "type": "string",
                    "description": " For the chosen node, specify the interface that will be the tunnel source.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Interface",
                ...
                "local_tunnel_ip": {
                    "type": "string",
                    "description": " For a particular tunnel on a node, specify the local tunnel IP Address i.e. the IP address of the tunnel on the CE node itself and a subnet prefix length\n\nExample: - \"10.10.15.1/24\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.ipv4_prefix: true\n",
                    "title": "Local Tunnel IP Address",
                    "x-displayname": "Local Tunnel IP Address/Prefix Length",
                    "x-ves-example": "10.10.15.1/24",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.ipv4_prefix": "true"
                ...
                "node": {
                    "type": "string",
                    "description": " A CE site is composed of multiple nodes. Choose a node that will be part of this external connection.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Node",
                    "x-displayname": "Node",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                ...
                "remote_tunnel_ip": {
                    "type": "string",
                    "description": " For a particular tunnel on a node, specify the remote tunnel IP Address i.e. the IP address of the tunnel on the remote gateway and a subnet prefix length\n\nExample: - \"10.10.15.2/24\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.ipv4_prefix: true\n",
                    "title": "Remote Tunnel IP Address",
                    "x-displayname": "Remote Tunnel IP Address/Prefix Length",
                    "x-ves-example": "10.10.15.2/24",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true",
                        "ves.io.schema.rules.string.ipv4_prefix": "true"
        ...
        "external_connectorTunnelParameters": {
            "type": "object",
            "description": "In this section, we will configure the tunnel parameters, source, destination, IP addresses,  and segment.",
            "title": "TunnelParameters",
            ...
            "properties": {
                "peer_ip_address": {
                    "description": " This is the reachable address for the remote gateway. For instance if the remote gateway is reachable over the public internet with a public address, then the remote Gateway IP Address would be this public address.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Remote Gateway IP Address",
                    "$ref": "#/definitions/schemaIpv4AddressType",
                ...
                "psk": {
                    "type": "string",
                    "description": " The IKE pre-shared key (PSK) is required to ensure the IKE peers can authenticate one another within IKE phase 1 negotiation.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "tunnel_mtu": {
                    "type": "integer",
                    "description": " The tunnel MTU defines the maximum size of the packet that can be sent through the tunnel without needing to be fragmented\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.uint32.gte: 512\n  ves.io.schema.rules.uint32.lte: 1370\n",
                    "title": "MTU",
                    "format": "int64",
                    "x-displayname": "MTU",
                    "x-ves-required": "true",
    ...
    "x-displayname": "External Connector Configuration",
    "x-ves-proto-file": "ves.io/schema/views/external_connector/public_crudapi.proto"
}`
