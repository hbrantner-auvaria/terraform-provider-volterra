...
func (c *privateCustomAPIInprocClient) UpdateSiteError(ctx context.Context, in *ves_io_schema_views.UpdateSiteErrorRequest, opts ...grpc.CallOption) (*ves_io_schema_views.UpdateSiteErrorResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.gcp_vpc_site.PrivateCustomAPI.UpdateSiteError")
...
func (s *privateCustomAPISrv) UpdateSiteError(ctx context.Context, in *ves_io_schema_views.UpdateSiteErrorRequest) (*ves_io_schema_views.UpdateSiteErrorResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.views.gcp_vpc_site.PrivateCustomAPI")
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.views.gcp_vpc_site.PrivateCustomAPI.UpdateSiteError"); rvFn != nil {
...
var PrivateCustomAPISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/gcp_vpc_site/private_customapi.proto",
    ...
    "tags": [],
    "paths": {
        "/private/custom/namespaces/{namespace}/gcp_vpc_site/{name}/update_site_error": {
            "post": {
                "summary": "UpdateSiteError",
                "description": "Private API to update service domains from service.",
                "operationId": "ves.io.schema.views.gcp_vpc_site.PrivateCustomAPI.UpdateSiteError",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-gcp_vpc_site-privatecustomapi-updatesiteerror"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.gcp_vpc_site.PrivateCustomAPI.UpdateSiteError"
            },
            "x-displayname": "Private Custom API for AWS TGW Site",
            "x-ves-proto-service": "ves.io.schema.views.gcp_vpc_site.PrivateCustomAPI",
            "x-ves-proto-service-type": "CUSTOM_PRIVATE"
        },
        "/ves.io.schema/introspect/write/custom/namespaces/{namespace}/gcp_vpc_site/{name}/update_site_error": {
            "post": {
                "summary": "UpdateSiteError",
                "description": "Private API to update service domains from service.",
                "operationId": "ves.io.schema.views.gcp_vpc_site.PrivateCustomAPI.UpdateSiteError",
    ...
    "x-displayname": "",
    "x-ves-proto-file": "ves.io/schema/views/gcp_vpc_site/private_customapi.proto"
}`
