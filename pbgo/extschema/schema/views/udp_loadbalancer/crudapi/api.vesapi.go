...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/udp_loadbalancer"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.udp_loadbalancer.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.udp_loadbalancer.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.views.udp_loadbalancer.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.udp_loadbalancer.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.udp_loadbalancer.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.udp_loadbalancer.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.udp_loadbalancer.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.udp_loadbalancer.crudapi.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.udp_loadbalancer.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.udp_loadbalancer.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.udp_loadbalancer.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.udp_loadbalancer.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.udp_loadbalancer.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.udp_loadbalancer.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.udp_loadbalancer.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.udp_loadbalancer.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/udp_loadbalancer/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.udp_loadbalancer/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-udp_loadbalancer-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-udp_loadbalancer-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-udp_loadbalancer-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "udp_loadbalancer",
            "x-ves-object-type": "ves.io.schema.views.udp_loadbalancer.Object",
            "x-ves-proto-service": "ves.io.schema.views.udp_loadbalancer.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.udp_loadbalancer/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-udp_loadbalancer-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.udp_loadbalancer.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-udp_loadbalancer-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "udp_loadbalancer",
            "x-ves-object-type": "ves.io.schema.views.udp_loadbalancer.Object",
        ...
        "/ves.io.schema.views.udp_loadbalancer/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-udp_loadbalancer-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.udp_loadbalancer.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "udp_loadbalancer",
            "x-ves-object-type": "ves.io.schema.views.udp_loadbalancer.Object",
        ...
        "/ves.io.schema.views.udp_loadbalancer/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.udp_loadbalancer/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.udp_loadbalancer/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.udp_loadbalancer/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.udp_loadbalancer.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/viewsudp_loadbalancerSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/udp_loadbalancercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/udp_loadbalancercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/udp_loadbalancerStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/udp_loadbalancercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/udp_loadbalancercrudapiErrorCode"
                },
        ...
        "udp_loadbalancercrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.udp_loadbalancer.crudapi.ErrorCode"
        },
        ...
        "viewsudp_loadbalancerGlobalSpecType": {
            "type": "object",
            "description": "Shape of the UDP load balancer view specification",
        ...
        "viewsudp_loadbalancerSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.udp_loadbalancer.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/viewsudp_loadbalancerGlobalSpecType",
    ...
    "x-ves-proto-file": "ves.io/schema/views/udp_loadbalancer/crudapi/api.proto"
}`
