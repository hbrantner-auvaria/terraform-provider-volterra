...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.tcp_loadbalancer.API.Create' operation on 'tcp_loadbalancer'"
		if retErr == nil {
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.tcp_loadbalancer.API.Replace' operation on 'tcp_loadbalancer'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.tcp_loadbalancer.API.Delete' operation on 'tcp_loadbalancer'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
    ...
    "paths": {
        "/public/namespaces/{metadata.namespace}/tcp_loadbalancers": {
            "post": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-tcp_loadbalancer-api-create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/tcp_loadbalancers/{metadata.name}": {
            "put": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-tcp_loadbalancer-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/tcp_loadbalancers": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-tcp_loadbalancer-api-list"
                },
        ...
        "/public/namespaces/{namespace}/tcp_loadbalancers/{name}": {
            "get": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-tcp_loadbalancer-api-get"
                },
            ...
            "delete": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-tcp_loadbalancer-api-delete"
                },
