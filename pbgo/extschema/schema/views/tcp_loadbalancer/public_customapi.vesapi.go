...
func (c *CustomAPIGrpcClient) doRPCGetDnsInfo(ctx context.Context, yamlReq string, opts ...grpc.CallOption) (proto.Message, error) {
	...
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.views.tcp_loadbalancer.GetDnsInfoRequest", yamlReq)
	}
...
func (c *CustomAPIRestClient) doRPCGetDnsInfo(ctx context.Context, callOpts *server.CustomCallOpts) (proto.Message, error) {
	...
	req := &GetDnsInfoRequest{}
	if err := codec.FromYAML(yamlReq, req); err != nil {
		return nil, fmt.Errorf("YAML Request %s is not of type *ves.io.schema.views.tcp_loadbalancer.GetDnsInfoRequest: %s", yamlReq, err)
	}
...
func (c *customAPIInprocClient) GetDnsInfo(ctx context.Context, in *GetDnsInfoRequest, opts ...grpc.CallOption) (*GetDnsInfoResponse, error) {
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.tcp_loadbalancer.CustomAPI.GetDnsInfo")
...
func (s *customAPISrv) GetDnsInfo(ctx context.Context, in *GetDnsInfoRequest) (*GetDnsInfoResponse, error) {
	ah := s.svc.GetAPIHandler("ves.io.schema.views.tcp_loadbalancer.CustomAPI")
	...
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.svc, "ves.io.schema.views.tcp_loadbalancer.GetDnsInfoRequest", in)
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'CustomAPI.GetDnsInfo' operation on 'tcp_loadbalancer'"
		if err == nil {
	...
	if s.svc.Config().EnableAPIValidation {
		if rvFn := s.svc.GetRPCValidator("ves.io.schema.views.tcp_loadbalancer.CustomAPI.GetDnsInfo"); rvFn != nil {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/tcp_loadbalancerGetDnsInfoResponse"
                        }
                    },
                    "401": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-tcp_loadbalancer-customapi-getdnsinfo"
                },
