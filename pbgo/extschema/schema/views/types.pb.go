...
type WhereType struct {
	...
	//	*WhereType_AdvertiseV6OnPublic
	//	*WhereType_AdvertiseDualstackOnPublic
...
type WhereType_AdvertiseV6OnPublic struct {
	AdvertiseV6OnPublic *AdvertisePublic `protobuf:"bytes,18,opt,name=advertise_v6_on_public,json=advertiseV6OnPublic,proto3,oneof" json:"advertise_v6_on_public,omitempty"`
}
type WhereType_AdvertiseDualstackOnPublic struct {
	AdvertiseDualstackOnPublic *AdvertisePublic `protobuf:"bytes,19,opt,name=advertise_dualstack_on_public,json=advertiseDualstackOnPublic,proto3,oneof" json:"advertise_dualstack_on_public,omitempty"`
}
...
func (*WhereType_AdvertiseV6OnPublic) isWhereType_Choice()        {}
func (*WhereType_AdvertiseDualstackOnPublic) isWhereType_Choice() {}
...
func (m *WhereType) GetAdvertiseV6OnPublic() *AdvertisePublic {
	if x, ok := m.GetChoice().(*WhereType_AdvertiseV6OnPublic); ok {
		return x.AdvertiseV6OnPublic
	}
	return nil
}

func (m *WhereType) GetAdvertiseDualstackOnPublic() *AdvertisePublic {
	if x, ok := m.GetChoice().(*WhereType_AdvertiseDualstackOnPublic); ok {
...
func (*WhereType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*WhereType_AdvertiseV6OnPublic)(nil),
		(*WhereType_AdvertiseDualstackOnPublic)(nil),
...
type PerformanceEnhancementModeType_PerfModeL7Enhanced struct {
	PerfModeL7Enhanced *L7PerformanceEnhancementType `protobuf:"bytes,2,opt,name=perf_mode_l7_enhanced,json=perfModeL7Enhanced,proto3,oneof" json:"perf_mode_l7_enhanced,omitempty"`
}
...
func (m *PerformanceEnhancementModeType) GetPerfModeL7Enhanced() *L7PerformanceEnhancementType {
...
// L7 Mode Enhanced Performance options
//
// x-displayName: "L7 Mode Enhanced Performance"
// x-required
// L7 enhanced performance mode options
type L7PerformanceEnhancementType struct {
	// L7 Mode Enhanced Performance Options
	//
	// x-displayName: "Jumbo Frame Support"
	// x-required
	// Choose to enable/disable jumbo frame support for L7 optimized workloads.
	//
	// Types that are valid to be assigned to PerfModeChoice:
	//	*L7PerformanceEnhancementType_JumboDisabled
	//	*L7PerformanceEnhancementType_JumboEnabled
	PerfModeChoice isL7PerformanceEnhancementType_PerfModeChoice `protobuf_oneof:"perf_mode_choice"`
}

func (m *L7PerformanceEnhancementType) Reset()      { *m = L7PerformanceEnhancementType{} }
func (*L7PerformanceEnhancementType) ProtoMessage() {}
func (*L7PerformanceEnhancementType) Descriptor() ([]byte, []int) {
	return fileDescriptor_e96f5c708a09275e, []int{40}
}
func (m *L7PerformanceEnhancementType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *L7PerformanceEnhancementType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *L7PerformanceEnhancementType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_L7PerformanceEnhancementType.Merge(m, src)
}
func (m *L7PerformanceEnhancementType) XXX_Size() int {
	return m.Size()
}
func (m *L7PerformanceEnhancementType) XXX_DiscardUnknown() {
	xxx_messageInfo_L7PerformanceEnhancementType.DiscardUnknown(m)
}

var xxx_messageInfo_L7PerformanceEnhancementType proto.InternalMessageInfo

type isL7PerformanceEnhancementType_PerfModeChoice interface {
	isL7PerformanceEnhancementType_PerfModeChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type L7PerformanceEnhancementType_JumboDisabled struct {
	JumboDisabled *schema.Empty `protobuf:"bytes,2,opt,name=jumbo_disabled,json=jumboDisabled,proto3,oneof" json:"jumbo_disabled,omitempty"`
}
type L7PerformanceEnhancementType_JumboEnabled struct {
	JumboEnabled *schema.Empty `protobuf:"bytes,3,opt,name=jumbo_enabled,json=jumboEnabled,proto3,oneof" json:"jumbo_enabled,omitempty"`
}

func (*L7PerformanceEnhancementType_JumboDisabled) isL7PerformanceEnhancementType_PerfModeChoice() {}
func (*L7PerformanceEnhancementType_JumboEnabled) isL7PerformanceEnhancementType_PerfModeChoice()  {}

func (m *L7PerformanceEnhancementType) GetPerfModeChoice() isL7PerformanceEnhancementType_PerfModeChoice {
	if m != nil {
		return m.PerfModeChoice
	}
	return nil
...
func (m *L7PerformanceEnhancementType) GetJumboDisabled() *schema.Empty {
	if x, ok := m.GetPerfModeChoice().(*L7PerformanceEnhancementType_JumboDisabled); ok {
		return x.JumboDisabled
	}
	return nil
}

func (m *L7PerformanceEnhancementType) GetJumboEnabled() *schema.Empty {
	if x, ok := m.GetPerfModeChoice().(*L7PerformanceEnhancementType_JumboEnabled); ok {
		return x.JumboEnabled
	}
	return nil
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*L7PerformanceEnhancementType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*L7PerformanceEnhancementType_JumboDisabled)(nil),
		(*L7PerformanceEnhancementType_JumboEnabled)(nil),
	}
}
...
func (*SnatPoolConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_e96f5c708a09275e, []int{54}
}
...
// ThirdPartyAuthorizationToken
//
// x-displayName: "ThirdPartyAuthorizationToken"
// ThirdPartyAuthorizationToken message
// will return as a base64 encode struct for GenerateToken rpc
// will be used in accesslog request header
type ThirdPartyAuthorizationToken struct {
	// Tenant
	//
	// x-displayName: "Tenant"
	// x-example: "customer1-xgarnod"
	// x-required
	...
	// x-example: "ves-io-third-party-ds1-app2"
	// x-required
	// The Name of the Virtual Host
	VhName string `protobuf:"bytes,3,opt,name=vh_name,json=vhName,proto3" json:"vh_name,omitempty"`
	// AppType
	//
	// x-displayName: "App Type"
	// x-example: "ves-io-system-oob-ds-app1"
	// x-required
	// Name of the App Type object
	AppType string `protobuf:"bytes,4,opt,name=app_type,json=appType,proto3" json:"app_type,omitempty"`
}

func (m *ThirdPartyAuthorizationToken) Reset()      { *m = ThirdPartyAuthorizationToken{} }
func (*ThirdPartyAuthorizationToken) ProtoMessage() {}
func (*ThirdPartyAuthorizationToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_e96f5c708a09275e, []int{55}
}
func (m *ThirdPartyAuthorizationToken) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ThirdPartyAuthorizationToken) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ThirdPartyAuthorizationToken) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ThirdPartyAuthorizationToken.Merge(m, src)
}
func (m *ThirdPartyAuthorizationToken) XXX_Size() int {
	return m.Size()
}
func (m *ThirdPartyAuthorizationToken) XXX_DiscardUnknown() {
	xxx_messageInfo_ThirdPartyAuthorizationToken.DiscardUnknown(m)
}

var xxx_messageInfo_ThirdPartyAuthorizationToken proto.InternalMessageInfo

func (m *ThirdPartyAuthorizationToken) GetTenant() string {
	if m != nil {
		return m.Tenant
	}
	return ""
...
func (m *ThirdPartyAuthorizationToken) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *ThirdPartyAuthorizationToken) GetVhName() string {
	if m != nil {
		return m.VhName
	}
	return ""
...
func (m *ThirdPartyAuthorizationToken) GetAppType() string {
	if m != nil {
		return m.AppType
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*L7PerformanceEnhancementType)(nil), "ves.io.schema.views.L7PerformanceEnhancementType")
	golang_proto.RegisterType((*L7PerformanceEnhancementType)(nil), "ves.io.schema.views.L7PerformanceEnhancementType")
	...
	proto.RegisterType((*ThirdPartyAuthorizationToken)(nil), "ves.io.schema.views.ThirdPartyAuthorizationToken")
	golang_proto.RegisterType((*ThirdPartyAuthorizationToken)(nil), "ves.io.schema.views.ThirdPartyAuthorizationToken")
}
...
var fileDescriptor_e96f5c708a09275e = []byte{
	...
	,
}
...
func (this *WhereType_AdvertiseV6OnPublic) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WhereType_AdvertiseV6OnPublic)
	if !ok {
		that2, ok := that.(WhereType_AdvertiseV6OnPublic)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *WhereType_AdvertiseDualstackOnPublic) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WhereType_AdvertiseDualstackOnPublic)
	if !ok {
		that2, ok := that.(WhereType_AdvertiseDualstackOnPublic)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *L7PerformanceEnhancementType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*L7PerformanceEnhancementType)
	if !ok {
		that2, ok := that.(L7PerformanceEnhancementType)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *L7PerformanceEnhancementType_JumboDisabled) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*L7PerformanceEnhancementType_JumboDisabled)
	if !ok {
		that2, ok := that.(L7PerformanceEnhancementType_JumboDisabled)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.JumboDisabled.Equal(that1.JumboDisabled) {
		return false
	}
	return true
}
func (this *L7PerformanceEnhancementType_JumboEnabled) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*L7PerformanceEnhancementType_JumboEnabled)
	if !ok {
		that2, ok := that.(L7PerformanceEnhancementType_JumboEnabled)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.JumboEnabled.Equal(that1.JumboEnabled) {
		return false
	}
	return true
}
...
func (this *ThirdPartyAuthorizationToken) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ThirdPartyAuthorizationToken)
	if !ok {
		that2, ok := that.(ThirdPartyAuthorizationToken)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *WhereType_AdvertiseV6OnPublic) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.WhereType_AdvertiseV6OnPublic{` +
		`AdvertiseV6OnPublic:` + fmt.Sprintf("%#v", this.AdvertiseV6OnPublic) + `}`}, ", ")
	return s
}
func (this *WhereType_AdvertiseDualstackOnPublic) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.WhereType_AdvertiseDualstackOnPublic{` +
...
func (this *L7PerformanceEnhancementType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&views.L7PerformanceEnhancementType{")
	if this.PerfModeChoice != nil {
		s = append(s, "PerfModeChoice: "+fmt.Sprintf("%#v", this.PerfModeChoice)+",\n")
	}
	s = append(s, "}")
...
func (this *L7PerformanceEnhancementType_JumboDisabled) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.L7PerformanceEnhancementType_JumboDisabled{` +
		`JumboDisabled:` + fmt.Sprintf("%#v", this.JumboDisabled) + `}`}, ", ")
	return s
}
func (this *L7PerformanceEnhancementType_JumboEnabled) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.L7PerformanceEnhancementType_JumboEnabled{` +
		`JumboEnabled:` + fmt.Sprintf("%#v", this.JumboEnabled) + `}`}, ", ")
	return s
}
...
func (this *ThirdPartyAuthorizationToken) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&views.ThirdPartyAuthorizationToken{")
	s = append(s, "Tenant: "+fmt.Sprintf("%#v", this.Tenant)+",\n")
	s = append(s, "Namespace: "+fmt.Sprintf("%#v", this.Namespace)+",\n")
...
func (m *WhereType_AdvertiseV6OnPublic) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WhereType_AdvertiseV6OnPublic) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *WhereType_AdvertiseDualstackOnPublic) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WhereType_AdvertiseDualstackOnPublic) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *XfccHeaderKeys) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.XfccHeaderElements) > 0 {
		dAtA49 := make([]byte, len(m.XfccHeaderElements)*10)
		var j48 int
...
func (m *L7PerformanceEnhancementType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *L7PerformanceEnhancementType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *L7PerformanceEnhancementType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *L7PerformanceEnhancementType_JumboDisabled) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *L7PerformanceEnhancementType_JumboDisabled) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.JumboDisabled != nil {
		{
			size, err := m.JumboDisabled.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *L7PerformanceEnhancementType_JumboEnabled) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *L7PerformanceEnhancementType_JumboEnabled) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.JumboEnabled != nil {
		{
			size, err := m.JumboEnabled.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ThirdPartyAuthorizationToken) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ThirdPartyAuthorizationToken) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ThirdPartyAuthorizationToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *WhereType_AdvertiseV6OnPublic) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WhereType_AdvertiseDualstackOnPublic) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *L7PerformanceEnhancementType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *L7PerformanceEnhancementType_JumboDisabled) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.JumboDisabled != nil {
		l = m.JumboDisabled.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *L7PerformanceEnhancementType_JumboEnabled) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ThirdPartyAuthorizationToken) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *WhereType_AdvertiseV6OnPublic) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WhereType_AdvertiseV6OnPublic{`,
		`AdvertiseV6OnPublic:` + strings.Replace(fmt.Sprintf("%v", this.AdvertiseV6OnPublic), "AdvertisePublic", "AdvertisePublic", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *WhereType_AdvertiseDualstackOnPublic) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WhereType_AdvertiseDualstackOnPublic{`,
		`AdvertiseDualstackOnPublic:` + strings.Replace(fmt.Sprintf("%v", this.AdvertiseDualstackOnPublic), "AdvertisePublic", "AdvertisePublic", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PerformanceEnhancementModeType_PerfModeL7Enhanced) String() string {
	...
	s := strings.Join([]string{`&PerformanceEnhancementModeType_PerfModeL7Enhanced{`,
		`PerfModeL7Enhanced:` + strings.Replace(fmt.Sprintf("%v", this.PerfModeL7Enhanced), "L7PerformanceEnhancementType", "L7PerformanceEnhancementType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *L7PerformanceEnhancementType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&L7PerformanceEnhancementType{`,
		`PerfModeChoice:` + fmt.Sprintf("%v", this.PerfModeChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *L7PerformanceEnhancementType_JumboDisabled) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&L7PerformanceEnhancementType_JumboDisabled{`,
		`JumboDisabled:` + strings.Replace(fmt.Sprintf("%v", this.JumboDisabled), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *L7PerformanceEnhancementType_JumboEnabled) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&L7PerformanceEnhancementType_JumboEnabled{`,
		`JumboEnabled:` + strings.Replace(fmt.Sprintf("%v", this.JumboEnabled), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *ThirdPartyAuthorizationToken) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ThirdPartyAuthorizationToken{`,
		`Tenant:` + fmt.Sprintf("%v", this.Tenant) + `,`,
		`Namespace:` + fmt.Sprintf("%v", this.Namespace) + `,`,
...
func (m *WhereType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			...
			m.Choice = &WhereType_AdvertiseV6OnPublic{v}
			iNdEx = postIndex
		case 19:
			if wireType != 2 {
			...
			m.Choice = &WhereType_AdvertiseDualstackOnPublic{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *PerformanceEnhancementModeType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			v := &L7PerformanceEnhancementType{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *L7PerformanceEnhancementType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: L7PerformanceEnhancementType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: L7PerformanceEnhancementType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JumboDisabled", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PerfModeChoice = &L7PerformanceEnhancementType_JumboDisabled{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JumboEnabled", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PerfModeChoice = &L7PerformanceEnhancementType_JumboEnabled{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ThirdPartyAuthorizationToken) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ThirdPartyAuthorizationToken: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ThirdPartyAuthorizationToken: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
