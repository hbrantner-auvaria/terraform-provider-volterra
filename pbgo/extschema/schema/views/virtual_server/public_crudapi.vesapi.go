...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/virtual_servers", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/virtual_servers/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/virtual_servers/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/virtual_servers", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/virtual_servers/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.virtual_server.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.views.virtual_server")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.virtual_server.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.virtual_server.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.virtual_server.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.views.virtual_server.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.virtual_server.API.Create' operation on 'virtual_server'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.views.virtual_server.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.virtual_server.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.virtual_server.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.views.virtual_server.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.views.virtual_server.API.Replace' operation on 'virtual_server'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.virtual_server.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.views.virtual_server.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.virtual_server.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.views.virtual_server.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.views.virtual_server.API.Delete' operation on 'virtual_server'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.views.virtual_server.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/virtual_servers": {
            "post": {
                "summary": "Create Virtual Server",
                "description": "Shape of the Virtual Server create specification",
                "operationId": "ves.io.schema.views.virtual_server.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/virtual_serverCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/virtual_serverCreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.API.Create"
            },
            "x-displayname": "Virtual Server",
            "x-ves-proto-service": "ves.io.schema.views.virtual_server.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/virtual_servers/{metadata.name}": {
            "put": {
                "summary": "Replace Virtual Server",
                "description": "Shape of the Virtual Server create specification",
                "operationId": "ves.io.schema.views.virtual_server.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/virtual_serverReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/virtual_serverReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.API.Replace"
            },
            "x-displayname": "Virtual Server",
            "x-ves-proto-service": "ves.io.schema.views.virtual_server.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/virtual_servers": {
            "get": {
                "summary": "List Virtual Server",
                "description": "List the set of virtual_server in a namespace",
                "operationId": "ves.io.schema.views.virtual_server.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/virtual_serverListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    {
                        "name": "namespace",
                        "description": "namespace\n\nx-example: \"ns1\"\nNamespace to scope the listing of virtual_server",
                        "in": "path",
                        "required": true,
                        "type": "string",
                        "x-displayname": "Namespace"
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.API.List"
            },
            "x-displayname": "Virtual Server",
            "x-ves-proto-service": "ves.io.schema.views.virtual_server.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{namespace}/virtual_servers/{name}": {
            "get": {
                "summary": "Get Virtual Server",
                "description": "Shape of the Virtual Server get specification",
                "operationId": "ves.io.schema.views.virtual_server.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/virtual_serverGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.API.Get"
            },
            "delete": {
                "summary": "Delete Virtual Server",
                "description": "Delete the specified virtual_server",
                "operationId": "ves.io.schema.views.virtual_server.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {}
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/virtual_serverDeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.API.Delete"
            },
            "x-displayname": "Virtual Server",
            "x-ves-proto-service": "ves.io.schema.views.virtual_server.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
    ...
    "definitions": {
        ...
        "schemaDestinationAddressType": {
            "type": "object",
            "title": "Destination Address Mask",
            "x-displayname": "Destination Address Mask",
            "x-ves-proto-message": "ves.io.schema.DestinationAddressType",
            "properties": {
                "destination_mask": {
                    "type": "integer",
        ...
        "schemaSourceAddressType": {
            "type": "object",
            "title": "Source Address",
            "x-displayname": "Source Address Mask",
            "x-ves-proto-message": "ves.io.schema.SourceAddressType",
            "properties": {
                "source_mask": {
                    "type": "integer",
                    "description": "\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 600000\n",
        ...
        "schemaSourceDestinationAddressType": {
            "type": "object",
            "title": "Destination and Source Address",
            "x-displayname": "Destination and Source Address Mask",
            "x-ves-proto-message": "ves.io.schema.SourceDestinationAddressType",
            "properties": {
                "destination_mask": {
                    "type": "integer",
                    "description": "\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 600000\n",
        ...
        "schemaTMMImmediateActionOnServiceDownType": {
            "type": "object",
            ...
            "title": "Immediate Action On Service Down",
            ...
            "properties": {
                "immediate_action_on_service_down_drop": {
                    "description": "Exclusive with [immediate_action_on_service_down_none immediate_action_on_service_down_reset]\n",
                    "title": "Drop",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Drop"
                },
                "immediate_action_on_service_down_none": {
                    "description": "Exclusive with [immediate_action_on_service_down_drop immediate_action_on_service_down_reset]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "immediate_action_on_service_down_reset": {
                    "description": "Exclusive with [immediate_action_on_service_down_drop immediate_action_on_service_down_none]\n",
                    "title": "Reset",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Reset"
                }
        ...
        "schemaTMMVirtualServerAddressTranslationType": {
            "type": "object",
            ...
            "properties": {
                "address_translation_disable": {
                    "description": "Exclusive with [address_translation_enable]\n",
                    "title": "Disable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Disable"
                },
                "address_translation_enable": {
                    "description": "Exclusive with [address_translation_disable]\n",
                    "title": "Enable",
                    "$ref": "#/definitions/ioschemaEmpty",
        ...
        "schemaTMMVirtualServerAutoLastHopType": {
            "type": "object",
            ...
            "properties": {
                "auto_last_hop_default": {
                    "description": "Exclusive with [auto_last_hop_disable auto_last_hop_enable]\n",
                    "title": "Default",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Default"
                },
                "auto_last_hop_disable": {
                    "description": "Exclusive with [auto_last_hop_default auto_last_hop_enable]\n",
                    "title": "Disable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Disable"
                },
                "auto_last_hop_enable": {
                    "description": "Exclusive with [auto_last_hop_default auto_last_hop_disable]\n",
                    "title": "Enable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Enable"
                }
        ...
        "schemaTMMVirtualServerConnectionRateLimitMode": {
            "type": "object",
            "title": "Connection Rate Limit Mode",
            ...
            "properties": {
                "per_destination_address": {
                    "description": "Exclusive with [per_source_address per_source_destination_address per_virtual_server per_virtual_server_destination_address per_virtual_server_source_address per_virtual_server_source_destination_address]\n",
                    "title": "Per Destination Address (All Rate Limiting Virtual Servers)",
                    "$ref": "#/definitions/schemaDestinationAddressType",
                    "x-displayname": "Per Destination Address (All Rate Limiting Virtual Servers)"
                },
                "per_source_address": {
                    "description": "Exclusive with [per_destination_address per_source_destination_address per_virtual_server per_virtual_server_destination_address per_virtual_server_source_address per_virtual_server_source_destination_address]\n",
                    "title": "Per Source Address (All Rate Limiting Virtual Servers)",
                    "$ref": "#/definitions/schemaSourceAddressType",
                    "x-displayname": "Per Source Address (All Rate Limiting Virtual Servers)"
                },
                "per_source_destination_address": {
                    "description": "Exclusive with [per_destination_address per_source_address per_virtual_server per_virtual_server_destination_address per_virtual_server_source_address per_virtual_server_source_destination_address]\n",
                    "title": "Per Source And Destination Address (All Rate Limiting Virtual Servers)",
                    "$ref": "#/definitions/schemaSourceDestinationAddressType",
                    "x-displayname": "Per Source And Destination Address (All Rate Limiting Virtual Servers)"
                },
                "per_virtual_server": {
                    "description": "Exclusive with [per_destination_address per_source_address per_source_destination_address per_virtual_server_destination_address per_virtual_server_source_address per_virtual_server_source_destination_address]\n",
                    "title": "Per Virtual Server",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Per Virtual Server"
                },
                "per_virtual_server_destination_address": {
                    "description": "Exclusive with [per_destination_address per_source_address per_source_destination_address per_virtual_server per_virtual_server_source_address per_virtual_server_source_destination_address]\n",
                    "title": "Per Virtual Server and Destination Address",
                    "$ref": "#/definitions/schemaDestinationAddressType",
                    "x-displayname": "Per Virtual Server and Destination Address"
                },
                "per_virtual_server_source_address": {
                    "description": "Exclusive with [per_destination_address per_source_address per_source_destination_address per_virtual_server per_virtual_server_destination_address per_virtual_server_source_destination_address]\n",
                    "title": "Per Virtual Server and Source Address",
                    "$ref": "#/definitions/schemaSourceAddressType",
                    "x-displayname": "Per Virtual Server and Source Address"
                },
                "per_virtual_server_source_destination_address": {
                    "description": "Exclusive with [per_destination_address per_source_address per_source_destination_address per_virtual_server per_virtual_server_destination_address per_virtual_server_source_address]\n",
                    "title": "Per Virtual Server, Destination and Source Address",
                    "$ref": "#/definitions/schemaSourceDestinationAddressType",
                    "x-displayname": "Per Virtual Server, Destination and Source Address"
                }
            }
        },
        "schemaTMMVirtualServerNAT64Type": {
            "type": "object",
            "description": "When enabled, allows the system to send return traffic to the MAC address that transmitted the request, even if the routing table points to a different network or interface. As a result, the system can send return traffic to clients even when there is no matching route. For example, if the system does not have a default route configured and the client is located on a remote network. This setting is also useful when the system is load balancing transparent devices that do not modify the source IP address of the packet. Without the last hop option enabled, the system could return connections to a different transparent node, resulting in asymmetric routing. You can configure this setting globally and on an object level. You set the global Auto Last Hop value on the System :: Configuration :: Local Traffic :: General screen. To configure this setting globally, retain the Default setting. When you configure Auto Last Hop with a value other than Default at the object level, its setting takes precedence over the global setting. This enables you to configure auto last hop on a per-virtual server basis. The default is Default, meaning that the system uses the global auto-lasthop setting to send back the request.",
            "title": "NAT64",
            "x-displayname": "NAT64",
            ...
            "properties": {
                "nat64_disable": {
                    "description": "Exclusive with [nat64_enable]\n",
                    "title": "Disable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Disable"
                },
                "nat64_enable": {
                    "description": "Exclusive with [nat64_disable]\n",
                    "title": "Enable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Enable"
                }
        ...
        "schemaTMMVirtualServerPortTranslationType": {
            "type": "object",
            ...
            "properties": {
                "port_translation_disable": {
                    "description": "Exclusive with [port_translation_enable]\n",
                    "title": "Disable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Disable"
                },
                "port_translation_enable": {
                    "description": "Exclusive with [port_translation_disable]\n",
                    "title": "Enable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Enable"
                }
        ...
        "schemaTMMVirtualServerSourcePortType": {
            "type": "object",
            ...
            "properties": {
                "source_port_change": {
                    "description": "Exclusive with [source_port_preserve source_port_preserve_strict]\n",
                    "title": "Change",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Change"
                },
                "source_port_preserve": {
                    "description": "Exclusive with [source_port_change source_port_preserve_strict]\n",
                    "title": "Preserve",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Preserve"
                },
                "source_port_preserve_strict": {
                    "description": "Exclusive with [source_port_change source_port_preserve]\n",
                    "title": "Preserve Strict",
                    "$ref": "#/definitions/ioschemaEmpty",
        ...
        "viewsvirtual_serverCreateSpecType": {
            "type": "object",
            "description": "Shape of the Virtual Server create specification",
            "title": "CreateSpecType",
            "x-displayname": "Create Virtual Server",
            "x-ves-oneof-field-default_persistence_profile_choice": "[\"default_persistence_profile\",\"default_persistence_profile_none\"]",
            "x-ves-oneof-field-default_pool_choice": "[\"default_pool\",\"default_pool_none\"]",
            "x-ves-oneof-field-fallback_persistence_profile_choice": "[\"fallback_persistence_profile\",\"fallback_persistence_profile_none\"]",
            ...
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.CreateSpecType",
            "properties": {
                "auto_last_hop": {
                    "description": " When enabled, allows the system to send return traffic to the MAC address that transmitted the request, even if the routing table points to a different network or interface. As a result, the system can send return traffic to clients even when there is no matching route. For example, if the system does not have a default route configured and the client is located on a remote network. This setting is also useful when the system is load balancing transparent devices that do not modify the source IP address of the packet. Without the last hop option enabled, the system could return connections to a different transparent node, resulting in asymmetric routing. You can configure this setting globally and on an object level. You set the global Auto Last Hop value on the System :: Configuration :: Local Traffic :: General screen. To configure this setting globally, retain the Default setting. When you configure Auto Last Hop with a value other than Default at the object level, its setting takes precedence over the global setting. This enables you to configure auto last hop on a per-virtual server basis. The default is Default, meaning that the system uses the global auto-lasthop setting to send back the request.",
                    "$ref": "#/definitions/schemaTMMVirtualServerAutoLastHopType",
                    "x-displayname": "Auto Last Hop"
                },
                "clone_pool_options": {
                    "$ref": "#/definitions/virtual_serverClonePoolType",
                    "x-displayname": "Clone Pool"
                },
                "connection_limit_options": {
                    "$ref": "#/definitions/virtual_serverConnectionLimitsType",
                    "x-displayname": "Connection Limit Options"
                },
                "default_persistence_profile": {
                    "description": "Exclusive with [default_persistence_profile_none]\n",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "default_persistence_profile_none": {
                    "description": "Exclusive with [default_persistence_profile]\n",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "default_pool": {
                    "description": "Exclusive with [default_pool_none]\n",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Pool"
                },
                "default_pool_none": {
                ...
                "fallback_persistence_profile": {
                    "description": "Exclusive with [fallback_persistence_profile_none]\n",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "fallback_persistence_profile_none": {
                    "description": "Exclusive with [fallback_persistence_profile]\n",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "http": {
                ...
                "immediate_action_on_service_down": {
                    "description": " Specifies the immediate action the BIG-IP system should respond with upon the receipt of the initial client's SYN packet, if the availability status of the virtual server is Offline or Unavailable. This is supported for the virtual server of Standard type and TCP protocol. The default is None.\n - None: Specifies that the system takes no immediate action if the virtual server is reported Offline or Unavailable.\n - Reset: Specifies that the system resets the connections when the virtual server is reported Offline or Unavailable.\n - Drop: Specifies that the system drops the connections when the virtual server is reported Offline or Unavailable.",
                    "$ref": "#/definitions/schemaTMMImmediateActionOnServiceDownType",
                    "x-displayname": "Immediate Action On Service Down"
                },
                "irules": {
                    "type": "array",
                    "description": " Specifies the iRules you want run on this virtual server. iRules help automate the intercepting, processing, and routing of application traffic.",
                    "items": {
                ...
                "json": {
                    "description": " Specifies whether the JSON profile is enabled. Default value is False.",
                    "$ref": "#/definitions/vs_profilesTrueFalseChoice",
                    "x-displayname": "JSON"
                },
                "last_hop_pool": {
                    "description": "Exclusive with [last_hop_pool_none]\n",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Pool"
                },
                "last_hop_pool_none": {
                    "description": "Exclusive with [last_hop_pool]\n",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "nat64": {
                    "description": " When enabled, allows the system to send return traffic to the MAC address that transmitted the request, even if the routing table points to a different network or interface. As a result, the system can send return traffic to clients even when there is no matching route. For example, if the system does not have a default route configured and the client is located on a remote network. This setting is also useful when the system is load balancing transparent devices that do not modify the source IP address of the packet. Without the last hop option enabled, the system could return connections to a different transparent node, resulting in asymmetric routing. You can configure this setting globally and on an object level. You set the global Auto Last Hop value on the System :: Configuration :: Local Traffic :: General screen. To configure this setting globally, retain the Default setting. When you configure Auto Last Hop with a value other than Default at the object level, its setting takes precedence over the global setting. This enables you to configure auto last hop on a per-virtual server basis. The default is Default, meaning that the system uses the global auto-lasthop setting to send back the request.",
                    "$ref": "#/definitions/schemaTMMVirtualServerNAT64Type",
                    "x-displayname": "NAT64"
                },
                "request_logging_profile": {
                    "description": "Exclusive with [request_logging_profile_none]\n",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "request_logging_profile_none": {
                    "description": "Exclusive with [request_logging_profile]\n",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "sse": {
                    "description": " Specifies whether the SSE profile is enabled. Default value is False.",
                    "$ref": "#/definitions/vs_profilesTrueFalseChoice",
                    "x-displayname": "SSE"
                },
                "state": {
                ...
                "statistics_profile": {
                    "description": "Exclusive with [statistics_profile_none]\n",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "statistics_profile_none": {
                    "description": "Exclusive with [statistics_profile]\n",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "tcp": {
                ...
                "virtual_addresses": {
                    "type": "array",
                    "description": " Specify the virtual address objects to be associated with this virtual server",
                    "items": {
                        "$ref": "#/definitions/schemaviewsObjectRefType"
                    },
                ...
                "vs_score": {
                    "type": "integer",
                    "description": " Specifies the virtual server score in percent. Global Traffic Manager (GTM) can rely on this value to load balance traffic in a proportional manner. The default is 0, meaning that no additional metric is applied for the virtual server.\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 600000\n",
                    "format": "int64",
        ...
        "viewsvirtual_serverGetSpecType": {
            "type": "object",
            "description": "Shape of the Virtual Server get specification",
            "title": "GetSpecType",
            ...
            "x-ves-oneof-field-statistics_profile_choice": "[\"statistics_profile\",\"statistics_profile_none\"]",
            "x-ves-oneof-field-virtual_server_type": "[\"http\",\"http3\",\"https\",\"tcp\",\"udp\"]",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.GetSpecType",
            "properties": {
                "auto_last_hop": {
                    "description": " When enabled, allows the system to send return traffic to the MAC address that transmitted the request, even if the routing table points to a different network or interface. As a result, the system can send return traffic to clients even when there is no matching route. For example, if the system does not have a default route configured and the client is located on a remote network. This setting is also useful when the system is load balancing transparent devices that do not modify the source IP address of the packet. Without the last hop option enabled, the system could return connections to a different transparent node, resulting in asymmetric routing. You can configure this setting globally and on an object level. You set the global Auto Last Hop value on the System :: Configuration :: Local Traffic :: General screen. To configure this setting globally, retain the Default setting. When you configure Auto Last Hop with a value other than Default at the object level, its setting takes precedence over the global setting. This enables you to configure auto last hop on a per-virtual server basis. The default is Default, meaning that the system uses the global auto-lasthop setting to send back the request.",
                    "$ref": "#/definitions/schemaTMMVirtualServerAutoLastHopType",
        ...
        "viewsvirtual_serverReplaceSpecType": {
            "type": "object",
            "description": "Shape of the Virtual Server create specification",
            ...
            "x-ves-oneof-field-statistics_profile_choice": "[\"statistics_profile\",\"statistics_profile_none\"]",
            "x-ves-oneof-field-virtual_server_type": "[\"http\",\"http3\",\"https\",\"tcp\",\"udp\"]",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ReplaceSpecType",
            "properties": {
                "auto_last_hop": {
                    "description": " When enabled, allows the system to send return traffic to the MAC address that transmitted the request, even if the routing table points to a different network or interface. As a result, the system can send return traffic to clients even when there is no matching route. For example, if the system does not have a default route configured and the client is located on a remote network. This setting is also useful when the system is load balancing transparent devices that do not modify the source IP address of the packet. Without the last hop option enabled, the system could return connections to a different transparent node, resulting in asymmetric routing. You can configure this setting globally and on an object level. You set the global Auto Last Hop value on the System :: Configuration :: Local Traffic :: General screen. To configure this setting globally, retain the Default setting. When you configure Auto Last Hop with a value other than Default at the object level, its setting takes precedence over the global setting. This enables you to configure auto last hop on a per-virtual server basis. The default is Default, meaning that the system uses the global auto-lasthop setting to send back the request.",
                    "$ref": "#/definitions/schemaTMMVirtualServerAutoLastHopType",
        ...
        "viewsvirtual_serverServiceType": {
            "type": "object",
            "title": "Service",
            "x-displayname": "Service",
            "x-ves-oneof-field-port_choice": "[\"port\",\"port_ranges\"]",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ServiceType",
            "properties": {
                "port": {
                    "type": "integer",
        ...
        "viewsvirtual_serverStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "virtual_serverClonePoolType": {
            "type": "object",
            "title": "Clone Pool",
            "x-displayname": "Clone Pool",
            "x-ves-oneof-field-clone_pool_client_choice": "[\"pool_client\",\"pool_client_none\"]",
            "x-ves-oneof-field-clone_pool_server_choice": "[\"pool_server\",\"pool_server_none\"]",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ClonePoolType",
            "properties": {
                "pool_client": {
                    "description": "Exclusive with [pool_client_none]\n",
                    "title": "Select",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Pool"
                },
                "pool_client_none": {
                    "description": "Exclusive with [pool_client]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "pool_server": {
                    "description": "Exclusive with [pool_server_none]\n",
                    "title": "Select",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Pool"
                },
                "pool_server_none": {
                    "description": "Exclusive with [pool_server]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                }
        ...
        "virtual_serverConnectionLimitsType": {
            "type": "object",
            "title": "Connection Limit",
            "x-displayname": "Connection Limit",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ConnectionLimitsType",
            "properties": {
                "connection_limit": {
                    "type": "integer",
                    "description": " Specifies the maximum number of concurrent connections allowed for the virtual server. Setting this to 0 turns off connection limits. The default is 0.\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 0\n  ves.io.schema.rules.uint32.lte: 600000\n",
                    "title": "Connection Limit",
                    "format": "int64",
                    "x-displayname": "Connection Limit",
                    "x-ves-validation-rules": {
        ...
        "virtual_serverCreateRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/viewsvirtual_serverCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "virtual_serverCreateResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.CreateResponse",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the tenant",
                    "title": "spec",
                    "$ref": "#/definitions/viewsvirtual_serverGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "virtual_serverDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a virtual_server",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "virtual_serverGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read virtual_server",
            "x-displayname": "Get Response",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.GetResponse",
            "properties": {
                "create_form": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/viewsvirtual_serverStatusObject"
                    },
                    "x-displayname": "Status"
                },
                "system_metadata": {
        ...
        "virtual_serverGetResponseFormatCode": {
            "type": "string",
        ...
        "virtual_serverHTTP3DefaultServerSelection": {
            "type": "object",
            "title": "Http3DefaultServerSelection",
            ...
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.HTTP3DefaultServerSelection",
            "properties": {
                "http_server_profile": {
                ...
                "http_server_profile_same_as_client": {
                    "description": "Exclusive with [http_server_profile]\n",
                ...
                "tcp_server_profile": {
                    "description": " Specifies that the selected profile is a server-side profile. Options are: (Use Client Profile), and entries for each already defined server protocol profile. The default is (Use Client Profile).\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "virtual_serverHTTP3Services": {
            "type": "object",
            "title": "HTTP/3 Services",
            "x-displayname": "HTTP/3 Services",
            "x-ves-oneof-field-quic_profile_choice": "[\"quic_client_profile\",\"quic_client_profile_none\"]",
            "x-ves-oneof-field-server_app_type_choice": "[\"server_app_type_default\"]",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.HTTP3Services",
            "properties": {
                ...
                "quic_client_profile": {
                    "description": "Exclusive with [quic_client_profile_none]\n",
                    "title": "Select Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "quic_client_profile_none": {
                    "description": "Exclusive with [quic_client_profile]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "server_app_type_default": {
                    ...
                    "title": "TCP",
                    "$ref": "#/definitions/virtual_serverHTTP3DefaultServerSelection",
                    "x-displayname": "TCP"
                },
                "services": {
                    "type": "array",
        ...
        "virtual_serverHTTPDefaultServerSelection": {
            "type": "object",
            ...
            "properties": {
                ...
                "protocol_server_profile": {
                    "description": "Exclusive with [protocol_server_profile_same_as_client]\n",
                    "title": "Select Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "protocol_server_profile_same_as_client": {
                    "description": "Exclusive with [protocol_server_profile]\n",
                    "title": "Same as Client Profile (Use Client Profile)",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Use Client Profile"
                },
                ...
                "websocket_server_profile": {
                    "description": "Exclusive with [websocket_server_profile_same_as_client]\n",
                    "title": "Select Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "websocket_server_profile_same_as_client": {
                    "description": "Exclusive with [websocket_server_profile]\n",
        ...
        "virtual_serverHTTPServices": {
            "type": "object",
            "title": "HTTPServices",
            "x-displayname": "HTTPServices",
            "x-ves-oneof-field-fix_profile_choice": "[\"fix_profile\",\"fix_profile_none\"]",
            "x-ves-oneof-field-http2_client_profile_choice": "[\"http2_client_profile\",\"http2_client_profile_none\"]",
            "x-ves-oneof-field-ocsp_profile_choice": "[\"ocsp_profile\",\"ocsp_profile_none\"]",
            "x-ves-oneof-field-server_app_type_choice": "[\"server_app_type_same_as_client\"]",
            "x-ves-oneof-field-stream_profile_choice": "[\"stream_profile\",\"stream_profile_none\"]",
            "x-ves-oneof-field-websocket_client_profile_choice": "[\"websocket_client_profile\",\"websocket_client_profile_none\"]",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.HTTPServices",
            "properties": {
                "fix_profile": {
                    "description": "Exclusive with [fix_profile_none]\n",
                    "title": "Select Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "fix_profile_none": {
                    "description": "Exclusive with [fix_profile]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "http2_client_profile": {
                    "description": "Exclusive with [http2_client_profile_none]\n",
                    "title": "Select Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "http2_client_profile_none": {
                    "description": "Exclusive with [http2_client_profile]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "http_client_profile": {
                    "description": " Specifies that the selected profile is a client-side HTTP profile. The list contains entries for each already defined client protocol profile.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "HTTP Profile (Client)",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                ...
                "ocsp_profile": {
                    "description": "Exclusive with [ocsp_profile_none]\n",
                    "title": "Select Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "ocsp_profile_none": {
                    "description": "Exclusive with [ocsp_profile]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                ...
                "server_app_type_same_as_client": {
                    "description": "Exclusive with []\n",
                    "title": "Same As Client",
                    "$ref": "#/definitions/virtual_serverHTTPDefaultServerSelection",
                ...
                "stream_profile": {
                    "description": "Exclusive with [stream_profile_none]\n",
                    "title": "Select Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "stream_profile_none": {
                    "description": "Exclusive with [stream_profile]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                "websocket_client_profile": {
                    "description": "Exclusive with [websocket_client_profile_none]\n",
                    "title": "Select Profile",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Select Profile"
                },
                "websocket_client_profile_none": {
                    "description": "Exclusive with [websocket_client_profile]\n",
                    "title": "None",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                }
        ...
        "virtual_serverListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of virtual_server",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/virtual_serverListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "virtual_serverListResponseItem": {
            "type": "object",
            "description": "By default a summary of virtual_server is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of virtual_server",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this virtual_server",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this virtual_server",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates virtual_server is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                    "x-displayname": "Disabled"
                },
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this virtual_server",
                    "title": "labels",
                    "x-displayname": "Labels"
                },
                "metadata": {
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this virtual_server\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this virtual_server\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "virtual_serverReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a virtual_server",
            "x-displayname": "Replace Request",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ReplaceRequest",
            "properties": {
                "metadata": {
                    "description": " Standard object's metadata",
                    "title": "metadata",
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the tenant",
                    "title": "spec",
                    "$ref": "#/definitions/viewsvirtual_serverReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "virtual_serverReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ReplaceResponse"
        },
        ...
        "virtual_serverTranslationType": {
            "type": "object",
            "title": "Translation Options",
            "x-displayname": "Translation",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.TranslationType",
            "properties": {
                "address_translation": {
                    "description": " Specifies, when checked (enabled), that the system translates the address of the virtual server. When cleared (disabled), specifies that the system uses the address without translation. This option is useful when the system is load balancing devices that have the same IP address. The default is enabled.",
                    "title": "Address Translation",
                    "$ref": "#/definitions/schemaTMMVirtualServerAddressTranslationType",
                    "x-displayname": "Address Translation"
                },
                "port_translation": {
                    "description": " Specifies, when checked (enabled), that the system translates the port of the virtual server. When cleared (disabled), specifies that the system uses the port without translation. Turning off port translation for a virtual server is useful if you want to use the virtual server to load balance connections to any service. The default is enabled.",
                    "title": "Port Translation",
                    "$ref": "#/definitions/schemaTMMVirtualServerPortTranslationType",
                    "x-displayname": "Port Translation"
                },
                "source_port": {
    ...
    "x-displayname": "Virtual Server",
    "x-ves-proto-file": "ves.io/schema/views/virtual_server/public_crudapi.proto"
}`
