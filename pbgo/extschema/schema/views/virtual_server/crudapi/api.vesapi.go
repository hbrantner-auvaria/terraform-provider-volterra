...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/virtual_server"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.virtual_server.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.virtual_server.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.views.virtual_server.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.virtual_server.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.virtual_server.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.virtual_server.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.virtual_server.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.virtual_server.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.virtual_server.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.virtual_server.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/virtual_server/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.virtual_server/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-crudapi-api-get"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-crudapi-api-delete"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-crudapi-api-replace"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "virtual_server",
            "x-ves-object-type": "ves.io.schema.views.virtual_server.Object",
            "x-ves-proto-service": "ves.io.schema.views.virtual_server.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.virtual_server/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-crudapi-api-list"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-crudapi-api-create"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "virtual_server",
            "x-ves-object-type": "ves.io.schema.views.virtual_server.Object",
        ...
        "/ves.io.schema.views.virtual_server/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-virtual_server-crudapi-api-liststream"
                },
                "x-ves-in-development": "true",
                "x-ves-proto-rpc": "ves.io.schema.views.virtual_server.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "virtual_server",
            "x-ves-object-type": "ves.io.schema.views.virtual_server.Object",
        ...
        "/ves.io.schema.views.virtual_server/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.virtual_server/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.virtual_server/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.virtual_server/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.virtual_server.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/virtual_serverSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/virtual_servercrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/virtual_servercrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/virtual_serverStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/virtual_servercrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/virtual_servercrudapiErrorCode"
                },
        ...
        "viewsvirtual_serverGlobalSpecType": {
            "type": "object",
            "description": "Shape of the virtual server specification",
            ...
            "x-ves-oneof-field-domain_choice": "[\"managed\",\"not_managed\"]",
            ...
            "properties": {
                ...
                "managed": {
                    "description": "Exclusive with [not_managed]\n Domains that are managed by F5XC platform through setting up of dns_zones",
                    "title": "Managed by F5XC",
                    "$ref": "#/definitions/virtual_serverDomainsManagedByF5XC",
                ...
                "not_managed": {
                    "description": "Exclusive with [managed]\n Not Managed by F5XC",
                    "title": "Not Managed by F5XC",
                    "$ref": "#/definitions/virtual_serverNotManagedDomainsType",
        ...
        "virtual_serverDomainsManagedByF5XC": {
            "type": "object",
            "description": "A list of Domains (host/authority header) that will be matched to load balancer.",
            "title": "Managed Domains",
            "x-displayname": "Managed Domains",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.DomainsManagedByF5XC",
            "properties": {
                "domains": {
                    "type": "array",
                    "description": " A list of Domains (host/authority header) that will be matched to load balancer.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    ...
                    "maxItems": 32,
                    "items": {
                        "$ref": "#/definitions/virtual_serverManagedDomain"
                    },
                    "x-displayname": "Domains",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "virtual_serverManagedDomain": {
            "type": "object",
            "description": "A list of Domains (host/authority header) that will be matched to load balancer.",
            "title": "Domains",
            "x-displayname": "Domains",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.ManagedDomain",
            "properties": {
                "dns_zone": {
                    "description": " DNS Zone managed by F5XC\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "DNS Zone",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
        ...
        "virtual_serverNotManagedDomainsType": {
            "type": "object",
            "description": "A list of Domains (host/authority header) that will be matched to load balancer.",
            "title": "Domains",
            "x-displayname": "Domains",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.NotManagedDomainsType",
            "properties": {
                "domains": {
                    "type": "array",
                    "description": " A list of Domains (host/authority header) that will be matched to load balancer.\n\n Supported Domains and search order:\n  1. Exact Domain names: www.foo.com.\n  2. Domains starting with a Wildcard: *.foo.com.\n\n Not supported Domains:\n - Just a Wildcard: *\n - A Wildcard and TLD with no root Domain: *.com.\n - A Wildcard not matching a whole DNS label.\n e.g. *.foo.com and *.bar.foo.com are valid Wildcards however *bar.foo.com, *-bar.foo.com, and bar*.foo.com are all invalid.\n\n Additional notes:\n A Wildcard will not match empty string.\n e.g. *.foo.com will match bar.foo.com and baz-bar.foo.com but not .foo.com.\n The longest Wildcards match first.\n Only a single virtual host in the entire route configuration can match on *.\n Also a Domain must be unique across all virtual hosts within an advertise policy.\n\n Domains are also used for SNI matching if the Loadbalancer type is HTTPS.\n Domains also indicate the list of names for which DNS resolution will be automatically resolved to IP addresses by the system.\n\nExample: - \"www.foo.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.items.string.max_len: 256\n  ves.io.schema.rules.repeated.items.string.min_len: 1\n  ves.io.schema.rules.repeated.items.string.vh_domain: true\n  ves.io.schema.rules.repeated.max_items: 32\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
        ...
        "virtual_serverSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.virtual_server.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/viewsvirtual_serverGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "virtual_serverStatusObject": {
            "type": "object",
        ...
        "virtual_servercrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.virtual_server.crudapi.ErrorCode"
        },
    ...
    "x-ves-proto-file": "ves.io/schema/views/virtual_server/crudapi/api.proto"
}`
