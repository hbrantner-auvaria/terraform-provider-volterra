...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/ike_phase1_profile"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.ike_phase1_profile.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.ike_phase1_profile.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.views.ike_phase1_profile.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.ike_phase1_profile.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.ike_phase1_profile.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.ike_phase1_profile.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.ike_phase1_profile.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.ike_phase1_profile.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.ike_phase1_profile.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.ike_phase1_profile.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.ike_phase1_profile.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.ike_phase1_profile.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.ike_phase1_profile.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.ike_phase1_profile.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.ike_phase1_profile.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.ike_phase1_profile.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.ike_phase1_profile.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.ike_phase1_profile.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/ike_phase1_profile/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.ike_phase1_profile/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-ike_phase1_profile-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-ike_phase1_profile-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-ike_phase1_profile-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ike_phase1_profile",
            "x-ves-object-type": "ves.io.schema.views.ike_phase1_profile.Object",
            "x-ves-proto-service": "ves.io.schema.views.ike_phase1_profile.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.ike_phase1_profile/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-ike_phase1_profile-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.ike_phase1_profile.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-ike_phase1_profile-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ike_phase1_profile",
            "x-ves-object-type": "ves.io.schema.views.ike_phase1_profile.Object",
        ...
        "/ves.io.schema.views.ike_phase1_profile/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-ike_phase1_profile-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.ike_phase1_profile.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "ike_phase1_profile",
            "x-ves-object-type": "ves.io.schema.views.ike_phase1_profile.Object",
        ...
        "/ves.io.schema.views.ike_phase1_profile/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.ike_phase1_profile/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.ike_phase1_profile/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.ike_phase1_profile/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.ike_phase1_profile.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/ike_phase1_profileSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ike_phase1_profilecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ike_phase1_profilecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ike_phase1_profileStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ike_phase1_profilecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/ike_phase1_profilecrudapiErrorCode"
                },
        ...
        "ike_phase1_profileGlobalSpecType": {
            "type": "object",
            "description": "Shape of the External connector configuration specification",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-oneof-field-ike_key_lifetime": "[\"ike_keylifetime_hours\",\"ike_keylifetime_minutes\",\"use_default_keylifetime\"]",
            "x-ves-oneof-field-ike_reauth_timeout": "[\"reauth_disabled\",\"reauth_timeout_days\",\"reauth_timeout_hours\"]",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.GlobalSpecType",
            "properties": {
                "authentication_algos": {
                    "type": "array",
                    "description": " Choose one or more Authentication Algorithm. Use None option when using the aes-gcm or aes-ccm encryption algorithms.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "encryption_algos": {
                    "type": "array",
                    "description": " Choose one or more encryption algorithms.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "ike_keylifetime_hours": {
                    "description": "Exclusive with [ike_keylifetime_minutes use_default_keylifetime]\n Set IKE Key Lifetime in Hours",
                    "title": "Hours",
                    "$ref": "#/definitions/ike_phase1_profileInputHours",
                    "x-displayname": "Hours"
                },
                "ike_keylifetime_minutes": {
                    "description": "Exclusive with [ike_keylifetime_hours use_default_keylifetime]\n Set IKE Key Lifetime in minutes",
                    "title": "Minutes",
                    "$ref": "#/definitions/ike_phase1_profileInputMinutes",
                    "x-displayname": "Minutes"
                },
                "prf": {
                    "type": "array",
                    "description": " Select PseudoRandomFunction for IKE SA.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "reauth_disabled": {
                    "description": "Exclusive with [reauth_timeout_days reauth_timeout_hours]\n The default is not use IKE reauthentication.",
                    "title": "Disabled",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Disabled"
                },
                "reauth_timeout_days": {
                    "description": "Exclusive with [reauth_disabled reauth_timeout_hours]\n Set Reauthentication timeout in Days",
                    "title": "Days",
                    "$ref": "#/definitions/ike_phase1_profileInputDays",
                    "x-displayname": "Days"
                },
                "reauth_timeout_hours": {
                    "description": "Exclusive with [reauth_disabled reauth_timeout_days]\n Set Reauthentication timeout in Hours",
                    "title": "Hours",
                    "$ref": "#/definitions/ike_phase1_profileInputHours",
                    "x-displayname": "Hours"
                },
                "use_default_keylifetime": {
                    "description": "Exclusive with [ike_keylifetime_hours ike_keylifetime_minutes]\n Use default key lifetime (4Hrs)",
                    "title": "Default",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Default (4 Hours)"
                },
                "view_internal": {
        ...
        "ike_phase1_profileInputDays": {
            "type": "object",
            "description": "Set Duration in days",
            "title": "Days",
            "x-displayname": "Days",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.InputDays",
            "properties": {
                "duration": {
                    "type": "integer",
        ...
        "ike_phase1_profileInputHours": {
            "type": "object",
            "description": "Input Hours",
            "title": "Hours",
            "x-displayname": "Hours",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.InputHours",
            "properties": {
                "duration": {
                    "type": "integer",
        ...
        "ike_phase1_profileInputMinutes": {
            "type": "object",
            "description": "Set IKE Key Lifetime in minutes",
            "title": "Minutes",
            "x-displayname": "Minutes",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.InputMinutes",
            "properties": {
                "duration": {
                    "type": "integer",
        ...
        "ike_phase1_profileSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/ike_phase1_profileGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "ike_phase1_profileStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.views.ike_phase1_profile.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "ike_phase1_profilecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.ike_phase1_profile.crudapi.ErrorCode"
        },
        ...
        "schemaAuthenticationAlgorithm": {
            ...
            "x-ves-proto-enum": "ves.io.schema.AuthenticationAlgorithm"
        },
        "schemaConditionType": {
            "type": "object",
        ...
        "schemaDHGroup": {
            ...
            "x-ves-proto-enum": "ves.io.schema.DHGroup"
        },
        "schemaEmpty": {
            "type": "object",
        ...
        "schemaEncryptionAlgorithm": {
            ...
            "x-ves-proto-enum": "ves.io.schema.EncryptionAlgorithm"
        },
        ...
        "schemaPseudoRandomFunction": {
            ...
            "x-ves-proto-enum": "ves.io.schema.PseudoRandomFunction"
        },
    ...
    "x-ves-proto-file": "ves.io/schema/views/ike_phase1_profile/crudapi/api.proto"
}`
