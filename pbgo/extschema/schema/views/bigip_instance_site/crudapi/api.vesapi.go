...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/bigip_instance_site"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.bigip_instance_site.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.bigip_instance_site.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.views.bigip_instance_site.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_instance_site.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.bigip_instance_site.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.bigip_instance_site.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_instance_site.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_instance_site.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_instance_site.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_instance_site.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/bigip_instance_site/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.bigip_instance_site/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bigip_instance_site",
            "x-ves-object-type": "ves.io.schema.views.bigip_instance_site.Object",
            "x-ves-proto-service": "ves.io.schema.views.bigip_instance_site.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.bigip_instance_site/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bigip_instance_site",
            "x-ves-object-type": "ves.io.schema.views.bigip_instance_site.Object",
        ...
        "/ves.io.schema.views.bigip_instance_site/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-bigip_instance_site-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.bigip_instance_site.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "bigip_instance_site",
            "x-ves-object-type": "ves.io.schema.views.bigip_instance_site.Object",
        ...
        "/ves.io.schema.views.bigip_instance_site/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.bigip_instance_site/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.bigip_instance_site/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.bigip_instance_site/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.bigip_instance_site.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "bigip_instance_siteCentralManagerList": {
            "type": "object",
            "description": "List BIG-IP Central manager site managing this BIG-IP instance",
            "title": "Central Manager",
            "x-displayname": "Central Manager",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.CentralManagerList",
            "properties": {
                "central_manager_site": {
                    "type": "array",
                    "description": " BIG-IP Central manager site managing this BIG-IP instance\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 1\n",
                    "title": "Central Manager",
                    "maxItems": 1,
                    "items": {
        ...
        "bigip_instance_siteSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/viewsbigip_instance_siteGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "bigip_instance_siteStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "StatusObject",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "object_refs": {
                    "type": "array",
                    "description": " F5XC BIG-IP Instance site object direct reference",
                    "title": "object_refs",
                    "items": {
        ...
        "bigip_instance_sitecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.bigip_instance_site.crudapi.ErrorCode"
        },
        "common_nodeInterface": {
            "type": "object",
            ...
            "properties": {
                ...
                "ethernet_interface": {
                    ...
                    "$ref": "#/definitions/viewscommon_nodeEthernetInterfaceType",
        ...
        "common_nodeVlanInterfaceType": {
            "type": "object",
            "title": "Vlan Interface",
            "x-displayname": "Vlan Interface",
            "x-ves-proto-message": "ves.io.schema.views.common_node.VlanInterfaceType",
            "properties": {
                "device": {
                    "type": "string",
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/bigip_instance_siteSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bigip_instance_sitecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bigip_instance_sitecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/bigip_instance_siteStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bigip_instance_sitecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/bigip_instance_sitecrudapiErrorCode"
                },
        ...
        "viewsbigip_instance_siteGlobalSpecType": {
            "type": "object",
            "description": "Shape of the BIG-IP Instance specification",
            "title": "GlobalSpecType",
            "x-displayname": "Global Specification",
            "x-ves-proto-message": "ves.io.schema.views.bigip_instance_site.GlobalSpecType",
            "properties": {
                "central_manager": {
                    "description": " BIG-IP Central manager site managing this BIG-IP instance\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Central Manager",
                    "$ref": "#/definitions/bigip_instance_siteCentralManagerList",
                    "x-displayname": "Central Manager",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "node_list": {
                    ...
                    "maxItems": 128,
                    "items": {
                        "$ref": "#/definitions/viewscommon_nodeNode"
                    },
                    "x-displayname": "Nodes",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.repeated.max_items": "128",
        ...
        "viewscommon_nodeEthernetInterfaceType": {
            "type": "object",
            "title": "Ethernet Interface",
            "x-displayname": "Ethernet Interface",
            "x-ves-proto-message": "ves.io.schema.views.common_node.EthernetInterfaceType",
            "properties": {
                "device": {
                    "type": "string",
        ...
        "viewscommon_nodeNode": {
            "type": "object",
            "description": "Nodes definition",
            "title": "Node",
            "x-displayname": "Nodes",
            "x-ves-proto-message": "ves.io.schema.views.common_node.Node",
            "properties": {
                "hostname": {
                    "type": "string",
                ...
                "interface_list": {
                    ...
                    "maxItems": 128,
                    "items": {
                        "$ref": "#/definitions/common_nodeInterface"
                    },
    ...
    "x-ves-proto-file": "ves.io/schema/views/bigip_instance_site/crudapi/api.proto"
}`
