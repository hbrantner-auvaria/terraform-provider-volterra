...
type JWTValidation_AuthorizationServer struct {
	AuthorizationServer *AuthorizationServer `protobuf:"bytes,10,opt,name=authorization_server,json=authorizationServer,proto3,oneof" json:"authorization_server,omitempty"`
}
...
func (*JWTValidation_AuthorizationServer) isJWTValidation_JwksConfiguration() {}
...
func (m *JWTValidation) GetAuthorizationServer() *AuthorizationServer {
	if x, ok := m.GetJwksConfiguration().(*JWTValidation_AuthorizationServer); ok {
...
func (*JWTValidation) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*JWTValidation_AuthorizationServer)(nil),
	}
}
...
type AuthorizationServer struct {
	...
	AuthorizationServers []*views.ObjectRefType `protobuf:"bytes,1,rep,name=authorization_servers,json=authorizationServers,proto3" json:"authorization_servers,omitempty"`
}

func (m *AuthorizationServer) Reset()      { *m = AuthorizationServer{} }
...
func (m *AuthorizationServer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AuthorizationServer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AuthorizationServer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AuthorizationServer.Merge(m, src)
}
func (m *AuthorizationServer) XXX_Size() int {
	return m.Size()
}
func (m *AuthorizationServer) XXX_DiscardUnknown() {
	xxx_messageInfo_AuthorizationServer.DiscardUnknown(m)
}

var xxx_messageInfo_AuthorizationServer proto.InternalMessageInfo

func (m *AuthorizationServer) GetAuthorizationServers() []*views.ObjectRefType {
	if m != nil {
...
type ApiDiscoveryAdvancedSettings struct {
	...
	// x-required
	// Defines how discovery operates and how traffic is analyzed. Use policies to customize discovery behavior, authentication handling, and other related settings.
...
type ApiDiscoverySetting struct {
	...
	//
	// x-displayName: "API Discovery Policy"
	// x-required
...
type ApiCrawler struct {
	...
	// x-displayName: "API Crawling"
	// x-required
	// Toggle to start the API crawler for detecting shadow and rogue APIs.
	//
...
func (*WafExclusion) Descriptor() ([]byte, []int) {
	return fileDescriptor_0072b3e117243bde, []int{57}
}
...
// Live Signatures Update
//
// x-displayName: "WAF Signatures Update Mode"
// Select F5XC WAF Signatures update mode for the site. By default, new signatures will be applied manually.
// Refer to release notes for details about available Signatures update modes.
type LiveSignaturesUpdate struct {
	// WAF Signatures update mode
	//
	// x-displayName: "WAF Signatures Update Mode"
	// Select F5XC WAF Signatures update mode for the site. By default, new signatures will be applied manually.
	// Refer to release notes for details about available Signatures update modes and versions.
	//
	// Types that are valid to be assigned to SignaturesUpdateModeChoice:
	//	*LiveSignaturesUpdate_Automatic
	//	*LiveSignaturesUpdate_Manual
	SignaturesUpdateModeChoice isLiveSignaturesUpdate_SignaturesUpdateModeChoice `protobuf_oneof:"signatures_update_mode_choice"`
}

func (m *LiveSignaturesUpdate) Reset()      { *m = LiveSignaturesUpdate{} }
func (*LiveSignaturesUpdate) ProtoMessage() {}
func (*LiveSignaturesUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_0072b3e117243bde, []int{58}
}
func (m *LiveSignaturesUpdate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LiveSignaturesUpdate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *LiveSignaturesUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LiveSignaturesUpdate.Merge(m, src)
}
func (m *LiveSignaturesUpdate) XXX_Size() int {
	return m.Size()
}
func (m *LiveSignaturesUpdate) XXX_DiscardUnknown() {
	xxx_messageInfo_LiveSignaturesUpdate.DiscardUnknown(m)
}

var xxx_messageInfo_LiveSignaturesUpdate proto.InternalMessageInfo

type isLiveSignaturesUpdate_SignaturesUpdateModeChoice interface {
	isLiveSignaturesUpdate_SignaturesUpdateModeChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type LiveSignaturesUpdate_Automatic struct {
	Automatic *schema.Empty `protobuf:"bytes,2,opt,name=automatic,proto3,oneof" json:"automatic,omitempty"`
}
type LiveSignaturesUpdate_Manual struct {
	Manual *schema.Empty `protobuf:"bytes,3,opt,name=manual,proto3,oneof" json:"manual,omitempty"`
}

func (*LiveSignaturesUpdate_Automatic) isLiveSignaturesUpdate_SignaturesUpdateModeChoice() {}
func (*LiveSignaturesUpdate_Manual) isLiveSignaturesUpdate_SignaturesUpdateModeChoice()    {}

func (m *LiveSignaturesUpdate) GetSignaturesUpdateModeChoice() isLiveSignaturesUpdate_SignaturesUpdateModeChoice {
	if m != nil {
		return m.SignaturesUpdateModeChoice
	}
	return nil
}

func (m *LiveSignaturesUpdate) GetAutomatic() *schema.Empty {
	if x, ok := m.GetSignaturesUpdateModeChoice().(*LiveSignaturesUpdate_Automatic); ok {
		return x.Automatic
	}
	return nil
}

func (m *LiveSignaturesUpdate) GetManual() *schema.Empty {
	if x, ok := m.GetSignaturesUpdateModeChoice().(*LiveSignaturesUpdate_Manual); ok {
		return x.Manual
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*LiveSignaturesUpdate) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*LiveSignaturesUpdate_Automatic)(nil),
		(*LiveSignaturesUpdate_Manual)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*AuthorizationServer)(nil), "ves.io.schema.views.common_waf.AuthorizationServer")
	golang_proto.RegisterType((*AuthorizationServer)(nil), "ves.io.schema.views.common_waf.AuthorizationServer")
	...
	proto.RegisterType((*LiveSignaturesUpdate)(nil), "ves.io.schema.views.common_waf.LiveSignaturesUpdate")
	golang_proto.RegisterType((*LiveSignaturesUpdate)(nil), "ves.io.schema.views.common_waf.LiveSignaturesUpdate")
}
...
var fileDescriptor_0072b3e117243bde = []byte{
	// 7969 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *JWTValidation_AuthorizationServer) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*JWTValidation_AuthorizationServer)
	if !ok {
		that2, ok := that.(JWTValidation_AuthorizationServer)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.AuthorizationServer.Equal(that1.AuthorizationServer) {
		return false
	}
	return true
}
func (this *AuthorizationServer) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AuthorizationServer)
	if !ok {
		that2, ok := that.(AuthorizationServer)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.AuthorizationServers) != len(that1.AuthorizationServers) {
		return false
	}
	for i := range this.AuthorizationServers {
		if !this.AuthorizationServers[i].Equal(that1.AuthorizationServers[i]) {
			return false
		}
	}
	return true
...
func (this *LiveSignaturesUpdate) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LiveSignaturesUpdate)
	if !ok {
		that2, ok := that.(LiveSignaturesUpdate)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.SignaturesUpdateModeChoice == nil {
		if this.SignaturesUpdateModeChoice != nil {
			return false
		}
	} else if this.SignaturesUpdateModeChoice == nil {
		return false
	} else if !this.SignaturesUpdateModeChoice.Equal(that1.SignaturesUpdateModeChoice) {
		return false
	}
	return true
}
func (this *LiveSignaturesUpdate_Automatic) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LiveSignaturesUpdate_Automatic)
	if !ok {
		that2, ok := that.(LiveSignaturesUpdate_Automatic)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.Automatic.Equal(that1.Automatic) {
		return false
	}
	return true
}
func (this *LiveSignaturesUpdate_Manual) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LiveSignaturesUpdate_Manual)
	if !ok {
		that2, ok := that.(LiveSignaturesUpdate_Manual)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *JWTValidation_AuthorizationServer) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&common_waf.JWTValidation_AuthorizationServer{` +
		`AuthorizationServer:` + fmt.Sprintf("%#v", this.AuthorizationServer) + `}`}, ", ")
	return s
}
func (this *AuthorizationServer) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&common_waf.AuthorizationServer{")
	if this.AuthorizationServers != nil {
		s = append(s, "AuthorizationServers: "+fmt.Sprintf("%#v", this.AuthorizationServers)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *LiveSignaturesUpdate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&common_waf.LiveSignaturesUpdate{")
	if this.SignaturesUpdateModeChoice != nil {
		s = append(s, "SignaturesUpdateModeChoice: "+fmt.Sprintf("%#v", this.SignaturesUpdateModeChoice)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *LiveSignaturesUpdate_Automatic) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&common_waf.LiveSignaturesUpdate_Automatic{` +
		`Automatic:` + fmt.Sprintf("%#v", this.Automatic) + `}`}, ", ")
	return s
}
func (this *LiveSignaturesUpdate_Manual) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&common_waf.LiveSignaturesUpdate_Manual{` +
...
func (m *JWTValidation_AuthorizationServer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JWTValidation_AuthorizationServer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AuthorizationServer != nil {
		{
			size, err := m.AuthorizationServer.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AuthorizationServer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AuthorizationServer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AuthorizationServer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.AuthorizationServers) > 0 {
		for iNdEx := len(m.AuthorizationServers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AuthorizationServers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *LiveSignaturesUpdate) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LiveSignaturesUpdate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LiveSignaturesUpdate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.SignaturesUpdateModeChoice != nil {
		{
			size := m.SignaturesUpdateModeChoice.Size()
			i -= size
			if _, err := m.SignaturesUpdateModeChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *LiveSignaturesUpdate_Automatic) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LiveSignaturesUpdate_Automatic) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Automatic != nil {
		{
			size, err := m.Automatic.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *LiveSignaturesUpdate_Manual) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LiveSignaturesUpdate_Manual) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Manual != nil {
		{
...
func (m *JWTValidation_AuthorizationServer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.AuthorizationServer != nil {
		l = m.AuthorizationServer.Size()
		n += 1 + l + sovCommonWafTypes(uint64(l))
	}
	return n
}
func (m *AuthorizationServer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.AuthorizationServers) > 0 {
		for _, e := range m.AuthorizationServers {
			l = e.Size()
			n += 1 + l + sovCommonWafTypes(uint64(l))
		}
	}
...
func (m *LiveSignaturesUpdate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignaturesUpdateModeChoice != nil {
		n += m.SignaturesUpdateModeChoice.Size()
	}
	return n
}

func (m *LiveSignaturesUpdate_Automatic) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LiveSignaturesUpdate_Manual) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *JWTValidation_AuthorizationServer) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&JWTValidation_AuthorizationServer{`,
		`AuthorizationServer:` + strings.Replace(fmt.Sprintf("%v", this.AuthorizationServer), "AuthorizationServer", "AuthorizationServer", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AuthorizationServer) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForAuthorizationServers := "[]*ObjectRefType{"
	for _, f := range this.AuthorizationServers {
		repeatedStringForAuthorizationServers += strings.Replace(fmt.Sprintf("%v", f), "ObjectRefType", "views.ObjectRefType", 1) + ","
	}
	repeatedStringForAuthorizationServers += "}"
	s := strings.Join([]string{`&AuthorizationServer{`,
		`AuthorizationServers:` + repeatedStringForAuthorizationServers + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *LiveSignaturesUpdate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LiveSignaturesUpdate{`,
		`SignaturesUpdateModeChoice:` + fmt.Sprintf("%v", this.SignaturesUpdateModeChoice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *LiveSignaturesUpdate_Automatic) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LiveSignaturesUpdate_Automatic{`,
		`Automatic:` + strings.Replace(fmt.Sprintf("%v", this.Automatic), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *LiveSignaturesUpdate_Manual) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LiveSignaturesUpdate_Manual{`,
...
func (m *JWTValidation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthorizationServer", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.JwksConfiguration = &JWTValidation_AuthorizationServer{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCommonWafTypes(dAtA[iNdEx:])
...
func (m *AuthorizationServer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AuthorizationServer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AuthorizationServer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.AuthorizationServers = append(m.AuthorizationServers, &views.ObjectRefType{})
			if err := m.AuthorizationServers[len(m.AuthorizationServers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *LiveSignaturesUpdate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LiveSignaturesUpdate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LiveSignaturesUpdate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
			...
			m.SignaturesUpdateModeChoice = &LiveSignaturesUpdate_Automatic{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.SignaturesUpdateModeChoice = &LiveSignaturesUpdate_Manual{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCommonWafTypes(dAtA[iNdEx:])
