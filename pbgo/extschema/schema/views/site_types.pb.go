...
// Segment Subnet
//
// x-displayName: "Segment Subnet"
// Parameters for Segment subnet
type SegmentSubnetType struct {
	// Choice of subnet
	//
	...
	//
	// Types that are valid to be assigned to Choice:
	//	*SegmentSubnetType_Ipv4
	//	*SegmentSubnetType_ExistingSubnetId
	Choice isSegmentSubnetType_Choice `protobuf_oneof:"choice"`
}

func (m *SegmentSubnetType) Reset()      { *m = SegmentSubnetType{} }
func (*SegmentSubnetType) ProtoMessage() {}
func (*SegmentSubnetType) Descriptor() ([]byte, []int) {
	return fileDescriptor_5debf32965df805e, []int{3}
}
func (m *SegmentSubnetType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SegmentSubnetType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *SegmentSubnetType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SegmentSubnetType.Merge(m, src)
}
func (m *SegmentSubnetType) XXX_Size() int {
	return m.Size()
}
func (m *SegmentSubnetType) XXX_DiscardUnknown() {
	xxx_messageInfo_SegmentSubnetType.DiscardUnknown(m)
}

var xxx_messageInfo_SegmentSubnetType proto.InternalMessageInfo

type isSegmentSubnetType_Choice interface {
	isSegmentSubnetType_Choice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type SegmentSubnetType_Ipv4 struct {
	Ipv4 string `protobuf:"bytes,1,opt,name=ipv4,proto3,oneof" json:"ipv4,omitempty"`
}
type SegmentSubnetType_ExistingSubnetId struct {
...
func (*SegmentSubnetType_Ipv4) isSegmentSubnetType_Choice()             {}
func (*SegmentSubnetType_ExistingSubnetId) isSegmentSubnetType_Choice() {}

func (m *SegmentSubnetType) GetChoice() isSegmentSubnetType_Choice {
	if m != nil {
		return m.Choice
	}
	return nil
...
func (m *SegmentSubnetType) GetIpv4() string {
	if x, ok := m.GetChoice().(*SegmentSubnetType_Ipv4); ok {
		return x.Ipv4
	}
	return ""
}

func (m *SegmentSubnetType) GetExistingSubnetId() string {
	if x, ok := m.GetChoice().(*SegmentSubnetType_ExistingSubnetId); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*SegmentSubnetType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*SegmentSubnetType_Ipv4)(nil),
		(*SegmentSubnetType_ExistingSubnetId)(nil),
	}
}
...
// Interface Options on Interface
//
// x-displayName: "Interface Options on Interface"
// Interface Options on Interface, internal use only added as part of SMS v2
type SMSv2InterfaceOptions struct {
	...
	// Set through Secure mesh V2 options
	EnableSiteToSiteConnectivity bool `protobuf:"varint,2,opt,name=enable_site_to_site_connectivity,json=enableSiteToSiteConnectivity,proto3" json:"enable_site_to_site_connectivity,omitempty"`
	// Segment
	//
	// x-displayName: "Segment (Global VRF)"
	SegmentNetwork *ObjectRefType `protobuf:"bytes,3,opt,name=segment_network,json=segmentNetwork,proto3" json:"segment_network,omitempty"`
	// Subnet for Segment Interface
	//
	// x-displayName: "Subnet for Segment Interface"
	// Subnet for the Segment interface of the node
	SegmentSubnet *SegmentSubnetType `protobuf:"bytes,4,opt,name=segment_subnet,json=segmentSubnet,proto3" json:"segment_subnet,omitempty"`
}

func (m *SMSv2InterfaceOptions) Reset()      { *m = SMSv2InterfaceOptions{} }
func (*SMSv2InterfaceOptions) ProtoMessage() {}
func (*SMSv2InterfaceOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_5debf32965df805e, []int{9}
}
func (m *SMSv2InterfaceOptions) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SMSv2InterfaceOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *SMSv2InterfaceOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SMSv2InterfaceOptions.Merge(m, src)
}
func (m *SMSv2InterfaceOptions) XXX_Size() int {
	return m.Size()
}
func (m *SMSv2InterfaceOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_SMSv2InterfaceOptions.DiscardUnknown(m)
}

var xxx_messageInfo_SMSv2InterfaceOptions proto.InternalMessageInfo

func (m *SMSv2InterfaceOptions) GetMtu() uint32 {
	if m != nil {
		return m.Mtu
	}
	return 0
...
func (m *SMSv2InterfaceOptions) GetEnableSiteToSiteConnectivity() bool {
	if m != nil {
		return m.EnableSiteToSiteConnectivity
	}
	return false
}

func (m *SMSv2InterfaceOptions) GetSegmentNetwork() *ObjectRefType {
	if m != nil {
...
func (m *SMSv2InterfaceOptions) GetSegmentSubnet() *SegmentSubnetType {
	if m != nil {
		return m.SegmentSubnet
	}
	return nil
}
...
type AzureVnetType struct {
	...
	//	*AzureVnetType_F5OrchestratedRouting
	//	*AzureVnetType_ManualRouting
	RoutingType isAzureVnetType_RoutingType `protobuf_oneof:"routing_type"`
}
...
type isAzureVnetType_RoutingType interface {
	isAzureVnetType_RoutingType()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type AzureVnetType_F5OrchestratedRouting struct {
	F5OrchestratedRouting *schema.Empty `protobuf:"bytes,4,opt,name=f5_orchestrated_routing,json=f5OrchestratedRouting,proto3,oneof" json:"f5_orchestrated_routing,omitempty"`
}
type AzureVnetType_ManualRouting struct {
	ManualRouting *schema.Empty `protobuf:"bytes,5,opt,name=manual_routing,json=manualRouting,proto3,oneof" json:"manual_routing,omitempty"`
}

func (*AzureVnetType_F5OrchestratedRouting) isAzureVnetType_RoutingType() {}
func (*AzureVnetType_ManualRouting) isAzureVnetType_RoutingType()         {}

func (m *AzureVnetType) GetRoutingType() isAzureVnetType_RoutingType {
	if m != nil {
...
func (m *AzureVnetType) GetF5OrchestratedRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*AzureVnetType_F5OrchestratedRouting); ok {
		return x.F5OrchestratedRouting
	}
	return nil
}

func (m *AzureVnetType) GetManualRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*AzureVnetType_ManualRouting); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*AzureVnetType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*AzureVnetType_F5OrchestratedRouting)(nil),
		(*AzureVnetType_ManualRouting)(nil),
	}
}
...
type GCPVPCNetworkType struct {
	...
	// Choice of Routing
	//
	// x-displayName: "Orchestrate VPC Routing"
	// This is choice of F5 Orchestrated Routing or Manual Routing for CE VPC
	//
	// Types that are valid to be assigned to RoutingType:
	//	*GCPVPCNetworkType_F5OrchestratedRouting
	//	*GCPVPCNetworkType_ManualRouting
	RoutingType isGCPVPCNetworkType_RoutingType `protobuf_oneof:"routing_type"`
}
...
type isGCPVPCNetworkType_RoutingType interface {
	isGCPVPCNetworkType_RoutingType()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type GCPVPCNetworkType_F5OrchestratedRouting struct {
	F5OrchestratedRouting *schema.Empty `protobuf:"bytes,3,opt,name=f5_orchestrated_routing,json=f5OrchestratedRouting,proto3,oneof" json:"f5_orchestrated_routing,omitempty"`
}
type GCPVPCNetworkType_ManualRouting struct {
...
func (*GCPVPCNetworkType_F5OrchestratedRouting) isGCPVPCNetworkType_RoutingType() {}
func (*GCPVPCNetworkType_ManualRouting) isGCPVPCNetworkType_RoutingType()         {}

func (m *GCPVPCNetworkType) GetRoutingType() isGCPVPCNetworkType_RoutingType {
	if m != nil {
		return m.RoutingType
	}
	return nil
...
// Deprecated: Do not use.
func (m *GCPVPCNetworkType) GetF5OrchestratedRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*GCPVPCNetworkType_F5OrchestratedRouting); ok {
		return x.F5OrchestratedRouting
	}
	return nil
}
...
// Deprecated: Do not use.
func (m *GCPVPCNetworkType) GetManualRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*GCPVPCNetworkType_ManualRouting); ok {
		return x.ManualRouting
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*GCPVPCNetworkType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*GCPVPCNetworkType_F5OrchestratedRouting)(nil),
		(*GCPVPCNetworkType_ManualRouting)(nil),
	}
}
...
type SiteError struct {
	...
	// Error Details
	//
	// x-example: "VPC vpc-1233548 NotExistent"
	// x-displayName: "Error Details"
	// Error details contains error message from cloud provider
...
func (m *SiteError) GetErrorDetails() string {
	if m != nil {
...
func (*ValidateConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5debf32965df805e, []int{50}
}
...
func (*ValidateConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5debf32965df805e, []int{51}
}
...
func (m *AWSDiskEncryption) Reset()      { *m = AWSDiskEncryption{} }
func (*AWSDiskEncryption) ProtoMessage() {}
func (*AWSDiskEncryption) Descriptor() ([]byte, []int) {
	return fileDescriptor_5debf32965df805e, []int{52}
}
func (m *AWSDiskEncryption) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AWSDiskEncryption) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AWSDiskEncryption) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AWSDiskEncryption.Merge(m, src)
}
func (m *AWSDiskEncryption) XXX_Size() int {
	return m.Size()
}
func (m *AWSDiskEncryption) XXX_DiscardUnknown() {
	xxx_messageInfo_AWSDiskEncryption.DiscardUnknown(m)
}

var xxx_messageInfo_AWSDiskEncryption proto.InternalMessageInfo

func (m *AWSDiskEncryption) GetKmsKeyId() string {
	if m != nil {
		return m.KmsKeyId
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*SegmentSubnetType)(nil), "ves.io.schema.views.SegmentSubnetType")
	golang_proto.RegisterType((*SegmentSubnetType)(nil), "ves.io.schema.views.SegmentSubnetType")
	...
	proto.RegisterType((*SMSv2InterfaceOptions)(nil), "ves.io.schema.views.SMSv2InterfaceOptions")
	golang_proto.RegisterType((*SMSv2InterfaceOptions)(nil), "ves.io.schema.views.SMSv2InterfaceOptions")
	...
	proto.RegisterType((*AWSDiskEncryption)(nil), "ves.io.schema.views.AWSDiskEncryption")
	golang_proto.RegisterType((*AWSDiskEncryption)(nil), "ves.io.schema.views.AWSDiskEncryption")
}
...
var fileDescriptor_5debf32965df805e = []byte{
	...
	,
}
...
func (this *SegmentSubnetType) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SegmentSubnetType)
	if !ok {
		that2, ok := that.(SegmentSubnetType)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SegmentSubnetType_Ipv4) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SegmentSubnetType_Ipv4)
	if !ok {
		that2, ok := that.(SegmentSubnetType_Ipv4)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SegmentSubnetType_ExistingSubnetId) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SegmentSubnetType_ExistingSubnetId)
	if !ok {
		that2, ok := that.(SegmentSubnetType_ExistingSubnetId)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SMSv2InterfaceOptions) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SMSv2InterfaceOptions)
	if !ok {
		that2, ok := that.(SMSv2InterfaceOptions)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.EnableSiteToSiteConnectivity != that1.EnableSiteToSiteConnectivity {
		return false
	}
	if !this.SegmentNetwork.Equal(that1.SegmentNetwork) {
		return false
	}
	if !this.SegmentSubnet.Equal(that1.SegmentSubnet) {
		return false
	}
	return true
}
...
func (this *AzureVnetType_F5OrchestratedRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AzureVnetType_F5OrchestratedRouting)
	if !ok {
		that2, ok := that.(AzureVnetType_F5OrchestratedRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AzureVnetType_ManualRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AzureVnetType_ManualRouting)
	if !ok {
		that2, ok := that.(AzureVnetType_ManualRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GCPVPCNetworkType_F5OrchestratedRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GCPVPCNetworkType_F5OrchestratedRouting)
	if !ok {
		that2, ok := that.(GCPVPCNetworkType_F5OrchestratedRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GCPVPCNetworkType_ManualRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GCPVPCNetworkType_ManualRouting)
	if !ok {
		that2, ok := that.(GCPVPCNetworkType_ManualRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SiteError) Equal(that interface{}) bool {
	...
	if this.ErrorDetails != that1.ErrorDetails {
		return false
	}
	return true
}
...
func (this *AWSDiskEncryption) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AWSDiskEncryption)
	if !ok {
		that2, ok := that.(AWSDiskEncryption)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SegmentSubnetType) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&views.SegmentSubnetType{")
	if this.Choice != nil {
		s = append(s, "Choice: "+fmt.Sprintf("%#v", this.Choice)+",\n")
	}
	s = append(s, "}")
...
func (this *SegmentSubnetType_Ipv4) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.SegmentSubnetType_Ipv4{` +
		`Ipv4:` + fmt.Sprintf("%#v", this.Ipv4) + `}`}, ", ")
	return s
}
func (this *SegmentSubnetType_ExistingSubnetId) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.SegmentSubnetType_ExistingSubnetId{` +
...
func (this *SMSv2InterfaceOptions) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&views.SMSv2InterfaceOptions{")
	s = append(s, "Mtu: "+fmt.Sprintf("%#v", this.Mtu)+",\n")
	s = append(s, "EnableSiteToSiteConnectivity: "+fmt.Sprintf("%#v", this.EnableSiteToSiteConnectivity)+",\n")
	if this.SegmentNetwork != nil {
		s = append(s, "SegmentNetwork: "+fmt.Sprintf("%#v", this.SegmentNetwork)+",\n")
	}
	if this.SegmentSubnet != nil {
		s = append(s, "SegmentSubnet: "+fmt.Sprintf("%#v", this.SegmentSubnet)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *AzureVnetType_F5OrchestratedRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.AzureVnetType_F5OrchestratedRouting{` +
		`F5OrchestratedRouting:` + fmt.Sprintf("%#v", this.F5OrchestratedRouting) + `}`}, ", ")
	return s
}
func (this *AzureVnetType_ManualRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.AzureVnetType_ManualRouting{` +
...
func (this *GCPVPCNetworkType_F5OrchestratedRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.GCPVPCNetworkType_F5OrchestratedRouting{` +
		`F5OrchestratedRouting:` + fmt.Sprintf("%#v", this.F5OrchestratedRouting) + `}`}, ", ")
	return s
}
func (this *GCPVPCNetworkType_ManualRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&views.GCPVPCNetworkType_ManualRouting{` +
		`ManualRouting:` + fmt.Sprintf("%#v", this.ManualRouting) + `}`}, ", ")
	return s
}
...
func (this *AWSDiskEncryption) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&views.AWSDiskEncryption{")
	s = append(s, "KmsKeyId: "+fmt.Sprintf("%#v", this.KmsKeyId)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SegmentSubnetType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SegmentSubnetType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SegmentSubnetType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SegmentSubnetType_Ipv4) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SegmentSubnetType_Ipv4) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Ipv4)
	copy(dAtA[i:], m.Ipv4)
	i = encodeVarintSiteTypes(dAtA, i, uint64(len(m.Ipv4)))
...
func (m *SegmentSubnetType_ExistingSubnetId) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SegmentSubnetType_ExistingSubnetId) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *SMSv2InterfaceOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SMSv2InterfaceOptions) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SMSv2InterfaceOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.SegmentSubnet != nil {
		{
			size, err := m.SegmentSubnet.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.EnableSiteToSiteConnectivity {
		i--
		if m.EnableSiteToSiteConnectivity {
			dAtA[i] = 1
		} else {
	...
	if m.Mtu != 0 {
		i = encodeVarintSiteTypes(dAtA, i, uint64(m.Mtu))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AzureVnetType_F5OrchestratedRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AzureVnetType_F5OrchestratedRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *AzureVnetType_ManualRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AzureVnetType_ManualRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *GCPVPCNetworkType_F5OrchestratedRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GCPVPCNetworkType_F5OrchestratedRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.F5OrchestratedRouting != nil {
		{
			size, err := m.F5OrchestratedRouting.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GCPVPCNetworkType_ManualRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GCPVPCNetworkType_ManualRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ManualRouting != nil {
		{
			size, err := m.ManualRouting.MarshalToSizedBuffer(dAtA[:i])
...
func (m *SiteError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ErrorDetails) > 0 {
		...
		i = encodeVarintSiteTypes(dAtA, i, uint64(len(m.ErrorDetails)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *AWSDiskEncryption) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AWSDiskEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AWSDiskEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.KmsKeyId) > 0 {
		...
		i = encodeVarintSiteTypes(dAtA, i, uint64(len(m.KmsKeyId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SegmentSubnetType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SegmentSubnetType_Ipv4) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SegmentSubnetType_ExistingSubnetId) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SMSv2InterfaceOptions) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AzureVnetType_F5OrchestratedRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AzureVnetType_ManualRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GCPVPCNetworkType_F5OrchestratedRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GCPVPCNetworkType_ManualRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AWSDiskEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *SegmentSubnetType) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SegmentSubnetType{`,
		`Choice:` + fmt.Sprintf("%v", this.Choice) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SegmentSubnetType_Ipv4) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SegmentSubnetType_Ipv4{`,
		`Ipv4:` + fmt.Sprintf("%v", this.Ipv4) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SegmentSubnetType_ExistingSubnetId) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SegmentSubnetType_ExistingSubnetId{`,
		`ExistingSubnetId:` + fmt.Sprintf("%v", this.ExistingSubnetId) + `,`,
		`}`,
	}, "")
	return s
...
func (this *SMSv2InterfaceOptions) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SMSv2InterfaceOptions{`,
		`Mtu:` + fmt.Sprintf("%v", this.Mtu) + `,`,
		`EnableSiteToSiteConnectivity:` + fmt.Sprintf("%v", this.EnableSiteToSiteConnectivity) + `,`,
		`SegmentNetwork:` + strings.Replace(fmt.Sprintf("%v", this.SegmentNetwork), "ObjectRefType", "ObjectRefType", 1) + `,`,
		`SegmentSubnet:` + strings.Replace(this.SegmentSubnet.String(), "SegmentSubnetType", "SegmentSubnetType", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *AzureVnetType_F5OrchestratedRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AzureVnetType_F5OrchestratedRouting{`,
		`F5OrchestratedRouting:` + strings.Replace(fmt.Sprintf("%v", this.F5OrchestratedRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AzureVnetType_ManualRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AzureVnetType_ManualRouting{`,
...
func (this *GCPVPCNetworkType_F5OrchestratedRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GCPVPCNetworkType_F5OrchestratedRouting{`,
		`F5OrchestratedRouting:` + strings.Replace(fmt.Sprintf("%v", this.F5OrchestratedRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GCPVPCNetworkType_ManualRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GCPVPCNetworkType_ManualRouting{`,
		`ManualRouting:` + strings.Replace(fmt.Sprintf("%v", this.ManualRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *AWSDiskEncryption) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AWSDiskEncryption{`,
...
func (m *SegmentSubnetType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SegmentSubnetType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SegmentSubnetType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Choice = &SegmentSubnetType_Ipv4{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Choice = &SegmentSubnetType_ExistingSubnetId{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSiteTypes(dAtA[iNdEx:])
...
func (m *SMSv2InterfaceOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SMSv2InterfaceOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SMSv2InterfaceOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableSiteToSiteConnectivity", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableSiteToSiteConnectivity = bool(v != 0)
		case 3:
			if wireType != 2 {
			...
			if m.SegmentNetwork == nil {
				m.SegmentNetwork = &ObjectRefType{}
			}
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SegmentSubnet", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SegmentSubnet == nil {
				m.SegmentSubnet = &SegmentSubnetType{}
			}
			if err := m.SegmentSubnet.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AzureVnetType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.RoutingType = &AzureVnetType_F5OrchestratedRouting{v}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			m.RoutingType = &AzureVnetType_ManualRouting{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSiteTypes(dAtA[iNdEx:])
...
func (m *GCPVPCNetworkType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.RoutingType = &GCPVPCNetworkType_F5OrchestratedRouting{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ManualRouting", wireType)
			...
			m.RoutingType = &GCPVPCNetworkType_ManualRouting{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSiteTypes(dAtA[iNdEx:])
...
func (m *AWSDiskEncryption) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AWSDiskEncryption: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AWSDiskEncryption: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
