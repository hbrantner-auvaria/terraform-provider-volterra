...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.terraform_parameters.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.terraform_parameters.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.terraform_parameters.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.terraform_parameters.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.terraform_parameters.crudapi.API.Delete")
    ...
    "definitions": {
        ...
        "terraform_parametersGlobalSpecType": {
            ...
            "properties": {
                ...
                "creds": {
                    "type": "array",
                    "description": " Reference to cloud credentials used in the terraform.",
...
// CLIENT side
func newStatusObjectListReqFrom(cco *server.CrudCallOpts) (*StatusObjectListReq, error) {
	r := &StatusObjectListReq{
		TenantFilter:      cco.TenantFilter,
		NamespaceFilter:   cco.NamespaceFilter,
		ReportFields:      cco.ReportFields,
		IncludeReferredId: cco.IncludeReferredID,
...
func (c *crudStatusAPIGrpcClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*StatusObjectListRsp, error) {
	...
	req, err := newStatusObjectListReqFrom(cco)
	if err != nil {
		return nil, err
	}
	ctx = client.AddHdrsToCtx(cco.Headers, ctx)
...
func (c *StatusAPIInprocClient) List(ctx context.Context, req *StatusObjectListReq, opts ...grpc.CallOption) (*StatusObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.terraform_parameters.crudapi.StatusAPI.List")
	return oah.List(ctx, req)
}
...
func NewStatusAPIInprocClient(svc svcfw.Service) StatusAPIClient {
	return &StatusAPIInprocClient{svc: svc}
}
...
func newCRUDStatusAPIInprocClient(svc svcfw.Service) *crudStatusAPIInprocClient {
	return &crudStatusAPIInprocClient{cl: NewStatusAPIInprocClient(svc)}
}
