...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.voltstack_site.API.Create' operation on 'voltstack_site'"
		if retErr == nil {
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.voltstack_site.API.Replace' operation on 'voltstack_site'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.voltstack_site.API.Delete' operation on 'voltstack_site'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
