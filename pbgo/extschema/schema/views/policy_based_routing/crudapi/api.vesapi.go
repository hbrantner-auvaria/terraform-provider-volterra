...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/policy_based_routing"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.policy_based_routing.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.policy_based_routing.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.views.policy_based_routing.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.policy_based_routing.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.policy_based_routing.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.policy_based_routing.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.policy_based_routing.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.policy_based_routing.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.policy_based_routing.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.policy_based_routing.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.policy_based_routing.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.policy_based_routing.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.policy_based_routing.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.policy_based_routing.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.policy_based_routing.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.policy_based_routing.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.policy_based_routing.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.policy_based_routing.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/policy_based_routing/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.policy_based_routing/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-policy_based_routing-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.policy_based_routing.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-policy_based_routing-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.policy_based_routing.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-policy_based_routing-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.policy_based_routing.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "policy_based_routing",
            "x-ves-object-type": "ves.io.schema.views.policy_based_routing.Object",
            "x-ves-proto-service": "ves.io.schema.views.policy_based_routing.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.policy_based_routing/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-policy_based_routing-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.policy_based_routing.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-policy_based_routing-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.policy_based_routing.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "policy_based_routing",
            "x-ves-object-type": "ves.io.schema.views.policy_based_routing.Object",
        ...
        "/ves.io.schema.views.policy_based_routing/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-policy_based_routing-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.policy_based_routing.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "policy_based_routing",
            "x-ves-object-type": "ves.io.schema.views.policy_based_routing.Object",
        ...
        "/ves.io.schema.views.policy_based_routing/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.policy_based_routing/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.policy_based_routing/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.policy_based_routing/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.policy_based_routing.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/policy_based_routingSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/policy_based_routingcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/policy_based_routingcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/policy_based_routingStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/policy_based_routingcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/policy_based_routingcrudapiErrorCode"
                },
        ...
        "policy_based_routingForwardProxyPBRRuleType": {
            ...
            "properties": {
                "all_destinations": {
                    "description": "Exclusive with [http_list tls_list]\n Match on all destinations",
                ...
                "http_list": {
                    "description": "Exclusive with [all_destinations tls_list]\n URLs for HTTP connections",
                    "title": "HTTP URLs",
                ...
                "tls_list": {
                    "description": "Exclusive with [all_destinations http_list]\n Domains in SNI for TLS connections",
                    "title": "TLS Domains",
        ...
        "policy_based_routingForwardProxyPBRType": {
            ...
            "properties": {
                "forward_proxy_pbr_rules": {
                    ...
                    "maxItems": 128,
                    "items": {
                        "$ref": "#/definitions/policy_based_routingForwardProxyPBRRuleType"
                    },
        ...
        "policy_based_routingNetworkPBRRuleType": {
            ...
            "properties": {
                ...
                "any": {
                    "description": "Exclusive with [dns_name ip_prefix_set prefix_list]\n Any Endpoint that matches 0/0 ip prefix",
                    "title": "Any Endpoint",
                    "$ref": "#/definitions/schemaEmpty",
        ...
        "policy_based_routingNetworkPBRType": {
            ...
            "properties": {
                "any": {
                    "description": "Exclusive with [label_selector prefix_list]\n Any Endpoint that matches 0/0 ip prefix",
                    "title": "Any Endpoint",
                    "$ref": "#/definitions/schemaEmpty",
                    "x-displayname": "Any Endpoint"
                },
                "label_selector": {
                    "description": "Exclusive with [any prefix_list]\n local end point is set of prefixes determined by label selector expression\n\nExample: - \"app != web\"-",
                ...
                "network_pbr_rules": {
                    ...
                    "maxItems": 128,
                    "items": {
                        "$ref": "#/definitions/policy_based_routingNetworkPBRRuleType"
                    },
        ...
        "policy_based_routingSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/viewspolicy_based_routingGlobalSpecType",
        ...
        "policy_based_routingcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.policy_based_routing.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
        ...
        "viewspolicy_based_routingGlobalSpecType": {
            "type": "object",
            "description": "Policy based routing policy",
            "title": "Global Spec",
            "x-displayname": "Policy Based Routing",
            "x-ves-oneof-field-policy_choice": "[\"forward_proxy_pbr\",\"network_pbr\"]",
            "x-ves-proto-message": "ves.io.schema.views.policy_based_routing.GlobalSpecType",
            "properties": {
                "forward_proxy_pbr": {
                    "description": "Exclusive with [network_pbr]\n Forward Proxy (L7) Policy based routing policy",
                    "title": "Forward Proxy PBR",
                    "$ref": "#/definitions/policy_based_routingForwardProxyPBRType",
                ...
                "forwarding_class_list": {
                    ...
                    "title": "Default Forwarding Class",
                    "minItems": 1,
                    "maxItems": 3,
                    "items": {
                        "$ref": "#/definitions/schemaviewsObjectRefType"
                ...
                "network_pbr": {
                    "description": "Exclusive with [forward_proxy_pbr]\n Network(L3/L4) Policy based routing policy",
                    "title": "Network PBR",
                    "$ref": "#/definitions/policy_based_routingNetworkPBRType",
                    "x-displayname": "L3/L4 Policy based routing"
                }
            }
        }
    },
    ...
    "x-ves-proto-file": "ves.io/schema/views/policy_based_routing/crudapi/api.proto"
}`
