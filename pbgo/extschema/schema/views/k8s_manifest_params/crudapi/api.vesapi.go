...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/k8s_manifest_params"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.k8s_manifest_params.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.k8s_manifest_params.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.views.k8s_manifest_params.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.k8s_manifest_params.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.k8s_manifest_params.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.k8s_manifest_params.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.k8s_manifest_params.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.k8s_manifest_params.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.k8s_manifest_params.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.k8s_manifest_params.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.k8s_manifest_params.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.k8s_manifest_params.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.k8s_manifest_params.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.k8s_manifest_params.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.k8s_manifest_params.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.k8s_manifest_params.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.k8s_manifest_params.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.k8s_manifest_params.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/k8s_manifest_params/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.k8s_manifest_params/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-k8s_manifest_params-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-k8s_manifest_params-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-k8s_manifest_params-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_manifest_params",
            "x-ves-object-type": "ves.io.schema.views.k8s_manifest_params.Object",
            "x-ves-proto-service": "ves.io.schema.views.k8s_manifest_params.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.k8s_manifest_params/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-k8s_manifest_params-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.k8s_manifest_params.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-k8s_manifest_params-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_manifest_params",
            "x-ves-object-type": "ves.io.schema.views.k8s_manifest_params.Object",
        ...
        "/ves.io.schema.views.k8s_manifest_params/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-k8s_manifest_params-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.k8s_manifest_params.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "k8s_manifest_params",
            "x-ves-object-type": "ves.io.schema.views.k8s_manifest_params.Object",
        ...
        "/ves.io.schema.views.k8s_manifest_params/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.k8s_manifest_params/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.k8s_manifest_params/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.k8s_manifest_params/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.k8s_manifest_params.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/k8s_manifest_paramsSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_manifest_paramscrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_manifest_paramscrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/k8s_manifest_paramsStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_manifest_paramscrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/k8s_manifest_paramscrudapiErrorCode"
                },
        ...
        "k8s_manifest_paramsBigIpBareMetalDeviceK8sParams": {
            "type": "object",
            "description": "Big-IP Device Configuration Parameters",
            "title": "Big-IP Device Configuration Parameters",
            "x-displayname": "Big-IP Device Parameters",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.BigIpBareMetalDeviceK8sParams",
            "properties": {
                "bigiq_tcplb_vip": {
                    "type": "string",
                    "description": " IP address from the TCP Load Balancer created and configured to talk to BIG-IQ\n\nExample: - \"192.168.0.77\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "BIG-IQ TCP Load Balancer IP",
                ...
                "external_network_gateway": {
                    "type": "string",
                    "description": " External network interface default gateway\n\nExample: - \"10.2.3.0\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "BIG-IP External Network Default Gateway",
                ...
                "external_network_selfip": {
                    "type": "string",
                    "description": " BIG-IP external network self ip\n\nExample: - \"10.2.3.0/24\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "BIG-IP External Network Self IP",
                ...
                "internal_network_gateway": {
                    "type": "string",
                    "description": " Internal network interface default gateway\n\nExample: - \"10.2.3.0\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "BIG-IP Internal Network Default Gateway",
                ...
                "internal_network_selfip": {
                    "type": "string",
                    "description": " BIG-IP internal network self ip\n\nExample: - \"10.2.3.0/24\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "BIG-IP Internal Network Self IP",
                ...
                "memory_size": {
                    "type": "string",
                    "description": " Amount of memory to assign to the service node\n\nExample: - 16GB-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Memory Size",
                ...
                "nad_for_external_interface": {
                    "type": "string",
                    "description": " BIG-IP External Network Attachment Defintion/Subnet Object\n\nExample: - \"subnet_object_name\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "BIG-IP External Network Attachment Defintion/Subnet Object",
                    "x-displayname": "External Network Attachment Defintion/",
                    "x-ves-example": "subnet_object_name",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
                },
                "nad_for_internal_interface": {
                    "type": "string",
                    "description": " BIG-IP Internal Network Attachment Defintion/Subnet Object\n\nExample: - \"subnet_object_name\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "BIG-IP Internal Network Attachment Defintion/Subnet Object",
                ...
                "vcpu_count": {
                    "type": "string",
                    "description": " Number of virtual CPU's to assign the service node\n\nExample: - 4-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "k8s_manifest_paramsBigIpBareMetalK8sType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.BigIpBareMetalK8sType",
            "properties": {
                "admin_username": {
                    "type": "string",
                ...
                "devices": {
                    "type": "array",
                    "description": " Big-IP Devices Info\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 1\n  ves.io.schema.rules.repeated.min_items: 1\n",
                    "title": "Big-IP Devices Info",
                    "minItems": 1,
                    "maxItems": 1,
                    "items": {
                        "$ref": "#/definitions/k8s_manifest_paramsBigIpBareMetalDeviceK8sParams"
                    },
                ...
                "public_download_url": {
                    "type": "string",
                    "description": " public URL where BIG-IP image VE edition is hosted.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                ...
                "ssh_key": {
                    "type": "string",
                    "description": " SSH Public Key to be programmed on bigip instance for ssh access\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
        ...
        "k8s_manifest_paramsDeployStatus": {
            "type": "string",
            "title": "- RUNNING: x-displayName: \"Running\"\n - STOPPED: x-displayName: \"Stopped\"\n - PROVISIONING: x-displayName: \"Provisioning\"\n - STARTING: x-displayName: \"Starting\"\n - PAUSED: x-displayName: \"Paused\"\n - STOPPING: x-displayName: \"Stopping\"\n - TERMINATING: x-displayName: \"Terminating\"\n - CRASHLOOP_BACKOFF: x-displayName: \"Crash Loop Back Off\"\n - MIGRATING: x-displayName: \"Migrating\"\n - UNKNOWN: x-displayName: \"Unknown\"\n - ERROR_RUN_SCHEDULABLE: x-displayName: \"Error Run Schedulable\"\n - ERR_IMAGE_PULL: x-displayName: \"Error Image Pull\"\n - IMAGE_PULL_BACKOFF: x-displayName: \"Image Pull BackOff\"\n - ERROR_PVC_NOTFOUND: x-displayName: \"Error PVC Not Found\"\n - DATA_VOLUME_ERROR: x-displayName: \"Data Volume Error\"\n - WAITING_FOR_VOLUME_BINDING: x-displayName: \"Waiting For Volume Binding\"\n - ERROR_UNSCHEDULABLE: x-displayName: \"Error Unschedulable\"\n - TIMEDOUT: x-displayName: \"Timed Out\"",
            "enum": [
                "RUNNING",
                "STOPPED",
                "PROVISIONING",
        ...
        "k8s_manifest_paramsDeploymentStatusType": {
            "type": "object",
        ...
        "k8s_manifest_paramsGlobalSpecType": {
            "type": "object",
            "description": "Shape of the view Kubernetes Manifest specification",
            "title": "GlobalSpecType",
            "x-displayname": "View Kubernetes Manifest Specification",
            "x-ves-oneof-field-f5_k8s_type": "[\"f5_bare_metal_k8s_params\"]",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.GlobalSpecType",
            "properties": {
                "f5_bare_metal_k8s_params": {
                    "description": "Exclusive with []\n Data specific to F5 Bare Metal Kubernetes parameters",
                    "title": "F5 App Stack Bare Metal params",
                    "$ref": "#/definitions/k8s_manifest_paramsBigIpBareMetalK8sType",
                    "x-displayname": "F5 App Stack Bare Metal Kubernetes Manifest Params"
                }
            }
        },
        "k8s_manifest_paramsSpecType": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.SpecType",
            "properties": {
                "gc_spec": {
                    "$ref": "#/definitions/k8s_manifest_paramsGlobalSpecType"
                }
            }
        },
        "k8s_manifest_paramsStatusObject": {
            "type": "object",
            "description": "view kubernetes manifest parameters status object",
            "title": "Status Object",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.views.k8s_manifest_params.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "deploy_status": {
                    "$ref": "#/definitions/k8s_manifest_paramsDeploymentStatusType"
                },
                "metadata": {
                ...
                "object_refs": {
                    "type": "array",
                    "description": " k8s manifest params direct reference",
                    "title": "object_refs",
                    "items": {
        ...
        "k8s_manifest_paramscrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.k8s_manifest_params.crudapi.ErrorCode"
        },
        "protobufAny": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/views/k8s_manifest_params/crudapi/api.proto"
}`
