...
const (
	...
	CreateRequestFQN = "ves.io.schema.views.securemesh_site_v2.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.views.securemesh_site_v2.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.views.securemesh_site_v2.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.views.securemesh_site_v2.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.views.securemesh_site_v2.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.views.securemesh_site_v2.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.views.securemesh_site_v2.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.views.securemesh_site_v2.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.views.securemesh_site_v2.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.views.securemesh_site_v2.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/securemesh_site_v2s", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/securemesh_site_v2s/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/securemesh_site_v2s/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/securemesh_site_v2s", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/securemesh_site_v2s/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.securemesh_site_v2.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.views.securemesh_site_v2")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.securemesh_site_v2.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.securemesh_site_v2.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.securemesh_site_v2.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.securemesh_site_v2.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.securemesh_site_v2.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.securemesh_site_v2.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.securemesh_site_v2.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.securemesh_site_v2.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.securemesh_site_v2.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.views.securemesh_site_v2.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.securemesh_site_v2.API.Create' operation on 'securemesh_site_v2'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.views.securemesh_site_v2.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.securemesh_site_v2.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.securemesh_site_v2.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.securemesh_site_v2.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.views.securemesh_site_v2.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.views.securemesh_site_v2.API.Replace' operation on 'securemesh_site_v2'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.securemesh_site_v2.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.securemesh_site_v2.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.views.securemesh_site_v2.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.securemesh_site_v2.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.securemesh_site_v2.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.securemesh_site_v2.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.views.securemesh_site_v2.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.views.securemesh_site_v2.API.Delete' operation on 'securemesh_site_v2'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.views.securemesh_site_v2.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/securemesh_site_v2s": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/securemesh_site_v2CreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/securemesh_site_v2CreateRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-securemesh_site_v2-api-create"
                },
        ...
        "/public/namespaces/{metadata.namespace}/securemesh_site_v2s/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/securemesh_site_v2ReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/securemesh_site_v2ReplaceRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-securemesh_site_v2-api-replace"
                },
        ...
        "/public/namespaces/{namespace}/securemesh_site_v2s": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/securemesh_site_v2ListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-securemesh_site_v2-api-list"
                },
        ...
        "/public/namespaces/{namespace}/securemesh_site_v2s/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/securemesh_site_v2GetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-securemesh_site_v2-api-get"
                },
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/securemesh_site_v2DeleteRequest"
                        }
                    }
                ],
                "tags": [
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-securemesh_site_v2-api-delete"
                },
    ...
    "definitions": {
        ...
        "network_interfaceDHCPInterfaceIPType": {
            "type": "object",
            "description": "x-displayName: \"Interface IPv4 Assignments\"\nSpecify static IPv4 addresses per node.",
            "title": "Interface IPv4 Assignments",
            "properties": {
                "interface_ip_map": {
                    "type": "object",
                    "description": "x-displayName: \"Site:Node to IPv4 Address Mapping\"\nx-example: \"value\"\nSpecify static IPv4 addresses per site:node.",
        ...
        "network_interfaceDHCPServerParametersType": {
            ...
            "properties": {
                ...
                "fixed_ip_map": {
                    "type": "object",
                    "description": "x-displayName: \"Fixed MAC Address to IPv4 Assignments\"\nx-example: \"value\"\nAssign fixed IPv4 addresses based on the MAC Address of the DHCP Client.",
        ...
        "securemesh_site_v2AWSManagedMode": {
            "type": "object",
        ...
        "securemesh_site_v2AWSManagedNode": {
            "type": "object",
            "description": "This section will show nodes associated with this site.",
            "title": "AWSManagedNode",
            "x-displayname": "Nodes",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AWSManagedNode",
            "properties": {
                "aws_az_name": {
                    "type": "string",
        ...
        "securemesh_site_v2AWSManagedNodeList": {
            "type": "object",
            "description": "This section will show nodes associated with this site.",
            "title": "AWSManagedNodeList",
            "x-displayname": "List of Nodes",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AWSManagedNodeList",
            "properties": {
                "node_list": {
                    "type": "array",
                    "description": " This section will show nodes associated with this site.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 128\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
        ...
        "securemesh_site_v2AWSOrchestratedInterface": {
            "type": "object",
        ...
        "securemesh_site_v2AWSProviderType": {
            ...
            "properties": {
                "managed": {
                    "description": " F5 Distributed Cloud will automate provisioning (ex: node bringup) for this site.",
                    "title": "Managed By F5XC",
                    "$ref": "#/definitions/securemesh_site_v2AWSManagedMode",
                    "x-displayname": "Managed By F5XC"
                },
                "not_managed": {
        ...
        "securemesh_site_v2AzureManagedMode": {
            "type": "object",
            "description": "F5 Distributed Cloud will automate provisioning (ex: node bringup) for this Azure site.",
            "title": "AzureManagedMode",
            "x-displayname": "Managed By F5XC",
            "x-ves-oneof-field-cloud_connect_attachments": "[\"disabled\",\"enabled\"]",
            ...
            "properties": {
                ...
                "azure_cred": {
                    "description": " Reference to Azure credentials for automatic deployment\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Automatic Deployment",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                ...
                "multiple_interface": {
                    ...
                    "$ref": "#/definitions/securemesh_site_v2AzureMultipleInterface",
                ...
                "single_interface": {
                    ...
                    "title": "One Interface",
                    "$ref": "#/definitions/securemesh_site_v2AzureSingleInterface",
        ...
        "securemesh_site_v2AzureManagedNode": {
            "type": "object",
            "description": "This section will show nodes associated with this site.",
            "title": "AzureManagedNode",
            "x-displayname": "Nodes",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AzureManagedNode",
            "properties": {
                "azure_az": {
                    "type": "string",
                ...
                "interface_list": {
                    ...
                    "title": "AzureOrchestratedInterface",
                    "minItems": 1,
                    "maxItems": 2,
                    "items": {
                        "$ref": "#/definitions/securemesh_site_v2AzureOrchestratedInterface"
                    },
                    "x-displayname": "Interfaces",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "securemesh_site_v2AzureManagedNodeList": {
            "type": "object",
            "description": "This section will show nodes associated with this site.",
            "title": "AzureManagedNodeList",
            "x-displayname": "List of Nodes",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AzureManagedNodeList",
            "properties": {
                "node_list": {
                    "type": "array",
                    "description": " This section will show nodes associated with this site.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 128\n  ves.io.schema.rules.repeated.unique: true\n",
                    ...
                    "maxItems": 128,
                    "items": {
                        "$ref": "#/definitions/securemesh_site_v2AzureManagedNode"
                    },
                    "x-displayname": "Nodes",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "securemesh_site_v2AzureMultipleInterface": {
            "type": "object",
            "description": "Multiple interface site is useful when site is used as ingress/egress gateway to the VNET.",
            "title": "Multiple Interface Site",
            "x-displayname": "Multiple Interface",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AzureMultipleInterface",
            "properties": {
                "node_list": {
                    "description": " This section will show nodes associated with this site.",
                    "title": "Nodes",
                    "$ref": "#/definitions/securemesh_site_v2AzureManagedNodeList",
                    "x-displayname": "Nodes"
                }
            }
        },
        "securemesh_site_v2AzureOrchestratedInterface": {
            "type": "object",
            "description": "Interfaces belonging to this node",
            "title": "AzureOrchestratedInterface",
            "x-displayname": "Interfaces",
            "x-ves-oneof-field-site_to_site_connectivity_interface_choice": "[\"site_to_site_connectivity_interface_disabled\",\"site_to_site_connectivity_interface_enabled\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AzureOrchestratedInterface",
            "properties": {
                "mtu": {
                    "type": "integer",
                    "description": " Maximum packet size (Maximum Transfer Unit) of the interface\n When configured, mtu must be between 512 and 8000\n\nExample: - \"1450\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.ranges: 0,512-8000\n",
                ...
                "subnet": {
                    ...
                    "title": "Subnet Choice",
                    "$ref": "#/definitions/viewssecuremesh_site_v2AzureSubnetChoiceType",
        ...
        "securemesh_site_v2AzureProviderType": {
            ...
            "properties": {
                "managed": {
                    "description": " F5 Distributed Cloud will automate provisioning (ex: node bringup) for this site.",
                    "title": "Managed By F5XC",
                    "$ref": "#/definitions/securemesh_site_v2AzureManagedMode",
                    "x-displayname": "Managed By F5XC"
                },
                "not_managed": {
                    "description": "Exclusive with []\n F5 Distributed Cloud will not automate any provisioning (ex: node bringup) for this site.\n Customers will need to do this either via provider specific manual workflows\n or by using automation tools such as Terraform.",
        ...
        "securemesh_site_v2AzureSingleInterface": {
            "type": "object",
            "description": "One interface site is useful when site is only used as ingress gateway to the VNET.",
            "title": "One Interface",
            "x-displayname": "One Interface",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AzureSingleInterface",
            "properties": {
                "node_list": {
                    "description": " This section will show nodes associated with this site.",
                    "title": "Nodes",
        ...
        "securemesh_site_v2CreateRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    ...
                    "title": "spec",
                    "$ref": "#/definitions/viewssecuremesh_site_v2CreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "securemesh_site_v2CreateResponse": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the tenant",
                    "title": "spec",
                    "$ref": "#/definitions/viewssecuremesh_site_v2GetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "securemesh_site_v2CustomProxy": {
            ...
            "properties": {
                "disable_re_tunnel": {
                    "description": "Exclusive with [enable_re_tunnel]\n Do not use the internal Enterprise Proxy for RE Tunnels",
                    "title": "Disable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Disable"
                },
                "enable_re_tunnel": {
                    "description": "Exclusive with [disable_re_tunnel]\n Use the internal Enterprise Proxy for RE Tunnels",
                    "title": "Enable",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Enable"
                },
                "password": {
                    "description": " If the internal Enterprise Proxy is using basic authentication, specify the password. This is an optional field.\n Note: To protect the password, it is recommended to blindfold it.",
                    "title": "Password",
        ...
        "securemesh_site_v2DNSNTPServerConfig": {
            ...
            "properties": {
                "custom_dns": {
                    "description": "Exclusive with [f5_dns_default]\n User specified DNS Servers",
                    "title": "Custom",
                    "$ref": "#/definitions/securemesh_site_v2CustomDNSSettings",
                    "x-displayname": "Custom"
                },
                "custom_ntp": {
                    "description": "Exclusive with [f5_ntp_default]\n User specified NTP Servers",
                    "title": "Custom",
                    "$ref": "#/definitions/securemesh_site_v2CustomNTPSettings",
                    "x-displayname": "Custom"
                },
                "f5_dns_default": {
                    "description": "Exclusive with [custom_dns]\n F5 defaults will use 8.8.8.8, 8.8.4.4",
                    "title": "Default",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Default"
                },
                "f5_ntp_default": {
                    "description": "Exclusive with [custom_ntp]\n F5 default will use time.google.com during registration",
                    "title": "Default",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Default"
                }
        ...
        "securemesh_site_v2GCPCloudSubnetParamType": {
            "type": "object",
            ...
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPCloudSubnetParamType",
            "properties": {
                "autogenerate": {
                    "description": "Exclusive with [name]\n This options auto generates a subnet name for your subnet",
                    "title": "autogenerate",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Autogenerated Subnet Name"
                },
                "ipv4": {
                    "type": "string",
                    "description": " Enter an IPv4 prefix for this subnet. The IP address must be in a private address space.\n\nExample: - \"10.1.0.0/16\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.ipv4_prefix: true\n  ves.io.schema.rules.string.max_ip_prefix_length: 28\n  ves.io.schema.rules.string.min_ip_prefix_length: 8\n",
        ...
        "securemesh_site_v2GCPCloudVPCParamsType": {
            "type": "object",
            "description": "Parameters to create new GCP VPC",
            "title": "GCP VPC Parameters",
            "x-displayname": "GCP VPC Parameters",
            "x-ves-displayorder": "1",
            "x-ves-oneof-field-name_choice": "[\"autogenerate\",\"name_tag\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPCloudVPCParamsType",
            "properties": {
                "autogenerate": {
                    "description": "Exclusive with [name_tag]\n With this option the VPC Name is auto generated by F5 Distributed Cloud",
                    "title": "autogenerate",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "Autogenerated Name"
                },
                "name_tag": {
                    "type": "string",
                    "description": "Exclusive with [autogenerate]\n With this option, user can specify a unique name for VPC.\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 64\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "name_tag",
                    "minLength": 1,
                    "maxLength": 64,
                    "x-displayname": "User Specified Name",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.string.max_len": "64",
                        "ves.io.schema.rules.string.min_len": "1"
                    }
        ...
        "securemesh_site_v2GCPManagedMode": {
            "type": "object",
            "description": "F5 Distributed Cloud will automate all provisioning (ex: node bringup, cloud route table addition) for this site.",
            "title": "GCPManagedMode",
            "x-displayname": "Managed By F5XC",
            "x-ves-oneof-field-private_connectivity_choice": "[\"private_connectivity\",\"private_connectivity_disabled\"]",
            "x-ves-oneof-field-site_type": "[\"multiple_interface\",\"single_interface\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPManagedMode",
            "properties": {
                "disk_size": {
                    "type": "integer",
                    "description": " Select the disk size of the node. The default value is 80GB.\n\nExample: - \"80\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.lte: 64000\n",
                    "title": "Node Disk size",
                    "format": "int64",
                    "x-displayname": "Node Disk Size",
                    "x-ves-example": "80",
                ...
                "gcp_cred": {
                    "description": " Select the GCP cloud credential object using which GCP cloud resources are to be deployed.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Automatic Deployment",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                ...
                "gcp_region": {
                    "type": "string",
                    "description": " Select the GCP Region where you want to deploy F5 Distributed Cloud Customer Edge site.\n\nExample: - \"us-east-1\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "GCP Region",
                ...
                "instance_type": {
                    "type": "string",
                    "description": " Select the GCP instance type for deploying nodes of CE (customer edge) site.\n\nExample: - \"a1.xlarge\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 64\n",
                ...
                "multiple_interface": {
                    ...
                    "title": "Multiple Interface Site",
                    "$ref": "#/definitions/securemesh_site_v2GCPMultipleInterface",
                ...
                "private_connectivity_disabled": {
                    "description": "Exclusive with [private_connectivity]\n This option disables private connectivity for this site.",
                ...
                "single_interface": {
                    ...
                    "title": "One Interface",
                    "$ref": "#/definitions/securemesh_site_v2GCPSingleInterface",
                    "x-displayname": "One Interface"
                },
                "tags": {
                    "type": "object",
                    "description": " GCP Tags is a label consisting of a user-defined key and value.\n It helps to manage, identify, organize, search for, and filter resources in GCP console.\n\nExample: - \"devstaging\"-\n\nValidation Rules:\n  ves.io.schema.rules.map.keys.string.max_len: 127\n  ves.io.schema.rules.map.max_pairs: 40\n  ves.io.schema.rules.map.values.string.max_len: 255\n",
                    "title": "GCP Tags",
        ...
        "securemesh_site_v2GCPManagedNode": {
            "type": "object",
            "description": "This section will show nodes associated with this site.",
            "title": "GCPManagedNode",
            "x-displayname": "Nodes",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPManagedNode",
            "properties": {
                "gcp_az_name": {
                    "type": "string",
                    "description": " Select the GCP availability zone. This must be consistent with the selected GCP region.\n\nExample: - \"us-west-2a\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "GCP AZ",
                ...
                "interface_list": {
                    "type": "array",
                    "description": " Configure Interfaces for this node\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 2\n  ves.io.schema.rules.repeated.min_items: 1\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "GCPOrchestratedInterface",
                    "minItems": 1,
                    "maxItems": 2,
                    "items": {
                        "$ref": "#/definitions/securemesh_site_v2GCPOrchestratedInterface"
                    },
                    "x-displayname": "Interfaces",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "securemesh_site_v2GCPManagedNodeList": {
            "type": "object",
            "description": "This section will show nodes associated with this site.",
            "title": "GCPManagedNodeList",
            "x-displayname": "List of Nodes",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPManagedNodeList",
            "properties": {
                "node_list": {
                    "type": "array",
                    "description": " This section will show nodes associated with this site.\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.repeated.max_items: 128\n  ves.io.schema.rules.repeated.unique: true\n",
                    ...
                    "maxItems": 128,
                    "items": {
                        "$ref": "#/definitions/securemesh_site_v2GCPManagedNode"
                    },
                    "x-displayname": "Nodes",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
        ...
        "securemesh_site_v2GCPMultipleInterface": {
            "type": "object",
            "description": "This option deploys the CE (Customer Edge) Site as an ingress/egress gateway.",
            "title": "Multiple Interface Site",
            "x-displayname": "Multiple Interfaces",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPMultipleInterface",
            "properties": {
                "node_list": {
                    "description": " This section will show nodes associated with this site.",
                    "title": "Nodes",
                    "$ref": "#/definitions/securemesh_site_v2GCPManagedNodeList",
                    "x-displayname": "Nodes"
                }
            }
        },
        "securemesh_site_v2GCPOrchestratedInterface": {
            "type": "object",
            "description": "Interfaces belonging to this node",
            "title": "GCPOrchestratedInterface",
            "x-displayname": "Interfaces",
            "x-ves-oneof-field-site_to_site_connectivity_interface_choice": "[\"site_to_site_connectivity_interface_disabled\",\"site_to_site_connectivity_interface_enabled\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPOrchestratedInterface",
            "properties": {
                "mtu": {
                    "type": "integer",
                    "description": " Maximum packet size (Maximum Transfer Unit) of the interface\n When configured, mtu must be between 512 and 8000\n\nExample: - \"1450\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.ranges: 0,512-8000\n",
                ...
                "subnet": {
                    "description": " Provide Subnet details. User can either create a new subnet or use an existing subnet.",
                    "title": "Subnet Choice",
                    "$ref": "#/definitions/securemesh_site_v2GCPSubnetChoiceType",
                    "x-displayname": "Subnet Parameters"
                },
                "vpc": {
                    "description": " Provide VPC details. User can either create a new VPC or use an existing VPC",
                    "title": "VPC Choice",
                    "$ref": "#/definitions/securemesh_site_v2GCPVPCChoiceType",
        ...
        "securemesh_site_v2GCPProviderType": {
            ...
            "properties": {
                "managed": {
                    "description": " F5 Distributed Cloud will automate provisioning (ex: node bringup) for this site.",
                    "title": "Managed By F5XC",
                    "$ref": "#/definitions/securemesh_site_v2GCPManagedMode",
                    "x-displayname": "Managed By F5XC"
                },
                "not_managed": {
                    "description": "Exclusive with []\n F5 Distributed Cloud will not automate any provisioning (ex: node bringup) for this site.\n Customers will need to do this either via provider specific manual workflows\n or by using automation tools such as Terraform.",
        ...
        "securemesh_site_v2GCPSingleInterface": {
            "type": "object",
            "description": "This option deploys the CE (Customer Edge) Site as an ingress gateway.",
            "title": "One Interface",
            "x-displayname": "One Interface",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPSingleInterface",
            "properties": {
                "node_list": {
                    "description": " This section will show nodes associated with this site",
                    "title": "Nodes",
        ...
        "securemesh_site_v2GCPSubnetChoiceType": {
            "type": "object",
            "description": "Parameters for subnet",
            "title": "GCP Subnet",
            "x-displayname": "GCP Subnet",
            "x-ves-oneof-field-choice": "[\"existing_subnet_id\",\"subnet_param\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPSubnetChoiceType",
            "properties": {
                "existing_subnet_id": {
                    "type": "string",
                    "description": "Exclusive with [subnet_param]\n Select this option when you want to use an existing subnet\n\nExample: - \"subnet-12345678901234567\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 64\n  ves.io.schema.rules.string.min_len: 1\n",
                ...
                "subnet_param": {
                    ...
                    "title": "New Subnet",
                    "$ref": "#/definitions/securemesh_site_v2GCPCloudSubnetParamType",
                    "x-displayname": "New Subnet"
                }
            }
        },
        "securemesh_site_v2GCPVPCChoiceType": {
            "type": "object",
            "description": "Parameters for VPC",
            "title": "GCP VPC",
            "x-displayname": "GCP VPC",
            "x-ves-oneof-field-service_vpc_choice": "[\"existing_vpc_id\",\"new_vpc\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.GCPVPCChoiceType",
            "properties": {
                "existing_vpc_id": {
                    "type": "string",
                    "description": "Exclusive with [new_vpc]\n Select this option when you want to use an existing VPC.\n\nExample: - \"inside-12345678901234567\"-\n\nValidation Rules:\n  ves.io.schema.rules.string.max_len: 64\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "Existing VPC ID",
                    "minLength": 1,
                    "maxLength": 64,
                    "x-displayname": "Existing VPC ID",
                    "x-ves-example": "inside-12345678901234567",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.string.max_len": "64",
                        "ves.io.schema.rules.string.min_len": "1"
                    }
                ...
                "new_vpc": {
                    "description": "Exclusive with [existing_vpc_id]\n Select this option when you want a new VPC to be created.",
                    "title": "New VPC",
                    "$ref": "#/definitions/securemesh_site_v2GCPCloudVPCParamsType",
        ...
        "securemesh_site_v2GetResponseFormatCode": {
            "type": "string",
        ...
        "securemesh_site_v2Interface": {
            ...
            "properties": {
                ...
                "static_ip": {
                    "description": "Exclusive with [dhcp_client no_ipv4_address]\n Interface IP address is configured statically.",
                    "title": "Static IP",
                    "$ref": "#/definitions/network_interfaceStaticIpParametersNodeType",
        ...
        "securemesh_site_v2ListResponse": {
            ...
            "properties": {
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/securemesh_site_v2ListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        ...
        "securemesh_site_v2RSeriesProviderType": {
            "type": "object",
            "description": "x-displayName: \"RSeries Provider Type\"\nRSeries Provider Type",
        ...
        "securemesh_site_v2ReplaceRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the tenant",
                    "title": "spec",
                    "$ref": "#/definitions/viewssecuremesh_site_v2ReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        ...
        "viewssecuremesh_site_v2AzureSubnetChoiceType": {
            "type": "object",
            "description": "Parameters for Azure subnet",
            "title": "Azure Cloud Subnet",
            "x-displayname": "Azure Subnet",
            "x-ves-oneof-field-choice": "[\"existing_subnet\",\"subnet_param\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AzureSubnetChoiceType",
            "properties": {
                "existing_subnet": {
                    "description": "Exclusive with [subnet_param]\n Information about existing subnet.\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Existing Subnet",
                    "$ref": "#/definitions/viewssecuremesh_site_v2AzureSubnetType",
                ...
                "subnet_param": {
                    ...
                    "title": "New Subnet",
                    "$ref": "#/definitions/viewssecuremesh_site_v2CloudSubnetParamType",
                    "x-displayname": "New Subnet",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
        ...
        "viewssecuremesh_site_v2AzureSubnetType": {
            "type": "object",
            "description": "Parameters for Azure subnet",
            "title": "Azure Cloud Subnet",
            "x-displayname": "Azure Subnet",
            "x-ves-displayorder": "3,1",
            "x-ves-oneof-field-resource_group_choice": "[\"vnet_resource_group\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.AzureSubnetType",
            "properties": {
                "subnet_name": {
                    "type": "string",
        ...
        "viewssecuremesh_site_v2CloudSubnetParamType": {
            "type": "object",
            "description": "Parameters for creating a new cloud subnet",
            "title": "Cloud Subnet Param",
            "x-displayname": "New Cloud Subnet Parameters",
            ...
            "x-ves-oneof-field-name_choice": "[\"autogenerate\",\"name\"]",
            "x-ves-proto-message": "ves.io.schema.views.securemesh_site_v2.CloudSubnetParamType",
            "properties": {
                "autogenerate": {
        ...
        "viewssecuremesh_site_v2CreateSpecType": {
            ...
            "x-ves-oneof-field-provider_choice": "[\"aws\",\"azure\",\"baremetal\",\"eks_k8s\",\"equinix\",\"gcp\",\"kvm\",\"nutanix\",\"oci\",\"openshift_virtualization\",\"openstack\",\"vmware\"]",
            ...
            "properties": {
                ...
                "aws": {
                    "description": "Exclusive with [azure baremetal eks_k8s equinix gcp kvm nutanix oci openshift_virtualization openstack vmware]\n",
                    "$ref": "#/definitions/securemesh_site_v2AWSProviderType",
                    "x-displayname": "AWS"
                },
                "azure": {
                    "description": "Exclusive with [aws baremetal eks_k8s equinix gcp kvm nutanix oci openshift_virtualization openstack vmware]\n",
                    "$ref": "#/definitions/securemesh_site_v2AzureProviderType",
                    "x-displayname": "Azure"
                },
                "baremetal": {
                    "description": "Exclusive with [aws azure eks_k8s equinix gcp kvm nutanix oci openshift_virtualization openstack vmware]\n",
                ...
                "custom_proxy_bypass": {
                    "description": "Exclusive with [no_proxy_bypass]\n User specified domains will bypass the proxy",
                    "$ref": "#/definitions/securemesh_site_v2CustomProxyBypassSettings",
                    "x-displayname": "Custom"
                },
                ...
                "equinix": {
                    "description": "Exclusive with [aws azure baremetal eks_k8s gcp kvm nutanix oci openshift_virtualization openstack vmware]\n",
                ...
                "gcp": {
                    "description": "Exclusive with [aws azure baremetal eks_k8s equinix kvm nutanix oci openshift_virtualization openstack vmware]\n",
                    "$ref": "#/definitions/securemesh_site_v2GCPProviderType",
                    "x-displayname": "GCP"
                },
                "kvm": {
                    "description": "Exclusive with [aws azure baremetal eks_k8s equinix gcp nutanix oci openshift_virtualization openstack vmware]\n",
                ...
                "no_proxy_bypass": {
                    "description": "Exclusive with [custom_proxy_bypass]\n No domains will bypass the proxy",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "None"
                },
                ...
                "nutanix": {
                    "description": "Exclusive with [aws azure baremetal eks_k8s equinix gcp kvm oci openshift_virtualization openstack vmware]\n",
                    "$ref": "#/definitions/securemesh_site_v2NutanixProviderType",
                    "x-displayname": "Nutanix"
                },
                "oci": {
                    "description": "Exclusive with [aws azure baremetal eks_k8s equinix gcp kvm nutanix openshift_virtualization openstack vmware]\n",
                ...
                "openshift_virtualization": {
                    "description": "Exclusive with [aws azure baremetal eks_k8s equinix gcp kvm nutanix oci openstack vmware]\n",
                    "$ref": "#/definitions/securemesh_site_v2OpenShiftProviderType",
                    "x-displayname": "OpenShift Virtualization"
                },
                "openstack": {
                    "description": "Exclusive with [aws azure baremetal eks_k8s equinix gcp kvm nutanix oci openshift_virtualization vmware]\n",
                ...
                "vmware": {
                    "description": "Exclusive with [aws azure baremetal eks_k8s equinix gcp kvm nutanix oci openshift_virtualization openstack]\n",
    ...
    "x-displayname": "Configure Secure Mesh Site",
    "x-ves-proto-file": "ves.io/schema/views/securemesh_site_v2/public_crudapi.proto"
}`
