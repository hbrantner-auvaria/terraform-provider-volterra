...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/views/api_inventory"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.api_inventory.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.api_inventory.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.api_inventory.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.api_inventory.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_inventory.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.api_inventory.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_inventory.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.api_inventory.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_inventory.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_inventory.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.api_inventory.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.api_inventory.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/api_inventory/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.api_inventory/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_inventory-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_inventory.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_inventory-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_inventory.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_inventory-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_inventory.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_inventory",
            "x-ves-object-type": "ves.io.schema.views.api_inventory.Object",
            "x-ves-proto-service": "ves.io.schema.views.api_inventory.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.api_inventory/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_inventory-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_inventory.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_inventory-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_inventory.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_inventory",
            "x-ves-object-type": "ves.io.schema.views.api_inventory.Object",
        ...
        "/ves.io.schema.views.api_inventory/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-api_inventory-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.api_inventory.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_inventory",
            "x-ves-object-type": "ves.io.schema.views.api_inventory.Object",
        ...
        "/ves.io.schema.views.api_inventory/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.api_inventory/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.api_inventory/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.api_inventory/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.api_inventory.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "api_inventoryStatusObject": {
            ...
            "x-ves-proto-message": "ves.io.schema.views.api_inventory.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_inventory.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_inventorycrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_inventory.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_inventorycrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_inventory.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api_inventoryStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_inventory.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_inventorycrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_inventory.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_inventory.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.api_inventory.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_inventorycrudapiErrorCode"
                },
        ...
        "viewsapi_inventoryGlobalSpecType": {
            "type": "object",
    ...
    "x-ves-proto-file": "ves.io/schema/views/api_inventory/crudapi/api.proto"
}`
