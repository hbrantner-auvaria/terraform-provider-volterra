...
func (m *AWSVPCIngressGwReplaceType) GetAzNodes() []*views.AWSVPCOneInterfaceNodeType {
	if m != nil {
		return m.AzNodes
	}
	return nil
...
func (m *AWSVPCIngressEgressGwReplaceType) GetAzNodes() []*views.AWSVPCTwoInterfaceNodeType {
	if m != nil {
		return m.AzNodes
	}
	return nil
...
type AWSVPCVoltstackClusterReplaceType struct {
	...
	//
	// Types that are valid to be assigned to K8SClusterChoice:
	//	*AWSVPCVoltstackClusterReplaceType_NoK8SCluster
	//	*AWSVPCVoltstackClusterReplaceType_K8SCluster
	K8SClusterChoice isAWSVPCVoltstackClusterReplaceType_K8SClusterChoice `protobuf_oneof:"k8s_cluster_choice"`
}
...
type isAWSVPCVoltstackClusterReplaceType_K8SClusterChoice interface {
	isAWSVPCVoltstackClusterReplaceType_K8SClusterChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type AWSVPCVoltstackClusterReplaceType_NoK8SCluster struct {
	NoK8SCluster *schema.Empty `protobuf:"bytes,26,opt,name=no_k8s_cluster,json=noK8sCluster,proto3,oneof" json:"no_k8s_cluster,omitempty"`
}
type AWSVPCVoltstackClusterReplaceType_K8SCluster struct {
	K8SCluster *views.ObjectRefType `protobuf:"bytes,27,opt,name=k8s_cluster,json=k8sCluster,proto3,oneof" json:"k8s_cluster,omitempty"`
}
...
func (*AWSVPCVoltstackClusterReplaceType_NoK8SCluster) isAWSVPCVoltstackClusterReplaceType_K8SClusterChoice() {
}
func (*AWSVPCVoltstackClusterReplaceType_K8SCluster) isAWSVPCVoltstackClusterReplaceType_K8SClusterChoice() {
}
...
func (m *AWSVPCVoltstackClusterReplaceType) GetK8SClusterChoice() isAWSVPCVoltstackClusterReplaceType_K8SClusterChoice {
	if m != nil {
		return m.K8SClusterChoice
	}
	return nil
...
func (m *AWSVPCVoltstackClusterReplaceType) GetAzNodes() []*views.AWSVPCOneInterfaceNodeType {
	if m != nil {
		return m.AzNodes
	}
	return nil
...
func (m *AWSVPCVoltstackClusterReplaceType) GetNoK8SCluster() *schema.Empty {
	if x, ok := m.GetK8SClusterChoice().(*AWSVPCVoltstackClusterReplaceType_NoK8SCluster); ok {
		return x.NoK8SCluster
	}
	return nil
}

func (m *AWSVPCVoltstackClusterReplaceType) GetK8SCluster() *views.ObjectRefType {
	if x, ok := m.GetK8SClusterChoice().(*AWSVPCVoltstackClusterReplaceType_K8SCluster); ok {
		return x.K8SCluster
	}
	return nil
}
...
func (*AWSVPCVoltstackClusterReplaceType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*AWSVPCVoltstackClusterReplaceType_NoK8SCluster)(nil),
		(*AWSVPCVoltstackClusterReplaceType_K8SCluster)(nil),
	}
}
...
type GlobalSpecType struct {
	...
	// Option to encrypt the node disk with CMK. Defaults to disable encryption
	//
	// Types that are valid to be assigned to EncryptionChoice:
	//	*GlobalSpecType_DisableEncryption
	//	*GlobalSpecType_EnableEncryption
	EncryptionChoice isGlobalSpecType_EncryptionChoice `protobuf_oneof:"encryption_choice"`
	// Public SSH key
	//
	...
	WafSignatures *common_waf.LiveSignaturesUpdate `protobuf:"bytes,66,opt,name=waf_signatures,json=wafSignatures,proto3" json:"waf_signatures,omitempty"`
	// AWS Tags
	//
	...
	KubernetesUpgradeDrain *views.KubernetesUpgradeDrain `protobuf:"bytes,58,opt,name=kubernetes_upgrade_drain,json=kubernetesUpgradeDrain,proto3" json:"kubernetes_upgrade_drain,omitempty"`
	...
	// Choice of Routing
	//
	// x-displayName: "Orchestrate VPC/VNET Routing"
	// x-required
	// This is choice of F5 Orchestrated Routing or Manual Routing for CE VPC/VNET
	//
	// Types that are valid to be assigned to RoutingType:
	//	*GlobalSpecType_F5OrchestratedRouting
	//	*GlobalSpecType_ManualRouting
	RoutingType isGlobalSpecType_RoutingType `protobuf_oneof:"routing_type"`
}
...
type isGlobalSpecType_EncryptionChoice interface {
	isGlobalSpecType_EncryptionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type isGlobalSpecType_RoutingType interface {
	isGlobalSpecType_RoutingType()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GlobalSpecType_DisableEncryption struct {
	DisableEncryption *schema.Empty `protobuf:"bytes,64,opt,name=disable_encryption,json=disableEncryption,proto3,oneof" json:"disable_encryption,omitempty"`
}
type GlobalSpecType_EnableEncryption struct {
	EnableEncryption *views.AWSDiskEncryption `protobuf:"bytes,65,opt,name=enable_encryption,json=enableEncryption,proto3,oneof" json:"enable_encryption,omitempty"`
}
...
type GlobalSpecType_F5OrchestratedRouting struct {
	F5OrchestratedRouting *schema.Empty `protobuf:"bytes,61,opt,name=f5_orchestrated_routing,json=f5OrchestratedRouting,proto3,oneof" json:"f5_orchestrated_routing,omitempty"`
}
type GlobalSpecType_ManualRouting struct {
	ManualRouting *schema.Empty `protobuf:"bytes,62,opt,name=manual_routing,json=manualRouting,proto3,oneof" json:"manual_routing,omitempty"`
}
...
func (*GlobalSpecType_DisableEncryption) isGlobalSpecType_EncryptionChoice()              {}
func (*GlobalSpecType_EnableEncryption) isGlobalSpecType_EncryptionChoice()               {}
...
func (*GlobalSpecType_F5OrchestratedRouting) isGlobalSpecType_RoutingType()               {}
func (*GlobalSpecType_ManualRouting) isGlobalSpecType_RoutingType()                       {}
...
func (m *GlobalSpecType) GetEncryptionChoice() isGlobalSpecType_EncryptionChoice {
	if m != nil {
		return m.EncryptionChoice
	}
	return nil
}
...
func (m *GlobalSpecType) GetRoutingType() isGlobalSpecType_RoutingType {
	if m != nil {
...
func (m *GlobalSpecType) GetDisableEncryption() *schema.Empty {
	if x, ok := m.GetEncryptionChoice().(*GlobalSpecType_DisableEncryption); ok {
		return x.DisableEncryption
	}
	return nil
}

func (m *GlobalSpecType) GetEnableEncryption() *views.AWSDiskEncryption {
	if x, ok := m.GetEncryptionChoice().(*GlobalSpecType_EnableEncryption); ok {
...
func (m *GlobalSpecType) GetWafSignatures() *common_waf.LiveSignaturesUpdate {
	if m != nil {
		return m.WafSignatures
	}
	return nil
}
...
func (m *GlobalSpecType) GetF5OrchestratedRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*GlobalSpecType_F5OrchestratedRouting); ok {
		return x.F5OrchestratedRouting
	}
	return nil
}

func (m *GlobalSpecType) GetManualRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*GlobalSpecType_ManualRouting); ok {
...
func (*GlobalSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GlobalSpecType_DisableEncryption)(nil),
		(*GlobalSpecType_EnableEncryption)(nil),
		...
		(*GlobalSpecType_F5OrchestratedRouting)(nil),
		(*GlobalSpecType_ManualRouting)(nil),
	}
}
...
type CreateSpecType struct {
	...
	DiskSize     uint32                      `protobuf:"varint,15,opt,name=disk_size,json=diskSize,proto3" json:"disk_size,omitempty"`
	// Types that are valid to be assigned to EncryptionChoice:
	//	*CreateSpecType_DisableEncryption
	//	*CreateSpecType_EnableEncryption
	EncryptionChoice isCreateSpecType_EncryptionChoice `protobuf_oneof:"encryption_choice"`
	AwsRegion        string                            `protobuf:"bytes,12,opt,name=aws_region,json=awsRegion,proto3" json:"aws_region,omitempty"`
	SshKey           string                            `protobuf:"bytes,13,opt,name=ssh_key,json=sshKey,proto3" json:"ssh_key,omitempty"`
	AdminPassword    *schema.SecretType                `protobuf:"bytes,59,opt,name=admin_password,json=adminPassword,proto3" json:"admin_password,omitempty"`
	Address          string                            `protobuf:"bytes,17,opt,name=address,proto3" json:"address,omitempty"`
	...
	// Types that are valid to be assigned to RoutingType:
	//	*CreateSpecType_F5OrchestratedRouting
	//	*CreateSpecType_ManualRouting
	RoutingType isCreateSpecType_RoutingType `protobuf_oneof:"routing_type"`
	// custom_dns
	//
	// x-displayName: "Custom DNS"
	// custom dns configure to the CE site
...
type isCreateSpecType_EncryptionChoice interface {
	isCreateSpecType_EncryptionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type isCreateSpecType_RoutingType interface {
	isCreateSpecType_RoutingType()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type CreateSpecType_DisableEncryption struct {
	DisableEncryption *schema.Empty `protobuf:"bytes,64,opt,name=disable_encryption,json=disableEncryption,proto3,oneof" json:"disable_encryption,omitempty"`
}
type CreateSpecType_EnableEncryption struct {
	EnableEncryption *views.AWSDiskEncryption `protobuf:"bytes,65,opt,name=enable_encryption,json=enableEncryption,proto3,oneof" json:"enable_encryption,omitempty"`
}
...
type CreateSpecType_F5OrchestratedRouting struct {
	F5OrchestratedRouting *schema.Empty `protobuf:"bytes,61,opt,name=f5_orchestrated_routing,json=f5OrchestratedRouting,proto3,oneof" json:"f5_orchestrated_routing,omitempty"`
}
type CreateSpecType_ManualRouting struct {
	ManualRouting *schema.Empty `protobuf:"bytes,62,opt,name=manual_routing,json=manualRouting,proto3,oneof" json:"manual_routing,omitempty"`
}
...
func (*CreateSpecType_DisableEncryption) isCreateSpecType_EncryptionChoice()              {}
func (*CreateSpecType_EnableEncryption) isCreateSpecType_EncryptionChoice()               {}
...
func (*CreateSpecType_F5OrchestratedRouting) isCreateSpecType_RoutingType()               {}
func (*CreateSpecType_ManualRouting) isCreateSpecType_RoutingType()                       {}
...
func (m *CreateSpecType) GetEncryptionChoice() isCreateSpecType_EncryptionChoice {
	if m != nil {
		return m.EncryptionChoice
	}
	return nil
...
func (m *CreateSpecType) GetRoutingType() isCreateSpecType_RoutingType {
	if m != nil {
		return m.RoutingType
	}
	return nil
...
func (m *CreateSpecType) GetDisableEncryption() *schema.Empty {
	if x, ok := m.GetEncryptionChoice().(*CreateSpecType_DisableEncryption); ok {
		return x.DisableEncryption
	}
	return nil
}

func (m *CreateSpecType) GetEnableEncryption() *views.AWSDiskEncryption {
	if x, ok := m.GetEncryptionChoice().(*CreateSpecType_EnableEncryption); ok {
		return x.EnableEncryption
	}
	return nil
}
...
func (m *CreateSpecType) GetWafSignatures() *common_waf.LiveSignaturesUpdate {
	if m != nil {
		return m.WafSignatures
	}
	return nil
...
func (m *CreateSpecType) GetF5OrchestratedRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*CreateSpecType_F5OrchestratedRouting); ok {
		return x.F5OrchestratedRouting
	}
	return nil
}

func (m *CreateSpecType) GetManualRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*CreateSpecType_ManualRouting); ok {
		return x.ManualRouting
	}
	return nil
}
...
func (*CreateSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*CreateSpecType_DisableEncryption)(nil),
		(*CreateSpecType_EnableEncryption)(nil),
		...
		(*CreateSpecType_F5OrchestratedRouting)(nil),
		(*CreateSpecType_ManualRouting)(nil),
	}
}
...
type ReplaceSpecType struct {
	...
	// Types that are valid to be assigned to EgressGatewayChoice:
	//	*ReplaceSpecType_EgressGatewayDefault
	//	*ReplaceSpecType_EgressNatGw
	//	*ReplaceSpecType_EgressVirtualPrivateGateway
	EgressGatewayChoice isReplaceSpecType_EgressGatewayChoice `protobuf_oneof:"egress_gateway_choice"`
	// Types that are valid to be assigned to SecurityGroupChoice:
	//	*ReplaceSpecType_F5XcSecurityGroup
	//	*ReplaceSpecType_CustomSecurityGroup
	SecurityGroupChoice isReplaceSpecType_SecurityGroupChoice `protobuf_oneof:"security_group_choice"`
	// custom_dns
	//
	// x-displayName: "Custom DNS"
	// custom dns configure to the CE site
...
type isReplaceSpecType_EgressGatewayChoice interface {
	isReplaceSpecType_EgressGatewayChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
type isReplaceSpecType_SecurityGroupChoice interface {
...
type ReplaceSpecType_EgressGatewayDefault struct {
	EgressGatewayDefault *schema.Empty `protobuf:"bytes,46,opt,name=egress_gateway_default,json=egressGatewayDefault,proto3,oneof" json:"egress_gateway_default,omitempty"`
}
type ReplaceSpecType_EgressNatGw struct {
	EgressNatGw *views.AWSNATGatewaychoiceType `protobuf:"bytes,47,opt,name=egress_nat_gw,json=egressNatGw,proto3,oneof" json:"egress_nat_gw,omitempty"`
}
type ReplaceSpecType_EgressVirtualPrivateGateway struct {
	EgressVirtualPrivateGateway *views.AWSVirtualPrivateGatewaychoiceType `protobuf:"bytes,48,opt,name=egress_virtual_private_gateway,json=egressVirtualPrivateGateway,proto3,oneof" json:"egress_virtual_private_gateway,omitempty"`
}
type ReplaceSpecType_F5XcSecurityGroup struct {
	F5XcSecurityGroup *schema.Empty `protobuf:"bytes,52,opt,name=f5xc_security_group,json=f5xcSecurityGroup,proto3,oneof" json:"f5xc_security_group,omitempty"`
}
type ReplaceSpecType_CustomSecurityGroup struct {
	CustomSecurityGroup *views.SecurityGroupType `protobuf:"bytes,53,opt,name=custom_security_group,json=customSecurityGroup,proto3,oneof" json:"custom_security_group,omitempty"`
}
...
func (*ReplaceSpecType_EgressGatewayDefault) isReplaceSpecType_EgressGatewayChoice()        {}
func (*ReplaceSpecType_EgressNatGw) isReplaceSpecType_EgressGatewayChoice()                 {}
func (*ReplaceSpecType_EgressVirtualPrivateGateway) isReplaceSpecType_EgressGatewayChoice() {}
func (*ReplaceSpecType_F5XcSecurityGroup) isReplaceSpecType_SecurityGroupChoice()           {}
func (*ReplaceSpecType_CustomSecurityGroup) isReplaceSpecType_SecurityGroupChoice()         {}
...
func (m *ReplaceSpecType) GetEgressGatewayChoice() isReplaceSpecType_EgressGatewayChoice {
	if m != nil {
		return m.EgressGatewayChoice
	}
	return nil
}
func (m *ReplaceSpecType) GetSecurityGroupChoice() isReplaceSpecType_SecurityGroupChoice {
	if m != nil {
		return m.SecurityGroupChoice
	}
	return nil
...
func (m *ReplaceSpecType) GetVpc() *views.AWSVPCchoiceType {
	if m != nil {
		return m.Vpc
	}
	return nil
...
func (m *ReplaceSpecType) GetAwsRegion() string {
	if m != nil {
		return m.AwsRegion
	}
	return ""
...
func (m *ReplaceSpecType) GetEgressGatewayDefault() *schema.Empty {
	if x, ok := m.GetEgressGatewayChoice().(*ReplaceSpecType_EgressGatewayDefault); ok {
		return x.EgressGatewayDefault
	}
	return nil
}

func (m *ReplaceSpecType) GetEgressNatGw() *views.AWSNATGatewaychoiceType {
	if x, ok := m.GetEgressGatewayChoice().(*ReplaceSpecType_EgressNatGw); ok {
		return x.EgressNatGw
	}
	return nil
}

func (m *ReplaceSpecType) GetEgressVirtualPrivateGateway() *views.AWSVirtualPrivateGatewaychoiceType {
	if x, ok := m.GetEgressGatewayChoice().(*ReplaceSpecType_EgressVirtualPrivateGateway); ok {
		return x.EgressVirtualPrivateGateway
	}
	return nil
}

func (m *ReplaceSpecType) GetF5XcSecurityGroup() *schema.Empty {
	if x, ok := m.GetSecurityGroupChoice().(*ReplaceSpecType_F5XcSecurityGroup); ok {
		return x.F5XcSecurityGroup
	}
	return nil
}

func (m *ReplaceSpecType) GetCustomSecurityGroup() *views.SecurityGroupType {
	if x, ok := m.GetSecurityGroupChoice().(*ReplaceSpecType_CustomSecurityGroup); ok {
		return x.CustomSecurityGroup
	}
	return nil
}
...
func (m *ReplaceSpecType) GetWafSignatures() *common_waf.LiveSignaturesUpdate {
	if m != nil {
		return m.WafSignatures
	}
	return nil
...
func (*ReplaceSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ReplaceSpecType_EgressGatewayDefault)(nil),
		(*ReplaceSpecType_EgressNatGw)(nil),
		(*ReplaceSpecType_EgressVirtualPrivateGateway)(nil),
		(*ReplaceSpecType_F5XcSecurityGroup)(nil),
		(*ReplaceSpecType_CustomSecurityGroup)(nil),
	}
}
...
type GetSpecType struct {
	...
	DiskSize     uint32                   `protobuf:"varint,15,opt,name=disk_size,json=diskSize,proto3" json:"disk_size,omitempty"`
	// Types that are valid to be assigned to EncryptionChoice:
	//	*GetSpecType_DisableEncryption
	//	*GetSpecType_EnableEncryption
	EncryptionChoice        isGetSpecType_EncryptionChoice `protobuf_oneof:"encryption_choice"`
	VolterraSoftwareVersion string                         `protobuf:"bytes,8,opt,name=volterra_software_version,json=volterraSoftwareVersion,proto3" json:"volterra_software_version,omitempty"`
	OperatingSystemVersion  string                         `protobuf:"bytes,9,opt,name=operating_system_version,json=operatingSystemVersion,proto3" json:"operating_system_version,omitempty"`
	AwsRegion               string                         `protobuf:"bytes,12,opt,name=aws_region,json=awsRegion,proto3" json:"aws_region,omitempty"`
	SshKey                  string                         `protobuf:"bytes,13,opt,name=ssh_key,json=sshKey,proto3" json:"ssh_key,omitempty"`
	...
	// Types that are valid to be assigned to RoutingType:
	//	*GetSpecType_F5OrchestratedRouting
	//	*GetSpecType_ManualRouting
	RoutingType     isGetSpecType_RoutingType   `protobuf_oneof:"routing_type"`
	SiteErrors      []*views.SiteError          `protobuf:"bytes,55,rep,name=site_errors,json=siteErrors,proto3" json:"site_errors,omitempty"`
	ValidationState views.ConfigValidationState `protobuf:"varint,56,opt,name=validation_state,json=validationState,proto3,enum=ves.io.schema.views.ConfigValidationState" json:"validation_state,omitempty"`
	// custom_dns
	//
...
type isGetSpecType_EncryptionChoice interface {
	isGetSpecType_EncryptionChoice()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type isGetSpecType_RoutingType interface {
	isGetSpecType_RoutingType()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type GetSpecType_DisableEncryption struct {
	DisableEncryption *schema.Empty `protobuf:"bytes,64,opt,name=disable_encryption,json=disableEncryption,proto3,oneof" json:"disable_encryption,omitempty"`
}
type GetSpecType_EnableEncryption struct {
	EnableEncryption *views.AWSDiskEncryption `protobuf:"bytes,65,opt,name=enable_encryption,json=enableEncryption,proto3,oneof" json:"enable_encryption,omitempty"`
}
...
type GetSpecType_F5OrchestratedRouting struct {
	F5OrchestratedRouting *schema.Empty `protobuf:"bytes,61,opt,name=f5_orchestrated_routing,json=f5OrchestratedRouting,proto3,oneof" json:"f5_orchestrated_routing,omitempty"`
}
type GetSpecType_ManualRouting struct {
	ManualRouting *schema.Empty `protobuf:"bytes,62,opt,name=manual_routing,json=manualRouting,proto3,oneof" json:"manual_routing,omitempty"`
}
...
func (*GetSpecType_DisableEncryption) isGetSpecType_EncryptionChoice()              {}
func (*GetSpecType_EnableEncryption) isGetSpecType_EncryptionChoice()               {}
...
func (*GetSpecType_F5OrchestratedRouting) isGetSpecType_RoutingType()               {}
func (*GetSpecType_ManualRouting) isGetSpecType_RoutingType()                       {}
...
func (m *GetSpecType) GetEncryptionChoice() isGetSpecType_EncryptionChoice {
	if m != nil {
		return m.EncryptionChoice
	}
	return nil
...
func (m *GetSpecType) GetRoutingType() isGetSpecType_RoutingType {
	if m != nil {
		return m.RoutingType
	}
	return nil
...
func (m *GetSpecType) GetDisableEncryption() *schema.Empty {
	if x, ok := m.GetEncryptionChoice().(*GetSpecType_DisableEncryption); ok {
		return x.DisableEncryption
	}
	return nil
}

func (m *GetSpecType) GetEnableEncryption() *views.AWSDiskEncryption {
	if x, ok := m.GetEncryptionChoice().(*GetSpecType_EnableEncryption); ok {
		return x.EnableEncryption
	}
	return nil
}
...
func (m *GetSpecType) GetF5OrchestratedRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*GetSpecType_F5OrchestratedRouting); ok {
		return x.F5OrchestratedRouting
	}
	return nil
}

func (m *GetSpecType) GetManualRouting() *schema.Empty {
	if x, ok := m.GetRoutingType().(*GetSpecType_ManualRouting); ok {
		return x.ManualRouting
	}
	return nil
}
...
func (m *GetSpecType) GetWafSignatures() *common_waf.LiveSignaturesUpdate {
	if m != nil {
		return m.WafSignatures
	}
	return nil
...
func (*GetSpecType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GetSpecType_DisableEncryption)(nil),
		(*GetSpecType_EnableEncryption)(nil),
		...
		(*GetSpecType_F5OrchestratedRouting)(nil),
		(*GetSpecType_ManualRouting)(nil),
	}
}
...
var fileDescriptor_ea70a88e595e3c7c = []byte{
	...
	,
}
...
func (this *AWSVPCVoltstackClusterReplaceType_NoK8SCluster) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AWSVPCVoltstackClusterReplaceType_NoK8SCluster)
	if !ok {
		that2, ok := that.(AWSVPCVoltstackClusterReplaceType_NoK8SCluster)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AWSVPCVoltstackClusterReplaceType_K8SCluster) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AWSVPCVoltstackClusterReplaceType_K8SCluster)
	if !ok {
		that2, ok := that.(AWSVPCVoltstackClusterReplaceType_K8SCluster)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GlobalSpecType) Equal(that interface{}) bool {
	...
	if that1.EncryptionChoice == nil {
		if this.EncryptionChoice != nil {
			return false
		}
	} else if this.EncryptionChoice == nil {
		return false
	} else if !this.EncryptionChoice.Equal(that1.EncryptionChoice) {
		return false
	}
	...
	if !this.WafSignatures.Equal(that1.WafSignatures) {
		return false
	}
	...
	if that1.RoutingType == nil {
		if this.RoutingType != nil {
			return false
		}
	} else if this.RoutingType == nil {
		return false
	} else if !this.RoutingType.Equal(that1.RoutingType) {
		return false
	}
	return true
}
...
func (this *GlobalSpecType_DisableEncryption) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_DisableEncryption)
	if !ok {
		that2, ok := that.(GlobalSpecType_DisableEncryption)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DisableEncryption.Equal(that1.DisableEncryption) {
		return false
	}
	return true
}
func (this *GlobalSpecType_EnableEncryption) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_EnableEncryption)
	if !ok {
		that2, ok := that.(GlobalSpecType_EnableEncryption)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.EnableEncryption.Equal(that1.EnableEncryption) {
		return false
	}
	return true
}
...
func (this *GlobalSpecType_F5OrchestratedRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_F5OrchestratedRouting)
	if !ok {
		that2, ok := that.(GlobalSpecType_F5OrchestratedRouting)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.F5OrchestratedRouting.Equal(that1.F5OrchestratedRouting) {
		return false
	}
	return true
}
func (this *GlobalSpecType_ManualRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GlobalSpecType_ManualRouting)
	if !ok {
		that2, ok := that.(GlobalSpecType_ManualRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_DisableEncryption) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_DisableEncryption)
	if !ok {
		that2, ok := that.(CreateSpecType_DisableEncryption)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_EnableEncryption) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_EnableEncryption)
	if !ok {
		that2, ok := that.(CreateSpecType_EnableEncryption)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_F5OrchestratedRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_F5OrchestratedRouting)
	if !ok {
		that2, ok := that.(CreateSpecType_F5OrchestratedRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreateSpecType_ManualRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreateSpecType_ManualRouting)
	if !ok {
		that2, ok := that.(CreateSpecType_ManualRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_EgressGatewayDefault) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_EgressGatewayDefault)
	if !ok {
		that2, ok := that.(ReplaceSpecType_EgressGatewayDefault)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_EgressNatGw) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_EgressNatGw)
	if !ok {
		that2, ok := that.(ReplaceSpecType_EgressNatGw)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_EgressVirtualPrivateGateway) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_EgressVirtualPrivateGateway)
	if !ok {
		that2, ok := that.(ReplaceSpecType_EgressVirtualPrivateGateway)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_F5XcSecurityGroup) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_F5XcSecurityGroup)
	if !ok {
		that2, ok := that.(ReplaceSpecType_F5XcSecurityGroup)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ReplaceSpecType_CustomSecurityGroup) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ReplaceSpecType_CustomSecurityGroup)
	if !ok {
		that2, ok := that.(ReplaceSpecType_CustomSecurityGroup)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_DisableEncryption) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_DisableEncryption)
	if !ok {
		that2, ok := that.(GetSpecType_DisableEncryption)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_EnableEncryption) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_EnableEncryption)
	if !ok {
		that2, ok := that.(GetSpecType_EnableEncryption)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_F5OrchestratedRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_F5OrchestratedRouting)
	if !ok {
		that2, ok := that.(GetSpecType_F5OrchestratedRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetSpecType_ManualRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetSpecType_ManualRouting)
	if !ok {
		that2, ok := that.(GetSpecType_ManualRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AWSVPCVoltstackClusterReplaceType_NoK8SCluster) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.AWSVPCVoltstackClusterReplaceType_NoK8SCluster{` +
		`NoK8SCluster:` + fmt.Sprintf("%#v", this.NoK8SCluster) + `}`}, ", ")
	return s
}
func (this *AWSVPCVoltstackClusterReplaceType_K8SCluster) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.AWSVPCVoltstackClusterReplaceType_K8SCluster{` +
		`K8SCluster:` + fmt.Sprintf("%#v", this.K8SCluster) + `}`}, ", ")
	return s
}
...
func (this *GlobalSpecType) GoString() string {
	...
	if this.EncryptionChoice != nil {
		s = append(s, "EncryptionChoice: "+fmt.Sprintf("%#v", this.EncryptionChoice)+",\n")
	}
	...
	if this.WafSignatures != nil {
		s = append(s, "WafSignatures: "+fmt.Sprintf("%#v", this.WafSignatures)+",\n")
	}
...
func (this *GlobalSpecType_DisableEncryption) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.GlobalSpecType_DisableEncryption{` +
		`DisableEncryption:` + fmt.Sprintf("%#v", this.DisableEncryption) + `}`}, ", ")
	return s
}
func (this *GlobalSpecType_EnableEncryption) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.GlobalSpecType_EnableEncryption{` +
...
func (this *GlobalSpecType_F5OrchestratedRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.GlobalSpecType_F5OrchestratedRouting{` +
		`F5OrchestratedRouting:` + fmt.Sprintf("%#v", this.F5OrchestratedRouting) + `}`}, ", ")
	return s
}
func (this *GlobalSpecType_ManualRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.GlobalSpecType_ManualRouting{` +
...
func (this *CreateSpecType_DisableEncryption) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.CreateSpecType_DisableEncryption{` +
		`DisableEncryption:` + fmt.Sprintf("%#v", this.DisableEncryption) + `}`}, ", ")
	return s
}
func (this *CreateSpecType_EnableEncryption) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.CreateSpecType_EnableEncryption{` +
		`EnableEncryption:` + fmt.Sprintf("%#v", this.EnableEncryption) + `}`}, ", ")
	return s
}
...
func (this *CreateSpecType_F5OrchestratedRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.CreateSpecType_F5OrchestratedRouting{` +
		`F5OrchestratedRouting:` + fmt.Sprintf("%#v", this.F5OrchestratedRouting) + `}`}, ", ")
	return s
}
func (this *CreateSpecType_ManualRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.CreateSpecType_ManualRouting{` +
		`ManualRouting:` + fmt.Sprintf("%#v", this.ManualRouting) + `}`}, ", ")
	return s
}
...
func (this *ReplaceSpecType_EgressGatewayDefault) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.ReplaceSpecType_EgressGatewayDefault{` +
		`EgressGatewayDefault:` + fmt.Sprintf("%#v", this.EgressGatewayDefault) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_EgressNatGw) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.ReplaceSpecType_EgressNatGw{` +
		`EgressNatGw:` + fmt.Sprintf("%#v", this.EgressNatGw) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_EgressVirtualPrivateGateway) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.ReplaceSpecType_EgressVirtualPrivateGateway{` +
		`EgressVirtualPrivateGateway:` + fmt.Sprintf("%#v", this.EgressVirtualPrivateGateway) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_F5XcSecurityGroup) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.ReplaceSpecType_F5XcSecurityGroup{` +
		`F5XcSecurityGroup:` + fmt.Sprintf("%#v", this.F5XcSecurityGroup) + `}`}, ", ")
	return s
}
func (this *ReplaceSpecType_CustomSecurityGroup) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.ReplaceSpecType_CustomSecurityGroup{` +
		`CustomSecurityGroup:` + fmt.Sprintf("%#v", this.CustomSecurityGroup) + `}`}, ", ")
	return s
}
...
func (this *GetSpecType_DisableEncryption) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.GetSpecType_DisableEncryption{` +
		`DisableEncryption:` + fmt.Sprintf("%#v", this.DisableEncryption) + `}`}, ", ")
	return s
}
func (this *GetSpecType_EnableEncryption) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.GetSpecType_EnableEncryption{` +
		`EnableEncryption:` + fmt.Sprintf("%#v", this.EnableEncryption) + `}`}, ", ")
	return s
}
...
func (this *GetSpecType_F5OrchestratedRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.GetSpecType_F5OrchestratedRouting{` +
		`F5OrchestratedRouting:` + fmt.Sprintf("%#v", this.F5OrchestratedRouting) + `}`}, ", ")
	return s
}
func (this *GetSpecType_ManualRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&aws_vpc_site.GetSpecType_ManualRouting{` +
		`ManualRouting:` + fmt.Sprintf("%#v", this.ManualRouting) + `}`}, ", ")
	return s
}
...
func (m *AWSVPCVoltstackClusterReplaceType_NoK8SCluster) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AWSVPCVoltstackClusterReplaceType_NoK8SCluster) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoK8SCluster != nil {
		{
			size, err := m.NoK8SCluster.MarshalToSizedBuffer(dAtA[:i])
...
func (m *AWSVPCVoltstackClusterReplaceType_K8SCluster) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AWSVPCVoltstackClusterReplaceType_K8SCluster) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.K8SCluster != nil {
		{
			size, err := m.K8SCluster.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GlobalSpecType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.WafSignatures != nil {
		{
			size, err := m.WafSignatures.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.EncryptionChoice != nil {
		{
			size := m.EncryptionChoice.Size()
			i -= size
			if _, err := m.EncryptionChoice.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
	if m.RoutingType != nil {
		{
			size := m.RoutingType.Size()
			i -= size
			if _, err := m.RoutingType.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *GlobalSpecType_F5OrchestratedRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_F5OrchestratedRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.F5OrchestratedRouting != nil {
		{
			size, err := m.F5OrchestratedRouting.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_ManualRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_ManualRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *GlobalSpecType_DisableEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_DisableEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableEncryption != nil {
		{
			size, err := m.DisableEncryption.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GlobalSpecType_EnableEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GlobalSpecType_EnableEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnableEncryption != nil {
		{
			size, err := m.EnableEncryption.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CreateSpecType_F5OrchestratedRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_F5OrchestratedRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.F5OrchestratedRouting != nil {
		{
			size, err := m.F5OrchestratedRouting.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_ManualRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_ManualRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ManualRouting != nil {
		{
			size, err := m.ManualRouting.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_DisableEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_DisableEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableEncryption != nil {
		{
			size, err := m.DisableEncryption.MarshalToSizedBuffer(dAtA[:i])
...
func (m *CreateSpecType_EnableEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateSpecType_EnableEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnableEncryption != nil {
		{
			size, err := m.EnableEncryption.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_EgressGatewayDefault) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_EgressGatewayDefault) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EgressGatewayDefault != nil {
		{
			size, err := m.EgressGatewayDefault.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_EgressNatGw) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_EgressNatGw) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EgressNatGw != nil {
		{
			size, err := m.EgressNatGw.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_EgressVirtualPrivateGateway) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_EgressVirtualPrivateGateway) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EgressVirtualPrivateGateway != nil {
		{
			size, err := m.EgressVirtualPrivateGateway.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_F5XcSecurityGroup) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_F5XcSecurityGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.F5XcSecurityGroup != nil {
		{
			size, err := m.F5XcSecurityGroup.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ReplaceSpecType_CustomSecurityGroup) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ReplaceSpecType_CustomSecurityGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CustomSecurityGroup != nil {
		{
			size, err := m.CustomSecurityGroup.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_F5OrchestratedRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_F5OrchestratedRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.F5OrchestratedRouting != nil {
		{
			size, err := m.F5OrchestratedRouting.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_ManualRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_ManualRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ManualRouting != nil {
		{
			size, err := m.ManualRouting.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_DisableEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_DisableEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisableEncryption != nil {
		{
			size, err := m.DisableEncryption.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GetSpecType_EnableEncryption) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpecType_EnableEncryption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EnableEncryption != nil {
		{
			size, err := m.EnableEncryption.MarshalToSizedBuffer(dAtA[:i])
...
func (m *AWSVPCVoltstackClusterReplaceType_NoK8SCluster) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AWSVPCVoltstackClusterReplaceType_K8SCluster) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GlobalSpecType) Size() (n int) {
	...
	if m.RoutingType != nil {
		n += m.RoutingType.Size()
	}
	if m.EncryptionChoice != nil {
		n += m.EncryptionChoice.Size()
	}
	if m.WafSignatures != nil {
		l = m.WafSignatures.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	if m.TfParams != nil {
		l = m.TfParams.Size()
...
func (m *GlobalSpecType_F5OrchestratedRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.F5OrchestratedRouting != nil {
		l = m.F5OrchestratedRouting.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *GlobalSpecType_ManualRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GlobalSpecType_DisableEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DisableEncryption != nil {
		l = m.DisableEncryption.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *GlobalSpecType_EnableEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_F5OrchestratedRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_ManualRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_DisableEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateSpecType_EnableEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_EgressGatewayDefault) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_EgressNatGw) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_EgressVirtualPrivateGateway) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_F5XcSecurityGroup) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReplaceSpecType_CustomSecurityGroup) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_F5OrchestratedRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_ManualRouting) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_DisableEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpecType_EnableEncryption) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *AWSVPCVoltstackClusterReplaceType_NoK8SCluster) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AWSVPCVoltstackClusterReplaceType_NoK8SCluster{`,
		`NoK8SCluster:` + strings.Replace(fmt.Sprintf("%v", this.NoK8SCluster), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *AWSVPCVoltstackClusterReplaceType_K8SCluster) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AWSVPCVoltstackClusterReplaceType_K8SCluster{`,
		`K8SCluster:` + strings.Replace(fmt.Sprintf("%v", this.K8SCluster), "ObjectRefType", "views.ObjectRefType", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GlobalSpecType) String() string {
	...
	s := strings.Join([]string{`&GlobalSpecType{`,
		...
		`EncryptionChoice:` + fmt.Sprintf("%v", this.EncryptionChoice) + `,`,
		`WafSignatures:` + strings.Replace(fmt.Sprintf("%v", this.WafSignatures), "LiveSignaturesUpdate", "common_waf.LiveSignaturesUpdate", 1) + `,`,
...
func (this *GlobalSpecType_F5OrchestratedRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_F5OrchestratedRouting{`,
		`F5OrchestratedRouting:` + strings.Replace(fmt.Sprintf("%v", this.F5OrchestratedRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GlobalSpecType_ManualRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_ManualRouting{`,
		`ManualRouting:` + strings.Replace(fmt.Sprintf("%v", this.ManualRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GlobalSpecType_DisableEncryption) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_DisableEncryption{`,
		`DisableEncryption:` + strings.Replace(fmt.Sprintf("%v", this.DisableEncryption), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GlobalSpecType_EnableEncryption) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GlobalSpecType_EnableEncryption{`,
		`EnableEncryption:` + strings.Replace(fmt.Sprintf("%v", this.EnableEncryption), "AWSDiskEncryption", "views.AWSDiskEncryption", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *CreateSpecType_F5OrchestratedRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_F5OrchestratedRouting{`,
		`F5OrchestratedRouting:` + strings.Replace(fmt.Sprintf("%v", this.F5OrchestratedRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_ManualRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_ManualRouting{`,
		`ManualRouting:` + strings.Replace(fmt.Sprintf("%v", this.ManualRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_DisableEncryption) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_DisableEncryption{`,
		`DisableEncryption:` + strings.Replace(fmt.Sprintf("%v", this.DisableEncryption), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CreateSpecType_EnableEncryption) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreateSpecType_EnableEncryption{`,
		`EnableEncryption:` + strings.Replace(fmt.Sprintf("%v", this.EnableEncryption), "AWSDiskEncryption", "views.AWSDiskEncryption", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *ReplaceSpecType_EgressGatewayDefault) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_EgressGatewayDefault{`,
		`EgressGatewayDefault:` + strings.Replace(fmt.Sprintf("%v", this.EgressGatewayDefault), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_EgressNatGw) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_EgressNatGw{`,
		`EgressNatGw:` + strings.Replace(fmt.Sprintf("%v", this.EgressNatGw), "AWSNATGatewaychoiceType", "views.AWSNATGatewaychoiceType", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_EgressVirtualPrivateGateway) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_EgressVirtualPrivateGateway{`,
		`EgressVirtualPrivateGateway:` + strings.Replace(fmt.Sprintf("%v", this.EgressVirtualPrivateGateway), "AWSVirtualPrivateGatewaychoiceType", "views.AWSVirtualPrivateGatewaychoiceType", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_F5XcSecurityGroup) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_F5XcSecurityGroup{`,
		`F5XcSecurityGroup:` + strings.Replace(fmt.Sprintf("%v", this.F5XcSecurityGroup), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ReplaceSpecType_CustomSecurityGroup) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ReplaceSpecType_CustomSecurityGroup{`,
		`CustomSecurityGroup:` + strings.Replace(fmt.Sprintf("%v", this.CustomSecurityGroup), "SecurityGroupType", "views.SecurityGroupType", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetSpecType_F5OrchestratedRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_F5OrchestratedRouting{`,
		`F5OrchestratedRouting:` + strings.Replace(fmt.Sprintf("%v", this.F5OrchestratedRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_ManualRouting) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_ManualRouting{`,
		`ManualRouting:` + strings.Replace(fmt.Sprintf("%v", this.ManualRouting), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_DisableEncryption) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_DisableEncryption{`,
		`DisableEncryption:` + strings.Replace(fmt.Sprintf("%v", this.DisableEncryption), "Empty", "schema.Empty", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GetSpecType_EnableEncryption) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetSpecType_EnableEncryption{`,
		`EnableEncryption:` + strings.Replace(fmt.Sprintf("%v", this.EnableEncryption), "AWSDiskEncryption", "views.AWSDiskEncryption", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *AWSVPCVoltstackClusterReplaceType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			...
			m.K8SClusterChoice = &AWSVPCVoltstackClusterReplaceType_NoK8SCluster{v}
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field K8SCluster", wireType)
			...
			m.K8SClusterChoice = &AWSVPCVoltstackClusterReplaceType_K8SCluster{v}
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NoDcClusterGroup", wireType)
...
func (m *GlobalSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 61:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field F5OrchestratedRouting", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RoutingType = &GlobalSpecType_F5OrchestratedRouting{v}
			iNdEx = postIndex
		case 62:
			if wireType != 2 {
			...
			m.RoutingType = &GlobalSpecType_ManualRouting{v}
			iNdEx = postIndex
		case 64:
			if wireType != 2 {
			...
			m.EncryptionChoice = &GlobalSpecType_DisableEncryption{v}
			iNdEx = postIndex
		case 65:
			if wireType != 2 {
			...
			v := &views.AWSDiskEncryption{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.EncryptionChoice = &GlobalSpecType_EnableEncryption{v}
			iNdEx = postIndex
		case 66:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WafSignatures", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WafSignatures == nil {
				m.WafSignatures = &common_waf.LiveSignaturesUpdate{}
			}
			if err := m.WafSignatures.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 999:
...
func (m *CreateSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 61:
			...
			m.RoutingType = &CreateSpecType_F5OrchestratedRouting{v}
			iNdEx = postIndex
		case 62:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ManualRouting", wireType)
			...
			m.RoutingType = &CreateSpecType_ManualRouting{v}
			iNdEx = postIndex
		case 64:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableEncryption", wireType)
			...
			m.EncryptionChoice = &CreateSpecType_DisableEncryption{v}
			iNdEx = postIndex
		case 65:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableEncryption", wireType)
			...
			m.EncryptionChoice = &CreateSpecType_EnableEncryption{v}
			iNdEx = postIndex
		case 66:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WafSignatures", wireType)
...
func (m *ReplaceSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 46:
			...
			m.EgressGatewayChoice = &ReplaceSpecType_EgressGatewayDefault{v}
			iNdEx = postIndex
		case 47:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EgressNatGw", wireType)
			...
			m.EgressGatewayChoice = &ReplaceSpecType_EgressNatGw{v}
			iNdEx = postIndex
		case 48:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EgressVirtualPrivateGateway", wireType)
			...
			m.EgressGatewayChoice = &ReplaceSpecType_EgressVirtualPrivateGateway{v}
			iNdEx = postIndex
		case 52:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field F5XcSecurityGroup", wireType)
			...
			m.SecurityGroupChoice = &ReplaceSpecType_F5XcSecurityGroup{v}
			iNdEx = postIndex
		case 53:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomSecurityGroup", wireType)
			...
			m.SecurityGroupChoice = &ReplaceSpecType_CustomSecurityGroup{v}
			iNdEx = postIndex
		case 54:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrivateConnectivity", wireType)
...
func (m *GetSpecType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 61:
			...
			m.RoutingType = &GetSpecType_F5OrchestratedRouting{v}
			iNdEx = postIndex
		case 62:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ManualRouting", wireType)
			...
			m.RoutingType = &GetSpecType_ManualRouting{v}
			iNdEx = postIndex
		case 64:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableEncryption", wireType)
			...
			m.EncryptionChoice = &GetSpecType_DisableEncryption{v}
			iNdEx = postIndex
		case 65:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableEncryption", wireType)
			...
			m.EncryptionChoice = &GetSpecType_EnableEncryption{v}
			iNdEx = postIndex
		case 66:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WafSignatures", wireType)
