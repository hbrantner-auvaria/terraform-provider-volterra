...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.views.azure_vnet_site.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.azure_vnet_site.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.azure_vnet_site.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				...
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.azure_vnet_site.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/views/azure_vnet_site/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.views.azure_vnet_site/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-azure_vnet_site-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.azure_vnet_site.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-azure_vnet_site-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.azure_vnet_site.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-azure_vnet_site-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.azure_vnet_site.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "azure_vnet_site",
            "x-ves-object-type": "ves.io.schema.views.azure_vnet_site.Object",
            "x-ves-proto-service": "ves.io.schema.views.azure_vnet_site.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.views.azure_vnet_site/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-azure_vnet_site-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.views.azure_vnet_site.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-azure_vnet_site-crudapi-api-create"
                },
        ...
        "/ves.io.schema.views.azure_vnet_site/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-views-azure_vnet_site-crudapi-api-liststream"
                },
        ...
        "/ves.io.schema.views.azure_vnet_site/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.azure_vnet_site/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.azure_vnet_site/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.views.azure_vnet_site/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.views.azure_vnet_site.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "azure_vnet_siteStatusObject": {
            ...
            "properties": {
                ...
                "vnet_attachment": {
                    "description": " Cloud Connect to Azure Vnet Sites",
        ...
        "azure_vnet_sitecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.views.azure_vnet_site.crudapi.ErrorCode"
        },
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.azure_vnet_site.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/viewsazure_vnet_siteSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.azure_vnet_site.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/azure_vnet_sitecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.azure_vnet_site.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/azure_vnet_sitecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.azure_vnet_site.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.azure_vnet_site.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/azure_vnet_sitecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.azure_vnet_site.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.azure_vnet_site.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.azure_vnet_site.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/azure_vnet_sitecrudapiErrorCode"
                },
        ...
        "viewsazure_vnet_siteGlobalSpecType": {
            ...
            "properties": {
                ...
                "disable_encryption": {
                    "description": "Exclusive with [enable_encryption]\n Disk attached to VM will not be encrypted with CMK",
                ...
                "enable_encryption": {
                    ...
                    "$ref": "#/definitions/azure_vnet_siteAzureDiskEncryption",
    ...
    "x-ves-proto-file": "ves.io/schema/views/azure_vnet_site/crudapi/api.proto"
}`
