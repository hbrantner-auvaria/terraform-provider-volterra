...
const (
	...
	CreateRequestFQN = "ves.io.schema.views.bigip_http_proxy.CreateRequest"
	// CreateResponseFQN is the fully-qualified-name of the CreateResponse message
	CreateResponseFQN = "ves.io.schema.views.bigip_http_proxy.CreateResponse"
	// ReplaceRequestFQN is the fully-qualified-name of the ReplaceRequest message
	ReplaceRequestFQN = "ves.io.schema.views.bigip_http_proxy.ReplaceRequest"
	// ReplaceResponseFQN is the fully-qualified-name of the ReplaceResponse message
	ReplaceResponseFQN = "ves.io.schema.views.bigip_http_proxy.ReplaceResponse"
	// GetRequestFQN is the fully-qualified-name of the GetRequest message
	GetRequestFQN = "ves.io.schema.views.bigip_http_proxy.GetRequest"
	// GetResponseFQN is the fully-qualified-name of the GetResponse message
	GetResponseFQN = "ves.io.schema.views.bigip_http_proxy.GetResponse"
	// ListRequestFQN is the fully-qualified-name of the ListRequest message
	ListRequestFQN = "ves.io.schema.views.bigip_http_proxy.ListRequest"
	// ListResponseFQN is the fully-qualified-name of the ListResponse message
	ListResponseFQN = "ves.io.schema.views.bigip_http_proxy.ListResponse"
	// DeleteRequestFQN is the fully-qualified-name of the DeleteRequest message
	DeleteRequestFQN = "ves.io.schema.views.bigip_http_proxy.DeleteRequest"
	// DeleteResponseFQN is the fully-qualified-name of the DeleteResponse message
	DeleteResponseFQN = "ves.io.schema.views.bigip_http_proxy.DeleteResponse"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_http_proxys", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_http_proxys/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_http_proxys/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_http_proxys", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/bigip_http_proxys/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.views.bigip_http_proxy.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.views.bigip_http_proxy")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_http_proxy.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_http_proxy.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_http_proxy.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_http_proxy.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.views.bigip_http_proxy.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.views.bigip_http_proxy.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.views.bigip_http_proxy.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_http_proxy.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_http_proxy.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.views.bigip_http_proxy.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.views.bigip_http_proxy.API.Create' operation on 'bigip_http_proxy'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.views.bigip_http_proxy.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.bigip_http_proxy.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_http_proxy.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_http_proxy.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.views.bigip_http_proxy.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.views.bigip_http_proxy.API.Replace' operation on 'bigip_http_proxy'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.views.bigip_http_proxy.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_http_proxy.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.views.bigip_http_proxy.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_http_proxy.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.views.bigip_http_proxy.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.views.bigip_http_proxy.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.views.bigip_http_proxy.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.views.bigip_http_proxy.API.Delete' operation on 'bigip_http_proxy'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.views.bigip_http_proxy.GetResponse"
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "BIG-IP HTTP Proxy",
        "description": "BIG-IP HTTP Proxy is used for configuring HTTP/HTTPS Load Balancer for a domain.",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/bigip_http_proxys": {
            "post": {
                "summary": "Create BigIP HTTP Proxy",
                "description": "Create BigIP HTTP Proxy in a given namespace. If one already exists, it will give an error.",
                "operationId": "ves.io.schema.views.bigip_http_proxy.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bigip_http_proxyCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bigip_http_proxyCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-displayname": "Configure BIG-IP HTTP Proxy",
            "x-ves-proto-service": "ves.io.schema.views.bigip_http_proxy.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/bigip_http_proxys/{metadata.name}": {
            "put": {
                "summary": "Replace BigIP HTTP Proxy",
                "description": "Replace BigIP HTTP Proxy in a given namespace.",
                "operationId": "ves.io.schema.views.bigip_http_proxy.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bigip_http_proxyReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bigip_http_proxyReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/bigip_http_proxys": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bigip_http_proxyListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/bigip_http_proxys/{name}": {
            "get": {
                "summary": "Get BigIP HTTP Proxy",
                "description": "Get BigIP HTTP Proxy details.",
                "operationId": "ves.io.schema.views.bigip_http_proxy.API.Get",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/bigip_http_proxyGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bigip_http_proxyDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "bigip_http_proxyCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of bigip_http_proxy",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the BigIP HTTP Proxy",
                    "title": "spec",
                    "$ref": "#/definitions/viewsbigip_http_proxyCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "bigip_http_proxyCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the BigIP HTTP Proxy",
                    "title": "spec",
                    "$ref": "#/definitions/viewsbigip_http_proxyGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "bigip_http_proxyDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a bigip_http_proxy",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.views.bigip_http_proxy.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "bigip_http_proxyGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read bigip_http_proxy",
        ...
        "bigip_http_proxyGetResponseFormatCode": {
            "type": "string",
        ...
        "bigip_http_proxyListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of bigip_http_proxy",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.views.bigip_http_proxy.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/bigip_http_proxyListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "bigip_http_proxyListResponseItem": {
            "type": "object",
            "description": "By default a summary of bigip_http_proxy is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of bigip_http_proxy",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.views.bigip_http_proxy.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this bigip_http_proxy",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this bigip_http_proxy",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates bigip_http_proxy is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this bigip_http_proxy",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this bigip_http_proxy\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this bigip_http_proxy\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "bigip_http_proxyReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a bigip_http_proxy",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the BigIP HTTP Proxy",
                    "title": "spec",
                    "$ref": "#/definitions/viewsbigip_http_proxyReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "bigip_http_proxyReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.views.bigip_http_proxy.ReplaceResponse"
        },
        ...
        "viewsbigip_http_proxyCreateSpecType": {
            "type": "object",
            "description": "Create BigIP HTTP Proxy in a given namespace. If one already exists, it will give an error.",
            "title": "Create BigIP HTTP Proxy",
        ...
        "viewsbigip_http_proxyGetSpecType": {
            "type": "object",
            "description": "Get BigIP HTTP Proxy details.",
            "title": "Get BigIP HTTP Proxy",
        ...
        "viewsbigip_http_proxyReplaceSpecType": {
            "type": "object",
            "description": "Replace BigIP HTTP Proxy in a given namespace.",
            "title": "Replace BigIP HTTP Proxy",
    ...
    "x-displayname": "Configure BIG-IP HTTP Proxy",
    "x-ves-proto-file": "ves.io/schema/views/bigip_http_proxy/public_crudapi.proto"
}`
