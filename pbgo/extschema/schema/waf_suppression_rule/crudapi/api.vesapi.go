...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/waf_suppression_rule"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.waf_suppression_rule.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.waf_suppression_rule.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.waf_suppression_rule.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_suppression_rule.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_suppression_rule.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_suppression_rule.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_suppression_rule.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.waf_suppression_rule.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.waf_suppression_rule.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.waf_suppression_rule.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_suppression_rule.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_suppression_rule.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_suppression_rule.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_suppression_rule.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_suppression_rule.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_suppression_rule.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.waf_suppression_rule.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.waf_suppression_rule.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/waf_suppression_rule/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.waf_suppression_rule/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_suppression_rule-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_suppression_rule.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_suppression_rule-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_suppression_rule.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_suppression_rule-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_suppression_rule.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_suppression_rule",
            "x-ves-object-type": "ves.io.schema.waf_suppression_rule.Object",
            "x-ves-proto-service": "ves.io.schema.waf_suppression_rule.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.waf_suppression_rule/Objects": {
            "get": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_suppression_rule-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_suppression_rule.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_suppression_rule-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_suppression_rule.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_suppression_rule",
            "x-ves-object-type": "ves.io.schema.waf_suppression_rule.Object",
        ...
        "/ves.io.schema.waf_suppression_rule/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-waf_suppression_rule-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.waf_suppression_rule.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "waf_suppression_rule",
            "x-ves-object-type": "ves.io.schema.waf_suppression_rule.Object",
        ...
        "/ves.io.schema.waf_suppression_rule/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_suppression_rule/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_suppression_rule/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.waf_suppression_rule/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.waf_suppression_rule.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        ...
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/waf_suppression_ruleSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/waf_suppression_rulecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/waf_suppression_rulecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/waf_suppression_ruleStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/waf_suppression_rulecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/waf_suppression_rulecrudapiErrorCode"
                },
        ...
        "schemawaf_suppression_ruleGlobalSpecType": {
            "type": "object",
            "title": "GlobalSpecType",
            "x-displayname": "Suppression WAF Rule Specification",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.GlobalSpecType",
            "properties": {
                "contexts": {
                    "type": "array",
                    "description": " Contexts represents list of contexts that should be considered as false positive.\n context is combined of type (for example PARAMETER) and name (for example __VIEWSTATE)\n\nValidation Rules:\n  ves.io.schema.rules.repeated.max_items: 5000\n",
                    "title": "contexts",
                    "maxItems": 5000,
                    "items": {
                        "$ref": "#/definitions/waf_suppression_ruleContext"
                    },
                ...
                "desired_state": {
                    "description": " State represents the detection's desired state once all the above attributes are being matched.",
                    "title": "desired_state",
                    "$ref": "#/definitions/waf_suppression_ruleDesiredState",
                    "x-displayname": "Desired State"
                },
                "detections": {
                    "description": " Detections represents all the IDs of any type of detection (lie signatures and violations)\n which considered as false positive.",
                    "title": "detections",
                    "$ref": "#/definitions/waf_suppression_ruleDetections",
                    "x-displayname": "Detections"
                }
            }
        },
        "waf_suppression_ruleContext": {
            "type": "object",
            "description": "Defines the context in the suppression rule.\nContext will be compared with the detection's state as part of false positive process.",
            "title": "Context",
            "x-displayname": "Context For Suppression Rule",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.Context",
            "properties": {
                "name": {
                    "type": "string",
                    "description": " Context name configures the name of the context used for suppression rule\n\nExample: - \"__VIEWSTATE\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "__VIEWSTATE",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
                ...
                "type": {
                    "description": " Context type configures the type of the context used for suppression rule\n\nExample: - \"PARAMETER\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.enum.defined_only: true\n  ves.io.schema.rules.enum.not_in: 0\n  ves.io.schema.rules.message.required: true\n",
                    "title": "type",
                    "$ref": "#/definitions/waf_suppression_ruleContextType",
                    "x-displayname": "Type",
        ...
        "waf_suppression_ruleContextType": {
            "type": "string",
            "description": "The origin type of the context, whether it is cookie, parameter or other\n",
            "title": "Context Type",
            "enum": [
                "NO_CONTEXT",
                "REQUEST",
            ...
            "x-ves-proto-enum": "ves.io.schema.waf_suppression_rule.ContextType"
        },
        "waf_suppression_ruleDesiredState": {
            "type": "string",
            "description": "Desired state represents the state of the detection once it is being considered as false positive.\n",
            "title": "Desired State",
            "enum": [
                "DISABLED",
                "AUTO_SUPPRESSED",
            ...
            "default": "DISABLED",
            "x-displayname": "Desired State",
            "x-ves-proto-enum": "ves.io.schema.waf_suppression_rule.DesiredState"
        },
        "waf_suppression_ruleDetections": {
            "type": "object",
            "description": "Configuration of detections such as signatures or violations used for suppression rule",
            "title": "Detections",
            "x-displayname": "Detections For Suppression Rule",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.Detections",
            "properties": {
                "signatures": {
                    "type": "array",
                    "description": " List of signatures' IDs. all signatures that should be considered as false positive as part of the rule's scope.\n\nExample: - \"[\"200020157\", \"200010243\"]\"-\n\nValidation Rules:\n  ves.io.schema.rules.repeated.items.uint32.gte: 10000000\n  ves.io.schema.rules.repeated.items.uint32.lte: 300000000\n  ves.io.schema.rules.repeated.max_items: 5000\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "signatures",
                    "maxItems": 5000,
                    "items": {
                        "type": "string"
                    ...
                    "x-ves-example": "[\"200020157\", \"200010243\"]",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.repeated.items.uint32.gte": "10000000",
                        "ves.io.schema.rules.repeated.items.uint32.lte": "300000000",
                        "ves.io.schema.rules.repeated.max_items": "5000",
                ...
                "violations": {
                    "type": "array",
                    "description": " List of violations' IDs. all violations that should be considered as false positive as part of the rule's scope.\n\nExample: - \"[\"VIOL_EVASION_IIS_UNICODE_CODEPOINTS\", \"VIOL_EVASION_IIS_BACKSLASHES\"]\"-\n\nValidation Rules:\n  ves.io.schema.rules.repeated.items.enum.defined_only: true\n  ves.io.schema.rules.repeated.items.enum.not_in: 0\n  ves.io.schema.rules.repeated.max_items: 5000\n  ves.io.schema.rules.repeated.unique: true\n",
                    "title": "violations",
                    "maxItems": 5000,
                    "items": {
                    ...
                    "x-ves-example": "[\"VIOL_EVASION_IIS_UNICODE_CODEPOINTS\", \"VIOL_EVASION_IIS_BACKSLASHES\"]",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.repeated.items.enum.defined_only": "true",
                        "ves.io.schema.rules.repeated.items.enum.not_in": "0",
                        "ves.io.schema.rules.repeated.max_items": "5000",
        ...
        "waf_suppression_ruleSpecType": {
            "type": "object",
            "description": "Shape of the WAF Suppression Rule Object specification",
            "title": "WAF Suppression Rule Object Specification",
            "x-displayname": "WAF Suppression Rule Object Specification",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/schemawaf_suppression_ruleGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "waf_suppression_ruleStatusObject": {
            "type": "object",
            "description": "WAF Suppression Rule Object to configure false positive rule.",
            "title": "WAF Suppression Rule Status",
            "x-displayname": "WAF Suppression Rule Object",
            "x-ves-proto-message": "ves.io.schema.waf_suppression_rule.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "waf_suppression_rulecrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.waf_suppression_rule.crudapi.ErrorCode"
        }
    },
    "x-displayname": "",
    ...
    "x-ves-proto-file": "ves.io/schema/waf_suppression_rule/crudapi/api.proto"
}`
