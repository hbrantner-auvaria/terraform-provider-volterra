...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/network_interfaces", c.baseURL, namespace)
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_interface.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_interface.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_interface.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_interface.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.network_interface.API.Delete")
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.network_interface.API.Create' operation on 'network_interface'"
		if retErr == nil {
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.network_interface.API.Replace' operation on 'network_interface'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.network_interface.API.Delete' operation on 'network_interface'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
...
var APISwaggerJSON string = `{
    ...
    "definitions": {
        ...
        "network_interfaceLayer2InterfaceType": {
            ...
            "properties": {
                "l2sriov_interface": {
                    "description": "Exclusive with [l2vlan_interface l2vlan_slo_interface]\n Layer2 SR-IOV interface",
                    "title": "SR-IOV interface",
                    "$ref": "#/definitions/network_interfaceLayer2SriovInterfaceType",
                    "x-displayname": "SR-IOV interface"
                },
                "l2vlan_interface": {
                    "description": "Exclusive with [l2sriov_interface l2vlan_slo_interface]\n Layer2 interface of type VLAN",
                ...
                "l2vlan_slo_interface": {
                    "description": "Exclusive with [l2sriov_interface l2vlan_interface]\n VLAN on site local outside interface",
