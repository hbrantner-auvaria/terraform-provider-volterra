...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_proxys", c.baseURL, namespace)
...
func (c *crudAPIRestClient) Replace(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_proxys/%s", c.baseURL, namespace, name)
...
func (c *crudAPIRestClient) GetRaw(ctx context.Context, key string, opts ...server.CRUDCallOpt) (*GetResponse, error) {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_proxys/%s", c.baseURL, req.Namespace, req.Name)
...
func (c *crudAPIRestClient) List(ctx context.Context, opts ...server.CRUDCallOpt) (*ListResponse, error) {
	req := NewListRequest(opts...)
	_ = req
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_proxys", c.baseURL, req.Namespace)
...
func (c *crudAPIRestClient) Delete(ctx context.Context, key string, opts ...server.CRUDCallOpt) error {
	...
	url := fmt.Sprintf("%s/public/namespaces/%s/dns_proxys/%s", c.baseURL, dReq.Namespace, dReq.Name)
	cco := server.NewCRUDCallOpts()
	for _, opt := range opts {
		opt(cco)
	}
...
func (c *APIInprocClient) Create(ctx context.Context, req *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.dns_proxy.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		err := fmt.Errorf("No CRUD Server for ves.io.schema.dns_proxy")
		return nil, server.GRPCStatusFromError(server.MaybePublicRestError(ctx, err)).Err()
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_proxy.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ReplaceRequest, opts ...grpc.CallOption) (*ReplaceResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_proxy.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_proxy.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_proxy.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *DeleteRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.dns_proxy.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.dns_proxy.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.dns_proxy.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *CreateRequest) (*CreateResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_proxy.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_proxy.API.Create"), zap.Error(err))
			}
		}
	}
	reqMsgFQN := "ves.io.schema.dns_proxy.CreateRequest"
	...
	defer func() {
		...
		userMsg := "The 'ves.io.schema.dns_proxy.API.Create' operation on 'dns_proxy'"
		if retErr == nil {
	...
	rspMsgFQN := "ves.io.schema.dns_proxy.CreateResponse"
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.dns_proxy.API.CreateResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Replace(ctx context.Context, req *ReplaceRequest) (*ReplaceResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_proxy.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_proxy.API.Replace"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.dns_proxy.API.ReplaceRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.dns_proxy.API.Replace' operation on 'dns_proxy'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	bodyFields = append(bodyFields, svcfw.GenAuditRspBodyFields(ctx, s.sf, "ves.io.schema.dns_proxy.API.ReplaceResponse", rsp)...)
	return rsp, nil
}
...
func (s *APISrv) Get(ctx context.Context, req *GetRequest) (*GetResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_proxy.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
	...
	rspMsgFQN := "ves.io.schema.dns_proxy.GetResponse"
	if conv, exists := s.sf.Config().ObjToMsgConverters[rspMsgFQN]; exists {
		if err := conv(rsrcRsp.Entry, rsp); err != nil {
			return nil, err
		}
...
func (s *APISrv) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_proxy.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
				return nil, server.GRPCStatusFromError(err).Err()
			}
...
func (s *APISrv) Delete(ctx context.Context, req *DeleteRequest) (*google_protobuf.Empty, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.dns_proxy.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					err := server.MaybePublicRestError(ctx, errors.Wrapf(err, "Validating Request"))
					return nil, server.GRPCStatusFromError(err).Err()
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.dns_proxy.API.Delete"), zap.Error(err))
			}
		}
	}
	bodyFields := svcfw.GenAuditReqBodyFields(ctx, s.sf, "ves.io.schema.dns_proxy.API.DeleteRequest", req)
	var retErr error
	defer func() {
		if len(bodyFields) > 0 {
			server.ExtendAPIAudit(ctx, svcfw.PublicAPIBodyLog.Uid, bodyFields)
		}
		userMsg := "The 'ves.io.schema.dns_proxy.API.Delete' operation on 'dns_proxy'"
		if retErr == nil {
			userMsg += " was successfully performed."
		} else {
			userMsg += " failed to be performed."
	...
	for _, rsrcItem := range rsrcRsp.Items {
		...
		if len(req.ReportFields) > 0 {
			...
			if o.Object.GetSpec().GetGcSpec() != nil {
				msgFQN := "ves.io.schema.dns_proxy.GetResponse"
...
var APISwaggerJSON string = `{
    ...
    "info": {
        "title": "DNS Proxy",
        "description": "DNS Proxy view defines the required parameters that can be used in CRUD, to create and manage DNS Proxy.\nIt can be used to create DNS Proxy.\n\nView will create the following child objects.\n\n* Virtual-host\n* default route\n* clusters\n* endpoints\n* advertise policy",
    ...
    "tags": [],
    "paths": {
        "/public/namespaces/{metadata.namespace}/dns_proxys": {
            "post": {
                "summary": "Create DNS Proxy",
                "description": "Create DNS Proxy in a given namespace. If one already exists it will give an error.",
                "operationId": "ves.io.schema.dns_proxy.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_proxyCreateResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_proxyCreateRequest"
                        }
                    }
                ],
                "tags": [
            ...
            "x-displayname": "Configure DNS Proxy",
            "x-ves-proto-service": "ves.io.schema.dns_proxy.API",
            "x-ves-proto-service-type": "AUTO_CRUD_PUBLIC"
        },
        "/public/namespaces/{metadata.namespace}/dns_proxys/{metadata.name}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_proxyReplaceResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_proxyReplaceRequest"
                        }
                    }
                ],
                "tags": [
        ...
        "/public/namespaces/{namespace}/dns_proxys": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_proxyListResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
        ...
        "/public/namespaces/{namespace}/dns_proxys/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                            "$ref": "#/definitions/dns_proxyGetResponse"
                        }
                    },
                    "401": {
                        "description": "Returned when operation is not authorized",
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dns_proxyDeleteRequest"
                        }
                    }
                ],
                "tags": [
    ...
    "definitions": {
        "dns_proxyCreateRequest": {
            "type": "object",
            "description": "This is the input message of the 'Create' RPC",
            "title": "CreateRequest is used to create an instance of dns_proxy",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Proxy",
                    "title": "spec",
                    "$ref": "#/definitions/schemadns_proxyCreateSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "dns_proxyCreateResponse": {
            "type": "object",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Proxy",
                    "title": "spec",
                    "$ref": "#/definitions/schemadns_proxyGetSpecType",
                    "x-displayname": "Spec"
                },
                "system_metadata": {
        ...
        "dns_proxyDNSProxyDeploymentStatus": {
            "type": "string",
            "description": "Deployment Status of DNS Proxy\n\nDNS Proxy is successfully deployed and active\nDeployment of DNS Proxy is pending\nDNS Proxy has been disabled.\nDNS Proxy deployment encountered an error.",
            "title": "DNS PROXY Deployment Status",
            "enum": [
                "DNS_PROXY_CONFIG_ACTIVE",
                "DNS_PROXY_CONFIG_PENDING",
                "DNS_PROXY_CONFIG_DISABLED",
                "DNS_PROXY_CONFIG_FAILED"
            ],
            "default": "DNS_PROXY_CONFIG_ACTIVE",
            "x-displayname": "DNS Proxy Deployment Status",
            "x-ves-proto-enum": "ves.io.schema.dns_proxy.DNSProxyDeploymentStatus"
        },
        "dns_proxyDNSProxyStatus": {
            "type": "object",
            "description": "Status DNS Proxy",
            "title": "DNS Proxy Status",
            "x-displayname": "DNS Proxy Status",
            "x-ves-proto-message": "ves.io.schema.dns_proxy.DNSProxyStatus",
            "properties": {
                "deployment_status": {
                    "description": " Status of DNS Proxy Deployment",
                    "title": "DNS Proxy Deployment Status",
                    "$ref": "#/definitions/dns_proxyDNSProxyDeploymentStatus",
                    "x-displayname": "DNS Proxy Deployment Status"
                }
            }
        },
        "dns_proxyDeleteRequest": {
            "type": "object",
            "description": "This is the input message of the 'Delete' RPC.",
            "title": "DeleteRequest is used to delete a dns_proxy",
            "x-displayname": "Delete Request",
            "x-ves-proto-message": "ves.io.schema.dns_proxy.DeleteRequest",
            "properties": {
                "fail_if_referred": {
                    "type": "boolean",
        ...
        "dns_proxyGetResponse": {
            "type": "object",
            "description": "This is the output message of the 'Get' RPC",
            "title": "GetResponse is the shape of a read dns_proxy",
            ...
            "properties": {
                ...
                "status": {
                    ...
                    "title": "status",
                    "items": {
                        "$ref": "#/definitions/dns_proxyStatusObject"
                    },
        ...
        "dns_proxyGetResponseFormatCode": {
            "type": "string",
        ...
        "dns_proxyHealthCheckType": {
            "type": "object",
            "description": "Server Health Check",
            "title": "Server Health Check",
            "x-displayname": "Server Health Check",
            "x-ves-oneof-field-choice": "[\"dns_health_check\",\"icmp_health_check\",\"tcp_health_check\"]",
            "x-ves-proto-message": "ves.io.schema.dns_proxy.HealthCheckType",
            "properties": {
                "dns_health_check": {
                    "description": "Exclusive with [icmp_health_check tcp_health_check]\n DNS Health Check",
                    "title": "DNS Health Check",
                    "$ref": "#/definitions/healthcheckDnsHealthCheck",
                    "x-displayname": "DNS Health Check"
                },
                "icmp_health_check": {
                    "description": "Exclusive with [dns_health_check tcp_health_check]\n ICMP Health Check",
                    "title": "ICMP Health Check",
                    "$ref": "#/definitions/ioschemaEmpty",
                    "x-displayname": "ICMP Health Check"
                },
                "tcp_health_check": {
                    "description": "Exclusive with [dns_health_check icmp_health_check]\n TCP Health Check",
        ...
        "dns_proxyHealthChecks": {
            ...
            "properties": {
                "health_check": {
                    ...
                    "maxItems": 4,
                    "items": {
                        "$ref": "#/definitions/dns_proxyHealthCheckType"
                    },
        ...
        "dns_proxyListResponse": {
            "type": "object",
            "description": "This is the output message of 'List' RPC.",
            "title": "ListResponse is the collection of dns_proxy",
            "x-displayname": "List Response",
            "x-ves-proto-message": "ves.io.schema.dns_proxy.ListResponse",
            "properties": {
                "errors": {
                    "type": "array",
                ...
                "items": {
                    ...
                    "title": "items",
                    "items": {
                        "$ref": "#/definitions/dns_proxyListResponseItem"
                    },
                    "x-displayname": "Items"
                }
            }
        },
        "dns_proxyListResponseItem": {
            "type": "object",
            "description": "By default a summary of dns_proxy is returned in 'List'. By setting\n'report_fields' in the ListRequest more details of each item can be got.",
            "title": "ListResponseItem is an individual item in a collection of dns_proxy",
            "x-displayname": "List Item",
            "x-ves-proto-message": "ves.io.schema.dns_proxy.ListResponseItem",
            "properties": {
                "annotations": {
                    "type": "object",
                    "description": " The set of annotations present on this dns_proxy",
                    "title": "annotations",
                    "x-displayname": "Annotations"
                },
                "description": {
                    "type": "string",
                    "description": " The description set for this dns_proxy",
                    "title": "description",
                    "x-displayname": "Description"
                },
                "disabled": {
                    "type": "boolean",
                    "description": " A value of true indicates dns_proxy is administratively disabled",
                    "title": "disabled",
                    "format": "boolean",
                ...
                "labels": {
                    "type": "object",
                    "description": " The set of labels present on this dns_proxy",
                    "title": "labels",
                ...
                "name": {
                    "type": "string",
                    "description": " The name of this dns_proxy\n\nExample: - \"name\"-",
                    "title": "name",
                    "x-displayname": "Name",
                    "x-ves-example": "name"
                },
                ...
                "uid": {
                    "type": "string",
                    "description": " The unique uid of this dns_proxy\n\nExample: - \"d27938ba-967e-40a7-9709-57b8627f9f75\"-",
                    "title": "uid",
                    "x-displayname": "UID",
        ...
        "dns_proxyOriginServers": {
            ...
            "properties": {
                "health_checks": {
                    "description": "\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Origin Server Health Check",
                    "$ref": "#/definitions/dns_proxyHealthChecks",
                    "x-displayname": "Server Health Check",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "origin_servers": {
                    ...
                    "maxItems": 8,
                    "items": {
                        "$ref": "#/definitions/schemadns_proxyOriginServerType"
                    },
        ...
        "dns_proxyProxyAdvertisementType": {
            "type": "object",
            ...
            "properties": {
                ...
                "advertise_on_public": {
                    ...
                    "title": "Advertise IPv4 On Public",
                    "$ref": "#/definitions/viewsAdvertisePublic",
                    "x-displayname": "Internet (Specified IPv4 VIP)"
                },
                "advertise_on_public_default_dualstack_vip": {
                    ...
                    "title": "Advertise On Public Default VIP (Dualstack)",
                    "$ref": "#/definitions/ioschemaEmpty",
                ...
                "advertise_on_public_default_ipv6_vip": {
                    ...
                    "title": "Advertise On Public Default VIP (IPv6)",
                    "$ref": "#/definitions/ioschemaEmpty",
        ...
        "dns_proxyReplaceRequest": {
            "type": "object",
            "description": "This is the input message of the 'Replace' RPC",
            "title": "ReplaceRequest is used to replace contents of a dns_proxy",
            ...
            "properties": {
                ...
                "spec": {
                    "description": " Specification of the desired behavior of the DNS Proxy",
                    "title": "spec",
                    "$ref": "#/definitions/schemadns_proxyReplaceSpecType",
                    "x-displayname": "Spec"
                }
            }
        },
        "dns_proxyReplaceResponse": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.dns_proxy.ReplaceResponse"
        },
        "dns_proxyStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "Status of DNS PROXY",
            "x-displayname": "Status",
            "x-ves-proto-message": "ves.io.schema.dns_proxy.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
                ...
                "verification_status": {
                    "description": " Verification Status of the DNS proxy",
                    "title": "Verification Status",
                    "$ref": "#/definitions/dns_proxyDNSProxyStatus",
                    "x-displayname": "Verification Status"
                }
            }
        },
        "dns_proxyTransportType": {
            "type": "string",
            ...
            "x-ves-proto-enum": "ves.io.schema.dns_proxy.TransportType"
        },
        "healthcheckDNSQueryType": {
            "type": "string",
            "description": "DNS Query Type\n\n - DNS_QTYPE_A: Query Type A\n\n - DNS_QTYPE_AAAA: Query Type AAAA\n",
            ...
            "x-ves-proto-enum": "ves.io.schema.healthcheck.DNSQueryType"
        },
        "healthcheckDNSResponseRcodeType": {
            "type": "string",
            "description": "Expected DNS Response Rcode Type\n\n - DNS_RES_RCODE_NOERROR: Rcode NOERROR\n\n - DNS_RES_RCODE_ANY: RCODE ANY\n",
            "title": "Expected DNS Response Rcode Type",
            "enum": [
            ...
            "x-ves-proto-enum": "ves.io.schema.healthcheck.DNSResponseRcodeType"
        },
        "healthcheckDNSResponseRecordType": {
            "type": "string",
            "description": "DNS Response Record Type\n\n - DNS_REQUESTED_QUERY_TYPE: Requested Query Type\n\n - DNS_RES_RECORD_TYPE_ANY: Any Record Type\n",
            ...
            "x-ves-proto-enum": "ves.io.schema.healthcheck.DNSResponseRecordType"
        },
        "healthcheckDnsHealthCheck": {
            "type": "object",
            ...
            "properties": {
                "expected_rcode": {
                    "description": " Specifies an expected Rcode in the answer section of DNS Response, option [no-error, any]\n\nExample: - \"no-error\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Expected Response Rcode",
                    "$ref": "#/definitions/healthcheckDNSResponseRcodeType",
                    "x-displayname": "Expected Response Rcode",
                    "x-ves-example": "no-error",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
                ...
                "expected_record_type": {
                    "description": " Specifies an expected record type in the answer section of DNS Response\n options: [REQUESTED_QUERY_TYPE, RECORD_TYPE_ANY] when REQUESTED_QUERY_TYPE is set, health monitor expects record type same as requested query type\n\nExample: - \"REQUESTED_QUERY_TYPE\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Expected Response Record Type",
                    "$ref": "#/definitions/healthcheckDNSResponseRecordType",
                    "x-displayname": "Expected Response Record Type",
                    "x-ves-example": "REQUESTED_QUERY_TYPE",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                    }
                ...
                "expected_response": {
                    "type": "string",
                    "description": " Specifies an IPv4 or IPv6 address in the answer section of DNS Response\n\nExample: - \"10.0.0.1\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 1024\n",
                    "title": "Expected Response Content",
                    "maxLength": 1024,
                ...
                "query_name": {
                    "type": "string",
                    "description": " The query name that the monitor sends a DNS query for.\n\nExample: - \"www.example.com\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 255\n  ves.io.schema.rules.string.min_len: 1\n",
                    "title": "Query Name",
                    "minLength": 1,
                    "maxLength": 255,
                ...
                "query_type": {
                    "description": " The DNS query type that the monitor sends. Supported types are: [a, aaaa] default: a\n\nExample: - \"A\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Query Type",
                    "$ref": "#/definitions/healthcheckDNSQueryType",
        ...
        "schemadns_proxyCreateSpecType": {
            ...
            "properties": {
                ...
                "lb_algorithm": {
                    ...
                    "$ref": "#/definitions/dns_proxyLBAlgorithmType",
                    "x-displayname": "Load Balancing Algorithm"
                },
                "origin_servers": {
                    "description": " Origin Servers for DNS Proxy\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/dns_proxyOriginServers",
                    "x-displayname": "Origin Servers",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
                ...
                "protocol_inspection": {
                    "description": " Options for enabling and configuring protocol inspection configuration",
                    "$ref": "#/definitions/schemaviewsObjectRefType",
                    "x-displayname": "Protocol Inspection"
                },
                "proxy_advertisement": {
                    "description": " Proxy Advertisement choice",
                    "$ref": "#/definitions/dns_proxyProxyAdvertisementType",
                    "x-displayname": "Proxy Advertisement"
                },
                "transport_type": {
                    "description": " DNS Proxy supports TCP and UDP transport\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "$ref": "#/definitions/dns_proxyTransportType",
                    "x-displayname": "Transport Type",
                    "x-ves-required": "true",
                    "x-ves-validation-rules": {
                        "ves.io.schema.rules.message.required": "true"
        ...
        "schemadns_proxyOriginServerType": {
            "type": "object",
            "description": "Origin Server",
            "title": "Origin Server",
            "x-displayname": "Origin Server",
            "x-ves-oneof-field-choice": "[\"k8s_service\",\"public_ip\",\"public_name\"]",
            ...
            "properties": {
                "k8s_service": {
                    "description": "Exclusive with [public_ip public_name]\n Specify origin server with K8s service name and site information",
                    "title": "OriginServerK8SService",
                ...
                "site_preferences": {
                    ...
                    "$ref": "#/definitions/schemaviewsSiteReferenceListType",
                    "x-displayname": "Site Preferences"
                }
            }
        },
        "schemadns_proxyReplaceSpecType": {
            "type": "object",
            "description": "Replace DNS Proxy in a given namespace.",
            "title": "Replace DNS Proxy",
        ...
        "virtual_hostDNSCacheProfile": {
            ...
            "x-ves-proto-message": "ves.io.schema.virtual_host.DNSCacheProfile",
            "properties": {
                "cache_size": {
                    "type": "integer",
                    "description": "Exclusive with [disable_cache_profile]\n cache size\n\nExample: - \"1000\"-\n\nValidation Rules:\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 10240\n",
                    "title": "Cache size",
                    "format": "int64",
                ...
                "disable_cache_profile": {
                    "description": "Exclusive with [cache_size]\n",
    ...
    "x-displayname": "Configure DNS Proxy",
    "x-ves-proto-file": "ves.io/schema/dns_proxy/public_crudapi.proto"
}`
