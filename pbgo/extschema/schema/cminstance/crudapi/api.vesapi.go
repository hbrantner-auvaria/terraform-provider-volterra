...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/cminstance"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.cminstance.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.cminstance.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.cminstance.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cminstance.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cminstance.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cminstance.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cminstance.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.cminstance.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.cminstance.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.cminstance.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cminstance.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cminstance.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cminstance.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cminstance.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cminstance.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cminstance.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.cminstance.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.cminstance.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/cminstance/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.cminstance/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cminstance-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.cminstance.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cminstance-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.cminstance.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cminstance-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.cminstance.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cminstance",
            "x-ves-object-type": "ves.io.schema.cminstance.Object",
            "x-ves-proto-service": "ves.io.schema.cminstance.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.cminstance/Objects": {
            "get": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cminstance-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.cminstance.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cminstance-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.cminstance.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cminstance",
            "x-ves-object-type": "ves.io.schema.cminstance.Object",
        ...
        "/ves.io.schema.cminstance/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-cminstance-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.cminstance.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "cminstance",
            "x-ves-object-type": "ves.io.schema.cminstance.Object",
        ...
        "/ves.io.schema.cminstance/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cminstance/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cminstance/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.cminstance/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.cminstance.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "cminstanceGlobalSpecType": {
            "type": "object",
            "title": "Central Manager Instance Configuration specification",
            "x-displayname": "Central Manager Instance Spec",
            "x-ves-proto-message": "ves.io.schema.cminstance.GlobalSpecType",
            "properties": {
                "api_token": {
                    "description": " API Token of User\n\nExample: - \"*******\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "API Token of User",
                ...
                "ip": {
                    "description": " IP address of the Central Manager instance to connect to\n\nExample: - \"10.1.1.10\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "IP",
                ...
                "password": {
                    "description": " Password for the Central Manager instance\n\nExample: - \"******\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n",
                    "title": "Password",
                    "$ref": "#/definitions/schemaSecretType",
                ...
                "port": {
                    "type": "integer",
                    "description": " Port of the Central Manager instance to connect to\n\nExample: - \"443\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.uint32.gte: 1\n  ves.io.schema.rules.uint32.lte: 65535\n",
                    "title": "Port",
                    "format": "int64",
                    "x-displayname": "Port",
                    "x-ves-example": "443",
                ...
                "username": {
                    "type": "string",
                    "description": " Username for the Central Manager instance\n\nExample: - \"admin\"-\n\nRequired: YES\n\nValidation Rules:\n  ves.io.schema.rules.message.required: true\n  ves.io.schema.rules.string.max_len: 128\n  ves.io.schema.rules.string.min_len: 4\n",
                    "title": "Username",
                    "minLength": 4,
                    "maxLength": 128,
        ...
        "cminstanceSpecType": {
            "type": "object",
            "description": "Shape of the CMInstance specification",
            "title": "CMInstance Object Specification",
            "x-ves-proto-message": "ves.io.schema.cminstance.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/cminstanceGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "cminstanceStatusObject": {
            "type": "object",
            "description": "Most recently observed status of object",
            "title": "CMInstance Status",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.cminstance.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "cminstancecrudapiErrorCode": {
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.cminstance.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cminstance.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/cminstanceSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cminstance.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cminstancecrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cminstance.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cminstancecrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cminstance.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/cminstanceStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cminstance.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cminstancecrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cminstance.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cminstance.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.cminstance.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/cminstancecrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/cminstance/crudapi/api.proto"
}`
