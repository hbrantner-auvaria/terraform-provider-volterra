...
import (
	...
	object "github.com/volterraedge/terraform-provider-volterra/pbgo/extschema/schema/api_group_element"
)
...
func (c *crudAPIRestClient) Create(ctx context.Context, e db.Entry, opts ...server.CRUDCallOpt) (db.Entry, error) {
	...
	sl := strings.Split("ves.io.schema.api_group_element.crudapi", ".")
...
func (c *APIInprocClient) Create(ctx context.Context, req *ObjectCreateReq, opts ...grpc.CallOption) (*ObjectCreateRsp, error) {
	ah := c.svc.GetAPIHandler("ves.io.schema.api_group_element.crudapi.API")
	oah, ok := ah.(*APISrv)
	if !ok {
		return nil, fmt.Errorf("No CRUD Server for ves.io.schema.api_group_element.crudapi")
	}

	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_group_element.crudapi.API.Create")
...
func (c *APIInprocClient) Replace(ctx context.Context, req *ObjectReplaceReq, opts ...grpc.CallOption) (*ObjectReplaceRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_group_element.crudapi.API.Replace")
...
func (c *APIInprocClient) Get(ctx context.Context, req *ObjectGetReq, opts ...grpc.CallOption) (*ObjectGetRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_group_element.crudapi.API.Get")
...
func (c *APIInprocClient) List(ctx context.Context, req *ObjectListReq, opts ...grpc.CallOption) (*ObjectListRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_group_element.crudapi.API.List")
...
func (c *APIInprocClient) Delete(ctx context.Context, req *ObjectDeleteReq, opts ...grpc.CallOption) (*ObjectDeleteRsp, error) {
	...
	ctx = server.ContextWithRpcFQN(ctx, "ves.io.schema.api_group_element.crudapi.API.Delete")
...
func (s *APISrv) validateTransport(ctx context.Context) error {
	if s.sf.IsTransportNotSupported("ves.io.schema.api_group_element.crudapi.API", server.TransportFromContext(ctx)) {
		userMsg := fmt.Sprintf("ves.io.schema.api_group_element.crudapi.API not allowed in transport '%s'", server.TransportFromContext(ctx))
...
func (s *APISrv) Create(ctx context.Context, req *ObjectCreateReq) (*ObjectCreateRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group_element.crudapi.API.Create"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private create request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_group_element.crudapi.API.Create"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Replace(ctx context.Context, req *ObjectReplaceReq) (*ObjectReplaceRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group_element.crudapi.API.Replace"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private replace request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_group_element.crudapi.API.Replace"), zap.Error(err))
			}
		}
	}
...
func (s *APISrv) Get(ctx context.Context, req *ObjectGetReq) (*ObjectGetRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group_element.crudapi.API.Get"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) List(ctx context.Context, req *ObjectListReq) (*ObjectListRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group_element.crudapi.API.List"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
...
func (s *APISrv) Delete(ctx context.Context, req *ObjectDeleteReq) (*ObjectDeleteRsp, error) {
	...
	if s.sf.Config().EnableAPIValidation {
		if rvFn := s.sf.GetRPCValidator("ves.io.schema.api_group_element.crudapi.API.Delete"); rvFn != nil {
			if err := rvFn(ctx, req); err != nil {
				if !server.NoReqValidateFromContext(ctx) {
					return nil, errors.Wrap(err, "Validating private delete request")
				}
				s.sf.Logger().Warn(server.NoReqValidateAcceptLog, zap.String("rpc_fqn", "ves.io.schema.api_group_element.crudapi.API.Delete"), zap.Error(err))
			}
		}
	}
	key := req.ToUid()
...
var APISwaggerJSON string = `{
    "swagger": "2.0",
    "info": {
        "title": "ves.io/schema/api_group_element/crudapi/api.proto",
    ...
    "tags": [],
    "paths": {
        "/ves.io.schema.api_group_element/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.Get",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    ...
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_group_element-crudapi-api-get"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_group_element.crudapi.API.Get"
            },
            "delete": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.Delete",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_group_element-crudapi-api-delete"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_group_element.crudapi.API.Delete"
            },
            "put": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.Replace",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_group_element-crudapi-api-replace"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_group_element.crudapi.API.Replace"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_group_element",
            "x-ves-object-type": "ves.io.schema.api_group_element.Object",
            "x-ves-proto-service": "ves.io.schema.api_group_element.crudapi.API",
            "x-ves-proto-service-type": "AUTO_CRUD"
        },
        "/ves.io.schema.api_group_element/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.List",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_group_element-crudapi-api-list"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_group_element.crudapi.API.List"
            },
            "post": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.Create",
                "responses": {
                    "200": {
                        "description": "A successful response.",
                        "schema": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_group_element-crudapi-api-create"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_group_element.crudapi.API.Create"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_group_element",
            "x-ves-object-type": "ves.io.schema.api_group_element.Object",
        ...
        "/ves.io.schema.api_group_element/Objects/stream": {
            "get": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.ListStream",
                "responses": {
                    "200": {
                ...
                "externalDocs": {
                    "description": "Examples of this operation",
                    "url": "https://docs.cloud.f5.com/docs-v2/platform/reference/api-ref/ves-io-schema-api_group_element-crudapi-api-liststream"
                },
                "x-ves-proto-rpc": "ves.io.schema.api_group_element.crudapi.API.ListStream"
            },
            "x-displayname": "",
            "x-ves-object-kind": "api_group_element",
            "x-ves-object-type": "ves.io.schema.api_group_element.Object",
        ...
        "/ves.io.schema.api_group_element/introspect/read/Object/{object_uid}": {
            "get": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.Get",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_group_element/introspect/read/Objects": {
            "get": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.List",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_group_element/introspect/write/Object/{object_uid}": {
            "delete": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.Delete",
                "responses": {
                    "200": {
        ...
        "/ves.io.schema.api_group_element/introspect/write/Objects": {
            "post": {
                "operationId": "ves.io.schema.api_group_element.crudapi.API.Create",
                "responses": {
                    "200": {
    ...
    "definitions": {
        "api_group_elementGlobalSpecType": {
            "type": "object",
        ...
        "api_group_elementSpecType": {
            "type": "object",
            "title": "Shape of the api group element specification",
            "x-displayname": "Specification",
            "x-ves-proto-message": "ves.io.schema.api_group_element.SpecType",
            "properties": {
                "gc_spec": {
                    "title": "gc_spec",
                    "$ref": "#/definitions/api_group_elementGlobalSpecType",
                    "x-displayname": "GC Spec"
                }
            }
        },
        "api_group_elementStatusObject": {
            "type": "object",
            "title": "Most recently observed status of object",
            "x-displayname": "Status Object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.StatusObject",
            "properties": {
                "conditions": {
                    "type": "array",
        ...
        "api_group_elementcrudapiErrorCode": {
            "type": "string",
            "enum": [
                "EOK",
                "ENOTFOUND",
            ...
            "default": "EOK",
            "x-displayname": "",
            "x-ves-proto-enum": "ves.io.schema.api_group_element.crudapi.ErrorCode"
        },
        "crudapiObjectCreateReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.crudapi.ObjectCreateReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
                "spec": {
                    "$ref": "#/definitions/api_group_elementSpecType"
                },
                "system_metadata": {
        ...
        "crudapiObjectCreateRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.crudapi.ObjectCreateRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_group_elementcrudapiErrorCode"
                },
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectDeleteRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.crudapi.ObjectDeleteRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_group_elementcrudapiErrorCode"
                }
        ...
        "crudapiObjectGetRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.crudapi.ObjectGetRsp",
            "properties": {
                "ent_backrefs": {
                    "type": "array",
                    "items": {
                ...
                "status": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api_group_elementStatusObject"
                    }
                },
                "system_metadata": {
                    "$ref": "#/definitions/schemaSystemObjectMetaType"
        ...
        "crudapiObjectListRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.crudapi.ObjectListRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_group_elementcrudapiErrorCode"
                },
        ...
        "crudapiObjectListRspItem": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.crudapi.ObjectListRspItem",
            "properties": {
                "labels": {
                    "type": "object"
                },
        ...
        "crudapiObjectReplaceReq": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.crudapi.ObjectReplaceReq",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/schemaObjectMetaType"
                },
        ...
        "crudapiObjectReplaceRsp": {
            "type": "object",
            "x-ves-proto-message": "ves.io.schema.api_group_element.crudapi.ObjectReplaceRsp",
            "properties": {
                "err": {
                    "$ref": "#/definitions/api_group_elementcrudapiErrorCode"
                },
    ...
    "x-ves-proto-file": "ves.io/schema/api_group_element/crudapi/api.proto"
}`
