...
func resourceVolterraUdpLoadbalancerCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("advertise_dualstack_on_public"); ok && !isIntfNil(v) && !advertiseChoiceTypeFound {
		...
		advertiseChoiceTypeFound = true
		advertiseChoiceInt := &ves_io_schema_views_udp_loadbalancer.CreateSpecType_AdvertiseDualstackOnPublic{}
	...
	if v, ok := d.GetOk("advertise_on_public_default_dualstack_vip"); ok && !advertiseChoiceTypeFound {
		...
		if v.(bool) {
			advertiseChoiceInt := &ves_io_schema_views_udp_loadbalancer.CreateSpecType_AdvertiseOnPublicDefaultDualstackVip{}
	...
	if v, ok := d.GetOk("advertise_on_public_default_ipv6_vip"); ok && !advertiseChoiceTypeFound {
		...
		if v.(bool) {
			advertiseChoiceInt := &ves_io_schema_views_udp_loadbalancer.CreateSpecType_AdvertiseOnPublicDefaultIpv6Vip{}
	...
	if v, ok := d.GetOk("advertise_v6_on_public"); ok && !isIntfNil(v) && !advertiseChoiceTypeFound {
		...
		advertiseChoiceTypeFound = true
		advertiseChoiceInt := &ves_io_schema_views_udp_loadbalancer.CreateSpecType_AdvertiseV6OnPublic{}
	...
	if v, ok := d.GetOk("enable_per_packet_load_balancing"); ok && !isIntfNil(v) {
		...
		if v.(bool) {
			createSpec.EnablePerPacketLoadBalancing = &ves_io_schema.Empty{}
		}
	...
	if v, ok := d.GetOk("active_service_policies"); ok && !isIntfNil(v) && !servicePolicyChoiceTypeFound {
		...
		servicePolicyChoiceInt := &ves_io_schema_views_udp_loadbalancer.CreateSpecType_ActiveServicePolicies{}
	...
	if v, ok := d.GetOk("no_service_policies"); ok && !servicePolicyChoiceTypeFound {
		...
		if v.(bool) {
			servicePolicyChoiceInt := &ves_io_schema_views_udp_loadbalancer.CreateSpecType_NoServicePolicies{}
	...
	if v, ok := d.GetOk("service_policies_from_namespace"); ok && !servicePolicyChoiceTypeFound {
		...
		if v.(bool) {
			servicePolicyChoiceInt := &ves_io_schema_views_udp_loadbalancer.CreateSpecType_ServicePoliciesFromNamespace{}
...
func resourceVolterraUdpLoadbalancerUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("advertise_dualstack_on_public"); ok && !isIntfNil(v) && !advertiseChoiceTypeFound {
		...
		advertiseChoiceTypeFound = true
		advertiseChoiceInt := &ves_io_schema_views_udp_loadbalancer.ReplaceSpecType_AdvertiseDualstackOnPublic{}
		advertiseChoiceInt.AdvertiseDualstackOnPublic = &ves_io_schema_views.AdvertisePublic{}
		updateSpec.AdvertiseChoice = advertiseChoiceInt
	...
	if v, ok := d.GetOk("advertise_on_public_default_dualstack_vip"); ok && !advertiseChoiceTypeFound {
		...
		if v.(bool) {
			advertiseChoiceInt := &ves_io_schema_views_udp_loadbalancer.ReplaceSpecType_AdvertiseOnPublicDefaultDualstackVip{}
			advertiseChoiceInt.AdvertiseOnPublicDefaultDualstackVip = &ves_io_schema.Empty{}
			updateSpec.AdvertiseChoice = advertiseChoiceInt
		}
	...
	if v, ok := d.GetOk("advertise_on_public_default_ipv6_vip"); ok && !advertiseChoiceTypeFound {
		...
		if v.(bool) {
			advertiseChoiceInt := &ves_io_schema_views_udp_loadbalancer.ReplaceSpecType_AdvertiseOnPublicDefaultIpv6Vip{}
			advertiseChoiceInt.AdvertiseOnPublicDefaultIpv6Vip = &ves_io_schema.Empty{}
			updateSpec.AdvertiseChoice = advertiseChoiceInt
		}
	...
	if v, ok := d.GetOk("advertise_v6_on_public"); ok && !isIntfNil(v) && !advertiseChoiceTypeFound {
		...
		advertiseChoiceTypeFound = true
		advertiseChoiceInt := &ves_io_schema_views_udp_loadbalancer.ReplaceSpecType_AdvertiseV6OnPublic{}
		advertiseChoiceInt.AdvertiseV6OnPublic = &ves_io_schema_views.AdvertisePublic{}
		updateSpec.AdvertiseChoice = advertiseChoiceInt
	...
	if v, ok := d.GetOk("enable_per_packet_load_balancing"); ok && !isIntfNil(v) {
		...
		if v.(bool) {
			updateSpec.EnablePerPacketLoadBalancing = &ves_io_schema.Empty{}
		}
	...
	if v, ok := d.GetOk("active_service_policies"); ok && !isIntfNil(v) && !servicePolicyChoiceTypeFound {
		...
		servicePolicyChoiceTypeFound = true
		servicePolicyChoiceInt := &ves_io_schema_views_udp_loadbalancer.ReplaceSpecType_ActiveServicePolicies{}
		servicePolicyChoiceInt.ActiveServicePolicies = &ves_io_schema_views_common_waf.ServicePolicyList{}
	...
	if v, ok := d.GetOk("no_service_policies"); ok && !servicePolicyChoiceTypeFound {
		...
		if v.(bool) {
			servicePolicyChoiceInt := &ves_io_schema_views_udp_loadbalancer.ReplaceSpecType_NoServicePolicies{}
			servicePolicyChoiceInt.NoServicePolicies = &ves_io_schema.Empty{}
			updateSpec.ServicePolicyChoice = servicePolicyChoiceInt
		}
	...
	if v, ok := d.GetOk("service_policies_from_namespace"); ok && !servicePolicyChoiceTypeFound {
		...
		if v.(bool) {
			servicePolicyChoiceInt := &ves_io_schema_views_udp_loadbalancer.ReplaceSpecType_ServicePoliciesFromNamespace{}
			servicePolicyChoiceInt.ServicePoliciesFromNamespace = &ves_io_schema.Empty{}
			updateSpec.ServicePolicyChoice = servicePolicyChoiceInt
		}
