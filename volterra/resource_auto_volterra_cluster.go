...
func resourceVolterraClusterCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("max_requests_per_connection"); ok && !isIntfNil(v) && !maxRequestsPerConnectionChoiceTypeFound {
		...
		maxRequestsPerConnectionChoiceInt := &ves_io_schema_cluster.CreateSpecType_MaxRequestsPerConnection{}
	...
	if v, ok := d.GetOk("no_request_limit_per_connection"); ok && !maxRequestsPerConnectionChoiceTypeFound {
		...
		if v.(bool) {
			maxRequestsPerConnectionChoiceInt := &ves_io_schema_cluster.CreateSpecType_NoRequestLimitPerConnection{}
...
func resourceVolterraClusterUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("max_requests_per_connection"); ok && !isIntfNil(v) && !maxRequestsPerConnectionChoiceTypeFound {
		...
		maxRequestsPerConnectionChoiceTypeFound = true
		maxRequestsPerConnectionChoiceInt := &ves_io_schema_cluster.ReplaceSpecType_MaxRequestsPerConnection{}
	...
	if v, ok := d.GetOk("no_request_limit_per_connection"); ok && !maxRequestsPerConnectionChoiceTypeFound {
		...
		if v.(bool) {
			maxRequestsPerConnectionChoiceInt := &ves_io_schema_cluster.ReplaceSpecType_NoRequestLimitPerConnection{}
			maxRequestsPerConnectionChoiceInt.NoRequestLimitPerConnection = &ves_io_schema.Empty{}
			updateSpec.MaxRequestsPerConnectionChoice = maxRequestsPerConnectionChoiceInt
		}
...
func resourceVolterraClusterDelete(d *schema.ResourceData, meta interface{}) error {
	...
	err = client.DeleteObject(context.Background(), ves_io_schema_cluster.ObjectType, namespace, name, opts...)
	if err != nil {
