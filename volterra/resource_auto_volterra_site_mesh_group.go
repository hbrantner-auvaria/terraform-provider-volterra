...
func resourceVolterraSiteMeshGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("bfd_disabled"); ok && !bfdChoiceTypeFound {

		bfdChoiceTypeFound = true

		if v.(bool) {
			bfdChoiceInt := &ves_io_schema_site_mesh_group.CreateSpecType_BfdDisabled{}
			bfdChoiceInt.BfdDisabled = &ves_io_schema.Empty{}
			createSpec.BfdChoice = bfdChoiceInt
		}

	}

	if v, ok := d.GetOk("bfd_enabled"); ok && !isIntfNil(v) && !bfdChoiceTypeFound {

		bfdChoiceTypeFound = true
		bfdChoiceInt := &ves_io_schema_site_mesh_group.CreateSpecType_BfdEnabled{}
		bfdChoiceInt.BfdEnabled = &ves_io_schema_site_mesh_group.BFD{}
		createSpec.BfdChoice = bfdChoiceInt
...
func resourceVolterraSiteMeshGroupUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("bfd_disabled"); ok && !bfdChoiceTypeFound {
		...
		if v.(bool) {
			bfdChoiceInt := &ves_io_schema_site_mesh_group.ReplaceSpecType_BfdDisabled{}
			bfdChoiceInt.BfdDisabled = &ves_io_schema.Empty{}
			updateSpec.BfdChoice = bfdChoiceInt
		}
	...
	if v, ok := d.GetOk("bfd_enabled"); ok && !isIntfNil(v) && !bfdChoiceTypeFound {
		...
		bfdChoiceTypeFound = true
		bfdChoiceInt := &ves_io_schema_site_mesh_group.ReplaceSpecType_BfdEnabled{}
		bfdChoiceInt.BfdEnabled = &ves_io_schema_site_mesh_group.BFD{}
		updateSpec.BfdChoice = bfdChoiceInt
