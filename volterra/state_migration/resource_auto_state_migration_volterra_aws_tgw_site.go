...
func ResourceAwsTgwSiteInstanceResourceV1() *schema.Resource {
...
func ResourceAwsTgwSiteInstanceStateUpgradeV1(ctx context.Context, rawState map[string]interface{}, meta interface{}) (map[string]interface{}, error) {
