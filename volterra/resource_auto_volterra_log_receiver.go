...
func resourceVolterraLogReceiverCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("data_dog"); ok && !isIntfNil(v) && !logReceiverChoiceTypeFound {
	...
	if v, ok := d.GetOk("splunk"); ok && !isIntfNil(v) && !logReceiverChoiceTypeFound {
	...
	if v, ok := d.GetOk("log_receiver_sites"); ok && !isIntfNil(v) && !whereChoiceTypeFound {
