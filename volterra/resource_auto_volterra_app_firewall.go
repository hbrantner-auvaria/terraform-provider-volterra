...
func resourceVolterraAppFirewallCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("bot_protection_setting"); ok && !isIntfNil(v) && !botProtectionChoiceTypeFound {
	...
	if v, ok := d.GetOk("detection_settings"); ok && !isIntfNil(v) && !detectionSettingChoiceTypeFound {
		...
		for _, set := range sl {
			if set != nil {
				...
				if v, ok := cs["configured_violations"]; ok && !isIntfNil(v) {

					sl := v.([]interface{})
					configuredViolations := make([]*ves_io_schema_app_firewall.ViolationConfiguration, len(sl))
					detectionSettingChoiceInt.DetectionSettings.ConfiguredViolations = configuredViolations
					for i, set := range sl {
						if set != nil {
							configuredViolations[i] = &ves_io_schema_app_firewall.ViolationConfiguration{}
							configuredViolationsMapStrToI := set.(map[string]interface{})

							if w, ok := configuredViolationsMapStrToI["name"]; ok && !isIntfNil(w) {
								configuredViolations[i].Name = w.(string)
							}

							stateChoiceTypeFound := false

							if v, ok := configuredViolationsMapStrToI["disabled"]; ok && !isIntfNil(v) && !stateChoiceTypeFound {

								stateChoiceTypeFound = true

								if v.(bool) {
									stateChoiceInt := &ves_io_schema_app_firewall.ViolationConfiguration_Disabled{}
									stateChoiceInt.Disabled = &ves_io_schema.Empty{}
									configuredViolations[i].StateChoice = stateChoiceInt
								}

							}

							if v, ok := configuredViolationsMapStrToI["enabled"]; ok && !isIntfNil(v) && !stateChoiceTypeFound {

								stateChoiceTypeFound = true

								if v.(bool) {
									stateChoiceInt := &ves_io_schema_app_firewall.ViolationConfiguration_Enabled{}
									stateChoiceInt.Enabled = &ves_io_schema.Empty{}
									configuredViolations[i].StateChoice = stateChoiceInt
								}
				...
				if v, ok := cs["violations_view"]; ok && !isIntfNil(v) {

					sl := v.([]interface{})
					violationsView := make([]*ves_io_schema_app_firewall.ViolationConfigView, len(sl))
					detectionSettingChoiceInt.DetectionSettings.ViolationsView = violationsView
					for i, set := range sl {
						if set != nil {
							violationsView[i] = &ves_io_schema_app_firewall.ViolationConfigView{}
							violationsViewMapStrToI := set.(map[string]interface{})

							if w, ok := violationsViewMapStrToI["description"]; ok && !isIntfNil(w) {
								violationsView[i].Description = w.(string)
							}

							if w, ok := violationsViewMapStrToI["enabled"]; ok && !isIntfNil(w) {
								violationsView[i].Enabled = w.(bool)
							}

							if w, ok := violationsViewMapStrToI["enabled_by_default"]; ok && !isIntfNil(w) {
								violationsView[i].EnabledByDefault = w.(string)
							}

							if w, ok := violationsViewMapStrToI["name"]; ok && !isIntfNil(w) {
								violationsView[i].Name = w.(string)
							}

							if w, ok := violationsViewMapStrToI["title"]; ok && !isIntfNil(w) {
								violationsView[i].Title = w.(string)
							}
	...
	if v, ok := d.GetOk("disable_ai_enhancements"); ok && !enhanceWithAiChoiceTypeFound {
		...
		if v.(bool) {
			enhanceWithAiChoiceInt := &ves_io_schema_app_firewall.CreateSpecType_DisableAiEnhancements{}
			enhanceWithAiChoiceInt.DisableAiEnhancements = &ves_io_schema.Empty{}
			createSpec.EnhanceWithAiChoice = enhanceWithAiChoiceInt
		}

	}

	if v, ok := d.GetOk("enable_ai_enhancements"); ok && !isIntfNil(v) && !enhanceWithAiChoiceTypeFound {

		enhanceWithAiChoiceTypeFound = true
		enhanceWithAiChoiceInt := &ves_io_schema_app_firewall.CreateSpecType_EnableAiEnhancements{}
		enhanceWithAiChoiceInt.EnableAiEnhancements = &ves_io_schema_app_firewall.AIEnhancementsConfig{}
		createSpec.EnhanceWithAiChoice = enhanceWithAiChoiceInt
		...
		for _, set := range sl {
			if set != nil {
				...
				riskScoreActionChoiceTypeFound := false

				if v, ok := cs["mitigate_high_medium_risk_action"]; ok && !isIntfNil(v) && !riskScoreActionChoiceTypeFound {

					riskScoreActionChoiceTypeFound = true

					if v.(bool) {
						riskScoreActionChoiceInt := &ves_io_schema_app_firewall.AIEnhancementsConfig_MitigateHighMediumRiskAction{}
						riskScoreActionChoiceInt.MitigateHighMediumRiskAction = &ves_io_schema.Empty{}
						enhanceWithAiChoiceInt.EnableAiEnhancements.RiskScoreActionChoice = riskScoreActionChoiceInt
					}

				}

				if v, ok := cs["mitigate_high_risk_action"]; ok && !isIntfNil(v) && !riskScoreActionChoiceTypeFound {

					riskScoreActionChoiceTypeFound = true

					if v.(bool) {
						riskScoreActionChoiceInt := &ves_io_schema_app_firewall.AIEnhancementsConfig_MitigateHighRiskAction{}
						riskScoreActionChoiceInt.MitigateHighRiskAction = &ves_io_schema.Empty{}
						enhanceWithAiChoiceInt.EnableAiEnhancements.RiskScoreActionChoice = riskScoreActionChoiceInt
					}
...
func resourceVolterraAppFirewallUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("disable_ai_enhancements"); ok && !enhanceWithAiChoiceTypeFound {
		...
		if v.(bool) {
			enhanceWithAiChoiceInt := &ves_io_schema_app_firewall.ReplaceSpecType_DisableAiEnhancements{}
			enhanceWithAiChoiceInt.DisableAiEnhancements = &ves_io_schema.Empty{}
			updateSpec.EnhanceWithAiChoice = enhanceWithAiChoiceInt
		}
	...
	if v, ok := d.GetOk("enable_ai_enhancements"); ok && !isIntfNil(v) && !enhanceWithAiChoiceTypeFound {
		...
		enhanceWithAiChoiceTypeFound = true
		enhanceWithAiChoiceInt := &ves_io_schema_app_firewall.ReplaceSpecType_EnableAiEnhancements{}
		enhanceWithAiChoiceInt.EnableAiEnhancements = &ves_io_schema_app_firewall.AIEnhancementsConfig{}
		updateSpec.EnhanceWithAiChoice = enhanceWithAiChoiceInt
