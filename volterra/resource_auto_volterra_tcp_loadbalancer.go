...
func resourceVolterraTcpLoadbalancerDelete(d *schema.ResourceData, meta interface{}) error {
	...
	err = client.DeleteObject(context.Background(), ves_io_schema_views_tcp_loadbalancer.ObjectType, namespace, name, opts...)
	if err != nil {
		return fmt.Errorf("error deleting TcpLoadbalancer: %w", err)
	}
	return nil
