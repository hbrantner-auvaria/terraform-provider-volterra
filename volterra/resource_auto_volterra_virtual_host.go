...
func resourceVolterraVirtualHostCreate(d *schema.ResourceData, meta interface{}) error {
	...
	//bigip_application_profiles
	if v, ok := d.GetOk("bigip_application_profiles"); ok && !isIntfNil(v) {

		sl := v.([]interface{})
		bigipApplicationProfilesInt := make([]*ves_io_schema.ObjectRefType, len(sl))
		createSpec.BigipApplicationProfiles = bigipApplicationProfilesInt
		for i, ps := range sl {
			if ps != nil {

				bapMapToStrVal := ps.(map[string]interface{})
				bigipApplicationProfilesInt[i] = &ves_io_schema.ObjectRefType{}

				bigipApplicationProfilesInt[i].Kind = "application_profiles"

				if v, ok := bapMapToStrVal["name"]; ok && !isIntfNil(v) {
					bigipApplicationProfilesInt[i].Name = v.(string)
				}

				if v, ok := bapMapToStrVal["namespace"]; ok && !isIntfNil(v) {
					bigipApplicationProfilesInt[i].Namespace = v.(string)
				}

				if v, ok := bapMapToStrVal["tenant"]; ok && !isIntfNil(v) {
					bigipApplicationProfilesInt[i].Tenant = v.(string)
				}

				if v, ok := bapMapToStrVal["uid"]; ok && !isIntfNil(v) {
					bigipApplicationProfilesInt[i].Uid = v.(string)
				}
	...
	//max_requests_per_connection_choice

	maxRequestsPerConnectionChoiceTypeFound := false

	if v, ok := d.GetOk("max_requests_per_connection"); ok && !isIntfNil(v) && !maxRequestsPerConnectionChoiceTypeFound {

		maxRequestsPerConnectionChoiceTypeFound = true
		maxRequestsPerConnectionChoiceInt := &ves_io_schema_virtual_host.CreateSpecType_MaxRequestsPerConnection{}

		createSpec.MaxRequestsPerConnectionChoice = maxRequestsPerConnectionChoiceInt

		maxRequestsPerConnectionChoiceInt.MaxRequestsPerConnection = uint32(v.(int))

	}

	if v, ok := d.GetOk("no_request_limit_per_connection"); ok && !maxRequestsPerConnectionChoiceTypeFound {

		maxRequestsPerConnectionChoiceTypeFound = true

		if v.(bool) {
			maxRequestsPerConnectionChoiceInt := &ves_io_schema_virtual_host.CreateSpecType_NoRequestLimitPerConnection{}
	...
	if v, ok := d.GetOk("additional_domains"); ok && !isIntfNil(v) && !strictSniHostHeaderCheckChoiceTypeFound {
	...
	if v, ok := d.GetOk("tls_cert_params"); ok && !isIntfNil(v) && !tlsCertificatesChoiceTypeFound {
		...
		for _, set := range sl {
			if set != nil {
				...
				if v, ok := cs["client_certificate_optional"]; ok && !isIntfNil(v) && !clientCertificateVerifyChoiceTypeFound {
				...
				if v, ok := cs["client_certificate_required"]; ok && !isIntfNil(v) && !clientCertificateVerifyChoiceTypeFound {
				...
				if v, ok := cs["no_client_certificate"]; ok && !isIntfNil(v) && !clientCertificateVerifyChoiceTypeFound {
	...
	if v, ok := d.GetOk("tls_parameters"); ok && !isIntfNil(v) && !tlsCertificatesChoiceTypeFound {
...
func resourceVolterraVirtualHostUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("bigip_application_profiles"); ok && !isIntfNil(v) {
		...
		sl := v.([]interface{})
		bigipApplicationProfilesInt := make([]*ves_io_schema.ObjectRefType, len(sl))
		updateSpec.BigipApplicationProfiles = bigipApplicationProfilesInt
		for i, ps := range sl {
			if ps != nil {
	...
	if v, ok := d.GetOk("max_requests_per_connection"); ok && !isIntfNil(v) && !maxRequestsPerConnectionChoiceTypeFound {
		...
		maxRequestsPerConnectionChoiceTypeFound = true
		maxRequestsPerConnectionChoiceInt := &ves_io_schema_virtual_host.ReplaceSpecType_MaxRequestsPerConnection{}

		updateSpec.MaxRequestsPerConnectionChoice = maxRequestsPerConnectionChoiceInt
	...
	if v, ok := d.GetOk("no_request_limit_per_connection"); ok && !maxRequestsPerConnectionChoiceTypeFound {
		...
		if v.(bool) {
			maxRequestsPerConnectionChoiceInt := &ves_io_schema_virtual_host.ReplaceSpecType_NoRequestLimitPerConnection{}
			maxRequestsPerConnectionChoiceInt.NoRequestLimitPerConnection = &ves_io_schema.Empty{}
			updateSpec.MaxRequestsPerConnectionChoice = maxRequestsPerConnectionChoiceInt
		}
