...
func resourceVolterraAwsVpcSiteCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("aws_cred"); ok && !isIntfNil(v) && !deploymentTypeFound {
						...
						if set != nil {
							...
							if v, ok := cs["vifs"]; ok && !isIntfNil(v) {
								...
								for i, v := range v.([]interface{}) {
									if v == nil {
										return fmt.Errorf("please provide valid non-empty string value of field vifs")
									}
	...
	if v, ok := d.GetOk("egress_nat_gw"); ok && !isIntfNil(v) && !egressGatewayChoiceTypeFound {
	...
	if v, ok := d.GetOk("egress_virtual_private_gateway"); ok && !isIntfNil(v) && !egressGatewayChoiceTypeFound {
	...
	encryptionChoiceTypeFound := false

	if v, ok := d.GetOk("disable_encryption"); ok && !encryptionChoiceTypeFound {

		encryptionChoiceTypeFound = true

		if v.(bool) {
			encryptionChoiceInt := &ves_io_schema_views_aws_vpc_site.CreateSpecType_DisableEncryption{}
			encryptionChoiceInt.DisableEncryption = &ves_io_schema.Empty{}
			createSpec.EncryptionChoice = encryptionChoiceInt
		}

	}

	if v, ok := d.GetOk("enable_encryption"); ok && !isIntfNil(v) && !encryptionChoiceTypeFound {

		encryptionChoiceTypeFound = true
		encryptionChoiceInt := &ves_io_schema_views_aws_vpc_site.CreateSpecType_EnableEncryption{}
		encryptionChoiceInt.EnableEncryption = &ves_io_schema_views.AWSDiskEncryption{}
		createSpec.EncryptionChoice = encryptionChoiceInt
		...
		for _, set := range sl {
			if set != nil {
				...
				if v, ok := cs["kms_key_id"]; ok && !isIntfNil(v) {

					encryptionChoiceInt.EnableEncryption.KmsKeyId = v.(string)
	...
	if v, ok := d.GetOk("custom_security_group"); ok && !isIntfNil(v) && !securityGroupChoiceTypeFound {
					...
					for _, set := range sl {
						if set != nil {
							...
							if v, ok := performanceEnhancementModeMapStrToI["perf_mode_l7_enhanced"]; ok && !isIntfNil(v) && !perfModeChoiceTypeFound {
								...
								perfModeChoiceInt.PerfModeL7Enhanced = &ves_io_schema_views.L7PerformanceEnhancementType{}
								performanceEnhancementMode.PerfModeChoice = perfModeChoiceInt
								...
								for _, set := range sl {
									if set != nil {
										...
										if v, ok := cs["jumbo_disabled"]; ok && !isIntfNil(v) && !perfModeChoiceTypeFound {

											perfModeChoiceTypeFound = true

											if v.(bool) {
												perfModeChoiceIntNew := &ves_io_schema_views.L7PerformanceEnhancementType_JumboDisabled{}
												perfModeChoiceIntNew.JumboDisabled = &ves_io_schema.Empty{}
												perfModeChoiceInt.PerfModeL7Enhanced.PerfModeChoice = perfModeChoiceIntNew
											}

										}

										if v, ok := cs["jumbo_enabled"]; ok && !isIntfNil(v) && !perfModeChoiceTypeFound {

											perfModeChoiceTypeFound = true

											if v.(bool) {
												perfModeChoiceIntNew := &ves_io_schema_views.L7PerformanceEnhancementType_JumboEnabled{}
												perfModeChoiceIntNew.JumboEnabled = &ves_io_schema.Empty{}
												perfModeChoiceInt.PerfModeL7Enhanced.PerfModeChoice = perfModeChoiceIntNew
											}
...
func resourceVolterraAwsVpcSiteUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if v, ok := d.GetOk("egress_gateway_default"); ok && !egressGatewayChoiceTypeFound {
		...
		if v.(bool) {
			egressGatewayChoiceInt := &ves_io_schema_views_aws_vpc_site.ReplaceSpecType_EgressGatewayDefault{}
			egressGatewayChoiceInt.EgressGatewayDefault = &ves_io_schema.Empty{}
	...
	if v, ok := d.GetOk("egress_nat_gw"); ok && !isIntfNil(v) && !egressGatewayChoiceTypeFound {
		...
		egressGatewayChoiceTypeFound = true
		egressGatewayChoiceInt := &ves_io_schema_views_aws_vpc_site.ReplaceSpecType_EgressNatGw{}
		egressGatewayChoiceInt.EgressNatGw = &ves_io_schema_views.AWSNATGatewaychoiceType{}
		updateSpec.EgressGatewayChoice = egressGatewayChoiceInt
	...
	if v, ok := d.GetOk("egress_virtual_private_gateway"); ok && !isIntfNil(v) && !egressGatewayChoiceTypeFound {
		...
		egressGatewayChoiceTypeFound = true
		egressGatewayChoiceInt := &ves_io_schema_views_aws_vpc_site.ReplaceSpecType_EgressVirtualPrivateGateway{}
		egressGatewayChoiceInt.EgressVirtualPrivateGateway = &ves_io_schema_views.AWSVirtualPrivateGatewaychoiceType{}
		updateSpec.EgressGatewayChoice = egressGatewayChoiceInt
	...
	if v, ok := d.GetOk("custom_security_group"); ok && !isIntfNil(v) && !securityGroupChoiceTypeFound {
		...
		securityGroupChoiceTypeFound = true
		securityGroupChoiceInt := &ves_io_schema_views_aws_vpc_site.ReplaceSpecType_CustomSecurityGroup{}
		securityGroupChoiceInt.CustomSecurityGroup = &ves_io_schema_views.SecurityGroupType{}
	...
	if v, ok := d.GetOk("f5xc_security_group"); ok && !securityGroupChoiceTypeFound {
		...
		if v.(bool) {
			securityGroupChoiceInt := &ves_io_schema_views_aws_vpc_site.ReplaceSpecType_F5XcSecurityGroup{}
			securityGroupChoiceInt.F5XcSecurityGroup = &ves_io_schema.Empty{}
			updateSpec.SecurityGroupChoice = securityGroupChoiceInt
		}
		...
		for _, set := range sl {
			if set != nil {
				...
				if v, ok := cs["k8s_cluster"]; ok && !isIntfNil(v) && !k8SClusterChoiceTypeFound {
					...
					k8SClusterChoiceTypeFound = true
					k8SClusterChoiceInt := &ves_io_schema_views_aws_vpc_site.AWSVPCVoltstackClusterReplaceType_K8SCluster{}
					k8SClusterChoiceInt.K8SCluster = &ves_io_schema_views.ObjectRefType{}
					siteTypeInt.VoltstackCluster.K8SClusterChoice = k8SClusterChoiceInt
				...
				if v, ok := cs["no_k8s_cluster"]; ok && !isIntfNil(v) && !k8SClusterChoiceTypeFound {
					...
					if v.(bool) {
						k8SClusterChoiceInt := &ves_io_schema_views_aws_vpc_site.AWSVPCVoltstackClusterReplaceType_NoK8SCluster{}
						k8SClusterChoiceInt.NoK8SCluster = &ves_io_schema.Empty{}
						siteTypeInt.VoltstackCluster.K8SClusterChoice = k8SClusterChoiceInt
					}
...
func resourceVolterraAwsVpcSiteDelete(d *schema.ResourceData, meta interface{}) error {
	...
	err = client.DeleteObject(context.Background(), ves_io_schema_views_aws_vpc_site.ObjectType, namespace, name, opts...)
	if err != nil {
		return fmt.Errorf("error deleting AwsVpcSite: %w", err)
	}
	return nil
