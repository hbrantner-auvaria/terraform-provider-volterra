											...
											for i, set := range sl {
												if set != nil {
													...
													if v, ok := cacheHeadersMapStrToI["operator"]; ok && !isIntfNil(v) {
														...
														sl := v.([]interface{})
														operator := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator{}
														...
														for _, set := range sl {
															if set != nil {
																...
																if v, ok := operatorMapStrToI["contains"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_Contains{}
																...
																if v, ok := operatorMapStrToI["does_not_contain"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_DoesNotContain{}
																...
																if v, ok := operatorMapStrToI["does_not_end_with"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_DoesNotEndWith{}
																...
																if v, ok := operatorMapStrToI["does_not_equal"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_DoesNotEqual{}
																...
																if v, ok := operatorMapStrToI["does_not_start_with"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_DoesNotStartWith{}
																...
																if v, ok := operatorMapStrToI["endswith"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_Endswith{}
																...
																if v, ok := operatorMapStrToI["equals"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_Equals{}
																...
																if v, ok := operatorMapStrToI["match_regex"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_MatchRegex{}
																...
																if v, ok := operatorMapStrToI["startswith"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.HeaderCacheOperator_Startswith{}
											...
											for i, set := range sl {
												if set != nil {
													...
													if v, ok := cookieMatcherMapStrToI["operator"]; ok && !isIntfNil(v) {
														...
														sl := v.([]interface{})
														operator := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator{}
														...
														for _, set := range sl {
															if set != nil {
																...
																if v, ok := operatorMapStrToI["contains"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_Contains{}
																...
																if v, ok := operatorMapStrToI["does_not_contain"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_DoesNotContain{}
																...
																if v, ok := operatorMapStrToI["does_not_end_with"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_DoesNotEndWith{}
																...
																if v, ok := operatorMapStrToI["does_not_equal"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_DoesNotEqual{}
																...
																if v, ok := operatorMapStrToI["does_not_start_with"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_DoesNotStartWith{}
																...
																if v, ok := operatorMapStrToI["endswith"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_Endswith{}
																...
																if v, ok := operatorMapStrToI["equals"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_Equals{}
																...
																if v, ok := operatorMapStrToI["match_regex"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_MatchRegex{}
																...
																if v, ok := operatorMapStrToI["startswith"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.CookieMatcherCacheOperator_Startswith{}
											...
											for i, set := range sl {
												if set != nil {
													...
													if v, ok := queryParametersMapStrToI["operator"]; ok && !isIntfNil(v) {
														...
														sl := v.([]interface{})
														operator := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator{}
														...
														for _, set := range sl {
															if set != nil {
																...
																if v, ok := operatorMapStrToI["contains"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_Contains{}
																...
																if v, ok := operatorMapStrToI["does_not_contain"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_DoesNotContain{}
																...
																if v, ok := operatorMapStrToI["does_not_end_with"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_DoesNotEndWith{}
																...
																if v, ok := operatorMapStrToI["does_not_equal"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_DoesNotEqual{}
																...
																if v, ok := operatorMapStrToI["does_not_start_with"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_DoesNotStartWith{}
																...
																if v, ok := operatorMapStrToI["endswith"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_Endswith{}
																...
																if v, ok := operatorMapStrToI["equals"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_Equals{}
																...
																if v, ok := operatorMapStrToI["match_regex"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_MatchRegex{}
																...
																if v, ok := operatorMapStrToI["startswith"]; ok && !isIntfNil(v) && !cacheOperatorTypeFound {
																	...
																	cacheOperatorTypeFound = true
																	cacheOperatorInt := &ves_io_schema_cdn_cache_rule.QueryParamCacheOperator_Startswith{}
